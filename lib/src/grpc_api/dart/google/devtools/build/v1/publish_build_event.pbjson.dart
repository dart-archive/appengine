...
const PublishBuildEventServiceBase$json = const {
  '1': 'PublishBuildEvent',
  '2': const [
...
const PublishBuildEventServiceBase$messageJson = const {
  ...
  '.google.devtools.build.v1.BuildEvent.InvocationAttemptStarted': $1.BuildEvent_InvocationAttemptStarted$json,
  '.google.protobuf.Any': $4.Any$json,
  '.google.devtools.build.v1.BuildEvent.InvocationAttemptFinished': $1.BuildEvent_InvocationAttemptFinished$json,
  '.google.devtools.build.v1.BuildStatus': $5.BuildStatus$json,
  '.google.devtools.build.v1.BuildEvent.BuildEnqueued': $1.BuildEvent_BuildEnqueued$json,
  '.google.devtools.build.v1.BuildEvent.BuildFinished': $1.BuildEvent_BuildFinished$json,
  '.google.devtools.build.v1.BuildEvent.ConsoleOutput': $1.BuildEvent_ConsoleOutput$json,
  '.google.devtools.build.v1.BuildEvent.BuildComponentStreamFinished': $1.BuildEvent_BuildComponentStreamFinished$json,
