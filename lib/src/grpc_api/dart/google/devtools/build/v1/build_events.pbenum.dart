...
class ConsoleOutputStream extends $pb.ProtobufEnum {
  static const ConsoleOutputStream UNKNOWN = ConsoleOutputStream._(0, 'UNKNOWN');
...
class BuildEvent_BuildComponentStreamFinished_FinishType extends $pb.ProtobufEnum {
  static const BuildEvent_BuildComponentStreamFinished_FinishType FINISH_TYPE_UNSPECIFIED = BuildEvent_BuildComponentStreamFinished_FinishType._(0, 'FINISH_TYPE_UNSPECIFIED');
  static const BuildEvent_BuildComponentStreamFinished_FinishType FINISHED = BuildEvent_BuildComponentStreamFinished_FinishType._(1, 'FINISHED');
  static const BuildEvent_BuildComponentStreamFinished_FinishType EXPIRED = BuildEvent_BuildComponentStreamFinished_FinishType._(2, 'EXPIRED');
...
class StreamId_BuildComponent extends $pb.ProtobufEnum {
  static const StreamId_BuildComponent UNKNOWN_COMPONENT = StreamId_BuildComponent._(0, 'UNKNOWN_COMPONENT');
  static const StreamId_BuildComponent CONTROLLER = StreamId_BuildComponent._(1, 'CONTROLLER');
  static const StreamId_BuildComponent WORKER = StreamId_BuildComponent._(2, 'WORKER');
  static const StreamId_BuildComponent TOOL = StreamId_BuildComponent._(3, 'TOOL');
