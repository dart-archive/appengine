...
class BuildEvent_InvocationAttemptFinished extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName('google.devtools.build.v1'))
    ..a<$2.BuildStatus>(3, 'invocationStatus', $pb.PbFieldType.OM,
...
class BuildEvent_BuildFinished extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('BuildEvent.BuildFinished',
      package: const $pb.PackageName('google.devtools.build.v1'))
    ..a<$2.BuildStatus>(1, 'status', $pb.PbFieldType.OM,
        $2.BuildStatus.getDefault, $2.BuildStatus.create)
    ..hasRequiredFields = false;
...
class BuildEvent extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('BuildEvent',
    ...
    ..a<BuildEvent_BuildEnqueued>(53, 'buildEnqueued', $pb.PbFieldType.OM,
        BuildEvent_BuildEnqueued.getDefault, BuildEvent_BuildEnqueued.create)
    ..a<BuildEvent_BuildFinished>(55, 'buildFinished', $pb.PbFieldType.OM,
        BuildEvent_BuildFinished.getDefault, BuildEvent_BuildFinished.create)
    ..a<BuildEvent_ConsoleOutput>(56, 'consoleOutput', $pb.PbFieldType.OM,
    ...
    ..a<$1.Any>(
        60, 'bazelEvent', $pb.PbFieldType.OM, $1.Any.getDefault, $1.Any.create)
    ..a<$1.Any>(61, 'buildExecutionEvent', $pb.PbFieldType.OM,
