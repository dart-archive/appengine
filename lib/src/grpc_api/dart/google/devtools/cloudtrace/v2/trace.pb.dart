...
class Span_Attributes extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Span.Attributes', package: const $pb.PackageName('google.devtools.cloudtrace.v2'))
    ..m<$core.String, AttributeValue>(1, 'attributeMap', 'Span.Attributes.AttributeMapEntry',$pb.PbFieldType.OS, $pb.PbFieldType.OM, AttributeValue.create, null, null , const $pb.PackageName('google.devtools.cloudtrace.v2'))
    ..a<$core.int>(2, 'droppedAttributesCount', $pb.PbFieldType.O3)
    ..hasRequiredFields = false
  ;

  Span_Attributes() : super();
  Span_Attributes.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  Span_Attributes.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  Span_Attributes clone() => Span_Attributes()..mergeFromMessage(this);
  Span_Attributes copyWith(void Function(Span_Attributes) updates) => super.copyWith((message) => updates(message as Span_Attributes));
  ...
  static Span_Attributes getDefault() => _defaultInstance ??= create()..freeze();
...
class Span_TimeEvent_Annotation extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Span.TimeEvent.Annotation', package: const $pb.PackageName('google.devtools.cloudtrace.v2'))
    ..a<TruncatableString>(1, 'description', $pb.PbFieldType.OM, TruncatableString.getDefault, TruncatableString.create)
    ..a<Span_Attributes>(2, 'attributes', $pb.PbFieldType.OM, Span_Attributes.getDefault, Span_Attributes.create)
    ..hasRequiredFields = false
  ;

  Span_TimeEvent_Annotation() : super();
  Span_TimeEvent_Annotation.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  Span_TimeEvent_Annotation.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  Span_TimeEvent_Annotation clone() => Span_TimeEvent_Annotation()..mergeFromMessage(this);
  Span_TimeEvent_Annotation copyWith(void Function(Span_TimeEvent_Annotation) updates) => super.copyWith((message) => updates(message as Span_TimeEvent_Annotation));
  $pb.BuilderInfo get info_ => _i;
  ...
  static Span_TimeEvent_Annotation getDefault() => _defaultInstance ??= create()..freeze();
...
class Span_TimeEvent_MessageEvent extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Span.TimeEvent.MessageEvent', package: const $pb.PackageName('google.devtools.cloudtrace.v2'))
    ..e<Span_TimeEvent_MessageEvent_Type>(1, 'type', $pb.PbFieldType.OE, Span_TimeEvent_MessageEvent_Type.TYPE_UNSPECIFIED, Span_TimeEvent_MessageEvent_Type.valueOf, Span_TimeEvent_MessageEvent_Type.values)
    ..aInt64(2, 'id')
  ...
  Span_TimeEvent_MessageEvent.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  Span_TimeEvent_MessageEvent.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  Span_TimeEvent_MessageEvent clone() => Span_TimeEvent_MessageEvent()..mergeFromMessage(this);
  Span_TimeEvent_MessageEvent copyWith(void Function(Span_TimeEvent_MessageEvent) updates) => super.copyWith((message) => updates(message as Span_TimeEvent_MessageEvent));
  $pb.BuilderInfo get info_ => _i;
  ...
  static Span_TimeEvent_MessageEvent getDefault() => _defaultInstance ??= create()..freeze();
  ...
  set uncompressedSizeBytes(Int64 v) { $_setInt64(2, v); }
  ...
  set compressedSizeBytes(Int64 v) { $_setInt64(3, v); }
...
class Span_TimeEvent extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Span.TimeEvent', package: const $pb.PackageName('google.devtools.cloudtrace.v2'))
    ..a<$0.Timestamp>(1, 'time', $pb.PbFieldType.OM, $0.Timestamp.getDefault, $0.Timestamp.create)
    ..a<Span_TimeEvent_Annotation>(2, 'annotation', $pb.PbFieldType.OM, Span_TimeEvent_Annotation.getDefault, Span_TimeEvent_Annotation.create)
    ..a<Span_TimeEvent_MessageEvent>(3, 'messageEvent', $pb.PbFieldType.OM, Span_TimeEvent_MessageEvent.getDefault, Span_TimeEvent_MessageEvent.create)
    ..oo(0, [2, 3])
    ..hasRequiredFields = false
  ;

  Span_TimeEvent() : super();
  Span_TimeEvent.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  Span_TimeEvent.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  Span_TimeEvent clone() => Span_TimeEvent()..mergeFromMessage(this);
  Span_TimeEvent copyWith(void Function(Span_TimeEvent) updates) => super.copyWith((message) => updates(message as Span_TimeEvent));
  $pb.BuilderInfo get info_ => _i;
...
class Span_TimeEvents extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Span.TimeEvents', package: const $pb.PackageName('google.devtools.cloudtrace.v2'))
    ..pc<Span_TimeEvent>(1, 'timeEvent', $pb.PbFieldType.PM,Span_TimeEvent.create)
  ...
  Span_TimeEvents.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  Span_TimeEvents.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  Span_TimeEvents clone() => Span_TimeEvents()..mergeFromMessage(this);
  Span_TimeEvents copyWith(void Function(Span_TimeEvents) updates) => super.copyWith((message) => updates(message as Span_TimeEvents));
  $pb.BuilderInfo get info_ => _i;
  ...
  static Span_TimeEvents getDefault() => _defaultInstance ??= create()..freeze();
...
class Span_Link extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Span.Link', package: const $pb.PackageName('google.devtools.cloudtrace.v2'))
    ..aOS(1, 'traceId')
    ..aOS(2, 'spanId')
    ..e<Span_Link_Type>(3, 'type', $pb.PbFieldType.OE, Span_Link_Type.TYPE_UNSPECIFIED, Span_Link_Type.valueOf, Span_Link_Type.values)
    ..a<Span_Attributes>(4, 'attributes', $pb.PbFieldType.OM, Span_Attributes.getDefault, Span_Attributes.create)
    ..hasRequiredFields = false
  ;

  Span_Link() : super();
  Span_Link.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  Span_Link.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  Span_Link clone() => Span_Link()..mergeFromMessage(this);
  Span_Link copyWith(void Function(Span_Link) updates) => super.copyWith((message) => updates(message as Span_Link));
  $pb.BuilderInfo get info_ => _i;
...
class Span_Links extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Span.Links', package: const $pb.PackageName('google.devtools.cloudtrace.v2'))
  ...
  Span_Links() : super();
  Span_Links.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  Span_Links.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  Span_Links clone() => Span_Links()..mergeFromMessage(this);
  Span_Links copyWith(void Function(Span_Links) updates) => super.copyWith((message) => updates(message as Span_Links));
  $pb.BuilderInfo get info_ => _i;
...
class Span extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Span', package: const $pb.PackageName('google.devtools.cloudtrace.v2'))
    ..aOS(1, 'name')
    ..aOS(2, 'spanId')
    ..aOS(3, 'parentSpanId')
    ..a<TruncatableString>(4, 'displayName', $pb.PbFieldType.OM, TruncatableString.getDefault, TruncatableString.create)
    ...
    ..a<Span_Attributes>(7, 'attributes', $pb.PbFieldType.OM, Span_Attributes.getDefault, Span_Attributes.create)
    ..a<StackTrace>(8, 'stackTrace', $pb.PbFieldType.OM, StackTrace.getDefault, StackTrace.create)
    ..a<Span_TimeEvents>(9, 'timeEvents', $pb.PbFieldType.OM, Span_TimeEvents.getDefault, Span_TimeEvents.create)
    ..a<Span_Links>(10, 'links', $pb.PbFieldType.OM, Span_Links.getDefault, Span_Links.create)
    ..a<$1.Status>(11, 'status', $pb.PbFieldType.OM, $1.Status.getDefault, $1.Status.create)
    ..a<$2.BoolValue>(12, 'sameProcessAsParentSpan', $pb.PbFieldType.OM, $2.BoolValue.getDefault, $2.BoolValue.create)
    ..a<$2.Int32Value>(13, 'childSpanCount', $pb.PbFieldType.OM, $2.Int32Value.getDefault, $2.Int32Value.create)
    ..hasRequiredFields = false
  ;

  Span() : super();
  Span.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  Span.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  Span clone() => Span()..mergeFromMessage(this);
  Span copyWith(void Function(Span) updates) => super.copyWith((message) => updates(message as Span));
  $pb.BuilderInfo get info_ => _i;
...
class AttributeValue extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('AttributeValue', package: const $pb.PackageName('google.devtools.cloudtrace.v2'))
    ..a<TruncatableString>(1, 'stringValue', $pb.PbFieldType.OM, TruncatableString.getDefault, TruncatableString.create)
    ..aInt64(2, 'intValue')
    ..aOB(3, 'boolValue')
    ..oo(0, [1, 2, 3])
    ..hasRequiredFields = false
  ...
  AttributeValue.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  AttributeValue.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  AttributeValue clone() => AttributeValue()..mergeFromMessage(this);
  AttributeValue copyWith(void Function(AttributeValue) updates) => super.copyWith((message) => updates(message as AttributeValue));
  $pb.BuilderInfo get info_ => _i;
...
class StackTrace_StackFrame extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('StackTrace.StackFrame', package: const $pb.PackageName('google.devtools.cloudtrace.v2'))
    ..a<TruncatableString>(1, 'functionName', $pb.PbFieldType.OM, TruncatableString.getDefault, TruncatableString.create)
    ..a<TruncatableString>(2, 'originalFunctionName', $pb.PbFieldType.OM, TruncatableString.getDefault, TruncatableString.create)
    ..a<TruncatableString>(3, 'fileName', $pb.PbFieldType.OM, TruncatableString.getDefault, TruncatableString.create)
    ..aInt64(4, 'lineNumber')
    ..aInt64(5, 'columnNumber')
    ..a<Module>(6, 'loadModule', $pb.PbFieldType.OM, Module.getDefault, Module.create)
    ..a<TruncatableString>(7, 'sourceVersion', $pb.PbFieldType.OM, TruncatableString.getDefault, TruncatableString.create)
    ..hasRequiredFields = false
  ;

  StackTrace_StackFrame() : super();
  StackTrace_StackFrame.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  StackTrace_StackFrame.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  StackTrace_StackFrame clone() => StackTrace_StackFrame()..mergeFromMessage(this);
  StackTrace_StackFrame copyWith(void Function(StackTrace_StackFrame) updates) => super.copyWith((message) => updates(message as StackTrace_StackFrame));
  $pb.BuilderInfo get info_ => _i;
  ...
  static StackTrace_StackFrame getDefault() => _defaultInstance ??= create()..freeze();
...
class StackTrace_StackFrames extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('StackTrace.StackFrames', package: const $pb.PackageName('google.devtools.cloudtrace.v2'))
    ..pc<StackTrace_StackFrame>(1, 'frame', $pb.PbFieldType.PM,StackTrace_StackFrame.create)
    ..a<$core.int>(2, 'droppedFramesCount', $pb.PbFieldType.O3)
    ..hasRequiredFields = false
  ;

  StackTrace_StackFrames() : super();
  StackTrace_StackFrames.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  StackTrace_StackFrames.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  StackTrace_StackFrames clone() => StackTrace_StackFrames()..mergeFromMessage(this);
  StackTrace_StackFrames copyWith(void Function(StackTrace_StackFrames) updates) => super.copyWith((message) => updates(message as StackTrace_StackFrames));
  $pb.BuilderInfo get info_ => _i;
  ...
  static StackTrace_StackFrames getDefault() => _defaultInstance ??= create()..freeze();
...
class StackTrace extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('StackTrace', package: const $pb.PackageName('google.devtools.cloudtrace.v2'))
    ..a<StackTrace_StackFrames>(1, 'stackFrames', $pb.PbFieldType.OM, StackTrace_StackFrames.getDefault, StackTrace_StackFrames.create)
    ..aInt64(2, 'stackTraceHashId')
    ..hasRequiredFields = false
  ;

  StackTrace() : super();
  StackTrace.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  StackTrace.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  StackTrace clone() => StackTrace()..mergeFromMessage(this);
  StackTrace copyWith(void Function(StackTrace) updates) => super.copyWith((message) => updates(message as StackTrace));
  $pb.BuilderInfo get info_ => _i;
  ...
  set stackTraceHashId(Int64 v) { $_setInt64(1, v); }
  $core.bool hasStackTraceHashId() => $_has(1);
  void clearStackTraceHashId() => clearField(2);
}

class Module extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Module', package: const $pb.PackageName('google.devtools.cloudtrace.v2'))
    ..a<TruncatableString>(1, 'module', $pb.PbFieldType.OM, TruncatableString.getDefault, TruncatableString.create)
    ..a<TruncatableString>(2, 'buildId', $pb.PbFieldType.OM, TruncatableString.getDefault, TruncatableString.create)
    ..hasRequiredFields = false
  ;
...
class TruncatableString extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('TruncatableString', package: const $pb.PackageName('google.devtools.cloudtrace.v2'))
    ..aOS(1, 'value')
  ...
  TruncatableString.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  TruncatableString.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  TruncatableString clone() => TruncatableString()..mergeFromMessage(this);
  TruncatableString copyWith(void Function(TruncatableString) updates) => super.copyWith((message) => updates(message as TruncatableString));
  $pb.BuilderInfo get info_ => _i;
  ...
  static TruncatableString getDefault() => _defaultInstance ??= create()..freeze();
