...
class Span_Attributes_AttributeMapEntry extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('Span_Attributes_AttributeMapEntry')
    ..aOS(1, 'key')
    ..a<AttributeValue>(2, 'value', PbFieldType.OM, AttributeValue.getDefault, AttributeValue.create)
    ..hasRequiredFields = false
  ;

  Span_Attributes_AttributeMapEntry() : super();
  Span_Attributes_AttributeMapEntry.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  Span_Attributes_AttributeMapEntry.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  Span_Attributes_AttributeMapEntry clone() => new Span_Attributes_AttributeMapEntry()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static Span_Attributes_AttributeMapEntry create() => new Span_Attributes_AttributeMapEntry();
  static PbList<Span_Attributes_AttributeMapEntry> createRepeated() => new PbList<Span_Attributes_AttributeMapEntry>();
  static Span_Attributes_AttributeMapEntry getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlySpan_Attributes_AttributeMapEntry();
    return _defaultInstance;
  }
  static Span_Attributes_AttributeMapEntry _defaultInstance;
  static void $checkItem(Span_Attributes_AttributeMapEntry v) {
    if (v is! Span_Attributes_AttributeMapEntry) checkItemFailed(v, 'Span_Attributes_AttributeMapEntry');
  }
  ...
  set value(AttributeValue v) { setField(2, v); }
  bool hasValue() => $_has(1);
  void clearValue() => clearField(2);
}

class _ReadonlySpan_Attributes_AttributeMapEntry extends Span_Attributes_AttributeMapEntry with ReadonlyMessageMixin {}

class Span_Attributes extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('Span_Attributes')
    ..pp<Span_Attributes_AttributeMapEntry>(1, 'attributeMap', PbFieldType.PM, Span_Attributes_AttributeMapEntry.$checkItem, Span_Attributes_AttributeMapEntry.create)
    ..a<int>(2, 'droppedAttributesCount', PbFieldType.O3)
    ..hasRequiredFields = false
  ;

  Span_Attributes() : super();
  Span_Attributes.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  Span_Attributes.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  Span_Attributes clone() => new Span_Attributes()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static Span_Attributes create() => new Span_Attributes();
  static PbList<Span_Attributes> createRepeated() => new PbList<Span_Attributes>();
  static Span_Attributes getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlySpan_Attributes();
    return _defaultInstance;
  }
  ...
  set droppedAttributesCount(int v) { $_setSignedInt32(1, v); }
  bool hasDroppedAttributesCount() => $_has(1);
  void clearDroppedAttributesCount() => clearField(2);
}

class _ReadonlySpan_Attributes extends Span_Attributes with ReadonlyMessageMixin {}
...
class Span_TimeEvent_Annotation extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('Span_TimeEvent_Annotation')
    ..a<TruncatableString>(1, 'description', PbFieldType.OM, TruncatableString.getDefault, TruncatableString.create)
    ..a<Span_Attributes>(2, 'attributes', PbFieldType.OM, Span_Attributes.getDefault, Span_Attributes.create)
    ..hasRequiredFields = false
  ;
...
class Span_TimeEvent_MessageEvent extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('Span_TimeEvent_MessageEvent')
    ..e<Span_TimeEvent_MessageEvent_Type>(1, 'type', PbFieldType.OE, Span_TimeEvent_MessageEvent_Type.TYPE_UNSPECIFIED, Span_TimeEvent_MessageEvent_Type.valueOf, Span_TimeEvent_MessageEvent_Type.values)
    ..aInt64(2, 'id')
  ...
  Span_TimeEvent_MessageEvent.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  Span_TimeEvent_MessageEvent.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  Span_TimeEvent_MessageEvent clone() => new Span_TimeEvent_MessageEvent()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static Span_TimeEvent_MessageEvent create() => new Span_TimeEvent_MessageEvent();
  static PbList<Span_TimeEvent_MessageEvent> createRepeated() => new PbList<Span_TimeEvent_MessageEvent>();
  static Span_TimeEvent_MessageEvent getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlySpan_TimeEvent_MessageEvent();
    return _defaultInstance;
  }
  static Span_TimeEvent_MessageEvent _defaultInstance;
  static void $checkItem(Span_TimeEvent_MessageEvent v) {
    if (v is! Span_TimeEvent_MessageEvent) checkItemFailed(v, 'Span_TimeEvent_MessageEvent');
  }
...
class _ReadonlySpan_TimeEvent_MessageEvent extends Span_TimeEvent_MessageEvent with ReadonlyMessageMixin {}
...
class Span_TimeEvent extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('Span_TimeEvent')
    ...
    ..a<Span_TimeEvent_MessageEvent>(3, 'messageEvent', PbFieldType.OM, Span_TimeEvent_MessageEvent.getDefault, Span_TimeEvent_MessageEvent.create)
    ..hasRequiredFields = false
  ;
  ...
  set time($google$protobuf.Timestamp v) { setField(1, v); }
  bool hasTime() => $_has(0);
...
class Span_TimeEvents extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('Span_TimeEvents')
    ..pp<Span_TimeEvent>(1, 'timeEvent', PbFieldType.PM, Span_TimeEvent.$checkItem, Span_TimeEvent.create)
  ...
  Span_TimeEvents.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  Span_TimeEvents.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  Span_TimeEvents clone() => new Span_TimeEvents()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static Span_TimeEvents create() => new Span_TimeEvents();
  static PbList<Span_TimeEvents> createRepeated() => new PbList<Span_TimeEvents>();
  static Span_TimeEvents getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlySpan_TimeEvents();
    return _defaultInstance;
  }
  ...
  set droppedAnnotationsCount(int v) { $_setSignedInt32(1, v); }
  ...
  set droppedMessageEventsCount(int v) { $_setSignedInt32(2, v); }
  bool hasDroppedMessageEventsCount() => $_has(2);
  void clearDroppedMessageEventsCount() => clearField(3);
}

class _ReadonlySpan_TimeEvents extends Span_TimeEvents with ReadonlyMessageMixin {}

class Span_Link extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('Span_Link')
    ..aOS(1, 'traceId')
    ..aOS(2, 'spanId')
    ..e<Span_Link_Type>(3, 'type', PbFieldType.OE, Span_Link_Type.TYPE_UNSPECIFIED, Span_Link_Type.valueOf, Span_Link_Type.values)
    ..a<Span_Attributes>(4, 'attributes', PbFieldType.OM, Span_Attributes.getDefault, Span_Attributes.create)
    ..hasRequiredFields = false
  ;
...
class Span_Links extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('Span_Links')
    ..pp<Span_Link>(1, 'link', PbFieldType.PM, Span_Link.$checkItem, Span_Link.create)
    ..a<int>(2, 'droppedLinksCount', PbFieldType.O3)
    ..hasRequiredFields = false
  ;

  Span_Links() : super();
  Span_Links.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  Span_Links.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ...
  set droppedLinksCount(int v) { $_setSignedInt32(1, v); }
...
class Span extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('Span')
    ...
    ..aOS(2, 'spanId')
    ..aOS(3, 'parentSpanId')
    ..a<TruncatableString>(4, 'displayName', PbFieldType.OM, TruncatableString.getDefault, TruncatableString.create)
    ...
    ..a<Span_Attributes>(7, 'attributes', PbFieldType.OM, Span_Attributes.getDefault, Span_Attributes.create)
    ..a<StackTrace>(8, 'stackTrace', PbFieldType.OM, StackTrace.getDefault, StackTrace.create)
    ..a<Span_TimeEvents>(9, 'timeEvents', PbFieldType.OM, Span_TimeEvents.getDefault, Span_TimeEvents.create)
    ..a<Span_Links>(10, 'links', PbFieldType.OM, Span_Links.getDefault, Span_Links.create)
    ..a<$google$rpc.Status>(11, 'status', PbFieldType.OM, $google$rpc.Status.getDefault, $google$rpc.Status.create)
    ..a<$google$protobuf.BoolValue>(12, 'sameProcessAsParentSpan', PbFieldType.OM, $google$protobuf.BoolValue.getDefault, $google$protobuf.BoolValue.create)
    ..a<$google$protobuf.Int32Value>(13, 'childSpanCount', PbFieldType.OM, $google$protobuf.Int32Value.getDefault, $google$protobuf.Int32Value.create)
    ..hasRequiredFields = false
  ;
  ...
  set parentSpanId(String v) { $_setString(2, v); }
  ...
  set status($google$rpc.Status v) { setField(11, v); }
  bool hasStatus() => $_has(10);
  void clearStatus() => clearField(11);

  $google$protobuf.BoolValue get sameProcessAsParentSpan => $_getN(11);
  set sameProcessAsParentSpan($google$protobuf.BoolValue v) { setField(12, v); }
  ...
  set childSpanCount($google$protobuf.Int32Value v) { setField(13, v); }
...
class AttributeValue extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('AttributeValue')
    ..a<TruncatableString>(1, 'stringValue', PbFieldType.OM, TruncatableString.getDefault, TruncatableString.create)
    ..aInt64(2, 'intValue')
    ..aOB(3, 'boolValue')
    ..hasRequiredFields = false
  ;
  ...
  AttributeValue.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  AttributeValue.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  AttributeValue clone() => new AttributeValue()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static AttributeValue create() => new AttributeValue();
  static PbList<AttributeValue> createRepeated() => new PbList<AttributeValue>();
  static AttributeValue getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyAttributeValue();
    return _defaultInstance;
  }
  ...
  set boolValue(bool v) { $_setBool(2, v); }
...
class StackTrace_StackFrame extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('StackTrace_StackFrame')
    ..a<TruncatableString>(1, 'functionName', PbFieldType.OM, TruncatableString.getDefault, TruncatableString.create)
    ..a<TruncatableString>(2, 'originalFunctionName', PbFieldType.OM, TruncatableString.getDefault, TruncatableString.create)
    ..a<TruncatableString>(3, 'fileName', PbFieldType.OM, TruncatableString.getDefault, TruncatableString.create)
    ..aInt64(4, 'lineNumber')
    ..aInt64(5, 'columnNumber')
    ..a<Module>(6, 'loadModule', PbFieldType.OM, Module.getDefault, Module.create)
    ..a<TruncatableString>(7, 'sourceVersion', PbFieldType.OM, TruncatableString.getDefault, TruncatableString.create)
    ..hasRequiredFields = false
  ;
...
class StackTrace_StackFrames extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('StackTrace_StackFrames')
    ..pp<StackTrace_StackFrame>(1, 'frame', PbFieldType.PM, StackTrace_StackFrame.$checkItem, StackTrace_StackFrame.create)
    ..a<int>(2, 'droppedFramesCount', PbFieldType.O3)
    ..hasRequiredFields = false
  ;

  StackTrace_StackFrames() : super();
  StackTrace_StackFrames.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  StackTrace_StackFrames.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  StackTrace_StackFrames clone() => new StackTrace_StackFrames()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static StackTrace_StackFrames create() => new StackTrace_StackFrames();
  static PbList<StackTrace_StackFrames> createRepeated() => new PbList<StackTrace_StackFrames>();
  static StackTrace_StackFrames getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyStackTrace_StackFrames();
    return _defaultInstance;
  }
  static StackTrace_StackFrames _defaultInstance;
  static void $checkItem(StackTrace_StackFrames v) {
    if (v is! StackTrace_StackFrames) checkItemFailed(v, 'StackTrace_StackFrames');
  }

  List<StackTrace_StackFrame> get frame => $_getList(0);

  int get droppedFramesCount => $_get(1, 0);
  set droppedFramesCount(int v) { $_setSignedInt32(1, v); }
  bool hasDroppedFramesCount() => $_has(1);
  void clearDroppedFramesCount() => clearField(2);
}

class _ReadonlyStackTrace_StackFrames extends StackTrace_StackFrames with ReadonlyMessageMixin {}

class StackTrace extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('StackTrace')
    ..a<StackTrace_StackFrames>(1, 'stackFrames', PbFieldType.OM, StackTrace_StackFrames.getDefault, StackTrace_StackFrames.create)
...
class Module extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('Module')
    ..a<TruncatableString>(1, 'module', PbFieldType.OM, TruncatableString.getDefault, TruncatableString.create)
    ..a<TruncatableString>(2, 'buildId', PbFieldType.OM, TruncatableString.getDefault, TruncatableString.create)
    ..hasRequiredFields = false
  ;
...
class TruncatableString extends GeneratedMessage {
  ...
  TruncatableString.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  TruncatableString.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  TruncatableString clone() => new TruncatableString()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static TruncatableString create() => new TruncatableString();
  static PbList<TruncatableString> createRepeated() => new PbList<TruncatableString>();
  static TruncatableString getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyTruncatableString();
    return _defaultInstance;
  }
  ...
  set truncatedByteCount(int v) { $_setSignedInt32(1, v); }
  bool hasTruncatedByteCount() => $_has(1);
  void clearTruncatedByteCount() => clearField(2);
}

class _ReadonlyTruncatableString extends TruncatableString with ReadonlyMessageMixin {}
