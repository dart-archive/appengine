...
class CreateProfileRequest extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('CreateProfileRequest')
    ..a<Deployment>(1, 'deployment', PbFieldType.OM, Deployment.getDefault, Deployment.create)
    ..pp<ProfileType>(2, 'profileType', PbFieldType.PE, ProfileType.$checkItem, null, ProfileType.valueOf, ProfileType.values)
    ..a<Profile>(3, 'profile', PbFieldType.OM, Profile.getDefault, Profile.create)
    ..hasRequiredFields = false
  ;

  CreateProfileRequest() : super();
  CreateProfileRequest.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  CreateProfileRequest.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ...
  static PbList<CreateProfileRequest> createRepeated() => new PbList<CreateProfileRequest>();
  static CreateProfileRequest getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyCreateProfileRequest();
  ...
  set profile(Profile v) { setField(3, v); }
  bool hasProfile() => $_has(2);
  void clearProfile() => clearField(3);
}

class _ReadonlyCreateProfileRequest extends CreateProfileRequest with ReadonlyMessageMixin {}

class UpdateProfileRequest extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('UpdateProfileRequest')
    ..a<Profile>(1, 'profile', PbFieldType.OM, Profile.getDefault, Profile.create)
    ..hasRequiredFields = false
  ;

  UpdateProfileRequest() : super();
  UpdateProfileRequest.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  UpdateProfileRequest.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  UpdateProfileRequest clone() => new UpdateProfileRequest()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static UpdateProfileRequest create() => new UpdateProfileRequest();
  static PbList<UpdateProfileRequest> createRepeated() => new PbList<UpdateProfileRequest>();
  static UpdateProfileRequest getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyUpdateProfileRequest();
    return _defaultInstance;
  }
...
class _ReadonlyUpdateProfileRequest extends UpdateProfileRequest with ReadonlyMessageMixin {}
...
class Profile_LabelsEntry extends GeneratedMessage {
  ...
  Profile_LabelsEntry.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  Profile_LabelsEntry.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  Profile_LabelsEntry clone() => new Profile_LabelsEntry()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static Profile_LabelsEntry create() => new Profile_LabelsEntry();
  static PbList<Profile_LabelsEntry> createRepeated() => new PbList<Profile_LabelsEntry>();
  static Profile_LabelsEntry getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyProfile_LabelsEntry();
    return _defaultInstance;
  }
...
class _ReadonlyProfile_LabelsEntry extends Profile_LabelsEntry with ReadonlyMessageMixin {}

class Profile extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('Profile')
    ..aOS(1, 'name')
    ..e<ProfileType>(2, 'profileType', PbFieldType.OE, ProfileType.PROFILE_TYPE_UNSPECIFIED, ProfileType.valueOf, ProfileType.values)
    ..a<Deployment>(3, 'deployment', PbFieldType.OM, Deployment.getDefault, Deployment.create)
    ..a<$google$protobuf.Duration>(4, 'duration', PbFieldType.OM, $google$protobuf.Duration.getDefault, $google$protobuf.Duration.create)
    ..a<List<int>>(5, 'profileBytes', PbFieldType.OY)
    ..pp<Profile_LabelsEntry>(6, 'labels', PbFieldType.PM, Profile_LabelsEntry.$checkItem, Profile_LabelsEntry.create)
    ..hasRequiredFields = false
  ;

  Profile() : super();
  Profile.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  Profile.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ...
  set duration($google$protobuf.Duration v) { setField(4, v); }
  bool hasDuration() => $_has(3);
  void clearDuration() => clearField(4);

  List<int> get profileBytes => $_getN(4);
  set profileBytes(List<int> v) { $_setBytes(4, v); }
...
class Deployment_LabelsEntry extends GeneratedMessage {
  ...
  Deployment_LabelsEntry.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  Deployment_LabelsEntry.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  Deployment_LabelsEntry clone() => new Deployment_LabelsEntry()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static Deployment_LabelsEntry create() => new Deployment_LabelsEntry();
  static PbList<Deployment_LabelsEntry> createRepeated() => new PbList<Deployment_LabelsEntry>();
  static Deployment_LabelsEntry getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyDeployment_LabelsEntry();
    return _defaultInstance;
  }
  static Deployment_LabelsEntry _defaultInstance;
  static void $checkItem(Deployment_LabelsEntry v) {
    if (v is! Deployment_LabelsEntry) checkItemFailed(v, 'Deployment_LabelsEntry');
  }
...
class _ReadonlyDeployment_LabelsEntry extends Deployment_LabelsEntry with ReadonlyMessageMixin {}

class Deployment extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('Deployment')
    ..aOS(1, 'projectId')
    ..aOS(2, 'target')
    ..pp<Deployment_LabelsEntry>(3, 'labels', PbFieldType.PM, Deployment_LabelsEntry.$checkItem, Deployment_LabelsEntry.create)
    ..hasRequiredFields = false
  ;
...
class ProfilerServiceApi {
  ...
  Future<Profile> createProfile(ClientContext ctx, CreateProfileRequest request) {
    var emptyResponse = new Profile();
    return _client.invoke<Profile>(ctx, 'ProfilerService', 'CreateProfile', request, emptyResponse);
  }
  Future<Profile> updateProfile(ClientContext ctx, UpdateProfileRequest request) {
    var emptyResponse = new Profile();
