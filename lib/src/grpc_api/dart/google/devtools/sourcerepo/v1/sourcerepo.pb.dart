...
class Repo extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('Repo')
    ...
    ..aInt64(2, 'size')
    ..aOS(3, 'url')
    ..a<MirrorConfig>(4, 'mirrorConfig', PbFieldType.OM, MirrorConfig.getDefault, MirrorConfig.create)
    ..hasRequiredFields = false
  ;

  Repo() : super();
  Repo.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  Repo.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
...
class MirrorConfig extends GeneratedMessage {
  ...
  MirrorConfig() : super();
  MirrorConfig.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  MirrorConfig.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ...
  static MirrorConfig getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyMirrorConfig();
    return _defaultInstance;
  }
...
class GetRepoRequest extends GeneratedMessage {
  ...
  GetRepoRequest.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  GetRepoRequest.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  GetRepoRequest clone() => new GetRepoRequest()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static GetRepoRequest create() => new GetRepoRequest();
  static PbList<GetRepoRequest> createRepeated() => new PbList<GetRepoRequest>();
  static GetRepoRequest getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyGetRepoRequest();
    return _defaultInstance;
  }
...
class ListReposRequest extends GeneratedMessage {
  ...
  ListReposRequest.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  ListReposRequest.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ListReposRequest clone() => new ListReposRequest()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static ListReposRequest create() => new ListReposRequest();
  static PbList<ListReposRequest> createRepeated() => new PbList<ListReposRequest>();
  static ListReposRequest getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyListReposRequest();
    return _defaultInstance;
  }
...
class _ReadonlyListReposRequest extends ListReposRequest with ReadonlyMessageMixin {}
...
class ListReposResponse extends GeneratedMessage {
  ...
  ListReposResponse.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  ListReposResponse.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ListReposResponse clone() => new ListReposResponse()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static ListReposResponse create() => new ListReposResponse();
  static PbList<ListReposResponse> createRepeated() => new PbList<ListReposResponse>();
  static ListReposResponse getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyListReposResponse();
    return _defaultInstance;
  }
...
class _ReadonlyListReposResponse extends ListReposResponse with ReadonlyMessageMixin {}
...
class CreateRepoRequest extends GeneratedMessage {
  ...
  CreateRepoRequest.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  CreateRepoRequest.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  CreateRepoRequest clone() => new CreateRepoRequest()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static CreateRepoRequest create() => new CreateRepoRequest();
  static PbList<CreateRepoRequest> createRepeated() => new PbList<CreateRepoRequest>();
  static CreateRepoRequest getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyCreateRepoRequest();
    return _defaultInstance;
  }
...
class _ReadonlyCreateRepoRequest extends CreateRepoRequest with ReadonlyMessageMixin {}
...
class DeleteRepoRequest extends GeneratedMessage {
  ...
  DeleteRepoRequest.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  DeleteRepoRequest.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  DeleteRepoRequest clone() => new DeleteRepoRequest()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static DeleteRepoRequest create() => new DeleteRepoRequest();
  static PbList<DeleteRepoRequest> createRepeated() => new PbList<DeleteRepoRequest>();
  static DeleteRepoRequest getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyDeleteRepoRequest();
    return _defaultInstance;
  }
...
class _ReadonlyDeleteRepoRequest extends DeleteRepoRequest with ReadonlyMessageMixin {}

class SourceRepoApi {
  RpcClient _client;
  SourceRepoApi(this._client);

  Future<ListReposResponse> listRepos(ClientContext ctx, ListReposRequest request) {
  ...
  Future<$google$protobuf.Empty> deleteRepo(ClientContext ctx, DeleteRepoRequest request) {
    var emptyResponse = new $google$protobuf.Empty();
    return _client.invoke<$google$protobuf.Empty>(ctx, 'SourceRepo', 'DeleteRepo', request, emptyResponse);
  }
  Future<$google$iam$v1.Policy> setIamPolicy(ClientContext ctx, $google$iam$v1.SetIamPolicyRequest request) {
    ...
    return _client.invoke<$google$iam$v1.Policy>(ctx, 'SourceRepo', 'SetIamPolicy', request, emptyResponse);
  }
  Future<$google$iam$v1.Policy> getIamPolicy(ClientContext ctx, $google$iam$v1.GetIamPolicyRequest request) {
    var emptyResponse = new $google$iam$v1.Policy();
    return _client.invoke<$google$iam$v1.Policy>(ctx, 'SourceRepo', 'GetIamPolicy', request, emptyResponse);
  }
  Future<$google$iam$v1.TestIamPermissionsResponse> testIamPermissions(ClientContext ctx, $google$iam$v1.TestIamPermissionsRequest request) {
    ...
    return _client.invoke<$google$iam$v1.TestIamPermissionsResponse>(ctx, 'SourceRepo', 'TestIamPermissions', request, emptyResponse);
  }
}
