...
abstract class SourceRepoServiceBase extends $pb.GeneratedService {
  $async.Future<ListReposResponse> listRepos($pb.ServerContext ctx, ListReposRequest request);
  $async.Future<Repo> getRepo($pb.ServerContext ctx, GetRepoRequest request);
  $async.Future<Repo> createRepo($pb.ServerContext ctx, CreateRepoRequest request);
  $async.Future<$0.Empty> deleteRepo($pb.ServerContext ctx, DeleteRepoRequest request);
  ...
  $pb.GeneratedMessage createRequest($core.String method) {
    switch (method) {
      case 'ListRepos': return ListReposRequest();
      case 'GetRepo': return GetRepoRequest();
      case 'CreateRepo': return CreateRepoRequest();
      case 'DeleteRepo': return DeleteRepoRequest();
  ...
  $async.Future<$pb.GeneratedMessage> handleCall($pb.ServerContext ctx, $core.String method, $pb.GeneratedMessage request) {
    switch (method) {
      case 'ListRepos': return this.listRepos(ctx, request);
      case 'GetRepo': return this.getRepo(ctx, request);
      case 'CreateRepo': return this.createRepo(ctx, request);
      case 'DeleteRepo': return this.deleteRepo(ctx, request);
  ...
  $core.Map<$core.String, $core.dynamic> get $json => SourceRepoServiceBase$json;
  $core.Map<$core.String, $core.Map<$core.String, $core.dynamic>> get $messageJson => SourceRepoServiceBase$messageJson;
}
