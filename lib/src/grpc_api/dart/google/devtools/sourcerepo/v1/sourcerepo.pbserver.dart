...
abstract class SourceRepoServiceBase extends GeneratedService {
  Future<ListReposResponse> listRepos(ServerContext ctx, ListReposRequest request);
  ...
  Future<$google$protobuf.Empty> deleteRepo(ServerContext ctx, DeleteRepoRequest request);
  ...
  GeneratedMessage createRequest(String method) {
    switch (method) {
      case 'ListRepos': return new ListReposRequest();
      case 'GetRepo': return new GetRepoRequest();
      case 'CreateRepo': return new CreateRepoRequest();
      case 'DeleteRepo': return new DeleteRepoRequest();
