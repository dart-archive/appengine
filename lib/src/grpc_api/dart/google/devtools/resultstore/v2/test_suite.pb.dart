...
class TestSuite extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('TestSuite', package: const $pb.PackageName('google.devtools.resultstore.v2'))
    ..aOS(1, 'suiteName')
    ...
    ..a<$0.Timing>(6, 'timing', $pb.PbFieldType.OM, $0.Timing.getDefault, $0.Timing.create)
...
class Test extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Test', package: const $pb.PackageName('google.devtools.resultstore.v2'))
    ..a<TestCase>(1, 'testCase', $pb.PbFieldType.OM, TestCase.getDefault, TestCase.create)
    ..a<TestSuite>(2, 'testSuite', $pb.PbFieldType.OM, TestSuite.getDefault, TestSuite.create)
    ..oo(0, [1, 2])
    ..hasRequiredFields = false
  ;

  Test() : super();
  Test.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  Test.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
...
class TestCase extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('TestCase', package: const $pb.PackageName('google.devtools.resultstore.v2'))
    ..aOS(1, 'caseName')
    ..aOS(2, 'className')
    ..e<TestCase_Result>(3, 'result', $pb.PbFieldType.OE, TestCase_Result.RESULT_UNSPECIFIED, TestCase_Result.valueOf, TestCase_Result.values)
    ..pc<TestFailure>(4, 'failures', $pb.PbFieldType.PM,TestFailure.create)
    ..pc<TestError>(5, 'errors', $pb.PbFieldType.PM,TestError.create)
    ..a<$0.Timing>(7, 'timing', $pb.PbFieldType.OM, $0.Timing.getDefault, $0.Timing.create)
  ...
  TestCase() : super();
  TestCase.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  TestCase.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
...
class TestFailure extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('TestFailure', package: const $pb.PackageName('google.devtools.resultstore.v2'))
  ...
  TestFailure() : super();
  TestFailure.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  TestFailure.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  TestFailure clone() => TestFailure()..mergeFromMessage(this);
  TestFailure copyWith(void Function(TestFailure) updates) => super.copyWith((message) => updates(message as TestFailure));
  $pb.BuilderInfo get info_ => _i;
...
class TestError extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('TestError', package: const $pb.PackageName('google.devtools.resultstore.v2'))
    ..aOS(1, 'errorMessage')
    ..aOS(2, 'exceptionType')
    ..aOS(3, 'stackTrace')
    ..hasRequiredFields = false
  ...
  TestError() : super();
  TestError.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  TestError.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
