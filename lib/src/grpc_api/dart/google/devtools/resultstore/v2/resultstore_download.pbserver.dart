...
abstract class ResultStoreDownloadServiceBase extends $pb.GeneratedService {
  $async.Future<$0.Invocation> getInvocation(
      $pb.ServerContext ctx, GetInvocationRequest request);
  $async.Future<SearchInvocationsResponse> searchInvocations(
      $pb.ServerContext ctx, SearchInvocationsRequest request);
  $async.Future<$1.Configuration> getConfiguration(
      $pb.ServerContext ctx, GetConfigurationRequest request);
  $async.Future<ListConfigurationsResponse> listConfigurations(
      $pb.ServerContext ctx, ListConfigurationsRequest request);
  $async.Future<$2.Target> getTarget(
      $pb.ServerContext ctx, GetTargetRequest request);
  $async.Future<ListTargetsResponse> listTargets(
      $pb.ServerContext ctx, ListTargetsRequest request);
  $async.Future<$3.ConfiguredTarget> getConfiguredTarget(
      $pb.ServerContext ctx, GetConfiguredTargetRequest request);
  $async.Future<ListConfiguredTargetsResponse> listConfiguredTargets(
      $pb.ServerContext ctx, ListConfiguredTargetsRequest request);
  $async.Future<$4.Action> getAction(
      $pb.ServerContext ctx, GetActionRequest request);
  $async.Future<ListActionsResponse> listActions(
      $pb.ServerContext ctx, ListActionsRequest request);
  $async.Future<$5.FileSet> getFileSet(
      $pb.ServerContext ctx, GetFileSetRequest request);
  $async.Future<ListFileSetsResponse> listFileSets(
      $pb.ServerContext ctx, ListFileSetsRequest request);
  ...
  $pb.GeneratedMessage createRequest($core.String method) {
    switch (method) {
      ...
      case 'SearchInvocations':
        return SearchInvocationsRequest();
      ...
      case 'GetConfiguredTarget':
        return GetConfiguredTargetRequest();
      case 'ListConfiguredTargets':
        return ListConfiguredTargetsRequest();
      case 'GetAction':
        return GetActionRequest();
      case 'ListActions':
        return ListActionsRequest();
      case 'GetFileSet':
        return GetFileSetRequest();
      case 'ListFileSets':
        return ListFileSetsRequest();
      default:
  ...
  $async.Future<$pb.GeneratedMessage> handleCall($pb.ServerContext ctx,
    ...
    switch (method) {
      case 'GetInvocation':
        return this.getInvocation(ctx, request);
      case 'SearchInvocations':
        return this.searchInvocations(ctx, request);
      case 'GetConfiguration':
        return this.getConfiguration(ctx, request);
      case 'ListConfigurations':
        return this.listConfigurations(ctx, request);
      case 'GetTarget':
        return this.getTarget(ctx, request);
      case 'ListTargets':
        return this.listTargets(ctx, request);
      case 'GetConfiguredTarget':
        return this.getConfiguredTarget(ctx, request);
      case 'ListConfiguredTargets':
        return this.listConfiguredTargets(ctx, request);
      case 'GetAction':
        return this.getAction(ctx, request);
      case 'ListActions':
        return this.listActions(ctx, request);
      case 'GetFileSet':
        return this.getFileSet(ctx, request);
      case 'ListFileSets':
        return this.listFileSets(ctx, request);
      default:
        throw $core.ArgumentError('Unknown method: $method');
    }
  }
  ...
  $core.Map<$core.String, $core.dynamic> get $json =>
      ResultStoreDownloadServiceBase$json;
  $core.Map<$core.String, $core.Map<$core.String, $core.dynamic>>
      get $messageJson => ResultStoreDownloadServiceBase$messageJson;
}
