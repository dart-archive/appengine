...
class TestCase_Result extends $pb.ProtobufEnum {
  static const TestCase_Result RESULT_UNSPECIFIED = TestCase_Result._(0, 'RESULT_UNSPECIFIED');
  static const TestCase_Result COMPLETED = TestCase_Result._(1, 'COMPLETED');
  static const TestCase_Result INTERRUPTED = TestCase_Result._(2, 'INTERRUPTED');
