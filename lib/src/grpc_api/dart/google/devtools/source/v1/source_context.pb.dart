...
class SourceContext extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('SourceContext', package: const $pb.PackageName('google.devtools.source.v1'))
    ..a<CloudRepoSourceContext>(1, 'cloudRepo', $pb.PbFieldType.OM, CloudRepoSourceContext.getDefault, CloudRepoSourceContext.create)
    ..a<CloudWorkspaceSourceContext>(2, 'cloudWorkspace', $pb.PbFieldType.OM, CloudWorkspaceSourceContext.getDefault, CloudWorkspaceSourceContext.create)
    ..a<GerritSourceContext>(3, 'gerrit', $pb.PbFieldType.OM, GerritSourceContext.getDefault, GerritSourceContext.create)
    ..a<GitSourceContext>(6, 'git', $pb.PbFieldType.OM, GitSourceContext.getDefault, GitSourceContext.create)
    ..oo(0, [1, 2, 3, 6])
...
class ExtendedSourceContext extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ExtendedSourceContext', package: const $pb.PackageName('google.devtools.source.v1'))
    ..a<SourceContext>(1, 'context', $pb.PbFieldType.OM, SourceContext.getDefault, SourceContext.create)
    ..m<$core.String, $core.String>(2, 'labels', 'ExtendedSourceContext.LabelsEntry',$pb.PbFieldType.OS, $pb.PbFieldType.OS, null, null, null , const $pb.PackageName('google.devtools.source.v1'))
    ..hasRequiredFields = false
  ;

  ExtendedSourceContext() : super();
  ExtendedSourceContext.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  ExtendedSourceContext.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ExtendedSourceContext clone() => ExtendedSourceContext()..mergeFromMessage(this);
  ExtendedSourceContext copyWith(void Function(ExtendedSourceContext) updates) => super.copyWith((message) => updates(message as ExtendedSourceContext));
  $pb.BuilderInfo get info_ => _i;
  ...
  static ExtendedSourceContext getDefault() => _defaultInstance ??= create()..freeze();
...
class AliasContext extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('AliasContext', package: const $pb.PackageName('google.devtools.source.v1'))
    ..e<AliasContext_Kind>(1, 'kind', $pb.PbFieldType.OE, AliasContext_Kind.ANY, AliasContext_Kind.valueOf, AliasContext_Kind.values)
    ..aOS(2, 'name')
    ..hasRequiredFields = false
  ;
...
class CloudRepoSourceContext extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('CloudRepoSourceContext', package: const $pb.PackageName('google.devtools.source.v1'))
...
class CloudWorkspaceSourceContext extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('CloudWorkspaceSourceContext', package: const $pb.PackageName('google.devtools.source.v1'))
    ..a<CloudWorkspaceId>(1, 'workspaceId', $pb.PbFieldType.OM, CloudWorkspaceId.getDefault, CloudWorkspaceId.create)
    ..aOS(2, 'snapshotId')
    ..hasRequiredFields = false
  ;

  CloudWorkspaceSourceContext() : super();
  CloudWorkspaceSourceContext.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  CloudWorkspaceSourceContext.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  CloudWorkspaceSourceContext clone() => CloudWorkspaceSourceContext()..mergeFromMessage(this);
  CloudWorkspaceSourceContext copyWith(void Function(CloudWorkspaceSourceContext) updates) => super.copyWith((message) => updates(message as CloudWorkspaceSourceContext));
  $pb.BuilderInfo get info_ => _i;
  ...
  static CloudWorkspaceSourceContext getDefault() => _defaultInstance ??= create()..freeze();
...
class GerritSourceContext extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('GerritSourceContext', package: const $pb.PackageName('google.devtools.source.v1'))
    ..aOS(1, 'hostUri')
    ..aOS(2, 'gerritProject')
    ..aOS(3, 'revisionId')
    ..aOS(4, 'aliasName')
    ..a<AliasContext>(5, 'aliasContext', $pb.PbFieldType.OM, AliasContext.getDefault, AliasContext.create)
    ..oo(0, [3, 4, 5])
    ..hasRequiredFields = false
  ;
...
class GitSourceContext extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('GitSourceContext', package: const $pb.PackageName('google.devtools.source.v1'))
    ..aOS(1, 'url')
    ..aOS(2, 'revisionId')
    ..hasRequiredFields = false
  ;
...
class RepoId extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('RepoId', package: const $pb.PackageName('google.devtools.source.v1'))
...
class ProjectRepoId extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ProjectRepoId', package: const $pb.PackageName('google.devtools.source.v1'))
    ..aOS(1, 'projectId')
    ..aOS(2, 'repoName')
    ..hasRequiredFields = false
  ;
...
class CloudWorkspaceId extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('CloudWorkspaceId', package: const $pb.PackageName('google.devtools.source.v1'))
    ..a<RepoId>(1, 'repoId', $pb.PbFieldType.OM, RepoId.getDefault, RepoId.create)
    ..aOS(2, 'name')
    ..hasRequiredFields = false
  ;
  ...
  CloudWorkspaceId.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  CloudWorkspaceId.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  CloudWorkspaceId clone() => CloudWorkspaceId()..mergeFromMessage(this);
  CloudWorkspaceId copyWith(void Function(CloudWorkspaceId) updates) => super.copyWith((message) => updates(message as CloudWorkspaceId));
  $pb.BuilderInfo get info_ => _i;
  ...
  static CloudWorkspaceId getDefault() => _defaultInstance ??= create()..freeze();
