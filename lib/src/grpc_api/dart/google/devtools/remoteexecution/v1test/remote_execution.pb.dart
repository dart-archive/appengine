...
class Action extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('Action')
    ..a<Digest>(1, 'commandDigest', PbFieldType.OM, Digest.getDefault, Digest.create)
    ..a<Digest>(2, 'inputRootDigest', PbFieldType.OM, Digest.getDefault, Digest.create)
    ..pPS(3, 'outputFiles')
    ..pPS(4, 'outputDirectories')
    ..a<Platform>(5, 'platform', PbFieldType.OM, Platform.getDefault, Platform.create)
    ..a<$google$protobuf.Duration>(6, 'timeout', PbFieldType.OM, $google$protobuf.Duration.getDefault, $google$protobuf.Duration.create)
    ..aOB(7, 'doNotCache')
  ...
  set timeout($google$protobuf.Duration v) { setField(6, v); }
  bool hasTimeout() => $_has(5);
  void clearTimeout() => clearField(6);

  bool get doNotCache => $_get(6, false);
  set doNotCache(bool v) { $_setBool(6, v); }
...
class Command_EnvironmentVariable extends GeneratedMessage {
  ...
  Command_EnvironmentVariable.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  Command_EnvironmentVariable.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  Command_EnvironmentVariable clone() => new Command_EnvironmentVariable()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static Command_EnvironmentVariable create() => new Command_EnvironmentVariable();
  static PbList<Command_EnvironmentVariable> createRepeated() => new PbList<Command_EnvironmentVariable>();
  static Command_EnvironmentVariable getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyCommand_EnvironmentVariable();
    return _defaultInstance;
  }
  static Command_EnvironmentVariable _defaultInstance;
  static void $checkItem(Command_EnvironmentVariable v) {
    if (v is! Command_EnvironmentVariable) checkItemFailed(v, 'Command_EnvironmentVariable');
  }
...
class _ReadonlyCommand_EnvironmentVariable extends Command_EnvironmentVariable with ReadonlyMessageMixin {}

class Command extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('Command')
    ..pPS(1, 'arguments')
    ..pp<Command_EnvironmentVariable>(2, 'environmentVariables', PbFieldType.PM, Command_EnvironmentVariable.$checkItem, Command_EnvironmentVariable.create)
    ..hasRequiredFields = false
  ;
...
class Platform_Property extends GeneratedMessage {
  ...
  Platform_Property.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  Platform_Property.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  Platform_Property clone() => new Platform_Property()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static Platform_Property create() => new Platform_Property();
  static PbList<Platform_Property> createRepeated() => new PbList<Platform_Property>();
  static Platform_Property getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyPlatform_Property();
    return _defaultInstance;
  }
...
class _ReadonlyPlatform_Property extends Platform_Property with ReadonlyMessageMixin {}

class Platform extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('Platform')
    ..pp<Platform_Property>(1, 'properties', PbFieldType.PM, Platform_Property.$checkItem, Platform_Property.create)
    ..hasRequiredFields = false
  ;

  Platform() : super();
  Platform.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  Platform.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
...
class Directory extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('Directory')
    ..pp<FileNode>(1, 'files', PbFieldType.PM, FileNode.$checkItem, FileNode.create)
    ..pp<DirectoryNode>(2, 'directories', PbFieldType.PM, DirectoryNode.$checkItem, DirectoryNode.create)
    ..hasRequiredFields = false
  ;

  Directory() : super();
  Directory.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  Directory.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
...
class FileNode extends GeneratedMessage {
  ...
  FileNode() : super();
  FileNode.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  FileNode.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ...
  set isExecutable(bool v) { $_setBool(2, v); }
...
class DirectoryNode extends GeneratedMessage {
  ...
  DirectoryNode() : super();
  DirectoryNode.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  DirectoryNode.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ...
  static DirectoryNode getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyDirectoryNode();
    return _defaultInstance;
  }
...
class Digest extends GeneratedMessage {
  ...
  Digest() : super();
  Digest.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  Digest.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ...
  set hash(String v) { $_setString(0, v); }
  bool hasHash() => $_has(0);
...
class ActionResult extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('ActionResult')
    ..pp<OutputFile>(2, 'outputFiles', PbFieldType.PM, OutputFile.$checkItem, OutputFile.create)
    ..pp<OutputDirectory>(3, 'outputDirectories', PbFieldType.PM, OutputDirectory.$checkItem, OutputDirectory.create)
    ..a<int>(4, 'exitCode', PbFieldType.O3)
    ..a<List<int>>(5, 'stdoutRaw', PbFieldType.OY)
    ..a<Digest>(6, 'stdoutDigest', PbFieldType.OM, Digest.getDefault, Digest.create)
    ..a<List<int>>(7, 'stderrRaw', PbFieldType.OY)
    ..a<Digest>(8, 'stderrDigest', PbFieldType.OM, Digest.getDefault, Digest.create)
    ..hasRequiredFields = false
  ;

  ActionResult() : super();
  ActionResult.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  ActionResult.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ...
  static ActionResult getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyActionResult();
    return _defaultInstance;
  }
  ...
  set stderrRaw(List<int> v) { $_setBytes(5, v); }
...
class OutputFile extends GeneratedMessage {
  ...
  OutputFile() : super();
  OutputFile.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  OutputFile.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ...
  set content(List<int> v) { $_setBytes(2, v); }
  bool hasContent() => $_has(2);
  void clearContent() => clearField(3);

  bool get isExecutable => $_get(3, false);
  set isExecutable(bool v) { $_setBool(3, v); }
...
class Tree extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('Tree')
    ..a<Directory>(1, 'root', PbFieldType.OM, Directory.getDefault, Directory.create)
    ..pp<Directory>(2, 'children', PbFieldType.PM, Directory.$checkItem, Directory.create)
    ..hasRequiredFields = false
  ;

  Tree() : super();
  Tree.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  Tree.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
...
class OutputDirectory extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('OutputDirectory')
    ..aOS(1, 'path')
    ..a<Digest>(2, 'digest', PbFieldType.OM, Digest.getDefault, Digest.create)
    ..a<Digest>(3, 'treeDigest', PbFieldType.OM, Digest.getDefault, Digest.create)
    ..hasRequiredFields = false
  ;

  OutputDirectory() : super();
  OutputDirectory.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  OutputDirectory.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  OutputDirectory clone() => new OutputDirectory()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static OutputDirectory create() => new OutputDirectory();
  static PbList<OutputDirectory> createRepeated() => new PbList<OutputDirectory>();
  static OutputDirectory getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyOutputDirectory();
    return _defaultInstance;
  }
...
class _ReadonlyOutputDirectory extends OutputDirectory with ReadonlyMessageMixin {}
...
class ExecuteRequest extends GeneratedMessage {
  ...
  ExecuteRequest.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  ExecuteRequest.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ExecuteRequest clone() => new ExecuteRequest()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static ExecuteRequest create() => new ExecuteRequest();
  static PbList<ExecuteRequest> createRepeated() => new PbList<ExecuteRequest>();
  static ExecuteRequest getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyExecuteRequest();
    return _defaultInstance;
  }
...
class LogFile extends GeneratedMessage {
  ...
  LogFile() : super();
  LogFile.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  LogFile.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ...
  set humanReadable(bool v) { $_setBool(1, v); }
...
class ExecuteResponse_ServerLogsEntry extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('ExecuteResponse_ServerLogsEntry')
    ..aOS(1, 'key')
  ...
  ExecuteResponse_ServerLogsEntry.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  ExecuteResponse_ServerLogsEntry.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ExecuteResponse_ServerLogsEntry clone() => new ExecuteResponse_ServerLogsEntry()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static ExecuteResponse_ServerLogsEntry create() => new ExecuteResponse_ServerLogsEntry();
  static PbList<ExecuteResponse_ServerLogsEntry> createRepeated() => new PbList<ExecuteResponse_ServerLogsEntry>();
  static ExecuteResponse_ServerLogsEntry getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyExecuteResponse_ServerLogsEntry();
    return _defaultInstance;
  }
  static ExecuteResponse_ServerLogsEntry _defaultInstance;
  static void $checkItem(ExecuteResponse_ServerLogsEntry v) {
    if (v is! ExecuteResponse_ServerLogsEntry) checkItemFailed(v, 'ExecuteResponse_ServerLogsEntry');
  }
  ...
  set value(LogFile v) { setField(2, v); }
  bool hasValue() => $_has(1);
  void clearValue() => clearField(2);
}

class _ReadonlyExecuteResponse_ServerLogsEntry extends ExecuteResponse_ServerLogsEntry with ReadonlyMessageMixin {}

class ExecuteResponse extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('ExecuteResponse')
    ..a<ActionResult>(1, 'result', PbFieldType.OM, ActionResult.getDefault, ActionResult.create)
    ..aOB(2, 'cachedResult')
    ..a<$google$rpc.Status>(3, 'status', PbFieldType.OM, $google$rpc.Status.getDefault, $google$rpc.Status.create)
    ..pp<ExecuteResponse_ServerLogsEntry>(4, 'serverLogs', PbFieldType.PM, ExecuteResponse_ServerLogsEntry.$checkItem, ExecuteResponse_ServerLogsEntry.create)
    ..hasRequiredFields = false
  ;

  ExecuteResponse() : super();
  ExecuteResponse.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  ExecuteResponse.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ExecuteResponse clone() => new ExecuteResponse()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static ExecuteResponse create() => new ExecuteResponse();
  static PbList<ExecuteResponse> createRepeated() => new PbList<ExecuteResponse>();
  static ExecuteResponse getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyExecuteResponse();
    return _defaultInstance;
  }
  ...
  set cachedResult(bool v) { $_setBool(1, v); }
...
class _ReadonlyExecuteResponse extends ExecuteResponse with ReadonlyMessageMixin {}
...
class ExecuteOperationMetadata extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('ExecuteOperationMetadata')
    ..e<ExecuteOperationMetadata_Stage>(1, 'stage', PbFieldType.OE, ExecuteOperationMetadata_Stage.UNKNOWN, ExecuteOperationMetadata_Stage.valueOf, ExecuteOperationMetadata_Stage.values)
    ..a<Digest>(2, 'actionDigest', PbFieldType.OM, Digest.getDefault, Digest.create)
  ...
  ExecuteOperationMetadata.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  ExecuteOperationMetadata.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ExecuteOperationMetadata clone() => new ExecuteOperationMetadata()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static ExecuteOperationMetadata create() => new ExecuteOperationMetadata();
  static PbList<ExecuteOperationMetadata> createRepeated() => new PbList<ExecuteOperationMetadata>();
  static ExecuteOperationMetadata getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyExecuteOperationMetadata();
    return _defaultInstance;
  }
  static ExecuteOperationMetadata _defaultInstance;
  static void $checkItem(ExecuteOperationMetadata v) {
    if (v is! ExecuteOperationMetadata) checkItemFailed(v, 'ExecuteOperationMetadata');
  }
  ...
  set stdoutStreamName(String v) { $_setString(2, v); }
  bool hasStdoutStreamName() => $_has(2);
  void clearStdoutStreamName() => clearField(3);

  String get stderrStreamName => $_getS(3, '');
  set stderrStreamName(String v) { $_setString(3, v); }
  bool hasStderrStreamName() => $_has(3);
  void clearStderrStreamName() => clearField(4);
}

class _ReadonlyExecuteOperationMetadata extends ExecuteOperationMetadata with ReadonlyMessageMixin {}
...
class GetActionResultRequest extends GeneratedMessage {
  ...
  GetActionResultRequest.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  GetActionResultRequest.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  GetActionResultRequest clone() => new GetActionResultRequest()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static GetActionResultRequest create() => new GetActionResultRequest();
  static PbList<GetActionResultRequest> createRepeated() => new PbList<GetActionResultRequest>();
  static GetActionResultRequest getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyGetActionResultRequest();
    return _defaultInstance;
  }
  static GetActionResultRequest _defaultInstance;
  static void $checkItem(GetActionResultRequest v) {
    if (v is! GetActionResultRequest) checkItemFailed(v, 'GetActionResultRequest');
  }
...
class _ReadonlyGetActionResultRequest extends GetActionResultRequest with ReadonlyMessageMixin {}
...
class UpdateActionResultRequest extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('UpdateActionResultRequest')
    ..aOS(1, 'instanceName')
    ..a<Digest>(2, 'actionDigest', PbFieldType.OM, Digest.getDefault, Digest.create)
    ..a<ActionResult>(3, 'actionResult', PbFieldType.OM, ActionResult.getDefault, ActionResult.create)
    ..hasRequiredFields = false
  ;

  UpdateActionResultRequest() : super();
  UpdateActionResultRequest.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  UpdateActionResultRequest.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  UpdateActionResultRequest clone() => new UpdateActionResultRequest()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static UpdateActionResultRequest create() => new UpdateActionResultRequest();
  static PbList<UpdateActionResultRequest> createRepeated() => new PbList<UpdateActionResultRequest>();
  static UpdateActionResultRequest getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyUpdateActionResultRequest();
    return _defaultInstance;
  }
  static UpdateActionResultRequest _defaultInstance;
  static void $checkItem(UpdateActionResultRequest v) {
    if (v is! UpdateActionResultRequest) checkItemFailed(v, 'UpdateActionResultRequest');
  }
...
class _ReadonlyUpdateActionResultRequest extends UpdateActionResultRequest with ReadonlyMessageMixin {}
...
class FindMissingBlobsRequest extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('FindMissingBlobsRequest')
    ..aOS(1, 'instanceName')
    ..pp<Digest>(2, 'blobDigests', PbFieldType.PM, Digest.$checkItem, Digest.create)
    ..hasRequiredFields = false
  ;

  FindMissingBlobsRequest() : super();
  FindMissingBlobsRequest.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  FindMissingBlobsRequest.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  FindMissingBlobsRequest clone() => new FindMissingBlobsRequest()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static FindMissingBlobsRequest create() => new FindMissingBlobsRequest();
  static PbList<FindMissingBlobsRequest> createRepeated() => new PbList<FindMissingBlobsRequest>();
  static FindMissingBlobsRequest getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyFindMissingBlobsRequest();
    return _defaultInstance;
  }
  static FindMissingBlobsRequest _defaultInstance;
  static void $checkItem(FindMissingBlobsRequest v) {
    if (v is! FindMissingBlobsRequest) checkItemFailed(v, 'FindMissingBlobsRequest');
  }
...
class _ReadonlyFindMissingBlobsRequest extends FindMissingBlobsRequest with ReadonlyMessageMixin {}
...
class FindMissingBlobsResponse extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('FindMissingBlobsResponse')
    ..pp<Digest>(2, 'missingBlobDigests', PbFieldType.PM, Digest.$checkItem, Digest.create)
    ..hasRequiredFields = false
  ;

  FindMissingBlobsResponse() : super();
  FindMissingBlobsResponse.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  FindMissingBlobsResponse.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  FindMissingBlobsResponse clone() => new FindMissingBlobsResponse()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static FindMissingBlobsResponse create() => new FindMissingBlobsResponse();
  static PbList<FindMissingBlobsResponse> createRepeated() => new PbList<FindMissingBlobsResponse>();
  static FindMissingBlobsResponse getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyFindMissingBlobsResponse();
    return _defaultInstance;
  }
  static FindMissingBlobsResponse _defaultInstance;
  static void $checkItem(FindMissingBlobsResponse v) {
    if (v is! FindMissingBlobsResponse) checkItemFailed(v, 'FindMissingBlobsResponse');
  }

  List<Digest> get missingBlobDigests => $_getList(0);
}

class _ReadonlyFindMissingBlobsResponse extends FindMissingBlobsResponse with ReadonlyMessageMixin {}

class UpdateBlobRequest extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('UpdateBlobRequest')
    ..a<Digest>(1, 'contentDigest', PbFieldType.OM, Digest.getDefault, Digest.create)
    ..a<List<int>>(2, 'data', PbFieldType.OY)
    ..hasRequiredFields = false
  ;

  UpdateBlobRequest() : super();
  UpdateBlobRequest.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  UpdateBlobRequest.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  UpdateBlobRequest clone() => new UpdateBlobRequest()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static UpdateBlobRequest create() => new UpdateBlobRequest();
  static PbList<UpdateBlobRequest> createRepeated() => new PbList<UpdateBlobRequest>();
  static UpdateBlobRequest getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyUpdateBlobRequest();
    return _defaultInstance;
  }
...
class _ReadonlyUpdateBlobRequest extends UpdateBlobRequest with ReadonlyMessageMixin {}
...
class BatchUpdateBlobsRequest extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('BatchUpdateBlobsRequest')
    ..aOS(1, 'instanceName')
    ..pp<UpdateBlobRequest>(2, 'requests', PbFieldType.PM, UpdateBlobRequest.$checkItem, UpdateBlobRequest.create)
    ..hasRequiredFields = false
  ;

  BatchUpdateBlobsRequest() : super();
  BatchUpdateBlobsRequest.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  BatchUpdateBlobsRequest.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  BatchUpdateBlobsRequest clone() => new BatchUpdateBlobsRequest()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static BatchUpdateBlobsRequest create() => new BatchUpdateBlobsRequest();
  static PbList<BatchUpdateBlobsRequest> createRepeated() => new PbList<BatchUpdateBlobsRequest>();
  static BatchUpdateBlobsRequest getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyBatchUpdateBlobsRequest();
    return _defaultInstance;
  }
  static BatchUpdateBlobsRequest _defaultInstance;
  static void $checkItem(BatchUpdateBlobsRequest v) {
    if (v is! BatchUpdateBlobsRequest) checkItemFailed(v, 'BatchUpdateBlobsRequest');
  }
...
class _ReadonlyBatchUpdateBlobsRequest extends BatchUpdateBlobsRequest with ReadonlyMessageMixin {}

class BatchUpdateBlobsResponse_Response extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('BatchUpdateBlobsResponse_Response')
    ..a<Digest>(1, 'blobDigest', PbFieldType.OM, Digest.getDefault, Digest.create)
  ...
  BatchUpdateBlobsResponse_Response.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  BatchUpdateBlobsResponse_Response.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  BatchUpdateBlobsResponse_Response clone() => new BatchUpdateBlobsResponse_Response()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static BatchUpdateBlobsResponse_Response create() => new BatchUpdateBlobsResponse_Response();
  static PbList<BatchUpdateBlobsResponse_Response> createRepeated() => new PbList<BatchUpdateBlobsResponse_Response>();
  static BatchUpdateBlobsResponse_Response getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyBatchUpdateBlobsResponse_Response();
    return _defaultInstance;
  }
  static BatchUpdateBlobsResponse_Response _defaultInstance;
  static void $checkItem(BatchUpdateBlobsResponse_Response v) {
    if (v is! BatchUpdateBlobsResponse_Response) checkItemFailed(v, 'BatchUpdateBlobsResponse_Response');
  }
...
class _ReadonlyBatchUpdateBlobsResponse_Response extends BatchUpdateBlobsResponse_Response with ReadonlyMessageMixin {}
...
class BatchUpdateBlobsResponse extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('BatchUpdateBlobsResponse')
    ..pp<BatchUpdateBlobsResponse_Response>(1, 'responses', PbFieldType.PM, BatchUpdateBlobsResponse_Response.$checkItem, BatchUpdateBlobsResponse_Response.create)
    ..hasRequiredFields = false
  ;

  BatchUpdateBlobsResponse() : super();
  BatchUpdateBlobsResponse.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  BatchUpdateBlobsResponse.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  BatchUpdateBlobsResponse clone() => new BatchUpdateBlobsResponse()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static BatchUpdateBlobsResponse create() => new BatchUpdateBlobsResponse();
  static PbList<BatchUpdateBlobsResponse> createRepeated() => new PbList<BatchUpdateBlobsResponse>();
  static BatchUpdateBlobsResponse getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyBatchUpdateBlobsResponse();
    return _defaultInstance;
  }
  static BatchUpdateBlobsResponse _defaultInstance;
  static void $checkItem(BatchUpdateBlobsResponse v) {
    if (v is! BatchUpdateBlobsResponse) checkItemFailed(v, 'BatchUpdateBlobsResponse');
  }

  List<BatchUpdateBlobsResponse_Response> get responses => $_getList(0);
}

class _ReadonlyBatchUpdateBlobsResponse extends BatchUpdateBlobsResponse with ReadonlyMessageMixin {}

class GetTreeRequest extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('GetTreeRequest')
    ..aOS(1, 'instanceName')
    ..a<Digest>(2, 'rootDigest', PbFieldType.OM, Digest.getDefault, Digest.create)
  ...
  GetTreeRequest.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  GetTreeRequest.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  GetTreeRequest clone() => new GetTreeRequest()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static GetTreeRequest create() => new GetTreeRequest();
  static PbList<GetTreeRequest> createRepeated() => new PbList<GetTreeRequest>();
  static GetTreeRequest getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyGetTreeRequest();
    return _defaultInstance;
  }
...
class GetTreeResponse extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('GetTreeResponse')
    ..pp<Directory>(1, 'directories', PbFieldType.PM, Directory.$checkItem, Directory.create)
    ..aOS(2, 'nextPageToken')
    ..hasRequiredFields = false
  ;

  GetTreeResponse() : super();
  GetTreeResponse.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  GetTreeResponse.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  GetTreeResponse clone() => new GetTreeResponse()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static GetTreeResponse create() => new GetTreeResponse();
  static PbList<GetTreeResponse> createRepeated() => new PbList<GetTreeResponse>();
  static GetTreeResponse getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyGetTreeResponse();
    return _defaultInstance;
  }
...
class _ReadonlyGetTreeResponse extends GetTreeResponse with ReadonlyMessageMixin {}
...
class ToolDetails extends GeneratedMessage {
  ...
  ToolDetails() : super();
  ToolDetails.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  ToolDetails.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
...
class RequestMetadata extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('RequestMetadata')
    ..a<ToolDetails>(1, 'toolDetails', PbFieldType.OM, ToolDetails.getDefault, ToolDetails.create)
    ..aOS(2, 'actionId')
...
class ExecutionApi {
  ...
  Future<$google$longrunning.Operation> execute(ClientContext ctx, ExecuteRequest request) {
    var emptyResponse = new $google$longrunning.Operation();
    return _client.invoke<$google$longrunning.Operation>(ctx, 'Execution', 'Execute', request, emptyResponse);
  }
}
...
class ActionCacheApi {
  ...
  Future<ActionResult> getActionResult(ClientContext ctx, GetActionResultRequest request) {
  ...
  Future<ActionResult> updateActionResult(ClientContext ctx, UpdateActionResultRequest request) {
    var emptyResponse = new ActionResult();
...
class ContentAddressableStorageApi {
  ...
  Future<FindMissingBlobsResponse> findMissingBlobs(ClientContext ctx, FindMissingBlobsRequest request) {
  ...
  Future<BatchUpdateBlobsResponse> batchUpdateBlobs(ClientContext ctx, BatchUpdateBlobsRequest request) {
