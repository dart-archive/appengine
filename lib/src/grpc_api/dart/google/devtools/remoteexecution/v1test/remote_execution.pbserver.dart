...
abstract class ExecutionServiceBase extends $pb.GeneratedService {
  $async.Future<$2.Operation> execute(
      $pb.ServerContext ctx, ExecuteRequest request);
...
abstract class ActionCacheServiceBase extends $pb.GeneratedService {
  $async.Future<ActionResult> getActionResult(
      $pb.ServerContext ctx, GetActionResultRequest request);
  $async.Future<ActionResult> updateActionResult(
      $pb.ServerContext ctx, UpdateActionResultRequest request);
  ...
  $async.Future<$pb.GeneratedMessage> handleCall($pb.ServerContext ctx,
    ...
    switch (method) {
      case 'GetActionResult':
        return this.getActionResult(ctx, request);
      case 'UpdateActionResult':
  ...
  $core.Map<$core.String, $core.dynamic> get $json =>
      ActionCacheServiceBase$json;
  $core.Map<$core.String, $core.Map<$core.String, $core.dynamic>>
      get $messageJson => ActionCacheServiceBase$messageJson;
}

abstract class ContentAddressableStorageServiceBase
    extends $pb.GeneratedService {
  $async.Future<FindMissingBlobsResponse> findMissingBlobs(
      $pb.ServerContext ctx, FindMissingBlobsRequest request);
  $async.Future<BatchUpdateBlobsResponse> batchUpdateBlobs(
      $pb.ServerContext ctx, BatchUpdateBlobsRequest request);
  $async.Future<GetTreeResponse> getTree(
      $pb.ServerContext ctx, GetTreeRequest request);
  ...
  $async.Future<$pb.GeneratedMessage> handleCall($pb.ServerContext ctx,
    ...
    switch (method) {
      case 'FindMissingBlobs':
        return this.findMissingBlobs(ctx, request);
      case 'BatchUpdateBlobs':
        return this.batchUpdateBlobs(ctx, request);
      case 'GetTree':
  ...
  $core.Map<$core.String, $core.dynamic> get $json =>
      ContentAddressableStorageServiceBase$json;
  $core.Map<$core.String, $core.Map<$core.String, $core.dynamic>>
      get $messageJson => ContentAddressableStorageServiceBase$messageJson;
}
