...
abstract class ExecutionServiceBase extends GeneratedService {
  Future<$google$longrunning.Operation> execute(
      ServerContext ctx, ExecuteRequest request);
...
abstract class ActionCacheServiceBase extends GeneratedService {
  Future<ActionResult> getActionResult(
      ServerContext ctx, GetActionResultRequest request);
  Future<ActionResult> updateActionResult(
      ServerContext ctx, UpdateActionResultRequest request);
...
abstract class ContentAddressableStorageServiceBase extends GeneratedService {
  Future<FindMissingBlobsResponse> findMissingBlobs(
      ServerContext ctx, FindMissingBlobsRequest request);
  Future<BatchUpdateBlobsResponse> batchUpdateBlobs(
      ServerContext ctx, BatchUpdateBlobsRequest request);
  ...
  Map<String, Map<String, dynamic>> get $messageJson =>
      ContentAddressableStorage$messageJson;
}
