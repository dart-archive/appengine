...
class CommandTask_Inputs_EnvironmentVariable extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('CommandTask_Inputs_EnvironmentVariable')
    ..aOS(1, 'name')
    ..aOS(2, 'value')
  ...
  CommandTask_Inputs_EnvironmentVariable.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  CommandTask_Inputs_EnvironmentVariable.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  CommandTask_Inputs_EnvironmentVariable clone() => new CommandTask_Inputs_EnvironmentVariable()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static CommandTask_Inputs_EnvironmentVariable create() => new CommandTask_Inputs_EnvironmentVariable();
  static PbList<CommandTask_Inputs_EnvironmentVariable> createRepeated() => new PbList<CommandTask_Inputs_EnvironmentVariable>();
  static CommandTask_Inputs_EnvironmentVariable getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyCommandTask_Inputs_EnvironmentVariable();
  ...
  static void $checkItem(CommandTask_Inputs_EnvironmentVariable v) {
    if (v is! CommandTask_Inputs_EnvironmentVariable) checkItemFailed(v, 'CommandTask_Inputs_EnvironmentVariable');
  }
...
class _ReadonlyCommandTask_Inputs_EnvironmentVariable extends CommandTask_Inputs_EnvironmentVariable with ReadonlyMessageMixin {}
...
class CommandTask_Inputs extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('CommandTask_Inputs')
    ...
    ..pp<CommandTask_Inputs_EnvironmentVariable>(3, 'environmentVariables', PbFieldType.PM, CommandTask_Inputs_EnvironmentVariable.$checkItem, CommandTask_Inputs_EnvironmentVariable.create)
    ..hasRequiredFields = false
  ;

  CommandTask_Inputs() : super();
  CommandTask_Inputs.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  CommandTask_Inputs.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  CommandTask_Inputs clone() => new CommandTask_Inputs()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static CommandTask_Inputs create() => new CommandTask_Inputs();
  static PbList<CommandTask_Inputs> createRepeated() => new PbList<CommandTask_Inputs>();
  static CommandTask_Inputs getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyCommandTask_Inputs();
    return _defaultInstance;
  }
  ...
  List<CommandTask_Inputs_EnvironmentVariable> get environmentVariables => $_getList(2);
}

class _ReadonlyCommandTask_Inputs extends CommandTask_Inputs with ReadonlyMessageMixin {}
...
class CommandTask_Outputs extends GeneratedMessage {
  ...
  CommandTask_Outputs.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  CommandTask_Outputs.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  CommandTask_Outputs clone() => new CommandTask_Outputs()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static CommandTask_Outputs create() => new CommandTask_Outputs();
  static PbList<CommandTask_Outputs> createRepeated() => new PbList<CommandTask_Outputs>();
  static CommandTask_Outputs getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyCommandTask_Outputs();
    return _defaultInstance;
  }
...
class _ReadonlyCommandTask_Outputs extends CommandTask_Outputs with ReadonlyMessageMixin {}

class CommandTask_Timeouts extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('CommandTask_Timeouts')
    ..a<$google$protobuf.Duration>(1, 'execution', PbFieldType.OM, $google$protobuf.Duration.getDefault, $google$protobuf.Duration.create)
    ..a<$google$protobuf.Duration>(2, 'idle', PbFieldType.OM, $google$protobuf.Duration.getDefault, $google$protobuf.Duration.create)
    ..a<$google$protobuf.Duration>(3, 'shutdown', PbFieldType.OM, $google$protobuf.Duration.getDefault, $google$protobuf.Duration.create)
    ..hasRequiredFields = false
  ;

  CommandTask_Timeouts() : super();
  CommandTask_Timeouts.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  CommandTask_Timeouts.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  CommandTask_Timeouts clone() => new CommandTask_Timeouts()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static CommandTask_Timeouts create() => new CommandTask_Timeouts();
  static PbList<CommandTask_Timeouts> createRepeated() => new PbList<CommandTask_Timeouts>();
  static CommandTask_Timeouts getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyCommandTask_Timeouts();
    return _defaultInstance;
  }
  ...
  set execution($google$protobuf.Duration v) { setField(1, v); }
  bool hasExecution() => $_has(0);
  void clearExecution() => clearField(1);

  $google$protobuf.Duration get idle => $_getN(1);
  set idle($google$protobuf.Duration v) { setField(2, v); }
  bool hasIdle() => $_has(1);
  void clearIdle() => clearField(2);

  $google$protobuf.Duration get shutdown => $_getN(2);
  set shutdown($google$protobuf.Duration v) { setField(3, v); }
  bool hasShutdown() => $_has(2);
  void clearShutdown() => clearField(3);
}

class _ReadonlyCommandTask_Timeouts extends CommandTask_Timeouts with ReadonlyMessageMixin {}

class CommandTask extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('CommandTask')
    ..a<CommandTask_Inputs>(1, 'inputs', PbFieldType.OM, CommandTask_Inputs.getDefault, CommandTask_Inputs.create)
    ..a<CommandTask_Outputs>(4, 'expectedOutputs', PbFieldType.OM, CommandTask_Outputs.getDefault, CommandTask_Outputs.create)
    ..a<CommandTask_Timeouts>(5, 'timeouts', PbFieldType.OM, CommandTask_Timeouts.getDefault, CommandTask_Timeouts.create)
    ..hasRequiredFields = false
  ;

  CommandTask() : super();
  CommandTask.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  CommandTask.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
...
class CommandOutputs extends GeneratedMessage {
  ...
  CommandOutputs.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  CommandOutputs.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  CommandOutputs clone() => new CommandOutputs()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static CommandOutputs create() => new CommandOutputs();
  static PbList<CommandOutputs> createRepeated() => new PbList<CommandOutputs>();
  static CommandOutputs getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyCommandOutputs();
    return _defaultInstance;
  }
...
class CommandOverhead extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('CommandOverhead')
    ..a<$google$protobuf.Duration>(1, 'duration', PbFieldType.OM, $google$protobuf.Duration.getDefault, $google$protobuf.Duration.create)
    ..a<$google$protobuf.Duration>(2, 'overhead', PbFieldType.OM, $google$protobuf.Duration.getDefault, $google$protobuf.Duration.create)
    ..hasRequiredFields = false
  ;

  CommandOverhead() : super();
  CommandOverhead.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  CommandOverhead.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  CommandOverhead clone() => new CommandOverhead()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static CommandOverhead create() => new CommandOverhead();
  static PbList<CommandOverhead> createRepeated() => new PbList<CommandOverhead>();
  static CommandOverhead getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyCommandOverhead();
    return _defaultInstance;
  }
  ...
  set duration($google$protobuf.Duration v) { setField(1, v); }
  bool hasDuration() => $_has(0);
  void clearDuration() => clearField(1);

  $google$protobuf.Duration get overhead => $_getN(1);
  set overhead($google$protobuf.Duration v) { setField(2, v); }
  bool hasOverhead() => $_has(1);
  void clearOverhead() => clearField(2);
}

class _ReadonlyCommandOverhead extends CommandOverhead with ReadonlyMessageMixin {}
...
class FileMetadata extends GeneratedMessage {
  ...
  FileMetadata() : super();
  FileMetadata.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  FileMetadata.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ...
  static FileMetadata getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyFileMetadata();
    return _defaultInstance;
  }
  ...
  set contents(List<int> v) { $_setBytes(2, v); }
...
class DirectoryMetadata extends GeneratedMessage {
  ...
  DirectoryMetadata.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  DirectoryMetadata.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  DirectoryMetadata clone() => new DirectoryMetadata()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static DirectoryMetadata create() => new DirectoryMetadata();
  static PbList<DirectoryMetadata> createRepeated() => new PbList<DirectoryMetadata>();
  static DirectoryMetadata getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyDirectoryMetadata();
    return _defaultInstance;
  }
...
class _ReadonlyDirectoryMetadata extends DirectoryMetadata with ReadonlyMessageMixin {}
...
class Directory extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('Directory')
    ..pp<FileMetadata>(1, 'files', PbFieldType.PM, FileMetadata.$checkItem, FileMetadata.create)
    ..pp<DirectoryMetadata>(2, 'directories', PbFieldType.PM, DirectoryMetadata.$checkItem, DirectoryMetadata.create)
    ..hasRequiredFields = false
  ;
