...
abstract class TasksServiceBase extends GeneratedService {
  ...
  Future<TaskResult> updateTaskResult(ServerContext ctx, UpdateTaskResultRequest request);
  Future<AddTaskLogResponse> addTaskLog(ServerContext ctx, AddTaskLogRequest request);

  GeneratedMessage createRequest(String method) {
    switch (method) {
      case 'GetTask': return new GetTaskRequest();
      case 'UpdateTaskResult': return new UpdateTaskResultRequest();
      case 'AddTaskLog': return new AddTaskLogRequest();
