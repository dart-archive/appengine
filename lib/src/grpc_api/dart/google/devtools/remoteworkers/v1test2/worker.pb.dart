...
class Worker_Property extends GeneratedMessage {
  ...
  Worker_Property.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  Worker_Property.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  Worker_Property clone() => new Worker_Property()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static Worker_Property create() => new Worker_Property();
  static PbList<Worker_Property> createRepeated() => new PbList<Worker_Property>();
  static Worker_Property getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyWorker_Property();
...
class _ReadonlyWorker_Property extends Worker_Property with ReadonlyMessageMixin {}
...
class Worker extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('Worker')
    ...
    ..pp<Worker_Property>(2, 'properties', PbFieldType.PM, Worker_Property.$checkItem, Worker_Property.create)
    ..hasRequiredFields = false
  ;

  Worker() : super();
  Worker.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  Worker.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
...
class Device_Property extends GeneratedMessage {
  ...
  Device_Property.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  Device_Property.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  Device_Property clone() => new Device_Property()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static Device_Property create() => new Device_Property();
  static PbList<Device_Property> createRepeated() => new PbList<Device_Property>();
  static Device_Property getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyDevice_Property();
    return _defaultInstance;
  }
...
class _ReadonlyDevice_Property extends Device_Property with ReadonlyMessageMixin {}

class Device extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('Device')
    ..aOS(1, 'handle')
    ..pp<Device_Property>(2, 'properties', PbFieldType.PM, Device_Property.$checkItem, Device_Property.create)
    ..hasRequiredFields = false
  ;
