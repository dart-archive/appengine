...
abstract class BotsServiceBase extends $pb.GeneratedService {
  $async.Future<BotSession> createBotSession(
      $pb.ServerContext ctx, CreateBotSessionRequest request);
  $async.Future<BotSession> updateBotSession(
      $pb.ServerContext ctx, UpdateBotSessionRequest request);
  $async.Future<$5.Empty> postBotEventTemp(
      $pb.ServerContext ctx, PostBotEventTempRequest request);
  ...
  $core.Map<$core.String, $core.Map<$core.String, $core.dynamic>>
      get $messageJson => BotsServiceBase$messageJson;
}
