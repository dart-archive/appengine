...
class AdminTemp_Command extends ProtobufEnum {
  ...
  static final Map<int, dynamic> _byValue = ProtobufEnum.initByValue(values);
  static AdminTemp_Command valueOf(int value) =>
      _byValue[value] as AdminTemp_Command;
...
class PostBotEventTempRequest_Type extends ProtobufEnum {
  ...
  static final Map<int, dynamic> _byValue = ProtobufEnum.initByValue(values);
  static PostBotEventTempRequest_Type valueOf(int value) =>
      _byValue[value] as PostBotEventTempRequest_Type;
  static void $checkItem(PostBotEventTempRequest_Type v) {
    if (v is! PostBotEventTempRequest_Type)
      checkItemFailed(v, 'PostBotEventTempRequest_Type');
  }
