...
class Task_LogsEntry extends GeneratedMessage {
  ...
  Task_LogsEntry.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  Task_LogsEntry.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  Task_LogsEntry clone() => new Task_LogsEntry()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static Task_LogsEntry create() => new Task_LogsEntry();
  static PbList<Task_LogsEntry> createRepeated() => new PbList<Task_LogsEntry>();
  static Task_LogsEntry getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyTask_LogsEntry();
...
class Task extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('Task')
    ..aOS(1, 'name')
    ..a<$google$protobuf.Any>(2, 'description', PbFieldType.OM, $google$protobuf.Any.getDefault, $google$protobuf.Any.create)
    ..pp<Task_LogsEntry>(3, 'logs', PbFieldType.PM, Task_LogsEntry.$checkItem, Task_LogsEntry.create)
    ..hasRequiredFields = false
  ;
  ...
  set description($google$protobuf.Any v) { setField(2, v); }
...
class TaskResult extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('TaskResult')
    ...
    ..a<$google$protobuf.Any>(4, 'output', PbFieldType.OM, $google$protobuf.Any.getDefault, $google$protobuf.Any.create)
    ..a<$google$protobuf.Any>(5, 'meta', PbFieldType.OM, $google$protobuf.Any.getDefault, $google$protobuf.Any.create)
    ..hasRequiredFields = false
  ;

  TaskResult() : super();
  TaskResult.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  TaskResult.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ...
  set output($google$protobuf.Any v) { setField(4, v); }
  bool hasOutput() => $_has(3);
  void clearOutput() => clearField(4);

  $google$protobuf.Any get meta => $_getN(4);
  set meta($google$protobuf.Any v) { setField(5, v); }
  bool hasMeta() => $_has(4);
...
class UpdateTaskResultRequest extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('UpdateTaskResultRequest')
    ..aOS(1, 'name')
    ..a<TaskResult>(2, 'result', PbFieldType.OM, TaskResult.getDefault, TaskResult.create)
  ...
  UpdateTaskResultRequest.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  UpdateTaskResultRequest.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  UpdateTaskResultRequest clone() => new UpdateTaskResultRequest()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static UpdateTaskResultRequest create() => new UpdateTaskResultRequest();
  static PbList<UpdateTaskResultRequest> createRepeated() => new PbList<UpdateTaskResultRequest>();
  static UpdateTaskResultRequest getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyUpdateTaskResultRequest();
    return _defaultInstance;
  }
  static UpdateTaskResultRequest _defaultInstance;
  static void $checkItem(UpdateTaskResultRequest v) {
    if (v is! UpdateTaskResultRequest) checkItemFailed(v, 'UpdateTaskResultRequest');
  }
...
class _ReadonlyUpdateTaskResultRequest extends UpdateTaskResultRequest with ReadonlyMessageMixin {}
...
class AddTaskLogRequest extends GeneratedMessage {
  ...
  AddTaskLogRequest.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  AddTaskLogRequest.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  AddTaskLogRequest clone() => new AddTaskLogRequest()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static AddTaskLogRequest create() => new AddTaskLogRequest();
  static PbList<AddTaskLogRequest> createRepeated() => new PbList<AddTaskLogRequest>();
  static AddTaskLogRequest getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyAddTaskLogRequest();
    return _defaultInstance;
  }
  ...
  set logId(String v) { $_setString(1, v); }
  bool hasLogId() => $_has(1);
  void clearLogId() => clearField(2);
}

class _ReadonlyAddTaskLogRequest extends AddTaskLogRequest with ReadonlyMessageMixin {}
...
class AddTaskLogResponse extends GeneratedMessage {
  ...
  AddTaskLogResponse.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  AddTaskLogResponse.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  AddTaskLogResponse clone() => new AddTaskLogResponse()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static AddTaskLogResponse create() => new AddTaskLogResponse();
  static PbList<AddTaskLogResponse> createRepeated() => new PbList<AddTaskLogResponse>();
  static AddTaskLogResponse getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyAddTaskLogResponse();
    return _defaultInstance;
  }
  ...
  set handle(String v) { $_setString(0, v); }
  bool hasHandle() => $_has(0);
  void clearHandle() => clearField(1);
}

class _ReadonlyAddTaskLogResponse extends AddTaskLogResponse with ReadonlyMessageMixin {}
...
class TasksApi {
  ...
  Future<TaskResult> updateTaskResult(ClientContext ctx, UpdateTaskResultRequest request) {
    var emptyResponse = new TaskResult();
    return _client.invoke<TaskResult>(ctx, 'Tasks', 'UpdateTaskResult', request, emptyResponse);
  }
  Future<AddTaskLogResponse> addTaskLog(ClientContext ctx, AddTaskLogRequest request) {
