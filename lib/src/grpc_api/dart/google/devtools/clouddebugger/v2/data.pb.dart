...
class FormatMessage extends GeneratedMessage {
  ...
  FormatMessage() : super();
  FormatMessage.fromBuffer(List<int> i,
...
class StatusMessage extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('StatusMessage')
    ...
    ..a<FormatMessage>(3, 'description', PbFieldType.OM,
        FormatMessage.getDefault, FormatMessage.create)
    ..hasRequiredFields = false;

  StatusMessage() : super();
  StatusMessage.fromBuffer(List<int> i,
      [ExtensionRegistry r = ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);
...
class Variable extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('Variable')
    ...
    ..aOS(2, 'value')
    ..pp<Variable>(
        3, 'members', PbFieldType.PM, Variable.$checkItem, Variable.create)
    ...
    ..a<StatusMessage>(5, 'status', PbFieldType.OM, StatusMessage.getDefault,
  ...
  set varTableIndex($google$protobuf.Int32Value v) {
    setField(4, v);
  }
...
class StackFrame extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('StackFrame')
    ...
    ..pp<Variable>(
        3, 'arguments', PbFieldType.PM, Variable.$checkItem, Variable.create)
    ..pp<Variable>(
        4, 'locals', PbFieldType.PM, Variable.$checkItem, Variable.create)
    ..hasRequiredFields = false;

  StackFrame() : super();
  StackFrame.fromBuffer(List<int> i,
      [ExtensionRegistry r = ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);
...
class Breakpoint_LabelsEntry extends GeneratedMessage {
  ...
  Breakpoint_LabelsEntry.fromBuffer(List<int> i,
      [ExtensionRegistry r = ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);
  Breakpoint_LabelsEntry.fromJson(String i,
      [ExtensionRegistry r = ExtensionRegistry.EMPTY])
      : super.fromJson(i, r);
  ...
  static void $checkItem(Breakpoint_LabelsEntry v) {
    if (v is! Breakpoint_LabelsEntry)
      checkItemFailed(v, 'Breakpoint_LabelsEntry');
  }
...
class _ReadonlyBreakpoint_LabelsEntry extends Breakpoint_LabelsEntry
...
class Breakpoint extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('Breakpoint')
    ...
    ..pPS(4, 'expressions')
    ..aOB(5, 'isFinalState')
    ..pp<StackFrame>(7, 'stackFrames', PbFieldType.PM, StackFrame.$checkItem,
        StackFrame.create)
    ..pp<Variable>(8, 'evaluatedExpressions', PbFieldType.PM,
        Variable.$checkItem, Variable.create)
    ..pp<Variable>(9, 'variableTable', PbFieldType.PM, Variable.$checkItem,
        Variable.create)
    ..a<StatusMessage>(10, 'status', PbFieldType.OM, StatusMessage.getDefault,
        StatusMessage.create)
    ...
    ..aOS(16, 'userEmail')
    ..pp<Breakpoint_LabelsEntry>(17, 'labels', PbFieldType.PM,
        Breakpoint_LabelsEntry.$checkItem, Breakpoint_LabelsEntry.create)
    ..hasRequiredFields = false;

  Breakpoint() : super();
  Breakpoint.fromBuffer(List<int> i,
      [ExtensionRegistry r = ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);
  ...
  set finalTime($google$protobuf.Timestamp v) {
    setField(12, v);
  }
...
class Debuggee_LabelsEntry extends GeneratedMessage {
  ...
  Debuggee_LabelsEntry.fromBuffer(List<int> i,
      [ExtensionRegistry r = ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);
  Debuggee_LabelsEntry.fromJson(String i,
      [ExtensionRegistry r = ExtensionRegistry.EMPTY])
      : super.fromJson(i, r);
...
class _ReadonlyDebuggee_LabelsEntry extends Debuggee_LabelsEntry
    with ReadonlyMessageMixin {}
...
class Debuggee extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('Debuggee')
    ...
    ..aOS(6, 'agentVersion')
    ..aOB(7, 'isDisabled')
    ..a<StatusMessage>(8, 'status', PbFieldType.OM, StatusMessage.getDefault,
        StatusMessage.create)
    ..pp<$google$devtools$source$v1.SourceContext>(
        9,
        'sourceContexts',
        PbFieldType.PM,
        $google$devtools$source$v1.SourceContext.$checkItem,
        $google$devtools$source$v1.SourceContext.create)
    ..pp<Debuggee_LabelsEntry>(11, 'labels', PbFieldType.PM,
        Debuggee_LabelsEntry.$checkItem, Debuggee_LabelsEntry.create)
    ..pp<$google$devtools$source$v1.ExtendedSourceContext>(
        13,
        'extSourceContexts',
        PbFieldType.PM,
        $google$devtools$source$v1.ExtendedSourceContext.$checkItem,
        $google$devtools$source$v1.ExtendedSourceContext.create)
    ..hasRequiredFields = false;

  Debuggee() : super();
  Debuggee.fromBuffer(List<int> i,
      [ExtensionRegistry r = ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);
  ...
  List<$google$devtools$source$v1.SourceContext> get sourceContexts =>
      $_getList(8);

  List<Debuggee_LabelsEntry> get labels => $_getList(9);

  List<$google$devtools$source$v1.ExtendedSourceContext>
      get extSourceContexts => $_getList(10);
}
