...
class StatusMessage_Reference extends ProtobufEnum {
  static const StatusMessage_Reference UNSPECIFIED =
      const StatusMessage_Reference._(0, 'UNSPECIFIED');
  static const StatusMessage_Reference BREAKPOINT_SOURCE_LOCATION =
      const StatusMessage_Reference._(3, 'BREAKPOINT_SOURCE_LOCATION');
  static const StatusMessage_Reference BREAKPOINT_CONDITION =
      const StatusMessage_Reference._(4, 'BREAKPOINT_CONDITION');
  static const StatusMessage_Reference BREAKPOINT_EXPRESSION =
      const StatusMessage_Reference._(7, 'BREAKPOINT_EXPRESSION');
  static const StatusMessage_Reference BREAKPOINT_AGE =
      const StatusMessage_Reference._(8, 'BREAKPOINT_AGE');
  static const StatusMessage_Reference VARIABLE_NAME =
      const StatusMessage_Reference._(5, 'VARIABLE_NAME');
  static const StatusMessage_Reference VARIABLE_VALUE =
      const StatusMessage_Reference._(6, 'VARIABLE_VALUE');

  static const List<StatusMessage_Reference> values =
      const <StatusMessage_Reference>[
    UNSPECIFIED,
...
class Breakpoint_Action extends ProtobufEnum {
  static const Breakpoint_Action CAPTURE =
      const Breakpoint_Action._(0, 'CAPTURE');
...
class Breakpoint_LogLevel extends ProtobufEnum {
  static const Breakpoint_LogLevel INFO =
      const Breakpoint_LogLevel._(0, 'INFO');
  static const Breakpoint_LogLevel WARNING =
      const Breakpoint_LogLevel._(1, 'WARNING');
  static const Breakpoint_LogLevel ERROR =
      const Breakpoint_LogLevel._(2, 'ERROR');
