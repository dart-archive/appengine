...
const SetBreakpointRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'client_version', '3': 4, '4': 1, '5': 9, '10': 'clientVersion'},
  ],
};
...
const ListBreakpointsRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'client_version', '3': 8, '4': 1, '5': 9, '10': 'clientVersion'},
  ],
...
const Debugger2ServiceBase$json = const {
  '1': 'Debugger2',
  '2': const [
...
const Debugger2ServiceBase$messageJson = const {
  ...
  '.google.devtools.clouddebugger.v2.Breakpoint.LabelsEntry': $0.Breakpoint_LabelsEntry$json,
  ...
  '.google.devtools.source.v1.CloudRepoSourceContext': $4.CloudRepoSourceContext$json,
  ...
  '.google.devtools.source.v1.CloudWorkspaceSourceContext': $4.CloudWorkspaceSourceContext$json,
  ...
  '.google.devtools.clouddebugger.v2.Debuggee.LabelsEntry': $0.Debuggee_LabelsEntry$json,
  '.google.devtools.source.v1.ExtendedSourceContext': $4.ExtendedSourceContext$json,
  '.google.devtools.source.v1.ExtendedSourceContext.LabelsEntry': $4.ExtendedSourceContext_LabelsEntry$json,
};
