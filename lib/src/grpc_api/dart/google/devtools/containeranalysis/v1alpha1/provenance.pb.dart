...
class BuildProvenance_BuildOptionsEntry extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('BuildProvenance_BuildOptionsEntry')
    ..aOS(1, 'key')
    ..aOS(2, 'value')
  ...
  BuildProvenance_BuildOptionsEntry.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  BuildProvenance_BuildOptionsEntry.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  BuildProvenance_BuildOptionsEntry clone() => new BuildProvenance_BuildOptionsEntry()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static BuildProvenance_BuildOptionsEntry create() => new BuildProvenance_BuildOptionsEntry();
  static PbList<BuildProvenance_BuildOptionsEntry> createRepeated() => new PbList<BuildProvenance_BuildOptionsEntry>();
  static BuildProvenance_BuildOptionsEntry getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyBuildProvenance_BuildOptionsEntry();
    return _defaultInstance;
  }
  static BuildProvenance_BuildOptionsEntry _defaultInstance;
  static void $checkItem(BuildProvenance_BuildOptionsEntry v) {
    if (v is! BuildProvenance_BuildOptionsEntry) checkItemFailed(v, 'BuildProvenance_BuildOptionsEntry');
  }
...
class _ReadonlyBuildProvenance_BuildOptionsEntry extends BuildProvenance_BuildOptionsEntry with ReadonlyMessageMixin {}

class BuildProvenance extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('BuildProvenance')
    ..aOS(1, 'id')
    ..aOS(2, 'projectId')
    ..pp<Command>(5, 'commands', PbFieldType.PM, Command.$checkItem, Command.create)
    ..pp<Artifact>(6, 'builtArtifacts', PbFieldType.PM, Artifact.$checkItem, Artifact.create)
    ...
    ..a<$google$protobuf.Timestamp>(9, 'finishTime', PbFieldType.OM, $google$protobuf.Timestamp.getDefault, $google$protobuf.Timestamp.create)
    ..aOS(11, 'creator')
    ..aOS(13, 'logsBucket')
    ..a<Source>(14, 'sourceProvenance', PbFieldType.OM, Source.getDefault, Source.create)
    ..aOS(15, 'triggerId')
    ..pp<BuildProvenance_BuildOptionsEntry>(16, 'buildOptions', PbFieldType.PM, BuildProvenance_BuildOptionsEntry.$checkItem, BuildProvenance_BuildOptionsEntry.create)
    ..aOS(17, 'builderVersion')
    ..hasRequiredFields = false
  ;

  BuildProvenance() : super();
  BuildProvenance.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  BuildProvenance.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  BuildProvenance clone() => new BuildProvenance()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static BuildProvenance create() => new BuildProvenance();
  static PbList<BuildProvenance> createRepeated() => new PbList<BuildProvenance>();
  static BuildProvenance getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyBuildProvenance();
    return _defaultInstance;
  }
  ...
  set triggerId(String v) { $_setString(10, v); }
  ...
  set builderVersion(String v) { $_setString(12, v); }
  bool hasBuilderVersion() => $_has(12);
  void clearBuilderVersion() => clearField(17);
}

class _ReadonlyBuildProvenance extends BuildProvenance with ReadonlyMessageMixin {}
...
class Source_FileHashesEntry extends GeneratedMessage {
  ...
  Source_FileHashesEntry.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  Source_FileHashesEntry.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  Source_FileHashesEntry clone() => new Source_FileHashesEntry()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static Source_FileHashesEntry create() => new Source_FileHashesEntry();
  static PbList<Source_FileHashesEntry> createRepeated() => new PbList<Source_FileHashesEntry>();
  static Source_FileHashesEntry getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlySource_FileHashesEntry();
    return _defaultInstance;
  }
  static Source_FileHashesEntry _defaultInstance;
  static void $checkItem(Source_FileHashesEntry v) {
    if (v is! Source_FileHashesEntry) checkItemFailed(v, 'Source_FileHashesEntry');
  }
...
class _ReadonlySource_FileHashesEntry extends Source_FileHashesEntry with ReadonlyMessageMixin {}

class Source extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('Source')
    ..a<StorageSource>(1, 'storageSource', PbFieldType.OM, StorageSource.getDefault, StorageSource.create)
    ..a<RepoSource>(2, 'repoSource', PbFieldType.OM, RepoSource.getDefault, RepoSource.create)
    ..pp<Source_FileHashesEntry>(3, 'fileHashes', PbFieldType.PM, Source_FileHashesEntry.$checkItem, Source_FileHashesEntry.create)
    ..a<StorageSource>(4, 'artifactStorageSource', PbFieldType.OM, StorageSource.getDefault, StorageSource.create)
    ..a<SourceContext>(7, 'context', PbFieldType.OM, SourceContext.getDefault, SourceContext.create)
    ..pp<SourceContext>(8, 'additionalContexts', PbFieldType.PM, SourceContext.$checkItem, SourceContext.create)
    ..hasRequiredFields = false
  ;
  ...
  set context(SourceContext v) { setField(7, v); }
...
class Artifact extends GeneratedMessage {
  ...
  Artifact() : super();
  Artifact.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  Artifact.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ...
  set checksum(String v) { $_setString(1, v); }
