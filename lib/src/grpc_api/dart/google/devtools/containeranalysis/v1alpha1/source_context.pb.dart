...
class SourceContext_LabelsEntry extends GeneratedMessage {
  ...
  SourceContext_LabelsEntry.fromBuffer(List<int> i,
      [ExtensionRegistry r = ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);
  SourceContext_LabelsEntry.fromJson(String i,
      [ExtensionRegistry r = ExtensionRegistry.EMPTY])
      : super.fromJson(i, r);
  ...
  static void $checkItem(SourceContext_LabelsEntry v) {
    if (v is! SourceContext_LabelsEntry)
      checkItemFailed(v, 'SourceContext_LabelsEntry');
  }
...
class _ReadonlySourceContext_LabelsEntry extends SourceContext_LabelsEntry
...
class SourceContext extends GeneratedMessage {
  static final BuilderInfo _i = BuilderInfo('SourceContext')
    ...
    ..a<GitSourceContext>(3, 'git', PbFieldType.OM, GitSourceContext.getDefault,
        GitSourceContext.create)
    ..pp<SourceContext_LabelsEntry>(4, 'labels', PbFieldType.PM,
        SourceContext_LabelsEntry.$checkItem, SourceContext_LabelsEntry.create)
    ..hasRequiredFields = false;
...
class AliasContext extends GeneratedMessage {
  static final BuilderInfo _i = BuilderInfo('AliasContext')
    ..e<AliasContext_Kind>(
        ...
        AliasContext_Kind.valueOf,
        AliasContext_Kind.values)
    ..aOS(2, 'name')
    ..hasRequiredFields = false;
