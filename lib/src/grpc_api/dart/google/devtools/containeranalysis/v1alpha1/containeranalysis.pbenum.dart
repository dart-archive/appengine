...
class Note_Kind extends $pb.ProtobufEnum {
  ...
  static const Note_Kind PACKAGE_VULNERABILITY = Note_Kind._(2, 'PACKAGE_VULNERABILITY');
  ...
  static const Note_Kind ATTESTATION_AUTHORITY = Note_Kind._(8, 'ATTESTATION_AUTHORITY');
  ...
  static final $core.Map<$core.int, Note_Kind> _byValue = $pb.ProtobufEnum.initByValue(values);
...
class Deployable_Deployment_Platform extends $pb.ProtobufEnum {
  static const Deployable_Deployment_Platform PLATFORM_UNSPECIFIED = Deployable_Deployment_Platform._(0, 'PLATFORM_UNSPECIFIED');
  static const Deployable_Deployment_Platform GKE = Deployable_Deployment_Platform._(1, 'GKE');
  static const Deployable_Deployment_Platform FLEX = Deployable_Deployment_Platform._(2, 'FLEX');
  static const Deployable_Deployment_Platform CUSTOM = Deployable_Deployment_Platform._(3, 'CUSTOM');

  static const $core.List<Deployable_Deployment_Platform> values = <Deployable_Deployment_Platform> [
  ...
  static final $core.Map<$core.int, Deployable_Deployment_Platform> _byValue = $pb.ProtobufEnum.initByValue(values);
  static Deployable_Deployment_Platform valueOf($core.int value) => _byValue[value];

  const Deployable_Deployment_Platform._($core.int v, $core.String n) : super(v, n);
}

class Discovery_Discovered_AnalysisStatus extends $pb.ProtobufEnum {
  static const Discovery_Discovered_AnalysisStatus ANALYSIS_STATUS_UNSPECIFIED = Discovery_Discovered_AnalysisStatus._(0, 'ANALYSIS_STATUS_UNSPECIFIED');
  static const Discovery_Discovered_AnalysisStatus PENDING = Discovery_Discovered_AnalysisStatus._(1, 'PENDING');
  static const Discovery_Discovered_AnalysisStatus SCANNING = Discovery_Discovered_AnalysisStatus._(2, 'SCANNING');
  static const Discovery_Discovered_AnalysisStatus FINISHED_SUCCESS = Discovery_Discovered_AnalysisStatus._(3, 'FINISHED_SUCCESS');
  static const Discovery_Discovered_AnalysisStatus FINISHED_FAILED = Discovery_Discovered_AnalysisStatus._(4, 'FINISHED_FAILED');
  static const Discovery_Discovered_AnalysisStatus UNSUPPORTED_RESOURCE = Discovery_Discovered_AnalysisStatus._(5, 'UNSUPPORTED_RESOURCE');

  static const $core.List<Discovery_Discovered_AnalysisStatus> values = <Discovery_Discovered_AnalysisStatus> [
  ...
  static final $core.Map<$core.int, Discovery_Discovered_AnalysisStatus> _byValue = $pb.ProtobufEnum.initByValue(values);
  static Discovery_Discovered_AnalysisStatus valueOf($core.int value) => _byValue[value];

  const Discovery_Discovered_AnalysisStatus._($core.int v, $core.String n) : super(v, n);
}
