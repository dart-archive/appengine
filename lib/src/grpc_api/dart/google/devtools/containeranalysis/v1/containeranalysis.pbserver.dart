...
abstract class ContainerAnalysisServiceBase extends $pb.GeneratedService {
  $async.Future<$1.Policy> setIamPolicy(
      $pb.ServerContext ctx, $0.SetIamPolicyRequest request);
  $async.Future<$1.Policy> getIamPolicy(
      $pb.ServerContext ctx, $0.GetIamPolicyRequest request);
  $async.Future<$0.TestIamPermissionsResponse> testIamPermissions(
      $pb.ServerContext ctx, $0.TestIamPermissionsRequest request);

  $pb.GeneratedMessage createRequest($core.String method) {
    switch (method) {
      case 'SetIamPolicy':
        return $0.SetIamPolicyRequest();
      case 'GetIamPolicy':
        return $0.GetIamPolicyRequest();
      case 'TestIamPermissions':
        return $0.TestIamPermissionsRequest();
      default:
