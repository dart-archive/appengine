...
const UpdateScanConfigRequest$json = const {
  ...
  '2': const [
    const {'1': 'name', '3': 1, '4': 1, '5': 9, '10': 'name'},
    const {'1': 'scan_config', '3': 2, '4': 1, '5': 11, '6': '.google.devtools.containeranalysis.v1beta1.ScanConfig', '10': 'scanConfig'},
  ],
};

const ContainerAnalysisV1Beta1ServiceBase$json = const {
  ...
  '2': const [
    ...
    const {'1': 'GetScanConfig', '2': '.google.devtools.containeranalysis.v1beta1.GetScanConfigRequest', '3': '.google.devtools.containeranalysis.v1beta1.ScanConfig', '4': const {}},
    const {'1': 'ListScanConfigs', '2': '.google.devtools.containeranalysis.v1beta1.ListScanConfigsRequest', '3': '.google.devtools.containeranalysis.v1beta1.ListScanConfigsResponse', '4': const {}},
    const {'1': 'UpdateScanConfig', '2': '.google.devtools.containeranalysis.v1beta1.UpdateScanConfigRequest', '3': '.google.devtools.containeranalysis.v1beta1.ScanConfig', '4': const {}},
  ],
};

const ContainerAnalysisV1Beta1ServiceBase$messageJson = const {
  ...
  '.google.devtools.containeranalysis.v1beta1.GetScanConfigRequest': GetScanConfigRequest$json,
  '.google.devtools.containeranalysis.v1beta1.ScanConfig': ScanConfig$json,
  '.google.protobuf.Timestamp': $0.Timestamp$json,
  '.google.devtools.containeranalysis.v1beta1.ListScanConfigsRequest': ListScanConfigsRequest$json,
  '.google.devtools.containeranalysis.v1beta1.ListScanConfigsResponse': ListScanConfigsResponse$json,
  '.google.devtools.containeranalysis.v1beta1.UpdateScanConfigRequest': UpdateScanConfigRequest$json,
};
