...
class Architecture extends $pb.ProtobufEnum {
  static const Architecture ARCHITECTURE_UNSPECIFIED =
      Architecture._(0, 'ARCHITECTURE_UNSPECIFIED');
