...
class Discovery extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Discovery', package: const $pb.PackageName('grafeas.v1beta1.discovery'))
    ..e<$2.NoteKind>(1, 'analysisKind', $pb.PbFieldType.OE, $2.NoteKind.NOTE_KIND_UNSPECIFIED, $2.NoteKind.valueOf, $2.NoteKind.values)
...
class Details extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Details', package: const $pb.PackageName('grafeas.v1beta1.discovery'))
    ..a<Discovered>(1, 'discovered', $pb.PbFieldType.OM, Discovered.getDefault, Discovered.create)
    ..hasRequiredFields = false
  ;
...
class Discovered extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Discovered', package: const $pb.PackageName('grafeas.v1beta1.discovery'))
    ..e<Discovered_ContinuousAnalysis>(1, 'continuousAnalysis', $pb.PbFieldType.OE, Discovered_ContinuousAnalysis.CONTINUOUS_ANALYSIS_UNSPECIFIED, Discovered_ContinuousAnalysis.valueOf, Discovered_ContinuousAnalysis.values)
    ..a<$0.Timestamp>(2, 'lastAnalysisTime', $pb.PbFieldType.OM, $0.Timestamp.getDefault, $0.Timestamp.create)
    ..e<Discovered_AnalysisStatus>(3, 'analysisStatus', $pb.PbFieldType.OE, Discovered_AnalysisStatus.ANALYSIS_STATUS_UNSPECIFIED, Discovered_AnalysisStatus.valueOf, Discovered_AnalysisStatus.values)
    ..a<$1.Status>(4, 'analysisStatusError', $pb.PbFieldType.OM, $1.Status.getDefault, $1.Status.create)
    ..hasRequiredFields = false
  ;

  Discovered() : super();
  Discovered.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  Discovered.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  Discovered clone() => Discovered()..mergeFromMessage(this);
  Discovered copyWith(void Function(Discovered) updates) => super.copyWith((message) => updates(message as Discovered));
  $pb.BuilderInfo get info_ => _i;
