...
class BuildProvenance extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('BuildProvenance',
    ...
    ..aOS(8, 'creator')
    ..aOS(9, 'logsUri')
    ..a<Source>(10, 'sourceProvenance', $pb.PbFieldType.OM, Source.getDefault,
        Source.create)
    ..aOS(11, 'triggerId')
    ..m<$core.String, $core.String>(
        ...
        null,
        null,
        const $pb.PackageName('grafeas.v1beta1.provenance'))
    ..aOS(13, 'builderVersion')
    ..hasRequiredFields = false;

  BuildProvenance() : super();
  BuildProvenance.fromBuffer($core.List<$core.int> i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);
  BuildProvenance.fromJson($core.String i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromJson(i, r);
...
class Source extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Source',
    ...
    ..m<$core.String, FileHashes>(
        ...
        null,
        const $pb.PackageName('grafeas.v1beta1.provenance'))
    ..a<$1.SourceContext>(3, 'context', $pb.PbFieldType.OM,
        $1.SourceContext.getDefault, $1.SourceContext.create)
    ..pc<$1.SourceContext>(
        4, 'additionalContexts', $pb.PbFieldType.PM, $1.SourceContext.create)
    ..hasRequiredFields = false;
