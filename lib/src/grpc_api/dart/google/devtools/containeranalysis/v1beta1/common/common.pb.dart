...
class RelatedUrl extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('RelatedUrl', package: const $pb.PackageName('grafeas.v1beta1'))
    ..aOS(1, 'url')
    ..aOS(2, 'label')
  ...
  RelatedUrl() : super();
  RelatedUrl.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  RelatedUrl.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  RelatedUrl clone() => RelatedUrl()..mergeFromMessage(this);
  RelatedUrl copyWith(void Function(RelatedUrl) updates) => super.copyWith((message) => updates(message as RelatedUrl));
