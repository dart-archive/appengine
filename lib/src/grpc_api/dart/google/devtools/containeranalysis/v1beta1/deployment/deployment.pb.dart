...
class Deployable extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Deployable', package: const $pb.PackageName('grafeas.v1beta1.deployment'))
    ..pPS(1, 'resourceUri')
...
class Details extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Details', package: const $pb.PackageName('grafeas.v1beta1.deployment'))
...
class Deployment extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Deployment', package: const $pb.PackageName('grafeas.v1beta1.deployment'))
    ..aOS(1, 'userEmail')
    ..a<$0.Timestamp>(2, 'deployTime', $pb.PbFieldType.OM, $0.Timestamp.getDefault, $0.Timestamp.create)
    ..a<$0.Timestamp>(3, 'undeployTime', $pb.PbFieldType.OM, $0.Timestamp.getDefault, $0.Timestamp.create)
    ..aOS(4, 'config')
    ..aOS(5, 'address')
    ..pPS(6, 'resourceUri')
    ..e<Deployment_Platform>(7, 'platform', $pb.PbFieldType.OE, Deployment_Platform.PLATFORM_UNSPECIFIED, Deployment_Platform.valueOf, Deployment_Platform.values)
    ..hasRequiredFields = false
  ;
