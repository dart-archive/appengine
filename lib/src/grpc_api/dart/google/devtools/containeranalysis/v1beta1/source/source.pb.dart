...
class SourceContext extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('SourceContext', package: const $pb.PackageName('grafeas.v1beta1.source'))
    ...
    ..m<$core.String, $core.String>(4, 'labels', 'SourceContext.LabelsEntry',$pb.PbFieldType.OS, $pb.PbFieldType.OS, null, null, null , const $pb.PackageName('grafeas.v1beta1.source'))
    ..oo(0, [1, 2, 3])
...
class AliasContext extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('AliasContext', package: const $pb.PackageName('grafeas.v1beta1.source'))
...
class CloudRepoSourceContext extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('CloudRepoSourceContext', package: const $pb.PackageName('grafeas.v1beta1.source'))
...
class GerritSourceContext extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('GerritSourceContext', package: const $pb.PackageName('grafeas.v1beta1.source'))
    ..aOS(1, 'hostUri')
    ..aOS(2, 'gerritProject')
    ..aOS(3, 'revisionId')
...
class GitSourceContext extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('GitSourceContext', package: const $pb.PackageName('grafeas.v1beta1.source'))
    ..aOS(1, 'url')
    ..aOS(2, 'revisionId')
    ..hasRequiredFields = false
  ;
...
class RepoId extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('RepoId', package: const $pb.PackageName('grafeas.v1beta1.source'))
...
class ProjectRepoId extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ProjectRepoId', package: const $pb.PackageName('grafeas.v1beta1.source'))
    ..aOS(1, 'projectId')
    ..aOS(2, 'repoName')
    ..hasRequiredFields = false
  ;
