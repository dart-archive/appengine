...
class PgpSignedAttestation extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('PgpSignedAttestation', package: const $pb.PackageName('grafeas.v1beta1.attestation'))
    ..aOS(1, 'signature')
    ..aOS(2, 'pgpKeyId')
...
class Authority_Hint extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Authority.Hint', package: const $pb.PackageName('grafeas.v1beta1.attestation'))
    ..aOS(1, 'humanReadableName')
    ..hasRequiredFields = false
  ;

  Authority_Hint() : super();
  Authority_Hint.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  Authority_Hint.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  Authority_Hint clone() => Authority_Hint()..mergeFromMessage(this);
  Authority_Hint copyWith(void Function(Authority_Hint) updates) => super.copyWith((message) => updates(message as Authority_Hint));
  $pb.BuilderInfo get info_ => _i;
...
class Authority extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Authority', package: const $pb.PackageName('grafeas.v1beta1.attestation'))
    ..a<Authority_Hint>(1, 'hint', $pb.PbFieldType.OM, Authority_Hint.getDefault, Authority_Hint.create)
    ..hasRequiredFields = false
  ;

  Authority() : super();
  Authority.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  Authority.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
...
class Details extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Details', package: const $pb.PackageName('grafeas.v1beta1.attestation'))
    ..a<Attestation>(1, 'attestation', $pb.PbFieldType.OM, Attestation.getDefault, Attestation.create)
    ..hasRequiredFields = false
  ;
...
class Attestation extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Attestation', package: const $pb.PackageName('grafeas.v1beta1.attestation'))
  ...
  Attestation() : super();
  Attestation.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  Attestation.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  Attestation clone() => Attestation()..mergeFromMessage(this);
  Attestation copyWith(void Function(Attestation) updates) => super.copyWith((message) => updates(message as Attestation));
  $pb.BuilderInfo get info_ => _i;
