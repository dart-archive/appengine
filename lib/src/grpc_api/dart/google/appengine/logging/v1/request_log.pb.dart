...
class LogLine extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('LogLine', package: const $pb.PackageName('google.appengine.logging.v1'))
    ..a<$0.Timestamp>(1, 'time', $pb.PbFieldType.OM, $0.Timestamp.getDefault, $0.Timestamp.create)
    ..e<$2.LogSeverity>(2, 'severity', $pb.PbFieldType.OE, $2.LogSeverity.DEFAULT, $2.LogSeverity.valueOf, $2.LogSeverity.values)
    ..aOS(3, 'logMessage')
    ..a<SourceLocation>(4, 'sourceLocation', $pb.PbFieldType.OM, SourceLocation.getDefault, SourceLocation.create)
    ..hasRequiredFields = false
  ;

  LogLine() : super();
  LogLine.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  LogLine.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  LogLine clone() => LogLine()..mergeFromMessage(this);
  LogLine copyWith(void Function(LogLine) updates) => super.copyWith((message) => updates(message as LogLine));
...
class SourceLocation extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('SourceLocation', package: const $pb.PackageName('google.appengine.logging.v1'))
    ..aOS(1, 'file')
    ..aInt64(2, 'line')
    ..aOS(3, 'functionName')
    ..hasRequiredFields = false
...
class SourceReference extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('SourceReference', package: const $pb.PackageName('google.appengine.logging.v1'))
    ..aOS(1, 'repository')
    ..aOS(2, 'revisionId')
    ..hasRequiredFields = false
  ;
  ...
  SourceReference.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  SourceReference.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  SourceReference clone() => SourceReference()..mergeFromMessage(this);
  SourceReference copyWith(void Function(SourceReference) updates) => super.copyWith((message) => updates(message as SourceReference));
  $pb.BuilderInfo get info_ => _i;
  ...
  static SourceReference getDefault() => _defaultInstance ??= create()..freeze();
...
class RequestLog extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('RequestLog', package: const $pb.PackageName('google.appengine.logging.v1'))
    ..aOS(1, 'appId')
    ..aOS(2, 'versionId')
    ..aOS(3, 'requestId')
    ..aOS(4, 'ip')
    ...
    ..a<$1.Duration>(8, 'latency', $pb.PbFieldType.OM, $1.Duration.getDefault, $1.Duration.create)
    ..aInt64(9, 'megaCycles')
    ..aOS(10, 'method')
    ..aOS(11, 'resource')
    ..aOS(12, 'httpVersion')
    ...
    ..a<$1.Duration>(25, 'pendingTime', $pb.PbFieldType.OM, $1.Duration.getDefault, $1.Duration.create)
    ...
    ..aOS(39, 'traceId')
    ..aOS(40, 'nickname')
    ..pc<SourceReference>(41, 'sourceReference', $pb.PbFieldType.PM,SourceReference.create)
    ..aOB(42, 'first')
    ..hasRequiredFields = false
  ;

  RequestLog() : super();
  RequestLog.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  RequestLog.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  RequestLog clone() => RequestLog()..mergeFromMessage(this);
  RequestLog copyWith(void Function(RequestLog) updates) => super.copyWith((message) => updates(message as RequestLog));
  $pb.BuilderInfo get info_ => _i;
  ...
  set megaCycles(Int64 v) { $_setInt64(7, v); }
  ...
  set responseSize(Int64 v) { $_setInt64(12, v); }
