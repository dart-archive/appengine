...
class LogLine extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('LogLine')
    ...
    ..e<$google$logging$type.LogSeverity>(2, 'severity', PbFieldType.OE, $google$logging$type.LogSeverity.DEFAULT, $google$logging$type.LogSeverity.valueOf, $google$logging$type.LogSeverity.values)
    ..aOS(3, 'logMessage')
  ...
  set severity($google$logging$type.LogSeverity v) { setField(2, v); }
  bool hasSeverity() => $_has(1);
  void clearSeverity() => clearField(2);

  String get logMessage => $_getS(2, '');
  set logMessage(String v) { $_setString(2, v); }
...
class SourceReference extends GeneratedMessage {
  ...
  set repository(String v) { $_setString(0, v); }
...
class RequestLog extends GeneratedMessage {
  ...
  set appId(String v) { $_setString(0, v); }
  bool hasAppId() => $_has(0);
  void clearAppId() => clearField(1);

  String get versionId => $_getS(1, '');
  set versionId(String v) { $_setString(1, v); }
  ...
  set first(bool v) { $_setBool(31, v); }
