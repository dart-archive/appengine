...
class Application extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('Application')
    ...
    ..pp<UrlDispatchRule>(3, 'dispatchRules', PbFieldType.PM,
        UrlDispatchRule.$checkItem, UrlDispatchRule.create)
    ..aOS(6, 'authDomain')
    ..aOS(7, 'locationId')
    ..aOS(8, 'codeBucket')
    ..a<$google$protobuf.Duration>(9, 'defaultCookieExpiration', PbFieldType.OM,
  ...
  Application() : super();
  Application.fromBuffer(List<int> i,
  ...
  set defaultCookieExpiration($google$protobuf.Duration v) {
    setField(9, v);
  }
...
class UrlDispatchRule extends GeneratedMessage {
  ...
  UrlDispatchRule.fromBuffer(List<int> i,
      [ExtensionRegistry r = ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);
...
class _ReadonlyUrlDispatchRule extends UrlDispatchRule
