...
class Application extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Application', package: const $pb.PackageName('google.appengine.v1'))
    ..aOS(1, 'name')
    ..aOS(2, 'id')
    ..pc<UrlDispatchRule>(3, 'dispatchRules', $pb.PbFieldType.PM,UrlDispatchRule.create)
    ..aOS(6, 'authDomain')
    ..aOS(7, 'locationId')
    ..aOS(8, 'codeBucket')
    ..a<$0.Duration>(9, 'defaultCookieExpiration', $pb.PbFieldType.OM, $0.Duration.getDefault, $0.Duration.create)
  ...
  set defaultBucket($core.String v) { $_setString(8, v); }
  $core.bool hasDefaultBucket() => $_has(8);
  void clearDefaultBucket() => clearField(12);
}

class UrlDispatchRule extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('UrlDispatchRule', package: const $pb.PackageName('google.appengine.v1'))
    ..aOS(1, 'domain')
    ..aOS(2, 'path')
    ..aOS(3, 'service')
    ..hasRequiredFields = false
  ...
  UrlDispatchRule.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  UrlDispatchRule.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  UrlDispatchRule clone() => UrlDispatchRule()..mergeFromMessage(this);
  UrlDispatchRule copyWith(void Function(UrlDispatchRule) updates) => super.copyWith((message) => updates(message as UrlDispatchRule));
  $pb.BuilderInfo get info_ => _i;
  ...
  static UrlDispatchRule getDefault() => _defaultInstance ??= create()..freeze();
