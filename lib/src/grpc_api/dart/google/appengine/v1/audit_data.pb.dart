...
class AuditData extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('AuditData')
    ..a<UpdateServiceMethod>(1, 'updateService', PbFieldType.OM, UpdateServiceMethod.getDefault, UpdateServiceMethod.create)
    ..a<CreateVersionMethod>(2, 'createVersion', PbFieldType.OM, CreateVersionMethod.getDefault, CreateVersionMethod.create)
...
class UpdateServiceMethod extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('UpdateServiceMethod')
    ..a<UpdateServiceRequest>(1, 'request', PbFieldType.OM, UpdateServiceRequest.getDefault, UpdateServiceRequest.create)
    ..hasRequiredFields = false
  ;

  UpdateServiceMethod() : super();
  UpdateServiceMethod.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  UpdateServiceMethod.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  UpdateServiceMethod clone() => new UpdateServiceMethod()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static UpdateServiceMethod create() => new UpdateServiceMethod();
  static PbList<UpdateServiceMethod> createRepeated() => new PbList<UpdateServiceMethod>();
  static UpdateServiceMethod getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyUpdateServiceMethod();
    return _defaultInstance;
  }
  ...
  set request(UpdateServiceRequest v) { setField(1, v); }
  bool hasRequest() => $_has(0);
  void clearRequest() => clearField(1);
}

class _ReadonlyUpdateServiceMethod extends UpdateServiceMethod with ReadonlyMessageMixin {}

class CreateVersionMethod extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('CreateVersionMethod')
    ..a<CreateVersionRequest>(1, 'request', PbFieldType.OM, CreateVersionRequest.getDefault, CreateVersionRequest.create)
    ..hasRequiredFields = false
  ;

  CreateVersionMethod() : super();
  CreateVersionMethod.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  CreateVersionMethod.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  CreateVersionMethod clone() => new CreateVersionMethod()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static CreateVersionMethod create() => new CreateVersionMethod();
  static PbList<CreateVersionMethod> createRepeated() => new PbList<CreateVersionMethod>();
  static CreateVersionMethod getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyCreateVersionMethod();
    return _defaultInstance;
  }
  ...
  set request(CreateVersionRequest v) { setField(1, v); }
  bool hasRequest() => $_has(0);
  void clearRequest() => clearField(1);
}

class _ReadonlyCreateVersionMethod extends CreateVersionMethod with ReadonlyMessageMixin {}
