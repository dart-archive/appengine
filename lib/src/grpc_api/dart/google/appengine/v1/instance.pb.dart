...
class Instance extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('Instance')
    ...
    ..e<Instance_Availability>(4, 'availability', PbFieldType.OE, Instance_Availability.UNSPECIFIED, Instance_Availability.valueOf, Instance_Availability.values)
    ..aOS(5, 'vmName')
    ..aOS(6, 'vmZoneName')
    ..aOS(7, 'vmId')
  ...
  set appEngineRelease(String v) { $_setString(2, v); }
