...
class Instance extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Instance', package: const $pb.PackageName('google.appengine.v1'))
    ..aOS(1, 'name')
    ..aOS(2, 'id')
    ..aOS(3, 'appEngineRelease')
    ..e<Instance_Availability>(4, 'availability', $pb.PbFieldType.OE, Instance_Availability.UNSPECIFIED, Instance_Availability.valueOf, Instance_Availability.values)
    ..aOS(5, 'vmName')
    ..aOS(6, 'vmZoneName')
    ..aOS(7, 'vmId')
