...
class Service extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Service', package: const $pb.PackageName('google.appengine.v1'))
    ..aOS(1, 'name')
    ..aOS(2, 'id')
    ..a<TrafficSplit>(3, 'split', $pb.PbFieldType.OM, TrafficSplit.getDefault, TrafficSplit.create)
...
class TrafficSplit extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('TrafficSplit', package: const $pb.PackageName('google.appengine.v1'))
    ..e<TrafficSplit_ShardBy>(1, 'shardBy', $pb.PbFieldType.OE, TrafficSplit_ShardBy.UNSPECIFIED, TrafficSplit_ShardBy.valueOf, TrafficSplit_ShardBy.values)
    ..m<$core.String, $core.double>(2, 'allocations', 'TrafficSplit.AllocationsEntry',$pb.PbFieldType.OS, $pb.PbFieldType.OD, null, null, null , const $pb.PackageName('google.appengine.v1'))
    ..hasRequiredFields = false
  ;

  TrafficSplit() : super();
  TrafficSplit.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  TrafficSplit.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  TrafficSplit clone() => TrafficSplit()..mergeFromMessage(this);
  TrafficSplit copyWith(void Function(TrafficSplit) updates) => super.copyWith((message) => updates(message as TrafficSplit));
  $pb.BuilderInfo get info_ => _i;
