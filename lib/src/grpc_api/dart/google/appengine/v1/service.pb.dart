...
class TrafficSplit_AllocationsEntry extends GeneratedMessage {
  ...
  TrafficSplit_AllocationsEntry.fromBuffer(List<int> i,
      [ExtensionRegistry r = ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);
  TrafficSplit_AllocationsEntry.fromJson(String i,
      [ExtensionRegistry r = ExtensionRegistry.EMPTY])
      : super.fromJson(i, r);
  ...
  static void $checkItem(TrafficSplit_AllocationsEntry v) {
    if (v is! TrafficSplit_AllocationsEntry)
      checkItemFailed(v, 'TrafficSplit_AllocationsEntry');
  }
...
class _ReadonlyTrafficSplit_AllocationsEntry
...
class TrafficSplit extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('TrafficSplit')
    ...
    ..pp<TrafficSplit_AllocationsEntry>(
        2,
        'allocations',
        PbFieldType.PM,
        TrafficSplit_AllocationsEntry.$checkItem,
        TrafficSplit_AllocationsEntry.create)
    ..hasRequiredFields = false;

  TrafficSplit() : super();
  TrafficSplit.fromBuffer(List<int> i,
      [ExtensionRegistry r = ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);
