...
class Version extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('Version')
    ...
    ..pp<InboundServiceType>(6, 'inboundServices', PbFieldType.PE, InboundServiceType.$checkItem, null, InboundServiceType.valueOf, InboundServiceType.values)
    ..aOS(7, 'instanceClass')
    ...
    ..aOS(14, 'env')
    ..e<ServingStatus>(15, 'servingStatus', PbFieldType.OE, ServingStatus.SERVING_STATUS_UNSPECIFIED, ServingStatus.valueOf, ServingStatus.values)
    ..aOS(16, 'createdBy')
  ...
  set instanceClass(String v) { $_setString(6, v); }
  ...
  set env(String v) { $_setString(13, v); }
  bool hasEnv() => $_has(13);
  ...
  set apiConfig(ApiConfigHandler v) { setField(103, v); }
...
class AutomaticScaling extends GeneratedMessage {
  ...
  set coolDownPeriod($google$protobuf.Duration v) { setField(1, v); }
  ...
  set minPendingLatency($google$protobuf.Duration v) { setField(9, v); }
...
class BasicScaling extends GeneratedMessage {
  ...
  set idleTimeout($google$protobuf.Duration v) { setField(1, v); }
  bool hasIdleTimeout() => $_has(0);
  void clearIdleTimeout() => clearField(1);

  int get maxInstances => $_get(1, 0);
  set maxInstances(int v) { $_setSignedInt32(1, v); }
...
class ManualScaling extends GeneratedMessage {
  ...
  set instances(int v) { $_setSignedInt32(0, v); }
...
class RequestUtilization extends GeneratedMessage {
  ...
  set targetRequestCountPerSecond(int v) { $_setSignedInt32(0, v); }
  ...
  set targetConcurrentRequests(int v) { $_setSignedInt32(1, v); }
...
class DiskUtilization extends GeneratedMessage {
  ...
  set targetWriteBytesPerSecond(int v) { $_setSignedInt32(0, v); }
  ...
  set targetWriteOpsPerSecond(int v) { $_setSignedInt32(1, v); }
  ...
  set targetReadBytesPerSecond(int v) { $_setSignedInt32(2, v); }
  ...
  set targetReadOpsPerSecond(int v) { $_setSignedInt32(3, v); }
...
class NetworkUtilization extends GeneratedMessage {
  ...
  set targetSentBytesPerSecond(int v) { $_setSignedInt32(0, v); }
  ...
  set targetSentPacketsPerSecond(int v) { $_setSignedInt32(1, v); }
  ...
  set targetReceivedBytesPerSecond(int v) { $_setSignedInt32(2, v); }
  ...
  set targetReceivedPacketsPerSecond(int v) { $_setSignedInt32(3, v); }
...
class Network extends GeneratedMessage {
  ...
  set instanceTag(String v) { $_setString(1, v); }
