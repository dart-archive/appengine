...
abstract class FirestoreServiceBase extends $pb.GeneratedService {
  $async.Future<$2.Document> getDocument($pb.ServerContext ctx, GetDocumentRequest request);
  $async.Future<ListDocumentsResponse> listDocuments($pb.ServerContext ctx, ListDocumentsRequest request);
  $async.Future<$2.Document> createDocument($pb.ServerContext ctx, CreateDocumentRequest request);
  $async.Future<$2.Document> updateDocument($pb.ServerContext ctx, UpdateDocumentRequest request);
  $async.Future<$6.Empty> deleteDocument($pb.ServerContext ctx, DeleteDocumentRequest request);
  $async.Future<BatchGetDocumentsResponse> batchGetDocuments($pb.ServerContext ctx, BatchGetDocumentsRequest request);
  ...
  $async.Future<$6.Empty> rollback($pb.ServerContext ctx, RollbackRequest request);
  ...
  $async.Future<ListenResponse> listen($pb.ServerContext ctx, ListenRequest request);
  $async.Future<ListCollectionIdsResponse> listCollectionIds($pb.ServerContext ctx, ListCollectionIdsRequest request);
  ...
  $pb.GeneratedMessage createRequest($core.String method) {
    switch (method) {
      ...
      case 'BatchGetDocuments': return BatchGetDocumentsRequest();
      ...
      case 'Listen': return ListenRequest();
      case 'ListCollectionIds': return ListCollectionIdsRequest();
