...
class Document extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Document', package: const $pb.PackageName('google.firestore.v1'))
    ..aOS(1, 'name')
    ..m<$core.String, Value>(2, 'fields', 'Document.FieldsEntry',$pb.PbFieldType.OS, $pb.PbFieldType.OM, Value.create, null, null , const $pb.PackageName('google.firestore.v1'))
...
class Value extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Value', package: const $pb.PackageName('google.firestore.v1'))
    ..aOB(1, 'booleanValue')
...
class ArrayValue extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ArrayValue', package: const $pb.PackageName('google.firestore.v1'))
...
class MapValue extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('MapValue', package: const $pb.PackageName('google.firestore.v1'))
    ..m<$core.String, Value>(1, 'fields', 'MapValue.FieldsEntry',$pb.PbFieldType.OS, $pb.PbFieldType.OM, Value.create, null, null , const $pb.PackageName('google.firestore.v1'))
    ..hasRequiredFields = false
  ;
