...
class StructuredQuery_CollectionSelector extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('StructuredQuery.CollectionSelector', package: const $pb.PackageName('google.firestore.v1'))
    ..aOS(2, 'collectionId')
...
class StructuredQuery_Filter extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('StructuredQuery.Filter', package: const $pb.PackageName('google.firestore.v1'))
...
class StructuredQuery_CompositeFilter extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('StructuredQuery.CompositeFilter', package: const $pb.PackageName('google.firestore.v1'))
...
class StructuredQuery_FieldFilter extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('StructuredQuery.FieldFilter', package: const $pb.PackageName('google.firestore.v1'))
...
class StructuredQuery_UnaryFilter extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('StructuredQuery.UnaryFilter', package: const $pb.PackageName('google.firestore.v1'))
...
class StructuredQuery_FieldReference extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('StructuredQuery.FieldReference', package: const $pb.PackageName('google.firestore.v1'))
    ..aOS(2, 'fieldPath')
    ..hasRequiredFields = false
  ;
...
class StructuredQuery_Order extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('StructuredQuery.Order', package: const $pb.PackageName('google.firestore.v1'))
    ..a<StructuredQuery_FieldReference>(1, 'field_1', $pb.PbFieldType.OM, StructuredQuery_FieldReference.getDefault, StructuredQuery_FieldReference.create)
...
class StructuredQuery_Projection extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('StructuredQuery.Projection', package: const $pb.PackageName('google.firestore.v1'))
...
class StructuredQuery extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('StructuredQuery', package: const $pb.PackageName('google.firestore.v1'))
...
class Cursor extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Cursor', package: const $pb.PackageName('google.firestore.v1'))
