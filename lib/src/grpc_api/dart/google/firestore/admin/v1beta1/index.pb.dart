...
class IndexField extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('IndexField')
    ..aOS(1, 'fieldPath')
    ..e<IndexField_Mode>(2, 'mode', PbFieldType.OE, IndexField_Mode.MODE_UNSPECIFIED, IndexField_Mode.valueOf, IndexField_Mode.values)
    ..hasRequiredFields = false
  ;

  IndexField() : super();
  IndexField.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  IndexField.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
...
class Index extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('Index')
    ..aOS(1, 'name')
    ..aOS(2, 'collectionId')
    ..pp<IndexField>(3, 'fields', PbFieldType.PM, IndexField.$checkItem, IndexField.create)
    ..e<Index_State>(6, 'state', PbFieldType.OE, Index_State.STATE_UNSPECIFIED, Index_State.valueOf, Index_State.values)
    ..hasRequiredFields = false
  ;
