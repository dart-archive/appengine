...
class IndexField_Mode extends ProtobufEnum {
  static const IndexField_Mode MODE_UNSPECIFIED = const IndexField_Mode._(0, 'MODE_UNSPECIFIED');
  static const IndexField_Mode ASCENDING = const IndexField_Mode._(2, 'ASCENDING');
  static const IndexField_Mode DESCENDING = const IndexField_Mode._(3, 'DESCENDING');
  ...
  static IndexField_Mode valueOf(int value) => _byValue[value] as IndexField_Mode;
...
class Index_State extends ProtobufEnum {
  static const Index_State STATE_UNSPECIFIED = const Index_State._(0, 'STATE_UNSPECIFIED');
