...
class OperationState extends $pb.ProtobufEnum {
  static const OperationState STATE_UNSPECIFIED = OperationState._(0, 'STATE_UNSPECIFIED');
...
class IndexOperationMetadata_OperationType extends $pb.ProtobufEnum {
  static const IndexOperationMetadata_OperationType OPERATION_TYPE_UNSPECIFIED = IndexOperationMetadata_OperationType._(0, 'OPERATION_TYPE_UNSPECIFIED');
  static const IndexOperationMetadata_OperationType CREATING_INDEX = IndexOperationMetadata_OperationType._(1, 'CREATING_INDEX');
