...
class IndexOperationMetadata extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('IndexOperationMetadata', package: const $pb.PackageName('google.firestore.admin.v1beta1'))
    ...
    ..aOS(3, 'index')
    ..e<IndexOperationMetadata_OperationType>(4, 'operationType', $pb.PbFieldType.OE, IndexOperationMetadata_OperationType.OPERATION_TYPE_UNSPECIFIED, IndexOperationMetadata_OperationType.valueOf, IndexOperationMetadata_OperationType.values)
    ..aOB(5, 'cancelled')
    ..a<Progress>(6, 'documentProgress', $pb.PbFieldType.OM, Progress.getDefault, Progress.create)
...
class Progress extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Progress', package: const $pb.PackageName('google.firestore.admin.v1beta1'))
...
class CreateIndexRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('CreateIndexRequest', package: const $pb.PackageName('google.firestore.admin.v1beta1'))
    ..aOS(1, 'parent')
    ..a<$1.Index>(2, 'index', $pb.PbFieldType.OM, $1.Index.getDefault, $1.Index.create)
    ..hasRequiredFields = false
  ;
...
class GetIndexRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('GetIndexRequest', package: const $pb.PackageName('google.firestore.admin.v1beta1'))
    ..aOS(1, 'name')
    ..hasRequiredFields = false
  ;
...
class ListIndexesRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ListIndexesRequest', package: const $pb.PackageName('google.firestore.admin.v1beta1'))
    ..aOS(1, 'parent')
    ..aOS(2, 'filter')
...
class DeleteIndexRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('DeleteIndexRequest', package: const $pb.PackageName('google.firestore.admin.v1beta1'))
    ..aOS(1, 'name')
    ..hasRequiredFields = false
  ;
...
class ListIndexesResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ListIndexesResponse', package: const $pb.PackageName('google.firestore.admin.v1beta1'))
...
class ExportDocumentsRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ExportDocumentsRequest', package: const $pb.PackageName('google.firestore.admin.v1beta1'))
    ..aOS(1, 'name')
    ..pPS(3, 'collectionIds')
...
class ImportDocumentsRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ImportDocumentsRequest', package: const $pb.PackageName('google.firestore.admin.v1beta1'))
    ..aOS(1, 'name')
    ..pPS(3, 'collectionIds')
...
class ExportDocumentsResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ExportDocumentsResponse', package: const $pb.PackageName('google.firestore.admin.v1beta1'))
    ..aOS(1, 'outputUriPrefix')
    ..hasRequiredFields = false
  ;

  ExportDocumentsResponse() : super();
  ExportDocumentsResponse.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  ExportDocumentsResponse.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ExportDocumentsResponse clone() => ExportDocumentsResponse()..mergeFromMessage(this);
  ExportDocumentsResponse copyWith(void Function(ExportDocumentsResponse) updates) => super.copyWith((message) => updates(message as ExportDocumentsResponse));
  $pb.BuilderInfo get info_ => _i;
  ...
  static ExportDocumentsResponse getDefault() => _defaultInstance ??= create()..freeze();
...
class ExportDocumentsMetadata extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ExportDocumentsMetadata', package: const $pb.PackageName('google.firestore.admin.v1beta1'))
    ..a<$0.Timestamp>(1, 'startTime', $pb.PbFieldType.OM, $0.Timestamp.getDefault, $0.Timestamp.create)
    ..a<$0.Timestamp>(2, 'endTime', $pb.PbFieldType.OM, $0.Timestamp.getDefault, $0.Timestamp.create)
    ..e<OperationState>(3, 'operationState', $pb.PbFieldType.OE, OperationState.STATE_UNSPECIFIED, OperationState.valueOf, OperationState.values)
    ..a<Progress>(4, 'progressDocuments', $pb.PbFieldType.OM, Progress.getDefault, Progress.create)
    ..a<Progress>(5, 'progressBytes', $pb.PbFieldType.OM, Progress.getDefault, Progress.create)
    ..pPS(6, 'collectionIds')
  ...
  ExportDocumentsMetadata.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  ExportDocumentsMetadata.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ExportDocumentsMetadata clone() => ExportDocumentsMetadata()..mergeFromMessage(this);
  ExportDocumentsMetadata copyWith(void Function(ExportDocumentsMetadata) updates) => super.copyWith((message) => updates(message as ExportDocumentsMetadata));
  $pb.BuilderInfo get info_ => _i;
  ...
  static ExportDocumentsMetadata getDefault() => _defaultInstance ??= create()..freeze();
...
class ImportDocumentsMetadata extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ImportDocumentsMetadata', package: const $pb.PackageName('google.firestore.admin.v1beta1'))
    ..a<$0.Timestamp>(1, 'startTime', $pb.PbFieldType.OM, $0.Timestamp.getDefault, $0.Timestamp.create)
    ..a<$0.Timestamp>(2, 'endTime', $pb.PbFieldType.OM, $0.Timestamp.getDefault, $0.Timestamp.create)
    ..e<OperationState>(3, 'operationState', $pb.PbFieldType.OE, OperationState.STATE_UNSPECIFIED, OperationState.valueOf, OperationState.values)
    ..a<Progress>(4, 'progressDocuments', $pb.PbFieldType.OM, Progress.getDefault, Progress.create)
  ...
  ImportDocumentsMetadata.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  ImportDocumentsMetadata.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ImportDocumentsMetadata clone() => ImportDocumentsMetadata()..mergeFromMessage(this);
  ImportDocumentsMetadata copyWith(void Function(ImportDocumentsMetadata) updates) => super.copyWith((message) => updates(message as ImportDocumentsMetadata));
  $pb.BuilderInfo get info_ => _i;
  ...
  static ImportDocumentsMetadata getDefault() => _defaultInstance ??= create()..freeze();
...
class FirestoreAdminApi {
  ...
  $async.Future<$2.Operation> createIndex($pb.ClientContext ctx, CreateIndexRequest request) {
    var emptyResponse = $2.Operation();
    return _client.invoke<$2.Operation>(ctx, 'FirestoreAdmin', 'CreateIndex', request, emptyResponse);
  }
  ...
  $async.Future<$1.Index> getIndex($pb.ClientContext ctx, GetIndexRequest request) {
    ...
    return _client.invoke<$1.Index>(ctx, 'FirestoreAdmin', 'GetIndex', request, emptyResponse);
  }
  $async.Future<$3.Empty> deleteIndex($pb.ClientContext ctx, DeleteIndexRequest request) {
    var emptyResponse = $3.Empty();
    return _client.invoke<$3.Empty>(ctx, 'FirestoreAdmin', 'DeleteIndex', request, emptyResponse);
  }
  $async.Future<$2.Operation> exportDocuments($pb.ClientContext ctx, ExportDocumentsRequest request) {
    var emptyResponse = $2.Operation();
    return _client.invoke<$2.Operation>(ctx, 'FirestoreAdmin', 'ExportDocuments', request, emptyResponse);
  }
  $async.Future<$2.Operation> importDocuments($pb.ClientContext ctx, ImportDocumentsRequest request) {
    var emptyResponse = $2.Operation();
    return _client.invoke<$2.Operation>(ctx, 'FirestoreAdmin', 'ImportDocuments', request, emptyResponse);
  }
}
