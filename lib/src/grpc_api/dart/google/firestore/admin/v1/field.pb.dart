...
class Field_IndexConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Field.IndexConfig', package: const $pb.PackageName('google.firestore.admin.v1'))
...
class Field extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Field', package: const $pb.PackageName('google.firestore.admin.v1'))
    ..aOS(1, 'name')
