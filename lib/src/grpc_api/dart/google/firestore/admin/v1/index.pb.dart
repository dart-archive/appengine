...
class Index_IndexField extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Index.IndexField', package: const $pb.PackageName('google.firestore.admin.v1'))
    ..aOS(1, 'fieldPath')
...
class Index extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Index', package: const $pb.PackageName('google.firestore.admin.v1'))
    ..aOS(1, 'name')
