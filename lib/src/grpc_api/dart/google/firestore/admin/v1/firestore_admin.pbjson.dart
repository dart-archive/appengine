...
const UpdateFieldRequest$json = const {
  ...
  '2': const [
    const {'1': 'field', '3': 1, '4': 1, '5': 11, '6': '.google.firestore.admin.v1.Field', '10': 'field'},
...
const FirestoreAdminServiceBase$json = const {
  '1': 'FirestoreAdmin',
  '2': const [
    const {'1': 'CreateIndex', '2': '.google.firestore.admin.v1.CreateIndexRequest', '3': '.google.longrunning.Operation', '4': const {}},
    const {'1': 'ListIndexes', '2': '.google.firestore.admin.v1.ListIndexesRequest', '3': '.google.firestore.admin.v1.ListIndexesResponse', '4': const {}},
    const {'1': 'GetIndex', '2': '.google.firestore.admin.v1.GetIndexRequest', '3': '.google.firestore.admin.v1.Index', '4': const {}},
    const {'1': 'DeleteIndex', '2': '.google.firestore.admin.v1.DeleteIndexRequest', '3': '.google.protobuf.Empty', '4': const {}},
    const {'1': 'GetField', '2': '.google.firestore.admin.v1.GetFieldRequest', '3': '.google.firestore.admin.v1.Field', '4': const {}},
    const {'1': 'UpdateField', '2': '.google.firestore.admin.v1.UpdateFieldRequest', '3': '.google.longrunning.Operation', '4': const {}},
    const {'1': 'ListFields', '2': '.google.firestore.admin.v1.ListFieldsRequest', '3': '.google.firestore.admin.v1.ListFieldsResponse', '4': const {}},
    const {'1': 'ExportDocuments', '2': '.google.firestore.admin.v1.ExportDocumentsRequest', '3': '.google.longrunning.Operation', '4': const {}},
    const {'1': 'ImportDocuments', '2': '.google.firestore.admin.v1.ImportDocumentsRequest', '3': '.google.longrunning.Operation', '4': const {}},
  ],
};
...
const FirestoreAdminServiceBase$messageJson = const {
  ...
  '.google.firestore.admin.v1.ExportDocumentsRequest': ExportDocumentsRequest$json,
  '.google.firestore.admin.v1.ImportDocumentsRequest': ImportDocumentsRequest$json,
};
