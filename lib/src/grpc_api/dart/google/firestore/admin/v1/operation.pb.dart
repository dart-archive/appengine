...
class IndexOperationMetadata extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('IndexOperationMetadata', package: const $pb.PackageName('google.firestore.admin.v1'))
...
class FieldOperationMetadata_IndexConfigDelta extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('FieldOperationMetadata.IndexConfigDelta', package: const $pb.PackageName('google.firestore.admin.v1'))
...
class FieldOperationMetadata extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('FieldOperationMetadata', package: const $pb.PackageName('google.firestore.admin.v1'))
    ..a<$0.Timestamp>(1, 'startTime', $pb.PbFieldType.OM, $0.Timestamp.getDefault, $0.Timestamp.create)
    ..a<$0.Timestamp>(2, 'endTime', $pb.PbFieldType.OM, $0.Timestamp.getDefault, $0.Timestamp.create)
    ..aOS(3, 'field_3')
    ...
    ..a<Progress>(6, 'progressDocuments', $pb.PbFieldType.OM, Progress.getDefault, Progress.create)
    ..a<Progress>(7, 'progressBytes', $pb.PbFieldType.OM, Progress.getDefault, Progress.create)
    ..hasRequiredFields = false
  ;
...
class ExportDocumentsMetadata extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ExportDocumentsMetadata', package: const $pb.PackageName('google.firestore.admin.v1'))
    ..a<$0.Timestamp>(1, 'startTime', $pb.PbFieldType.OM, $0.Timestamp.getDefault, $0.Timestamp.create)
    ..a<$0.Timestamp>(2, 'endTime', $pb.PbFieldType.OM, $0.Timestamp.getDefault, $0.Timestamp.create)
...
class ImportDocumentsMetadata extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ImportDocumentsMetadata', package: const $pb.PackageName('google.firestore.admin.v1'))
    ..a<$0.Timestamp>(1, 'startTime', $pb.PbFieldType.OM, $0.Timestamp.getDefault, $0.Timestamp.create)
    ..a<$0.Timestamp>(2, 'endTime', $pb.PbFieldType.OM, $0.Timestamp.getDefault, $0.Timestamp.create)
    ..e<OperationState>(3, 'operationState', $pb.PbFieldType.OE, OperationState.OPERATION_STATE_UNSPECIFIED, OperationState.valueOf, OperationState.values)
    ..a<Progress>(4, 'progressDocuments', $pb.PbFieldType.OM, Progress.getDefault, Progress.create)
...
class ExportDocumentsResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ExportDocumentsResponse', package: const $pb.PackageName('google.firestore.admin.v1'))
...
class Progress extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Progress', package: const $pb.PackageName('google.firestore.admin.v1'))
