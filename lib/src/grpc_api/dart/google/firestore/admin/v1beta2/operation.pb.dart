...
class IndexOperationMetadata extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('IndexOperationMetadata', package: const $pb.PackageName('google.firestore.admin.v1beta2'))
    ...
    ..aOS(3, 'index')
    ..e<OperationState>(4, 'state', $pb.PbFieldType.OE, OperationState.OPERATION_STATE_UNSPECIFIED, OperationState.valueOf, OperationState.values)
    ..a<Progress>(5, 'progressDocuments', $pb.PbFieldType.OM, Progress.getDefault, Progress.create)
    ..a<Progress>(6, 'progressBytes', $pb.PbFieldType.OM, Progress.getDefault, Progress.create)
...
class FieldOperationMetadata_IndexConfigDelta extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('FieldOperationMetadata.IndexConfigDelta', package: const $pb.PackageName('google.firestore.admin.v1beta2'))
    ..e<FieldOperationMetadata_IndexConfigDelta_ChangeType>(1, 'changeType', $pb.PbFieldType.OE, FieldOperationMetadata_IndexConfigDelta_ChangeType.CHANGE_TYPE_UNSPECIFIED, FieldOperationMetadata_IndexConfigDelta_ChangeType.valueOf, FieldOperationMetadata_IndexConfigDelta_ChangeType.values)
    ..a<$1.Index>(2, 'index', $pb.PbFieldType.OM, $1.Index.getDefault, $1.Index.create)
    ..hasRequiredFields = false
  ;

  FieldOperationMetadata_IndexConfigDelta() : super();
  FieldOperationMetadata_IndexConfigDelta.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  FieldOperationMetadata_IndexConfigDelta.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  FieldOperationMetadata_IndexConfigDelta clone() => FieldOperationMetadata_IndexConfigDelta()..mergeFromMessage(this);
  FieldOperationMetadata_IndexConfigDelta copyWith(void Function(FieldOperationMetadata_IndexConfigDelta) updates) => super.copyWith((message) => updates(message as FieldOperationMetadata_IndexConfigDelta));
  $pb.BuilderInfo get info_ => _i;
  static FieldOperationMetadata_IndexConfigDelta create() => FieldOperationMetadata_IndexConfigDelta();
  ...
  static FieldOperationMetadata_IndexConfigDelta getDefault() => _defaultInstance ??= create()..freeze();
...
class FieldOperationMetadata extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('FieldOperationMetadata', package: const $pb.PackageName('google.firestore.admin.v1beta2'))
    ..a<$0.Timestamp>(1, 'startTime', $pb.PbFieldType.OM, $0.Timestamp.getDefault, $0.Timestamp.create)
    ..a<$0.Timestamp>(2, 'endTime', $pb.PbFieldType.OM, $0.Timestamp.getDefault, $0.Timestamp.create)
    ..aOS(3, 'field_3')
    ..pc<FieldOperationMetadata_IndexConfigDelta>(4, 'indexConfigDeltas', $pb.PbFieldType.PM,FieldOperationMetadata_IndexConfigDelta.create)
    ..e<OperationState>(5, 'state', $pb.PbFieldType.OE, OperationState.OPERATION_STATE_UNSPECIFIED, OperationState.valueOf, OperationState.values)
    ..a<Progress>(6, 'documentProgress', $pb.PbFieldType.OM, Progress.getDefault, Progress.create)
    ..a<Progress>(7, 'bytesProgress', $pb.PbFieldType.OM, Progress.getDefault, Progress.create)
    ..hasRequiredFields = false
  ;

  FieldOperationMetadata() : super();
  FieldOperationMetadata.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  FieldOperationMetadata.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  FieldOperationMetadata clone() => FieldOperationMetadata()..mergeFromMessage(this);
  FieldOperationMetadata copyWith(void Function(FieldOperationMetadata) updates) => super.copyWith((message) => updates(message as FieldOperationMetadata));
  $pb.BuilderInfo get info_ => _i;
  ...
  static FieldOperationMetadata getDefault() => _defaultInstance ??= create()..freeze();
...
class ExportDocumentsMetadata extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ExportDocumentsMetadata', package: const $pb.PackageName('google.firestore.admin.v1beta2'))
    ..a<$0.Timestamp>(1, 'startTime', $pb.PbFieldType.OM, $0.Timestamp.getDefault, $0.Timestamp.create)
    ..a<$0.Timestamp>(2, 'endTime', $pb.PbFieldType.OM, $0.Timestamp.getDefault, $0.Timestamp.create)
    ..e<OperationState>(3, 'operationState', $pb.PbFieldType.OE, OperationState.OPERATION_STATE_UNSPECIFIED, OperationState.valueOf, OperationState.values)
...
class ImportDocumentsMetadata extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ImportDocumentsMetadata', package: const $pb.PackageName('google.firestore.admin.v1beta2'))
    ..a<$0.Timestamp>(1, 'startTime', $pb.PbFieldType.OM, $0.Timestamp.getDefault, $0.Timestamp.create)
    ..a<$0.Timestamp>(2, 'endTime', $pb.PbFieldType.OM, $0.Timestamp.getDefault, $0.Timestamp.create)
    ..e<OperationState>(3, 'operationState', $pb.PbFieldType.OE, OperationState.OPERATION_STATE_UNSPECIFIED, OperationState.valueOf, OperationState.values)
    ..a<Progress>(4, 'progressDocuments', $pb.PbFieldType.OM, Progress.getDefault, Progress.create)
...
class ExportDocumentsResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ExportDocumentsResponse', package: const $pb.PackageName('google.firestore.admin.v1beta2'))
...
class Progress extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Progress', package: const $pb.PackageName('google.firestore.admin.v1beta2'))
