...
class Field_IndexConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Field.IndexConfig', package: const $pb.PackageName('google.firestore.admin.v1beta2'))
  ...
  Field_IndexConfig.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  Field_IndexConfig.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  Field_IndexConfig clone() => Field_IndexConfig()..mergeFromMessage(this);
  Field_IndexConfig copyWith(void Function(Field_IndexConfig) updates) => super.copyWith((message) => updates(message as Field_IndexConfig));
  ...
  static Field_IndexConfig getDefault() => _defaultInstance ??= create()..freeze();
...
class Field extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Field', package: const $pb.PackageName('google.firestore.admin.v1beta2'))
    ..aOS(1, 'name')
    ..a<Field_IndexConfig>(2, 'indexConfig', $pb.PbFieldType.OM, Field_IndexConfig.getDefault, Field_IndexConfig.create)
    ..hasRequiredFields = false
  ;
