...
class Index_IndexField extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Index.IndexField', package: const $pb.PackageName('google.firestore.admin.v1beta2'))
    ..aOS(1, 'fieldPath')
    ..e<Index_IndexField_Order>(2, 'order', $pb.PbFieldType.OE, Index_IndexField_Order.ORDER_UNSPECIFIED, Index_IndexField_Order.valueOf, Index_IndexField_Order.values)
    ..e<Index_IndexField_ArrayConfig>(3, 'arrayConfig', $pb.PbFieldType.OE, Index_IndexField_ArrayConfig.ARRAY_CONFIG_UNSPECIFIED, Index_IndexField_ArrayConfig.valueOf, Index_IndexField_ArrayConfig.values)
    ..oo(0, [2, 3])
    ..hasRequiredFields = false
  ;

  Index_IndexField() : super();
  Index_IndexField.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  Index_IndexField.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  Index_IndexField clone() => Index_IndexField()..mergeFromMessage(this);
  Index_IndexField copyWith(void Function(Index_IndexField) updates) => super.copyWith((message) => updates(message as Index_IndexField));
  ...
  static Index_IndexField getDefault() => _defaultInstance ??= create()..freeze();
...
class Index extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Index', package: const $pb.PackageName('google.firestore.admin.v1beta2'))
    ..aOS(1, 'name')
    ..e<Index_QueryScope>(2, 'queryScope', $pb.PbFieldType.OE, Index_QueryScope.QUERY_SCOPE_UNSPECIFIED, Index_QueryScope.valueOf, Index_QueryScope.values)
    ..pc<Index_IndexField>(3, 'fields', $pb.PbFieldType.PM,Index_IndexField.create)
    ..e<Index_State>(4, 'state', $pb.PbFieldType.OE, Index_State.STATE_UNSPECIFIED, Index_State.valueOf, Index_State.values)
    ..hasRequiredFields = false
  ;
