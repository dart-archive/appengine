...
class Document_FieldsEntry extends GeneratedMessage {
  ...
  Document_FieldsEntry.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  Document_FieldsEntry.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ...
  static PbList<Document_FieldsEntry> createRepeated() => new PbList<Document_FieldsEntry>();
  static Document_FieldsEntry getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyDocument_FieldsEntry();
...
class _ReadonlyDocument_FieldsEntry extends Document_FieldsEntry with ReadonlyMessageMixin {}

class Document extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('Document')
    ..aOS(1, 'name')
    ..pp<Document_FieldsEntry>(2, 'fields', PbFieldType.PM, Document_FieldsEntry.$checkItem, Document_FieldsEntry.create)
...
class Value extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('Value')
    ...
    ..a<MapValue>(6, 'mapValue', PbFieldType.OM, MapValue.getDefault, MapValue.create)
    ...
    ..e<$google$protobuf.NullValue>(11, 'nullValue', PbFieldType.OE, $google$protobuf.NullValue.NULL_VALUE, $google$protobuf.NullValue.valueOf, $google$protobuf.NullValue.values)
    ..aOS(17, 'stringValue')
  ...
  set geoPointValue($google$type.LatLng v) { setField(8, v); }
  ...
  set timestampValue($google$protobuf.Timestamp v) { setField(10, v); }
  bool hasTimestampValue() => $_has(7);
  void clearTimestampValue() => clearField(10);

  $google$protobuf.NullValue get nullValue => $_getN(8);
  set nullValue($google$protobuf.NullValue v) { setField(11, v); }
...
class MapValue_FieldsEntry extends GeneratedMessage {
  ...
  MapValue_FieldsEntry.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  MapValue_FieldsEntry.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ...
  static PbList<MapValue_FieldsEntry> createRepeated() => new PbList<MapValue_FieldsEntry>();
  static MapValue_FieldsEntry getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyMapValue_FieldsEntry();
    return _defaultInstance;
  }
...
class _ReadonlyMapValue_FieldsEntry extends MapValue_FieldsEntry with ReadonlyMessageMixin {}

class MapValue extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('MapValue')
    ..pp<MapValue_FieldsEntry>(1, 'fields', PbFieldType.PM, MapValue_FieldsEntry.$checkItem, MapValue_FieldsEntry.create)
    ..hasRequiredFields = false
  ;

  MapValue() : super();
  MapValue.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  MapValue.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
