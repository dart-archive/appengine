...
class StructuredQuery_CollectionSelector extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('StructuredQuery_CollectionSelector')
    ..aOS(2, 'collectionId')
  ...
  StructuredQuery_CollectionSelector.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  StructuredQuery_CollectionSelector.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ...
  static PbList<StructuredQuery_CollectionSelector> createRepeated() => new PbList<StructuredQuery_CollectionSelector>();
  static StructuredQuery_CollectionSelector getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyStructuredQuery_CollectionSelector();
    return _defaultInstance;
  }
  static StructuredQuery_CollectionSelector _defaultInstance;
  static void $checkItem(StructuredQuery_CollectionSelector v) {
    if (v is! StructuredQuery_CollectionSelector) checkItemFailed(v, 'StructuredQuery_CollectionSelector');
  }
...
class _ReadonlyStructuredQuery_CollectionSelector extends StructuredQuery_CollectionSelector with ReadonlyMessageMixin {}

class StructuredQuery_Filter extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('StructuredQuery_Filter')
    ..a<StructuredQuery_CompositeFilter>(1, 'compositeFilter', PbFieldType.OM, StructuredQuery_CompositeFilter.getDefault, StructuredQuery_CompositeFilter.create)
    ..a<StructuredQuery_FieldFilter>(2, 'fieldFilter', PbFieldType.OM, StructuredQuery_FieldFilter.getDefault, StructuredQuery_FieldFilter.create)
    ..a<StructuredQuery_UnaryFilter>(3, 'unaryFilter', PbFieldType.OM, StructuredQuery_UnaryFilter.getDefault, StructuredQuery_UnaryFilter.create)
    ..hasRequiredFields = false
  ;

  StructuredQuery_Filter() : super();
  StructuredQuery_Filter.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  StructuredQuery_Filter.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ...
  static PbList<StructuredQuery_Filter> createRepeated() => new PbList<StructuredQuery_Filter>();
  static StructuredQuery_Filter getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyStructuredQuery_Filter();
    return _defaultInstance;
  }
  static StructuredQuery_Filter _defaultInstance;
  static void $checkItem(StructuredQuery_Filter v) {
    if (v is! StructuredQuery_Filter) checkItemFailed(v, 'StructuredQuery_Filter');
  }
...
class _ReadonlyStructuredQuery_Filter extends StructuredQuery_Filter with ReadonlyMessageMixin {}

class StructuredQuery_CompositeFilter extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('StructuredQuery_CompositeFilter')
    ..e<StructuredQuery_CompositeFilter_Operator>(1, 'op', PbFieldType.OE, StructuredQuery_CompositeFilter_Operator.OPERATOR_UNSPECIFIED, StructuredQuery_CompositeFilter_Operator.valueOf, StructuredQuery_CompositeFilter_Operator.values)
    ..pp<StructuredQuery_Filter>(2, 'filters', PbFieldType.PM, StructuredQuery_Filter.$checkItem, StructuredQuery_Filter.create)
    ..hasRequiredFields = false
  ;

  StructuredQuery_CompositeFilter() : super();
  StructuredQuery_CompositeFilter.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  StructuredQuery_CompositeFilter.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ...
  static PbList<StructuredQuery_CompositeFilter> createRepeated() => new PbList<StructuredQuery_CompositeFilter>();
  static StructuredQuery_CompositeFilter getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyStructuredQuery_CompositeFilter();
    return _defaultInstance;
  }
  static StructuredQuery_CompositeFilter _defaultInstance;
  static void $checkItem(StructuredQuery_CompositeFilter v) {
    if (v is! StructuredQuery_CompositeFilter) checkItemFailed(v, 'StructuredQuery_CompositeFilter');
  }
...
class _ReadonlyStructuredQuery_CompositeFilter extends StructuredQuery_CompositeFilter with ReadonlyMessageMixin {}
...
class StructuredQuery_FieldFilter extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('StructuredQuery_FieldFilter')
    ..a<StructuredQuery_FieldReference>(1, 'field_1', PbFieldType.OM, StructuredQuery_FieldReference.getDefault, StructuredQuery_FieldReference.create)
    ..e<StructuredQuery_FieldFilter_Operator>(2, 'op', PbFieldType.OE, StructuredQuery_FieldFilter_Operator.OPERATOR_UNSPECIFIED, StructuredQuery_FieldFilter_Operator.valueOf, StructuredQuery_FieldFilter_Operator.values)
    ..a<Value>(3, 'value', PbFieldType.OM, Value.getDefault, Value.create)
    ..hasRequiredFields = false
  ;

  StructuredQuery_FieldFilter() : super();
  StructuredQuery_FieldFilter.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  StructuredQuery_FieldFilter.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ...
  static PbList<StructuredQuery_FieldFilter> createRepeated() => new PbList<StructuredQuery_FieldFilter>();
  static StructuredQuery_FieldFilter getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyStructuredQuery_FieldFilter();
    return _defaultInstance;
  }
  static StructuredQuery_FieldFilter _defaultInstance;
  static void $checkItem(StructuredQuery_FieldFilter v) {
    if (v is! StructuredQuery_FieldFilter) checkItemFailed(v, 'StructuredQuery_FieldFilter');
  }
...
class _ReadonlyStructuredQuery_FieldFilter extends StructuredQuery_FieldFilter with ReadonlyMessageMixin {}
...
class StructuredQuery_UnaryFilter extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('StructuredQuery_UnaryFilter')
    ..e<StructuredQuery_UnaryFilter_Operator>(1, 'op', PbFieldType.OE, StructuredQuery_UnaryFilter_Operator.OPERATOR_UNSPECIFIED, StructuredQuery_UnaryFilter_Operator.valueOf, StructuredQuery_UnaryFilter_Operator.values)
    ..a<StructuredQuery_FieldReference>(2, 'field_2', PbFieldType.OM, StructuredQuery_FieldReference.getDefault, StructuredQuery_FieldReference.create)
    ..hasRequiredFields = false
  ;

  StructuredQuery_UnaryFilter() : super();
  StructuredQuery_UnaryFilter.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  StructuredQuery_UnaryFilter.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ...
  static PbList<StructuredQuery_UnaryFilter> createRepeated() => new PbList<StructuredQuery_UnaryFilter>();
  static StructuredQuery_UnaryFilter getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyStructuredQuery_UnaryFilter();
    return _defaultInstance;
  }
  static StructuredQuery_UnaryFilter _defaultInstance;
  static void $checkItem(StructuredQuery_UnaryFilter v) {
    if (v is! StructuredQuery_UnaryFilter) checkItemFailed(v, 'StructuredQuery_UnaryFilter');
  }
...
class _ReadonlyStructuredQuery_UnaryFilter extends StructuredQuery_UnaryFilter with ReadonlyMessageMixin {}

class StructuredQuery_Order extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('StructuredQuery_Order')
    ..a<StructuredQuery_FieldReference>(1, 'field_1', PbFieldType.OM, StructuredQuery_FieldReference.getDefault, StructuredQuery_FieldReference.create)
    ..e<StructuredQuery_Direction>(2, 'direction', PbFieldType.OE, StructuredQuery_Direction.DIRECTION_UNSPECIFIED, StructuredQuery_Direction.valueOf, StructuredQuery_Direction.values)
    ..hasRequiredFields = false
  ;

  StructuredQuery_Order() : super();
  StructuredQuery_Order.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  StructuredQuery_Order.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ...
  static PbList<StructuredQuery_Order> createRepeated() => new PbList<StructuredQuery_Order>();
  static StructuredQuery_Order getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyStructuredQuery_Order();
    return _defaultInstance;
  }
  static StructuredQuery_Order _defaultInstance;
  static void $checkItem(StructuredQuery_Order v) {
    if (v is! StructuredQuery_Order) checkItemFailed(v, 'StructuredQuery_Order');
  }
...
class _ReadonlyStructuredQuery_Order extends StructuredQuery_Order with ReadonlyMessageMixin {}

class StructuredQuery_FieldReference extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('StructuredQuery_FieldReference')
    ..aOS(2, 'fieldPath')
    ..hasRequiredFields = false
  ;

  StructuredQuery_FieldReference() : super();
  StructuredQuery_FieldReference.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  StructuredQuery_FieldReference.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ...
  static PbList<StructuredQuery_FieldReference> createRepeated() => new PbList<StructuredQuery_FieldReference>();
  static StructuredQuery_FieldReference getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyStructuredQuery_FieldReference();
    return _defaultInstance;
  }
  static StructuredQuery_FieldReference _defaultInstance;
  static void $checkItem(StructuredQuery_FieldReference v) {
    if (v is! StructuredQuery_FieldReference) checkItemFailed(v, 'StructuredQuery_FieldReference');
  }
...
class _ReadonlyStructuredQuery_FieldReference extends StructuredQuery_FieldReference with ReadonlyMessageMixin {}
...
class StructuredQuery_Projection extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('StructuredQuery_Projection')
    ..pp<StructuredQuery_FieldReference>(2, 'fields', PbFieldType.PM, StructuredQuery_FieldReference.$checkItem, StructuredQuery_FieldReference.create)
    ..hasRequiredFields = false
  ;

  StructuredQuery_Projection() : super();
  StructuredQuery_Projection.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  StructuredQuery_Projection.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ...
  static PbList<StructuredQuery_Projection> createRepeated() => new PbList<StructuredQuery_Projection>();
  static StructuredQuery_Projection getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyStructuredQuery_Projection();
    return _defaultInstance;
  }
  static StructuredQuery_Projection _defaultInstance;
  static void $checkItem(StructuredQuery_Projection v) {
    if (v is! StructuredQuery_Projection) checkItemFailed(v, 'StructuredQuery_Projection');
  }

  List<StructuredQuery_FieldReference> get fields => $_getList(0);
}

class _ReadonlyStructuredQuery_Projection extends StructuredQuery_Projection with ReadonlyMessageMixin {}

class StructuredQuery extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('StructuredQuery')
    ..a<StructuredQuery_Projection>(1, 'select', PbFieldType.OM, StructuredQuery_Projection.getDefault, StructuredQuery_Projection.create)
    ..pp<StructuredQuery_CollectionSelector>(2, 'from', PbFieldType.PM, StructuredQuery_CollectionSelector.$checkItem, StructuredQuery_CollectionSelector.create)
    ..a<StructuredQuery_Filter>(3, 'where', PbFieldType.OM, StructuredQuery_Filter.getDefault, StructuredQuery_Filter.create)
    ..pp<StructuredQuery_Order>(4, 'orderBy', PbFieldType.PM, StructuredQuery_Order.$checkItem, StructuredQuery_Order.create)
    ..a<$google$protobuf.Int32Value>(5, 'limit', PbFieldType.OM, $google$protobuf.Int32Value.getDefault, $google$protobuf.Int32Value.create)
  ...
  StructuredQuery.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  StructuredQuery.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  StructuredQuery clone() => new StructuredQuery()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static StructuredQuery create() => new StructuredQuery();
  static PbList<StructuredQuery> createRepeated() => new PbList<StructuredQuery>();
  static StructuredQuery getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyStructuredQuery();
    return _defaultInstance;
  }
  ...
  set limit($google$protobuf.Int32Value v) { setField(5, v); }
...
class _ReadonlyStructuredQuery extends StructuredQuery with ReadonlyMessageMixin {}
