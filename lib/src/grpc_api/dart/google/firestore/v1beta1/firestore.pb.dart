...
class GetDocumentRequest extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('GetDocumentRequest')
    ..aOS(1, 'name')
    ..a<DocumentMask>(2, 'mask', PbFieldType.OM, DocumentMask.getDefault, DocumentMask.create)
    ..a<List<int>>(3, 'transaction', PbFieldType.OY)
    ..a<$google$protobuf.Timestamp>(5, 'readTime', PbFieldType.OM, $google$protobuf.Timestamp.getDefault, $google$protobuf.Timestamp.create)
    ..hasRequiredFields = false
  ;

  GetDocumentRequest() : super();
  GetDocumentRequest.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  GetDocumentRequest.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ...
  static PbList<GetDocumentRequest> createRepeated() => new PbList<GetDocumentRequest>();
  static GetDocumentRequest getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyGetDocumentRequest();
  ...
  set mask(DocumentMask v) { setField(2, v); }
  bool hasMask() => $_has(1);
  ...
  set readTime($google$protobuf.Timestamp v) { setField(5, v); }
  bool hasReadTime() => $_has(3);
  void clearReadTime() => clearField(5);
}

class _ReadonlyGetDocumentRequest extends GetDocumentRequest with ReadonlyMessageMixin {}
...
class ListDocumentsRequest extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('ListDocumentsRequest')
    ...
    ..aOS(4, 'pageToken')
    ..aOS(6, 'orderBy')
    ..a<DocumentMask>(7, 'mask', PbFieldType.OM, DocumentMask.getDefault, DocumentMask.create)
    ..a<List<int>>(8, 'transaction', PbFieldType.OY)
    ..a<$google$protobuf.Timestamp>(10, 'readTime', PbFieldType.OM, $google$protobuf.Timestamp.getDefault, $google$protobuf.Timestamp.create)
    ..aOB(12, 'showMissing')
    ..hasRequiredFields = false
  ;

  ListDocumentsRequest() : super();
  ListDocumentsRequest.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  ListDocumentsRequest.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ...
  static PbList<ListDocumentsRequest> createRepeated() => new PbList<ListDocumentsRequest>();
  static ListDocumentsRequest getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyListDocumentsRequest();
    return _defaultInstance;
  }
  ...
  set mask(DocumentMask v) { setField(7, v); }
  bool hasMask() => $_has(5);
  ...
  set readTime($google$protobuf.Timestamp v) { setField(10, v); }
...
class _ReadonlyListDocumentsRequest extends ListDocumentsRequest with ReadonlyMessageMixin {}

class ListDocumentsResponse extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('ListDocumentsResponse')
    ..pp<Document>(1, 'documents', PbFieldType.PM, Document.$checkItem, Document.create)
    ..aOS(2, 'nextPageToken')
    ..hasRequiredFields = false
  ;

  ListDocumentsResponse() : super();
  ListDocumentsResponse.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  ListDocumentsResponse.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ...
  static PbList<ListDocumentsResponse> createRepeated() => new PbList<ListDocumentsResponse>();
  static ListDocumentsResponse getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyListDocumentsResponse();
    return _defaultInstance;
  }
  static ListDocumentsResponse _defaultInstance;
  static void $checkItem(ListDocumentsResponse v) {
    if (v is! ListDocumentsResponse) checkItemFailed(v, 'ListDocumentsResponse');
  }
...
class _ReadonlyListDocumentsResponse extends ListDocumentsResponse with ReadonlyMessageMixin {}
...
class CreateDocumentRequest extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('CreateDocumentRequest')
    ...
    ..aOS(2, 'collectionId')
    ..aOS(3, 'documentId')
    ..a<Document>(4, 'document', PbFieldType.OM, Document.getDefault, Document.create)
    ..a<DocumentMask>(5, 'mask', PbFieldType.OM, DocumentMask.getDefault, DocumentMask.create)
    ..hasRequiredFields = false
  ;

  CreateDocumentRequest() : super();
  CreateDocumentRequest.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  CreateDocumentRequest.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ...
  static PbList<CreateDocumentRequest> createRepeated() => new PbList<CreateDocumentRequest>();
  static CreateDocumentRequest getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyCreateDocumentRequest();
    return _defaultInstance;
  }
  static CreateDocumentRequest _defaultInstance;
  static void $checkItem(CreateDocumentRequest v) {
    if (v is! CreateDocumentRequest) checkItemFailed(v, 'CreateDocumentRequest');
  }
  ...
  set mask(DocumentMask v) { setField(5, v); }
  bool hasMask() => $_has(4);
  void clearMask() => clearField(5);
}

class _ReadonlyCreateDocumentRequest extends CreateDocumentRequest with ReadonlyMessageMixin {}
...
class UpdateDocumentRequest extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('UpdateDocumentRequest')
    ...
    ..a<DocumentMask>(2, 'updateMask', PbFieldType.OM, DocumentMask.getDefault, DocumentMask.create)
    ..a<DocumentMask>(3, 'mask', PbFieldType.OM, DocumentMask.getDefault, DocumentMask.create)
    ..a<Precondition>(4, 'currentDocument', PbFieldType.OM, Precondition.getDefault, Precondition.create)
    ..hasRequiredFields = false
  ;

  UpdateDocumentRequest() : super();
  UpdateDocumentRequest.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  UpdateDocumentRequest.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ...
  static PbList<UpdateDocumentRequest> createRepeated() => new PbList<UpdateDocumentRequest>();
  static UpdateDocumentRequest getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyUpdateDocumentRequest();
    return _defaultInstance;
  }
  static UpdateDocumentRequest _defaultInstance;
  static void $checkItem(UpdateDocumentRequest v) {
    if (v is! UpdateDocumentRequest) checkItemFailed(v, 'UpdateDocumentRequest');
  }
  ...
  set updateMask(DocumentMask v) { setField(2, v); }
  bool hasUpdateMask() => $_has(1);
  void clearUpdateMask() => clearField(2);

  DocumentMask get mask => $_getN(2);
  set mask(DocumentMask v) { setField(3, v); }
  bool hasMask() => $_has(2);
...
class _ReadonlyUpdateDocumentRequest extends UpdateDocumentRequest with ReadonlyMessageMixin {}

class DeleteDocumentRequest extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('DeleteDocumentRequest')
    ..aOS(1, 'name')
    ..a<Precondition>(2, 'currentDocument', PbFieldType.OM, Precondition.getDefault, Precondition.create)
    ..hasRequiredFields = false
  ;

  DeleteDocumentRequest() : super();
  DeleteDocumentRequest.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  DeleteDocumentRequest.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ...
  static PbList<DeleteDocumentRequest> createRepeated() => new PbList<DeleteDocumentRequest>();
  static DeleteDocumentRequest getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyDeleteDocumentRequest();
    return _defaultInstance;
  }
  static DeleteDocumentRequest _defaultInstance;
  static void $checkItem(DeleteDocumentRequest v) {
    if (v is! DeleteDocumentRequest) checkItemFailed(v, 'DeleteDocumentRequest');
  }
  ...
  set currentDocument(Precondition v) { setField(2, v); }
  bool hasCurrentDocument() => $_has(1);
  void clearCurrentDocument() => clearField(2);
}

class _ReadonlyDeleteDocumentRequest extends DeleteDocumentRequest with ReadonlyMessageMixin {}
...
class BatchGetDocumentsRequest extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('BatchGetDocumentsRequest')
    ...
    ..a<TransactionOptions>(5, 'newTransaction', PbFieldType.OM, TransactionOptions.getDefault, TransactionOptions.create)
    ..a<$google$protobuf.Timestamp>(7, 'readTime', PbFieldType.OM, $google$protobuf.Timestamp.getDefault, $google$protobuf.Timestamp.create)
    ..hasRequiredFields = false
  ;

  BatchGetDocumentsRequest() : super();
  BatchGetDocumentsRequest.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  BatchGetDocumentsRequest.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ...
  static PbList<BatchGetDocumentsRequest> createRepeated() => new PbList<BatchGetDocumentsRequest>();
  static BatchGetDocumentsRequest getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyBatchGetDocumentsRequest();
    return _defaultInstance;
  }
  static BatchGetDocumentsRequest _defaultInstance;
  static void $checkItem(BatchGetDocumentsRequest v) {
    if (v is! BatchGetDocumentsRequest) checkItemFailed(v, 'BatchGetDocumentsRequest');
  }
  ...
  set newTransaction(TransactionOptions v) { setField(5, v); }
  bool hasNewTransaction() => $_has(4);
  void clearNewTransaction() => clearField(5);

  $google$protobuf.Timestamp get readTime => $_getN(5);
  set readTime($google$protobuf.Timestamp v) { setField(7, v); }
  bool hasReadTime() => $_has(5);
  void clearReadTime() => clearField(7);
}

class _ReadonlyBatchGetDocumentsRequest extends BatchGetDocumentsRequest with ReadonlyMessageMixin {}
...
class BatchGetDocumentsResponse extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('BatchGetDocumentsResponse')
    ..a<Document>(1, 'found', PbFieldType.OM, Document.getDefault, Document.create)
    ..aOS(2, 'missing')
    ..a<List<int>>(3, 'transaction', PbFieldType.OY)
  ...
  BatchGetDocumentsResponse.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  BatchGetDocumentsResponse.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ...
  static PbList<BatchGetDocumentsResponse> createRepeated() => new PbList<BatchGetDocumentsResponse>();
  static BatchGetDocumentsResponse getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyBatchGetDocumentsResponse();
    return _defaultInstance;
  }
  static BatchGetDocumentsResponse _defaultInstance;
  static void $checkItem(BatchGetDocumentsResponse v) {
    if (v is! BatchGetDocumentsResponse) checkItemFailed(v, 'BatchGetDocumentsResponse');
  }

  Document get found => $_getN(0);
  set found(Document v) { setField(1, v); }
...
class _ReadonlyBatchGetDocumentsResponse extends BatchGetDocumentsResponse with ReadonlyMessageMixin {}
...
class CommitResponse extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('CommitResponse')
    ..pp<WriteResult>(1, 'writeResults', PbFieldType.PM, WriteResult.$checkItem, WriteResult.create)
    ..a<$google$protobuf.Timestamp>(2, 'commitTime', PbFieldType.OM, $google$protobuf.Timestamp.getDefault, $google$protobuf.Timestamp.create)
    ..hasRequiredFields = false
  ;
  ...
  set commitTime($google$protobuf.Timestamp v) { setField(2, v); }
...
class RunQueryRequest extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('RunQueryRequest')
    ..aOS(1, 'parent')
    ..a<StructuredQuery>(2, 'structuredQuery', PbFieldType.OM, StructuredQuery.getDefault, StructuredQuery.create)
    ..a<List<int>>(5, 'transaction', PbFieldType.OY)
    ..a<TransactionOptions>(6, 'newTransaction', PbFieldType.OM, TransactionOptions.getDefault, TransactionOptions.create)
    ..a<$google$protobuf.Timestamp>(7, 'readTime', PbFieldType.OM, $google$protobuf.Timestamp.getDefault, $google$protobuf.Timestamp.create)
    ..hasRequiredFields = false
  ;
  ...
  set structuredQuery(StructuredQuery v) { setField(2, v); }
  ...
  set newTransaction(TransactionOptions v) { setField(6, v); }
...
class RunQueryResponse extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('RunQueryResponse')
    ..a<Document>(1, 'document', PbFieldType.OM, Document.getDefault, Document.create)
    ..a<List<int>>(2, 'transaction', PbFieldType.OY)
    ..a<$google$protobuf.Timestamp>(3, 'readTime', PbFieldType.OM, $google$protobuf.Timestamp.getDefault, $google$protobuf.Timestamp.create)
  ...
  set readTime($google$protobuf.Timestamp v) { setField(3, v); }
...
class WriteRequest_LabelsEntry extends GeneratedMessage {
  ...
  WriteRequest_LabelsEntry.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  WriteRequest_LabelsEntry.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ...
  static PbList<WriteRequest_LabelsEntry> createRepeated() => new PbList<WriteRequest_LabelsEntry>();
  static WriteRequest_LabelsEntry getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyWriteRequest_LabelsEntry();
    return _defaultInstance;
  }
  static WriteRequest_LabelsEntry _defaultInstance;
  static void $checkItem(WriteRequest_LabelsEntry v) {
    if (v is! WriteRequest_LabelsEntry) checkItemFailed(v, 'WriteRequest_LabelsEntry');
  }
...
class _ReadonlyWriteRequest_LabelsEntry extends WriteRequest_LabelsEntry with ReadonlyMessageMixin {}
...
class WriteRequest extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('WriteRequest')
    ...
    ..pp<WriteRequest_LabelsEntry>(5, 'labels', PbFieldType.PM, WriteRequest_LabelsEntry.$checkItem, WriteRequest_LabelsEntry.create)
    ..hasRequiredFields = false
  ;
...
class WriteResponse extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('WriteResponse')
    ...
    ..pp<WriteResult>(3, 'writeResults', PbFieldType.PM, WriteResult.$checkItem, WriteResult.create)
    ..a<$google$protobuf.Timestamp>(4, 'commitTime', PbFieldType.OM, $google$protobuf.Timestamp.getDefault, $google$protobuf.Timestamp.create)
    ..hasRequiredFields = false
  ;
  ...
  set commitTime($google$protobuf.Timestamp v) { setField(4, v); }
...
class ListenRequest_LabelsEntry extends GeneratedMessage {
  ...
  ListenRequest_LabelsEntry.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  ListenRequest_LabelsEntry.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ...
  static PbList<ListenRequest_LabelsEntry> createRepeated() => new PbList<ListenRequest_LabelsEntry>();
  static ListenRequest_LabelsEntry getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyListenRequest_LabelsEntry();
    return _defaultInstance;
  }
  static ListenRequest_LabelsEntry _defaultInstance;
  static void $checkItem(ListenRequest_LabelsEntry v) {
    if (v is! ListenRequest_LabelsEntry) checkItemFailed(v, 'ListenRequest_LabelsEntry');
  }
...
class _ReadonlyListenRequest_LabelsEntry extends ListenRequest_LabelsEntry with ReadonlyMessageMixin {}

class ListenRequest extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('ListenRequest')
    ..aOS(1, 'database')
    ..a<Target>(2, 'addTarget', PbFieldType.OM, Target.getDefault, Target.create)
    ..a<int>(3, 'removeTarget', PbFieldType.O3)
    ..pp<ListenRequest_LabelsEntry>(4, 'labels', PbFieldType.PM, ListenRequest_LabelsEntry.$checkItem, ListenRequest_LabelsEntry.create)
    ..hasRequiredFields = false
  ;

  ListenRequest() : super();
  ListenRequest.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  ListenRequest.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ...
  static ListenRequest getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyListenRequest();
    return _defaultInstance;
  }
...
class ListenResponse extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('ListenResponse')
    ..a<TargetChange>(2, 'targetChange', PbFieldType.OM, TargetChange.getDefault, TargetChange.create)
    ..a<DocumentChange>(3, 'documentChange', PbFieldType.OM, DocumentChange.getDefault, DocumentChange.create)
    ..a<DocumentDelete>(4, 'documentDelete', PbFieldType.OM, DocumentDelete.getDefault, DocumentDelete.create)
    ..a<ExistenceFilter>(5, 'filter', PbFieldType.OM, ExistenceFilter.getDefault, ExistenceFilter.create)
    ..a<DocumentRemove>(6, 'documentRemove', PbFieldType.OM, DocumentRemove.getDefault, DocumentRemove.create)
    ..hasRequiredFields = false
  ;

  ListenResponse() : super();
  ListenResponse.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  ListenResponse.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ListenResponse clone() => new ListenResponse()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static ListenResponse create() => new ListenResponse();
  static PbList<ListenResponse> createRepeated() => new PbList<ListenResponse>();
  static ListenResponse getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyListenResponse();
    return _defaultInstance;
  }
...
class Target_DocumentsTarget extends GeneratedMessage {
  ...
  Target_DocumentsTarget.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  Target_DocumentsTarget.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ...
  static PbList<Target_DocumentsTarget> createRepeated() => new PbList<Target_DocumentsTarget>();
  static Target_DocumentsTarget getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyTarget_DocumentsTarget();
    return _defaultInstance;
  }
  static Target_DocumentsTarget _defaultInstance;
  static void $checkItem(Target_DocumentsTarget v) {
    if (v is! Target_DocumentsTarget) checkItemFailed(v, 'Target_DocumentsTarget');
  }

  List<String> get documents => $_getList(0);
}

class _ReadonlyTarget_DocumentsTarget extends Target_DocumentsTarget with ReadonlyMessageMixin {}
...
class Target_QueryTarget extends GeneratedMessage {
  ...
  Target_QueryTarget.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  Target_QueryTarget.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ...
  static PbList<Target_QueryTarget> createRepeated() => new PbList<Target_QueryTarget>();
  static Target_QueryTarget getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyTarget_QueryTarget();
    return _defaultInstance;
  }
...
class _ReadonlyTarget_QueryTarget extends Target_QueryTarget with ReadonlyMessageMixin {}

class Target extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('Target')
    ..a<Target_QueryTarget>(2, 'query', PbFieldType.OM, Target_QueryTarget.getDefault, Target_QueryTarget.create)
    ..a<Target_DocumentsTarget>(3, 'documents', PbFieldType.OM, Target_DocumentsTarget.getDefault, Target_DocumentsTarget.create)
    ..a<List<int>>(4, 'resumeToken', PbFieldType.OY)
    ..a<int>(5, 'targetId', PbFieldType.O3)
    ..aOB(6, 'once')
    ..a<$google$protobuf.Timestamp>(11, 'readTime', PbFieldType.OM, $google$protobuf.Timestamp.getDefault, $google$protobuf.Timestamp.create)
    ..hasRequiredFields = false
  ;

  Target() : super();
  Target.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  Target.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ...
  $google$protobuf.Timestamp get readTime => $_getN(5);
  set readTime($google$protobuf.Timestamp v) { setField(11, v); }
  bool hasReadTime() => $_has(5);
...
class TargetChange extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('TargetChange')
    ..e<TargetChange_TargetChangeType>(1, 'targetChangeType', PbFieldType.OE, TargetChange_TargetChangeType.NO_CHANGE, TargetChange_TargetChangeType.valueOf, TargetChange_TargetChangeType.values)
    ..p<int>(2, 'targetIds', PbFieldType.P3)
    ..a<$google$rpc.Status>(3, 'cause', PbFieldType.OM, $google$rpc.Status.getDefault, $google$rpc.Status.create)
    ..a<List<int>>(4, 'resumeToken', PbFieldType.OY)
    ..a<$google$protobuf.Timestamp>(6, 'readTime', PbFieldType.OM, $google$protobuf.Timestamp.getDefault, $google$protobuf.Timestamp.create)
    ..hasRequiredFields = false
  ;

  TargetChange() : super();
  TargetChange.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  TargetChange.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ...
  static TargetChange getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyTargetChange();
    return _defaultInstance;
  }
  ...
  set cause($google$rpc.Status v) { setField(3, v); }
  ...
  $google$protobuf.Timestamp get readTime => $_getN(4);
  set readTime($google$protobuf.Timestamp v) { setField(6, v); }
  bool hasReadTime() => $_has(4);
...
class ListCollectionIdsRequest extends GeneratedMessage {
  ...
  ListCollectionIdsRequest.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  ListCollectionIdsRequest.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ...
  static PbList<ListCollectionIdsRequest> createRepeated() => new PbList<ListCollectionIdsRequest>();
  static ListCollectionIdsRequest getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyListCollectionIdsRequest();
    return _defaultInstance;
  }
  static ListCollectionIdsRequest _defaultInstance;
  static void $checkItem(ListCollectionIdsRequest v) {
    if (v is! ListCollectionIdsRequest) checkItemFailed(v, 'ListCollectionIdsRequest');
  }
...
class _ReadonlyListCollectionIdsRequest extends ListCollectionIdsRequest with ReadonlyMessageMixin {}
...
class ListCollectionIdsResponse extends GeneratedMessage {
  ...
  ListCollectionIdsResponse.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  ListCollectionIdsResponse.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ...
  static PbList<ListCollectionIdsResponse> createRepeated() => new PbList<ListCollectionIdsResponse>();
  static ListCollectionIdsResponse getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyListCollectionIdsResponse();
    return _defaultInstance;
  }
  static ListCollectionIdsResponse _defaultInstance;
  static void $checkItem(ListCollectionIdsResponse v) {
    if (v is! ListCollectionIdsResponse) checkItemFailed(v, 'ListCollectionIdsResponse');
  }
...
class _ReadonlyListCollectionIdsResponse extends ListCollectionIdsResponse with ReadonlyMessageMixin {}
...
class FirestoreApi {
  ...
  Future<Document> getDocument(ClientContext ctx, GetDocumentRequest request) {
    ...
    return _client.invoke<Document>(ctx, 'Firestore', 'GetDocument', request, emptyResponse);
  }
  Future<ListDocumentsResponse> listDocuments(ClientContext ctx, ListDocumentsRequest request) {
  ...
  Future<Document> createDocument(ClientContext ctx, CreateDocumentRequest request) {
    var emptyResponse = new Document();
    return _client.invoke<Document>(ctx, 'Firestore', 'CreateDocument', request, emptyResponse);
  }
  Future<Document> updateDocument(ClientContext ctx, UpdateDocumentRequest request) {
    var emptyResponse = new Document();
    return _client.invoke<Document>(ctx, 'Firestore', 'UpdateDocument', request, emptyResponse);
  }
  Future<$google$protobuf.Empty> deleteDocument(ClientContext ctx, DeleteDocumentRequest request) {
    var emptyResponse = new $google$protobuf.Empty();
    return _client.invoke<$google$protobuf.Empty>(ctx, 'Firestore', 'DeleteDocument', request, emptyResponse);
  }
  Future<BatchGetDocumentsResponse> batchGetDocuments(ClientContext ctx, BatchGetDocumentsRequest request) {
  ...
  Future<$google$protobuf.Empty> rollback(ClientContext ctx, RollbackRequest request) {
    var emptyResponse = new $google$protobuf.Empty();
    return _client.invoke<$google$protobuf.Empty>(ctx, 'Firestore', 'Rollback', request, emptyResponse);
  }
  ...
  Future<ListCollectionIdsResponse> listCollectionIds(ClientContext ctx, ListCollectionIdsRequest request) {
