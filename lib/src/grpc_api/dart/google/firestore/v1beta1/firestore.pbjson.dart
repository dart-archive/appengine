...
const FirestoreServiceBase$messageJson = {
  ...
  '.google.firestore.v1beta1.Document.FieldsEntry':
      $2.Document_FieldsEntry$json,
  '.google.firestore.v1beta1.Value': $2.Value$json,
  '.google.firestore.v1beta1.MapValue': $2.MapValue$json,
  '.google.firestore.v1beta1.MapValue.FieldsEntry':
      $2.MapValue_FieldsEntry$json,
