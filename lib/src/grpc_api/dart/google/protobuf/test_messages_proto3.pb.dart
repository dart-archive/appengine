...
class TestAllTypesProto3_NestedMessage extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('TestAllTypesProto3.NestedMessage', package: const $pb.PackageName('protobuf_test_messages.proto3'))
    ..a<$core.int>(1, 'a', $pb.PbFieldType.O3)
    ..a<TestAllTypesProto3>(2, 'corecursive', $pb.PbFieldType.OM, TestAllTypesProto3.getDefault, TestAllTypesProto3.create)
    ..hasRequiredFields = false
  ;

  TestAllTypesProto3_NestedMessage() : super();
  TestAllTypesProto3_NestedMessage.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  TestAllTypesProto3_NestedMessage.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  TestAllTypesProto3_NestedMessage clone() => TestAllTypesProto3_NestedMessage()..mergeFromMessage(this);
  TestAllTypesProto3_NestedMessage copyWith(void Function(TestAllTypesProto3_NestedMessage) updates) => super.copyWith((message) => updates(message as TestAllTypesProto3_NestedMessage));
  $pb.BuilderInfo get info_ => _i;
  static TestAllTypesProto3_NestedMessage create() => TestAllTypesProto3_NestedMessage();
  ...
  static TestAllTypesProto3_NestedMessage getDefault() => _defaultInstance ??= create()..freeze();
...
class TestAllTypesProto3 extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('TestAllTypesProto3', package: const $pb.PackageName('protobuf_test_messages.proto3'))
    ...
    ..a<TestAllTypesProto3_NestedMessage>(18, 'optionalNestedMessage', $pb.PbFieldType.OM, TestAllTypesProto3_NestedMessage.getDefault, TestAllTypesProto3_NestedMessage.create)
    ..a<ForeignMessage>(19, 'optionalForeignMessage', $pb.PbFieldType.OM, ForeignMessage.getDefault, ForeignMessage.create)
    ..e<TestAllTypesProto3_NestedEnum>(21, 'optionalNestedEnum', $pb.PbFieldType.OE, TestAllTypesProto3_NestedEnum.FOO, TestAllTypesProto3_NestedEnum.valueOf, TestAllTypesProto3_NestedEnum.values)
    ..e<ForeignEnum>(22, 'optionalForeignEnum', $pb.PbFieldType.OE, ForeignEnum.FOREIGN_FOO, ForeignEnum.valueOf, ForeignEnum.values)
    ..e<TestAllTypesProto3_AliasedEnum>(23, 'optionalAliasedEnum', $pb.PbFieldType.OE, TestAllTypesProto3_AliasedEnum.ALIAS_FOO, TestAllTypesProto3_AliasedEnum.valueOf, TestAllTypesProto3_AliasedEnum.values)
    ..aOS(24, 'optionalStringPiece')
    ..aOS(25, 'optionalCord')
    ..a<TestAllTypesProto3>(27, 'recursiveMessage', $pb.PbFieldType.OM, TestAllTypesProto3.getDefault, TestAllTypesProto3.create)
    ...
    ..pc<TestAllTypesProto3_NestedMessage>(48, 'repeatedNestedMessage', $pb.PbFieldType.PM,TestAllTypesProto3_NestedMessage.create)
    ..pc<ForeignMessage>(49, 'repeatedForeignMessage', $pb.PbFieldType.PM,ForeignMessage.create)
    ..pc<TestAllTypesProto3_NestedEnum>(51, 'repeatedNestedEnum', $pb.PbFieldType.PE, null, TestAllTypesProto3_NestedEnum.valueOf, TestAllTypesProto3_NestedEnum.values)
    ..pc<ForeignEnum>(52, 'repeatedForeignEnum', $pb.PbFieldType.PE, null, ForeignEnum.valueOf, ForeignEnum.values)
    ..pPS(54, 'repeatedStringPiece')
    ..pPS(55, 'repeatedCord')
    ..m<$core.int, $core.int>(56, 'mapInt32Int32', 'TestAllTypesProto3.MapInt32Int32Entry',$pb.PbFieldType.O3, $pb.PbFieldType.O3, null, null, null , const $pb.PackageName('protobuf_test_messages.proto3'))
    ..m<Int64, Int64>(57, 'mapInt64Int64', 'TestAllTypesProto3.MapInt64Int64Entry',$pb.PbFieldType.O6, $pb.PbFieldType.O6, null, null, null , const $pb.PackageName('protobuf_test_messages.proto3'))
    ..m<$core.int, $core.int>(58, 'mapUint32Uint32', 'TestAllTypesProto3.MapUint32Uint32Entry',$pb.PbFieldType.OU3, $pb.PbFieldType.OU3, null, null, null , const $pb.PackageName('protobuf_test_messages.proto3'))
  ...
  TestAllTypesProto3.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  TestAllTypesProto3.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  TestAllTypesProto3 clone() => TestAllTypesProto3()..mergeFromMessage(this);
  TestAllTypesProto3 copyWith(void Function(TestAllTypesProto3) updates) => super.copyWith((message) => updates(message as TestAllTypesProto3));
  $pb.BuilderInfo get info_ => _i;
  ...
  static TestAllTypesProto3 getDefault() => _defaultInstance ??= create()..freeze();
  ...
  set oneofUint32($core.int v) { $_setUnsignedInt32(63, v); }
