...
class TestAllTypesProto2_NestedMessage extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('TestAllTypesProto2.NestedMessage', package: const $pb.PackageName('protobuf_test_messages.proto2'))
    ..a<$core.int>(1, 'a', $pb.PbFieldType.O3)
    ..a<TestAllTypesProto2>(2, 'corecursive', $pb.PbFieldType.OM, TestAllTypesProto2.getDefault, TestAllTypesProto2.create)
  ;

  TestAllTypesProto2_NestedMessage() : super();
  TestAllTypesProto2_NestedMessage.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  TestAllTypesProto2_NestedMessage.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  TestAllTypesProto2_NestedMessage clone() => TestAllTypesProto2_NestedMessage()..mergeFromMessage(this);
  TestAllTypesProto2_NestedMessage copyWith(void Function(TestAllTypesProto2_NestedMessage) updates) => super.copyWith((message) => updates(message as TestAllTypesProto2_NestedMessage));
  $pb.BuilderInfo get info_ => _i;
  static TestAllTypesProto2_NestedMessage create() => TestAllTypesProto2_NestedMessage();
  ...
  static TestAllTypesProto2_NestedMessage getDefault() => _defaultInstance ??= create()..freeze();
...
class TestAllTypesProto2_Data extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('TestAllTypesProto2.Data', package: const $pb.PackageName('protobuf_test_messages.proto2'))
  ...
  TestAllTypesProto2_Data.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  TestAllTypesProto2_Data.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  TestAllTypesProto2_Data clone() => TestAllTypesProto2_Data()..mergeFromMessage(this);
  TestAllTypesProto2_Data copyWith(void Function(TestAllTypesProto2_Data) updates) => super.copyWith((message) => updates(message as TestAllTypesProto2_Data));
  $pb.BuilderInfo get info_ => _i;
  ...
  static TestAllTypesProto2_Data getDefault() => _defaultInstance ??= create()..freeze();
...
class TestAllTypesProto2_MessageSetCorrect extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('TestAllTypesProto2.MessageSetCorrect', package: const $pb.PackageName('protobuf_test_messages.proto2'))
    ..hasExtensions = true
  ;

  TestAllTypesProto2_MessageSetCorrect() : super();
  TestAllTypesProto2_MessageSetCorrect.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  TestAllTypesProto2_MessageSetCorrect.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  TestAllTypesProto2_MessageSetCorrect clone() => TestAllTypesProto2_MessageSetCorrect()..mergeFromMessage(this);
  TestAllTypesProto2_MessageSetCorrect copyWith(void Function(TestAllTypesProto2_MessageSetCorrect) updates) => super.copyWith((message) => updates(message as TestAllTypesProto2_MessageSetCorrect));
  $pb.BuilderInfo get info_ => _i;
  static TestAllTypesProto2_MessageSetCorrect create() => TestAllTypesProto2_MessageSetCorrect();
  ...
  static TestAllTypesProto2_MessageSetCorrect getDefault() => _defaultInstance ??= create()..freeze();
...
class TestAllTypesProto2_MessageSetCorrectExtension1 extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('TestAllTypesProto2.MessageSetCorrectExtension1', package: const $pb.PackageName('protobuf_test_messages.proto2'))
    ..aOS(25, 'str')
    ..hasRequiredFields = false
  ;
  static final $pb.Extension messageSetExtension = $pb.Extension<TestAllTypesProto2_MessageSetCorrectExtension1>('protobuf_test_messages.proto2.TestAllTypesProto2.MessageSetCorrect', 'messageSetExtension', 1547769, $pb.PbFieldType.OM, TestAllTypesProto2_MessageSetCorrectExtension1.getDefault, TestAllTypesProto2_MessageSetCorrectExtension1.create);

  TestAllTypesProto2_MessageSetCorrectExtension1() : super();
  TestAllTypesProto2_MessageSetCorrectExtension1.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  TestAllTypesProto2_MessageSetCorrectExtension1.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ...
  TestAllTypesProto2_MessageSetCorrectExtension1 copyWith(void Function(TestAllTypesProto2_MessageSetCorrectExtension1) updates) => super.copyWith((message) => updates(message as TestAllTypesProto2_MessageSetCorrectExtension1));
  $pb.BuilderInfo get info_ => _i;
  static TestAllTypesProto2_MessageSetCorrectExtension1 create() => TestAllTypesProto2_MessageSetCorrectExtension1();
  ...
  static TestAllTypesProto2_MessageSetCorrectExtension1 getDefault() => _defaultInstance ??= create()..freeze();
...
class TestAllTypesProto2_MessageSetCorrectExtension2 extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('TestAllTypesProto2.MessageSetCorrectExtension2', package: const $pb.PackageName('protobuf_test_messages.proto2'))
    ..a<$core.int>(9, 'i', $pb.PbFieldType.O3)
    ..hasRequiredFields = false
  ;
  static final $pb.Extension messageSetExtension = $pb.Extension<TestAllTypesProto2_MessageSetCorrectExtension2>('protobuf_test_messages.proto2.TestAllTypesProto2.MessageSetCorrect', 'messageSetExtension', 4135312, $pb.PbFieldType.OM, TestAllTypesProto2_MessageSetCorrectExtension2.getDefault, TestAllTypesProto2_MessageSetCorrectExtension2.create);

  TestAllTypesProto2_MessageSetCorrectExtension2() : super();
  TestAllTypesProto2_MessageSetCorrectExtension2.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  TestAllTypesProto2_MessageSetCorrectExtension2.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ...
  TestAllTypesProto2_MessageSetCorrectExtension2 copyWith(void Function(TestAllTypesProto2_MessageSetCorrectExtension2) updates) => super.copyWith((message) => updates(message as TestAllTypesProto2_MessageSetCorrectExtension2));
  $pb.BuilderInfo get info_ => _i;
  static TestAllTypesProto2_MessageSetCorrectExtension2 create() => TestAllTypesProto2_MessageSetCorrectExtension2();
  ...
  static TestAllTypesProto2_MessageSetCorrectExtension2 getDefault() => _defaultInstance ??= create()..freeze();
...
class TestAllTypesProto2 extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('TestAllTypesProto2', package: const $pb.PackageName('protobuf_test_messages.proto2'))
    ...
    ..a<TestAllTypesProto2_NestedMessage>(18, 'optionalNestedMessage', $pb.PbFieldType.OM, TestAllTypesProto2_NestedMessage.getDefault, TestAllTypesProto2_NestedMessage.create)
    ..a<ForeignMessageProto2>(19, 'optionalForeignMessage', $pb.PbFieldType.OM, ForeignMessageProto2.getDefault, ForeignMessageProto2.create)
    ..e<TestAllTypesProto2_NestedEnum>(21, 'optionalNestedEnum', $pb.PbFieldType.OE, TestAllTypesProto2_NestedEnum.FOO, TestAllTypesProto2_NestedEnum.valueOf, TestAllTypesProto2_NestedEnum.values)
    ..e<ForeignEnumProto2>(22, 'optionalForeignEnum', $pb.PbFieldType.OE, ForeignEnumProto2.FOREIGN_FOO, ForeignEnumProto2.valueOf, ForeignEnumProto2.values)
    ..aOS(24, 'optionalStringPiece')
    ..aOS(25, 'optionalCord')
    ..a<TestAllTypesProto2>(27, 'recursiveMessage', $pb.PbFieldType.OM, TestAllTypesProto2.getDefault, TestAllTypesProto2.create)
    ...
    ..pc<TestAllTypesProto2_NestedMessage>(48, 'repeatedNestedMessage', $pb.PbFieldType.PM,TestAllTypesProto2_NestedMessage.create)
    ..pc<ForeignMessageProto2>(49, 'repeatedForeignMessage', $pb.PbFieldType.PM,ForeignMessageProto2.create)
    ..pc<TestAllTypesProto2_NestedEnum>(51, 'repeatedNestedEnum', $pb.PbFieldType.PE, null, TestAllTypesProto2_NestedEnum.valueOf, TestAllTypesProto2_NestedEnum.values)
    ..pc<ForeignEnumProto2>(52, 'repeatedForeignEnum', $pb.PbFieldType.PE, null, ForeignEnumProto2.valueOf, ForeignEnumProto2.values)
    ..pPS(54, 'repeatedStringPiece')
    ..pPS(55, 'repeatedCord')
    ..m<$core.int, $core.int>(56, 'mapInt32Int32', 'TestAllTypesProto2.MapInt32Int32Entry',$pb.PbFieldType.O3, $pb.PbFieldType.O3, null, null, null , const $pb.PackageName('protobuf_test_messages.proto2'))
    ..m<Int64, Int64>(57, 'mapInt64Int64', 'TestAllTypesProto2.MapInt64Int64Entry',$pb.PbFieldType.O6, $pb.PbFieldType.O6, null, null, null , const $pb.PackageName('protobuf_test_messages.proto2'))
    ..m<$core.int, $core.int>(58, 'mapUint32Uint32', 'TestAllTypesProto2.MapUint32Uint32Entry',$pb.PbFieldType.OU3, $pb.PbFieldType.OU3, null, null, null , const $pb.PackageName('protobuf_test_messages.proto2'))
    ..m<Int64, Int64>(59, 'mapUint64Uint64', 'TestAllTypesProto2.MapUint64Uint64Entry',$pb.PbFieldType.OU6, $pb.PbFieldType.OU6, null, null, null , const $pb.PackageName('protobuf_test_messages.proto2'))
  ...
  TestAllTypesProto2.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  TestAllTypesProto2.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  TestAllTypesProto2 clone() => TestAllTypesProto2()..mergeFromMessage(this);
  TestAllTypesProto2 copyWith(void Function(TestAllTypesProto2) updates) => super.copyWith((message) => updates(message as TestAllTypesProto2));
  $pb.BuilderInfo get info_ => _i;
  ...
  static TestAllTypesProto2 getDefault() => _defaultInstance ??= create()..freeze();
  ...
  set oneofUint32($core.int v) { $_setUnsignedInt32(62, v); }
...
class ForeignMessageProto2 extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ForeignMessageProto2', package: const $pb.PackageName('protobuf_test_messages.proto2'))
    ..a<$core.int>(1, 'c', $pb.PbFieldType.O3)
    ..hasRequiredFields = false
  ;

  ForeignMessageProto2() : super();
  ForeignMessageProto2.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  ForeignMessageProto2.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ForeignMessageProto2 clone() => ForeignMessageProto2()..mergeFromMessage(this);
  ForeignMessageProto2 copyWith(void Function(ForeignMessageProto2) updates) => super.copyWith((message) => updates(message as ForeignMessageProto2));
  $pb.BuilderInfo get info_ => _i;
  ...
  static ForeignMessageProto2 getDefault() => _defaultInstance ??= create()..freeze();
...
class UnknownToTestAllTypes_OptionalGroup extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('UnknownToTestAllTypes.OptionalGroup', package: const $pb.PackageName('protobuf_test_messages.proto2'))
    ..a<$core.int>(1, 'a', $pb.PbFieldType.O3)
    ..hasRequiredFields = false
  ;

  UnknownToTestAllTypes_OptionalGroup() : super();
  UnknownToTestAllTypes_OptionalGroup.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  UnknownToTestAllTypes_OptionalGroup.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  UnknownToTestAllTypes_OptionalGroup clone() => UnknownToTestAllTypes_OptionalGroup()..mergeFromMessage(this);
  UnknownToTestAllTypes_OptionalGroup copyWith(void Function(UnknownToTestAllTypes_OptionalGroup) updates) => super.copyWith((message) => updates(message as UnknownToTestAllTypes_OptionalGroup));
  $pb.BuilderInfo get info_ => _i;
  static UnknownToTestAllTypes_OptionalGroup create() => UnknownToTestAllTypes_OptionalGroup();
  ...
  static UnknownToTestAllTypes_OptionalGroup getDefault() => _defaultInstance ??= create()..freeze();
...
class UnknownToTestAllTypes extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('UnknownToTestAllTypes', package: const $pb.PackageName('protobuf_test_messages.proto2'))
    ..a<$core.int>(1001, 'optionalInt32', $pb.PbFieldType.O3)
    ..aOS(1002, 'optionalString')
    ..a<ForeignMessageProto2>(1003, 'nestedMessage', $pb.PbFieldType.OM, ForeignMessageProto2.getDefault, ForeignMessageProto2.create)
    ..a<UnknownToTestAllTypes_OptionalGroup>(1004, 'optionalGroup', $pb.PbFieldType.OG, UnknownToTestAllTypes_OptionalGroup.getDefault, UnknownToTestAllTypes_OptionalGroup.create)
  ...
  UnknownToTestAllTypes.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  UnknownToTestAllTypes.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  UnknownToTestAllTypes clone() => UnknownToTestAllTypes()..mergeFromMessage(this);
  UnknownToTestAllTypes copyWith(void Function(UnknownToTestAllTypes) updates) => super.copyWith((message) => updates(message as UnknownToTestAllTypes));
  $pb.BuilderInfo get info_ => _i;
  ...
  static UnknownToTestAllTypes getDefault() => _defaultInstance ??= create()..freeze();
...
class Test_messages_proto2 {
  static final $pb.Extension extensionInt32 = $pb.Extension<$core.int>('protobuf_test_messages.proto2.TestAllTypesProto2', 'extensionInt32', 120, $pb.PbFieldType.O3);
