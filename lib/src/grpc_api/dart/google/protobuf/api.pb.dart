...
class Api extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Api', package: const $pb.PackageName('google.protobuf'))
    ...
    ..aOS(4, 'version')
    ..a<$1.SourceContext>(5, 'sourceContext', $pb.PbFieldType.OM, $1.SourceContext.getDefault, $1.SourceContext.create)
    ..pc<Mixin>(6, 'mixins', $pb.PbFieldType.PM,Mixin.create)
    ..e<$0.Syntax>(7, 'syntax', $pb.PbFieldType.OE, $0.Syntax.SYNTAX_PROTO2, $0.Syntax.valueOf, $0.Syntax.values)
