...
class Type extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('Type')
    ...
    ..e<Syntax>(6, 'syntax', PbFieldType.OE, Syntax.SYNTAX_PROTO2, Syntax.valueOf, Syntax.values)
...
class Field extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('Field')
    ..e<Field_Kind>(1, 'kind', PbFieldType.OE, Field_Kind.TYPE_UNKNOWN, Field_Kind.valueOf, Field_Kind.values)
    ..e<Field_Cardinality>(2, 'cardinality', PbFieldType.OE, Field_Cardinality.CARDINALITY_UNKNOWN, Field_Cardinality.valueOf, Field_Cardinality.values)
...
class Enum extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('Enum')
    ...
    ..e<Syntax>(5, 'syntax', PbFieldType.OE, Syntax.SYNTAX_PROTO2, Syntax.valueOf, Syntax.values)
    ..hasRequiredFields = false
  ;
