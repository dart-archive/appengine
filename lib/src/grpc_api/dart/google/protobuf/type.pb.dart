...
class Type extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Type', package: const $pb.PackageName('google.protobuf'))
    ..aOS(1, 'name')
...
class Field extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Field', package: const $pb.PackageName('google.protobuf'))
...
class Enum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Enum', package: const $pb.PackageName('google.protobuf'))
    ..aOS(1, 'name')
  ...
  Enum() : super();
  Enum.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  Enum.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
...
class EnumValue extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('EnumValue', package: const $pb.PackageName('google.protobuf'))
    ..aOS(1, 'name')
...
class Option extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Option', package: const $pb.PackageName('google.protobuf'))
    ..aOS(1, 'name')
