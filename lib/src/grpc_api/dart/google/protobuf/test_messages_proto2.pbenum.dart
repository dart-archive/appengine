...
class TestAllTypesProto2_NestedEnum extends $pb.ProtobufEnum {
  static const TestAllTypesProto2_NestedEnum FOO =
      TestAllTypesProto2_NestedEnum._(0,
          $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'FOO');
  static const TestAllTypesProto2_NestedEnum BAR =
      TestAllTypesProto2_NestedEnum._(1,
          $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'BAR');
  static const TestAllTypesProto2_NestedEnum BAZ =
      TestAllTypesProto2_NestedEnum._(2,
          $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'BAZ');
  static const TestAllTypesProto2_NestedEnum NEG =
      TestAllTypesProto2_NestedEnum._(-1,
          $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'NEG');
