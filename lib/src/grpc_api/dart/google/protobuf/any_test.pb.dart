...
class TestAny extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('TestAny', package: const $pb.PackageName('protobuf_unittest'))
    ..a<$core.int>(1, 'int32Value', $pb.PbFieldType.O3)
    ..a<$0.Any>(2, 'anyValue', $pb.PbFieldType.OM, $0.Any.getDefault, $0.Any.create)
    ..pc<$0.Any>(3, 'repeatedAnyValue', $pb.PbFieldType.PM,$0.Any.create)
    ..hasRequiredFields = false
  ;

  TestAny() : super();
  TestAny.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  TestAny.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  TestAny clone() => TestAny()..mergeFromMessage(this);
  TestAny copyWith(void Function(TestAny) updates) => super.copyWith((message) => updates(message as TestAny));
