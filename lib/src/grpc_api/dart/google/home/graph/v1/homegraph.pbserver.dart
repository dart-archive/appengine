...
abstract class HomeGraphApiServiceBase extends $pb.GeneratedService {
  $async.Future<RequestSyncDevicesResponse> requestSyncDevices(
      $pb.ServerContext ctx, RequestSyncDevicesRequest request);
  $async.Future<ReportStateAndNotificationResponse> reportStateAndNotification(
      $pb.ServerContext ctx, ReportStateAndNotificationRequest request);
  $async.Future<$2.Empty> deleteAgentUser(
      $pb.ServerContext ctx, DeleteAgentUserRequest request);
  $async.Future<QueryResponse> query(
      $pb.ServerContext ctx, QueryRequest request);
  ...
  $core.Map<$core.String, $core.dynamic> get $json =>
      HomeGraphApiServiceBase$json;
  $core.Map<$core.String, $core.Map<$core.String, $core.dynamic>>
      get $messageJson => HomeGraphApiServiceBase$messageJson;
}
