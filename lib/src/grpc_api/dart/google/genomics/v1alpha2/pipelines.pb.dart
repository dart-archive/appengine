...
class ComputeEngine extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ComputeEngine', package: const $pb.PackageName('google.genomics.v1alpha2'))
    ..aOS(1, 'instanceName')
    ..aOS(2, 'zone')
    ..aOS(3, 'machineType')
    ..pPS(4, 'diskNames')
  ...
  ComputeEngine() : super();
  ComputeEngine.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  ComputeEngine.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ComputeEngine clone() => ComputeEngine()..mergeFromMessage(this);
  ComputeEngine copyWith(void Function(ComputeEngine) updates) => super.copyWith((message) => updates(message as ComputeEngine));
...
class RuntimeMetadata extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('RuntimeMetadata', package: const $pb.PackageName('google.genomics.v1alpha2'))
    ..a<ComputeEngine>(1, 'computeEngine', $pb.PbFieldType.OM, ComputeEngine.getDefault, ComputeEngine.create)
    ..hasRequiredFields = false
  ;

  RuntimeMetadata() : super();
  RuntimeMetadata.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  RuntimeMetadata.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  RuntimeMetadata clone() => RuntimeMetadata()..mergeFromMessage(this);
  RuntimeMetadata copyWith(void Function(RuntimeMetadata) updates) => super.copyWith((message) => updates(message as RuntimeMetadata));
  $pb.BuilderInfo get info_ => _i;
  ...
  static RuntimeMetadata getDefault() => _defaultInstance ??= create()..freeze();
...
class Pipeline extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Pipeline', package: const $pb.PackageName('google.genomics.v1alpha2'))
    ..aOS(1, 'projectId')
    ..aOS(2, 'name')
    ..aOS(3, 'description')
    ..a<DockerExecutor>(5, 'docker', $pb.PbFieldType.OM, DockerExecutor.getDefault, DockerExecutor.create)
    ..a<PipelineResources>(6, 'resources', $pb.PbFieldType.OM, PipelineResources.getDefault, PipelineResources.create)
    ..aOS(7, 'pipelineId')
    ..pc<PipelineParameter>(8, 'inputParameters', $pb.PbFieldType.PM,PipelineParameter.create)
    ..pc<PipelineParameter>(9, 'outputParameters', $pb.PbFieldType.PM,PipelineParameter.create)
    ..oo(0, [5])
    ..hasRequiredFields = false
  ;

  Pipeline() : super();
  Pipeline.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  Pipeline.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  Pipeline clone() => Pipeline()..mergeFromMessage(this);
  Pipeline copyWith(void Function(Pipeline) updates) => super.copyWith((message) => updates(message as Pipeline));
  $pb.BuilderInfo get info_ => _i;
...
class CreatePipelineRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('CreatePipelineRequest', package: const $pb.PackageName('google.genomics.v1alpha2'))
    ..a<Pipeline>(1, 'pipeline', $pb.PbFieldType.OM, Pipeline.getDefault, Pipeline.create)
    ..hasRequiredFields = false
  ;

  CreatePipelineRequest() : super();
  CreatePipelineRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  CreatePipelineRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  CreatePipelineRequest clone() => CreatePipelineRequest()..mergeFromMessage(this);
  CreatePipelineRequest copyWith(void Function(CreatePipelineRequest) updates) => super.copyWith((message) => updates(message as CreatePipelineRequest));
  $pb.BuilderInfo get info_ => _i;
  ...
  static CreatePipelineRequest getDefault() => _defaultInstance ??= create()..freeze();
...
class RunPipelineArgs extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('RunPipelineArgs', package: const $pb.PackageName('google.genomics.v1alpha2'))
    ..aOS(1, 'projectId')
    ..m<$core.String, $core.String>(2, 'inputs', 'RunPipelineArgs.InputsEntry',$pb.PbFieldType.OS, $pb.PbFieldType.OS, null, null, null , const $pb.PackageName('google.genomics.v1alpha2'))
    ..m<$core.String, $core.String>(3, 'outputs', 'RunPipelineArgs.OutputsEntry',$pb.PbFieldType.OS, $pb.PbFieldType.OS, null, null, null , const $pb.PackageName('google.genomics.v1alpha2'))
    ..a<ServiceAccount>(4, 'serviceAccount', $pb.PbFieldType.OM, ServiceAccount.getDefault, ServiceAccount.create)
    ..aOS(5, 'clientId')
    ..a<PipelineResources>(6, 'resources', $pb.PbFieldType.OM, PipelineResources.getDefault, PipelineResources.create)
    ..a<LoggingOptions>(7, 'logging', $pb.PbFieldType.OM, LoggingOptions.getDefault, LoggingOptions.create)
    ..a<$0.Duration>(8, 'keepVmAliveOnFailureDuration', $pb.PbFieldType.OM, $0.Duration.getDefault, $0.Duration.create)
    ..m<$core.String, $core.String>(9, 'labels', 'RunPipelineArgs.LabelsEntry',$pb.PbFieldType.OS, $pb.PbFieldType.OS, null, null, null , const $pb.PackageName('google.genomics.v1alpha2'))
    ..hasRequiredFields = false
  ;

  RunPipelineArgs() : super();
  RunPipelineArgs.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  RunPipelineArgs.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  RunPipelineArgs clone() => RunPipelineArgs()..mergeFromMessage(this);
  RunPipelineArgs copyWith(void Function(RunPipelineArgs) updates) => super.copyWith((message) => updates(message as RunPipelineArgs));
  $pb.BuilderInfo get info_ => _i;
  ...
  static RunPipelineArgs getDefault() => _defaultInstance ??= create()..freeze();
  ...
  set keepVmAliveOnFailureDuration($0.Duration v) { setField(8, v); }
...
class RunPipelineRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('RunPipelineRequest', package: const $pb.PackageName('google.genomics.v1alpha2'))
    ..aOS(1, 'pipelineId')
    ..a<Pipeline>(2, 'ephemeralPipeline', $pb.PbFieldType.OM, Pipeline.getDefault, Pipeline.create)
    ..a<RunPipelineArgs>(3, 'pipelineArgs', $pb.PbFieldType.OM, RunPipelineArgs.getDefault, RunPipelineArgs.create)
    ..oo(0, [1, 2])
    ..hasRequiredFields = false
  ;

  RunPipelineRequest() : super();
  RunPipelineRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  RunPipelineRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  RunPipelineRequest clone() => RunPipelineRequest()..mergeFromMessage(this);
  RunPipelineRequest copyWith(void Function(RunPipelineRequest) updates) => super.copyWith((message) => updates(message as RunPipelineRequest));
  $pb.BuilderInfo get info_ => _i;
  ...
  static RunPipelineRequest getDefault() => _defaultInstance ??= create()..freeze();
...
class GetPipelineRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('GetPipelineRequest', package: const $pb.PackageName('google.genomics.v1alpha2'))
    ..aOS(1, 'pipelineId')
    ..hasRequiredFields = false
  ;

  GetPipelineRequest() : super();
  GetPipelineRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  GetPipelineRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  GetPipelineRequest clone() => GetPipelineRequest()..mergeFromMessage(this);
  GetPipelineRequest copyWith(void Function(GetPipelineRequest) updates) => super.copyWith((message) => updates(message as GetPipelineRequest));
  $pb.BuilderInfo get info_ => _i;
  ...
  static GetPipelineRequest getDefault() => _defaultInstance ??= create()..freeze();
...
class ListPipelinesRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ListPipelinesRequest', package: const $pb.PackageName('google.genomics.v1alpha2'))
    ..aOS(1, 'projectId')
    ..aOS(2, 'namePrefix')
  ...
  ListPipelinesRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  ListPipelinesRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ListPipelinesRequest clone() => ListPipelinesRequest()..mergeFromMessage(this);
  ListPipelinesRequest copyWith(void Function(ListPipelinesRequest) updates) => super.copyWith((message) => updates(message as ListPipelinesRequest));
  $pb.BuilderInfo get info_ => _i;
  ...
  static ListPipelinesRequest getDefault() => _defaultInstance ??= create()..freeze();
...
class ListPipelinesResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ListPipelinesResponse', package: const $pb.PackageName('google.genomics.v1alpha2'))
  ...
  ListPipelinesResponse.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  ListPipelinesResponse.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ListPipelinesResponse clone() => ListPipelinesResponse()..mergeFromMessage(this);
  ListPipelinesResponse copyWith(void Function(ListPipelinesResponse) updates) => super.copyWith((message) => updates(message as ListPipelinesResponse));
  $pb.BuilderInfo get info_ => _i;
  ...
  static ListPipelinesResponse getDefault() => _defaultInstance ??= create()..freeze();
...
class DeletePipelineRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('DeletePipelineRequest', package: const $pb.PackageName('google.genomics.v1alpha2'))
    ..aOS(1, 'pipelineId')
    ..hasRequiredFields = false
  ;

  DeletePipelineRequest() : super();
  DeletePipelineRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  DeletePipelineRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  DeletePipelineRequest clone() => DeletePipelineRequest()..mergeFromMessage(this);
  DeletePipelineRequest copyWith(void Function(DeletePipelineRequest) updates) => super.copyWith((message) => updates(message as DeletePipelineRequest));
  $pb.BuilderInfo get info_ => _i;
  ...
  static DeletePipelineRequest getDefault() => _defaultInstance ??= create()..freeze();
...
class GetControllerConfigRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('GetControllerConfigRequest', package: const $pb.PackageName('google.genomics.v1alpha2'))
    ..aOS(1, 'operationId')
  ...
  GetControllerConfigRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  GetControllerConfigRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  GetControllerConfigRequest clone() => GetControllerConfigRequest()..mergeFromMessage(this);
  GetControllerConfigRequest copyWith(void Function(GetControllerConfigRequest) updates) => super.copyWith((message) => updates(message as GetControllerConfigRequest));
  $pb.BuilderInfo get info_ => _i;
  ...
  static GetControllerConfigRequest getDefault() => _defaultInstance ??= create()..freeze();
...
class ControllerConfig_RepeatedString extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ControllerConfig.RepeatedString', package: const $pb.PackageName('google.genomics.v1alpha2'))
    ..pPS(1, 'values')
    ..hasRequiredFields = false
  ;

  ControllerConfig_RepeatedString() : super();
  ControllerConfig_RepeatedString.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  ControllerConfig_RepeatedString.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ControllerConfig_RepeatedString clone() => ControllerConfig_RepeatedString()..mergeFromMessage(this);
  ControllerConfig_RepeatedString copyWith(void Function(ControllerConfig_RepeatedString) updates) => super.copyWith((message) => updates(message as ControllerConfig_RepeatedString));
  $pb.BuilderInfo get info_ => _i;
  static ControllerConfig_RepeatedString create() => ControllerConfig_RepeatedString();
  ...
  static ControllerConfig_RepeatedString getDefault() => _defaultInstance ??= create()..freeze();
...
class ControllerConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ControllerConfig', package: const $pb.PackageName('google.genomics.v1alpha2'))
    ..aOS(1, 'image')
    ..aOS(2, 'cmd')
    ..aOS(3, 'gcsLogPath')
    ..aOS(4, 'machineType')
    ..m<$core.String, $core.String>(5, 'vars', 'ControllerConfig.VarsEntry',$pb.PbFieldType.OS, $pb.PbFieldType.OS, null, null, null , const $pb.PackageName('google.genomics.v1alpha2'))
    ..m<$core.String, $core.String>(6, 'disks', 'ControllerConfig.DisksEntry',$pb.PbFieldType.OS, $pb.PbFieldType.OS, null, null, null , const $pb.PackageName('google.genomics.v1alpha2'))
    ..m<$core.String, ControllerConfig_RepeatedString>(7, 'gcsSources', 'ControllerConfig.GcsSourcesEntry',$pb.PbFieldType.OS, $pb.PbFieldType.OM, ControllerConfig_RepeatedString.create, null, null , const $pb.PackageName('google.genomics.v1alpha2'))
    ..m<$core.String, ControllerConfig_RepeatedString>(8, 'gcsSinks', 'ControllerConfig.GcsSinksEntry',$pb.PbFieldType.OS, $pb.PbFieldType.OM, ControllerConfig_RepeatedString.create, null, null , const $pb.PackageName('google.genomics.v1alpha2'))
    ..hasRequiredFields = false
  ;

  ControllerConfig() : super();
  ControllerConfig.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  ControllerConfig.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ControllerConfig clone() => ControllerConfig()..mergeFromMessage(this);
  ControllerConfig copyWith(void Function(ControllerConfig) updates) => super.copyWith((message) => updates(message as ControllerConfig));
  $pb.BuilderInfo get info_ => _i;
  ...
  static ControllerConfig getDefault() => _defaultInstance ??= create()..freeze();
...
class TimestampEvent extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('TimestampEvent', package: const $pb.PackageName('google.genomics.v1alpha2'))
    ..aOS(1, 'description')
    ..a<$1.Timestamp>(2, 'timestamp', $pb.PbFieldType.OM, $1.Timestamp.getDefault, $1.Timestamp.create)
    ..hasRequiredFields = false
  ;

  TimestampEvent() : super();
  TimestampEvent.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  TimestampEvent.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  TimestampEvent clone() => TimestampEvent()..mergeFromMessage(this);
  TimestampEvent copyWith(void Function(TimestampEvent) updates) => super.copyWith((message) => updates(message as TimestampEvent));
  $pb.BuilderInfo get info_ => _i;
...
class SetOperationStatusRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('SetOperationStatusRequest', package: const $pb.PackageName('google.genomics.v1alpha2'))
    ..aOS(1, 'operationId')
    ..pc<TimestampEvent>(2, 'timestampEvents', $pb.PbFieldType.PM,TimestampEvent.create)
    ..e<$4.Code>(3, 'errorCode', $pb.PbFieldType.OE, $4.Code.OK, $4.Code.valueOf, $4.Code.values)
    ..aOS(4, 'errorMessage')
  ...
  SetOperationStatusRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  SetOperationStatusRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  SetOperationStatusRequest clone() => SetOperationStatusRequest()..mergeFromMessage(this);
  SetOperationStatusRequest copyWith(void Function(SetOperationStatusRequest) updates) => super.copyWith((message) => updates(message as SetOperationStatusRequest));
  $pb.BuilderInfo get info_ => _i;
  ...
  static SetOperationStatusRequest getDefault() => _defaultInstance ??= create()..freeze();
  ...
  set errorCode($4.Code v) { setField(3, v); }
...
class ServiceAccount extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ServiceAccount', package: const $pb.PackageName('google.genomics.v1alpha2'))
    ..aOS(1, 'email')
    ..pPS(2, 'scopes')
    ..hasRequiredFields = false
  ;
...
class LoggingOptions extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('LoggingOptions', package: const $pb.PackageName('google.genomics.v1alpha2'))
    ..aOS(1, 'gcsPath')
    ..hasRequiredFields = false
  ;

  LoggingOptions() : super();
  LoggingOptions.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  LoggingOptions.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  LoggingOptions clone() => LoggingOptions()..mergeFromMessage(this);
  LoggingOptions copyWith(void Function(LoggingOptions) updates) => super.copyWith((message) => updates(message as LoggingOptions));
  $pb.BuilderInfo get info_ => _i;
...
class PipelineResources_Disk extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('PipelineResources.Disk', package: const $pb.PackageName('google.genomics.v1alpha2'))
    ..aOS(1, 'name')
    ..e<PipelineResources_Disk_Type>(2, 'type', $pb.PbFieldType.OE, PipelineResources_Disk_Type.TYPE_UNSPECIFIED, PipelineResources_Disk_Type.valueOf, PipelineResources_Disk_Type.values)
  ...
  PipelineResources_Disk.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  PipelineResources_Disk.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  PipelineResources_Disk clone() => PipelineResources_Disk()..mergeFromMessage(this);
  PipelineResources_Disk copyWith(void Function(PipelineResources_Disk) updates) => super.copyWith((message) => updates(message as PipelineResources_Disk));
  $pb.BuilderInfo get info_ => _i;
  ...
  static PipelineResources_Disk getDefault() => _defaultInstance ??= create()..freeze();
...
class PipelineResources extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('PipelineResources', package: const $pb.PackageName('google.genomics.v1alpha2'))
    ..a<$core.int>(1, 'minimumCpuCores', $pb.PbFieldType.O3)
    ..aOB(2, 'preemptible')
    ..a<$core.double>(3, 'minimumRamGb', $pb.PbFieldType.OD)
    ..pc<PipelineResources_Disk>(4, 'disks', $pb.PbFieldType.PM,PipelineResources_Disk.create)
    ..pPS(5, 'zones')
  ...
  PipelineResources.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  PipelineResources.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  PipelineResources clone() => PipelineResources()..mergeFromMessage(this);
  PipelineResources copyWith(void Function(PipelineResources) updates) => super.copyWith((message) => updates(message as PipelineResources));
  $pb.BuilderInfo get info_ => _i;
  ...
  static PipelineResources getDefault() => _defaultInstance ??= create()..freeze();
...
class PipelineParameter_LocalCopy extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('PipelineParameter.LocalCopy', package: const $pb.PackageName('google.genomics.v1alpha2'))
    ..aOS(1, 'path')
    ..aOS(2, 'disk')
    ..hasRequiredFields = false
  ;
  ...
  PipelineParameter_LocalCopy.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  PipelineParameter_LocalCopy.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  PipelineParameter_LocalCopy clone() => PipelineParameter_LocalCopy()..mergeFromMessage(this);
  PipelineParameter_LocalCopy copyWith(void Function(PipelineParameter_LocalCopy) updates) => super.copyWith((message) => updates(message as PipelineParameter_LocalCopy));
  $pb.BuilderInfo get info_ => _i;
  ...
  static PipelineParameter_LocalCopy getDefault() => _defaultInstance ??= create()..freeze();
...
class PipelineParameter extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('PipelineParameter', package: const $pb.PackageName('google.genomics.v1alpha2'))
    ..aOS(1, 'name')
    ..aOS(2, 'description')
    ..aOS(5, 'defaultValue')
    ..a<PipelineParameter_LocalCopy>(6, 'localCopy', $pb.PbFieldType.OM, PipelineParameter_LocalCopy.getDefault, PipelineParameter_LocalCopy.create)
    ..hasRequiredFields = false
  ;

  PipelineParameter() : super();
  PipelineParameter.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  PipelineParameter.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  PipelineParameter clone() => PipelineParameter()..mergeFromMessage(this);
  PipelineParameter copyWith(void Function(PipelineParameter) updates) => super.copyWith((message) => updates(message as PipelineParameter));
  $pb.BuilderInfo get info_ => _i;
  ...
  static PipelineParameter getDefault() => _defaultInstance ??= create()..freeze();
...
class DockerExecutor extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('DockerExecutor', package: const $pb.PackageName('google.genomics.v1alpha2'))
    ..aOS(1, 'imageName')
    ..aOS(2, 'cmd')
    ..hasRequiredFields = false
  ;
  ...
  DockerExecutor.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  DockerExecutor.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  DockerExecutor clone() => DockerExecutor()..mergeFromMessage(this);
  DockerExecutor copyWith(void Function(DockerExecutor) updates) => super.copyWith((message) => updates(message as DockerExecutor));
  $pb.BuilderInfo get info_ => _i;
...
class PipelinesV1Alpha2Api {
  ...
  $async.Future<Pipeline> createPipeline($pb.ClientContext ctx, CreatePipelineRequest request) {
    var emptyResponse = Pipeline();
    return _client.invoke<Pipeline>(ctx, 'PipelinesV1Alpha2', 'CreatePipeline', request, emptyResponse);
  }
  $async.Future<$2.Operation> runPipeline($pb.ClientContext ctx, RunPipelineRequest request) {
    var emptyResponse = $2.Operation();
    return _client.invoke<$2.Operation>(ctx, 'PipelinesV1Alpha2', 'RunPipeline', request, emptyResponse);
  }
  $async.Future<Pipeline> getPipeline($pb.ClientContext ctx, GetPipelineRequest request) {
    var emptyResponse = Pipeline();
    return _client.invoke<Pipeline>(ctx, 'PipelinesV1Alpha2', 'GetPipeline', request, emptyResponse);
  }
  $async.Future<ListPipelinesResponse> listPipelines($pb.ClientContext ctx, ListPipelinesRequest request) {
  ...
  $async.Future<$3.Empty> deletePipeline($pb.ClientContext ctx, DeletePipelineRequest request) {
    var emptyResponse = $3.Empty();
    return _client.invoke<$3.Empty>(ctx, 'PipelinesV1Alpha2', 'DeletePipeline', request, emptyResponse);
  }
  $async.Future<ControllerConfig> getControllerConfig($pb.ClientContext ctx, GetControllerConfigRequest request) {
  ...
  $async.Future<$3.Empty> setOperationStatus($pb.ClientContext ctx, SetOperationStatusRequest request) {
    var emptyResponse = $3.Empty();
    return _client.invoke<$3.Empty>(ctx, 'PipelinesV1Alpha2', 'SetOperationStatus', request, emptyResponse);
  }
}
