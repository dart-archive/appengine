...
abstract class DatasetServiceV1ServiceBase extends $pb.GeneratedService {
  ...
  $async.Future<Dataset> createDataset($pb.ServerContext ctx, CreateDatasetRequest request);
  $async.Future<Dataset> getDataset($pb.ServerContext ctx, GetDatasetRequest request);
  $async.Future<Dataset> updateDataset($pb.ServerContext ctx, UpdateDatasetRequest request);
  $async.Future<$2.Empty> deleteDataset($pb.ServerContext ctx, DeleteDatasetRequest request);
  $async.Future<Dataset> undeleteDataset($pb.ServerContext ctx, UndeleteDatasetRequest request);
  ...
  $pb.GeneratedMessage createRequest($core.String method) {
    switch (method) {
      ...
      case 'UndeleteDataset': return UndeleteDatasetRequest();
  ...
  $core.Map<$core.String, $core.dynamic> get $json => DatasetServiceV1ServiceBase$json;
  $core.Map<$core.String, $core.Map<$core.String, $core.dynamic>> get $messageJson => DatasetServiceV1ServiceBase$messageJson;
}
