...
class LinearAlignment extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('LinearAlignment', package: const $pb.PackageName('google.genomics.v1'))
    ..a<$0.Position>(1, 'position', $pb.PbFieldType.OM, $0.Position.getDefault, $0.Position.create)
  ...
  LinearAlignment.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  LinearAlignment.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  LinearAlignment clone() => LinearAlignment()..mergeFromMessage(this);
  LinearAlignment copyWith(void Function(LinearAlignment) updates) => super.copyWith((message) => updates(message as LinearAlignment));
  ...
  static LinearAlignment getDefault() => _defaultInstance ??= create()..freeze();
...
class Read extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Read', package: const $pb.PackageName('google.genomics.v1'))
    ..aOS(1, 'id')
    ..aOS(2, 'readGroupId')
    ...
    ..a<LinearAlignment>(11, 'alignment', $pb.PbFieldType.OM, LinearAlignment.getDefault, LinearAlignment.create)
    ...
    ..a<$0.Position>(16, 'nextMatePosition', $pb.PbFieldType.OM, $0.Position.getDefault, $0.Position.create)
    ..m<$core.String, $2.ListValue>(17, 'info', 'Read.InfoEntry',$pb.PbFieldType.OS, $pb.PbFieldType.OM, $2.ListValue.create, null, null , const $pb.PackageName('google.genomics.v1'))
    ..hasRequiredFields = false
  ;

  Read() : super();
  Read.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  Read.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  Read clone() => Read()..mergeFromMessage(this);
  Read copyWith(void Function(Read) updates) => super.copyWith((message) => updates(message as Read));
  $pb.BuilderInfo get info_ => _i;
