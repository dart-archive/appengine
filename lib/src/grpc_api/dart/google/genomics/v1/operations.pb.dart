...
class OperationMetadata extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('OperationMetadata', package: const $pb.PackageName('google.genomics.v1'))
    ..aOS(1, 'projectId')
    ...
    ..a<$0.Timestamp>(4, 'endTime', $pb.PbFieldType.OM, $0.Timestamp.getDefault, $0.Timestamp.create)
    ..a<$1.Any>(5, 'request', $pb.PbFieldType.OM, $1.Any.getDefault, $1.Any.create)
    ..pc<OperationEvent>(6, 'events', $pb.PbFieldType.PM,OperationEvent.create)
    ..aOS(7, 'clientId')
    ..a<$1.Any>(8, 'runtimeMetadata', $pb.PbFieldType.OM, $1.Any.getDefault, $1.Any.create)
    ..m<$core.String, $core.String>(9, 'labels', 'OperationMetadata.LabelsEntry',$pb.PbFieldType.OS, $pb.PbFieldType.OS, null, null, null , const $pb.PackageName('google.genomics.v1'))
...
class OperationEvent extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('OperationEvent', package: const $pb.PackageName('google.genomics.v1'))
  ...
  OperationEvent.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  OperationEvent.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  OperationEvent clone() => OperationEvent()..mergeFromMessage(this);
  OperationEvent copyWith(void Function(OperationEvent) updates) => super.copyWith((message) => updates(message as OperationEvent));
  $pb.BuilderInfo get info_ => _i;
