...
class ImportReadGroupSetsRequest_PartitionStrategy extends ProtobufEnum {
  ...
  static ImportReadGroupSetsRequest_PartitionStrategy valueOf(int value) =>
      _byValue[value] as ImportReadGroupSetsRequest_PartitionStrategy;
  static void $checkItem(ImportReadGroupSetsRequest_PartitionStrategy v) {
    if (v is! ImportReadGroupSetsRequest_PartitionStrategy)
      checkItemFailed(v, 'ImportReadGroupSetsRequest_PartitionStrategy');
  }

  const ImportReadGroupSetsRequest_PartitionStrategy._(int v, String n)
      : super(v, n);
}
