...
class ImportReadGroupSetsRequest_PartitionStrategy extends $pb.ProtobufEnum {
  static const ImportReadGroupSetsRequest_PartitionStrategy PARTITION_STRATEGY_UNSPECIFIED = ImportReadGroupSetsRequest_PartitionStrategy._(0, 'PARTITION_STRATEGY_UNSPECIFIED');
  static const ImportReadGroupSetsRequest_PartitionStrategy PER_FILE_PER_SAMPLE = ImportReadGroupSetsRequest_PartitionStrategy._(1, 'PER_FILE_PER_SAMPLE');
  static const ImportReadGroupSetsRequest_PartitionStrategy MERGE_ALL = ImportReadGroupSetsRequest_PartitionStrategy._(2, 'MERGE_ALL');
