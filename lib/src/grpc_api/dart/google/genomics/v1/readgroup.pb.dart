...
class ReadGroup_Experiment extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ReadGroup.Experiment', package: const $pb.PackageName('google.genomics.v1'))
    ..aOS(1, 'libraryId')
    ..aOS(2, 'platformUnit')
  ...
  ReadGroup_Experiment.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  ReadGroup_Experiment.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ReadGroup_Experiment clone() => ReadGroup_Experiment()..mergeFromMessage(this);
  ReadGroup_Experiment copyWith(void Function(ReadGroup_Experiment) updates) => super.copyWith((message) => updates(message as ReadGroup_Experiment));
  ...
  static ReadGroup_Experiment getDefault() => _defaultInstance ??= create()..freeze();
...
class ReadGroup_Program extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ReadGroup.Program', package: const $pb.PackageName('google.genomics.v1'))
    ..aOS(1, 'commandLine')
    ..aOS(2, 'id')
    ..aOS(3, 'name')
    ..aOS(4, 'prevProgramId')
  ...
  ReadGroup_Program.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  ReadGroup_Program.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ReadGroup_Program clone() => ReadGroup_Program()..mergeFromMessage(this);
  ReadGroup_Program copyWith(void Function(ReadGroup_Program) updates) => super.copyWith((message) => updates(message as ReadGroup_Program));
  $pb.BuilderInfo get info_ => _i;
  ...
  static ReadGroup_Program getDefault() => _defaultInstance ??= create()..freeze();
...
class ReadGroup extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ReadGroup', package: const $pb.PackageName('google.genomics.v1'))
    ..aOS(1, 'id')
    ..aOS(2, 'datasetId')
    ..aOS(3, 'name')
    ..aOS(4, 'description')
    ..aOS(5, 'sampleId')
    ..a<ReadGroup_Experiment>(6, 'experiment', $pb.PbFieldType.OM, ReadGroup_Experiment.getDefault, ReadGroup_Experiment.create)
    ..a<$core.int>(7, 'predictedInsertSize', $pb.PbFieldType.O3)
    ..pc<ReadGroup_Program>(10, 'programs', $pb.PbFieldType.PM,ReadGroup_Program.create)
    ..aOS(11, 'referenceSetId')
    ..m<$core.String, $0.ListValue>(12, 'info', 'ReadGroup.InfoEntry',$pb.PbFieldType.OS, $pb.PbFieldType.OM, $0.ListValue.create, null, null , const $pb.PackageName('google.genomics.v1'))
    ..hasRequiredFields = false
  ;

  ReadGroup() : super();
  ReadGroup.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  ReadGroup.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ReadGroup clone() => ReadGroup()..mergeFromMessage(this);
  ReadGroup copyWith(void Function(ReadGroup) updates) => super.copyWith((message) => updates(message as ReadGroup));
  $pb.BuilderInfo get info_ => _i;
