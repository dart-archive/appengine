...
class VariantAnnotation_Type extends ProtobufEnum {
  ...
  static final Map<int, dynamic> _byValue = ProtobufEnum.initByValue(values);
  static VariantAnnotation_Type valueOf(int value) =>
      _byValue[value] as VariantAnnotation_Type;
  static void $checkItem(VariantAnnotation_Type v) {
    if (v is! VariantAnnotation_Type)
      checkItemFailed(v, 'VariantAnnotation_Type');
  }
...
class VariantAnnotation_Effect extends ProtobufEnum {
  ...
  static final Map<int, dynamic> _byValue = ProtobufEnum.initByValue(values);
  static VariantAnnotation_Effect valueOf(int value) =>
      _byValue[value] as VariantAnnotation_Effect;
  static void $checkItem(VariantAnnotation_Effect v) {
    if (v is! VariantAnnotation_Effect)
      checkItemFailed(v, 'VariantAnnotation_Effect');
  }
...
class VariantAnnotation_ClinicalSignificance extends ProtobufEnum {
  ...
  static final Map<int, dynamic> _byValue = ProtobufEnum.initByValue(values);
  static VariantAnnotation_ClinicalSignificance valueOf(int value) =>
      _byValue[value] as VariantAnnotation_ClinicalSignificance;
  static void $checkItem(VariantAnnotation_ClinicalSignificance v) {
    if (v is! VariantAnnotation_ClinicalSignificance)
      checkItemFailed(v, 'VariantAnnotation_ClinicalSignificance');
  }
