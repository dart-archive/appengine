...
abstract class AnnotationServiceV1ServiceBase extends $pb.GeneratedService {
  $async.Future<AnnotationSet> createAnnotationSet(
      $pb.ServerContext ctx, CreateAnnotationSetRequest request);
  $async.Future<AnnotationSet> getAnnotationSet(
      $pb.ServerContext ctx, GetAnnotationSetRequest request);
  $async.Future<AnnotationSet> updateAnnotationSet(
      $pb.ServerContext ctx, UpdateAnnotationSetRequest request);
  $async.Future<$4.Empty> deleteAnnotationSet(
      $pb.ServerContext ctx, DeleteAnnotationSetRequest request);
  $async.Future<SearchAnnotationSetsResponse> searchAnnotationSets(
      $pb.ServerContext ctx, SearchAnnotationSetsRequest request);
  ...
  $async.Future<BatchCreateAnnotationsResponse> batchCreateAnnotations(
      $pb.ServerContext ctx, BatchCreateAnnotationsRequest request);
  $async.Future<Annotation> getAnnotation(
      $pb.ServerContext ctx, GetAnnotationRequest request);
  $async.Future<Annotation> updateAnnotation(
      $pb.ServerContext ctx, UpdateAnnotationRequest request);
  $async.Future<$4.Empty> deleteAnnotation(
      $pb.ServerContext ctx, DeleteAnnotationRequest request);
  $async.Future<SearchAnnotationsResponse> searchAnnotations(
      $pb.ServerContext ctx, SearchAnnotationsRequest request);
  ...
  $core.Map<$core.String, $core.dynamic> get $json =>
      AnnotationServiceV1ServiceBase$json;
  $core.Map<$core.String, $core.Map<$core.String, $core.dynamic>>
      get $messageJson => AnnotationServiceV1ServiceBase$messageJson;
}
