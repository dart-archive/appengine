...
class AnnotationSet extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('AnnotationSet')
    ...
    ..aOS(4, 'name')
    ..aOS(5, 'sourceUri')
    ..e<AnnotationType>(6, 'type', PbFieldType.OE, AnnotationType.ANNOTATION_TYPE_UNSPECIFIED, AnnotationType.valueOf, AnnotationType.values)
  ...
  set sourceUri(String v) { $_setString(4, v); }
...
class Annotation extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('Annotation')
    ...
    ..aInt64(7, 'end')
    ..aOB(8, 'reverseStrand')
    ..e<AnnotationType>(9, 'type', PbFieldType.OE, AnnotationType.ANNOTATION_TYPE_UNSPECIFIED, AnnotationType.valueOf, AnnotationType.values)
  ...
  set annotationSetId(String v) { $_setString(1, v); }
  ...
  set referenceId(String v) { $_setString(3, v); }
  ...
  set reverseStrand(bool v) { $_setBool(7, v); }
...
class VariantAnnotation extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('VariantAnnotation')
    ..e<VariantAnnotation_Type>(1, 'type', PbFieldType.OE, VariantAnnotation_Type.TYPE_UNSPECIFIED, VariantAnnotation_Type.valueOf, VariantAnnotation_Type.values)
    ..e<VariantAnnotation_Effect>(2, 'effect', PbFieldType.OE, VariantAnnotation_Effect.EFFECT_UNSPECIFIED, VariantAnnotation_Effect.valueOf, VariantAnnotation_Effect.values)
    ...
    ..e<VariantAnnotation_ClinicalSignificance>(7, 'clinicalSignificance', PbFieldType.OE, VariantAnnotation_ClinicalSignificance.CLINICAL_SIGNIFICANCE_UNSPECIFIED, VariantAnnotation_ClinicalSignificance.valueOf, VariantAnnotation_ClinicalSignificance.values)
    ..hasRequiredFields = false
  ;
...
class Transcript_Exon extends GeneratedMessage {
  ...
  set frame($google$protobuf.Int32Value v) { setField(3, v); }
...
class Transcript extends GeneratedMessage {
  ...
  set geneId(String v) { $_setString(0, v); }
...
class ExternalId extends GeneratedMessage {
  ...
  set sourceName(String v) { $_setString(0, v); }
...
class GetAnnotationSetRequest extends GeneratedMessage {
  ...
  set annotationSetId(String v) { $_setString(0, v); }
...
class SearchAnnotationSetsRequest extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('SearchAnnotationSetsRequest')
    ...
    ..aOS(3, 'name')
    ..pp<AnnotationType>(4, 'types', PbFieldType.PE, AnnotationType.$checkItem, null, AnnotationType.valueOf, AnnotationType.values)
    ..aOS(5, 'pageToken')
  ...
  set referenceSetId(String v) { $_setString(1, v); }
...
class BatchCreateAnnotationsRequest extends GeneratedMessage {
  ...
  set requestId(String v) { $_setString(1, v); }
...
class GetAnnotationRequest extends GeneratedMessage {
  ...
  set annotationId(String v) { $_setString(0, v); }
...
class SearchAnnotationsRequest extends GeneratedMessage {
  ...
  set referenceId(String v) { $_setString(1, v); }
...
class AnnotationServiceV1Api {
  ...
  Future<$google$protobuf.Empty> deleteAnnotationSet(ClientContext ctx, DeleteAnnotationSetRequest request) {
    ...
    return _client.invoke<$google$protobuf.Empty>(ctx, 'AnnotationServiceV1', 'DeleteAnnotationSet', request, emptyResponse);
  }
  ...
  Future<$google$protobuf.Empty> deleteAnnotation(ClientContext ctx, DeleteAnnotationRequest request) {
    var emptyResponse = new $google$protobuf.Empty();
    return _client.invoke<$google$protobuf.Empty>(ctx, 'AnnotationServiceV1', 'DeleteAnnotation', request, emptyResponse);
  }
