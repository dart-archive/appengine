...
class AssistResponse_EventType extends ProtobufEnum {
  static const AssistResponse_EventType EVENT_TYPE_UNSPECIFIED = const AssistResponse_EventType._(0, 'EVENT_TYPE_UNSPECIFIED');
  static const AssistResponse_EventType END_OF_UTTERANCE = const AssistResponse_EventType._(1, 'END_OF_UTTERANCE');

  static const List<AssistResponse_EventType> values = const <AssistResponse_EventType> [
    EVENT_TYPE_UNSPECIFIED,
    END_OF_UTTERANCE,
  ];

  static final Map<int, dynamic> _byValue = ProtobufEnum.initByValue(values);
  static AssistResponse_EventType valueOf(int value) => _byValue[value] as AssistResponse_EventType;
  static void $checkItem(AssistResponse_EventType v) {
    if (v is! AssistResponse_EventType) checkItemFailed(v, 'AssistResponse_EventType');
  }
...
class ScreenOutConfig_ScreenMode extends ProtobufEnum {
  static const ScreenOutConfig_ScreenMode SCREEN_MODE_UNSPECIFIED = const ScreenOutConfig_ScreenMode._(0, 'SCREEN_MODE_UNSPECIFIED');
  static const ScreenOutConfig_ScreenMode OFF = const ScreenOutConfig_ScreenMode._(1, 'OFF');
  static const ScreenOutConfig_ScreenMode PLAYING = const ScreenOutConfig_ScreenMode._(3, 'PLAYING');

  static const List<ScreenOutConfig_ScreenMode> values = const <ScreenOutConfig_ScreenMode> [
  ...
  static final Map<int, dynamic> _byValue = ProtobufEnum.initByValue(values);
  static ScreenOutConfig_ScreenMode valueOf(int value) => _byValue[value] as ScreenOutConfig_ScreenMode;
  static void $checkItem(ScreenOutConfig_ScreenMode v) {
    if (v is! ScreenOutConfig_ScreenMode) checkItemFailed(v, 'ScreenOutConfig_ScreenMode');
  }
...
class ScreenOut_Format extends ProtobufEnum {
  static const ScreenOut_Format FORMAT_UNSPECIFIED = const ScreenOut_Format._(0, 'FORMAT_UNSPECIFIED');
  static const ScreenOut_Format HTML = const ScreenOut_Format._(1, 'HTML');

  static const List<ScreenOut_Format> values = const <ScreenOut_Format> [
    FORMAT_UNSPECIFIED,
    HTML,
  ];

  static final Map<int, dynamic> _byValue = ProtobufEnum.initByValue(values);
  static ScreenOut_Format valueOf(int value) => _byValue[value] as ScreenOut_Format;
...
class DialogStateOut_MicrophoneMode extends ProtobufEnum {
  static const DialogStateOut_MicrophoneMode MICROPHONE_MODE_UNSPECIFIED = const DialogStateOut_MicrophoneMode._(0, 'MICROPHONE_MODE_UNSPECIFIED');
  static const DialogStateOut_MicrophoneMode CLOSE_MICROPHONE = const DialogStateOut_MicrophoneMode._(1, 'CLOSE_MICROPHONE');
  static const DialogStateOut_MicrophoneMode DIALOG_FOLLOW_ON = const DialogStateOut_MicrophoneMode._(2, 'DIALOG_FOLLOW_ON');

  static const List<DialogStateOut_MicrophoneMode> values = const <DialogStateOut_MicrophoneMode> [
  ...
  static final Map<int, dynamic> _byValue = ProtobufEnum.initByValue(values);
  static DialogStateOut_MicrophoneMode valueOf(int value) => _byValue[value] as DialogStateOut_MicrophoneMode;
  static void $checkItem(DialogStateOut_MicrophoneMode v) {
    if (v is! DialogStateOut_MicrophoneMode) checkItemFailed(v, 'DialogStateOut_MicrophoneMode');
  }
