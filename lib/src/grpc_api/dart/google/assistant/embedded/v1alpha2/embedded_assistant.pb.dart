...
class AssistRequest extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('AssistRequest')
    ..a<AssistConfig>(1, 'config', PbFieldType.OM, AssistConfig.getDefault, AssistConfig.create)
    ..a<List<int>>(2, 'audioIn', PbFieldType.OY)
    ..hasRequiredFields = false
  ;

  AssistRequest() : super();
  AssistRequest.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  AssistRequest.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ...
  static AssistRequest getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyAssistRequest();
  ...
  set audioIn(List<int> v) { $_setBytes(1, v); }
...
class AssistResponse extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('AssistResponse')
    ..e<AssistResponse_EventType>(1, 'eventType', PbFieldType.OE, AssistResponse_EventType.EVENT_TYPE_UNSPECIFIED, AssistResponse_EventType.valueOf, AssistResponse_EventType.values)
    ..pp<SpeechRecognitionResult>(2, 'speechResults', PbFieldType.PM, SpeechRecognitionResult.$checkItem, SpeechRecognitionResult.create)
    ..a<AudioOut>(3, 'audioOut', PbFieldType.OM, AudioOut.getDefault, AudioOut.create)
    ..a<ScreenOut>(4, 'screenOut', PbFieldType.OM, ScreenOut.getDefault, ScreenOut.create)
    ..a<DialogStateOut>(5, 'dialogStateOut', PbFieldType.OM, DialogStateOut.getDefault, DialogStateOut.create)
    ..a<DeviceAction>(6, 'deviceAction', PbFieldType.OM, DeviceAction.getDefault, DeviceAction.create)
    ..hasRequiredFields = false
  ;

  AssistResponse() : super();
  AssistResponse.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  AssistResponse.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  AssistResponse clone() => new AssistResponse()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static AssistResponse create() => new AssistResponse();
  static PbList<AssistResponse> createRepeated() => new PbList<AssistResponse>();
  static AssistResponse getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyAssistResponse();
    return _defaultInstance;
  }
...
class AssistConfig extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('AssistConfig')
    ..a<AudioInConfig>(1, 'audioInConfig', PbFieldType.OM, AudioInConfig.getDefault, AudioInConfig.create)
    ..a<AudioOutConfig>(2, 'audioOutConfig', PbFieldType.OM, AudioOutConfig.getDefault, AudioOutConfig.create)
    ..a<DialogStateIn>(3, 'dialogStateIn', PbFieldType.OM, DialogStateIn.getDefault, DialogStateIn.create)
    ..a<DeviceConfig>(4, 'deviceConfig', PbFieldType.OM, DeviceConfig.getDefault, DeviceConfig.create)
    ..aOS(6, 'textQuery')
    ..a<ScreenOutConfig>(8, 'screenOutConfig', PbFieldType.OM, ScreenOutConfig.getDefault, ScreenOutConfig.create)
    ..hasRequiredFields = false
  ;

  AssistConfig() : super();
  AssistConfig.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  AssistConfig.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ...
  static AssistConfig getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyAssistConfig();
    return _defaultInstance;
  }
  ...
  set textQuery(String v) { $_setString(4, v); }
...
class AudioInConfig extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('AudioInConfig')
    ..e<AudioInConfig_Encoding>(1, 'encoding', PbFieldType.OE, AudioInConfig_Encoding.ENCODING_UNSPECIFIED, AudioInConfig_Encoding.valueOf, AudioInConfig_Encoding.values)
    ..a<int>(2, 'sampleRateHertz', PbFieldType.O3)
    ..hasRequiredFields = false
  ;

  AudioInConfig() : super();
  AudioInConfig.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  AudioInConfig.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ...
  static AudioInConfig getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyAudioInConfig();
    return _defaultInstance;
  }
...
class AudioOutConfig extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('AudioOutConfig')
    ..e<AudioOutConfig_Encoding>(1, 'encoding', PbFieldType.OE, AudioOutConfig_Encoding.ENCODING_UNSPECIFIED, AudioOutConfig_Encoding.valueOf, AudioOutConfig_Encoding.values)
    ..a<int>(2, 'sampleRateHertz', PbFieldType.O3)
  ...
  AudioOutConfig.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  AudioOutConfig.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  AudioOutConfig clone() => new AudioOutConfig()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static AudioOutConfig create() => new AudioOutConfig();
  static PbList<AudioOutConfig> createRepeated() => new PbList<AudioOutConfig>();
  static AudioOutConfig getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyAudioOutConfig();
    return _defaultInstance;
  }
  ...
  set volumePercentage(int v) { $_setSignedInt32(2, v); }
...
class ScreenOutConfig extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('ScreenOutConfig')
    ..e<ScreenOutConfig_ScreenMode>(1, 'screenMode', PbFieldType.OE, ScreenOutConfig_ScreenMode.SCREEN_MODE_UNSPECIFIED, ScreenOutConfig_ScreenMode.valueOf, ScreenOutConfig_ScreenMode.values)
    ..hasRequiredFields = false
  ;

  ScreenOutConfig() : super();
  ScreenOutConfig.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  ScreenOutConfig.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ScreenOutConfig clone() => new ScreenOutConfig()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static ScreenOutConfig create() => new ScreenOutConfig();
  static PbList<ScreenOutConfig> createRepeated() => new PbList<ScreenOutConfig>();
  static ScreenOutConfig getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyScreenOutConfig();
    return _defaultInstance;
  }
...
class _ReadonlyScreenOutConfig extends ScreenOutConfig with ReadonlyMessageMixin {}
...
class DialogStateIn extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('DialogStateIn')
    ...
    ..aOS(2, 'languageCode')
    ..a<DeviceLocation>(5, 'deviceLocation', PbFieldType.OM, DeviceLocation.getDefault, DeviceLocation.create)
    ..aOB(7, 'isNewConversation')
    ..hasRequiredFields = false
  ;

  DialogStateIn() : super();
  DialogStateIn.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  DialogStateIn.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ...
  static DialogStateIn getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyDialogStateIn();
    return _defaultInstance;
  }
  ...
  set conversationState(List<int> v) { $_setBytes(0, v); }
  ...
  set isNewConversation(bool v) { $_setBool(3, v); }
...
class DeviceConfig extends GeneratedMessage {
  ...
  set deviceModelId(String v) { $_setString(1, v); }
...
class AudioOut extends GeneratedMessage {
  ...
  AudioOut() : super();
  AudioOut.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  AudioOut.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ...
  set audioData(List<int> v) { $_setBytes(0, v); }
...
class ScreenOut extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('ScreenOut')
    ..e<ScreenOut_Format>(1, 'format', PbFieldType.OE, ScreenOut_Format.FORMAT_UNSPECIFIED, ScreenOut_Format.valueOf, ScreenOut_Format.values)
    ..a<List<int>>(2, 'data', PbFieldType.OY)
    ..hasRequiredFields = false
  ;

  ScreenOut() : super();
  ScreenOut.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  ScreenOut.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
...
class DeviceAction extends GeneratedMessage {
  ...
  DeviceAction() : super();
  DeviceAction.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  DeviceAction.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ...
  static DeviceAction getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyDeviceAction();
    return _defaultInstance;
  }
  ...
  set deviceRequestJson(String v) { $_setString(0, v); }
...
class SpeechRecognitionResult extends GeneratedMessage {
  ...
  set stability(double v) { $_setFloat(1, v); }
...
class DialogStateOut extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('DialogStateOut')
    ...
    ..e<DialogStateOut_MicrophoneMode>(3, 'microphoneMode', PbFieldType.OE, DialogStateOut_MicrophoneMode.MICROPHONE_MODE_UNSPECIFIED, DialogStateOut_MicrophoneMode.valueOf, DialogStateOut_MicrophoneMode.values)
    ..a<int>(4, 'volumePercentage', PbFieldType.O3)
    ..hasRequiredFields = false
  ;

  DialogStateOut() : super();
  DialogStateOut.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  DialogStateOut.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  DialogStateOut clone() => new DialogStateOut()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static DialogStateOut create() => new DialogStateOut();
  static PbList<DialogStateOut> createRepeated() => new PbList<DialogStateOut>();
  static DialogStateOut getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyDialogStateOut();
    return _defaultInstance;
  }
  ...
  set supplementalDisplayText(String v) { $_setString(0, v); }
  ...
  set conversationState(List<int> v) { $_setBytes(1, v); }
  ...
  set volumePercentage(int v) { $_setSignedInt32(3, v); }
...
class DeviceLocation extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('DeviceLocation')
    ..a<$google$type.LatLng>(1, 'coordinates', PbFieldType.OM, $google$type.LatLng.getDefault, $google$type.LatLng.create)
    ..hasRequiredFields = false
  ;

  DeviceLocation() : super();
  DeviceLocation.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  DeviceLocation.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  DeviceLocation clone() => new DeviceLocation()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static DeviceLocation create() => new DeviceLocation();
  static PbList<DeviceLocation> createRepeated() => new PbList<DeviceLocation>();
  static DeviceLocation getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyDeviceLocation();
    return _defaultInstance;
  }
  ...
  set coordinates($google$type.LatLng v) { setField(1, v); }
