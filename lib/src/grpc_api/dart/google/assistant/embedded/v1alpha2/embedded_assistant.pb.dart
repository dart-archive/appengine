...
class AssistRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('AssistRequest', package: const $pb.PackageName('google.assistant.embedded.v1alpha2'))
    ..a<AssistConfig>(1, 'config', $pb.PbFieldType.OM, AssistConfig.getDefault, AssistConfig.create)
  ...
  AssistRequest() : super();
  AssistRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  AssistRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  AssistRequest clone() => AssistRequest()..mergeFromMessage(this);
  AssistRequest copyWith(void Function(AssistRequest) updates) => super.copyWith((message) => updates(message as AssistRequest));
...
class AssistResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('AssistResponse', package: const $pb.PackageName('google.assistant.embedded.v1alpha2'))
    ..e<AssistResponse_EventType>(1, 'eventType', $pb.PbFieldType.OE, AssistResponse_EventType.EVENT_TYPE_UNSPECIFIED, AssistResponse_EventType.valueOf, AssistResponse_EventType.values)
    ..pc<SpeechRecognitionResult>(2, 'speechResults', $pb.PbFieldType.PM,SpeechRecognitionResult.create)
    ..a<AudioOut>(3, 'audioOut', $pb.PbFieldType.OM, AudioOut.getDefault, AudioOut.create)
    ..a<ScreenOut>(4, 'screenOut', $pb.PbFieldType.OM, ScreenOut.getDefault, ScreenOut.create)
    ..a<DialogStateOut>(5, 'dialogStateOut', $pb.PbFieldType.OM, DialogStateOut.getDefault, DialogStateOut.create)
    ..a<DeviceAction>(6, 'deviceAction', $pb.PbFieldType.OM, DeviceAction.getDefault, DeviceAction.create)
    ..a<DebugInfo>(8, 'debugInfo', $pb.PbFieldType.OM, DebugInfo.getDefault, DebugInfo.create)
    ..hasRequiredFields = false
  ;

  AssistResponse() : super();
  AssistResponse.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  AssistResponse.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  AssistResponse clone() => AssistResponse()..mergeFromMessage(this);
  AssistResponse copyWith(void Function(AssistResponse) updates) => super.copyWith((message) => updates(message as AssistResponse));
  $pb.BuilderInfo get info_ => _i;
...
class DebugInfo extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('DebugInfo', package: const $pb.PackageName('google.assistant.embedded.v1alpha2'))
...
class AssistConfig extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('AssistConfig', package: const $pb.PackageName('google.assistant.embedded.v1alpha2'))
    ...
    ..a<DialogStateIn>(3, 'dialogStateIn', $pb.PbFieldType.OM, DialogStateIn.getDefault, DialogStateIn.create)
    ..a<DeviceConfig>(4, 'deviceConfig', $pb.PbFieldType.OM, DeviceConfig.getDefault, DeviceConfig.create)
    ..a<DebugConfig>(5, 'debugConfig', $pb.PbFieldType.OM, DebugConfig.getDefault, DebugConfig.create)
    ..aOS(6, 'textQuery')
    ..a<ScreenOutConfig>(8, 'screenOutConfig', $pb.PbFieldType.OM, ScreenOutConfig.getDefault, ScreenOutConfig.create)
    ..oo(0, [1, 6])
    ..hasRequiredFields = false
  ;

  AssistConfig() : super();
  AssistConfig.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  AssistConfig.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  AssistConfig clone() => AssistConfig()..mergeFromMessage(this);
  AssistConfig copyWith(void Function(AssistConfig) updates) => super.copyWith((message) => updates(message as AssistConfig));
  $pb.BuilderInfo get info_ => _i;
...
class AudioInConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('AudioInConfig', package: const $pb.PackageName('google.assistant.embedded.v1alpha2'))
...
class AudioOutConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('AudioOutConfig', package: const $pb.PackageName('google.assistant.embedded.v1alpha2'))
...
class ScreenOutConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ScreenOutConfig', package: const $pb.PackageName('google.assistant.embedded.v1alpha2'))
    ..e<ScreenOutConfig_ScreenMode>(1, 'screenMode', $pb.PbFieldType.OE, ScreenOutConfig_ScreenMode.SCREEN_MODE_UNSPECIFIED, ScreenOutConfig_ScreenMode.valueOf, ScreenOutConfig_ScreenMode.values)
    ..hasRequiredFields = false
  ;

  ScreenOutConfig() : super();
  ScreenOutConfig.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  ScreenOutConfig.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ScreenOutConfig clone() => ScreenOutConfig()..mergeFromMessage(this);
  ScreenOutConfig copyWith(void Function(ScreenOutConfig) updates) => super.copyWith((message) => updates(message as ScreenOutConfig));
  $pb.BuilderInfo get info_ => _i;
  ...
  static ScreenOutConfig getDefault() => _defaultInstance ??= create()..freeze();
...
class DialogStateIn extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('DialogStateIn', package: const $pb.PackageName('google.assistant.embedded.v1alpha2'))
    ..a<$core.List<$core.int>>(1, 'conversationState', $pb.PbFieldType.OY)
    ..aOS(2, 'languageCode')
    ..a<DeviceLocation>(5, 'deviceLocation', $pb.PbFieldType.OM, DeviceLocation.getDefault, DeviceLocation.create)
    ..aOB(7, 'isNewConversation')
    ..hasRequiredFields = false
  ;

  DialogStateIn() : super();
  DialogStateIn.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  DialogStateIn.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  DialogStateIn clone() => DialogStateIn()..mergeFromMessage(this);
  DialogStateIn copyWith(void Function(DialogStateIn) updates) => super.copyWith((message) => updates(message as DialogStateIn));
  $pb.BuilderInfo get info_ => _i;
...
class DeviceConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('DeviceConfig', package: const $pb.PackageName('google.assistant.embedded.v1alpha2'))
    ..aOS(1, 'deviceId')
    ..aOS(3, 'deviceModelId')
    ..hasRequiredFields = false
  ;
...
class AudioOut extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('AudioOut', package: const $pb.PackageName('google.assistant.embedded.v1alpha2'))
...
class ScreenOut extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ScreenOut', package: const $pb.PackageName('google.assistant.embedded.v1alpha2'))
    ..e<ScreenOut_Format>(1, 'format', $pb.PbFieldType.OE, ScreenOut_Format.FORMAT_UNSPECIFIED, ScreenOut_Format.valueOf, ScreenOut_Format.values)
    ..a<$core.List<$core.int>>(2, 'data', $pb.PbFieldType.OY)
    ..hasRequiredFields = false
  ;

  ScreenOut() : super();
  ScreenOut.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  ScreenOut.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ScreenOut clone() => ScreenOut()..mergeFromMessage(this);
  ScreenOut copyWith(void Function(ScreenOut) updates) => super.copyWith((message) => updates(message as ScreenOut));
  $pb.BuilderInfo get info_ => _i;
...
class DeviceAction extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('DeviceAction', package: const $pb.PackageName('google.assistant.embedded.v1alpha2'))
    ..aOS(1, 'deviceRequestJson')
    ..hasRequiredFields = false
  ;

  DeviceAction() : super();
  DeviceAction.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  DeviceAction.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  DeviceAction clone() => DeviceAction()..mergeFromMessage(this);
  DeviceAction copyWith(void Function(DeviceAction) updates) => super.copyWith((message) => updates(message as DeviceAction));
  $pb.BuilderInfo get info_ => _i;
...
class SpeechRecognitionResult extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('SpeechRecognitionResult', package: const $pb.PackageName('google.assistant.embedded.v1alpha2'))
    ..aOS(1, 'transcript')
...
class DialogStateOut extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('DialogStateOut', package: const $pb.PackageName('google.assistant.embedded.v1alpha2'))
    ..aOS(1, 'supplementalDisplayText')
    ..a<$core.List<$core.int>>(2, 'conversationState', $pb.PbFieldType.OY)
    ..e<DialogStateOut_MicrophoneMode>(3, 'microphoneMode', $pb.PbFieldType.OE, DialogStateOut_MicrophoneMode.MICROPHONE_MODE_UNSPECIFIED, DialogStateOut_MicrophoneMode.valueOf, DialogStateOut_MicrophoneMode.values)
    ..a<$core.int>(4, 'volumePercentage', $pb.PbFieldType.O3)
    ..hasRequiredFields = false
  ;

  DialogStateOut() : super();
  DialogStateOut.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  DialogStateOut.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  DialogStateOut clone() => DialogStateOut()..mergeFromMessage(this);
  DialogStateOut copyWith(void Function(DialogStateOut) updates) => super.copyWith((message) => updates(message as DialogStateOut));
  $pb.BuilderInfo get info_ => _i;
...
class DebugConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('DebugConfig', package: const $pb.PackageName('google.assistant.embedded.v1alpha2'))
    ..aOB(6, 'returnDebugInfo')
    ..hasRequiredFields = false
  ;

  DebugConfig() : super();
  DebugConfig.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  DebugConfig.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  DebugConfig clone() => DebugConfig()..mergeFromMessage(this);
  DebugConfig copyWith(void Function(DebugConfig) updates) => super.copyWith((message) => updates(message as DebugConfig));
  $pb.BuilderInfo get info_ => _i;
...
class DeviceLocation extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('DeviceLocation', package: const $pb.PackageName('google.assistant.embedded.v1alpha2'))
    ..a<$0.LatLng>(1, 'coordinates', $pb.PbFieldType.OM, $0.LatLng.getDefault, $0.LatLng.create)
    ..oo(0, [1])
    ..hasRequiredFields = false
  ;

  DeviceLocation() : super();
  DeviceLocation.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  DeviceLocation.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  DeviceLocation clone() => DeviceLocation()..mergeFromMessage(this);
  DeviceLocation copyWith(void Function(DeviceLocation) updates) => super.copyWith((message) => updates(message as DeviceLocation));
  $pb.BuilderInfo get info_ => _i;
...
class EmbeddedAssistantApi {
  ...
  $async.Future<AssistResponse> assist($pb.ClientContext ctx, AssistRequest request) {
    var emptyResponse = AssistResponse();
    return _client.invoke<AssistResponse>(ctx, 'EmbeddedAssistant', 'Assist', request, emptyResponse);
  }
}
