...
class ConverseConfig extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('ConverseConfig')
    ...
    ..a<ConverseState>(3, 'converseState', PbFieldType.OM, ConverseState.getDefault, ConverseState.create)
    ..hasRequiredFields = false
  ;

  ConverseConfig() : super();
  ConverseConfig.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  ConverseConfig.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ConverseConfig clone() => new ConverseConfig()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static ConverseConfig create() => new ConverseConfig();
  static PbList<ConverseConfig> createRepeated() => new PbList<ConverseConfig>();
  static ConverseConfig getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyConverseConfig();
...
class ConverseState extends GeneratedMessage {
  ...
  ConverseState() : super();
  ConverseState.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  ConverseState.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ...
  static ConverseState getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyConverseState();
    return _defaultInstance;
  }
...
class ConverseResult extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('ConverseResult')
    ...
    ..e<ConverseResult_MicrophoneMode>(4, 'microphoneMode', PbFieldType.OE, ConverseResult_MicrophoneMode.MICROPHONE_MODE_UNSPECIFIED, ConverseResult_MicrophoneMode.valueOf, ConverseResult_MicrophoneMode.values)
    ..a<int>(5, 'volumePercentage', PbFieldType.O3)
    ..hasRequiredFields = false
  ;

  ConverseResult() : super();
  ConverseResult.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  ConverseResult.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ConverseResult clone() => new ConverseResult()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static ConverseResult create() => new ConverseResult();
  static PbList<ConverseResult> createRepeated() => new PbList<ConverseResult>();
  static ConverseResult getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyConverseResult();
    return _defaultInstance;
  }
  ...
  set volumePercentage(int v) { $_setSignedInt32(4, v); }
...
class ConverseRequest extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('ConverseRequest')
    ..a<ConverseConfig>(1, 'config', PbFieldType.OM, ConverseConfig.getDefault, ConverseConfig.create)
    ..a<List<int>>(2, 'audioIn', PbFieldType.OY)
    ..hasRequiredFields = false
  ;

  ConverseRequest() : super();
  ConverseRequest.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  ConverseRequest.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ConverseRequest clone() => new ConverseRequest()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static ConverseRequest create() => new ConverseRequest();
  static PbList<ConverseRequest> createRepeated() => new PbList<ConverseRequest>();
  static ConverseRequest getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyConverseRequest();
    return _defaultInstance;
  }
...
class _ReadonlyConverseRequest extends ConverseRequest with ReadonlyMessageMixin {}
...
class ConverseResponse extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('ConverseResponse')
    ...
    ..e<ConverseResponse_EventType>(2, 'eventType', PbFieldType.OE, ConverseResponse_EventType.EVENT_TYPE_UNSPECIFIED, ConverseResponse_EventType.valueOf, ConverseResponse_EventType.values)
    ..a<AudioOut>(3, 'audioOut', PbFieldType.OM, AudioOut.getDefault, AudioOut.create)
    ..a<ConverseResult>(5, 'result', PbFieldType.OM, ConverseResult.getDefault, ConverseResult.create)
    ..hasRequiredFields = false
  ;

  ConverseResponse() : super();
  ConverseResponse.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  ConverseResponse.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ConverseResponse clone() => new ConverseResponse()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static ConverseResponse create() => new ConverseResponse();
  static PbList<ConverseResponse> createRepeated() => new PbList<ConverseResponse>();
  static ConverseResponse getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyConverseResponse();
    return _defaultInstance;
  }
...
class _ReadonlyConverseResponse extends ConverseResponse with ReadonlyMessageMixin {}

class EmbeddedAssistantApi {
  RpcClient _client;
  EmbeddedAssistantApi(this._client);

  Future<ConverseResponse> converse(ClientContext ctx, ConverseRequest request) {
