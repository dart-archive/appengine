...
class ColumnRange extends GeneratedMessage {
  ...
  set startQualifierClosed(List<int> v) {
    $_setBytes(1, v);
  }
  ...
  set startQualifierOpen(List<int> v) {
    $_setBytes(2, v);
  }
  ...
  set endQualifierClosed(List<int> v) {
    $_setBytes(3, v);
  }
  ...
  set endQualifierOpen(List<int> v) {
    $_setBytes(4, v);
  }
...
class ValueRange extends GeneratedMessage {
  ...
  set startValueClosed(List<int> v) {
    $_setBytes(0, v);
  }
