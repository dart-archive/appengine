...
class ReadRowsRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ReadRowsRequest', package: const $pb.PackageName('google.bigtable.v2'))
    ..aOS(1, 'tableName')
    ..a<$0.RowSet>(2, 'rows', $pb.PbFieldType.OM, $0.RowSet.getDefault, $0.RowSet.create)
    ..a<$0.RowFilter>(3, 'filter', $pb.PbFieldType.OM, $0.RowFilter.getDefault, $0.RowFilter.create)
    ..aInt64(4, 'rowsLimit')
    ..aOS(5, 'appProfileId')
...
class ReadRowsResponse_CellChunk extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ReadRowsResponse.CellChunk', package: const $pb.PackageName('google.bigtable.v2'))
    ..a<$core.List<$core.int>>(1, 'rowKey', $pb.PbFieldType.OY)
    ..a<$1.StringValue>(2, 'familyName', $pb.PbFieldType.OM, $1.StringValue.getDefault, $1.StringValue.create)
    ..a<$1.BytesValue>(3, 'qualifier', $pb.PbFieldType.OM, $1.BytesValue.getDefault, $1.BytesValue.create)
  ...
  ReadRowsResponse_CellChunk.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  ReadRowsResponse_CellChunk.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ReadRowsResponse_CellChunk clone() => ReadRowsResponse_CellChunk()..mergeFromMessage(this);
  ReadRowsResponse_CellChunk copyWith(void Function(ReadRowsResponse_CellChunk) updates) => super.copyWith((message) => updates(message as ReadRowsResponse_CellChunk));
  $pb.BuilderInfo get info_ => _i;
  ...
  static ReadRowsResponse_CellChunk getDefault() => _defaultInstance ??= create()..freeze();
...
class ReadRowsResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ReadRowsResponse', package: const $pb.PackageName('google.bigtable.v2'))
    ..pc<ReadRowsResponse_CellChunk>(1, 'chunks', $pb.PbFieldType.PM,ReadRowsResponse_CellChunk.create)
...
class SampleRowKeysRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('SampleRowKeysRequest', package: const $pb.PackageName('google.bigtable.v2'))
    ..aOS(1, 'tableName')
    ..aOS(2, 'appProfileId')
    ..hasRequiredFields = false
  ;
...
class SampleRowKeysResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('SampleRowKeysResponse', package: const $pb.PackageName('google.bigtable.v2'))
    ..a<$core.List<$core.int>>(1, 'rowKey', $pb.PbFieldType.OY)
...
class MutateRowRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('MutateRowRequest', package: const $pb.PackageName('google.bigtable.v2'))
    ..aOS(1, 'tableName')
...
class MutateRowResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('MutateRowResponse', package: const $pb.PackageName('google.bigtable.v2'))
    ..hasRequiredFields = false
  ;

  MutateRowResponse() : super();
  MutateRowResponse.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  MutateRowResponse.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  MutateRowResponse clone() => MutateRowResponse()..mergeFromMessage(this);
  MutateRowResponse copyWith(void Function(MutateRowResponse) updates) => super.copyWith((message) => updates(message as MutateRowResponse));
  $pb.BuilderInfo get info_ => _i;
  ...
  static MutateRowResponse getDefault() => _defaultInstance ??= create()..freeze();
  static MutateRowResponse _defaultInstance;
}

class MutateRowsRequest_Entry extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('MutateRowsRequest.Entry', package: const $pb.PackageName('google.bigtable.v2'))
    ..a<$core.List<$core.int>>(1, 'rowKey', $pb.PbFieldType.OY)
...
class MutateRowsRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('MutateRowsRequest', package: const $pb.PackageName('google.bigtable.v2'))
    ..aOS(1, 'tableName')
...
class MutateRowsResponse_Entry extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('MutateRowsResponse.Entry', package: const $pb.PackageName('google.bigtable.v2'))
    ..aInt64(1, 'index')
    ..a<$2.Status>(2, 'status', $pb.PbFieldType.OM, $2.Status.getDefault, $2.Status.create)
    ..hasRequiredFields = false
  ;

  MutateRowsResponse_Entry() : super();
  MutateRowsResponse_Entry.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  MutateRowsResponse_Entry.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  MutateRowsResponse_Entry clone() => MutateRowsResponse_Entry()..mergeFromMessage(this);
  MutateRowsResponse_Entry copyWith(void Function(MutateRowsResponse_Entry) updates) => super.copyWith((message) => updates(message as MutateRowsResponse_Entry));
  $pb.BuilderInfo get info_ => _i;
  ...
  static MutateRowsResponse_Entry getDefault() => _defaultInstance ??= create()..freeze();
  ...
  set status($2.Status v) { setField(2, v); }
  $core.bool hasStatus() => $_has(1);
  void clearStatus() => clearField(2);
}

class MutateRowsResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('MutateRowsResponse', package: const $pb.PackageName('google.bigtable.v2'))
    ..pc<MutateRowsResponse_Entry>(1, 'entries', $pb.PbFieldType.PM,MutateRowsResponse_Entry.create)
    ..hasRequiredFields = false
  ;
...
class CheckAndMutateRowRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('CheckAndMutateRowRequest', package: const $pb.PackageName('google.bigtable.v2'))
    ..aOS(1, 'tableName')
    ..a<$core.List<$core.int>>(2, 'rowKey', $pb.PbFieldType.OY)
...
class CheckAndMutateRowResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('CheckAndMutateRowResponse', package: const $pb.PackageName('google.bigtable.v2'))
...
class ReadModifyWriteRowRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ReadModifyWriteRowRequest', package: const $pb.PackageName('google.bigtable.v2'))
    ..aOS(1, 'tableName')
    ..a<$core.List<$core.int>>(2, 'rowKey', $pb.PbFieldType.OY)
...
class ReadModifyWriteRowResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ReadModifyWriteRowResponse', package: const $pb.PackageName('google.bigtable.v2'))
    ..a<$0.Row>(1, 'row', $pb.PbFieldType.OM, $0.Row.getDefault, $0.Row.create)
    ..hasRequiredFields = false
  ;

  ReadModifyWriteRowResponse() : super();
  ReadModifyWriteRowResponse.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  ReadModifyWriteRowResponse.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ReadModifyWriteRowResponse clone() => ReadModifyWriteRowResponse()..mergeFromMessage(this);
  ReadModifyWriteRowResponse copyWith(void Function(ReadModifyWriteRowResponse) updates) => super.copyWith((message) => updates(message as ReadModifyWriteRowResponse));
  $pb.BuilderInfo get info_ => _i;
  ...
  static ReadModifyWriteRowResponse getDefault() => _defaultInstance ??= create()..freeze();
  static ReadModifyWriteRowResponse _defaultInstance;

  $0.Row get row => $_getN(0);
  set row($0.Row v) { setField(1, v); }
...
class BigtableApi {
  ...
  $async.Future<SampleRowKeysResponse> sampleRowKeys($pb.ClientContext ctx, SampleRowKeysRequest request) {
  ...
  $async.Future<MutateRowResponse> mutateRow($pb.ClientContext ctx, MutateRowRequest request) {
    var emptyResponse = MutateRowResponse();
    return _client.invoke<MutateRowResponse>(ctx, 'Bigtable', 'MutateRow', request, emptyResponse);
  }
  $async.Future<MutateRowsResponse> mutateRows($pb.ClientContext ctx, MutateRowsRequest request) {
  ...
  $async.Future<CheckAndMutateRowResponse> checkAndMutateRow($pb.ClientContext ctx, CheckAndMutateRowRequest request) {
  ...
  $async.Future<ReadModifyWriteRowResponse> readModifyWriteRow($pb.ClientContext ctx, ReadModifyWriteRowRequest request) {
