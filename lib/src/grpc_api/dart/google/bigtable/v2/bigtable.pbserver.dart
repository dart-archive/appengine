...
abstract class BigtableServiceBase extends $pb.GeneratedService {
  ...
  $async.Future<SampleRowKeysResponse> sampleRowKeys(
      $pb.ServerContext ctx, SampleRowKeysRequest request);
  $async.Future<MutateRowResponse> mutateRow(
      $pb.ServerContext ctx, MutateRowRequest request);
  $async.Future<MutateRowsResponse> mutateRows(
      $pb.ServerContext ctx, MutateRowsRequest request);
  $async.Future<CheckAndMutateRowResponse> checkAndMutateRow(
      $pb.ServerContext ctx, CheckAndMutateRowRequest request);
  $async.Future<ReadModifyWriteRowResponse> readModifyWriteRow(
      $pb.ServerContext ctx, ReadModifyWriteRowRequest request);
