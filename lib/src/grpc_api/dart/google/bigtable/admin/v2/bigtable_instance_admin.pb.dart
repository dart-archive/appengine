...
class CreateInstanceRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('CreateInstanceRequest',
    ...
    ..aOS(1, 'parent')
    ..aOS(2, 'instanceId')
    ..a<$0.Instance>(3, 'instance', $pb.PbFieldType.OM, $0.Instance.getDefault,
        $0.Instance.create)
    ..m<$core.String, $0.Cluster>(
        4,
        'clusters',
...
class PartialUpdateInstanceRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName('google.bigtable.admin.v2'))
    ..a<$0.Instance>(1, 'instance', $pb.PbFieldType.OM, $0.Instance.getDefault,
        $0.Instance.create)
...
class CreateAppProfileRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('CreateAppProfileRequest',
    ...
    ..aOS(1, 'parent')
    ..aOS(2, 'appProfileId')
    ..a<$0.AppProfile>(3, 'appProfile', $pb.PbFieldType.OM,
        $0.AppProfile.getDefault, $0.AppProfile.create)
...
class ListAppProfilesResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ListAppProfilesResponse',
      package: const $pb.PackageName('google.bigtable.admin.v2'))
    ..pc<$0.AppProfile>(
        1, 'appProfiles', $pb.PbFieldType.PM, $0.AppProfile.create)
    ..aOS(2, 'nextPageToken')
...
class UpdateAppProfileRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('UpdateAppProfileRequest',
      package: const $pb.PackageName('google.bigtable.admin.v2'))
    ..a<$0.AppProfile>(1, 'appProfile', $pb.PbFieldType.OM,
        $0.AppProfile.getDefault, $0.AppProfile.create)
    ..a<$1.FieldMask>(2, 'updateMask', $pb.PbFieldType.OM,
        $1.FieldMask.getDefault, $1.FieldMask.create)
...
class BigtableInstanceAdminApi {
  ...
  $async.Future<$0.Instance> getInstance(
    ...
    return _client.invoke<$0.Instance>(
  ...
  $async.Future<$0.Instance> updateInstance(
      $pb.ClientContext ctx, $0.Instance request) {
    var emptyResponse = $0.Instance();
    return _client.invoke<$0.Instance>(
  ...
  $async.Future<$3.Operation> partialUpdateInstance(
      $pb.ClientContext ctx, PartialUpdateInstanceRequest request) {
    var emptyResponse = $3.Operation();
    return _client.invoke<$3.Operation>(ctx, 'BigtableInstanceAdmin',
        'PartialUpdateInstance', request, emptyResponse);
  }
  ...
  $async.Future<$0.Cluster> getCluster(
    ...
    return _client.invoke<$0.Cluster>(
  ...
  $async.Future<$3.Operation> updateCluster(
      $pb.ClientContext ctx, $0.Cluster request) {
    var emptyResponse = $3.Operation();
    return _client.invoke<$3.Operation>(
  ...
  $async.Future<$0.AppProfile> createAppProfile(
      $pb.ClientContext ctx, CreateAppProfileRequest request) {
    var emptyResponse = $0.AppProfile();
    return _client.invoke<$0.AppProfile>(ctx, 'BigtableInstanceAdmin',
        'CreateAppProfile', request, emptyResponse);
  }

  $async.Future<$0.AppProfile> getAppProfile(
      $pb.ClientContext ctx, GetAppProfileRequest request) {
    var emptyResponse = $0.AppProfile();
    return _client.invoke<$0.AppProfile>(
        ctx, 'BigtableInstanceAdmin', 'GetAppProfile', request, emptyResponse);
  }

  $async.Future<ListAppProfilesResponse> listAppProfiles(
      $pb.ClientContext ctx, ListAppProfilesRequest request) {
  ...
  $async.Future<$3.Operation> updateAppProfile(
      $pb.ClientContext ctx, UpdateAppProfileRequest request) {
    var emptyResponse = $3.Operation();
    return _client.invoke<$3.Operation>(ctx, 'BigtableInstanceAdmin',
        'UpdateAppProfile', request, emptyResponse);
  }

  $async.Future<$4.Empty> deleteAppProfile(
      $pb.ClientContext ctx, DeleteAppProfileRequest request) {
    var emptyResponse = $4.Empty();
    return _client.invoke<$4.Empty>(ctx, 'BigtableInstanceAdmin',
        'DeleteAppProfile', request, emptyResponse);
  }

  $async.Future<$6.Policy> getIamPolicy(
      $pb.ClientContext ctx, $5.GetIamPolicyRequest request) {
    var emptyResponse = $6.Policy();
    return _client.invoke<$6.Policy>(
        ctx, 'BigtableInstanceAdmin', 'GetIamPolicy', request, emptyResponse);
  }

  $async.Future<$6.Policy> setIamPolicy(
      $pb.ClientContext ctx, $5.SetIamPolicyRequest request) {
    var emptyResponse = $6.Policy();
    return _client.invoke<$6.Policy>(
  ...
  $async.Future<$5.TestIamPermissionsResponse> testIamPermissions(
      $pb.ClientContext ctx, $5.TestIamPermissionsRequest request) {
    var emptyResponse = $5.TestIamPermissionsResponse();
    return _client.invoke<$5.TestIamPermissionsResponse>(ctx,
