...
class CreateTableFromSnapshotRequest extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('CreateTableFromSnapshotRequest')
    ..aOS(1, 'parent')
    ..aOS(2, 'tableId')
  ...
  CreateTableFromSnapshotRequest.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  CreateTableFromSnapshotRequest.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  CreateTableFromSnapshotRequest clone() => new CreateTableFromSnapshotRequest()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static CreateTableFromSnapshotRequest create() => new CreateTableFromSnapshotRequest();
  static PbList<CreateTableFromSnapshotRequest> createRepeated() => new PbList<CreateTableFromSnapshotRequest>();
  static CreateTableFromSnapshotRequest getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyCreateTableFromSnapshotRequest();
    return _defaultInstance;
  }
  static CreateTableFromSnapshotRequest _defaultInstance;
  static void $checkItem(CreateTableFromSnapshotRequest v) {
    if (v is! CreateTableFromSnapshotRequest) checkItemFailed(v, 'CreateTableFromSnapshotRequest');
  }
  ...
  set sourceSnapshot(String v) { $_setString(2, v); }
  bool hasSourceSnapshot() => $_has(2);
  void clearSourceSnapshot() => clearField(3);
}

class _ReadonlyCreateTableFromSnapshotRequest extends CreateTableFromSnapshotRequest with ReadonlyMessageMixin {}
...
class ListTablesRequest extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('ListTablesRequest')
    ..aOS(1, 'parent')
    ..e<Table_View>(2, 'view', PbFieldType.OE, Table_View.VIEW_UNSPECIFIED, Table_View.valueOf, Table_View.values)
    ..aOS(3, 'pageToken')
    ..hasRequiredFields = false
  ;
  ...
  set view(Table_View v) { setField(2, v); }
  bool hasView() => $_has(1);
...
class ModifyColumnFamiliesRequest extends GeneratedMessage {
  ...
  List<ModifyColumnFamiliesRequest_Modification> get modifications => $_getList(1);
}
...
class GenerateConsistencyTokenRequest extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('GenerateConsistencyTokenRequest')
    ..aOS(1, 'name')
    ..hasRequiredFields = false
  ;

  GenerateConsistencyTokenRequest() : super();
  GenerateConsistencyTokenRequest.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  GenerateConsistencyTokenRequest.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  GenerateConsistencyTokenRequest clone() => new GenerateConsistencyTokenRequest()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static GenerateConsistencyTokenRequest create() => new GenerateConsistencyTokenRequest();
  static PbList<GenerateConsistencyTokenRequest> createRepeated() => new PbList<GenerateConsistencyTokenRequest>();
  static GenerateConsistencyTokenRequest getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyGenerateConsistencyTokenRequest();
    return _defaultInstance;
  }
  static GenerateConsistencyTokenRequest _defaultInstance;
  static void $checkItem(GenerateConsistencyTokenRequest v) {
    if (v is! GenerateConsistencyTokenRequest) checkItemFailed(v, 'GenerateConsistencyTokenRequest');
  }
...
class _ReadonlyGenerateConsistencyTokenRequest extends GenerateConsistencyTokenRequest with ReadonlyMessageMixin {}

class GenerateConsistencyTokenResponse extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('GenerateConsistencyTokenResponse')
    ..aOS(1, 'consistencyToken')
    ..hasRequiredFields = false
  ;

  GenerateConsistencyTokenResponse() : super();
  GenerateConsistencyTokenResponse.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  GenerateConsistencyTokenResponse.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  GenerateConsistencyTokenResponse clone() => new GenerateConsistencyTokenResponse()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static GenerateConsistencyTokenResponse create() => new GenerateConsistencyTokenResponse();
  static PbList<GenerateConsistencyTokenResponse> createRepeated() => new PbList<GenerateConsistencyTokenResponse>();
  static GenerateConsistencyTokenResponse getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyGenerateConsistencyTokenResponse();
    return _defaultInstance;
  }
  static GenerateConsistencyTokenResponse _defaultInstance;
  static void $checkItem(GenerateConsistencyTokenResponse v) {
    if (v is! GenerateConsistencyTokenResponse) checkItemFailed(v, 'GenerateConsistencyTokenResponse');
  }

  String get consistencyToken => $_getS(0, '');
  set consistencyToken(String v) { $_setString(0, v); }
  bool hasConsistencyToken() => $_has(0);
  void clearConsistencyToken() => clearField(1);
}

class _ReadonlyGenerateConsistencyTokenResponse extends GenerateConsistencyTokenResponse with ReadonlyMessageMixin {}
...
class CheckConsistencyRequest extends GeneratedMessage {
  ...
  CheckConsistencyRequest.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  CheckConsistencyRequest.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  CheckConsistencyRequest clone() => new CheckConsistencyRequest()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static CheckConsistencyRequest create() => new CheckConsistencyRequest();
  static PbList<CheckConsistencyRequest> createRepeated() => new PbList<CheckConsistencyRequest>();
  static CheckConsistencyRequest getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyCheckConsistencyRequest();
    return _defaultInstance;
  }
  static CheckConsistencyRequest _defaultInstance;
  static void $checkItem(CheckConsistencyRequest v) {
    if (v is! CheckConsistencyRequest) checkItemFailed(v, 'CheckConsistencyRequest');
  }
  ...
  set consistencyToken(String v) { $_setString(1, v); }
  bool hasConsistencyToken() => $_has(1);
  void clearConsistencyToken() => clearField(2);
}

class _ReadonlyCheckConsistencyRequest extends CheckConsistencyRequest with ReadonlyMessageMixin {}
...
class CheckConsistencyResponse extends GeneratedMessage {
  ...
  CheckConsistencyResponse.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  CheckConsistencyResponse.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  CheckConsistencyResponse clone() => new CheckConsistencyResponse()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static CheckConsistencyResponse create() => new CheckConsistencyResponse();
  static PbList<CheckConsistencyResponse> createRepeated() => new PbList<CheckConsistencyResponse>();
  static CheckConsistencyResponse getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyCheckConsistencyResponse();
    return _defaultInstance;
  }
  static CheckConsistencyResponse _defaultInstance;
  static void $checkItem(CheckConsistencyResponse v) {
    if (v is! CheckConsistencyResponse) checkItemFailed(v, 'CheckConsistencyResponse');
  }

  bool get consistent => $_get(0, false);
  set consistent(bool v) { $_setBool(0, v); }
  bool hasConsistent() => $_has(0);
  void clearConsistent() => clearField(1);
}

class _ReadonlyCheckConsistencyResponse extends CheckConsistencyResponse with ReadonlyMessageMixin {}
...
class SnapshotTableRequest extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('SnapshotTableRequest')
    ...
    ..aOS(2, 'cluster')
    ..aOS(3, 'snapshotId')
    ..a<$google$protobuf.Duration>(4, 'ttl', PbFieldType.OM, $google$protobuf.Duration.getDefault, $google$protobuf.Duration.create)
    ..aOS(5, 'description')
    ..hasRequiredFields = false
  ;

  SnapshotTableRequest() : super();
  SnapshotTableRequest.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  SnapshotTableRequest.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  SnapshotTableRequest clone() => new SnapshotTableRequest()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static SnapshotTableRequest create() => new SnapshotTableRequest();
  static PbList<SnapshotTableRequest> createRepeated() => new PbList<SnapshotTableRequest>();
  static SnapshotTableRequest getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlySnapshotTableRequest();
    return _defaultInstance;
  }
...
class _ReadonlySnapshotTableRequest extends SnapshotTableRequest with ReadonlyMessageMixin {}
...
class GetSnapshotRequest extends GeneratedMessage {
  ...
  GetSnapshotRequest.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  GetSnapshotRequest.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  GetSnapshotRequest clone() => new GetSnapshotRequest()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static GetSnapshotRequest create() => new GetSnapshotRequest();
  static PbList<GetSnapshotRequest> createRepeated() => new PbList<GetSnapshotRequest>();
  static GetSnapshotRequest getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyGetSnapshotRequest();
    return _defaultInstance;
  }
...
class _ReadonlyGetSnapshotRequest extends GetSnapshotRequest with ReadonlyMessageMixin {}
...
class SnapshotTableMetadata extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('SnapshotTableMetadata')
    ..a<SnapshotTableRequest>(1, 'originalRequest', PbFieldType.OM, SnapshotTableRequest.getDefault, SnapshotTableRequest.create)
  ...
  SnapshotTableMetadata.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  SnapshotTableMetadata.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  SnapshotTableMetadata clone() => new SnapshotTableMetadata()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static SnapshotTableMetadata create() => new SnapshotTableMetadata();
  static PbList<SnapshotTableMetadata> createRepeated() => new PbList<SnapshotTableMetadata>();
  static SnapshotTableMetadata getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlySnapshotTableMetadata();
    return _defaultInstance;
  }
  static SnapshotTableMetadata _defaultInstance;
  static void $checkItem(SnapshotTableMetadata v) {
    if (v is! SnapshotTableMetadata) checkItemFailed(v, 'SnapshotTableMetadata');
  }
...
class _ReadonlySnapshotTableMetadata extends SnapshotTableMetadata with ReadonlyMessageMixin {}

class CreateTableFromSnapshotMetadata extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('CreateTableFromSnapshotMetadata')
    ..a<CreateTableFromSnapshotRequest>(1, 'originalRequest', PbFieldType.OM, CreateTableFromSnapshotRequest.getDefault, CreateTableFromSnapshotRequest.create)
    ..a<$google$protobuf.Timestamp>(2, 'requestTime', PbFieldType.OM, $google$protobuf.Timestamp.getDefault, $google$protobuf.Timestamp.create)
    ..a<$google$protobuf.Timestamp>(3, 'finishTime', PbFieldType.OM, $google$protobuf.Timestamp.getDefault, $google$protobuf.Timestamp.create)
    ..hasRequiredFields = false
  ;
  ...
  CreateTableFromSnapshotMetadata.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  CreateTableFromSnapshotMetadata.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  CreateTableFromSnapshotMetadata clone() => new CreateTableFromSnapshotMetadata()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static CreateTableFromSnapshotMetadata create() => new CreateTableFromSnapshotMetadata();
  static PbList<CreateTableFromSnapshotMetadata> createRepeated() => new PbList<CreateTableFromSnapshotMetadata>();
  static CreateTableFromSnapshotMetadata getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyCreateTableFromSnapshotMetadata();
    return _defaultInstance;
  }
  static CreateTableFromSnapshotMetadata _defaultInstance;
  static void $checkItem(CreateTableFromSnapshotMetadata v) {
    if (v is! CreateTableFromSnapshotMetadata) checkItemFailed(v, 'CreateTableFromSnapshotMetadata');
  }
...
class _ReadonlyCreateTableFromSnapshotMetadata extends CreateTableFromSnapshotMetadata with ReadonlyMessageMixin {}
...
class BigtableTableAdminApi {
  ...
  Future<Table> createTable(ClientContext ctx, CreateTableRequest request) {
    ...
    return _client.invoke<Table>(ctx, 'BigtableTableAdmin', 'CreateTable', request, emptyResponse);
  }
  Future<$google$longrunning.Operation> createTableFromSnapshot(ClientContext ctx, CreateTableFromSnapshotRequest request) {
    var emptyResponse = new $google$longrunning.Operation();
    return _client.invoke<$google$longrunning.Operation>(ctx, 'BigtableTableAdmin', 'CreateTableFromSnapshot', request, emptyResponse);
  }
  ...
  Future<Table> getTable(ClientContext ctx, GetTableRequest request) {
    var emptyResponse = new Table();
    return _client.invoke<Table>(ctx, 'BigtableTableAdmin', 'GetTable', request, emptyResponse);
  }
  Future<$google$protobuf.Empty> deleteTable(ClientContext ctx, DeleteTableRequest request) {
    var emptyResponse = new $google$protobuf.Empty();
    return _client.invoke<$google$protobuf.Empty>(ctx, 'BigtableTableAdmin', 'DeleteTable', request, emptyResponse);
  }
  Future<Table> modifyColumnFamilies(ClientContext ctx, ModifyColumnFamiliesRequest request) {
    var emptyResponse = new Table();
    return _client.invoke<Table>(ctx, 'BigtableTableAdmin', 'ModifyColumnFamilies', request, emptyResponse);
  }
  Future<$google$protobuf.Empty> dropRowRange(ClientContext ctx, DropRowRangeRequest request) {
    var emptyResponse = new $google$protobuf.Empty();
    return _client.invoke<$google$protobuf.Empty>(ctx, 'BigtableTableAdmin', 'DropRowRange', request, emptyResponse);
  }
  Future<GenerateConsistencyTokenResponse> generateConsistencyToken(ClientContext ctx, GenerateConsistencyTokenRequest request) {
  ...
  Future<CheckConsistencyResponse> checkConsistency(ClientContext ctx, CheckConsistencyRequest request) {
  ...
  Future<$google$longrunning.Operation> snapshotTable(ClientContext ctx, SnapshotTableRequest request) {
    var emptyResponse = new $google$longrunning.Operation();
    return _client.invoke<$google$longrunning.Operation>(ctx, 'BigtableTableAdmin', 'SnapshotTable', request, emptyResponse);
  }
  Future<Snapshot> getSnapshot(ClientContext ctx, GetSnapshotRequest request) {
    var emptyResponse = new Snapshot();
    return _client.invoke<Snapshot>(ctx, 'BigtableTableAdmin', 'GetSnapshot', request, emptyResponse);
  }
  ...
  Future<$google$protobuf.Empty> deleteSnapshot(ClientContext ctx, DeleteSnapshotRequest request) {
    var emptyResponse = new $google$protobuf.Empty();
    return _client.invoke<$google$protobuf.Empty>(ctx, 'BigtableTableAdmin', 'DeleteSnapshot', request, emptyResponse);
  }
}
