...
class Table_ClusterState_ReplicationState extends ProtobufEnum {
  ...
  static final Map<int, dynamic> _byValue = ProtobufEnum.initByValue(values);
  static Table_ClusterState_ReplicationState valueOf(int value) =>
      _byValue[value] as Table_ClusterState_ReplicationState;
  static void $checkItem(Table_ClusterState_ReplicationState v) {
    if (v is! Table_ClusterState_ReplicationState)
      checkItemFailed(v, 'Table_ClusterState_ReplicationState');
  }
