...
class Table_ClusterState extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('Table_ClusterState')
    ..e<Table_ClusterState_ReplicationState>(1, 'replicationState', PbFieldType.OE, Table_ClusterState_ReplicationState.STATE_NOT_KNOWN, Table_ClusterState_ReplicationState.valueOf, Table_ClusterState_ReplicationState.values)
    ..hasRequiredFields = false
  ;

  Table_ClusterState() : super();
  Table_ClusterState.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  Table_ClusterState.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  Table_ClusterState clone() => new Table_ClusterState()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static Table_ClusterState create() => new Table_ClusterState();
  static PbList<Table_ClusterState> createRepeated() => new PbList<Table_ClusterState>();
  static Table_ClusterState getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyTable_ClusterState();
...
class _ReadonlyTable_ClusterState extends Table_ClusterState with ReadonlyMessageMixin {}
...
class Table_ClusterStatesEntry extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('Table_ClusterStatesEntry')
    ..aOS(1, 'key')
    ..a<Table_ClusterState>(2, 'value', PbFieldType.OM, Table_ClusterState.getDefault, Table_ClusterState.create)
    ..hasRequiredFields = false
  ;

  Table_ClusterStatesEntry() : super();
  Table_ClusterStatesEntry.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  Table_ClusterStatesEntry.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  Table_ClusterStatesEntry clone() => new Table_ClusterStatesEntry()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static Table_ClusterStatesEntry create() => new Table_ClusterStatesEntry();
  static PbList<Table_ClusterStatesEntry> createRepeated() => new PbList<Table_ClusterStatesEntry>();
  static Table_ClusterStatesEntry getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyTable_ClusterStatesEntry();
    return _defaultInstance;
  }
  static Table_ClusterStatesEntry _defaultInstance;
  static void $checkItem(Table_ClusterStatesEntry v) {
    if (v is! Table_ClusterStatesEntry) checkItemFailed(v, 'Table_ClusterStatesEntry');
  }
  ...
  set value(Table_ClusterState v) { setField(2, v); }
  bool hasValue() => $_has(1);
  void clearValue() => clearField(2);
}

class _ReadonlyTable_ClusterStatesEntry extends Table_ClusterStatesEntry with ReadonlyMessageMixin {}
...
class Table extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('Table')
    ..aOS(1, 'name')
    ..pp<Table_ClusterStatesEntry>(2, 'clusterStates', PbFieldType.PM, Table_ClusterStatesEntry.$checkItem, Table_ClusterStatesEntry.create)
    ...
    ..e<Table_TimestampGranularity>(4, 'granularity', PbFieldType.OE, Table_TimestampGranularity.TIMESTAMP_GRANULARITY_UNSPECIFIED, Table_TimestampGranularity.valueOf, Table_TimestampGranularity.values)
    ..hasRequiredFields = false
  ;
...
class Snapshot extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('Snapshot')
    ...
    ..a<$google$protobuf.Timestamp>(5, 'deleteTime', PbFieldType.OM, $google$protobuf.Timestamp.getDefault, $google$protobuf.Timestamp.create)
    ..e<Snapshot_State>(6, 'state', PbFieldType.OE, Snapshot_State.STATE_NOT_KNOWN, Snapshot_State.valueOf, Snapshot_State.values)
    ..aOS(7, 'description')
    ..hasRequiredFields = false
  ;
  ...
  set deleteTime($google$protobuf.Timestamp v) { setField(5, v); }
