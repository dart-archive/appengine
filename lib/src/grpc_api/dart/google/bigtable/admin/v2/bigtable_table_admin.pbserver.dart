...
abstract class BigtableTableAdminServiceBase extends GeneratedService {
  ...
  Future<$google$longrunning.Operation> createTableFromSnapshot(ServerContext ctx, CreateTableFromSnapshotRequest request);
  ...
  Future<GenerateConsistencyTokenResponse> generateConsistencyToken(ServerContext ctx, GenerateConsistencyTokenRequest request);
  Future<CheckConsistencyResponse> checkConsistency(ServerContext ctx, CheckConsistencyRequest request);
  Future<$google$longrunning.Operation> snapshotTable(ServerContext ctx, SnapshotTableRequest request);
  ...
  GeneratedMessage createRequest(String method) {
    switch (method) {
      ...
      case 'CreateTableFromSnapshot': return new CreateTableFromSnapshotRequest();
      ...
      case 'GenerateConsistencyToken': return new GenerateConsistencyTokenRequest();
      case 'CheckConsistency': return new CheckConsistencyRequest();
      case 'SnapshotTable': return new SnapshotTableRequest();
      case 'GetSnapshot': return new GetSnapshotRequest();
  ...
  Map<String, Map<String, dynamic>> get $messageJson => BigtableTableAdmin$messageJson;
}
