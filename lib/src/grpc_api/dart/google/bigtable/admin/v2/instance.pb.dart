...
class Instance extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('Instance')
    ..aOS(1, 'name')
    ..aOS(2, 'displayName')
    ..e<Instance_State>(3, 'state', PbFieldType.OE, Instance_State.STATE_NOT_KNOWN, Instance_State.valueOf, Instance_State.values)
    ..e<Instance_Type>(4, 'type', PbFieldType.OE, Instance_Type.TYPE_UNSPECIFIED, Instance_Type.valueOf, Instance_Type.values)
    ..pp<Instance_LabelsEntry>(5, 'labels', PbFieldType.PM, Instance_LabelsEntry.$checkItem, Instance_LabelsEntry.create)
    ..hasRequiredFields = false
  ;
...
class Cluster extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('Cluster')
    ..aOS(1, 'name')
    ..aOS(2, 'location')
    ..e<Cluster_State>(3, 'state', PbFieldType.OE, Cluster_State.STATE_NOT_KNOWN, Cluster_State.valueOf, Cluster_State.values)
    ..a<int>(4, 'serveNodes', PbFieldType.O3)
    ..e<StorageType>(5, 'defaultStorageType', PbFieldType.OE, StorageType.STORAGE_TYPE_UNSPECIFIED, StorageType.valueOf, StorageType.values)
    ..hasRequiredFields = false
  ;
...
class AppProfile_MultiClusterRoutingUseAny extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('AppProfile_MultiClusterRoutingUseAny')
    ..hasRequiredFields = false
  ;

  AppProfile_MultiClusterRoutingUseAny() : super();
  AppProfile_MultiClusterRoutingUseAny.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  AppProfile_MultiClusterRoutingUseAny.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  AppProfile_MultiClusterRoutingUseAny clone() => new AppProfile_MultiClusterRoutingUseAny()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static AppProfile_MultiClusterRoutingUseAny create() => new AppProfile_MultiClusterRoutingUseAny();
  static PbList<AppProfile_MultiClusterRoutingUseAny> createRepeated() => new PbList<AppProfile_MultiClusterRoutingUseAny>();
  static AppProfile_MultiClusterRoutingUseAny getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyAppProfile_MultiClusterRoutingUseAny();
    return _defaultInstance;
  }
  static AppProfile_MultiClusterRoutingUseAny _defaultInstance;
  static void $checkItem(AppProfile_MultiClusterRoutingUseAny v) {
    if (v is! AppProfile_MultiClusterRoutingUseAny) checkItemFailed(v, 'AppProfile_MultiClusterRoutingUseAny');
  }
}

class _ReadonlyAppProfile_MultiClusterRoutingUseAny extends AppProfile_MultiClusterRoutingUseAny with ReadonlyMessageMixin {}

class AppProfile_SingleClusterRouting extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('AppProfile_SingleClusterRouting')
    ..aOS(1, 'clusterId')
  ...
  AppProfile_SingleClusterRouting.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  AppProfile_SingleClusterRouting.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  AppProfile_SingleClusterRouting clone() => new AppProfile_SingleClusterRouting()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static AppProfile_SingleClusterRouting create() => new AppProfile_SingleClusterRouting();
  static PbList<AppProfile_SingleClusterRouting> createRepeated() => new PbList<AppProfile_SingleClusterRouting>();
  static AppProfile_SingleClusterRouting getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyAppProfile_SingleClusterRouting();
    return _defaultInstance;
  }
  static AppProfile_SingleClusterRouting _defaultInstance;
  static void $checkItem(AppProfile_SingleClusterRouting v) {
    if (v is! AppProfile_SingleClusterRouting) checkItemFailed(v, 'AppProfile_SingleClusterRouting');
  }
  ...
  set allowTransactionalWrites(bool v) { $_setBool(1, v); }
  bool hasAllowTransactionalWrites() => $_has(1);
  void clearAllowTransactionalWrites() => clearField(2);
}

class _ReadonlyAppProfile_SingleClusterRouting extends AppProfile_SingleClusterRouting with ReadonlyMessageMixin {}
...
class AppProfile extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('AppProfile')
    ...
    ..aOS(2, 'etag')
    ..aOS(3, 'description')
    ..a<AppProfile_MultiClusterRoutingUseAny>(5, 'multiClusterRoutingUseAny', PbFieldType.OM, AppProfile_MultiClusterRoutingUseAny.getDefault, AppProfile_MultiClusterRoutingUseAny.create)
    ..a<AppProfile_SingleClusterRouting>(6, 'singleClusterRouting', PbFieldType.OM, AppProfile_SingleClusterRouting.getDefault, AppProfile_SingleClusterRouting.create)
    ..hasRequiredFields = false
  ;

  AppProfile() : super();
  AppProfile.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  AppProfile.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ...
  set etag(String v) { $_setString(1, v); }
  bool hasEtag() => $_has(1);
