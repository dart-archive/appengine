...
class Instance_State extends $pb.ProtobufEnum {
  static const Instance_State STATE_NOT_KNOWN = Instance_State._(0, 'STATE_NOT_KNOWN');
...
class Instance_Type extends $pb.ProtobufEnum {
  static const Instance_Type TYPE_UNSPECIFIED = Instance_Type._(0, 'TYPE_UNSPECIFIED');
...
class Cluster_State extends $pb.ProtobufEnum {
  static const Cluster_State STATE_NOT_KNOWN = Cluster_State._(0, 'STATE_NOT_KNOWN');
