...
class ListZonesRequest extends GeneratedMessage {
  ...
  ListZonesRequest.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  ListZonesRequest.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ListZonesRequest clone() => new ListZonesRequest()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static ListZonesRequest create() => new ListZonesRequest();
  static PbList<ListZonesRequest> createRepeated() => new PbList<ListZonesRequest>();
  static ListZonesRequest getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyListZonesRequest();
...
class _ReadonlyListZonesRequest extends ListZonesRequest with ReadonlyMessageMixin {}
...
class ListZonesResponse extends GeneratedMessage {
  ...
  ListZonesResponse.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  ListZonesResponse.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ListZonesResponse clone() => new ListZonesResponse()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static ListZonesResponse create() => new ListZonesResponse();
  static PbList<ListZonesResponse> createRepeated() => new PbList<ListZonesResponse>();
  static ListZonesResponse getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyListZonesResponse();
    return _defaultInstance;
  }
...
class _ReadonlyListZonesResponse extends ListZonesResponse with ReadonlyMessageMixin {}
...
class UpdateClusterMetadata extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('UpdateClusterMetadata')
    ...
    ..a<$google$protobuf.Timestamp>(4, 'finishTime', PbFieldType.OM, $google$protobuf.Timestamp.getDefault, $google$protobuf.Timestamp.create)
    ..hasRequiredFields = false
  ;
  ...
  set finishTime($google$protobuf.Timestamp v) { setField(4, v); }
...
class UndeleteClusterRequest extends GeneratedMessage {
  ...
  UndeleteClusterRequest.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  UndeleteClusterRequest.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  UndeleteClusterRequest clone() => new UndeleteClusterRequest()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static UndeleteClusterRequest create() => new UndeleteClusterRequest();
  static PbList<UndeleteClusterRequest> createRepeated() => new PbList<UndeleteClusterRequest>();
  static UndeleteClusterRequest getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyUndeleteClusterRequest();
    return _defaultInstance;
  }
  static UndeleteClusterRequest _defaultInstance;
  static void $checkItem(UndeleteClusterRequest v) {
    if (v is! UndeleteClusterRequest) checkItemFailed(v, 'UndeleteClusterRequest');
  }
...
class _ReadonlyUndeleteClusterRequest extends UndeleteClusterRequest with ReadonlyMessageMixin {}
...
class UndeleteClusterMetadata extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('UndeleteClusterMetadata')
    ..a<$google$protobuf.Timestamp>(1, 'requestTime', PbFieldType.OM, $google$protobuf.Timestamp.getDefault, $google$protobuf.Timestamp.create)
    ..a<$google$protobuf.Timestamp>(2, 'finishTime', PbFieldType.OM, $google$protobuf.Timestamp.getDefault, $google$protobuf.Timestamp.create)
    ..hasRequiredFields = false
  ;

  UndeleteClusterMetadata() : super();
  UndeleteClusterMetadata.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  UndeleteClusterMetadata.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  UndeleteClusterMetadata clone() => new UndeleteClusterMetadata()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static UndeleteClusterMetadata create() => new UndeleteClusterMetadata();
  static PbList<UndeleteClusterMetadata> createRepeated() => new PbList<UndeleteClusterMetadata>();
  static UndeleteClusterMetadata getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyUndeleteClusterMetadata();
    return _defaultInstance;
  }
  static UndeleteClusterMetadata _defaultInstance;
  static void $checkItem(UndeleteClusterMetadata v) {
    if (v is! UndeleteClusterMetadata) checkItemFailed(v, 'UndeleteClusterMetadata');
  }

  $google$protobuf.Timestamp get requestTime => $_getN(0);
  set requestTime($google$protobuf.Timestamp v) { setField(1, v); }
  bool hasRequestTime() => $_has(0);
  void clearRequestTime() => clearField(1);

  $google$protobuf.Timestamp get finishTime => $_getN(1);
  set finishTime($google$protobuf.Timestamp v) { setField(2, v); }
  bool hasFinishTime() => $_has(1);
  void clearFinishTime() => clearField(2);
}

class _ReadonlyUndeleteClusterMetadata extends UndeleteClusterMetadata with ReadonlyMessageMixin {}
...
class V2OperationMetadata extends GeneratedMessage {
  ...
  V2OperationMetadata.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  V2OperationMetadata.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  V2OperationMetadata clone() => new V2OperationMetadata()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static V2OperationMetadata create() => new V2OperationMetadata();
  static PbList<V2OperationMetadata> createRepeated() => new PbList<V2OperationMetadata>();
  static V2OperationMetadata getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyV2OperationMetadata();
    return _defaultInstance;
  }
...
class _ReadonlyV2OperationMetadata extends V2OperationMetadata with ReadonlyMessageMixin {}
