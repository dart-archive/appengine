...
abstract class BigtableClusterServiceBase extends $pb.GeneratedService {
  ...
  $async.Future<$1.Cluster> getCluster(
      $pb.ServerContext ctx, $0.GetClusterRequest request);
  $async.Future<$0.ListClustersResponse> listClusters(
      $pb.ServerContext ctx, $0.ListClustersRequest request);
  $async.Future<$1.Cluster> createCluster(
      $pb.ServerContext ctx, $0.CreateClusterRequest request);
  $async.Future<$1.Cluster> updateCluster(
      $pb.ServerContext ctx, $1.Cluster request);
  $async.Future<$2.Empty> deleteCluster(
      $pb.ServerContext ctx, $0.DeleteClusterRequest request);
  $async.Future<$3.Operation> undeleteCluster(
      $pb.ServerContext ctx, $0.UndeleteClusterRequest request);
  ...
  $pb.GeneratedMessage createRequest($core.String method) {
    switch (method) {
      ...
      case 'GetCluster':
        return $0.GetClusterRequest();
      case 'ListClusters':
        return $0.ListClustersRequest();
      case 'CreateCluster':
        return $0.CreateClusterRequest();
      case 'UpdateCluster':
        return $1.Cluster();
      case 'DeleteCluster':
        return $0.DeleteClusterRequest();
      case 'UndeleteCluster':
        return $0.UndeleteClusterRequest();
      default:
  ...
  $core.Map<$core.String, $core.dynamic> get $json =>
      BigtableClusterServiceBase$json;
  $core.Map<$core.String, $core.Map<$core.String, $core.dynamic>>
      get $messageJson => BigtableClusterServiceBase$messageJson;
}
