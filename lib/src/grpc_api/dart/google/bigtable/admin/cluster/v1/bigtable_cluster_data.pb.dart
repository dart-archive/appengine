...
class Zone extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('Zone')
    ..aOS(1, 'name')
    ..aOS(2, 'displayName')
    ..e<Zone_Status>(3, 'status', PbFieldType.OE, Zone_Status.UNKNOWN, Zone_Status.valueOf, Zone_Status.values)
    ..hasRequiredFields = false
  ;

  Zone() : super();
  Zone.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  Zone.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
...
class Cluster extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('Cluster')
    ..aOS(1, 'name')
    ..a<$google$longrunning.Operation>(3, 'currentOperation', PbFieldType.OM, $google$longrunning.Operation.getDefault, $google$longrunning.Operation.create)
    ..aOS(4, 'displayName')
    ..a<int>(5, 'serveNodes', PbFieldType.O3)
    ..e<StorageType>(8, 'defaultStorageType', PbFieldType.OE, StorageType.STORAGE_UNSPECIFIED, StorageType.valueOf, StorageType.values)
    ..hasRequiredFields = false
  ;
  ...
  set currentOperation($google$longrunning.Operation v) { setField(3, v); }
