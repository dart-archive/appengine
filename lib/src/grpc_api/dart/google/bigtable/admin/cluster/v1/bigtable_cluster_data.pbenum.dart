...
class StorageType extends $pb.ProtobufEnum {
  static const StorageType STORAGE_UNSPECIFIED = StorageType._(0, 'STORAGE_UNSPECIFIED');
...
class Zone_Status extends $pb.ProtobufEnum {
  ...
  static const Zone_Status PLANNED_MAINTENANCE = Zone_Status._(2, 'PLANNED_MAINTENANCE');
  static const Zone_Status EMERGENCY_MAINENANCE = Zone_Status._(3, 'EMERGENCY_MAINENANCE');
