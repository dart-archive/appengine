...
class Table extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Table', package: const $pb.PackageName('google.bigtable.admin.table.v1'))
    ..aOS(1, 'name')
    ..a<$0.Operation>(2, 'currentOperation', $pb.PbFieldType.OM, $0.Operation.getDefault, $0.Operation.create)
    ..m<$core.String, ColumnFamily>(3, 'columnFamilies', 'Table.ColumnFamiliesEntry',$pb.PbFieldType.OS, $pb.PbFieldType.OM, ColumnFamily.create, null, null , const $pb.PackageName('google.bigtable.admin.table.v1'))
    ..e<Table_TimestampGranularity>(4, 'granularity', $pb.PbFieldType.OE, Table_TimestampGranularity.MILLIS, Table_TimestampGranularity.valueOf, Table_TimestampGranularity.values)
  ...
  set currentOperation($0.Operation v) { setField(2, v); }
...
class ColumnFamily extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ColumnFamily', package: const $pb.PackageName('google.bigtable.admin.table.v1'))
    ..aOS(1, 'name')
    ..aOS(2, 'gcExpression')
    ..a<GcRule>(3, 'gcRule', $pb.PbFieldType.OM, GcRule.getDefault, GcRule.create)
    ..hasRequiredFields = false
  ;
  ...
  set gcExpression($core.String v) { $_setString(1, v); }
...
class GcRule_Intersection extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('GcRule.Intersection', package: const $pb.PackageName('google.bigtable.admin.table.v1'))
...
class GcRule_Union extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('GcRule.Union', package: const $pb.PackageName('google.bigtable.admin.table.v1'))
    ..pc<GcRule>(1, 'rules', $pb.PbFieldType.PM,GcRule.create)
    ..hasRequiredFields = false
  ;
...
class GcRule extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('GcRule', package: const $pb.PackageName('google.bigtable.admin.table.v1'))
    ..a<$core.int>(1, 'maxNumVersions', $pb.PbFieldType.O3)
    ..a<$1.Duration>(2, 'maxAge', $pb.PbFieldType.OM, $1.Duration.getDefault, $1.Duration.create)
  ...
  set maxAge($1.Duration v) { setField(2, v); }
