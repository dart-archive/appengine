...
const Row$json = const {
  ...
  '2': const [
    ...
    const {'1': 'families', '3': 2, '4': 3, '5': 11, '6': '.google.bigtable.v1.Family', '10': 'families'},
  ],
};
...
const Family$json = const {
  ...
  '2': const [
    ...
    const {'1': 'columns', '3': 2, '4': 3, '5': 11, '6': '.google.bigtable.v1.Column', '10': 'columns'},
  ],
};
...
const Column$json = const {
  ...
  '2': const [
    ...
    const {'1': 'cells', '3': 2, '4': 3, '5': 11, '6': '.google.bigtable.v1.Cell', '10': 'cells'},
  ],
};
...
const RowSet$json = const {
  ...
  '2': const [
    ...
    const {'1': 'row_ranges', '3': 2, '4': 3, '5': 11, '6': '.google.bigtable.v1.RowRange', '10': 'rowRanges'},
  ],
};
...
const ColumnRange$json = const {
  ...
  '2': const [
    ...
    const {'1': 'start_qualifier_inclusive', '3': 2, '4': 1, '5': 12, '9': 0, '10': 'startQualifierInclusive'},
    const {'1': 'start_qualifier_exclusive', '3': 3, '4': 1, '5': 12, '9': 0, '10': 'startQualifierExclusive'},
    const {'1': 'end_qualifier_inclusive', '3': 4, '4': 1, '5': 12, '9': 1, '10': 'endQualifierInclusive'},
    const {'1': 'end_qualifier_exclusive', '3': 5, '4': 1, '5': 12, '9': 1, '10': 'endQualifierExclusive'},
  ],
  '8': const [
...
const ValueRange$json = const {
  '1': 'ValueRange',
  '2': const [
    const {'1': 'start_value_inclusive', '3': 1, '4': 1, '5': 12, '9': 0, '10': 'startValueInclusive'},
    const {'1': 'start_value_exclusive', '3': 2, '4': 1, '5': 12, '9': 0, '10': 'startValueExclusive'},
    const {'1': 'end_value_inclusive', '3': 3, '4': 1, '5': 12, '9': 1, '10': 'endValueInclusive'},
    const {'1': 'end_value_exclusive', '3': 4, '4': 1, '5': 12, '9': 1, '10': 'endValueExclusive'},
  ],
  '8': const [
    const {'1': 'start_value'},
    const {'1': 'end_value'},
...
const RowFilter$json = const {
  '1': 'RowFilter',
  '2': const [
    const {'1': 'chain', '3': 1, '4': 1, '5': 11, '6': '.google.bigtable.v1.RowFilter.Chain', '9': 0, '10': 'chain'},
    const {'1': 'interleave', '3': 2, '4': 1, '5': 11, '6': '.google.bigtable.v1.RowFilter.Interleave', '9': 0, '10': 'interleave'},
    const {'1': 'condition', '3': 3, '4': 1, '5': 11, '6': '.google.bigtable.v1.RowFilter.Condition', '9': 0, '10': 'condition'},
    ...
    const {'1': 'column_range_filter', '3': 7, '4': 1, '5': 11, '6': '.google.bigtable.v1.ColumnRange', '9': 0, '10': 'columnRangeFilter'},
    const {'1': 'timestamp_range_filter', '3': 8, '4': 1, '5': 11, '6': '.google.bigtable.v1.TimestampRange', '9': 0, '10': 'timestampRangeFilter'},
    const {'1': 'value_regex_filter', '3': 9, '4': 1, '5': 12, '9': 0, '10': 'valueRegexFilter'},
    const {'1': 'value_range_filter', '3': 15, '4': 1, '5': 11, '6': '.google.bigtable.v1.ValueRange', '9': 0, '10': 'valueRangeFilter'},
...
const RowFilter_Chain$json = const {
  '1': 'Chain',
  '2': const [
    const {'1': 'filters', '3': 1, '4': 3, '5': 11, '6': '.google.bigtable.v1.RowFilter', '10': 'filters'},
  ],
};
...
const RowFilter_Condition$json = const {
  '1': 'Condition',
  '2': const [
    const {'1': 'predicate_filter', '3': 1, '4': 1, '5': 11, '6': '.google.bigtable.v1.RowFilter', '10': 'predicateFilter'},
    const {'1': 'true_filter', '3': 2, '4': 1, '5': 11, '6': '.google.bigtable.v1.RowFilter', '10': 'trueFilter'},
    const {'1': 'false_filter', '3': 3, '4': 1, '5': 11, '6': '.google.bigtable.v1.RowFilter', '10': 'falseFilter'},
  ],
};
...
const Mutation$json = const {
  '1': 'Mutation',
  '2': const [
    const {'1': 'set_cell', '3': 1, '4': 1, '5': 11, '6': '.google.bigtable.v1.Mutation.SetCell', '9': 0, '10': 'setCell'},
    const {'1': 'delete_from_column', '3': 2, '4': 1, '5': 11, '6': '.google.bigtable.v1.Mutation.DeleteFromColumn', '9': 0, '10': 'deleteFromColumn'},
    const {'1': 'delete_from_family', '3': 3, '4': 1, '5': 11, '6': '.google.bigtable.v1.Mutation.DeleteFromFamily', '9': 0, '10': 'deleteFromFamily'},
    const {'1': 'delete_from_row', '3': 4, '4': 1, '5': 11, '6': '.google.bigtable.v1.Mutation.DeleteFromRow', '9': 0, '10': 'deleteFromRow'},
  ],
...
const Mutation_DeleteFromColumn$json = const {
  ...
  '2': const [
    const {'1': 'family_name', '3': 1, '4': 1, '5': 9, '10': 'familyName'},
    const {'1': 'column_qualifier', '3': 2, '4': 1, '5': 12, '10': 'columnQualifier'},
    const {'1': 'time_range', '3': 3, '4': 1, '5': 11, '6': '.google.bigtable.v1.TimestampRange', '10': 'timeRange'},
  ],
};
