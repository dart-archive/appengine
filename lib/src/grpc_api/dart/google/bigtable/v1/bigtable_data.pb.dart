...
class Row extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Row', package: const $pb.PackageName('google.bigtable.v1'))
  ...
  Row() : super();
  Row.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  Row.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
...
class Family extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Family', package: const $pb.PackageName('google.bigtable.v1'))
    ..aOS(1, 'name')
...
class Column extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Column', package: const $pb.PackageName('google.bigtable.v1'))
  ...
  Column() : super();
  Column.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  Column.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  Column clone() => Column()..mergeFromMessage(this);
  Column copyWith(void Function(Column) updates) => super.copyWith((message) => updates(message as Column));
  $pb.BuilderInfo get info_ => _i;
...
class Cell extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Cell', package: const $pb.PackageName('google.bigtable.v1'))
  ...
  Cell() : super();
  Cell.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  Cell.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
...
class RowRange extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('RowRange', package: const $pb.PackageName('google.bigtable.v1'))
  ...
  RowRange() : super();
  RowRange.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  RowRange.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  RowRange clone() => RowRange()..mergeFromMessage(this);
  RowRange copyWith(void Function(RowRange) updates) => super.copyWith((message) => updates(message as RowRange));
  $pb.BuilderInfo get info_ => _i;
  ...
  set startKey($core.List<$core.int> v) { $_setBytes(0, v); }
  $core.bool hasStartKey() => $_has(0);
  void clearStartKey() => clearField(2);

  $core.List<$core.int> get endKey => $_getN(1);
  set endKey($core.List<$core.int> v) { $_setBytes(1, v); }
  $core.bool hasEndKey() => $_has(1);
  void clearEndKey() => clearField(3);
}

class RowSet extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('RowSet', package: const $pb.PackageName('google.bigtable.v1'))
  ...
  RowSet() : super();
  RowSet.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  RowSet.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  RowSet clone() => RowSet()..mergeFromMessage(this);
  RowSet copyWith(void Function(RowSet) updates) => super.copyWith((message) => updates(message as RowSet));
  $pb.BuilderInfo get info_ => _i;
...
class ColumnRange extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ColumnRange', package: const $pb.PackageName('google.bigtable.v1'))
    ..aOS(1, 'familyName')
  ...
  ColumnRange() : super();
  ColumnRange.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  ColumnRange.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ColumnRange clone() => ColumnRange()..mergeFromMessage(this);
  ColumnRange copyWith(void Function(ColumnRange) updates) => super.copyWith((message) => updates(message as ColumnRange));
  $pb.BuilderInfo get info_ => _i;
  ...
  set startQualifierInclusive($core.List<$core.int> v) { $_setBytes(1, v); }
  ...
  set startQualifierExclusive($core.List<$core.int> v) { $_setBytes(2, v); }
  ...
  set endQualifierInclusive($core.List<$core.int> v) { $_setBytes(3, v); }
  ...
  set endQualifierExclusive($core.List<$core.int> v) { $_setBytes(4, v); }
...
class TimestampRange extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('TimestampRange', package: const $pb.PackageName('google.bigtable.v1'))
  ...
  TimestampRange.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  TimestampRange.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  TimestampRange clone() => TimestampRange()..mergeFromMessage(this);
  TimestampRange copyWith(void Function(TimestampRange) updates) => super.copyWith((message) => updates(message as TimestampRange));
  $pb.BuilderInfo get info_ => _i;
...
class ValueRange extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ValueRange', package: const $pb.PackageName('google.bigtable.v1'))
  ...
  ValueRange() : super();
  ValueRange.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  ValueRange.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ValueRange clone() => ValueRange()..mergeFromMessage(this);
  ValueRange copyWith(void Function(ValueRange) updates) => super.copyWith((message) => updates(message as ValueRange));
  $pb.BuilderInfo get info_ => _i;
  ...
  set startValueInclusive($core.List<$core.int> v) { $_setBytes(0, v); }
  ...
  set startValueExclusive($core.List<$core.int> v) { $_setBytes(1, v); }
  ...
  set endValueInclusive($core.List<$core.int> v) { $_setBytes(2, v); }
  ...
  set endValueExclusive($core.List<$core.int> v) { $_setBytes(3, v); }
...
class RowFilter_Chain extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('RowFilter.Chain', package: const $pb.PackageName('google.bigtable.v1'))
    ..pc<RowFilter>(1, 'filters', $pb.PbFieldType.PM,RowFilter.create)
    ..hasRequiredFields = false
  ;

  RowFilter_Chain() : super();
  RowFilter_Chain.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  RowFilter_Chain.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  RowFilter_Chain clone() => RowFilter_Chain()..mergeFromMessage(this);
  RowFilter_Chain copyWith(void Function(RowFilter_Chain) updates) => super.copyWith((message) => updates(message as RowFilter_Chain));
  $pb.BuilderInfo get info_ => _i;
  ...
  static RowFilter_Chain getDefault() => _defaultInstance ??= create()..freeze();
...
class RowFilter_Interleave extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('RowFilter.Interleave', package: const $pb.PackageName('google.bigtable.v1'))
    ..pc<RowFilter>(1, 'filters', $pb.PbFieldType.PM,RowFilter.create)
    ..hasRequiredFields = false
  ;

  RowFilter_Interleave() : super();
  RowFilter_Interleave.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  RowFilter_Interleave.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  RowFilter_Interleave clone() => RowFilter_Interleave()..mergeFromMessage(this);
  RowFilter_Interleave copyWith(void Function(RowFilter_Interleave) updates) => super.copyWith((message) => updates(message as RowFilter_Interleave));
  $pb.BuilderInfo get info_ => _i;
  ...
  static RowFilter_Interleave getDefault() => _defaultInstance ??= create()..freeze();
...
class RowFilter_Condition extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('RowFilter.Condition', package: const $pb.PackageName('google.bigtable.v1'))
    ..a<RowFilter>(1, 'predicateFilter', $pb.PbFieldType.OM, RowFilter.getDefault, RowFilter.create)
    ..a<RowFilter>(2, 'trueFilter', $pb.PbFieldType.OM, RowFilter.getDefault, RowFilter.create)
    ..a<RowFilter>(3, 'falseFilter', $pb.PbFieldType.OM, RowFilter.getDefault, RowFilter.create)
    ..hasRequiredFields = false
  ;

  RowFilter_Condition() : super();
  RowFilter_Condition.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  RowFilter_Condition.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  RowFilter_Condition clone() => RowFilter_Condition()..mergeFromMessage(this);
  RowFilter_Condition copyWith(void Function(RowFilter_Condition) updates) => super.copyWith((message) => updates(message as RowFilter_Condition));
  $pb.BuilderInfo get info_ => _i;
  ...
  static RowFilter_Condition getDefault() => _defaultInstance ??= create()..freeze();
...
class RowFilter extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('RowFilter', package: const $pb.PackageName('google.bigtable.v1'))
    ..a<RowFilter_Chain>(1, 'chain', $pb.PbFieldType.OM, RowFilter_Chain.getDefault, RowFilter_Chain.create)
    ..a<RowFilter_Interleave>(2, 'interleave', $pb.PbFieldType.OM, RowFilter_Interleave.getDefault, RowFilter_Interleave.create)
    ..a<RowFilter_Condition>(3, 'condition', $pb.PbFieldType.OM, RowFilter_Condition.getDefault, RowFilter_Condition.create)
    ..a<$core.List<$core.int>>(4, 'rowKeyRegexFilter', $pb.PbFieldType.OY)
    ..aOS(5, 'familyNameRegexFilter')
    ..a<$core.List<$core.int>>(6, 'columnQualifierRegexFilter', $pb.PbFieldType.OY)
    ..a<ColumnRange>(7, 'columnRangeFilter', $pb.PbFieldType.OM, ColumnRange.getDefault, ColumnRange.create)
    ..a<TimestampRange>(8, 'timestampRangeFilter', $pb.PbFieldType.OM, TimestampRange.getDefault, TimestampRange.create)
    ...
    ..a<ValueRange>(15, 'valueRangeFilter', $pb.PbFieldType.OM, ValueRange.getDefault, ValueRange.create)
    ..aOB(16, 'sink')
  ...
  RowFilter() : super();
  RowFilter.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  RowFilter.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  RowFilter clone() => RowFilter()..mergeFromMessage(this);
  RowFilter copyWith(void Function(RowFilter) updates) => super.copyWith((message) => updates(message as RowFilter));
  $pb.BuilderInfo get info_ => _i;
...
class Mutation_SetCell extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Mutation.SetCell', package: const $pb.PackageName('google.bigtable.v1'))
    ..aOS(1, 'familyName')
  ...
  Mutation_SetCell.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  Mutation_SetCell.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  Mutation_SetCell clone() => Mutation_SetCell()..mergeFromMessage(this);
  Mutation_SetCell copyWith(void Function(Mutation_SetCell) updates) => super.copyWith((message) => updates(message as Mutation_SetCell));
  $pb.BuilderInfo get info_ => _i;
  ...
  static Mutation_SetCell getDefault() => _defaultInstance ??= create()..freeze();
...
class Mutation_DeleteFromColumn extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Mutation.DeleteFromColumn', package: const $pb.PackageName('google.bigtable.v1'))
    ..aOS(1, 'familyName')
    ..a<$core.List<$core.int>>(2, 'columnQualifier', $pb.PbFieldType.OY)
    ..a<TimestampRange>(3, 'timeRange', $pb.PbFieldType.OM, TimestampRange.getDefault, TimestampRange.create)
    ..hasRequiredFields = false
  ;

  Mutation_DeleteFromColumn() : super();
  Mutation_DeleteFromColumn.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  Mutation_DeleteFromColumn.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  Mutation_DeleteFromColumn clone() => Mutation_DeleteFromColumn()..mergeFromMessage(this);
  Mutation_DeleteFromColumn copyWith(void Function(Mutation_DeleteFromColumn) updates) => super.copyWith((message) => updates(message as Mutation_DeleteFromColumn));
  $pb.BuilderInfo get info_ => _i;
  ...
  static Mutation_DeleteFromColumn getDefault() => _defaultInstance ??= create()..freeze();
...
class Mutation_DeleteFromFamily extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Mutation.DeleteFromFamily', package: const $pb.PackageName('google.bigtable.v1'))
    ..aOS(1, 'familyName')
    ..hasRequiredFields = false
  ;

  Mutation_DeleteFromFamily() : super();
  Mutation_DeleteFromFamily.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  Mutation_DeleteFromFamily.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  Mutation_DeleteFromFamily clone() => Mutation_DeleteFromFamily()..mergeFromMessage(this);
  Mutation_DeleteFromFamily copyWith(void Function(Mutation_DeleteFromFamily) updates) => super.copyWith((message) => updates(message as Mutation_DeleteFromFamily));
  $pb.BuilderInfo get info_ => _i;
  ...
  static Mutation_DeleteFromFamily getDefault() => _defaultInstance ??= create()..freeze();
...
class Mutation_DeleteFromRow extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Mutation.DeleteFromRow', package: const $pb.PackageName('google.bigtable.v1'))
    ..hasRequiredFields = false
  ;

  Mutation_DeleteFromRow() : super();
  Mutation_DeleteFromRow.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  Mutation_DeleteFromRow.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  Mutation_DeleteFromRow clone() => Mutation_DeleteFromRow()..mergeFromMessage(this);
  Mutation_DeleteFromRow copyWith(void Function(Mutation_DeleteFromRow) updates) => super.copyWith((message) => updates(message as Mutation_DeleteFromRow));
  $pb.BuilderInfo get info_ => _i;
  ...
  static Mutation_DeleteFromRow getDefault() => _defaultInstance ??= create()..freeze();
...
class Mutation extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Mutation', package: const $pb.PackageName('google.bigtable.v1'))
    ..a<Mutation_SetCell>(1, 'setCell', $pb.PbFieldType.OM, Mutation_SetCell.getDefault, Mutation_SetCell.create)
    ..a<Mutation_DeleteFromColumn>(2, 'deleteFromColumn', $pb.PbFieldType.OM, Mutation_DeleteFromColumn.getDefault, Mutation_DeleteFromColumn.create)
    ..a<Mutation_DeleteFromFamily>(3, 'deleteFromFamily', $pb.PbFieldType.OM, Mutation_DeleteFromFamily.getDefault, Mutation_DeleteFromFamily.create)
    ..a<Mutation_DeleteFromRow>(4, 'deleteFromRow', $pb.PbFieldType.OM, Mutation_DeleteFromRow.getDefault, Mutation_DeleteFromRow.create)
    ..oo(0, [1, 2, 3, 4])
    ..hasRequiredFields = false
  ;
...
class ReadModifyWriteRule extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ReadModifyWriteRule', package: const $pb.PackageName('google.bigtable.v1'))
    ..aOS(1, 'familyName')
    ..a<$core.List<$core.int>>(2, 'columnQualifier', $pb.PbFieldType.OY)
  ...
  ReadModifyWriteRule.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  ReadModifyWriteRule.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ReadModifyWriteRule clone() => ReadModifyWriteRule()..mergeFromMessage(this);
  ReadModifyWriteRule copyWith(void Function(ReadModifyWriteRule) updates) => super.copyWith((message) => updates(message as ReadModifyWriteRule));
  $pb.BuilderInfo get info_ => _i;
  ...
  static ReadModifyWriteRule getDefault() => _defaultInstance ??= create()..freeze();
