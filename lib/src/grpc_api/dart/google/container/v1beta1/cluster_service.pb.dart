...
class NodeConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('NodeConfig', package: const $pb.PackageName('google.container.v1beta1'))
    ..aOS(1, 'machineType')
    ..a<$core.int>(2, 'diskSizeGb', $pb.PbFieldType.O3)
    ..pPS(3, 'oauthScopes')
    ..m<$core.String, $core.String>(4, 'metadata', 'NodeConfig.MetadataEntry',$pb.PbFieldType.OS, $pb.PbFieldType.OS, null, null, null , const $pb.PackageName('google.container.v1beta1'))
    ..aOS(5, 'imageType')
    ..m<$core.String, $core.String>(6, 'labels', 'NodeConfig.LabelsEntry',$pb.PbFieldType.OS, $pb.PbFieldType.OS, null, null, null , const $pb.PackageName('google.container.v1beta1'))
    ...
    ..a<WorkloadMetadataConfig>(14, 'workloadMetadataConfig', $pb.PbFieldType.OM, WorkloadMetadataConfig.getDefault, WorkloadMetadataConfig.create)
...
class NodeTaint extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('NodeTaint', package: const $pb.PackageName('google.container.v1beta1'))
    ..aOS(1, 'key')
    ..aOS(2, 'value')
...
class MasterAuth extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('MasterAuth', package: const $pb.PackageName('google.container.v1beta1'))
    ..aOS(1, 'username')
    ..aOS(2, 'password')
...
class ClientCertificateConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ClientCertificateConfig', package: const $pb.PackageName('google.container.v1beta1'))
...
class AddonsConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('AddonsConfig', package: const $pb.PackageName('google.container.v1beta1'))
    ...
    ..a<IstioConfig>(5, 'istioConfig', $pb.PbFieldType.OM, IstioConfig.getDefault, IstioConfig.create)
    ..a<CloudRunConfig>(7, 'cloudRunConfig', $pb.PbFieldType.OM, CloudRunConfig.getDefault, CloudRunConfig.create)
    ..hasRequiredFields = false
  ;
...
class HttpLoadBalancing extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('HttpLoadBalancing', package: const $pb.PackageName('google.container.v1beta1'))
    ..aOB(1, 'disabled')
    ..hasRequiredFields = false
  ;
...
class HorizontalPodAutoscaling extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('HorizontalPodAutoscaling', package: const $pb.PackageName('google.container.v1beta1'))
    ..aOB(1, 'disabled')
    ..hasRequiredFields = false
  ;
...
class KubernetesDashboard extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('KubernetesDashboard', package: const $pb.PackageName('google.container.v1beta1'))
    ..aOB(1, 'disabled')
    ..hasRequiredFields = false
  ;
...
class NetworkPolicyConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('NetworkPolicyConfig', package: const $pb.PackageName('google.container.v1beta1'))
    ..aOB(1, 'disabled')
    ..hasRequiredFields = false
  ;
...
class PrivateClusterConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('PrivateClusterConfig', package: const $pb.PackageName('google.container.v1beta1'))
  ...
  PrivateClusterConfig.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  PrivateClusterConfig.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  PrivateClusterConfig clone() => PrivateClusterConfig()..mergeFromMessage(this);
  PrivateClusterConfig copyWith(void Function(PrivateClusterConfig) updates) => super.copyWith((message) => updates(message as PrivateClusterConfig));
  $pb.BuilderInfo get info_ => _i;
  ...
  static PrivateClusterConfig getDefault() => _defaultInstance ??= create()..freeze();
...
class IstioConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('IstioConfig', package: const $pb.PackageName('google.container.v1beta1'))
    ..aOB(1, 'disabled')
    ..e<IstioConfig_IstioAuthMode>(2, 'auth', $pb.PbFieldType.OE, IstioConfig_IstioAuthMode.AUTH_NONE, IstioConfig_IstioAuthMode.valueOf, IstioConfig_IstioAuthMode.values)
    ..hasRequiredFields = false
  ;

  IstioConfig() : super();
  IstioConfig.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  IstioConfig.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  IstioConfig clone() => IstioConfig()..mergeFromMessage(this);
  IstioConfig copyWith(void Function(IstioConfig) updates) => super.copyWith((message) => updates(message as IstioConfig));
  $pb.BuilderInfo get info_ => _i;
...
class CloudRunConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('CloudRunConfig', package: const $pb.PackageName('google.container.v1beta1'))
    ..aOB(1, 'disabled')
    ..hasRequiredFields = false
  ;

  CloudRunConfig() : super();
  CloudRunConfig.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  CloudRunConfig.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  CloudRunConfig clone() => CloudRunConfig()..mergeFromMessage(this);
  CloudRunConfig copyWith(void Function(CloudRunConfig) updates) => super.copyWith((message) => updates(message as CloudRunConfig));
  $pb.BuilderInfo get info_ => _i;
...
class MasterAuthorizedNetworksConfig_CidrBlock extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('MasterAuthorizedNetworksConfig.CidrBlock', package: const $pb.PackageName('google.container.v1beta1'))
    ..aOS(1, 'displayName')
    ..aOS(2, 'cidrBlock')
    ..hasRequiredFields = false
  ;
...
class MasterAuthorizedNetworksConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('MasterAuthorizedNetworksConfig', package: const $pb.PackageName('google.container.v1beta1'))
    ..aOB(1, 'enabled')
...
class LegacyAbac extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('LegacyAbac', package: const $pb.PackageName('google.container.v1beta1'))
    ..aOB(1, 'enabled')
    ..hasRequiredFields = false
  ;

  LegacyAbac() : super();
  LegacyAbac.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  LegacyAbac.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  LegacyAbac clone() => LegacyAbac()..mergeFromMessage(this);
  LegacyAbac copyWith(void Function(LegacyAbac) updates) => super.copyWith((message) => updates(message as LegacyAbac));
  $pb.BuilderInfo get info_ => _i;
...
class NetworkPolicy extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('NetworkPolicy', package: const $pb.PackageName('google.container.v1beta1'))
...
class IPAllocationPolicy extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('IPAllocationPolicy', package: const $pb.PackageName('google.container.v1beta1'))
    ..aOB(1, 'useIpAliases')
...
class BinaryAuthorization extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('BinaryAuthorization', package: const $pb.PackageName('google.container.v1beta1'))
    ..aOB(1, 'enabled')
    ..hasRequiredFields = false
  ;

  BinaryAuthorization() : super();
  BinaryAuthorization.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  BinaryAuthorization.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  BinaryAuthorization clone() => BinaryAuthorization()..mergeFromMessage(this);
  BinaryAuthorization copyWith(void Function(BinaryAuthorization) updates) => super.copyWith((message) => updates(message as BinaryAuthorization));
  $pb.BuilderInfo get info_ => _i;
  ...
  static BinaryAuthorization getDefault() => _defaultInstance ??= create()..freeze();
...
class PodSecurityPolicyConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('PodSecurityPolicyConfig', package: const $pb.PackageName('google.container.v1beta1'))
    ..aOB(1, 'enabled')
    ..hasRequiredFields = false
  ;
...
class Cluster extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Cluster', package: const $pb.PackageName('google.container.v1beta1'))
    ..aOS(1, 'name')
    ..aOS(2, 'description')
    ...
    ..m<$core.String, $core.String>(15, 'resourceLabels', 'Cluster.ResourceLabelsEntry',$pb.PbFieldType.OS, $pb.PbFieldType.OS, null, null, null , const $pb.PackageName('google.container.v1beta1'))
    ..aOS(16, 'labelFingerprint')
    ..a<LegacyAbac>(18, 'legacyAbac', $pb.PbFieldType.OM, LegacyAbac.getDefault, LegacyAbac.create)
    ...
    ..a<BinaryAuthorization>(24, 'binaryAuthorization', $pb.PbFieldType.OM, BinaryAuthorization.getDefault, BinaryAuthorization.create)
  ...
  set selfLink($core.String v) { $_setString(31, v); }
  ...
  @$core.Deprecated('This field is deprecated.')
  set zone($core.String v) { $_setString(32, v); }
  @$core.Deprecated('This field is deprecated.')
  ...
  set currentMasterVersion($core.String v) { $_setString(35, v); }
  ...
  @$core.Deprecated('This field is deprecated.')
  set currentNodeVersion($core.String v) { $_setString(36, v); }
  @$core.Deprecated('This field is deprecated.')
  ...
  set createTime($core.String v) { $_setString(37, v); }
  ...
  @$core.Deprecated('This field is deprecated.')
  set currentNodeCount($core.int v) { $_setSignedInt32(43, v); }
  @$core.Deprecated('This field is deprecated.')
...
class ClusterUpdate extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ClusterUpdate', package: const $pb.PackageName('google.container.v1beta1'))
    ...
    ..a<ClusterAutoscaling>(15, 'desiredClusterAutoscaling', $pb.PbFieldType.OM, ClusterAutoscaling.getDefault, ClusterAutoscaling.create)
    ..a<BinaryAuthorization>(16, 'desiredBinaryAuthorization', $pb.PbFieldType.OM, BinaryAuthorization.getDefault, BinaryAuthorization.create)
    ..aOS(19, 'desiredLoggingService')
    ..a<ResourceUsageExportConfig>(21, 'desiredResourceUsageExportConfig', $pb.PbFieldType.OM, ResourceUsageExportConfig.getDefault, ResourceUsageExportConfig.create)
    ..a<VerticalPodAutoscaling>(22, 'desiredVerticalPodAutoscaling', $pb.PbFieldType.OM, VerticalPodAutoscaling.getDefault, VerticalPodAutoscaling.create)
  ...
  set desiredMasterVersion($core.String v) { $_setString(14, v); }
  $core.bool hasDesiredMasterVersion() => $_has(14);
  void clearDesiredMasterVersion() => clearField(100);
}

class Operation extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Operation', package: const $pb.PackageName('google.container.v1beta1'))
    ..aOS(1, 'name')
    ..aOS(2, 'zone')
    ...
    ..aOS(10, 'startTime')
    ..aOS(11, 'endTime')
    ..a<OperationProgress>(12, 'progress', $pb.PbFieldType.OM, OperationProgress.getDefault, OperationProgress.create)
    ..pc<StatusCondition>(13, 'clusterConditions', $pb.PbFieldType.PM,StatusCondition.create)
    ..pc<StatusCondition>(14, 'nodepoolConditions', $pb.PbFieldType.PM,StatusCondition.create)
    ..hasRequiredFields = false
  ;
...
class OperationProgress_Metric extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('OperationProgress.Metric', package: const $pb.PackageName('google.container.v1beta1'))
    ..aOS(1, 'name')
    ..aInt64(2, 'intValue')
  ...
  OperationProgress_Metric.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  OperationProgress_Metric.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  OperationProgress_Metric clone() => OperationProgress_Metric()..mergeFromMessage(this);
  OperationProgress_Metric copyWith(void Function(OperationProgress_Metric) updates) => super.copyWith((message) => updates(message as OperationProgress_Metric));
  $pb.BuilderInfo get info_ => _i;
  ...
  static OperationProgress_Metric getDefault() => _defaultInstance ??= create()..freeze();
  ...
  set intValue(Int64 v) { $_setInt64(1, v); }
...
class OperationProgress extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('OperationProgress', package: const $pb.PackageName('google.container.v1beta1'))
    ..aOS(1, 'name')
    ..e<Operation_Status>(2, 'status', $pb.PbFieldType.OE, Operation_Status.STATUS_UNSPECIFIED, Operation_Status.valueOf, Operation_Status.values)
    ..pc<OperationProgress_Metric>(3, 'metrics', $pb.PbFieldType.PM,OperationProgress_Metric.create)
    ..pc<OperationProgress>(4, 'stages', $pb.PbFieldType.PM,OperationProgress.create)
    ..hasRequiredFields = false
  ;

  OperationProgress() : super();
  OperationProgress.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  OperationProgress.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  OperationProgress clone() => OperationProgress()..mergeFromMessage(this);
  OperationProgress copyWith(void Function(OperationProgress) updates) => super.copyWith((message) => updates(message as OperationProgress));
  $pb.BuilderInfo get info_ => _i;
  ...
  static OperationProgress getDefault() => _defaultInstance ??= create()..freeze();
...
class CreateClusterRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('CreateClusterRequest', package: const $pb.PackageName('google.container.v1beta1'))
    ..aOS(1, 'projectId')
    ..aOS(2, 'zone')
...
class GetClusterRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('GetClusterRequest', package: const $pb.PackageName('google.container.v1beta1'))
    ..aOS(1, 'projectId')
    ..aOS(2, 'zone')
    ..aOS(3, 'clusterId')
    ..aOS(5, 'name')
...
class UpdateClusterRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('UpdateClusterRequest', package: const $pb.PackageName('google.container.v1beta1'))
    ..aOS(1, 'projectId')
    ..aOS(2, 'zone')
    ..aOS(3, 'clusterId')
...
class UpdateNodePoolRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('UpdateNodePoolRequest', package: const $pb.PackageName('google.container.v1beta1'))
    ..aOS(1, 'projectId')
    ..aOS(2, 'zone')
    ..aOS(3, 'clusterId')
    ..aOS(4, 'nodePoolId')
...
class SetNodePoolAutoscalingRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('SetNodePoolAutoscalingRequest', package: const $pb.PackageName('google.container.v1beta1'))
    ..aOS(1, 'projectId')
    ..aOS(2, 'zone')
    ..aOS(3, 'clusterId')
    ..aOS(4, 'nodePoolId')
...
class SetLoggingServiceRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('SetLoggingServiceRequest', package: const $pb.PackageName('google.container.v1beta1'))
    ..aOS(1, 'projectId')
    ..aOS(2, 'zone')
    ..aOS(3, 'clusterId')
...
class SetMonitoringServiceRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('SetMonitoringServiceRequest', package: const $pb.PackageName('google.container.v1beta1'))
    ..aOS(1, 'projectId')
    ..aOS(2, 'zone')
    ..aOS(3, 'clusterId')
...
class SetAddonsConfigRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('SetAddonsConfigRequest', package: const $pb.PackageName('google.container.v1beta1'))
    ..aOS(1, 'projectId')
    ..aOS(2, 'zone')
    ..aOS(3, 'clusterId')
...
class SetLocationsRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('SetLocationsRequest', package: const $pb.PackageName('google.container.v1beta1'))
    ..aOS(1, 'projectId')
    ..aOS(2, 'zone')
    ..aOS(3, 'clusterId')
    ..pPS(4, 'locations')
...
class UpdateMasterRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('UpdateMasterRequest', package: const $pb.PackageName('google.container.v1beta1'))
    ..aOS(1, 'projectId')
    ..aOS(2, 'zone')
    ..aOS(3, 'clusterId')
    ..aOS(4, 'masterVersion')
...
class SetMasterAuthRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('SetMasterAuthRequest', package: const $pb.PackageName('google.container.v1beta1'))
    ..aOS(1, 'projectId')
    ..aOS(2, 'zone')
    ..aOS(3, 'clusterId')
...
class DeleteClusterRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('DeleteClusterRequest', package: const $pb.PackageName('google.container.v1beta1'))
    ..aOS(1, 'projectId')
    ..aOS(2, 'zone')
    ..aOS(3, 'clusterId')
    ..aOS(4, 'name')
...
class ListClustersRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ListClustersRequest', package: const $pb.PackageName('google.container.v1beta1'))
    ..aOS(1, 'projectId')
    ..aOS(2, 'zone')
    ..aOS(4, 'parent')
    ..hasRequiredFields = false
...
class ListClustersResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ListClustersResponse', package: const $pb.PackageName('google.container.v1beta1'))
...
class GetOperationRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('GetOperationRequest', package: const $pb.PackageName('google.container.v1beta1'))
    ..aOS(1, 'projectId')
    ..aOS(2, 'zone')
    ..aOS(3, 'operationId')
    ..aOS(5, 'name')
...
class ListOperationsRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ListOperationsRequest', package: const $pb.PackageName('google.container.v1beta1'))
    ..aOS(1, 'projectId')
    ..aOS(2, 'zone')
    ..aOS(4, 'parent')
    ..hasRequiredFields = false
...
class CancelOperationRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('CancelOperationRequest', package: const $pb.PackageName('google.container.v1beta1'))
    ..aOS(1, 'projectId')
    ..aOS(2, 'zone')
    ..aOS(3, 'operationId')
    ..aOS(4, 'name')
...
class ListOperationsResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ListOperationsResponse', package: const $pb.PackageName('google.container.v1beta1'))
...
class GetServerConfigRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('GetServerConfigRequest', package: const $pb.PackageName('google.container.v1beta1'))
    ..aOS(1, 'projectId')
    ..aOS(2, 'zone')
    ..aOS(4, 'name')
    ..hasRequiredFields = false
...
class ServerConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ServerConfig', package: const $pb.PackageName('google.container.v1beta1'))
...
class CreateNodePoolRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('CreateNodePoolRequest', package: const $pb.PackageName('google.container.v1beta1'))
    ..aOS(1, 'projectId')
    ..aOS(2, 'zone')
    ..aOS(3, 'clusterId')
...
class DeleteNodePoolRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('DeleteNodePoolRequest', package: const $pb.PackageName('google.container.v1beta1'))
    ..aOS(1, 'projectId')
    ..aOS(2, 'zone')
    ..aOS(3, 'clusterId')
    ..aOS(4, 'nodePoolId')
...
class ListNodePoolsRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ListNodePoolsRequest', package: const $pb.PackageName('google.container.v1beta1'))
    ..aOS(1, 'projectId')
    ..aOS(2, 'zone')
    ..aOS(3, 'clusterId')
    ..aOS(5, 'parent')
...
class GetNodePoolRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('GetNodePoolRequest', package: const $pb.PackageName('google.container.v1beta1'))
    ..aOS(1, 'projectId')
    ..aOS(2, 'zone')
    ..aOS(3, 'clusterId')
    ..aOS(4, 'nodePoolId')
...
class NodePool extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('NodePool', package: const $pb.PackageName('google.container.v1beta1'))
    ..aOS(1, 'name')
    ...
    ..a<MaxPodsConstraint>(6, 'maxPodsConstraint', $pb.PbFieldType.OM, MaxPodsConstraint.getDefault, MaxPodsConstraint.create)
    ..aOS(100, 'selfLink')
    ..aOS(101, 'version')
    ...
    ..pc<StatusCondition>(105, 'conditions', $pb.PbFieldType.PM,StatusCondition.create)
    ..hasRequiredFields = false
  ;
...
class NodeManagement extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('NodeManagement', package: const $pb.PackageName('google.container.v1beta1'))
    ..aOB(1, 'autoUpgrade')
    ..aOB(2, 'autoRepair')
...
class AutoUpgradeOptions extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('AutoUpgradeOptions', package: const $pb.PackageName('google.container.v1beta1'))
...
class MaintenancePolicy extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('MaintenancePolicy', package: const $pb.PackageName('google.container.v1beta1'))
...
class MaintenanceWindow extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('MaintenanceWindow', package: const $pb.PackageName('google.container.v1beta1'))
...
class DailyMaintenanceWindow extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('DailyMaintenanceWindow', package: const $pb.PackageName('google.container.v1beta1'))
    ..aOS(2, 'startTime')
    ..aOS(3, 'duration')
    ..hasRequiredFields = false
  ;
...
class SetNodePoolManagementRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('SetNodePoolManagementRequest', package: const $pb.PackageName('google.container.v1beta1'))
    ..aOS(1, 'projectId')
    ..aOS(2, 'zone')
    ..aOS(3, 'clusterId')
    ..aOS(4, 'nodePoolId')
...
class SetNodePoolSizeRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('SetNodePoolSizeRequest', package: const $pb.PackageName('google.container.v1beta1'))
    ..aOS(1, 'projectId')
    ..aOS(2, 'zone')
    ..aOS(3, 'clusterId')
    ..aOS(4, 'nodePoolId')
...
class RollbackNodePoolUpgradeRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('RollbackNodePoolUpgradeRequest', package: const $pb.PackageName('google.container.v1beta1'))
    ..aOS(1, 'projectId')
    ..aOS(2, 'zone')
    ..aOS(3, 'clusterId')
    ..aOS(4, 'nodePoolId')
...
class ListNodePoolsResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ListNodePoolsResponse', package: const $pb.PackageName('google.container.v1beta1'))
...
class ClusterAutoscaling extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ClusterAutoscaling', package: const $pb.PackageName('google.container.v1beta1'))
    ..aOB(1, 'enableNodeAutoprovisioning')
    ..pc<ResourceLimit>(2, 'resourceLimits', $pb.PbFieldType.PM,ResourceLimit.create)
    ..hasRequiredFields = false
  ;

  ClusterAutoscaling() : super();
  ClusterAutoscaling.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  ClusterAutoscaling.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ClusterAutoscaling clone() => ClusterAutoscaling()..mergeFromMessage(this);
  ClusterAutoscaling copyWith(void Function(ClusterAutoscaling) updates) => super.copyWith((message) => updates(message as ClusterAutoscaling));
  $pb.BuilderInfo get info_ => _i;
  ...
  static ClusterAutoscaling getDefault() => _defaultInstance ??= create()..freeze();
...
class ResourceLimit extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ResourceLimit', package: const $pb.PackageName('google.container.v1beta1'))
    ..aOS(1, 'resourceType')
    ..aInt64(2, 'minimum')
    ..aInt64(3, 'maximum')
    ..hasRequiredFields = false
  ...
  ResourceLimit() : super();
  ResourceLimit.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  ResourceLimit.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
...
class SetLabelsRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('SetLabelsRequest', package: const $pb.PackageName('google.container.v1beta1'))
    ..aOS(1, 'projectId')
    ..aOS(2, 'zone')
    ..aOS(3, 'clusterId')
    ..m<$core.String, $core.String>(4, 'resourceLabels', 'SetLabelsRequest.ResourceLabelsEntry',$pb.PbFieldType.OS, $pb.PbFieldType.OS, null, null, null , const $pb.PackageName('google.container.v1beta1'))
...
class SetLegacyAbacRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('SetLegacyAbacRequest', package: const $pb.PackageName('google.container.v1beta1'))
    ..aOS(1, 'projectId')
    ..aOS(2, 'zone')
    ..aOS(3, 'clusterId')
    ..aOB(4, 'enabled')
...
class StartIPRotationRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('StartIPRotationRequest', package: const $pb.PackageName('google.container.v1beta1'))
    ..aOS(1, 'projectId')
    ..aOS(2, 'zone')
    ..aOS(3, 'clusterId')
    ..aOS(6, 'name')
...
class CompleteIPRotationRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('CompleteIPRotationRequest', package: const $pb.PackageName('google.container.v1beta1'))
    ..aOS(1, 'projectId')
    ..aOS(2, 'zone')
    ..aOS(3, 'clusterId')
    ..aOS(7, 'name')
...
class AcceleratorConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('AcceleratorConfig', package: const $pb.PackageName('google.container.v1beta1'))
...
class WorkloadMetadataConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('WorkloadMetadataConfig', package: const $pb.PackageName('google.container.v1beta1'))
    ..e<WorkloadMetadataConfig_NodeMetadata>(1, 'nodeMetadata', $pb.PbFieldType.OE, WorkloadMetadataConfig_NodeMetadata.UNSPECIFIED, WorkloadMetadataConfig_NodeMetadata.valueOf, WorkloadMetadataConfig_NodeMetadata.values)
    ..hasRequiredFields = false
  ;

  WorkloadMetadataConfig() : super();
  WorkloadMetadataConfig.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  WorkloadMetadataConfig.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  WorkloadMetadataConfig clone() => WorkloadMetadataConfig()..mergeFromMessage(this);
  WorkloadMetadataConfig copyWith(void Function(WorkloadMetadataConfig) updates) => super.copyWith((message) => updates(message as WorkloadMetadataConfig));
  $pb.BuilderInfo get info_ => _i;
  ...
  static WorkloadMetadataConfig getDefault() => _defaultInstance ??= create()..freeze();
...
class SetNetworkPolicyRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('SetNetworkPolicyRequest', package: const $pb.PackageName('google.container.v1beta1'))
    ..aOS(1, 'projectId')
    ..aOS(2, 'zone')
    ..aOS(3, 'clusterId')
...
class SetMaintenancePolicyRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('SetMaintenancePolicyRequest', package: const $pb.PackageName('google.container.v1beta1'))
    ..aOS(1, 'projectId')
    ..aOS(2, 'zone')
    ..aOS(3, 'clusterId')
...
class ListLocationsRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ListLocationsRequest', package: const $pb.PackageName('google.container.v1beta1'))
    ..aOS(1, 'parent')
    ..hasRequiredFields = false
  ;

  ListLocationsRequest() : super();
  ListLocationsRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  ListLocationsRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ListLocationsRequest clone() => ListLocationsRequest()..mergeFromMessage(this);
  ListLocationsRequest copyWith(void Function(ListLocationsRequest) updates) => super.copyWith((message) => updates(message as ListLocationsRequest));
  $pb.BuilderInfo get info_ => _i;
  ...
  static ListLocationsRequest getDefault() => _defaultInstance ??= create()..freeze();
...
class ListLocationsResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ListLocationsResponse', package: const $pb.PackageName('google.container.v1beta1'))
  ...
  ListLocationsResponse.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  ListLocationsResponse.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ListLocationsResponse clone() => ListLocationsResponse()..mergeFromMessage(this);
  ListLocationsResponse copyWith(void Function(ListLocationsResponse) updates) => super.copyWith((message) => updates(message as ListLocationsResponse));
  $pb.BuilderInfo get info_ => _i;
  ...
  static ListLocationsResponse getDefault() => _defaultInstance ??= create()..freeze();
...
class Location extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Location', package: const $pb.PackageName('google.container.v1beta1'))
    ..e<Location_LocationType>(1, 'type', $pb.PbFieldType.OE, Location_LocationType.LOCATION_TYPE_UNSPECIFIED, Location_LocationType.valueOf, Location_LocationType.values)
    ..aOS(2, 'name')
    ..aOB(3, 'recommended')
    ..hasRequiredFields = false
  ;
...
class StatusCondition extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('StatusCondition', package: const $pb.PackageName('google.container.v1beta1'))
    ..e<StatusCondition_Code>(1, 'code', $pb.PbFieldType.OE, StatusCondition_Code.UNKNOWN, StatusCondition_Code.valueOf, StatusCondition_Code.values)
    ..aOS(2, 'message')
    ..hasRequiredFields = false
  ;

  StatusCondition() : super();
  StatusCondition.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  StatusCondition.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  StatusCondition clone() => StatusCondition()..mergeFromMessage(this);
  StatusCondition copyWith(void Function(StatusCondition) updates) => super.copyWith((message) => updates(message as StatusCondition));
  $pb.BuilderInfo get info_ => _i;
  ...
  static StatusCondition getDefault() => _defaultInstance ??= create()..freeze();
...
class NetworkConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('NetworkConfig', package: const $pb.PackageName('google.container.v1beta1'))
    ..aOS(1, 'network')
    ..aOS(2, 'subnetwork')
    ..hasRequiredFields = false
  ;
  ...
  NetworkConfig() : super();
  NetworkConfig.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  NetworkConfig.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  NetworkConfig clone() => NetworkConfig()..mergeFromMessage(this);
  NetworkConfig copyWith(void Function(NetworkConfig) updates) => super.copyWith((message) => updates(message as NetworkConfig));
  $pb.BuilderInfo get info_ => _i;
...
class ListUsableSubnetworksRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ListUsableSubnetworksRequest', package: const $pb.PackageName('google.container.v1beta1'))
    ..aOS(1, 'parent')
    ..aOS(2, 'filter')
  ...
  ListUsableSubnetworksRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  ListUsableSubnetworksRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ListUsableSubnetworksRequest clone() => ListUsableSubnetworksRequest()..mergeFromMessage(this);
  ListUsableSubnetworksRequest copyWith(void Function(ListUsableSubnetworksRequest) updates) => super.copyWith((message) => updates(message as ListUsableSubnetworksRequest));
  $pb.BuilderInfo get info_ => _i;
  static ListUsableSubnetworksRequest create() => ListUsableSubnetworksRequest();
  ...
  static ListUsableSubnetworksRequest getDefault() => _defaultInstance ??= create()..freeze();
...
class ListUsableSubnetworksResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ListUsableSubnetworksResponse', package: const $pb.PackageName('google.container.v1beta1'))
    ..pc<UsableSubnetwork>(1, 'subnetworks', $pb.PbFieldType.PM,UsableSubnetwork.create)
    ..aOS(2, 'nextPageToken')
    ..hasRequiredFields = false
  ;

  ListUsableSubnetworksResponse() : super();
  ListUsableSubnetworksResponse.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  ListUsableSubnetworksResponse.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ListUsableSubnetworksResponse clone() => ListUsableSubnetworksResponse()..mergeFromMessage(this);
  ListUsableSubnetworksResponse copyWith(void Function(ListUsableSubnetworksResponse) updates) => super.copyWith((message) => updates(message as ListUsableSubnetworksResponse));
  $pb.BuilderInfo get info_ => _i;
  static ListUsableSubnetworksResponse create() => ListUsableSubnetworksResponse();
  ...
  static ListUsableSubnetworksResponse getDefault() => _defaultInstance ??= create()..freeze();
...
class UsableSubnetworkSecondaryRange extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('UsableSubnetworkSecondaryRange', package: const $pb.PackageName('google.container.v1beta1'))
    ..aOS(1, 'rangeName')
    ..aOS(2, 'ipCidrRange')
    ..e<UsableSubnetworkSecondaryRange_Status>(3, 'status', $pb.PbFieldType.OE, UsableSubnetworkSecondaryRange_Status.UNKNOWN, UsableSubnetworkSecondaryRange_Status.valueOf, UsableSubnetworkSecondaryRange_Status.values)
    ..hasRequiredFields = false
  ;

  UsableSubnetworkSecondaryRange() : super();
  UsableSubnetworkSecondaryRange.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  UsableSubnetworkSecondaryRange.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  UsableSubnetworkSecondaryRange clone() => UsableSubnetworkSecondaryRange()..mergeFromMessage(this);
  UsableSubnetworkSecondaryRange copyWith(void Function(UsableSubnetworkSecondaryRange) updates) => super.copyWith((message) => updates(message as UsableSubnetworkSecondaryRange));
  $pb.BuilderInfo get info_ => _i;
  static UsableSubnetworkSecondaryRange create() => UsableSubnetworkSecondaryRange();
  ...
  static UsableSubnetworkSecondaryRange getDefault() => _defaultInstance ??= create()..freeze();
...
class UsableSubnetwork extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('UsableSubnetwork', package: const $pb.PackageName('google.container.v1beta1'))
    ..aOS(1, 'subnetwork')
    ..aOS(2, 'network')
    ..aOS(3, 'ipCidrRange')
    ..pc<UsableSubnetworkSecondaryRange>(4, 'secondaryIpRanges', $pb.PbFieldType.PM,UsableSubnetworkSecondaryRange.create)
    ..aOS(5, 'statusMessage')
    ..hasRequiredFields = false
  ;

  UsableSubnetwork() : super();
  UsableSubnetwork.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  UsableSubnetwork.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  UsableSubnetwork clone() => UsableSubnetwork()..mergeFromMessage(this);
  UsableSubnetwork copyWith(void Function(UsableSubnetwork) updates) => super.copyWith((message) => updates(message as UsableSubnetwork));
  $pb.BuilderInfo get info_ => _i;
  ...
  static UsableSubnetwork getDefault() => _defaultInstance ??= create()..freeze();
...
class VerticalPodAutoscaling extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('VerticalPodAutoscaling', package: const $pb.PackageName('google.container.v1beta1'))
    ..aOB(1, 'enabled')
    ..hasRequiredFields = false
  ;

  VerticalPodAutoscaling() : super();
  VerticalPodAutoscaling.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  VerticalPodAutoscaling.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  VerticalPodAutoscaling clone() => VerticalPodAutoscaling()..mergeFromMessage(this);
  VerticalPodAutoscaling copyWith(void Function(VerticalPodAutoscaling) updates) => super.copyWith((message) => updates(message as VerticalPodAutoscaling));
  $pb.BuilderInfo get info_ => _i;
  ...
  static VerticalPodAutoscaling getDefault() => _defaultInstance ??= create()..freeze();
...
class MaxPodsConstraint extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('MaxPodsConstraint', package: const $pb.PackageName('google.container.v1beta1'))
    ..aInt64(1, 'maxPodsPerNode')
    ..hasRequiredFields = false
  ;

  MaxPodsConstraint() : super();
  MaxPodsConstraint.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  MaxPodsConstraint.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  MaxPodsConstraint clone() => MaxPodsConstraint()..mergeFromMessage(this);
  MaxPodsConstraint copyWith(void Function(MaxPodsConstraint) updates) => super.copyWith((message) => updates(message as MaxPodsConstraint));
  $pb.BuilderInfo get info_ => _i;
  ...
  static MaxPodsConstraint getDefault() => _defaultInstance ??= create()..freeze();
  static MaxPodsConstraint _defaultInstance;

  Int64 get maxPodsPerNode => $_getI64(0);
  set maxPodsPerNode(Int64 v) { $_setInt64(0, v); }
...
class ResourceUsageExportConfig_BigQueryDestination extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ResourceUsageExportConfig.BigQueryDestination', package: const $pb.PackageName('google.container.v1beta1'))
    ..aOS(1, 'datasetId')
    ..hasRequiredFields = false
  ;

  ResourceUsageExportConfig_BigQueryDestination() : super();
  ResourceUsageExportConfig_BigQueryDestination.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  ResourceUsageExportConfig_BigQueryDestination.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ResourceUsageExportConfig_BigQueryDestination clone() => ResourceUsageExportConfig_BigQueryDestination()..mergeFromMessage(this);
  ResourceUsageExportConfig_BigQueryDestination copyWith(void Function(ResourceUsageExportConfig_BigQueryDestination) updates) => super.copyWith((message) => updates(message as ResourceUsageExportConfig_BigQueryDestination));
  $pb.BuilderInfo get info_ => _i;
  static ResourceUsageExportConfig_BigQueryDestination create() => ResourceUsageExportConfig_BigQueryDestination();
  ...
  static ResourceUsageExportConfig_BigQueryDestination getDefault() => _defaultInstance ??= create()..freeze();
...
class ResourceUsageExportConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ResourceUsageExportConfig', package: const $pb.PackageName('google.container.v1beta1'))
    ..a<ResourceUsageExportConfig_BigQueryDestination>(1, 'bigqueryDestination', $pb.PbFieldType.OM, ResourceUsageExportConfig_BigQueryDestination.getDefault, ResourceUsageExportConfig_BigQueryDestination.create)
    ..aOB(2, 'enableNetworkEgressMetering')
    ..hasRequiredFields = false
  ;

  ResourceUsageExportConfig() : super();
  ResourceUsageExportConfig.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  ResourceUsageExportConfig.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ResourceUsageExportConfig clone() => ResourceUsageExportConfig()..mergeFromMessage(this);
  ResourceUsageExportConfig copyWith(void Function(ResourceUsageExportConfig) updates) => super.copyWith((message) => updates(message as ResourceUsageExportConfig));
  $pb.BuilderInfo get info_ => _i;
  ...
  static ResourceUsageExportConfig getDefault() => _defaultInstance ??= create()..freeze();
...
class ClusterManagerApi {
  ...
  $async.Future<ListUsableSubnetworksResponse> listUsableSubnetworks($pb.ClientContext ctx, ListUsableSubnetworksRequest request) {
    var emptyResponse = ListUsableSubnetworksResponse();
    return _client.invoke<ListUsableSubnetworksResponse>(ctx, 'ClusterManager', 'ListUsableSubnetworks', request, emptyResponse);
  }
  $async.Future<ListLocationsResponse> listLocations($pb.ClientContext ctx, ListLocationsRequest request) {
    ...
    return _client.invoke<ListLocationsResponse>(ctx, 'ClusterManager', 'ListLocations', request, emptyResponse);
  }
}
