...
class LegacyAbac extends GeneratedMessage {
  static final BuilderInfo _i = BuilderInfo('LegacyAbac')
    ..aOB(1, 'enabled')
    ..hasRequiredFields = false;
  ...
  static PbList<LegacyAbac> createRepeated() => PbList<LegacyAbac>();
  static LegacyAbac getDefault() {
    if (_defaultInstance == null) _defaultInstance = _ReadonlyLegacyAbac();
    return _defaultInstance;
  }
...
class Cluster_ResourceLabelsEntry extends GeneratedMessage {
  static final BuilderInfo _i = BuilderInfo('Cluster_ResourceLabelsEntry')
    ..aOS(1, 'key')
    ..aOS(2, 'value')
    ..hasRequiredFields = false;
  ...
  Cluster_ResourceLabelsEntry clone() =>
      Cluster_ResourceLabelsEntry()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static Cluster_ResourceLabelsEntry create() => Cluster_ResourceLabelsEntry();
  static PbList<Cluster_ResourceLabelsEntry> createRepeated() =>
      PbList<Cluster_ResourceLabelsEntry>();
  static Cluster_ResourceLabelsEntry getDefault() {
    if (_defaultInstance == null)
      _defaultInstance = _ReadonlyCluster_ResourceLabelsEntry();
    return _defaultInstance;
  }
