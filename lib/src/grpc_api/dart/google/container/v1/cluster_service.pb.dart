...
class LegacyAbac extends GeneratedMessage {
  ...
  LegacyAbac() : super();
  LegacyAbac.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  LegacyAbac.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
...
class Cluster_ResourceLabelsEntry extends GeneratedMessage {
  ...
  Cluster_ResourceLabelsEntry.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  Cluster_ResourceLabelsEntry.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  Cluster_ResourceLabelsEntry clone() => new Cluster_ResourceLabelsEntry()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static Cluster_ResourceLabelsEntry create() => new Cluster_ResourceLabelsEntry();
  static PbList<Cluster_ResourceLabelsEntry> createRepeated() => new PbList<Cluster_ResourceLabelsEntry>();
  static Cluster_ResourceLabelsEntry getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyCluster_ResourceLabelsEntry();
    return _defaultInstance;
  }
  static Cluster_ResourceLabelsEntry _defaultInstance;
  static void $checkItem(Cluster_ResourceLabelsEntry v) {
    if (v is! Cluster_ResourceLabelsEntry) checkItemFailed(v, 'Cluster_ResourceLabelsEntry');
  }
...
class _ReadonlyCluster_ResourceLabelsEntry extends Cluster_ResourceLabelsEntry with ReadonlyMessageMixin {}
...
class Cluster extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('Cluster')
    ...
    ..pp<Cluster_ResourceLabelsEntry>(15, 'resourceLabels', PbFieldType.PM, Cluster_ResourceLabelsEntry.$checkItem, Cluster_ResourceLabelsEntry.create)
    ..aOS(16, 'labelFingerprint')
    ..a<LegacyAbac>(18, 'legacyAbac', PbFieldType.OM, LegacyAbac.getDefault, LegacyAbac.create)
  ...
  set labelFingerprint(String v) { $_setString(15, v); }
...
class ClusterUpdate extends GeneratedMessage {
  ...
  set desiredMasterVersion(String v) { $_setString(8, v); }
