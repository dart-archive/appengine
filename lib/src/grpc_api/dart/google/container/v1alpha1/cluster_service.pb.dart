...
class NodeConfig extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('NodeConfig')
    ...
    ..aOB(10, 'preemptible')
    ..pp<AcceleratorConfig>(11, 'accelerators', PbFieldType.PM, AcceleratorConfig.$checkItem, AcceleratorConfig.create)
    ..aOS(13, 'minCpuPlatform')
    ..pp<NodeTaint>(15, 'taints', PbFieldType.PM, NodeTaint.$checkItem, NodeTaint.create)
    ..hasRequiredFields = false
  ;
  ...
  set imageType(String v) { $_setString(4, v); }
  ...
  set localSsdCount(int v) { $_setSignedInt32(6, v); }
  ...
  set minCpuPlatform(String v) { $_setString(11, v); }
  bool hasMinCpuPlatform() => $_has(11);
  void clearMinCpuPlatform() => clearField(13);

  List<NodeTaint> get taints => $_getList(12);
}
...
class NodeTaint extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('NodeTaint')
    ..aOS(1, 'key')
    ..aOS(2, 'value')
    ..e<NodeTaint_Effect>(3, 'effect', PbFieldType.OE, NodeTaint_Effect.EFFECT_UNSPECIFIED, NodeTaint_Effect.valueOf, NodeTaint_Effect.values)
    ..hasRequiredFields = false
  ;

  NodeTaint() : super();
  NodeTaint.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  NodeTaint.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ...
  static void $checkItem(NodeTaint v) {
    if (v is! NodeTaint) checkItemFailed(v, 'NodeTaint');
  }
...
class MasterAuth extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('MasterAuth')
    ..aOS(1, 'username')
    ..aOS(2, 'password')
    ..a<ClientCertificateConfig>(3, 'clientCertificateConfig', PbFieldType.OM, ClientCertificateConfig.getDefault, ClientCertificateConfig.create)
...
class ClientCertificateConfig extends GeneratedMessage {
  ...
  ClientCertificateConfig.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  ClientCertificateConfig.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ClientCertificateConfig clone() => new ClientCertificateConfig()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static ClientCertificateConfig create() => new ClientCertificateConfig();
  static PbList<ClientCertificateConfig> createRepeated() => new PbList<ClientCertificateConfig>();
  static ClientCertificateConfig getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyClientCertificateConfig();
    return _defaultInstance;
  }
  static ClientCertificateConfig _defaultInstance;
  static void $checkItem(ClientCertificateConfig v) {
    if (v is! ClientCertificateConfig) checkItemFailed(v, 'ClientCertificateConfig');
  }

  bool get issueClientCertificate => $_get(0, false);
  set issueClientCertificate(bool v) { $_setBool(0, v); }
  bool hasIssueClientCertificate() => $_has(0);
  void clearIssueClientCertificate() => clearField(1);
}

class _ReadonlyClientCertificateConfig extends ClientCertificateConfig with ReadonlyMessageMixin {}
...
class AddonsConfig extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('AddonsConfig')
    ...
    ..a<KubernetesDashboard>(3, 'kubernetesDashboard', PbFieldType.OM, KubernetesDashboard.getDefault, KubernetesDashboard.create)
    ..a<NetworkPolicyConfig>(4, 'networkPolicyConfig', PbFieldType.OM, NetworkPolicyConfig.getDefault, NetworkPolicyConfig.create)
    ..hasRequiredFields = false
  ;
...
class HttpLoadBalancing extends GeneratedMessage {
  ...
  set disabled(bool v) { $_setBool(0, v); }
...
class KubernetesDashboard extends GeneratedMessage {
  ...
  KubernetesDashboard.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  KubernetesDashboard.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  KubernetesDashboard clone() => new KubernetesDashboard()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static KubernetesDashboard create() => new KubernetesDashboard();
  static PbList<KubernetesDashboard> createRepeated() => new PbList<KubernetesDashboard>();
  static KubernetesDashboard getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyKubernetesDashboard();
    return _defaultInstance;
  }
...
class _ReadonlyKubernetesDashboard extends KubernetesDashboard with ReadonlyMessageMixin {}
...
class NetworkPolicyConfig extends GeneratedMessage {
  ...
  NetworkPolicyConfig.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  NetworkPolicyConfig.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  NetworkPolicyConfig clone() => new NetworkPolicyConfig()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static NetworkPolicyConfig create() => new NetworkPolicyConfig();
  static PbList<NetworkPolicyConfig> createRepeated() => new PbList<NetworkPolicyConfig>();
  static NetworkPolicyConfig getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyNetworkPolicyConfig();
    return _defaultInstance;
  }
...
class _ReadonlyNetworkPolicyConfig extends NetworkPolicyConfig with ReadonlyMessageMixin {}

class MasterAuthorizedNetworksConfig_CidrBlock extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('MasterAuthorizedNetworksConfig_CidrBlock')
    ..aOS(1, 'displayName')
    ..aOS(2, 'cidrBlock')
    ..hasRequiredFields = false
  ;
  ...
  MasterAuthorizedNetworksConfig_CidrBlock.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  MasterAuthorizedNetworksConfig_CidrBlock.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  MasterAuthorizedNetworksConfig_CidrBlock clone() => new MasterAuthorizedNetworksConfig_CidrBlock()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static MasterAuthorizedNetworksConfig_CidrBlock create() => new MasterAuthorizedNetworksConfig_CidrBlock();
  static PbList<MasterAuthorizedNetworksConfig_CidrBlock> createRepeated() => new PbList<MasterAuthorizedNetworksConfig_CidrBlock>();
  static MasterAuthorizedNetworksConfig_CidrBlock getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyMasterAuthorizedNetworksConfig_CidrBlock();
    return _defaultInstance;
  }
  ...
  static void $checkItem(MasterAuthorizedNetworksConfig_CidrBlock v) {
    if (v is! MasterAuthorizedNetworksConfig_CidrBlock) checkItemFailed(v, 'MasterAuthorizedNetworksConfig_CidrBlock');
  }
  ...
  set cidrBlock(String v) { $_setString(1, v); }
  bool hasCidrBlock() => $_has(1);
  void clearCidrBlock() => clearField(2);
}

class _ReadonlyMasterAuthorizedNetworksConfig_CidrBlock extends MasterAuthorizedNetworksConfig_CidrBlock with ReadonlyMessageMixin {}

class MasterAuthorizedNetworksConfig extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('MasterAuthorizedNetworksConfig')
    ..aOB(1, 'enabled')
    ..pp<MasterAuthorizedNetworksConfig_CidrBlock>(2, 'cidrBlocks', PbFieldType.PM, MasterAuthorizedNetworksConfig_CidrBlock.$checkItem, MasterAuthorizedNetworksConfig_CidrBlock.create)
    ..hasRequiredFields = false
  ;

  MasterAuthorizedNetworksConfig() : super();
  MasterAuthorizedNetworksConfig.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  MasterAuthorizedNetworksConfig.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  MasterAuthorizedNetworksConfig clone() => new MasterAuthorizedNetworksConfig()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static MasterAuthorizedNetworksConfig create() => new MasterAuthorizedNetworksConfig();
  static PbList<MasterAuthorizedNetworksConfig> createRepeated() => new PbList<MasterAuthorizedNetworksConfig>();
  static MasterAuthorizedNetworksConfig getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyMasterAuthorizedNetworksConfig();
    return _defaultInstance;
  }
  static MasterAuthorizedNetworksConfig _defaultInstance;
  static void $checkItem(MasterAuthorizedNetworksConfig v) {
    if (v is! MasterAuthorizedNetworksConfig) checkItemFailed(v, 'MasterAuthorizedNetworksConfig');
  }

  bool get enabled => $_get(0, false);
  set enabled(bool v) { $_setBool(0, v); }
...
class _ReadonlyMasterAuthorizedNetworksConfig extends MasterAuthorizedNetworksConfig with ReadonlyMessageMixin {}

class NetworkPolicy extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('NetworkPolicy')
    ..e<NetworkPolicy_Provider>(1, 'provider', PbFieldType.OE, NetworkPolicy_Provider.PROVIDER_UNSPECIFIED, NetworkPolicy_Provider.valueOf, NetworkPolicy_Provider.values)
    ..aOB(2, 'enabled')
    ..hasRequiredFields = false
  ;

  NetworkPolicy() : super();
  NetworkPolicy.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  NetworkPolicy.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ...
  static NetworkPolicy getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyNetworkPolicy();
    return _defaultInstance;
  }
...
class IPAllocationPolicy extends GeneratedMessage {
  ...
  IPAllocationPolicy.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  IPAllocationPolicy.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  IPAllocationPolicy clone() => new IPAllocationPolicy()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static IPAllocationPolicy create() => new IPAllocationPolicy();
  static PbList<IPAllocationPolicy> createRepeated() => new PbList<IPAllocationPolicy>();
  static IPAllocationPolicy getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyIPAllocationPolicy();
    return _defaultInstance;
  }
  ...
  set servicesSecondaryRangeName(String v) { $_setString(7, v); }
...
class PodSecurityPolicyConfig extends GeneratedMessage {
  ...
  PodSecurityPolicyConfig.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  PodSecurityPolicyConfig.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  PodSecurityPolicyConfig clone() => new PodSecurityPolicyConfig()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static PodSecurityPolicyConfig create() => new PodSecurityPolicyConfig();
  static PbList<PodSecurityPolicyConfig> createRepeated() => new PbList<PodSecurityPolicyConfig>();
  static PodSecurityPolicyConfig getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyPodSecurityPolicyConfig();
    return _defaultInstance;
  }
  static PodSecurityPolicyConfig _defaultInstance;
  static void $checkItem(PodSecurityPolicyConfig v) {
    if (v is! PodSecurityPolicyConfig) checkItemFailed(v, 'PodSecurityPolicyConfig');
  }
...
class _ReadonlyPodSecurityPolicyConfig extends PodSecurityPolicyConfig with ReadonlyMessageMixin {}
...
class Cluster extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('Cluster')
    ...
    ..a<NetworkPolicy>(19, 'networkPolicy', PbFieldType.OM, NetworkPolicy.getDefault, NetworkPolicy.create)
    ..a<IPAllocationPolicy>(20, 'ipAllocationPolicy', PbFieldType.OM, IPAllocationPolicy.getDefault, IPAllocationPolicy.create)
    ..a<MasterAuthorizedNetworksConfig>(22, 'masterAuthorizedNetworksConfig', PbFieldType.OM, MasterAuthorizedNetworksConfig.getDefault, MasterAuthorizedNetworksConfig.create)
    ..a<MaintenancePolicy>(23, 'maintenancePolicy', PbFieldType.OM, MaintenancePolicy.getDefault, MaintenancePolicy.create)
    ..a<PodSecurityPolicyConfig>(25, 'podSecurityPolicyConfig', PbFieldType.OM, PodSecurityPolicyConfig.getDefault, PodSecurityPolicyConfig.create)
    ..aOS(100, 'selfLink')
    ..aOS(101, 'zone')
    ..aOS(102, 'endpoint')
    ...
    ..aOS(106, 'createTime')
    ..e<Cluster_Status>(107, 'status', PbFieldType.OE, Cluster_Status.STATUS_UNSPECIFIED, Cluster_Status.valueOf, Cluster_Status.values)
  ...
  set initialNodeCount(int v) { $_setSignedInt32(2, v); }
  ...
  set subnetwork(String v) { $_setString(10, v); }
  ...
  set enableKubernetesAlpha(bool v) { $_setBool(13, v); }
  ...
  bool hasIpAllocationPolicy() => $_has(15);
  ...
  bool hasMasterAuthorizedNetworksConfig() => $_has(16);
  ...
  bool hasMaintenancePolicy() => $_has(17);
  ...
  bool hasPodSecurityPolicyConfig() => $_has(18);
  void clearPodSecurityPolicyConfig() => clearField(25);

  String get selfLink => $_getS(19, '');
  set selfLink(String v) { $_setString(19, v); }
  bool hasSelfLink() => $_has(19);
  void clearSelfLink() => clearField(100);

  String get zone => $_getS(20, '');
  set zone(String v) { $_setString(20, v); }
  bool hasZone() => $_has(20);
  void clearZone() => clearField(101);

  String get endpoint => $_getS(21, '');
  set endpoint(String v) { $_setString(21, v); }
  bool hasEndpoint() => $_has(21);
  void clearEndpoint() => clearField(102);

  String get initialClusterVersion => $_getS(22, '');
  set initialClusterVersion(String v) { $_setString(22, v); }
  bool hasInitialClusterVersion() => $_has(22);
  void clearInitialClusterVersion() => clearField(103);

  String get currentMasterVersion => $_getS(23, '');
  set currentMasterVersion(String v) { $_setString(23, v); }
  bool hasCurrentMasterVersion() => $_has(23);
  void clearCurrentMasterVersion() => clearField(104);

  String get currentNodeVersion => $_getS(24, '');
  set currentNodeVersion(String v) { $_setString(24, v); }
  bool hasCurrentNodeVersion() => $_has(24);
  void clearCurrentNodeVersion() => clearField(105);

  String get createTime => $_getS(25, '');
  set createTime(String v) { $_setString(25, v); }
  bool hasCreateTime() => $_has(25);
  void clearCreateTime() => clearField(106);

  Cluster_Status get status => $_getN(26);
  set status(Cluster_Status v) { setField(107, v); }
  bool hasStatus() => $_has(26);
  void clearStatus() => clearField(107);

  String get statusMessage => $_getS(27, '');
  set statusMessage(String v) { $_setString(27, v); }
  bool hasStatusMessage() => $_has(27);
  void clearStatusMessage() => clearField(108);

  int get nodeIpv4CidrSize => $_get(28, 0);
  set nodeIpv4CidrSize(int v) { $_setSignedInt32(28, v); }
  bool hasNodeIpv4CidrSize() => $_has(28);
  void clearNodeIpv4CidrSize() => clearField(109);

  String get servicesIpv4Cidr => $_getS(29, '');
  set servicesIpv4Cidr(String v) { $_setString(29, v); }
  bool hasServicesIpv4Cidr() => $_has(29);
  void clearServicesIpv4Cidr() => clearField(110);

  List<String> get instanceGroupUrls => $_getList(30);

  int get currentNodeCount => $_get(31, 0);
  set currentNodeCount(int v) { $_setSignedInt32(31, v); }
  bool hasCurrentNodeCount() => $_has(31);
  void clearCurrentNodeCount() => clearField(112);

  String get expireTime => $_getS(32, '');
  set expireTime(String v) { $_setString(32, v); }
  bool hasExpireTime() => $_has(32);
  void clearExpireTime() => clearField(113);

  String get location => $_getS(33, '');
  set location(String v) { $_setString(33, v); }
  bool hasLocation() => $_has(33);
...
class ClusterUpdate extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('ClusterUpdate')
    ...
    ..a<MasterAuthorizedNetworksConfig>(12, 'desiredMasterAuthorizedNetworksConfig', PbFieldType.OM, MasterAuthorizedNetworksConfig.getDefault, MasterAuthorizedNetworksConfig.create)
    ..a<PodSecurityPolicyConfig>(14, 'desiredPodSecurityPolicyConfig', PbFieldType.OM, PodSecurityPolicyConfig.getDefault, PodSecurityPolicyConfig.create)
  ...
  bool hasDesiredPodSecurityPolicyConfig() => $_has(8);
  void clearDesiredPodSecurityPolicyConfig() => clearField(14);

  String get desiredMasterVersion => $_getS(9, '');
  set desiredMasterVersion(String v) { $_setString(9, v); }
  bool hasDesiredMasterVersion() => $_has(9);
...
class Operation extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('Operation')
    ..aOS(1, 'name')
    ..aOS(2, 'zone')
    ..e<Operation_Type>(3, 'operationType', PbFieldType.OE, Operation_Type.TYPE_UNSPECIFIED, Operation_Type.valueOf, Operation_Type.values)
    ..e<Operation_Status>(4, 'status', PbFieldType.OE, Operation_Status.STATUS_UNSPECIFIED, Operation_Status.valueOf, Operation_Status.values)
    ..aOS(5, 'statusMessage')
    ..aOS(6, 'selfLink')
    ..aOS(7, 'targetLink')
    ..aOS(8, 'detail')
  ...
  String get endTime => $_getS(10, '');
  set endTime(String v) { $_setString(10, v); }
  bool hasEndTime() => $_has(10);
...
class GetClusterRequest extends GeneratedMessage {
  ...
  set clusterId(String v) { $_setString(2, v); }
...
class UpdateNodePoolRequest extends GeneratedMessage {
  ...
  UpdateNodePoolRequest.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  UpdateNodePoolRequest.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  UpdateNodePoolRequest clone() => new UpdateNodePoolRequest()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static UpdateNodePoolRequest create() => new UpdateNodePoolRequest();
  static PbList<UpdateNodePoolRequest> createRepeated() => new PbList<UpdateNodePoolRequest>();
  static UpdateNodePoolRequest getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyUpdateNodePoolRequest();
    return _defaultInstance;
  }
  static UpdateNodePoolRequest _defaultInstance;
  static void $checkItem(UpdateNodePoolRequest v) {
    if (v is! UpdateNodePoolRequest) checkItemFailed(v, 'UpdateNodePoolRequest');
  }
...
class _ReadonlyUpdateNodePoolRequest extends UpdateNodePoolRequest with ReadonlyMessageMixin {}
...
class SetNodePoolAutoscalingRequest extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('SetNodePoolAutoscalingRequest')
    ...
    ..aOS(3, 'clusterId')
    ..aOS(4, 'nodePoolId')
    ..a<NodePoolAutoscaling>(5, 'autoscaling', PbFieldType.OM, NodePoolAutoscaling.getDefault, NodePoolAutoscaling.create)
    ..aOS(6, 'name')
    ..hasRequiredFields = false
  ;

  SetNodePoolAutoscalingRequest() : super();
  SetNodePoolAutoscalingRequest.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  SetNodePoolAutoscalingRequest.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  SetNodePoolAutoscalingRequest clone() => new SetNodePoolAutoscalingRequest()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static SetNodePoolAutoscalingRequest create() => new SetNodePoolAutoscalingRequest();
  static PbList<SetNodePoolAutoscalingRequest> createRepeated() => new PbList<SetNodePoolAutoscalingRequest>();
  static SetNodePoolAutoscalingRequest getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlySetNodePoolAutoscalingRequest();
    return _defaultInstance;
  }
  static SetNodePoolAutoscalingRequest _defaultInstance;
  static void $checkItem(SetNodePoolAutoscalingRequest v) {
    if (v is! SetNodePoolAutoscalingRequest) checkItemFailed(v, 'SetNodePoolAutoscalingRequest');
  }
...
class _ReadonlySetNodePoolAutoscalingRequest extends SetNodePoolAutoscalingRequest with ReadonlyMessageMixin {}
...
class SetLoggingServiceRequest extends GeneratedMessage {
  ...
  SetLoggingServiceRequest.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  SetLoggingServiceRequest.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  SetLoggingServiceRequest clone() => new SetLoggingServiceRequest()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static SetLoggingServiceRequest create() => new SetLoggingServiceRequest();
  static PbList<SetLoggingServiceRequest> createRepeated() => new PbList<SetLoggingServiceRequest>();
  static SetLoggingServiceRequest getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlySetLoggingServiceRequest();
    return _defaultInstance;
  }
  static SetLoggingServiceRequest _defaultInstance;
  static void $checkItem(SetLoggingServiceRequest v) {
    if (v is! SetLoggingServiceRequest) checkItemFailed(v, 'SetLoggingServiceRequest');
  }
  ...
  set loggingService(String v) { $_setString(3, v); }
...
class _ReadonlySetLoggingServiceRequest extends SetLoggingServiceRequest with ReadonlyMessageMixin {}
...
class SetMonitoringServiceRequest extends GeneratedMessage {
  ...
  SetMonitoringServiceRequest.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  SetMonitoringServiceRequest.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  SetMonitoringServiceRequest clone() => new SetMonitoringServiceRequest()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static SetMonitoringServiceRequest create() => new SetMonitoringServiceRequest();
  static PbList<SetMonitoringServiceRequest> createRepeated() => new PbList<SetMonitoringServiceRequest>();
  static SetMonitoringServiceRequest getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlySetMonitoringServiceRequest();
    return _defaultInstance;
  }
  static SetMonitoringServiceRequest _defaultInstance;
  static void $checkItem(SetMonitoringServiceRequest v) {
    if (v is! SetMonitoringServiceRequest) checkItemFailed(v, 'SetMonitoringServiceRequest');
  }
  ...
  set monitoringService(String v) { $_setString(3, v); }
...
class _ReadonlySetMonitoringServiceRequest extends SetMonitoringServiceRequest with ReadonlyMessageMixin {}
...
class SetAddonsConfigRequest extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('SetAddonsConfigRequest')
    ...
    ..aOS(2, 'zone')
    ..aOS(3, 'clusterId')
    ..a<AddonsConfig>(4, 'addonsConfig', PbFieldType.OM, AddonsConfig.getDefault, AddonsConfig.create)
    ..aOS(6, 'name')
    ..hasRequiredFields = false
  ;

  SetAddonsConfigRequest() : super();
  SetAddonsConfigRequest.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  SetAddonsConfigRequest.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  SetAddonsConfigRequest clone() => new SetAddonsConfigRequest()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static SetAddonsConfigRequest create() => new SetAddonsConfigRequest();
  static PbList<SetAddonsConfigRequest> createRepeated() => new PbList<SetAddonsConfigRequest>();
  static SetAddonsConfigRequest getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlySetAddonsConfigRequest();
    return _defaultInstance;
  }
  static SetAddonsConfigRequest _defaultInstance;
  static void $checkItem(SetAddonsConfigRequest v) {
    if (v is! SetAddonsConfigRequest) checkItemFailed(v, 'SetAddonsConfigRequest');
  }
...
class _ReadonlySetAddonsConfigRequest extends SetAddonsConfigRequest with ReadonlyMessageMixin {}
...
class SetLocationsRequest extends GeneratedMessage {
  ...
  SetLocationsRequest.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  SetLocationsRequest.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  SetLocationsRequest clone() => new SetLocationsRequest()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static SetLocationsRequest create() => new SetLocationsRequest();
  static PbList<SetLocationsRequest> createRepeated() => new PbList<SetLocationsRequest>();
  static SetLocationsRequest getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlySetLocationsRequest();
    return _defaultInstance;
  }
...
class _ReadonlySetLocationsRequest extends SetLocationsRequest with ReadonlyMessageMixin {}
...
class UpdateMasterRequest extends GeneratedMessage {
  ...
  UpdateMasterRequest.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  UpdateMasterRequest.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  UpdateMasterRequest clone() => new UpdateMasterRequest()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static UpdateMasterRequest create() => new UpdateMasterRequest();
  static PbList<UpdateMasterRequest> createRepeated() => new PbList<UpdateMasterRequest>();
  static UpdateMasterRequest getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyUpdateMasterRequest();
    return _defaultInstance;
  }
  ...
  set masterVersion(String v) { $_setString(3, v); }
...
class _ReadonlyUpdateMasterRequest extends UpdateMasterRequest with ReadonlyMessageMixin {}
...
class SetMasterAuthRequest extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('SetMasterAuthRequest')
    ...
    ..aOS(2, 'zone')
    ..aOS(3, 'clusterId')
    ..e<SetMasterAuthRequest_Action>(4, 'action', PbFieldType.OE, SetMasterAuthRequest_Action.UNKNOWN, SetMasterAuthRequest_Action.valueOf, SetMasterAuthRequest_Action.values)
    ..a<MasterAuth>(5, 'update', PbFieldType.OM, MasterAuth.getDefault, MasterAuth.create)
    ..aOS(7, 'name')
    ..hasRequiredFields = false
  ;

  SetMasterAuthRequest() : super();
  SetMasterAuthRequest.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  SetMasterAuthRequest.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  SetMasterAuthRequest clone() => new SetMasterAuthRequest()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static SetMasterAuthRequest create() => new SetMasterAuthRequest();
  static PbList<SetMasterAuthRequest> createRepeated() => new PbList<SetMasterAuthRequest>();
  static SetMasterAuthRequest getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlySetMasterAuthRequest();
    return _defaultInstance;
  }
...
class _ReadonlySetMasterAuthRequest extends SetMasterAuthRequest with ReadonlyMessageMixin {}
...
class ServerConfig extends GeneratedMessage {
  ...
  set defaultClusterVersion(String v) { $_setString(0, v); }
  ...
  set defaultImageType(String v) { $_setString(2, v); }
...
class NodePool extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('NodePool')
    ...
    ..e<NodePool_Status>(103, 'status', PbFieldType.OE, NodePool_Status.STATUS_UNSPECIFIED, NodePool_Status.valueOf, NodePool_Status.values)
  ...
  set statusMessage(String v) { $_setString(9, v); }
...
class AutoUpgradeOptions extends GeneratedMessage {
  ...
  set autoUpgradeStartTime(String v) { $_setString(0, v); }
...
class MaintenancePolicy extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('MaintenancePolicy')
    ..a<MaintenanceWindow>(1, 'window', PbFieldType.OM, MaintenanceWindow.getDefault, MaintenanceWindow.create)
    ..hasRequiredFields = false
  ;

  MaintenancePolicy() : super();
  MaintenancePolicy.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  MaintenancePolicy.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  MaintenancePolicy clone() => new MaintenancePolicy()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static MaintenancePolicy create() => new MaintenancePolicy();
  static PbList<MaintenancePolicy> createRepeated() => new PbList<MaintenancePolicy>();
  static MaintenancePolicy getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyMaintenancePolicy();
    return _defaultInstance;
  }
...
class _ReadonlyMaintenancePolicy extends MaintenancePolicy with ReadonlyMessageMixin {}

class MaintenanceWindow extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('MaintenanceWindow')
    ..a<DailyMaintenanceWindow>(2, 'dailyMaintenanceWindow', PbFieldType.OM, DailyMaintenanceWindow.getDefault, DailyMaintenanceWindow.create)
    ..hasRequiredFields = false
  ;

  MaintenanceWindow() : super();
  MaintenanceWindow.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  MaintenanceWindow.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  MaintenanceWindow clone() => new MaintenanceWindow()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static MaintenanceWindow create() => new MaintenanceWindow();
  static PbList<MaintenanceWindow> createRepeated() => new PbList<MaintenanceWindow>();
  static MaintenanceWindow getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyMaintenanceWindow();
    return _defaultInstance;
  }
...
class _ReadonlyMaintenanceWindow extends MaintenanceWindow with ReadonlyMessageMixin {}
...
class DailyMaintenanceWindow extends GeneratedMessage {
  ...
  DailyMaintenanceWindow.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  DailyMaintenanceWindow.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  DailyMaintenanceWindow clone() => new DailyMaintenanceWindow()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static DailyMaintenanceWindow create() => new DailyMaintenanceWindow();
  static PbList<DailyMaintenanceWindow> createRepeated() => new PbList<DailyMaintenanceWindow>();
  static DailyMaintenanceWindow getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyDailyMaintenanceWindow();
    return _defaultInstance;
  }
  static DailyMaintenanceWindow _defaultInstance;
  static void $checkItem(DailyMaintenanceWindow v) {
    if (v is! DailyMaintenanceWindow) checkItemFailed(v, 'DailyMaintenanceWindow');
  }

  String get startTime => $_getS(0, '');
  set startTime(String v) { $_setString(0, v); }
  bool hasStartTime() => $_has(0);
  void clearStartTime() => clearField(2);

  String get duration => $_getS(1, '');
  set duration(String v) { $_setString(1, v); }
  bool hasDuration() => $_has(1);
  void clearDuration() => clearField(3);
}

class _ReadonlyDailyMaintenanceWindow extends DailyMaintenanceWindow with ReadonlyMessageMixin {}
...
class SetNodePoolSizeRequest extends GeneratedMessage {
  ...
  SetNodePoolSizeRequest.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  SetNodePoolSizeRequest.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  SetNodePoolSizeRequest clone() => new SetNodePoolSizeRequest()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static SetNodePoolSizeRequest create() => new SetNodePoolSizeRequest();
  static PbList<SetNodePoolSizeRequest> createRepeated() => new PbList<SetNodePoolSizeRequest>();
  static SetNodePoolSizeRequest getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlySetNodePoolSizeRequest();
    return _defaultInstance;
  }
  static SetNodePoolSizeRequest _defaultInstance;
  static void $checkItem(SetNodePoolSizeRequest v) {
    if (v is! SetNodePoolSizeRequest) checkItemFailed(v, 'SetNodePoolSizeRequest');
  }
  ...
  set nodeCount(int v) { $_setSignedInt32(4, v); }
...
class _ReadonlySetNodePoolSizeRequest extends SetNodePoolSizeRequest with ReadonlyMessageMixin {}
...
class SetLabelsRequest_ResourceLabelsEntry extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('SetLabelsRequest_ResourceLabelsEntry')
    ..aOS(1, 'key')
    ..aOS(2, 'value')
    ..hasRequiredFields = false
  ;
  ...
  SetLabelsRequest_ResourceLabelsEntry.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  SetLabelsRequest_ResourceLabelsEntry.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  SetLabelsRequest_ResourceLabelsEntry clone() => new SetLabelsRequest_ResourceLabelsEntry()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static SetLabelsRequest_ResourceLabelsEntry create() => new SetLabelsRequest_ResourceLabelsEntry();
  static PbList<SetLabelsRequest_ResourceLabelsEntry> createRepeated() => new PbList<SetLabelsRequest_ResourceLabelsEntry>();
  static SetLabelsRequest_ResourceLabelsEntry getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlySetLabelsRequest_ResourceLabelsEntry();
    return _defaultInstance;
  }
  static SetLabelsRequest_ResourceLabelsEntry _defaultInstance;
  static void $checkItem(SetLabelsRequest_ResourceLabelsEntry v) {
    if (v is! SetLabelsRequest_ResourceLabelsEntry) checkItemFailed(v, 'SetLabelsRequest_ResourceLabelsEntry');
  }
...
class _ReadonlySetLabelsRequest_ResourceLabelsEntry extends SetLabelsRequest_ResourceLabelsEntry with ReadonlyMessageMixin {}
...
class SetLabelsRequest extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('SetLabelsRequest')
    ...
    ..aOS(2, 'zone')
    ..aOS(3, 'clusterId')
    ..pp<SetLabelsRequest_ResourceLabelsEntry>(4, 'resourceLabels', PbFieldType.PM, SetLabelsRequest_ResourceLabelsEntry.$checkItem, SetLabelsRequest_ResourceLabelsEntry.create)
  ...
  SetLabelsRequest.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  SetLabelsRequest.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  SetLabelsRequest clone() => new SetLabelsRequest()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static SetLabelsRequest create() => new SetLabelsRequest();
  static PbList<SetLabelsRequest> createRepeated() => new PbList<SetLabelsRequest>();
  static SetLabelsRequest getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlySetLabelsRequest();
    return _defaultInstance;
  }
  ...
  set labelFingerprint(String v) { $_setString(4, v); }
...
class _ReadonlySetLabelsRequest extends SetLabelsRequest with ReadonlyMessageMixin {}
...
class SetLegacyAbacRequest extends GeneratedMessage {
  ...
  SetLegacyAbacRequest.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  SetLegacyAbacRequest.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  SetLegacyAbacRequest clone() => new SetLegacyAbacRequest()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static SetLegacyAbacRequest create() => new SetLegacyAbacRequest();
  static PbList<SetLegacyAbacRequest> createRepeated() => new PbList<SetLegacyAbacRequest>();
  static SetLegacyAbacRequest getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlySetLegacyAbacRequest();
    return _defaultInstance;
  }
  ...
  set enabled(bool v) { $_setBool(3, v); }
...
class _ReadonlySetLegacyAbacRequest extends SetLegacyAbacRequest with ReadonlyMessageMixin {}
...
class StartIPRotationRequest extends GeneratedMessage {
  ...
  StartIPRotationRequest.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  StartIPRotationRequest.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  StartIPRotationRequest clone() => new StartIPRotationRequest()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static StartIPRotationRequest create() => new StartIPRotationRequest();
  static PbList<StartIPRotationRequest> createRepeated() => new PbList<StartIPRotationRequest>();
  static StartIPRotationRequest getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyStartIPRotationRequest();
    return _defaultInstance;
  }
  static StartIPRotationRequest _defaultInstance;
  static void $checkItem(StartIPRotationRequest v) {
    if (v is! StartIPRotationRequest) checkItemFailed(v, 'StartIPRotationRequest');
  }
...
class _ReadonlyStartIPRotationRequest extends StartIPRotationRequest with ReadonlyMessageMixin {}
...
class CompleteIPRotationRequest extends GeneratedMessage {
  ...
  CompleteIPRotationRequest.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  CompleteIPRotationRequest.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  CompleteIPRotationRequest clone() => new CompleteIPRotationRequest()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static CompleteIPRotationRequest create() => new CompleteIPRotationRequest();
  static PbList<CompleteIPRotationRequest> createRepeated() => new PbList<CompleteIPRotationRequest>();
  static CompleteIPRotationRequest getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyCompleteIPRotationRequest();
    return _defaultInstance;
  }
  static CompleteIPRotationRequest _defaultInstance;
  static void $checkItem(CompleteIPRotationRequest v) {
    if (v is! CompleteIPRotationRequest) checkItemFailed(v, 'CompleteIPRotationRequest');
  }
...
class _ReadonlyCompleteIPRotationRequest extends CompleteIPRotationRequest with ReadonlyMessageMixin {}
...
class AcceleratorConfig extends GeneratedMessage {
  ...
  AcceleratorConfig.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  AcceleratorConfig.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  AcceleratorConfig clone() => new AcceleratorConfig()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static AcceleratorConfig create() => new AcceleratorConfig();
  static PbList<AcceleratorConfig> createRepeated() => new PbList<AcceleratorConfig>();
  static AcceleratorConfig getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyAcceleratorConfig();
    return _defaultInstance;
  }
  ...
  set acceleratorType(String v) { $_setString(1, v); }
  bool hasAcceleratorType() => $_has(1);
  void clearAcceleratorType() => clearField(2);
}

class _ReadonlyAcceleratorConfig extends AcceleratorConfig with ReadonlyMessageMixin {}
...
class SetNetworkPolicyRequest extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('SetNetworkPolicyRequest')
    ...
    ..aOS(2, 'zone')
    ..aOS(3, 'clusterId')
    ..a<NetworkPolicy>(4, 'networkPolicy', PbFieldType.OM, NetworkPolicy.getDefault, NetworkPolicy.create)
    ..aOS(6, 'name')
    ..hasRequiredFields = false
  ;

  SetNetworkPolicyRequest() : super();
  SetNetworkPolicyRequest.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  SetNetworkPolicyRequest.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  SetNetworkPolicyRequest clone() => new SetNetworkPolicyRequest()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static SetNetworkPolicyRequest create() => new SetNetworkPolicyRequest();
  static PbList<SetNetworkPolicyRequest> createRepeated() => new PbList<SetNetworkPolicyRequest>();
  static SetNetworkPolicyRequest getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlySetNetworkPolicyRequest();
    return _defaultInstance;
  }
  static SetNetworkPolicyRequest _defaultInstance;
  static void $checkItem(SetNetworkPolicyRequest v) {
    if (v is! SetNetworkPolicyRequest) checkItemFailed(v, 'SetNetworkPolicyRequest');
  }
...
class _ReadonlySetNetworkPolicyRequest extends SetNetworkPolicyRequest with ReadonlyMessageMixin {}
...
class SetMaintenancePolicyRequest extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('SetMaintenancePolicyRequest')
    ...
    ..aOS(2, 'zone')
    ..aOS(3, 'clusterId')
    ..a<MaintenancePolicy>(4, 'maintenancePolicy', PbFieldType.OM, MaintenancePolicy.getDefault, MaintenancePolicy.create)
    ..aOS(5, 'name')
    ..hasRequiredFields = false
  ;

  SetMaintenancePolicyRequest() : super();
  SetMaintenancePolicyRequest.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  SetMaintenancePolicyRequest.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  SetMaintenancePolicyRequest clone() => new SetMaintenancePolicyRequest()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static SetMaintenancePolicyRequest create() => new SetMaintenancePolicyRequest();
  static PbList<SetMaintenancePolicyRequest> createRepeated() => new PbList<SetMaintenancePolicyRequest>();
  static SetMaintenancePolicyRequest getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlySetMaintenancePolicyRequest();
    return _defaultInstance;
  }
  static SetMaintenancePolicyRequest _defaultInstance;
  static void $checkItem(SetMaintenancePolicyRequest v) {
    if (v is! SetMaintenancePolicyRequest) checkItemFailed(v, 'SetMaintenancePolicyRequest');
  }
...
class _ReadonlySetMaintenancePolicyRequest extends SetMaintenancePolicyRequest with ReadonlyMessageMixin {}
...
class ClusterManagerApi {
  ...
  Future<Operation> updateNodePool(ClientContext ctx, UpdateNodePoolRequest request) {
    var emptyResponse = new Operation();
    return _client.invoke<Operation>(ctx, 'ClusterManager', 'UpdateNodePool', request, emptyResponse);
  }
  Future<Operation> setNodePoolAutoscaling(ClientContext ctx, SetNodePoolAutoscalingRequest request) {
    var emptyResponse = new Operation();
    return _client.invoke<Operation>(ctx, 'ClusterManager', 'SetNodePoolAutoscaling', request, emptyResponse);
  }
  Future<Operation> setLoggingService(ClientContext ctx, SetLoggingServiceRequest request) {
    var emptyResponse = new Operation();
    return _client.invoke<Operation>(ctx, 'ClusterManager', 'SetLoggingService', request, emptyResponse);
  }
  Future<Operation> setMonitoringService(ClientContext ctx, SetMonitoringServiceRequest request) {
    var emptyResponse = new Operation();
    return _client.invoke<Operation>(ctx, 'ClusterManager', 'SetMonitoringService', request, emptyResponse);
  }
  Future<Operation> setAddonsConfig(ClientContext ctx, SetAddonsConfigRequest request) {
    var emptyResponse = new Operation();
    return _client.invoke<Operation>(ctx, 'ClusterManager', 'SetAddonsConfig', request, emptyResponse);
  }
  Future<Operation> setLocations(ClientContext ctx, SetLocationsRequest request) {
    var emptyResponse = new Operation();
    return _client.invoke<Operation>(ctx, 'ClusterManager', 'SetLocations', request, emptyResponse);
  }
  Future<Operation> updateMaster(ClientContext ctx, UpdateMasterRequest request) {
    var emptyResponse = new Operation();
    return _client.invoke<Operation>(ctx, 'ClusterManager', 'UpdateMaster', request, emptyResponse);
  }
  Future<Operation> setMasterAuth(ClientContext ctx, SetMasterAuthRequest request) {
    var emptyResponse = new Operation();
  ...
  Future<$google$protobuf.Empty> cancelOperation(ClientContext ctx, CancelOperationRequest request) {
    ...
    return _client.invoke<$google$protobuf.Empty>(ctx, 'ClusterManager', 'CancelOperation', request, emptyResponse);
  }
  ...
  Future<Operation> setLegacyAbac(ClientContext ctx, SetLegacyAbacRequest request) {
    var emptyResponse = new Operation();
    return _client.invoke<Operation>(ctx, 'ClusterManager', 'SetLegacyAbac', request, emptyResponse);
  }
  Future<Operation> startIPRotation(ClientContext ctx, StartIPRotationRequest request) {
    var emptyResponse = new Operation();
    return _client.invoke<Operation>(ctx, 'ClusterManager', 'StartIPRotation', request, emptyResponse);
  }
  Future<Operation> completeIPRotation(ClientContext ctx, CompleteIPRotationRequest request) {
    var emptyResponse = new Operation();
    return _client.invoke<Operation>(ctx, 'ClusterManager', 'CompleteIPRotation', request, emptyResponse);
  }
  Future<Operation> setNodePoolSize(ClientContext ctx, SetNodePoolSizeRequest request) {
    var emptyResponse = new Operation();
    return _client.invoke<Operation>(ctx, 'ClusterManager', 'SetNodePoolSize', request, emptyResponse);
  }
  Future<Operation> setNetworkPolicy(ClientContext ctx, SetNetworkPolicyRequest request) {
    var emptyResponse = new Operation();
    return _client.invoke<Operation>(ctx, 'ClusterManager', 'SetNetworkPolicy', request, emptyResponse);
  }
  Future<Operation> setMaintenancePolicy(ClientContext ctx, SetMaintenancePolicyRequest request) {
    var emptyResponse = new Operation();
