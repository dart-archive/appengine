...
class NodeConfig extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('NodeConfig')
    ...
    ..pp<NodeTaint>(
        15, 'taints', PbFieldType.PM, NodeTaint.$checkItem, NodeTaint.create)
    ..hasRequiredFields = false;
...
class NodeTaint extends GeneratedMessage {
  ...
  NodeTaint() : super();
  NodeTaint.fromBuffer(List<int> i,
      [ExtensionRegistry r = ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);
...
class PodSecurityPolicyConfig extends GeneratedMessage {
  ...
  PodSecurityPolicyConfig.fromBuffer(List<int> i,
      [ExtensionRegistry r = ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);
  PodSecurityPolicyConfig.fromJson(String i,
      [ExtensionRegistry r = ExtensionRegistry.EMPTY])
      : super.fromJson(i, r);
  ...
  static void $checkItem(PodSecurityPolicyConfig v) {
    if (v is! PodSecurityPolicyConfig)
      checkItemFailed(v, 'PodSecurityPolicyConfig');
  }
...
class _ReadonlyPodSecurityPolicyConfig extends PodSecurityPolicyConfig
    with ReadonlyMessageMixin {}
...
class Cluster extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('Cluster')
    ...
    ..a<PodSecurityPolicyConfig>(25, 'podSecurityPolicyConfig', PbFieldType.OM,
        PodSecurityPolicyConfig.getDefault, PodSecurityPolicyConfig.create)
    ..aOS(100, 'selfLink')
    ..aOS(101, 'zone')
    ..aOS(102, 'endpoint')
