...
abstract class ClusterManagerServiceBase extends GeneratedService {
  ...
  Future<Operation> updateNodePool(ServerContext ctx, UpdateNodePoolRequest request);
  Future<Operation> setNodePoolAutoscaling(ServerContext ctx, SetNodePoolAutoscalingRequest request);
  Future<Operation> setLoggingService(ServerContext ctx, SetLoggingServiceRequest request);
  Future<Operation> setMonitoringService(ServerContext ctx, SetMonitoringServiceRequest request);
  Future<Operation> setAddonsConfig(ServerContext ctx, SetAddonsConfigRequest request);
  Future<Operation> setLocations(ServerContext ctx, SetLocationsRequest request);
  Future<Operation> updateMaster(ServerContext ctx, UpdateMasterRequest request);
  ...
  Future<Operation> setNodePoolSize(ServerContext ctx, SetNodePoolSizeRequest request);
  ...
  GeneratedMessage createRequest(String method) {
    switch (method) {
      ...
      case 'UpdateNodePool': return new UpdateNodePoolRequest();
      case 'SetNodePoolAutoscaling': return new SetNodePoolAutoscalingRequest();
      case 'SetLoggingService': return new SetLoggingServiceRequest();
      case 'SetMonitoringService': return new SetMonitoringServiceRequest();
      case 'SetAddonsConfig': return new SetAddonsConfigRequest();
      case 'SetLocations': return new SetLocationsRequest();
      case 'UpdateMaster': return new UpdateMasterRequest();
      ...
      case 'SetNodePoolSize': return new SetNodePoolSizeRequest();
