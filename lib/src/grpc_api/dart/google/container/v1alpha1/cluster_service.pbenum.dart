...
class NodeTaint_Effect extends ProtobufEnum {
  static const NodeTaint_Effect EFFECT_UNSPECIFIED = const NodeTaint_Effect._(0, 'EFFECT_UNSPECIFIED');
  static const NodeTaint_Effect NO_SCHEDULE = const NodeTaint_Effect._(1, 'NO_SCHEDULE');
  static const NodeTaint_Effect PREFER_NO_SCHEDULE = const NodeTaint_Effect._(2, 'PREFER_NO_SCHEDULE');
  static const NodeTaint_Effect NO_EXECUTE = const NodeTaint_Effect._(3, 'NO_EXECUTE');
  ...
  static NodeTaint_Effect valueOf(int value) => _byValue[value] as NodeTaint_Effect;
...
class NetworkPolicy_Provider extends ProtobufEnum {
  static const NetworkPolicy_Provider PROVIDER_UNSPECIFIED = const NetworkPolicy_Provider._(0, 'PROVIDER_UNSPECIFIED');
  static const NetworkPolicy_Provider CALICO = const NetworkPolicy_Provider._(1, 'CALICO');

  static const List<NetworkPolicy_Provider> values = const <NetworkPolicy_Provider> [
    PROVIDER_UNSPECIFIED,
    CALICO,
  ];

  static final Map<int, dynamic> _byValue = ProtobufEnum.initByValue(values);
  static NetworkPolicy_Provider valueOf(int value) => _byValue[value] as NetworkPolicy_Provider;
  static void $checkItem(NetworkPolicy_Provider v) {
    if (v is! NetworkPolicy_Provider) checkItemFailed(v, 'NetworkPolicy_Provider');
  }
...
class Operation_Type extends ProtobufEnum {
  ...
  static const Operation_Type AUTO_REPAIR_NODES = const Operation_Type._(10, 'AUTO_REPAIR_NODES');
  static const Operation_Type AUTO_UPGRADE_NODES = const Operation_Type._(11, 'AUTO_UPGRADE_NODES');
  static const Operation_Type SET_LABELS = const Operation_Type._(12, 'SET_LABELS');
  static const Operation_Type SET_MASTER_AUTH = const Operation_Type._(13, 'SET_MASTER_AUTH');
  static const Operation_Type SET_NODE_POOL_SIZE = const Operation_Type._(14, 'SET_NODE_POOL_SIZE');
  static const Operation_Type SET_NETWORK_POLICY = const Operation_Type._(15, 'SET_NETWORK_POLICY');
  static const Operation_Type SET_MAINTENANCE_POLICY = const Operation_Type._(16, 'SET_MAINTENANCE_POLICY');
...
class SetMasterAuthRequest_Action extends ProtobufEnum {
  static const SetMasterAuthRequest_Action UNKNOWN = const SetMasterAuthRequest_Action._(0, 'UNKNOWN');
  static const SetMasterAuthRequest_Action SET_PASSWORD = const SetMasterAuthRequest_Action._(1, 'SET_PASSWORD');
  static const SetMasterAuthRequest_Action GENERATE_PASSWORD = const SetMasterAuthRequest_Action._(2, 'GENERATE_PASSWORD');
  static const SetMasterAuthRequest_Action SET_USERNAME = const SetMasterAuthRequest_Action._(3, 'SET_USERNAME');

  static const List<SetMasterAuthRequest_Action> values = const <SetMasterAuthRequest_Action> [
    UNKNOWN,
    SET_PASSWORD,
    GENERATE_PASSWORD,
    SET_USERNAME,
  ...
  static final Map<int, dynamic> _byValue = ProtobufEnum.initByValue(values);
  static SetMasterAuthRequest_Action valueOf(int value) => _byValue[value] as SetMasterAuthRequest_Action;
  static void $checkItem(SetMasterAuthRequest_Action v) {
    if (v is! SetMasterAuthRequest_Action) checkItemFailed(v, 'SetMasterAuthRequest_Action');
  }
