...
class Documentation extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Documentation', package: const $pb.PackageName('google.api'))
    ..aOS(1, 'summary')
    ..aOS(2, 'overview')
    ..pc<DocumentationRule>(3, 'rules', $pb.PbFieldType.PM,DocumentationRule.create)
  ...
  Documentation() : super();
  Documentation.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  Documentation.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  Documentation clone() => Documentation()..mergeFromMessage(this);
  Documentation copyWith(void Function(Documentation) updates) => super.copyWith((message) => updates(message as Documentation));
...
class DocumentationRule extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('DocumentationRule', package: const $pb.PackageName('google.api'))
    ..aOS(1, 'selector')
    ..aOS(2, 'description')
  ...
  DocumentationRule.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  DocumentationRule.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  DocumentationRule clone() => DocumentationRule()..mergeFromMessage(this);
  DocumentationRule copyWith(void Function(DocumentationRule) updates) => super.copyWith((message) => updates(message as DocumentationRule));
  $pb.BuilderInfo get info_ => _i;
  ...
  static DocumentationRule getDefault() => _defaultInstance ??= create()..freeze();
...
class Page extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Page', package: const $pb.PackageName('google.api'))
    ..aOS(1, 'name')
    ..aOS(2, 'content')
