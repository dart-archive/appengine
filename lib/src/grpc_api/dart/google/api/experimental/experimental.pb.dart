...
class Experimental extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Experimental',
      package: const $pb.PackageName('google.api'))
    ..a<$0.AuthorizationConfig>(8, 'authorization', $pb.PbFieldType.OM,
        $0.AuthorizationConfig.getDefault, $0.AuthorizationConfig.create)
    ..hasRequiredFields = false;

  Experimental() : super();
  Experimental.fromBuffer($core.List<$core.int> i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);
  Experimental.fromJson($core.String i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromJson(i, r);
  Experimental clone() => Experimental()..mergeFromMessage(this);
  Experimental copyWith(void Function(Experimental) updates) =>
      super.copyWith((message) => updates(message as Experimental));
  $pb.BuilderInfo get info_ => _i;
  static Experimental create() => Experimental();
  Experimental createEmptyInstance() => create();
  static $pb.PbList<Experimental> createRepeated() =>
      $pb.PbList<Experimental>();
  ...
  set authorization($0.AuthorizationConfig v) {
    setField(8, v);
  }
