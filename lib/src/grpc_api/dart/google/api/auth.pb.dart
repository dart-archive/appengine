...
class Authentication extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Authentication', package: const $pb.PackageName('google.api'))
    ..pc<AuthenticationRule>(3, 'rules', $pb.PbFieldType.PM,AuthenticationRule.create)
    ..pc<AuthProvider>(4, 'providers', $pb.PbFieldType.PM,AuthProvider.create)
    ..hasRequiredFields = false
  ;

  Authentication() : super();
  Authentication.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  Authentication.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  Authentication clone() => Authentication()..mergeFromMessage(this);
  Authentication copyWith(void Function(Authentication) updates) => super.copyWith((message) => updates(message as Authentication));
...
class AuthenticationRule extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('AuthenticationRule', package: const $pb.PackageName('google.api'))
    ..aOS(1, 'selector')
    ..a<OAuthRequirements>(2, 'oauth', $pb.PbFieldType.OM, OAuthRequirements.getDefault, OAuthRequirements.create)
    ..aOB(5, 'allowWithoutCredential')
    ..pc<AuthRequirement>(7, 'requirements', $pb.PbFieldType.PM,AuthRequirement.create)
    ..hasRequiredFields = false
  ;

  AuthenticationRule() : super();
  AuthenticationRule.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  AuthenticationRule.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  AuthenticationRule clone() => AuthenticationRule()..mergeFromMessage(this);
  AuthenticationRule copyWith(void Function(AuthenticationRule) updates) => super.copyWith((message) => updates(message as AuthenticationRule));
  $pb.BuilderInfo get info_ => _i;
  ...
  static AuthenticationRule getDefault() => _defaultInstance ??= create()..freeze();
...
class AuthProvider extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('AuthProvider', package: const $pb.PackageName('google.api'))
    ..aOS(1, 'id')
    ..aOS(2, 'issuer')
    ..aOS(3, 'jwksUri')
    ..aOS(4, 'audiences')
  ...
  AuthProvider() : super();
  AuthProvider.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  AuthProvider.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  AuthProvider clone() => AuthProvider()..mergeFromMessage(this);
  AuthProvider copyWith(void Function(AuthProvider) updates) => super.copyWith((message) => updates(message as AuthProvider));
  $pb.BuilderInfo get info_ => _i;
...
class OAuthRequirements extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('OAuthRequirements', package: const $pb.PackageName('google.api'))
    ..aOS(1, 'canonicalScopes')
    ..hasRequiredFields = false
  ;

  OAuthRequirements() : super();
  OAuthRequirements.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  OAuthRequirements.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  OAuthRequirements clone() => OAuthRequirements()..mergeFromMessage(this);
  OAuthRequirements copyWith(void Function(OAuthRequirements) updates) => super.copyWith((message) => updates(message as OAuthRequirements));
  $pb.BuilderInfo get info_ => _i;
  ...
  static OAuthRequirements getDefault() => _defaultInstance ??= create()..freeze();
...
class AuthRequirement extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('AuthRequirement', package: const $pb.PackageName('google.api'))
    ..aOS(1, 'providerId')
    ..aOS(2, 'audiences')
    ..hasRequiredFields = false
  ;
  ...
  AuthRequirement.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  AuthRequirement.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  AuthRequirement clone() => AuthRequirement()..mergeFromMessage(this);
  AuthRequirement copyWith(void Function(AuthRequirement) updates) => super.copyWith((message) => updates(message as AuthRequirement));
  $pb.BuilderInfo get info_ => _i;
  ...
  static AuthRequirement getDefault() => _defaultInstance ??= create()..freeze();
