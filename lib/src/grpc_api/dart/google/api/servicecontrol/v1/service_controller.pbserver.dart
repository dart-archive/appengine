...
abstract class ServiceControllerServiceBase extends $pb.GeneratedService {
  $async.Future<CheckResponse> check(
      $pb.ServerContext ctx, CheckRequest request);
  $async.Future<ReportResponse> report(
      $pb.ServerContext ctx, ReportRequest request);
  ...
  $core.Map<$core.String, $core.dynamic> get $json =>
      ServiceControllerServiceBase$json;
  $core.Map<$core.String, $core.Map<$core.String, $core.dynamic>>
      get $messageJson => ServiceControllerServiceBase$messageJson;
}
