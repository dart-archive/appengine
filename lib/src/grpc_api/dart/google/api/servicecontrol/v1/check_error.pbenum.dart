...
class CheckError_Code extends ProtobufEnum {
  static const CheckError_Code ERROR_CODE_UNSPECIFIED =
      const CheckError_Code._(0, 'ERROR_CODE_UNSPECIFIED');
  static const CheckError_Code NOT_FOUND =
      const CheckError_Code._(5, 'NOT_FOUND');
  static const CheckError_Code PERMISSION_DENIED =
      const CheckError_Code._(7, 'PERMISSION_DENIED');
  static const CheckError_Code RESOURCE_EXHAUSTED =
      const CheckError_Code._(8, 'RESOURCE_EXHAUSTED');
  static const CheckError_Code SERVICE_NOT_ACTIVATED =
      const CheckError_Code._(104, 'SERVICE_NOT_ACTIVATED');
  static const CheckError_Code BILLING_DISABLED =
      const CheckError_Code._(107, 'BILLING_DISABLED');
  static const CheckError_Code PROJECT_DELETED =
      const CheckError_Code._(108, 'PROJECT_DELETED');
  static const CheckError_Code PROJECT_INVALID =
      const CheckError_Code._(114, 'PROJECT_INVALID');
  static const CheckError_Code IP_ADDRESS_BLOCKED =
      const CheckError_Code._(109, 'IP_ADDRESS_BLOCKED');
  static const CheckError_Code REFERER_BLOCKED =
      const CheckError_Code._(110, 'REFERER_BLOCKED');
  static const CheckError_Code CLIENT_APP_BLOCKED =
      const CheckError_Code._(111, 'CLIENT_APP_BLOCKED');
  static const CheckError_Code API_KEY_INVALID =
      const CheckError_Code._(105, 'API_KEY_INVALID');
  static const CheckError_Code API_KEY_EXPIRED =
      const CheckError_Code._(112, 'API_KEY_EXPIRED');
  static const CheckError_Code API_KEY_NOT_FOUND =
      const CheckError_Code._(113, 'API_KEY_NOT_FOUND');
  static const CheckError_Code NAMESPACE_LOOKUP_UNAVAILABLE =
      const CheckError_Code._(300, 'NAMESPACE_LOOKUP_UNAVAILABLE');
  static const CheckError_Code SERVICE_STATUS_UNAVAILABLE =
      const CheckError_Code._(301, 'SERVICE_STATUS_UNAVAILABLE');
  static const CheckError_Code BILLING_STATUS_UNAVAILABLE =
      const CheckError_Code._(302, 'BILLING_STATUS_UNAVAILABLE');
