...
class AllocateQuotaRequest extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('AllocateQuotaRequest')
    ..aOS(1, 'serviceName')
    ..a<QuotaOperation>(2, 'allocateOperation', PbFieldType.OM, QuotaOperation.getDefault, QuotaOperation.create)
    ..aOS(4, 'serviceConfigId')
    ..hasRequiredFields = false
  ;

  AllocateQuotaRequest() : super();
  AllocateQuotaRequest.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  AllocateQuotaRequest.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  AllocateQuotaRequest clone() => new AllocateQuotaRequest()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static AllocateQuotaRequest create() => new AllocateQuotaRequest();
  static PbList<AllocateQuotaRequest> createRepeated() => new PbList<AllocateQuotaRequest>();
  static AllocateQuotaRequest getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyAllocateQuotaRequest();
...
class _ReadonlyAllocateQuotaRequest extends AllocateQuotaRequest with ReadonlyMessageMixin {}
...
class QuotaOperation_LabelsEntry extends GeneratedMessage {
  ...
  QuotaOperation_LabelsEntry.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  QuotaOperation_LabelsEntry.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  QuotaOperation_LabelsEntry clone() => new QuotaOperation_LabelsEntry()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static QuotaOperation_LabelsEntry create() => new QuotaOperation_LabelsEntry();
  static PbList<QuotaOperation_LabelsEntry> createRepeated() => new PbList<QuotaOperation_LabelsEntry>();
  static QuotaOperation_LabelsEntry getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyQuotaOperation_LabelsEntry();
    return _defaultInstance;
  }
  static QuotaOperation_LabelsEntry _defaultInstance;
  static void $checkItem(QuotaOperation_LabelsEntry v) {
    if (v is! QuotaOperation_LabelsEntry) checkItemFailed(v, 'QuotaOperation_LabelsEntry');
  }
...
class _ReadonlyQuotaOperation_LabelsEntry extends QuotaOperation_LabelsEntry with ReadonlyMessageMixin {}
...
class QuotaOperation extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('QuotaOperation')
    ...
    ..aOS(2, 'methodName')
    ..aOS(3, 'consumerId')
    ..pp<QuotaOperation_LabelsEntry>(4, 'labels', PbFieldType.PM, QuotaOperation_LabelsEntry.$checkItem, QuotaOperation_LabelsEntry.create)
    ..pp<MetricValueSet>(5, 'quotaMetrics', PbFieldType.PM, MetricValueSet.$checkItem, MetricValueSet.create)
    ..e<QuotaOperation_QuotaMode>(6, 'quotaMode', PbFieldType.OE, QuotaOperation_QuotaMode.UNSPECIFIED, QuotaOperation_QuotaMode.valueOf, QuotaOperation_QuotaMode.values)
    ..hasRequiredFields = false
  ;

  QuotaOperation() : super();
  QuotaOperation.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  QuotaOperation.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  QuotaOperation clone() => new QuotaOperation()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static QuotaOperation create() => new QuotaOperation();
  static PbList<QuotaOperation> createRepeated() => new PbList<QuotaOperation>();
  static QuotaOperation getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyQuotaOperation();
    return _defaultInstance;
  }
...
class AllocateQuotaResponse extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('AllocateQuotaResponse')
    ..aOS(1, 'operationId')
    ..pp<QuotaError>(2, 'allocateErrors', PbFieldType.PM, QuotaError.$checkItem, QuotaError.create)
    ..pp<MetricValueSet>(3, 'quotaMetrics', PbFieldType.PM, MetricValueSet.$checkItem, MetricValueSet.create)
    ..aOS(4, 'serviceConfigId')
    ..hasRequiredFields = false
  ;

  AllocateQuotaResponse() : super();
  AllocateQuotaResponse.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  AllocateQuotaResponse.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  AllocateQuotaResponse clone() => new AllocateQuotaResponse()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static AllocateQuotaResponse create() => new AllocateQuotaResponse();
  static PbList<AllocateQuotaResponse> createRepeated() => new PbList<AllocateQuotaResponse>();
  static AllocateQuotaResponse getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyAllocateQuotaResponse();
    return _defaultInstance;
  }
  static AllocateQuotaResponse _defaultInstance;
  static void $checkItem(AllocateQuotaResponse v) {
    if (v is! AllocateQuotaResponse) checkItemFailed(v, 'AllocateQuotaResponse');
  }
  ...
  set serviceConfigId(String v) { $_setString(3, v); }
  bool hasServiceConfigId() => $_has(3);
  void clearServiceConfigId() => clearField(4);
}

class _ReadonlyAllocateQuotaResponse extends AllocateQuotaResponse with ReadonlyMessageMixin {}

class QuotaError extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('QuotaError')
    ..e<QuotaError_Code>(1, 'code', PbFieldType.OE, QuotaError_Code.UNSPECIFIED, QuotaError_Code.valueOf, QuotaError_Code.values)
    ..aOS(2, 'subject')
    ..aOS(3, 'description')
    ..hasRequiredFields = false
  ;
  ...
  QuotaError() : super();
  QuotaError.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  QuotaError.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
...
class QuotaControllerApi {
  ...
  Future<AllocateQuotaResponse> allocateQuota(ClientContext ctx, AllocateQuotaRequest request) {
