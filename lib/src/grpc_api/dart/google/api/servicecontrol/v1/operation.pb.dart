...
class Operation extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('Operation')
    ...
    ..e<Operation_Importance>(11, 'importance', PbFieldType.OE, Operation_Importance.LOW, Operation_Importance.valueOf, Operation_Importance.values)
    ..hasRequiredFields = false
  ;
  ...
  set operationName(String v) { $_setString(1, v); }
