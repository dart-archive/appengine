...
class Service extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Service',
    ...
    ..a<$2.Documentation>(6, 'documentation', $pb.PbFieldType.OM,
        $2.Documentation.getDefault, $2.Documentation.create)
    ..a<$3.Backend>(8, 'backend', $pb.PbFieldType.OM, $3.Backend.getDefault,
        $3.Backend.create)
    ..a<$4.Http>(
        9, 'http', $pb.PbFieldType.OM, $4.Http.getDefault, $4.Http.create)
    ..a<$5.Quota>(
        10, 'quota', $pb.PbFieldType.OM, $5.Quota.getDefault, $5.Quota.create)
    ..a<$6.Authentication>(11, 'authentication', $pb.PbFieldType.OM,
        $6.Authentication.getDefault, $6.Authentication.create)
    ..a<$7.Context>(12, 'context', $pb.PbFieldType.OM, $7.Context.getDefault,
        $7.Context.create)
    ..a<$8.Usage>(
        15, 'usage', $pb.PbFieldType.OM, $8.Usage.getDefault, $8.Usage.create)
    ..pc<$9.Endpoint>(18, 'endpoints', $pb.PbFieldType.PM, $9.Endpoint.create)
    ..a<$10.UInt32Value>(20, 'configVersion', $pb.PbFieldType.OM,
        $10.UInt32Value.getDefault, $10.UInt32Value.create)
    ..a<$11.Control>(21, 'control', $pb.PbFieldType.OM, $11.Control.getDefault,
        $11.Control.create)
    ..aOS(22, 'producerProjectId')
    ..pc<$12.LogDescriptor>(
        23, 'logs', $pb.PbFieldType.PM, $12.LogDescriptor.create)
    ..pc<$13.MetricDescriptor>(
        24, 'metrics', $pb.PbFieldType.PM, $13.MetricDescriptor.create)
    ..pc<$14.MonitoredResourceDescriptor>(
        25, 'monitoredResources', $pb.PbFieldType.PM, $14.MonitoredResourceDescriptor.create)
