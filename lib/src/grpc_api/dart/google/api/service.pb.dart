...
class Service extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('Service')
    ...
    ..a<Billing>(26, 'billing', PbFieldType.OM, Billing.getDefault, Billing.create)
    ...
    ..aOS(33, 'id')
    ..a<SourceInfo>(37, 'sourceInfo', PbFieldType.OM, SourceInfo.getDefault, SourceInfo.create)
