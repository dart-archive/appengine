...
class ProjectProperties extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ProjectProperties', package: const $pb.PackageName('google.api'))
    ..pc<Property>(1, 'properties', $pb.PbFieldType.PM,Property.create)
    ..hasRequiredFields = false
  ;

  ProjectProperties() : super();
  ProjectProperties.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  ProjectProperties.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ProjectProperties clone() => ProjectProperties()..mergeFromMessage(this);
  ProjectProperties copyWith(void Function(ProjectProperties) updates) => super.copyWith((message) => updates(message as ProjectProperties));
  ...
  static ProjectProperties getDefault() => _defaultInstance ??= create()..freeze();
...
class Property extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Property', package: const $pb.PackageName('google.api'))
    ..aOS(1, 'name')
    ..e<Property_PropertyType>(2, 'type', $pb.PbFieldType.OE, Property_PropertyType.UNSPECIFIED, Property_PropertyType.valueOf, Property_PropertyType.values)
    ..aOS(3, 'description')
    ..hasRequiredFields = false
  ;
