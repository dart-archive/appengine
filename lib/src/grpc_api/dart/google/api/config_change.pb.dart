...
class ConfigChange extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ConfigChange', package: const $pb.PackageName('google.api'))
    ..aOS(1, 'element')
    ..aOS(2, 'oldValue')
    ..aOS(3, 'newValue')
    ..e<ChangeType>(4, 'changeType', $pb.PbFieldType.OE, ChangeType.CHANGE_TYPE_UNSPECIFIED, ChangeType.valueOf, ChangeType.values)
    ..pc<Advice>(5, 'advices', $pb.PbFieldType.PM,Advice.create)
    ..hasRequiredFields = false
  ;

  ConfigChange() : super();
  ConfigChange.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  ConfigChange.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ConfigChange clone() => ConfigChange()..mergeFromMessage(this);
  ConfigChange copyWith(void Function(ConfigChange) updates) => super.copyWith((message) => updates(message as ConfigChange));
...
class Advice extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Advice', package: const $pb.PackageName('google.api'))
    ..aOS(2, 'description')
    ..hasRequiredFields = false
  ;

  Advice() : super();
  Advice.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  Advice.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  Advice clone() => Advice()..mergeFromMessage(this);
  Advice copyWith(void Function(Advice) updates) => super.copyWith((message) => updates(message as Advice));
  $pb.BuilderInfo get info_ => _i;
