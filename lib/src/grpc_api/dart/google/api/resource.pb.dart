...
class ResourceDescriptor extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ResourceDescriptor', package: const $pb.PackageName('google.api'))
    ..aOS(1, 'type')
    ..pPS(2, 'pattern')
    ..aOS(3, 'nameField')
  ...
  ResourceDescriptor.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  ResourceDescriptor.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
...
class ResourceReference extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ResourceReference', package: const $pb.PackageName('google.api'))
    ..aOS(1, 'type')
    ..aOS(2, 'childType')
    ..hasRequiredFields = false
  ;
  ...
  ResourceReference.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  ResourceReference.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
...
class Resource {
  static final $pb.Extension resourceReference = $pb.Extension<ResourceReference>('google.protobuf.FieldOptions', 'resourceReference', 1055, $pb.PbFieldType.OM, ResourceReference.getDefault, ResourceReference.create);
  static final $pb.Extension resource = $pb.Extension<ResourceDescriptor>('google.protobuf.MessageOptions', 'resource', 1053, $pb.PbFieldType.OM, ResourceDescriptor.getDefault, ResourceDescriptor.create);
