...
class Distribution_Range extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Distribution.Range', package: const $pb.PackageName('google.api'))
  ...
  Distribution_Range.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  Distribution_Range.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  Distribution_Range clone() => Distribution_Range()..mergeFromMessage(this);
  Distribution_Range copyWith(void Function(Distribution_Range) updates) => super.copyWith((message) => updates(message as Distribution_Range));
  ...
  static Distribution_Range getDefault() => _defaultInstance ??= create()..freeze();
...
class Distribution_BucketOptions_Linear extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Distribution.BucketOptions.Linear', package: const $pb.PackageName('google.api'))
  ...
  Distribution_BucketOptions_Linear.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  Distribution_BucketOptions_Linear.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  Distribution_BucketOptions_Linear clone() => Distribution_BucketOptions_Linear()..mergeFromMessage(this);
  Distribution_BucketOptions_Linear copyWith(void Function(Distribution_BucketOptions_Linear) updates) => super.copyWith((message) => updates(message as Distribution_BucketOptions_Linear));
  $pb.BuilderInfo get info_ => _i;
  static Distribution_BucketOptions_Linear create() => Distribution_BucketOptions_Linear();
  ...
  static Distribution_BucketOptions_Linear getDefault() => _defaultInstance ??= create()..freeze();
...
class Distribution_BucketOptions_Exponential extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Distribution.BucketOptions.Exponential', package: const $pb.PackageName('google.api'))
    ..a<$core.int>(1, 'numFiniteBuckets', $pb.PbFieldType.O3)
  ...
  Distribution_BucketOptions_Exponential.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  Distribution_BucketOptions_Exponential.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  Distribution_BucketOptions_Exponential clone() => Distribution_BucketOptions_Exponential()..mergeFromMessage(this);
  Distribution_BucketOptions_Exponential copyWith(void Function(Distribution_BucketOptions_Exponential) updates) => super.copyWith((message) => updates(message as Distribution_BucketOptions_Exponential));
  $pb.BuilderInfo get info_ => _i;
  static Distribution_BucketOptions_Exponential create() => Distribution_BucketOptions_Exponential();
  ...
  static Distribution_BucketOptions_Exponential getDefault() => _defaultInstance ??= create()..freeze();
...
class Distribution_BucketOptions_Explicit extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Distribution.BucketOptions.Explicit', package: const $pb.PackageName('google.api'))
    ..p<$core.double>(1, 'bounds', $pb.PbFieldType.PD)
    ..hasRequiredFields = false
  ;

  Distribution_BucketOptions_Explicit() : super();
  Distribution_BucketOptions_Explicit.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  Distribution_BucketOptions_Explicit.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  Distribution_BucketOptions_Explicit clone() => Distribution_BucketOptions_Explicit()..mergeFromMessage(this);
  Distribution_BucketOptions_Explicit copyWith(void Function(Distribution_BucketOptions_Explicit) updates) => super.copyWith((message) => updates(message as Distribution_BucketOptions_Explicit));
  $pb.BuilderInfo get info_ => _i;
  static Distribution_BucketOptions_Explicit create() => Distribution_BucketOptions_Explicit();
  ...
  static Distribution_BucketOptions_Explicit getDefault() => _defaultInstance ??= create()..freeze();
...
class Distribution_BucketOptions extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Distribution.BucketOptions', package: const $pb.PackageName('google.api'))
    ..a<Distribution_BucketOptions_Linear>(1, 'linearBuckets', $pb.PbFieldType.OM, Distribution_BucketOptions_Linear.getDefault, Distribution_BucketOptions_Linear.create)
    ..a<Distribution_BucketOptions_Exponential>(2, 'exponentialBuckets', $pb.PbFieldType.OM, Distribution_BucketOptions_Exponential.getDefault, Distribution_BucketOptions_Exponential.create)
    ..a<Distribution_BucketOptions_Explicit>(3, 'explicitBuckets', $pb.PbFieldType.OM, Distribution_BucketOptions_Explicit.getDefault, Distribution_BucketOptions_Explicit.create)
    ..oo(0, [1, 2, 3])
    ..hasRequiredFields = false
  ;

  Distribution_BucketOptions() : super();
  Distribution_BucketOptions.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  Distribution_BucketOptions.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  Distribution_BucketOptions clone() => Distribution_BucketOptions()..mergeFromMessage(this);
  Distribution_BucketOptions copyWith(void Function(Distribution_BucketOptions) updates) => super.copyWith((message) => updates(message as Distribution_BucketOptions));
  $pb.BuilderInfo get info_ => _i;
  ...
  static Distribution_BucketOptions getDefault() => _defaultInstance ??= create()..freeze();
...
class Distribution_Exemplar extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Distribution.Exemplar', package: const $pb.PackageName('google.api'))
  ...
  Distribution_Exemplar.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  Distribution_Exemplar.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  Distribution_Exemplar clone() => Distribution_Exemplar()..mergeFromMessage(this);
  Distribution_Exemplar copyWith(void Function(Distribution_Exemplar) updates) => super.copyWith((message) => updates(message as Distribution_Exemplar));
  $pb.BuilderInfo get info_ => _i;
  ...
  static Distribution_Exemplar getDefault() => _defaultInstance ??= create()..freeze();
...
class Distribution extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Distribution', package: const $pb.PackageName('google.api'))
    ..aInt64(1, 'count')
    ..a<$core.double>(2, 'mean', $pb.PbFieldType.OD)
    ..a<$core.double>(3, 'sumOfSquaredDeviation', $pb.PbFieldType.OD)
    ..a<Distribution_Range>(4, 'range', $pb.PbFieldType.OM, Distribution_Range.getDefault, Distribution_Range.create)
    ..a<Distribution_BucketOptions>(6, 'bucketOptions', $pb.PbFieldType.OM, Distribution_BucketOptions.getDefault, Distribution_BucketOptions.create)
    ..p<Int64>(7, 'bucketCounts', $pb.PbFieldType.P6)
    ..pc<Distribution_Exemplar>(10, 'exemplars', $pb.PbFieldType.PM,Distribution_Exemplar.create)
    ..hasRequiredFields = false
  ;
