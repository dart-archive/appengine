...
class Backend extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Backend', package: const $pb.PackageName('google.api'))
    ..pc<BackendRule>(1, 'rules', $pb.PbFieldType.PM,BackendRule.create)
    ..hasRequiredFields = false
  ;

  Backend() : super();
  Backend.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  Backend.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  Backend clone() => Backend()..mergeFromMessage(this);
  Backend copyWith(void Function(Backend) updates) => super.copyWith((message) => updates(message as Backend));
...
class BackendRule extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('BackendRule', package: const $pb.PackageName('google.api'))
    ..aOS(1, 'selector')
    ..aOS(2, 'address')
    ...
    ..e<BackendRule_PathTranslation>(6, 'pathTranslation', $pb.PbFieldType.OE, BackendRule_PathTranslation.PATH_TRANSLATION_UNSPECIFIED, BackendRule_PathTranslation.valueOf, BackendRule_PathTranslation.values)
    ..aOS(7, 'jwtAudience')
    ..oo(0, [7])
    ..hasRequiredFields = false
  ;
  ...
  BackendRule() : super();
  BackendRule.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  BackendRule.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  BackendRule clone() => BackendRule()..mergeFromMessage(this);
  BackendRule copyWith(void Function(BackendRule) updates) => super.copyWith((message) => updates(message as BackendRule));
  $pb.BuilderInfo get info_ => _i;
