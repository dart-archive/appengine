...
class ParsedExpr extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ParsedExpr', package: const $pb.PackageName('google.api.expr.v1beta1'))
    ..a<Expr>(2, 'expr', $pb.PbFieldType.OM, Expr.getDefault, Expr.create)
    ..a<$0.SourceInfo>(3, 'sourceInfo', $pb.PbFieldType.OM, $0.SourceInfo.getDefault, $0.SourceInfo.create)
    ..aOS(4, 'syntaxVersion')
...
class Expr_Ident extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Expr.Ident', package: const $pb.PackageName('google.api.expr.v1beta1'))
    ..aOS(1, 'name')
    ..hasRequiredFields = false
  ;
...
class Expr_Select extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Expr.Select', package: const $pb.PackageName('google.api.expr.v1beta1'))
...
class Expr_Call extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Expr.Call', package: const $pb.PackageName('google.api.expr.v1beta1'))
...
class Expr_CreateList extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Expr.CreateList', package: const $pb.PackageName('google.api.expr.v1beta1'))
...
class Expr_CreateStruct_Entry extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Expr.CreateStruct.Entry', package: const $pb.PackageName('google.api.expr.v1beta1'))
...
class Expr_CreateStruct extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Expr.CreateStruct', package: const $pb.PackageName('google.api.expr.v1beta1'))
    ..aOS(1, 'type')
...
class Expr_Comprehension extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Expr.Comprehension', package: const $pb.PackageName('google.api.expr.v1beta1'))
    ..aOS(1, 'iterVar')
...
class Expr extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Expr', package: const $pb.PackageName('google.api.expr.v1beta1'))
    ..a<$core.int>(2, 'id', $pb.PbFieldType.O3)
    ..a<Literal>(3, 'literalExpr', $pb.PbFieldType.OM, Literal.getDefault, Literal.create)
...
class Literal extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Literal', package: const $pb.PackageName('google.api.expr.v1beta1'))
    ..e<$1.NullValue>(1, 'nullValue', $pb.PbFieldType.OE, $1.NullValue.NULL_VALUE, $1.NullValue.valueOf, $1.NullValue.values)
    ..aOB(2, 'boolValue')
    ..aInt64(3, 'int64Value')
  ...
  Literal() : super();
  Literal.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  Literal.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  Literal clone() => Literal()..mergeFromMessage(this);
  Literal copyWith(void Function(Literal) updates) => super.copyWith((message) => updates(message as Literal));
  $pb.BuilderInfo get info_ => _i;
  static Literal create() => Literal();
