...
class Decl extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Decl', package: const $pb.PackageName('google.api.expr.v1beta1'))
    ..a<$core.int>(1, 'id', $pb.PbFieldType.O3)
    ..aOS(2, 'name')
    ..aOS(3, 'doc')
    ..a<IdentDecl>(4, 'ident', $pb.PbFieldType.OM, IdentDecl.getDefault, IdentDecl.create)
    ..a<FunctionDecl>(5, 'function', $pb.PbFieldType.OM, FunctionDecl.getDefault, FunctionDecl.create)
    ..oo(0, [4, 5])
...
class DeclType extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('DeclType', package: const $pb.PackageName('google.api.expr.v1beta1'))
    ..a<$core.int>(1, 'id', $pb.PbFieldType.O3)
    ..aOS(2, 'type')
  ...
  DeclType() : super();
  DeclType.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  DeclType.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  DeclType clone() => DeclType()..mergeFromMessage(this);
  DeclType copyWith(void Function(DeclType) updates) => super.copyWith((message) => updates(message as DeclType));
  $pb.BuilderInfo get info_ => _i;
...
class IdentDecl extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('IdentDecl', package: const $pb.PackageName('google.api.expr.v1beta1'))
    ..a<DeclType>(3, 'type', $pb.PbFieldType.OM, DeclType.getDefault, DeclType.create)
    ..a<$0.Expr>(4, 'value', $pb.PbFieldType.OM, $0.Expr.getDefault, $0.Expr.create)
    ..hasRequiredFields = false
  ;

  IdentDecl() : super();
  IdentDecl.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  IdentDecl.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  IdentDecl clone() => IdentDecl()..mergeFromMessage(this);
  IdentDecl copyWith(void Function(IdentDecl) updates) => super.copyWith((message) => updates(message as IdentDecl));
  $pb.BuilderInfo get info_ => _i;
...
class FunctionDecl extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('FunctionDecl', package: const $pb.PackageName('google.api.expr.v1beta1'))
    ..pc<IdentDecl>(1, 'args', $pb.PbFieldType.PM,IdentDecl.create)
    ..a<DeclType>(2, 'returnType', $pb.PbFieldType.OM, DeclType.getDefault, DeclType.create)
    ..aOB(3, 'receiverFunction')
    ..hasRequiredFields = false
  ;

  FunctionDecl() : super();
  FunctionDecl.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  FunctionDecl.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  FunctionDecl clone() => FunctionDecl()..mergeFromMessage(this);
  FunctionDecl copyWith(void Function(FunctionDecl) updates) => super.copyWith((message) => updates(message as FunctionDecl));
  $pb.BuilderInfo get info_ => _i;
