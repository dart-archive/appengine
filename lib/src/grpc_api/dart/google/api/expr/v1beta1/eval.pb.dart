...
class EvalState_Result extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('EvalState.Result', package: const $pb.PackageName('google.api.expr.v1beta1'))
  ...
  EvalState_Result.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  EvalState_Result.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  EvalState_Result clone() => EvalState_Result()..mergeFromMessage(this);
  EvalState_Result copyWith(void Function(EvalState_Result) updates) => super.copyWith((message) => updates(message as EvalState_Result));
  ...
  static EvalState_Result getDefault() => _defaultInstance ??= create()..freeze();
...
class EvalState extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('EvalState', package: const $pb.PackageName('google.api.expr.v1beta1'))
    ..pc<ExprValue>(1, 'values', $pb.PbFieldType.PM,ExprValue.create)
    ..pc<EvalState_Result>(3, 'results', $pb.PbFieldType.PM,EvalState_Result.create)
    ..hasRequiredFields = false
  ;

  EvalState() : super();
  EvalState.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  EvalState.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  EvalState clone() => EvalState()..mergeFromMessage(this);
  EvalState copyWith(void Function(EvalState) updates) => super.copyWith((message) => updates(message as EvalState));
  $pb.BuilderInfo get info_ => _i;
...
class ExprValue extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ExprValue', package: const $pb.PackageName('google.api.expr.v1beta1'))
    ..a<$0.Value>(1, 'value', $pb.PbFieldType.OM, $0.Value.getDefault, $0.Value.create)
    ..a<ErrorSet>(2, 'error', $pb.PbFieldType.OM, ErrorSet.getDefault, ErrorSet.create)
    ..a<UnknownSet>(3, 'unknown', $pb.PbFieldType.OM, UnknownSet.getDefault, UnknownSet.create)
    ..oo(0, [1, 2, 3])
    ..hasRequiredFields = false
  ;

  ExprValue() : super();
  ExprValue.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  ExprValue.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ExprValue clone() => ExprValue()..mergeFromMessage(this);
  ExprValue copyWith(void Function(ExprValue) updates) => super.copyWith((message) => updates(message as ExprValue));
  $pb.BuilderInfo get info_ => _i;
...
class ErrorSet extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ErrorSet', package: const $pb.PackageName('google.api.expr.v1beta1'))
    ..pc<$1.Status>(1, 'errors', $pb.PbFieldType.PM,$1.Status.create)
    ..hasRequiredFields = false
  ;

  ErrorSet() : super();
  ErrorSet.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  ErrorSet.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ErrorSet clone() => ErrorSet()..mergeFromMessage(this);
  ErrorSet copyWith(void Function(ErrorSet) updates) => super.copyWith((message) => updates(message as ErrorSet));
  $pb.BuilderInfo get info_ => _i;
...
class UnknownSet extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('UnknownSet', package: const $pb.PackageName('google.api.expr.v1beta1'))
    ..pc<IdRef>(1, 'exprs', $pb.PbFieldType.PM,IdRef.create)
    ..hasRequiredFields = false
  ;

  UnknownSet() : super();
  UnknownSet.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  UnknownSet.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  UnknownSet clone() => UnknownSet()..mergeFromMessage(this);
  UnknownSet copyWith(void Function(UnknownSet) updates) => super.copyWith((message) => updates(message as UnknownSet));
  $pb.BuilderInfo get info_ => _i;
...
class IdRef extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('IdRef', package: const $pb.PackageName('google.api.expr.v1beta1'))
    ..a<$core.int>(1, 'id', $pb.PbFieldType.O3)
    ..hasRequiredFields = false
  ;

  IdRef() : super();
  IdRef.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  IdRef.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  IdRef clone() => IdRef()..mergeFromMessage(this);
  IdRef copyWith(void Function(IdRef) updates) => super.copyWith((message) => updates(message as IdRef));
  $pb.BuilderInfo get info_ => _i;
