...
class ParseRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ParseRequest', package: const $pb.PackageName('google.api.expr.v1alpha1'))
    ..aOS(1, 'celSource')
    ..aOS(2, 'syntaxVersion')
  ...
  ParseRequest() : super();
  ParseRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  ParseRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ParseRequest clone() => ParseRequest()..mergeFromMessage(this);
  ParseRequest copyWith(void Function(ParseRequest) updates) => super.copyWith((message) => updates(message as ParseRequest));
...
class ParseResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ParseResponse', package: const $pb.PackageName('google.api.expr.v1alpha1'))
    ..a<$0.ParsedExpr>(1, 'parsedExpr', $pb.PbFieldType.OM, $0.ParsedExpr.getDefault, $0.ParsedExpr.create)
    ..pc<$1.Status>(2, 'issues', $pb.PbFieldType.PM,$1.Status.create)
    ..hasRequiredFields = false
  ;

  ParseResponse() : super();
  ParseResponse.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  ParseResponse.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ParseResponse clone() => ParseResponse()..mergeFromMessage(this);
  ParseResponse copyWith(void Function(ParseResponse) updates) => super.copyWith((message) => updates(message as ParseResponse));
  $pb.BuilderInfo get info_ => _i;
  ...
  set parsedExpr($0.ParsedExpr v) { setField(1, v); }
...
class CheckRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('CheckRequest', package: const $pb.PackageName('google.api.expr.v1alpha1'))
    ..a<$0.ParsedExpr>(1, 'parsedExpr', $pb.PbFieldType.OM, $0.ParsedExpr.getDefault, $0.ParsedExpr.create)
  ...
  CheckRequest() : super();
  CheckRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  CheckRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
...
class CheckResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('CheckResponse', package: const $pb.PackageName('google.api.expr.v1alpha1'))
    ..a<$2.CheckedExpr>(1, 'checkedExpr', $pb.PbFieldType.OM, $2.CheckedExpr.getDefault, $2.CheckedExpr.create)
    ..pc<$1.Status>(2, 'issues', $pb.PbFieldType.PM,$1.Status.create)
    ..hasRequiredFields = false
  ;

  CheckResponse() : super();
  CheckResponse.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  CheckResponse.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ...
  set checkedExpr($2.CheckedExpr v) { setField(1, v); }
...
class EvalRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('EvalRequest', package: const $pb.PackageName('google.api.expr.v1alpha1'))
    ..a<$0.ParsedExpr>(1, 'parsedExpr', $pb.PbFieldType.OM, $0.ParsedExpr.getDefault, $0.ParsedExpr.create)
    ..a<$2.CheckedExpr>(2, 'checkedExpr', $pb.PbFieldType.OM, $2.CheckedExpr.getDefault, $2.CheckedExpr.create)
    ..m<$core.String, $3.ExprValue>(3, 'bindings', 'EvalRequest.BindingsEntry',$pb.PbFieldType.OS, $pb.PbFieldType.OM, $3.ExprValue.create, null, null , const $pb.PackageName('google.api.expr.v1alpha1'))
    ..aOS(4, 'container')
    ..oo(0, [1, 2])
    ..hasRequiredFields = false
  ;
  ...
  EvalRequest() : super();
  EvalRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  EvalRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  EvalRequest clone() => EvalRequest()..mergeFromMessage(this);
  EvalRequest copyWith(void Function(EvalRequest) updates) => super.copyWith((message) => updates(message as EvalRequest));
  $pb.BuilderInfo get info_ => _i;
  ...
  set checkedExpr($2.CheckedExpr v) { setField(2, v); }
...
class EvalResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('EvalResponse', package: const $pb.PackageName('google.api.expr.v1alpha1'))
    ..a<$3.ExprValue>(1, 'result', $pb.PbFieldType.OM, $3.ExprValue.getDefault, $3.ExprValue.create)
    ..pc<$1.Status>(2, 'issues', $pb.PbFieldType.PM,$1.Status.create)
    ..hasRequiredFields = false
  ;

  EvalResponse() : super();
  EvalResponse.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  EvalResponse.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  EvalResponse clone() => EvalResponse()..mergeFromMessage(this);
  EvalResponse copyWith(void Function(EvalResponse) updates) => super.copyWith((message) => updates(message as EvalResponse));
  $pb.BuilderInfo get info_ => _i;
  ...
  set result($3.ExprValue v) { setField(1, v); }
...
class IssueDetails extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('IssueDetails', package: const $pb.PackageName('google.api.expr.v1alpha1'))
    ..e<IssueDetails_Severity>(1, 'severity', $pb.PbFieldType.OE, IssueDetails_Severity.SEVERITY_UNSPECIFIED, IssueDetails_Severity.valueOf, IssueDetails_Severity.values)
    ..a<$0.SourcePosition>(2, 'position', $pb.PbFieldType.OM, $0.SourcePosition.getDefault, $0.SourcePosition.create)
    ..aInt64(3, 'id')
    ..hasRequiredFields = false
  ;

  IssueDetails() : super();
  IssueDetails.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  IssueDetails.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  IssueDetails clone() => IssueDetails()..mergeFromMessage(this);
  IssueDetails copyWith(void Function(IssueDetails) updates) => super.copyWith((message) => updates(message as IssueDetails));
  $pb.BuilderInfo get info_ => _i;
  ...
  set position($0.SourcePosition v) { setField(2, v); }
...
class ConformanceServiceApi {
  ...
  $async.Future<ParseResponse> parse($pb.ClientContext ctx, ParseRequest request) {
    var emptyResponse = ParseResponse();
    return _client.invoke<ParseResponse>(ctx, 'ConformanceService', 'Parse', request, emptyResponse);
  }
  $async.Future<CheckResponse> check_($pb.ClientContext ctx, CheckRequest request) {
    var emptyResponse = CheckResponse();
    return _client.invoke<CheckResponse>(ctx, 'ConformanceService', 'Check', request, emptyResponse);
  }
  $async.Future<EvalResponse> eval($pb.ClientContext ctx, EvalRequest request) {
    var emptyResponse = EvalResponse();
    return _client.invoke<EvalResponse>(ctx, 'ConformanceService', 'Eval', request, emptyResponse);
  }
}
