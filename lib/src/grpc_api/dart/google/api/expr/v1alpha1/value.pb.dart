...
class Value extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Value', package: const $pb.PackageName('google.api.expr.v1alpha1'))
    ...
    ..a<EnumValue>(9, 'enumValue', $pb.PbFieldType.OM, EnumValue.getDefault, EnumValue.create)
    ..a<$0.Any>(10, 'objectValue', $pb.PbFieldType.OM, $0.Any.getDefault, $0.Any.create)
    ..a<MapValue>(11, 'mapValue', $pb.PbFieldType.OM, MapValue.getDefault, MapValue.create)
    ..a<ListValue>(12, 'listValue', $pb.PbFieldType.OM, ListValue.getDefault, ListValue.create)
    ..aOS(15, 'typeValue')
...
class EnumValue extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('EnumValue', package: const $pb.PackageName('google.api.expr.v1alpha1'))
    ..aOS(1, 'type')
  ...
  EnumValue() : super();
  EnumValue.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  EnumValue.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
...
class ListValue extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ListValue', package: const $pb.PackageName('google.api.expr.v1alpha1'))
...
class MapValue_Entry extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('MapValue.Entry', package: const $pb.PackageName('google.api.expr.v1alpha1'))
  ...
  MapValue_Entry.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  MapValue_Entry.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  MapValue_Entry clone() => MapValue_Entry()..mergeFromMessage(this);
  MapValue_Entry copyWith(void Function(MapValue_Entry) updates) => super.copyWith((message) => updates(message as MapValue_Entry));
  $pb.BuilderInfo get info_ => _i;
...
class MapValue extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('MapValue', package: const $pb.PackageName('google.api.expr.v1alpha1'))
    ..pc<MapValue_Entry>(1, 'entries', $pb.PbFieldType.PM,MapValue_Entry.create)
    ..hasRequiredFields = false
  ;

  MapValue() : super();
  MapValue.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  MapValue.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
