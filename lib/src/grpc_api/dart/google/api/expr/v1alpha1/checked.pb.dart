...
class CheckedExpr extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('CheckedExpr',
    ...
    ..m<Int64, Type>(
        ...
        const $pb.PackageName('google.api.expr.v1alpha1'))
    ..a<$0.Expr>(
        4, 'expr', $pb.PbFieldType.OM, $0.Expr.getDefault, $0.Expr.create)
    ..a<$0.SourceInfo>(5, 'sourceInfo', $pb.PbFieldType.OM,
        $0.SourceInfo.getDefault, $0.SourceInfo.create)
    ..hasRequiredFields = false;

  CheckedExpr() : super();
  CheckedExpr.fromBuffer($core.List<$core.int> i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);
  CheckedExpr.fromJson($core.String i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromJson(i, r);
...
class Type_ListType extends $pb.GeneratedMessage {
  ...
  Type_ListType() : super();
  Type_ListType.fromBuffer($core.List<$core.int> i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);
  Type_ListType.fromJson($core.String i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromJson(i, r);
...
class Type_MapType extends $pb.GeneratedMessage {
  ...
  Type_MapType() : super();
  Type_MapType.fromBuffer($core.List<$core.int> i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);
  Type_MapType.fromJson($core.String i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromJson(i, r);
...
class Type_FunctionType extends $pb.GeneratedMessage {
  ...
  Type_FunctionType.fromBuffer($core.List<$core.int> i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);
  Type_FunctionType.fromJson($core.String i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromJson(i, r);
  ...
  static Type_FunctionType getDefault() =>
...
class Type_AbstractType extends $pb.GeneratedMessage {
  ...
  Type_AbstractType.fromBuffer($core.List<$core.int> i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);
  Type_AbstractType.fromJson($core.String i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromJson(i, r);
  ...
  static Type_AbstractType getDefault() =>
      _defaultInstance ??= create()..freeze();
...
class Type extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Type',
      package: const $pb.PackageName('google.api.expr.v1alpha1'))
    ..a<$1.Empty>(
        1, 'dyn', $pb.PbFieldType.OM, $1.Empty.getDefault, $1.Empty.create)
    ..e<$2.NullValue>(2, 'null_2', $pb.PbFieldType.OE, $2.NullValue.NULL_VALUE,
        $2.NullValue.valueOf, $2.NullValue.values)
    ..e<Type_PrimitiveType>(
        3,
        'primitive',
        $pb.PbFieldType.OE,
        Type_PrimitiveType.PRIMITIVE_TYPE_UNSPECIFIED,
        Type_PrimitiveType.valueOf,
        Type_PrimitiveType.values)
    ..e<Type_PrimitiveType>(
        4,
        'wrapper',
        $pb.PbFieldType.OE,
    ...
    ..e<Type_WellKnownType>(
        ...
        Type_WellKnownType.valueOf,
        Type_WellKnownType.values)
    ..a<Type_ListType>(6, 'listType', $pb.PbFieldType.OM,
        Type_ListType.getDefault, Type_ListType.create)
    ..a<Type_MapType>(7, 'mapType', $pb.PbFieldType.OM, Type_MapType.getDefault,
        Type_MapType.create)
    ..a<Type_FunctionType>(8, 'function', $pb.PbFieldType.OM,
        Type_FunctionType.getDefault, Type_FunctionType.create)
    ..aOS(9, 'messageType')
    ..aOS(10, 'typeParam')
    ..a<Type>(11, 'type', $pb.PbFieldType.OM, Type.getDefault, Type.create)
    ..a<$1.Empty>(
        12, 'error', $pb.PbFieldType.OM, $1.Empty.getDefault, $1.Empty.create)
    ..a<Type_AbstractType>(14, 'abstractType', $pb.PbFieldType.OM,
        Type_AbstractType.getDefault, Type_AbstractType.create)
...
class Decl_IdentDecl extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Decl.IdentDecl',
    ...
    ..a<$0.Constant>(2, 'value', $pb.PbFieldType.OM, $0.Constant.getDefault,
        $0.Constant.create)
    ..aOS(3, 'doc')
    ..hasRequiredFields = false;

  Decl_IdentDecl() : super();
  Decl_IdentDecl.fromBuffer($core.List<$core.int> i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);
  Decl_IdentDecl.fromJson($core.String i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromJson(i, r);
...
class Decl_FunctionDecl_Overload extends $pb.GeneratedMessage {
  ...
  Decl_FunctionDecl_Overload.fromBuffer($core.List<$core.int> i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);
  Decl_FunctionDecl_Overload.fromJson($core.String i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromJson(i, r);
  ...
  static Decl_FunctionDecl_Overload getDefault() =>
      _defaultInstance ??= create()..freeze();
...
class Decl_FunctionDecl extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Decl.FunctionDecl',
    ...
    ..pc<Decl_FunctionDecl_Overload>(
        1, 'overloads', $pb.PbFieldType.PM, Decl_FunctionDecl_Overload.create)
    ..hasRequiredFields = false;

  Decl_FunctionDecl() : super();
  Decl_FunctionDecl.fromBuffer($core.List<$core.int> i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);
  Decl_FunctionDecl.fromJson($core.String i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromJson(i, r);
  ...
  static Decl_FunctionDecl getDefault() =>
      _defaultInstance ??= create()..freeze();
...
class Decl extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Decl',
      package: const $pb.PackageName('google.api.expr.v1alpha1'))
    ..aOS(1, 'name')
    ..a<Decl_IdentDecl>(2, 'ident', $pb.PbFieldType.OM,
        Decl_IdentDecl.getDefault, Decl_IdentDecl.create)
    ..a<Decl_FunctionDecl>(3, 'function', $pb.PbFieldType.OM,
        Decl_FunctionDecl.getDefault, Decl_FunctionDecl.create)
    ..oo(0, [2, 3])
    ..hasRequiredFields = false;
...
class Reference extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Reference',
    ...
    ..aOS(1, 'name')
    ..pPS(3, 'overloadId')
    ..a<$0.Constant>(4, 'value', $pb.PbFieldType.OM, $0.Constant.getDefault,
        $0.Constant.create)
    ..hasRequiredFields = false;
