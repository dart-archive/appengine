...
class Type_PrimitiveType extends $pb.ProtobufEnum {
  static const Type_PrimitiveType PRIMITIVE_TYPE_UNSPECIFIED = Type_PrimitiveType._(0, 'PRIMITIVE_TYPE_UNSPECIFIED');
...
class Type_WellKnownType extends $pb.ProtobufEnum {
  static const Type_WellKnownType WELL_KNOWN_TYPE_UNSPECIFIED = Type_WellKnownType._(0, 'WELL_KNOWN_TYPE_UNSPECIFIED');
  static const Type_WellKnownType ANY = Type_WellKnownType._(1, 'ANY');
  static const Type_WellKnownType TIMESTAMP = Type_WellKnownType._(2, 'TIMESTAMP');
  static const Type_WellKnownType DURATION = Type_WellKnownType._(3, 'DURATION');
