...
class Pose extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Pose',
      package: const $pb.PackageName('google.streetview.publish.v1'))
    ..a<$0.LatLng>(1, 'latLngPair', $pb.PbFieldType.OM, $0.LatLng.getDefault,
        $0.LatLng.create)
...
class Photo extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Photo',
      package: const $pb.PackageName('google.streetview.publish.v1'))
    ..a<PhotoId>(
        1, 'photoId', $pb.PbFieldType.OM, PhotoId.getDefault, PhotoId.create)
    ..a<UploadRef>(2, 'uploadReference', $pb.PbFieldType.OM,
        UploadRef.getDefault, UploadRef.create)
    ..aOS(3, 'downloadUrl')
    ...
    ..a<$1.Timestamp>(6, 'captureTime', $pb.PbFieldType.OM,
    ...
    ..e<Photo_TransferStatus>(
        ...
        'transferStatus',
        $pb.PbFieldType.OE,
        Photo_TransferStatus.TRANSFER_STATUS_UNKNOWN,
        Photo_TransferStatus.valueOf,
        Photo_TransferStatus.values)
    ..e<Photo_MapsPublishStatus>(
        13,
        'mapsPublishStatus',
        $pb.PbFieldType.OE,
        Photo_MapsPublishStatus.UNSPECIFIED_MAPS_PUBLISH_STATUS,
        Photo_MapsPublishStatus.valueOf,
