...
class UploadRef extends GeneratedMessage {
  ...
  UploadRef() : super();
  UploadRef.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  UploadRef.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
...
class PhotoId extends GeneratedMessage {
  ...
  PhotoId() : super();
  PhotoId.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  PhotoId.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
...
class Level extends GeneratedMessage {
  ...
  Level() : super();
  Level.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  Level.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ...
  set number(double v) { $_setDouble(0, v); }
...
class Pose extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('Pose')
    ..a<$google$type.LatLng>(1, 'latLngPair', PbFieldType.OM, $google$type.LatLng.getDefault, $google$type.LatLng.create)
  ...
  Pose() : super();
  Pose.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  Pose.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
...
class Place extends GeneratedMessage {
  ...
  Place() : super();
  Place.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  Place.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
...
class Connection extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('Connection')
    ..a<PhotoId>(1, 'target', PbFieldType.OM, PhotoId.getDefault, PhotoId.create)
    ..hasRequiredFields = false
  ;

  Connection() : super();
  Connection.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  Connection.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
...
class Photo extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('Photo')
    ..a<PhotoId>(1, 'photoId', PbFieldType.OM, PhotoId.getDefault, PhotoId.create)
    ..a<UploadRef>(2, 'uploadReference', PbFieldType.OM, UploadRef.getDefault, UploadRef.create)
    ..aOS(3, 'downloadUrl')
    ..a<Pose>(4, 'pose', PbFieldType.OM, Pose.getDefault, Pose.create)
    ..pp<Connection>(5, 'connections', PbFieldType.PM, Connection.$checkItem, Connection.create)
    ..a<$google$protobuf.Timestamp>(6, 'captureTime', PbFieldType.OM, $google$protobuf.Timestamp.getDefault, $google$protobuf.Timestamp.create)
  ...
  Photo() : super();
  Photo.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  Photo.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ...
  set downloadUrl(String v) { $_setString(2, v); }
  ...
  set captureTime($google$protobuf.Timestamp v) { setField(6, v); }
  ...
  set thumbnailUrl(String v) { $_setString(7, v); }
  ...
  set shareLink(String v) { $_setString(9, v); }
