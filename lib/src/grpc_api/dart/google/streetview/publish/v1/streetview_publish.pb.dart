...
class StreetViewPublishServiceApi {
  ...
  $async.Future<$2.BatchUpdatePhotosResponse> batchUpdatePhotos(
      $pb.ClientContext ctx, $2.BatchUpdatePhotosRequest request) {
    var emptyResponse = $2.BatchUpdatePhotosResponse();
    return _client.invoke<$2.BatchUpdatePhotosResponse>(
        ctx,
  ...
  $async.Future<$0.Empty> deletePhoto(
      $pb.ClientContext ctx, $2.DeletePhotoRequest request) {
  ...
  $async.Future<$2.BatchDeletePhotosResponse> batchDeletePhotos(
      $pb.ClientContext ctx, $2.BatchDeletePhotosRequest request) {
    var emptyResponse = $2.BatchDeletePhotosResponse();
    return _client.invoke<$2.BatchDeletePhotosResponse>(
        ctx,
        'StreetViewPublishService',
        'BatchDeletePhotos',
        request,
