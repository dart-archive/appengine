...
abstract class StreetViewPublishServiceBase extends $pb.GeneratedService {
  ...
  $async.Future<$1.Photo> createPhoto(
      $pb.ServerContext ctx, $2.CreatePhotoRequest request);
  $async.Future<$1.Photo> getPhoto(
      $pb.ServerContext ctx, $2.GetPhotoRequest request);
  $async.Future<$2.BatchGetPhotosResponse> batchGetPhotos(
      $pb.ServerContext ctx, $2.BatchGetPhotosRequest request);
  $async.Future<$2.ListPhotosResponse> listPhotos(
      $pb.ServerContext ctx, $2.ListPhotosRequest request);
  $async.Future<$1.Photo> updatePhoto(
      $pb.ServerContext ctx, $2.UpdatePhotoRequest request);
  $async.Future<$2.BatchUpdatePhotosResponse> batchUpdatePhotos(
      $pb.ServerContext ctx, $2.BatchUpdatePhotosRequest request);
  $async.Future<$0.Empty> deletePhoto(
      $pb.ServerContext ctx, $2.DeletePhotoRequest request);
  $async.Future<$2.BatchDeletePhotosResponse> batchDeletePhotos(
      $pb.ServerContext ctx, $2.BatchDeletePhotosRequest request);
  ...
  $pb.GeneratedMessage createRequest($core.String method) {
    switch (method) {
      case 'StartUpload':
        return $0.Empty();
      case 'CreatePhoto':
        return $2.CreatePhotoRequest();
      case 'GetPhoto':
        return $2.GetPhotoRequest();
      case 'BatchGetPhotos':
        return $2.BatchGetPhotosRequest();
      case 'ListPhotos':
        return $2.ListPhotosRequest();
      case 'UpdatePhoto':
        return $2.UpdatePhotoRequest();
      case 'BatchUpdatePhotos':
        return $2.BatchUpdatePhotosRequest();
      case 'DeletePhoto':
        return $2.DeletePhotoRequest();
      case 'BatchDeletePhotos':
        return $2.BatchDeletePhotosRequest();
      default:
  ...
  $core.Map<$core.String, $core.dynamic> get $json =>
      StreetViewPublishServiceBase$json;
  $core.Map<$core.String, $core.Map<$core.String, $core.dynamic>>
      get $messageJson => StreetViewPublishServiceBase$messageJson;
}
