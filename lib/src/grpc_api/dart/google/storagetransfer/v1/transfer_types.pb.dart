...
class GoogleServiceAccount extends GeneratedMessage {
  ...
  set accountEmail(String v) { $_setString(0, v); }
...
class ObjectConditions extends GeneratedMessage {
  ...
  $google$protobuf.Duration get minTimeElapsedSinceLastModification => $_getN(0);
  set minTimeElapsedSinceLastModification($google$protobuf.Duration v) { setField(1, v); }
  bool hasMinTimeElapsedSinceLastModification() => $_has(0);
  void clearMinTimeElapsedSinceLastModification() => clearField(1);

  $google$protobuf.Duration get maxTimeElapsedSinceLastModification => $_getN(1);
  set maxTimeElapsedSinceLastModification($google$protobuf.Duration v) { setField(2, v); }
...
class GcsData extends GeneratedMessage {
  ...
  set bucketName(String v) { $_setString(0, v); }
...
class HttpData extends GeneratedMessage {
  ...
  set listUrl(String v) { $_setString(0, v); }
...
class TransferOptions extends GeneratedMessage {
  ...
  set overwriteObjectsAlreadyExistingInSink(bool v) { $_setBool(0, v); }
  ...
  set deleteObjectsUniqueInSink(bool v) { $_setBool(1, v); }
  ...
  set deleteObjectsFromSourceAfterTransfer(bool v) { $_setBool(2, v); }
...
class TransferJob extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('TransferJob')
    ...
    ..e<TransferJob_Status>(6, 'status', PbFieldType.OE, TransferJob_Status.STATUS_UNSPECIFIED, TransferJob_Status.valueOf, TransferJob_Status.values)
  ...
  set creationTime($google$protobuf.Timestamp v) { setField(7, v); }
  bool hasCreationTime() => $_has(6);
  void clearCreationTime() => clearField(7);

  $google$protobuf.Timestamp get lastModificationTime => $_getN(7);
  set lastModificationTime($google$protobuf.Timestamp v) { setField(8, v); }
  ...
  set deletionTime($google$protobuf.Timestamp v) { setField(9, v); }
...
class ErrorSummary extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('ErrorSummary')
    ..e<$google$rpc.Code>(1, 'errorCode', PbFieldType.OE, $google$rpc.Code.OK, $google$rpc.Code.valueOf, $google$rpc.Code.values)
    ..aInt64(2, 'errorCount')
  ...
  set errorCode($google$rpc.Code v) { setField(1, v); }
...
class TransferOperation extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('TransferOperation')
    ...
    ..e<TransferOperation_Status>(6, 'status', PbFieldType.OE, TransferOperation_Status.STATUS_UNSPECIFIED, TransferOperation_Status.valueOf, TransferOperation_Status.values)
  ...
  set transferJobName(String v) { $_setString(8, v); }
