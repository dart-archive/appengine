...
class ComparisonType extends ProtobufEnum {
  static const ComparisonType COMPARISON_UNSPECIFIED = const ComparisonType._(0, 'COMPARISON_UNSPECIFIED');
  static const ComparisonType COMPARISON_GT = const ComparisonType._(1, 'COMPARISON_GT');
  static const ComparisonType COMPARISON_GE = const ComparisonType._(2, 'COMPARISON_GE');
  static const ComparisonType COMPARISON_LT = const ComparisonType._(3, 'COMPARISON_LT');
  static const ComparisonType COMPARISON_LE = const ComparisonType._(4, 'COMPARISON_LE');
  static const ComparisonType COMPARISON_EQ = const ComparisonType._(5, 'COMPARISON_EQ');
  static const ComparisonType COMPARISON_NE = const ComparisonType._(6, 'COMPARISON_NE');
...
class ServiceTier extends ProtobufEnum {
  static const ServiceTier SERVICE_TIER_UNSPECIFIED = const ServiceTier._(0, 'SERVICE_TIER_UNSPECIFIED');
  static const ServiceTier SERVICE_TIER_BASIC = const ServiceTier._(1, 'SERVICE_TIER_BASIC');
  static const ServiceTier SERVICE_TIER_PREMIUM = const ServiceTier._(2, 'SERVICE_TIER_PREMIUM');
...
class Aggregation_Aligner extends ProtobufEnum {
  ...
  static const Aggregation_Aligner ALIGN_COUNT_FALSE = const Aggregation_Aligner._(24, 'ALIGN_COUNT_FALSE');
  ...
  static const Aggregation_Aligner ALIGN_PERCENT_CHANGE = const Aggregation_Aligner._(23, 'ALIGN_PERCENT_CHANGE');
...
class Aggregation_Reducer extends ProtobufEnum {
  ...
  static const Aggregation_Reducer REDUCE_COUNT_FALSE = const Aggregation_Reducer._(15, 'REDUCE_COUNT_FALSE');
