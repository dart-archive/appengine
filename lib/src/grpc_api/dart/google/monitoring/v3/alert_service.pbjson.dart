...
const AlertPolicyService$messageJson = const {
  ...
  '.google.monitoring.v3.AlertPolicy.Condition.MetricThreshold': AlertPolicy_Condition_MetricThreshold$json,
  '.google.protobuf.Duration': $google$protobuf.Duration$json,
  '.google.monitoring.v3.AlertPolicy.Condition.Trigger': AlertPolicy_Condition_Trigger$json,
  '.google.monitoring.v3.Aggregation': Aggregation$json,
  '.google.monitoring.v3.AlertPolicy.Condition.MetricAbsence': AlertPolicy_Condition_MetricAbsence$json,
  '.google.monitoring.v3.AlertPolicy.Documentation': AlertPolicy_Documentation$json,
  '.google.monitoring.v3.AlertPolicy.UserLabelsEntry': AlertPolicy_UserLabelsEntry$json,
