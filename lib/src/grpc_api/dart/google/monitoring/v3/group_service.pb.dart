...
class ListGroupsRequest extends GeneratedMessage {
  ...
  ListGroupsRequest.fromBuffer(List<int> i,
  ...
  set descendantsOfGroup(String v) {
    $_setString(2, v);
  }
...
class _ReadonlyListGroupsRequest extends ListGroupsRequest
...
class ListGroupsResponse extends GeneratedMessage {
  ...
  ListGroupsResponse.fromBuffer(List<int> i,
      [ExtensionRegistry r = ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);
...
class _ReadonlyListGroupsResponse extends ListGroupsResponse
    with ReadonlyMessageMixin {}
...
class CreateGroupRequest extends GeneratedMessage {
  ...
  CreateGroupRequest.fromBuffer(List<int> i,
      [ExtensionRegistry r = ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);
...
class _ReadonlyCreateGroupRequest extends CreateGroupRequest
    with ReadonlyMessageMixin {}
...
class DeleteGroupRequest extends GeneratedMessage {
  ...
  DeleteGroupRequest.fromBuffer(List<int> i,
      [ExtensionRegistry r = ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);
...
class _ReadonlyDeleteGroupRequest extends DeleteGroupRequest
    with ReadonlyMessageMixin {}
...
class ListGroupMembersRequest extends GeneratedMessage {
  static final BuilderInfo _i = BuilderInfo('ListGroupMembersRequest')
    ...
    ..aOS(4, 'pageToken')
    ..aOS(5, 'filter')
    ..a<TimeInterval>(6, 'interval', PbFieldType.OM, TimeInterval.getDefault,
        TimeInterval.create)
    ..aOS(7, 'name')
    ..hasRequiredFields = false;

  ListGroupMembersRequest() : super();
  ListGroupMembersRequest.fromBuffer(List<int> i,
      [ExtensionRegistry r = ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);
  ListGroupMembersRequest.fromJson(String i,
      [ExtensionRegistry r = ExtensionRegistry.EMPTY])
      : super.fromJson(i, r);
  ...
  static void $checkItem(ListGroupMembersRequest v) {
    if (v is! ListGroupMembersRequest)
      checkItemFailed(v, 'ListGroupMembersRequest');
  }
...
class _ReadonlyListGroupMembersRequest extends ListGroupMembersRequest
    with ReadonlyMessageMixin {}
...
class ListGroupMembersResponse extends GeneratedMessage {
  static final BuilderInfo _i = BuilderInfo('ListGroupMembersResponse')
    ..pp<$google$api.MonitoredResource>(
        ...
        'members',
        PbFieldType.PM,
        $google$api.MonitoredResource.$checkItem,
  ...
  ListGroupMembersResponse.fromBuffer(List<int> i,
      [ExtensionRegistry r = ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);
  ListGroupMembersResponse.fromJson(String i,
      [ExtensionRegistry r = ExtensionRegistry.EMPTY])
      : super.fromJson(i, r);
  ...
  static void $checkItem(ListGroupMembersResponse v) {
    if (v is! ListGroupMembersResponse)
      checkItemFailed(v, 'ListGroupMembersResponse');
  }
...
class _ReadonlyListGroupMembersResponse extends ListGroupMembersResponse
    with ReadonlyMessageMixin {}
