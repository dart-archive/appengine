...
class ListGroupsRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ListGroupsRequest', package: const $pb.PackageName('google.monitoring.v3'))
  ...
  ListGroupsRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  ListGroupsRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
...
class ListGroupsResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ListGroupsResponse', package: const $pb.PackageName('google.monitoring.v3'))
  ...
  ListGroupsResponse.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  ListGroupsResponse.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ListGroupsResponse clone() => ListGroupsResponse()..mergeFromMessage(this);
  ListGroupsResponse copyWith(void Function(ListGroupsResponse) updates) => super.copyWith((message) => updates(message as ListGroupsResponse));
  $pb.BuilderInfo get info_ => _i;
  ...
  static ListGroupsResponse getDefault() => _defaultInstance ??= create()..freeze();
...
class GetGroupRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('GetGroupRequest', package: const $pb.PackageName('google.monitoring.v3'))
    ..aOS(3, 'name')
    ..hasRequiredFields = false
  ;
...
class CreateGroupRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('CreateGroupRequest', package: const $pb.PackageName('google.monitoring.v3'))
    ..a<$0.Group>(2, 'group', $pb.PbFieldType.OM, $0.Group.getDefault, $0.Group.create)
    ..aOB(3, 'validateOnly')
    ..aOS(4, 'name')
    ..hasRequiredFields = false
  ;
  ...
  CreateGroupRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  CreateGroupRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ...
  set group($0.Group v) { setField(2, v); }
...
class UpdateGroupRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('UpdateGroupRequest', package: const $pb.PackageName('google.monitoring.v3'))
    ..a<$0.Group>(2, 'group', $pb.PbFieldType.OM, $0.Group.getDefault, $0.Group.create)
    ..aOB(3, 'validateOnly')
    ..hasRequiredFields = false
  ;
...
class DeleteGroupRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('DeleteGroupRequest', package: const $pb.PackageName('google.monitoring.v3'))
    ..aOS(3, 'name')
    ..hasRequiredFields = false
  ;

  DeleteGroupRequest() : super();
  DeleteGroupRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  DeleteGroupRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
...
class ListGroupMembersRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ListGroupMembersRequest', package: const $pb.PackageName('google.monitoring.v3'))
    ..a<$core.int>(3, 'pageSize', $pb.PbFieldType.O3)
    ..aOS(4, 'pageToken')
    ..aOS(5, 'filter')
    ..a<$1.TimeInterval>(6, 'interval', $pb.PbFieldType.OM, $1.TimeInterval.getDefault, $1.TimeInterval.create)
    ..aOS(7, 'name')
    ..hasRequiredFields = false
  ;

  ListGroupMembersRequest() : super();
  ListGroupMembersRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  ListGroupMembersRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ListGroupMembersRequest clone() => ListGroupMembersRequest()..mergeFromMessage(this);
  ListGroupMembersRequest copyWith(void Function(ListGroupMembersRequest) updates) => super.copyWith((message) => updates(message as ListGroupMembersRequest));
  $pb.BuilderInfo get info_ => _i;
  ...
  static ListGroupMembersRequest getDefault() => _defaultInstance ??= create()..freeze();
  ...
  set interval($1.TimeInterval v) { setField(6, v); }
...
class ListGroupMembersResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ListGroupMembersResponse', package: const $pb.PackageName('google.monitoring.v3'))
    ..pc<$2.MonitoredResource>(1, 'members', $pb.PbFieldType.PM,$2.MonitoredResource.create)
    ..aOS(2, 'nextPageToken')
  ...
  ListGroupMembersResponse.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  ListGroupMembersResponse.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ListGroupMembersResponse clone() => ListGroupMembersResponse()..mergeFromMessage(this);
  ListGroupMembersResponse copyWith(void Function(ListGroupMembersResponse) updates) => super.copyWith((message) => updates(message as ListGroupMembersResponse));
  $pb.BuilderInfo get info_ => _i;
  ...
  static ListGroupMembersResponse getDefault() => _defaultInstance ??= create()..freeze();
...
class GroupServiceApi {
  ...
  $async.Future<$0.Group> getGroup($pb.ClientContext ctx, GetGroupRequest request) {
    var emptyResponse = $0.Group();
    return _client.invoke<$0.Group>(ctx, 'GroupService', 'GetGroup', request, emptyResponse);
  }
  $async.Future<$0.Group> createGroup($pb.ClientContext ctx, CreateGroupRequest request) {
    var emptyResponse = $0.Group();
    return _client.invoke<$0.Group>(ctx, 'GroupService', 'CreateGroup', request, emptyResponse);
  }
  $async.Future<$0.Group> updateGroup($pb.ClientContext ctx, UpdateGroupRequest request) {
    var emptyResponse = $0.Group();
    return _client.invoke<$0.Group>(ctx, 'GroupService', 'UpdateGroup', request, emptyResponse);
  }
  $async.Future<$3.Empty> deleteGroup($pb.ClientContext ctx, DeleteGroupRequest request) {
    var emptyResponse = $3.Empty();
    return _client.invoke<$3.Empty>(ctx, 'GroupService', 'DeleteGroup', request, emptyResponse);
  }
  $async.Future<ListGroupMembersResponse> listGroupMembers($pb.ClientContext ctx, ListGroupMembersRequest request) {
