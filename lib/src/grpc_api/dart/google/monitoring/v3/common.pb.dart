...
class TypedValue extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('TypedValue', package: const $pb.PackageName('google.monitoring.v3'))
    ..aOB(1, 'boolValue')
    ..aInt64(2, 'int64Value')
    ..a<$core.double>(3, 'doubleValue', $pb.PbFieldType.OD)
    ..aOS(4, 'stringValue')
    ..a<$0.Distribution>(5, 'distributionValue', $pb.PbFieldType.OM, $0.Distribution.getDefault, $0.Distribution.create)
    ..oo(0, [1, 2, 3, 4, 5])
    ..hasRequiredFields = false
  ;

  TypedValue() : super();
  TypedValue.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  TypedValue.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  TypedValue clone() => TypedValue()..mergeFromMessage(this);
  TypedValue copyWith(void Function(TypedValue) updates) => super.copyWith((message) => updates(message as TypedValue));
...
class TimeInterval extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('TimeInterval', package: const $pb.PackageName('google.monitoring.v3'))
...
class Aggregation extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Aggregation', package: const $pb.PackageName('google.monitoring.v3'))
    ..a<$2.Duration>(1, 'alignmentPeriod', $pb.PbFieldType.OM, $2.Duration.getDefault, $2.Duration.create)
    ..e<Aggregation_Aligner>(2, 'perSeriesAligner', $pb.PbFieldType.OE, Aggregation_Aligner.ALIGN_NONE, Aggregation_Aligner.valueOf, Aggregation_Aligner.values)
    ..e<Aggregation_Reducer>(4, 'crossSeriesReducer', $pb.PbFieldType.OE, Aggregation_Reducer.REDUCE_NONE, Aggregation_Reducer.valueOf, Aggregation_Reducer.values)
    ..pPS(5, 'groupByFields')
    ..hasRequiredFields = false
  ;

  Aggregation() : super();
  Aggregation.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  Aggregation.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  Aggregation clone() => Aggregation()..mergeFromMessage(this);
  Aggregation copyWith(void Function(Aggregation) updates) => super.copyWith((message) => updates(message as Aggregation));
  $pb.BuilderInfo get info_ => _i;
