...
class UptimeCheckRegion extends $pb.ProtobufEnum {
  static const UptimeCheckRegion REGION_UNSPECIFIED = UptimeCheckRegion._(0, 'REGION_UNSPECIFIED');
  ...
  static const UptimeCheckRegion SOUTH_AMERICA = UptimeCheckRegion._(3, 'SOUTH_AMERICA');
  static const UptimeCheckRegion ASIA_PACIFIC = UptimeCheckRegion._(4, 'ASIA_PACIFIC');
...
class GroupResourceType extends $pb.ProtobufEnum {
  static const GroupResourceType RESOURCE_TYPE_UNSPECIFIED = GroupResourceType._(0, 'RESOURCE_TYPE_UNSPECIFIED');
  static const GroupResourceType INSTANCE = GroupResourceType._(1, 'INSTANCE');
  static const GroupResourceType AWS_ELB_LOAD_BALANCER = GroupResourceType._(2, 'AWS_ELB_LOAD_BALANCER');
