...
class AlertPolicy_Documentation extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('AlertPolicy.Documentation', package: const $pb.PackageName('google.monitoring.v3'))
    ..aOS(1, 'content')
    ..aOS(2, 'mimeType')
  ...
  AlertPolicy_Documentation.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  AlertPolicy_Documentation.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  AlertPolicy_Documentation clone() => AlertPolicy_Documentation()..mergeFromMessage(this);
  AlertPolicy_Documentation copyWith(void Function(AlertPolicy_Documentation) updates) => super.copyWith((message) => updates(message as AlertPolicy_Documentation));
  ...
  static AlertPolicy_Documentation getDefault() => _defaultInstance ??= create()..freeze();
...
class AlertPolicy_Condition_Trigger extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('AlertPolicy.Condition.Trigger', package: const $pb.PackageName('google.monitoring.v3'))
  ...
  AlertPolicy_Condition_Trigger.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  AlertPolicy_Condition_Trigger.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  AlertPolicy_Condition_Trigger clone() => AlertPolicy_Condition_Trigger()..mergeFromMessage(this);
  AlertPolicy_Condition_Trigger copyWith(void Function(AlertPolicy_Condition_Trigger) updates) => super.copyWith((message) => updates(message as AlertPolicy_Condition_Trigger));
  $pb.BuilderInfo get info_ => _i;
  static AlertPolicy_Condition_Trigger create() => AlertPolicy_Condition_Trigger();
  ...
  static AlertPolicy_Condition_Trigger getDefault() => _defaultInstance ??= create()..freeze();
...
class AlertPolicy_Condition_MetricThreshold extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('AlertPolicy.Condition.MetricThreshold', package: const $pb.PackageName('google.monitoring.v3'))
    ..aOS(2, 'filter')
    ..e<$3.ComparisonType>(4, 'comparison', $pb.PbFieldType.OE, $3.ComparisonType.COMPARISON_UNSPECIFIED, $3.ComparisonType.valueOf, $3.ComparisonType.values)
    ..a<$core.double>(5, 'thresholdValue', $pb.PbFieldType.OD)
    ..a<$2.Duration>(6, 'duration', $pb.PbFieldType.OM, $2.Duration.getDefault, $2.Duration.create)
    ..a<AlertPolicy_Condition_Trigger>(7, 'trigger', $pb.PbFieldType.OM, AlertPolicy_Condition_Trigger.getDefault, AlertPolicy_Condition_Trigger.create)
    ..pc<$3.Aggregation>(8, 'aggregations', $pb.PbFieldType.PM,$3.Aggregation.create)
    ..aOS(9, 'denominatorFilter')
    ..pc<$3.Aggregation>(10, 'denominatorAggregations', $pb.PbFieldType.PM,$3.Aggregation.create)
    ..hasRequiredFields = false
  ;

  AlertPolicy_Condition_MetricThreshold() : super();
  AlertPolicy_Condition_MetricThreshold.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  AlertPolicy_Condition_MetricThreshold.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  AlertPolicy_Condition_MetricThreshold clone() => AlertPolicy_Condition_MetricThreshold()..mergeFromMessage(this);
  AlertPolicy_Condition_MetricThreshold copyWith(void Function(AlertPolicy_Condition_MetricThreshold) updates) => super.copyWith((message) => updates(message as AlertPolicy_Condition_MetricThreshold));
  $pb.BuilderInfo get info_ => _i;
  static AlertPolicy_Condition_MetricThreshold create() => AlertPolicy_Condition_MetricThreshold();
  ...
  static AlertPolicy_Condition_MetricThreshold getDefault() => _defaultInstance ??= create()..freeze();
  ...
  set comparison($3.ComparisonType v) { setField(4, v); }
...
class AlertPolicy_Condition_MetricAbsence extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('AlertPolicy.Condition.MetricAbsence', package: const $pb.PackageName('google.monitoring.v3'))
    ..aOS(1, 'filter')
    ..a<$2.Duration>(2, 'duration', $pb.PbFieldType.OM, $2.Duration.getDefault, $2.Duration.create)
    ..a<AlertPolicy_Condition_Trigger>(3, 'trigger', $pb.PbFieldType.OM, AlertPolicy_Condition_Trigger.getDefault, AlertPolicy_Condition_Trigger.create)
    ..pc<$3.Aggregation>(5, 'aggregations', $pb.PbFieldType.PM,$3.Aggregation.create)
    ..hasRequiredFields = false
  ;

  AlertPolicy_Condition_MetricAbsence() : super();
  AlertPolicy_Condition_MetricAbsence.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  AlertPolicy_Condition_MetricAbsence.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  AlertPolicy_Condition_MetricAbsence clone() => AlertPolicy_Condition_MetricAbsence()..mergeFromMessage(this);
  AlertPolicy_Condition_MetricAbsence copyWith(void Function(AlertPolicy_Condition_MetricAbsence) updates) => super.copyWith((message) => updates(message as AlertPolicy_Condition_MetricAbsence));
  $pb.BuilderInfo get info_ => _i;
  static AlertPolicy_Condition_MetricAbsence create() => AlertPolicy_Condition_MetricAbsence();
  ...
  static AlertPolicy_Condition_MetricAbsence getDefault() => _defaultInstance ??= create()..freeze();
...
class AlertPolicy_Condition extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('AlertPolicy.Condition', package: const $pb.PackageName('google.monitoring.v3'))
    ..a<AlertPolicy_Condition_MetricThreshold>(1, 'conditionThreshold', $pb.PbFieldType.OM, AlertPolicy_Condition_MetricThreshold.getDefault, AlertPolicy_Condition_MetricThreshold.create)
    ..a<AlertPolicy_Condition_MetricAbsence>(2, 'conditionAbsent', $pb.PbFieldType.OM, AlertPolicy_Condition_MetricAbsence.getDefault, AlertPolicy_Condition_MetricAbsence.create)
    ..aOS(6, 'displayName')
    ..aOS(12, 'name')
    ..oo(0, [1, 2])
    ..hasRequiredFields = false
  ...
  AlertPolicy_Condition.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  AlertPolicy_Condition.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  AlertPolicy_Condition clone() => AlertPolicy_Condition()..mergeFromMessage(this);
  AlertPolicy_Condition copyWith(void Function(AlertPolicy_Condition) updates) => super.copyWith((message) => updates(message as AlertPolicy_Condition));
  $pb.BuilderInfo get info_ => _i;
  ...
  static AlertPolicy_Condition getDefault() => _defaultInstance ??= create()..freeze();
...
class AlertPolicy extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('AlertPolicy', package: const $pb.PackageName('google.monitoring.v3'))
    ..aOS(1, 'name')
    ..aOS(2, 'displayName')
    ..e<AlertPolicy_ConditionCombinerType>(6, 'combiner', $pb.PbFieldType.OE, AlertPolicy_ConditionCombinerType.COMBINE_UNSPECIFIED, AlertPolicy_ConditionCombinerType.valueOf, AlertPolicy_ConditionCombinerType.values)
    ..a<$0.MutationRecord>(10, 'creationRecord', $pb.PbFieldType.OM, $0.MutationRecord.getDefault, $0.MutationRecord.create)
    ..a<$0.MutationRecord>(11, 'mutationRecord', $pb.PbFieldType.OM, $0.MutationRecord.getDefault, $0.MutationRecord.create)
    ..pc<AlertPolicy_Condition>(12, 'conditions', $pb.PbFieldType.PM,AlertPolicy_Condition.create)
    ..a<AlertPolicy_Documentation>(13, 'documentation', $pb.PbFieldType.OM, AlertPolicy_Documentation.getDefault, AlertPolicy_Documentation.create)
    ..pPS(14, 'notificationChannels')
    ..m<$core.String, $core.String>(16, 'userLabels', 'AlertPolicy.UserLabelsEntry',$pb.PbFieldType.OS, $pb.PbFieldType.OS, null, null, null , const $pb.PackageName('google.monitoring.v3'))
    ..a<$1.BoolValue>(17, 'enabled', $pb.PbFieldType.OM, $1.BoolValue.getDefault, $1.BoolValue.create)
    ..hasRequiredFields = false
  ;

  AlertPolicy() : super();
  AlertPolicy.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  AlertPolicy.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  AlertPolicy clone() => AlertPolicy()..mergeFromMessage(this);
  AlertPolicy copyWith(void Function(AlertPolicy) updates) => super.copyWith((message) => updates(message as AlertPolicy));
  $pb.BuilderInfo get info_ => _i;
