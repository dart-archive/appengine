...
class InternalChecker extends $pb.GeneratedMessage {
  ...
  static InternalChecker getDefault() =>
...
class UptimeCheckConfig extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('UptimeCheckConfig',
    ...
    ..a<$1.Duration>(7, 'period', $pb.PbFieldType.OM, $1.Duration.getDefault,
        $1.Duration.create)
    ..a<$1.Duration>(8, 'timeout', $pb.PbFieldType.OM, $1.Duration.getDefault,
        $1.Duration.create)
    ..pc<UptimeCheckConfig_ContentMatcher>(9, 'contentMatchers',
        $pb.PbFieldType.PM, UptimeCheckConfig_ContentMatcher.create)
    ..pc<UptimeCheckRegion>(10, 'selectedRegions', $pb.PbFieldType.PE, null,
        UptimeCheckRegion.valueOf, UptimeCheckRegion.values)
    ..pc<InternalChecker>(
