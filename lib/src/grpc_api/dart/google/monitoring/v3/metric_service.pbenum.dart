...
class ListTimeSeriesRequest_TimeSeriesView extends ProtobufEnum {
  ...
  static ListTimeSeriesRequest_TimeSeriesView valueOf(int value) =>
      _byValue[value] as ListTimeSeriesRequest_TimeSeriesView;
  static void $checkItem(ListTimeSeriesRequest_TimeSeriesView v) {
    if (v is! ListTimeSeriesRequest_TimeSeriesView)
      checkItemFailed(v, 'ListTimeSeriesRequest_TimeSeriesView');
  }
