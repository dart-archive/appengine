...
abstract class GroupServiceBase extends $pb.GeneratedService {
  $async.Future<ListGroupsResponse> listGroups($pb.ServerContext ctx, ListGroupsRequest request);
  $async.Future<$0.Group> getGroup($pb.ServerContext ctx, GetGroupRequest request);
  $async.Future<$0.Group> createGroup($pb.ServerContext ctx, CreateGroupRequest request);
  $async.Future<$0.Group> updateGroup($pb.ServerContext ctx, UpdateGroupRequest request);
  $async.Future<$3.Empty> deleteGroup($pb.ServerContext ctx, DeleteGroupRequest request);
  $async.Future<ListGroupMembersResponse> listGroupMembers($pb.ServerContext ctx, ListGroupMembersRequest request);

  $pb.GeneratedMessage createRequest($core.String method) {
    switch (method) {
      case 'ListGroups': return ListGroupsRequest();
      case 'GetGroup': return GetGroupRequest();
      case 'CreateGroup': return CreateGroupRequest();
      case 'UpdateGroup': return UpdateGroupRequest();
      case 'DeleteGroup': return DeleteGroupRequest();
      case 'ListGroupMembers': return ListGroupMembersRequest();
