...
class NotificationChannelDescriptor extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('NotificationChannelDescriptor')
    ...
    ..aOS(2, 'displayName')
    ..aOS(3, 'description')
    ..pp<$google$api.LabelDescriptor>(
        4,
        'labels',
        PbFieldType.PM,
        $google$api.LabelDescriptor.$checkItem,
        $google$api.LabelDescriptor.create)
    ..pp<ServiceTier>(5, 'supportedTiers', PbFieldType.PE,
        ServiceTier.$checkItem, null, ServiceTier.valueOf, ServiceTier.values)
    ..aOS(6, 'name')
    ..hasRequiredFields = false;

  NotificationChannelDescriptor() : super();
  NotificationChannelDescriptor.fromBuffer(List<int> i,
      [ExtensionRegistry r = ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);
  NotificationChannelDescriptor.fromJson(String i,
      [ExtensionRegistry r = ExtensionRegistry.EMPTY])
      : super.fromJson(i, r);
  ...
  static void $checkItem(NotificationChannelDescriptor v) {
    if (v is! NotificationChannelDescriptor)
      checkItemFailed(v, 'NotificationChannelDescriptor');
  }
...
class _ReadonlyNotificationChannelDescriptor
...
class NotificationChannel_LabelsEntry extends GeneratedMessage {
  ...
  NotificationChannel_LabelsEntry.fromBuffer(List<int> i,
      [ExtensionRegistry r = ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);
  NotificationChannel_LabelsEntry.fromJson(String i,
      [ExtensionRegistry r = ExtensionRegistry.EMPTY])
      : super.fromJson(i, r);
  ...
  static void $checkItem(NotificationChannel_LabelsEntry v) {
    if (v is! NotificationChannel_LabelsEntry)
      checkItemFailed(v, 'NotificationChannel_LabelsEntry');
  }
...
class _ReadonlyNotificationChannel_LabelsEntry
    extends NotificationChannel_LabelsEntry with ReadonlyMessageMixin {}
...
class NotificationChannel_UserLabelsEntry extends GeneratedMessage {
  ...
  NotificationChannel_UserLabelsEntry.fromBuffer(List<int> i,
      [ExtensionRegistry r = ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);
  NotificationChannel_UserLabelsEntry.fromJson(String i,
      [ExtensionRegistry r = ExtensionRegistry.EMPTY])
      : super.fromJson(i, r);
  ...
  static void $checkItem(NotificationChannel_UserLabelsEntry v) {
    if (v is! NotificationChannel_UserLabelsEntry)
      checkItemFailed(v, 'NotificationChannel_UserLabelsEntry');
  }
...
class _ReadonlyNotificationChannel_UserLabelsEntry
...
class NotificationChannel extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('NotificationChannel')
    ...
    ..aOS(3, 'displayName')
    ..aOS(4, 'description')
    ..pp<NotificationChannel_LabelsEntry>(
        5,
        'labels',
        PbFieldType.PM,
        NotificationChannel_LabelsEntry.$checkItem,
        NotificationChannel_LabelsEntry.create)
    ..aOS(6, 'name')
    ..pp<NotificationChannel_UserLabelsEntry>(
        8,
        'userLabels',
        PbFieldType.PM,
        NotificationChannel_UserLabelsEntry.$checkItem,
        NotificationChannel_UserLabelsEntry.create)
  ...
  NotificationChannel.fromBuffer(List<int> i,
      [ExtensionRegistry r = ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);
...
class _ReadonlyNotificationChannel extends NotificationChannel
