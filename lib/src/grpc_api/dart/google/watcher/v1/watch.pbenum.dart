...
class Change_State extends $pb.ProtobufEnum {
  ...
  static const Change_State DOES_NOT_EXIST = Change_State._(1, 'DOES_NOT_EXIST');
  static const Change_State INITIAL_STATE_SKIPPED = Change_State._(2, 'INITIAL_STATE_SKIPPED');
