...
class Request extends GeneratedMessage {
  ...
  set resumeMarker(List<int> v) { $_setBytes(1, v); }
...
class ChangeBatch extends GeneratedMessage {
  ...
  ChangeBatch() : super();
  ChangeBatch.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  ChangeBatch.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
...
class Change extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('Change')
    ..aOS(1, 'element')
    ..e<Change_State>(2, 'state', PbFieldType.OE, Change_State.EXISTS, Change_State.valueOf, Change_State.values)
    ..a<List<int>>(4, 'resumeMarker', PbFieldType.OY)
    ..aOB(5, 'continued')
    ..a<$google$protobuf.Any>(6, 'data', PbFieldType.OM, $google$protobuf.Any.getDefault, $google$protobuf.Any.create)
    ..hasRequiredFields = false
  ;

  Change() : super();
  Change.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  Change.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
