...
class ServiceAccount extends GeneratedMessage {
  ...
  set uniqueId(String v) { $_setString(2, v); }
  ...
  set etag(List<int> v) { $_setBytes(5, v); }
  bool hasEtag() => $_has(5);
  void clearEtag() => clearField(7);

  String get oauth2ClientId => $_getS(6, '');
  set oauth2ClientId(String v) { $_setString(6, v); }
...
class ListServiceAccountKeysRequest extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('ListServiceAccountKeysRequest')
    ..aOS(1, 'name')
    ..pp<ListServiceAccountKeysRequest_KeyType>(2, 'keyTypes', PbFieldType.PE, ListServiceAccountKeysRequest_KeyType.$checkItem, null, ListServiceAccountKeysRequest_KeyType.valueOf, ListServiceAccountKeysRequest_KeyType.values)
    ..hasRequiredFields = false
  ;
...
class GetServiceAccountKeyRequest extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('GetServiceAccountKeyRequest')
    ..aOS(1, 'name')
    ..e<ServiceAccountPublicKeyType>(2, 'publicKeyType', PbFieldType.OE, ServiceAccountPublicKeyType.TYPE_NONE, ServiceAccountPublicKeyType.valueOf, ServiceAccountPublicKeyType.values)
    ..hasRequiredFields = false
  ;
...
class ServiceAccountKey extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('ServiceAccountKey')
    ..aOS(1, 'name')
    ..e<ServiceAccountPrivateKeyType>(2, 'privateKeyType', PbFieldType.OE, ServiceAccountPrivateKeyType.TYPE_UNSPECIFIED, ServiceAccountPrivateKeyType.valueOf, ServiceAccountPrivateKeyType.values)
    ...
    ..e<ServiceAccountKeyAlgorithm>(8, 'keyAlgorithm', PbFieldType.OE, ServiceAccountKeyAlgorithm.KEY_ALG_UNSPECIFIED, ServiceAccountKeyAlgorithm.valueOf, ServiceAccountKeyAlgorithm.values)
    ..hasRequiredFields = false
  ;
...
class CreateServiceAccountKeyRequest extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('CreateServiceAccountKeyRequest')
    ..aOS(1, 'name')
    ..e<ServiceAccountPrivateKeyType>(2, 'privateKeyType', PbFieldType.OE, ServiceAccountPrivateKeyType.TYPE_UNSPECIFIED, ServiceAccountPrivateKeyType.valueOf, ServiceAccountPrivateKeyType.values)
    ..e<ServiceAccountKeyAlgorithm>(3, 'keyAlgorithm', PbFieldType.OE, ServiceAccountKeyAlgorithm.KEY_ALG_UNSPECIFIED, ServiceAccountKeyAlgorithm.valueOf, ServiceAccountKeyAlgorithm.values)
    ..hasRequiredFields = false
  ;
...
class SignBlobRequest extends GeneratedMessage {
  ...
  set bytesToSign(List<int> v) { $_setBytes(1, v); }
...
class SignJwtRequest extends GeneratedMessage {
  ...
  SignJwtRequest.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  SignJwtRequest.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  SignJwtRequest clone() => new SignJwtRequest()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static SignJwtRequest create() => new SignJwtRequest();
  static PbList<SignJwtRequest> createRepeated() => new PbList<SignJwtRequest>();
  static SignJwtRequest getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlySignJwtRequest();
    return _defaultInstance;
  }
  ...
  set payload(String v) { $_setString(1, v); }
...
class SignJwtResponse extends GeneratedMessage {
  ...
  SignJwtResponse.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  SignJwtResponse.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  SignJwtResponse clone() => new SignJwtResponse()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static SignJwtResponse create() => new SignJwtResponse();
  static PbList<SignJwtResponse> createRepeated() => new PbList<SignJwtResponse>();
  static SignJwtResponse getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlySignJwtResponse();
    return _defaultInstance;
  }
  ...
  set signedJwt(String v) { $_setString(1, v); }
  bool hasSignedJwt() => $_has(1);
  void clearSignedJwt() => clearField(2);
}

class _ReadonlySignJwtResponse extends SignJwtResponse with ReadonlyMessageMixin {}
...
class Role extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('Role')
    ...
    ..e<Role_RoleLaunchStage>(8, 'stage', PbFieldType.OE, Role_RoleLaunchStage.ALPHA, Role_RoleLaunchStage.valueOf, Role_RoleLaunchStage.values)
  ...
  set deleted(bool v) { $_setBool(6, v); }
...
class QueryGrantableRolesRequest extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('QueryGrantableRolesRequest')
    ...
    ..e<RoleView>(2, 'view', PbFieldType.OE, RoleView.BASIC, RoleView.valueOf, RoleView.values)
  ...
  set fullResourceName(String v) { $_setString(0, v); }
...
class ListRolesRequest extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('ListRolesRequest')
    ...
    ..a<int>(2, 'pageSize', PbFieldType.O3)
    ..aOS(3, 'pageToken')
    ..e<RoleView>(4, 'view', PbFieldType.OE, RoleView.BASIC, RoleView.valueOf, RoleView.values)
    ..aOB(6, 'showDeleted')
    ..hasRequiredFields = false
  ;

  ListRolesRequest() : super();
  ListRolesRequest.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  ListRolesRequest.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ListRolesRequest clone() => new ListRolesRequest()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static ListRolesRequest create() => new ListRolesRequest();
  static PbList<ListRolesRequest> createRepeated() => new PbList<ListRolesRequest>();
  static ListRolesRequest getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyListRolesRequest();
    return _defaultInstance;
  }
  ...
  set showDeleted(bool v) { $_setBool(4, v); }
  bool hasShowDeleted() => $_has(4);
  void clearShowDeleted() => clearField(6);
}

class _ReadonlyListRolesRequest extends ListRolesRequest with ReadonlyMessageMixin {}
...
class ListRolesResponse extends GeneratedMessage {
  ...
  ListRolesResponse.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  ListRolesResponse.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ListRolesResponse clone() => new ListRolesResponse()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static ListRolesResponse create() => new ListRolesResponse();
  static PbList<ListRolesResponse> createRepeated() => new PbList<ListRolesResponse>();
  static ListRolesResponse getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyListRolesResponse();
    return _defaultInstance;
  }
...
class _ReadonlyListRolesResponse extends ListRolesResponse with ReadonlyMessageMixin {}
...
class GetRoleRequest extends GeneratedMessage {
  ...
  GetRoleRequest.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  GetRoleRequest.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  GetRoleRequest clone() => new GetRoleRequest()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static GetRoleRequest create() => new GetRoleRequest();
  static PbList<GetRoleRequest> createRepeated() => new PbList<GetRoleRequest>();
  static GetRoleRequest getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyGetRoleRequest();
    return _defaultInstance;
  }
...
class CreateRoleRequest extends GeneratedMessage {
  ...
  CreateRoleRequest.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  CreateRoleRequest.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  CreateRoleRequest clone() => new CreateRoleRequest()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static CreateRoleRequest create() => new CreateRoleRequest();
  static PbList<CreateRoleRequest> createRepeated() => new PbList<CreateRoleRequest>();
  static CreateRoleRequest getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyCreateRoleRequest();
    return _defaultInstance;
  }
  ...
  set roleId(String v) { $_setString(1, v); }
...
class _ReadonlyCreateRoleRequest extends CreateRoleRequest with ReadonlyMessageMixin {}
...
class UpdateRoleRequest extends GeneratedMessage {
  ...
  UpdateRoleRequest.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  UpdateRoleRequest.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  UpdateRoleRequest clone() => new UpdateRoleRequest()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static UpdateRoleRequest create() => new UpdateRoleRequest();
  static PbList<UpdateRoleRequest> createRepeated() => new PbList<UpdateRoleRequest>();
  static UpdateRoleRequest getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyUpdateRoleRequest();
    return _defaultInstance;
  }
...
class _ReadonlyUpdateRoleRequest extends UpdateRoleRequest with ReadonlyMessageMixin {}
...
class DeleteRoleRequest extends GeneratedMessage {
  ...
  DeleteRoleRequest.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  DeleteRoleRequest.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  DeleteRoleRequest clone() => new DeleteRoleRequest()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static DeleteRoleRequest create() => new DeleteRoleRequest();
  static PbList<DeleteRoleRequest> createRepeated() => new PbList<DeleteRoleRequest>();
  static DeleteRoleRequest getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyDeleteRoleRequest();
    return _defaultInstance;
  }
...
class _ReadonlyDeleteRoleRequest extends DeleteRoleRequest with ReadonlyMessageMixin {}
...
class UndeleteRoleRequest extends GeneratedMessage {
  ...
  UndeleteRoleRequest.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  UndeleteRoleRequest.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  UndeleteRoleRequest clone() => new UndeleteRoleRequest()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static UndeleteRoleRequest create() => new UndeleteRoleRequest();
  static PbList<UndeleteRoleRequest> createRepeated() => new PbList<UndeleteRoleRequest>();
  static UndeleteRoleRequest getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyUndeleteRoleRequest();
    return _defaultInstance;
  }
...
class _ReadonlyUndeleteRoleRequest extends UndeleteRoleRequest with ReadonlyMessageMixin {}
...
class Permission extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('Permission')
    ...
    ..e<Permission_PermissionLaunchStage>(5, 'stage', PbFieldType.OE, Permission_PermissionLaunchStage.ALPHA, Permission_PermissionLaunchStage.valueOf, Permission_PermissionLaunchStage.values)
    ..e<Permission_CustomRolesSupportLevel>(6, 'customRolesSupportLevel', PbFieldType.OE, Permission_CustomRolesSupportLevel.SUPPORTED, Permission_CustomRolesSupportLevel.valueOf, Permission_CustomRolesSupportLevel.values)
    ..hasRequiredFields = false
  ;
  ...
  set onlyInPredefinedRoles(bool v) { $_setBool(3, v); }
...
class QueryTestablePermissionsRequest extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('QueryTestablePermissionsRequest')
    ..aOS(1, 'fullResourceName')
    ..a<int>(2, 'pageSize', PbFieldType.O3)
    ..aOS(3, 'pageToken')
    ..hasRequiredFields = false
  ...
  QueryTestablePermissionsRequest.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  QueryTestablePermissionsRequest.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  QueryTestablePermissionsRequest clone() => new QueryTestablePermissionsRequest()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static QueryTestablePermissionsRequest create() => new QueryTestablePermissionsRequest();
  static PbList<QueryTestablePermissionsRequest> createRepeated() => new PbList<QueryTestablePermissionsRequest>();
  static QueryTestablePermissionsRequest getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyQueryTestablePermissionsRequest();
    return _defaultInstance;
  }
  static QueryTestablePermissionsRequest _defaultInstance;
  static void $checkItem(QueryTestablePermissionsRequest v) {
    if (v is! QueryTestablePermissionsRequest) checkItemFailed(v, 'QueryTestablePermissionsRequest');
  }
...
class _ReadonlyQueryTestablePermissionsRequest extends QueryTestablePermissionsRequest with ReadonlyMessageMixin {}

class QueryTestablePermissionsResponse extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('QueryTestablePermissionsResponse')
    ..pp<Permission>(1, 'permissions', PbFieldType.PM, Permission.$checkItem, Permission.create)
    ..aOS(2, 'nextPageToken')
    ..hasRequiredFields = false
  ;

  QueryTestablePermissionsResponse() : super();
  QueryTestablePermissionsResponse.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  QueryTestablePermissionsResponse.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  QueryTestablePermissionsResponse clone() => new QueryTestablePermissionsResponse()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static QueryTestablePermissionsResponse create() => new QueryTestablePermissionsResponse();
  static PbList<QueryTestablePermissionsResponse> createRepeated() => new PbList<QueryTestablePermissionsResponse>();
  static QueryTestablePermissionsResponse getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyQueryTestablePermissionsResponse();
    return _defaultInstance;
  }
  static QueryTestablePermissionsResponse _defaultInstance;
  static void $checkItem(QueryTestablePermissionsResponse v) {
    if (v is! QueryTestablePermissionsResponse) checkItemFailed(v, 'QueryTestablePermissionsResponse');
  }
...
class _ReadonlyQueryTestablePermissionsResponse extends QueryTestablePermissionsResponse with ReadonlyMessageMixin {}
...
class IAMApi {
  ...
  Future<$google$protobuf.Empty> deleteServiceAccount(ClientContext ctx, DeleteServiceAccountRequest request) {
    ...
    return _client.invoke<$google$protobuf.Empty>(ctx, 'IAM', 'DeleteServiceAccount', request, emptyResponse);
  }
  ...
  Future<$google$protobuf.Empty> deleteServiceAccountKey(ClientContext ctx, DeleteServiceAccountKeyRequest request) {
    var emptyResponse = new $google$protobuf.Empty();
    return _client.invoke<$google$protobuf.Empty>(ctx, 'IAM', 'DeleteServiceAccountKey', request, emptyResponse);
  }
  ...
  Future<$google$iam$v1.Policy> getIamPolicy(ClientContext ctx, $google$iam$v1.GetIamPolicyRequest request) {
    ...
    return _client.invoke<$google$iam$v1.Policy>(ctx, 'IAM', 'GetIamPolicy', request, emptyResponse);
  }
  Future<$google$iam$v1.Policy> setIamPolicy(ClientContext ctx, $google$iam$v1.SetIamPolicyRequest request) {
    var emptyResponse = new $google$iam$v1.Policy();
    return _client.invoke<$google$iam$v1.Policy>(ctx, 'IAM', 'SetIamPolicy', request, emptyResponse);
  }
  Future<$google$iam$v1.TestIamPermissionsResponse> testIamPermissions(ClientContext ctx, $google$iam$v1.TestIamPermissionsRequest request) {
    ...
    return _client.invoke<$google$iam$v1.TestIamPermissionsResponse>(ctx, 'IAM', 'TestIamPermissions', request, emptyResponse);
  }
  ...
  Future<ListRolesResponse> listRoles(ClientContext ctx, ListRolesRequest request) {
  ...
  Future<QueryTestablePermissionsResponse> queryTestablePermissions(ClientContext ctx, QueryTestablePermissionsRequest request) {
