...
class AuditData extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('AuditData')
    ..a<$google$iam$v1.PolicyDelta>(2, 'policyDelta', PbFieldType.OM, $google$iam$v1.PolicyDelta.getDefault, $google$iam$v1.PolicyDelta.create)
  ...
  set policyDelta($google$iam$v1.PolicyDelta v) { setField(2, v); }
