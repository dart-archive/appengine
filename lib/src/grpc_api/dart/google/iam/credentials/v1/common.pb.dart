...
class GenerateAccessTokenRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('GenerateAccessTokenRequest', package: const $pb.PackageName('google.iam.credentials.v1'))
    ..aOS(1, 'name')
    ..pPS(2, 'delegates')
    ..pPS(4, 'scope')
    ..a<$0.Duration>(7, 'lifetime', $pb.PbFieldType.OM, $0.Duration.getDefault, $0.Duration.create)
    ..hasRequiredFields = false
  ;

  GenerateAccessTokenRequest() : super();
  GenerateAccessTokenRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  GenerateAccessTokenRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  GenerateAccessTokenRequest clone() => GenerateAccessTokenRequest()..mergeFromMessage(this);
  GenerateAccessTokenRequest copyWith(void Function(GenerateAccessTokenRequest) updates) => super.copyWith((message) => updates(message as GenerateAccessTokenRequest));
  ...
  static GenerateAccessTokenRequest getDefault() => _defaultInstance ??= create()..freeze();
...
class GenerateAccessTokenResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('GenerateAccessTokenResponse', package: const $pb.PackageName('google.iam.credentials.v1'))
    ..aOS(1, 'accessToken')
    ..a<$1.Timestamp>(3, 'expireTime', $pb.PbFieldType.OM, $1.Timestamp.getDefault, $1.Timestamp.create)
    ..hasRequiredFields = false
  ;

  GenerateAccessTokenResponse() : super();
  GenerateAccessTokenResponse.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  GenerateAccessTokenResponse.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  GenerateAccessTokenResponse clone() => GenerateAccessTokenResponse()..mergeFromMessage(this);
  GenerateAccessTokenResponse copyWith(void Function(GenerateAccessTokenResponse) updates) => super.copyWith((message) => updates(message as GenerateAccessTokenResponse));
  $pb.BuilderInfo get info_ => _i;
  ...
  static GenerateAccessTokenResponse getDefault() => _defaultInstance ??= create()..freeze();
...
class SignBlobRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('SignBlobRequest', package: const $pb.PackageName('google.iam.credentials.v1'))
    ..aOS(1, 'name')
    ..pPS(3, 'delegates')
...
class SignBlobResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('SignBlobResponse', package: const $pb.PackageName('google.iam.credentials.v1'))
    ..aOS(1, 'keyId')
...
class SignJwtRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('SignJwtRequest', package: const $pb.PackageName('google.iam.credentials.v1'))
    ..aOS(1, 'name')
    ..pPS(3, 'delegates')
    ..aOS(5, 'payload')
    ..hasRequiredFields = false
...
class SignJwtResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('SignJwtResponse', package: const $pb.PackageName('google.iam.credentials.v1'))
    ..aOS(1, 'keyId')
    ..aOS(2, 'signedJwt')
    ..hasRequiredFields = false
  ;
...
class GenerateIdTokenRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('GenerateIdTokenRequest', package: const $pb.PackageName('google.iam.credentials.v1'))
    ..aOS(1, 'name')
    ..pPS(2, 'delegates')
    ..aOS(3, 'audience')
    ..aOB(4, 'includeEmail')
  ...
  GenerateIdTokenRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  GenerateIdTokenRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  GenerateIdTokenRequest clone() => GenerateIdTokenRequest()..mergeFromMessage(this);
  GenerateIdTokenRequest copyWith(void Function(GenerateIdTokenRequest) updates) => super.copyWith((message) => updates(message as GenerateIdTokenRequest));
  $pb.BuilderInfo get info_ => _i;
  ...
  static GenerateIdTokenRequest getDefault() => _defaultInstance ??= create()..freeze();
...
class GenerateIdTokenResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('GenerateIdTokenResponse', package: const $pb.PackageName('google.iam.credentials.v1'))
    ..aOS(1, 'token')
    ..hasRequiredFields = false
  ;

  GenerateIdTokenResponse() : super();
  GenerateIdTokenResponse.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  GenerateIdTokenResponse.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  GenerateIdTokenResponse clone() => GenerateIdTokenResponse()..mergeFromMessage(this);
  GenerateIdTokenResponse copyWith(void Function(GenerateIdTokenResponse) updates) => super.copyWith((message) => updates(message as GenerateIdTokenResponse));
  $pb.BuilderInfo get info_ => _i;
  ...
  static GenerateIdTokenResponse getDefault() => _defaultInstance ??= create()..freeze();
...
class GenerateIdentityBindingAccessTokenRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('GenerateIdentityBindingAccessTokenRequest', package: const $pb.PackageName('google.iam.credentials.v1'))
    ..aOS(1, 'name')
    ..pPS(2, 'scope')
    ..aOS(3, 'jwt')
    ..hasRequiredFields = false
  ...
  GenerateIdentityBindingAccessTokenRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  GenerateIdentityBindingAccessTokenRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  GenerateIdentityBindingAccessTokenRequest clone() => GenerateIdentityBindingAccessTokenRequest()..mergeFromMessage(this);
  GenerateIdentityBindingAccessTokenRequest copyWith(void Function(GenerateIdentityBindingAccessTokenRequest) updates) => super.copyWith((message) => updates(message as GenerateIdentityBindingAccessTokenRequest));
  $pb.BuilderInfo get info_ => _i;
  static GenerateIdentityBindingAccessTokenRequest create() => GenerateIdentityBindingAccessTokenRequest();
  GenerateIdentityBindingAccessTokenRequest createEmptyInstance() => create();
  static $pb.PbList<GenerateIdentityBindingAccessTokenRequest> createRepeated() => $pb.PbList<GenerateIdentityBindingAccessTokenRequest>();
  static GenerateIdentityBindingAccessTokenRequest getDefault() => _defaultInstance ??= create()..freeze();
...
class GenerateIdentityBindingAccessTokenResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('GenerateIdentityBindingAccessTokenResponse', package: const $pb.PackageName('google.iam.credentials.v1'))
    ..aOS(1, 'accessToken')
    ..a<$1.Timestamp>(2, 'expireTime', $pb.PbFieldType.OM, $1.Timestamp.getDefault, $1.Timestamp.create)
    ..hasRequiredFields = false
  ;

  GenerateIdentityBindingAccessTokenResponse() : super();
  GenerateIdentityBindingAccessTokenResponse.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  GenerateIdentityBindingAccessTokenResponse.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  GenerateIdentityBindingAccessTokenResponse clone() => GenerateIdentityBindingAccessTokenResponse()..mergeFromMessage(this);
  GenerateIdentityBindingAccessTokenResponse copyWith(void Function(GenerateIdentityBindingAccessTokenResponse) updates) => super.copyWith((message) => updates(message as GenerateIdentityBindingAccessTokenResponse));
  $pb.BuilderInfo get info_ => _i;
  static GenerateIdentityBindingAccessTokenResponse create() => GenerateIdentityBindingAccessTokenResponse();
  GenerateIdentityBindingAccessTokenResponse createEmptyInstance() => create();
  static $pb.PbList<GenerateIdentityBindingAccessTokenResponse> createRepeated() => $pb.PbList<GenerateIdentityBindingAccessTokenResponse>();
  static GenerateIdentityBindingAccessTokenResponse getDefault() => _defaultInstance ??= create()..freeze();
