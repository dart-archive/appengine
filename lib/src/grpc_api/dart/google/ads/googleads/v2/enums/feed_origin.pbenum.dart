...
class FeedOriginEnum_FeedOrigin extends $pb.ProtobufEnum {
  static const FeedOriginEnum_FeedOrigin UNSPECIFIED =
      FeedOriginEnum_FeedOrigin._(0, 'UNSPECIFIED');
  static const FeedOriginEnum_FeedOrigin UNKNOWN =
      FeedOriginEnum_FeedOrigin._(1, 'UNKNOWN');
  static const FeedOriginEnum_FeedOrigin USER =
      FeedOriginEnum_FeedOrigin._(2, 'USER');
  static const FeedOriginEnum_FeedOrigin GOOGLE =
      FeedOriginEnum_FeedOrigin._(3, 'GOOGLE');
