...
class Ad extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(37)
  $core.String get resourceName => $_getSZ(31);
  @$pb.TagNumber(37)
  ...
  @$pb.TagNumber(37)
  $core.bool hasResourceName() => $_has(31);
  @$pb.TagNumber(37)
  void clearResourceName() => clearField(37);

  @$pb.TagNumber(38)
  $0.StringValue get finalUrlSuffix => $_getN(32);
  @$pb.TagNumber(38)
  ...
  @$pb.TagNumber(38)
  $core.bool hasFinalUrlSuffix() => $_has(32);
  @$pb.TagNumber(38)
  void clearFinalUrlSuffix() => clearField(38);
  @$pb.TagNumber(38)
  $0.StringValue ensureFinalUrlSuffix() => $_ensure(32);
}
