...
import '../resources/ad_group_ad_asset_view.pb.dart' as $138;
import '../resources/distance_view.pb.dart' as $139;
import '../resources/user_location_view.pb.dart' as $140;
import '../../../../rpc/status.pb.dart' as $141;
...
class SearchGoogleAdsRequest extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(6)
  $core.bool get returnSummaryRow => $_getBF(5);
  @$pb.TagNumber(6)
  set returnSummaryRow($core.bool v) {
    $_setBool(5, v);
  }

  @$pb.TagNumber(6)
  $core.bool hasReturnSummaryRow() => $_has(5);
  @$pb.TagNumber(6)
  void clearReturnSummaryRow() => clearField(6);
}
...
class SearchGoogleAdsResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('SearchGoogleAdsResponse',
    ...
    ..aOM<GoogleAdsRow>(6, 'summaryRow', subBuilder: GoogleAdsRow.create)
    ..hasRequiredFields = false;
...
class GoogleAdsRow extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('GoogleAdsRow',
    ...
    ..aOM<$138.AdGroupAdAssetView>(131, 'adGroupAdAssetView', subBuilder: $138.AdGroupAdAssetView.create)
    ..aOM<$139.DistanceView>(132, 'distanceView', subBuilder: $139.DistanceView.create)
    ..aOM<$140.UserLocationView>(135, 'userLocationView', subBuilder: $140.UserLocationView.create)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(131)
  $138.AdGroupAdAssetView get adGroupAdAssetView => $_getN(95);
  @$pb.TagNumber(131)
  set adGroupAdAssetView($138.AdGroupAdAssetView v) {
    setField(131, v);
  }

  @$pb.TagNumber(131)
  $core.bool hasAdGroupAdAssetView() => $_has(95);
  @$pb.TagNumber(131)
  void clearAdGroupAdAssetView() => clearField(131);
  @$pb.TagNumber(131)
  $138.AdGroupAdAssetView ensureAdGroupAdAssetView() => $_ensure(95);

  @$pb.TagNumber(132)
  $139.DistanceView get distanceView => $_getN(96);
  @$pb.TagNumber(132)
  set distanceView($139.DistanceView v) {
    setField(132, v);
  }

  @$pb.TagNumber(132)
  $core.bool hasDistanceView() => $_has(96);
  @$pb.TagNumber(132)
  void clearDistanceView() => clearField(132);
  @$pb.TagNumber(132)
  $139.DistanceView ensureDistanceView() => $_ensure(96);

  @$pb.TagNumber(135)
  $140.UserLocationView get userLocationView => $_getN(97);
  @$pb.TagNumber(135)
  set userLocationView($140.UserLocationView v) {
    setField(135, v);
  }
  ...
  @$pb.TagNumber(135)
  $140.UserLocationView ensureUserLocationView() => $_ensure(97);
}
...
class MutateGoogleAdsResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('MutateGoogleAdsResponse',
    ...
    ..aOM<$141.Status>(3, 'partialFailureError', subBuilder: $141.Status.create)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(3)
  $141.Status get partialFailureError => $_getN(1);
  @$pb.TagNumber(3)
  set partialFailureError($141.Status v) {
    setField(3, v);
  }
  ...
  @$pb.TagNumber(3)
  $141.Status ensurePartialFailureError() => $_ensure(1);
}
