...
class PolicyTopicEvidence_DestinationNotWorking extends $pb.GeneratedMessage {
  static const $core
    ...
    2: PolicyTopicEvidence_DestinationNotWorking_Reason.httpErrorCode,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      createEmptyInstance: create)
    ..oo(0, [1, 2])
    ..e<$3.PolicyTopicEvidenceDestinationNotWorkingDnsErrorTypeEnum_PolicyTopicEvidenceDestinationNotWorkingDnsErrorType>(
        1, 'dnsErrorType', $pb.PbFieldType.OE,
        defaultOrMaker: $3
        ...
        enumValues: $3
            .PolicyTopicEvidenceDestinationNotWorkingDnsErrorTypeEnum_PolicyTopicEvidenceDestinationNotWorkingDnsErrorType
            .values)
    ..aOM<$0.Int64Value>(2, 'httpErrorCode', subBuilder: $0.Int64Value.create)
    ..aOM<$0.StringValue>(3, 'expandedUrl', subBuilder: $0.StringValue.create)
    ..e<$4.PolicyTopicEvidenceDestinationNotWorkingDeviceEnum_PolicyTopicEvidenceDestinationNotWorkingDevice>(
        4, 'device', $pb.PbFieldType.OE,
        defaultOrMaker: $4.PolicyTopicEvidenceDestinationNotWorkingDeviceEnum_PolicyTopicEvidenceDestinationNotWorkingDevice.UNSPECIFIED,
        valueOf: $4.PolicyTopicEvidenceDestinationNotWorkingDeviceEnum_PolicyTopicEvidenceDestinationNotWorkingDevice.valueOf,
        enumValues: $4.PolicyTopicEvidenceDestinationNotWorkingDeviceEnum_PolicyTopicEvidenceDestinationNotWorkingDevice.values)
    ..aOM<$0.StringValue>(5, 'lastCheckedDateTime', subBuilder: $0.StringValue.create)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(1)
  $3.PolicyTopicEvidenceDestinationNotWorkingDnsErrorTypeEnum_PolicyTopicEvidenceDestinationNotWorkingDnsErrorType
  ...
  @$pb.TagNumber(2)
  $0.Int64Value get httpErrorCode => $_getN(1);
  @$pb.TagNumber(2)
  set httpErrorCode($0.Int64Value v) {
    setField(2, v);
  }

  @$pb.TagNumber(2)
  $core.bool hasHttpErrorCode() => $_has(1);
  @$pb.TagNumber(2)
  void clearHttpErrorCode() => clearField(2);
  @$pb.TagNumber(2)
  $0.Int64Value ensureHttpErrorCode() => $_ensure(1);

  @$pb.TagNumber(3)
  $0.StringValue get expandedUrl => $_getN(2);
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(3)
  $core.bool hasExpandedUrl() => $_has(2);
  @$pb.TagNumber(3)
  void clearExpandedUrl() => clearField(3);
  @$pb.TagNumber(3)
  $0.StringValue ensureExpandedUrl() => $_ensure(2);

  @$pb.TagNumber(4)
  $4.PolicyTopicEvidenceDestinationNotWorkingDeviceEnum_PolicyTopicEvidenceDestinationNotWorkingDevice
      get device => $_getN(3);
  @$pb.TagNumber(4)
  set device(
      $4.PolicyTopicEvidenceDestinationNotWorkingDeviceEnum_PolicyTopicEvidenceDestinationNotWorkingDevice
  ...
  @$pb.TagNumber(5)
  $0.StringValue get lastCheckedDateTime => $_getN(4);
  @$pb.TagNumber(5)
  ...
  @$pb.TagNumber(5)
  $0.StringValue ensureLastCheckedDateTime() => $_ensure(4);
}
...
class PolicyTopicEvidence extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(6)
  PolicyTopicEvidence_DestinationTextList get destinationTextList => $_getN(3);
  @$pb.TagNumber(6)
  ...
  @$pb.TagNumber(6)
  $core.bool hasDestinationTextList() => $_has(3);
  @$pb.TagNumber(6)
  ...
  @$pb.TagNumber(7)
  PolicyTopicEvidence_DestinationMismatch get destinationMismatch => $_getN(4);
  @$pb.TagNumber(7)
  ...
  @$pb.TagNumber(7)
  $core.bool hasDestinationMismatch() => $_has(4);
  @$pb.TagNumber(7)
  ...
  @$pb.TagNumber(8)
  $core.bool hasDestinationNotWorking() => $_has(5);
  @$pb.TagNumber(8)
