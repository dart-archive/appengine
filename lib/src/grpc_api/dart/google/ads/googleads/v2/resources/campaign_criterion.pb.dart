...
class CampaignCriterion extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('CampaignCriterion',
    ...
    ..aOM<$1.CustomAffinityInfo>(36, 'customAffinity', subBuilder: $1.CustomAffinityInfo.create)
  ...
  @$pb.TagNumber(36)
  $1.CustomAffinityInfo get customAffinity => $_getN(33);
  @$pb.TagNumber(36)
  ...
  @$pb.TagNumber(36)
  $core.bool hasCustomAffinity() => $_has(33);
  @$pb.TagNumber(36)
  void clearCustomAffinity() => clearField(36);
  @$pb.TagNumber(36)
  $1.CustomAffinityInfo ensureCustomAffinity() => $_ensure(33);
}
