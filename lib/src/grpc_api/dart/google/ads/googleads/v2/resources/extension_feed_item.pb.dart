...
class ExtensionFeedItem extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ExtensionFeedItem',
    ...
    ..oo(0, [2, 3, 7, 8, 9, 10, 11, 12, 14, 15, 23])
    ..oo(1, [18, 19])
    ..aOS(1, 'resourceName')
    ...
    ..aOM<$2.KeywordInfo>(22, 'targetedKeyword', subBuilder: $2.KeywordInfo.create)
    ..aOM<$0.HotelCalloutFeedItem>(23, 'hotelCalloutFeedItem', subBuilder: $0.HotelCalloutFeedItem.create)
    ..aOM<$1.Int64Value>(24, 'id', subBuilder: $1.Int64Value.create)
  ...
  @$pb.TagNumber(22)
  $2.KeywordInfo get targetedKeyword => $_getN(20);
  @$pb.TagNumber(22)
  set targetedKeyword($2.KeywordInfo v) {
    setField(22, v);
  }

  @$pb.TagNumber(22)
  $core.bool hasTargetedKeyword() => $_has(20);
  @$pb.TagNumber(22)
  void clearTargetedKeyword() => clearField(22);
  @$pb.TagNumber(22)
  $2.KeywordInfo ensureTargetedKeyword() => $_ensure(20);

  @$pb.TagNumber(23)
  $0.HotelCalloutFeedItem get hotelCalloutFeedItem => $_getN(21);
  @$pb.TagNumber(23)
  ...
  @$pb.TagNumber(23)
  $core.bool hasHotelCalloutFeedItem() => $_has(21);
  @$pb.TagNumber(23)
  void clearHotelCalloutFeedItem() => clearField(23);
  @$pb.TagNumber(23)
  $0.HotelCalloutFeedItem ensureHotelCalloutFeedItem() => $_ensure(21);

  @$pb.TagNumber(24)
  $1.Int64Value get id => $_getN(22);
  @$pb.TagNumber(24)
  set id($1.Int64Value v) {
    setField(24, v);
  }
  ...
  @$pb.TagNumber(24)
  $1.Int64Value ensureId() => $_ensure(22);
}
