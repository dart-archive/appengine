...
import '../enums/placeholder_type.pbenum.dart' as $11;
import '../errors/feed_item_validation_error.pbenum.dart' as $12;
...
class FeedItemPlaceholderPolicyInfo extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..pc<$10.FeedItemQualityDisapprovalReasonEnum_FeedItemQualityDisapprovalReason>(
        ...
        $pb.PbFieldType.PE,
        null,
        $10.FeedItemQualityDisapprovalReasonEnum_FeedItemQualityDisapprovalReason.valueOf,
        $10.FeedItemQualityDisapprovalReasonEnum_FeedItemQualityDisapprovalReason.values)
    ..e<$11.PlaceholderTypeEnum_PlaceholderType>(10, 'placeholderTypeEnum', $pb.PbFieldType.OE, $11.PlaceholderTypeEnum_PlaceholderType.UNSPECIFIED, $11.PlaceholderTypeEnum_PlaceholderType.valueOf, $11.PlaceholderTypeEnum_PlaceholderType.values)
    ..hasRequiredFields = false;
  ...
  $0.StringValue get feedMappingResourceName => $_getN(0);
  set feedMappingResourceName($0.StringValue v) {
    setField(2, v);
  }

  $core.bool hasFeedMappingResourceName() => $_has(0);
  void clearFeedMappingResourceName() => clearField(2);

  $6.PolicyReviewStatusEnum_PolicyReviewStatus get reviewStatus => $_getN(1);
  ...
  $core.List<$3.PolicyTopicEntry> get policyTopicEntries => $_getList(3);

  $8.FeedItemValidationStatusEnum_FeedItemValidationStatus
      get validationStatus => $_getN(4);
  ...
  $core.List<FeedItemValidationError> get validationErrors => $_getList(5);

  $9.FeedItemQualityApprovalStatusEnum_FeedItemQualityApprovalStatus
      get qualityApprovalStatus => $_getN(6);
  set qualityApprovalStatus(
      $9.FeedItemQualityApprovalStatusEnum_FeedItemQualityApprovalStatus v) {
    setField(8, v);
  }

  $core.bool hasQualityApprovalStatus() => $_has(6);
  void clearQualityApprovalStatus() => clearField(8);

  $core.List<
          $10.FeedItemQualityDisapprovalReasonEnum_FeedItemQualityDisapprovalReason>
      get qualityDisapprovalReasons => $_getList(7);

  $11.PlaceholderTypeEnum_PlaceholderType get placeholderTypeEnum => $_getN(8);
  set placeholderTypeEnum($11.PlaceholderTypeEnum_PlaceholderType v) {
    setField(10, v);
  }

  $core.bool hasPlaceholderTypeEnum() => $_has(8);
...
class FeedItemValidationError extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('FeedItemValidationError',
      package: const $pb.PackageName('google.ads.googleads.v2.resources'))
    ..e<$12.FeedItemValidationErrorEnum_FeedItemValidationError>(
        1,
        'validationError',
        $pb.PbFieldType.OE,
        $12.FeedItemValidationErrorEnum_FeedItemValidationError.UNSPECIFIED,
        $12.FeedItemValidationErrorEnum_FeedItemValidationError.valueOf,
        $12.FeedItemValidationErrorEnum_FeedItemValidationError.values)
  ...
  $12.FeedItemValidationErrorEnum_FeedItemValidationError get validationError =>
      $_getN(0);
  set validationError(
      $12.FeedItemValidationErrorEnum_FeedItemValidationError v) {
    setField(1, v);
  }
