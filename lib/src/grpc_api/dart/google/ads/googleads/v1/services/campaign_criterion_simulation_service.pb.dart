...
class GetCampaignCriterionSimulationRequest extends $pb.GeneratedMessage {
  ...
  GetCampaignCriterionSimulationRequest.fromBuffer($core.List<$core.int> i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);
  GetCampaignCriterionSimulationRequest.fromJson($core.String i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromJson(i, r);
...
class CampaignCriterionSimulationServiceApi {
  ...
  $async.Future<$0.CampaignCriterionSimulation> getCampaignCriterionSimulation(
      $pb.ClientContext ctx, GetCampaignCriterionSimulationRequest request) {
    var emptyResponse = $0.CampaignCriterionSimulation();
    return _client.invoke<$0.CampaignCriterionSimulation>(
        ctx,
