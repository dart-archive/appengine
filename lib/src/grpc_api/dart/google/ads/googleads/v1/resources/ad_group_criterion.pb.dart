...
class AdGroupCriterion_QualityInfo extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..a<$0.Int32Value>(1, 'qualityScore', $pb.PbFieldType.OM,
    ...
    ..e<$8.QualityScoreBucketEnum_QualityScoreBucket>(
        ...
        $8.QualityScoreBucketEnum_QualityScoreBucket.valueOf,
  ...
  static AdGroupCriterion_QualityInfo getDefault() =>
...
class AdGroupCriterion_PositionEstimates extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName('google.ads.googleads.v1.resources'))
    ..a<$0.Int64Value>(1, 'firstPageCpcMicros', $pb.PbFieldType.OM,
        $0.Int64Value.getDefault, $0.Int64Value.create)
    ..a<$0.Int64Value>(2, 'firstPositionCpcMicros', $pb.PbFieldType.OM,
        $0.Int64Value.getDefault, $0.Int64Value.create)
    ..a<$0.Int64Value>(3, 'topOfPageCpcMicros', $pb.PbFieldType.OM,
        $0.Int64Value.getDefault, $0.Int64Value.create)
    ..a<$0.Int64Value>(4, 'estimatedAddClicksAtFirstPositionCpc',
        $pb.PbFieldType.OM, $0.Int64Value.getDefault, $0.Int64Value.create)
    ..a<$0.Int64Value>(5, 'estimatedAddCostAtFirstPositionCpc',
        $pb.PbFieldType.OM, $0.Int64Value.getDefault, $0.Int64Value.create)
    ..hasRequiredFields = false;
  ...
  static AdGroupCriterion_PositionEstimates getDefault() =>
      _defaultInstance ??= create()..freeze();
...
class AdGroupCriterion extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('AdGroupCriterion',
    ...
    ..e<$3.AdGroupCriterionStatusEnum_AdGroupCriterionStatus>(
        ...
        $3.AdGroupCriterionStatusEnum_AdGroupCriterionStatus.valueOf,
        $3.AdGroupCriterionStatusEnum_AdGroupCriterionStatus.values)
    ..a<AdGroupCriterion_QualityInfo>(
        4,
        'qualityInfo',
        $pb.PbFieldType.OM,
        AdGroupCriterion_QualityInfo.getDefault,
        AdGroupCriterion_QualityInfo.create)
    ..a<$0.StringValue>(5, 'adGroup', $pb.PbFieldType.OM,
        $0.StringValue.getDefault, $0.StringValue.create)
    ..a<AdGroupCriterion_PositionEstimates>(
        10,
        'positionEstimates',
        $pb.PbFieldType.OM,
        AdGroupCriterion_PositionEstimates.getDefault,
        AdGroupCriterion_PositionEstimates.create)
    ..pc<$0.StringValue>(
        11, 'finalUrls', $pb.PbFieldType.PM, $0.StringValue.create)
  ...
  static AdGroupCriterion getDefault() =>
      _defaultInstance ??= create()..freeze();
