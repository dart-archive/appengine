...
class ChangeStatus extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ChangeStatus',
    ...
    ..aOS(1, 'resourceName')
    ..a<$0.StringValue>(3, 'lastChangeDateTime', $pb.PbFieldType.OM,
        $0.StringValue.getDefault, $0.StringValue.create)
    ..e<$1.ChangeStatusResourceTypeEnum_ChangeStatusResourceType>(
        4,
        'resourceType',
        $pb.PbFieldType.OE,
        $1.ChangeStatusResourceTypeEnum_ChangeStatusResourceType.UNSPECIFIED,
    ...
    ..a<$0.StringValue>(5, 'campaign', $pb.PbFieldType.OM,
        $0.StringValue.getDefault, $0.StringValue.create)
    ..a<$0.StringValue>(6, 'adGroup', $pb.PbFieldType.OM,
        $0.StringValue.getDefault, $0.StringValue.create)
    ..e<$2.ChangeStatusOperationEnum_ChangeStatusOperation>(
        ...
        $2.ChangeStatusOperationEnum_ChangeStatusOperation.valueOf,
        $2.ChangeStatusOperationEnum_ChangeStatusOperation.values)
    ..a<$0.StringValue>(9, 'adGroupAd', $pb.PbFieldType.OM,
        $0.StringValue.getDefault, $0.StringValue.create)
    ..a<$0.StringValue>(10, 'adGroupCriterion', $pb.PbFieldType.OM,
        $0.StringValue.getDefault, $0.StringValue.create)
    ..a<$0.StringValue>(11, 'campaignCriterion', $pb.PbFieldType.OM,
        $0.StringValue.getDefault, $0.StringValue.create)
    ..a<$0.StringValue>(12, 'feed', $pb.PbFieldType.OM,
        $0.StringValue.getDefault, $0.StringValue.create)
