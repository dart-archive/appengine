...
abstract class UserListServiceBase extends $pb.GeneratedService {
  $async.Future<$0.UserList> getUserList(
      $pb.ServerContext ctx, GetUserListRequest request);
  $async.Future<MutateUserListsResponse> mutateUserLists(
      $pb.ServerContext ctx, MutateUserListsRequest request);

  $pb.GeneratedMessage createRequest($core.String method) {
    switch (method) {
      case 'GetUserList':
        return GetUserListRequest();
      case 'MutateUserLists':
        return MutateUserListsRequest();
      default:
  ...
  $async.Future<$pb.GeneratedMessage> handleCall($pb.ServerContext ctx,
    ...
    switch (method) {
      case 'GetUserList':
        return this.getUserList(ctx, request);
      case 'MutateUserLists':
        return this.mutateUserLists(ctx, request);
      default:
        throw $core.ArgumentError('Unknown method: $method');
    }
  }
  ...
  $core.Map<$core.String, $core.Map<$core.String, $core.dynamic>>
      get $messageJson => UserListServiceBase$messageJson;
}
