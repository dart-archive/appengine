...
class Metrics extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Metrics', package: const $pb.PackageName('google.ads.googleads.v1.common'))
    ..a<$0.DoubleValue>(1, 'activeViewCpm', $pb.PbFieldType.OM, $0.DoubleValue.getDefault, $0.DoubleValue.create)
    ..a<$0.Int64Value>(2, 'activeViewImpressions', $pb.PbFieldType.OM, $0.Int64Value.getDefault, $0.Int64Value.create)
    ..a<$0.Int64Value>(3, 'activeViewMeasurableCostMicros', $pb.PbFieldType.OM, $0.Int64Value.getDefault, $0.Int64Value.create)
    ..a<$0.Int64Value>(4, 'activeViewMeasurableImpressions', $pb.PbFieldType.OM, $0.Int64Value.getDefault, $0.Int64Value.create)
    ..a<$0.DoubleValue>(7, 'allConversions', $pb.PbFieldType.OM, $0.DoubleValue.getDefault, $0.DoubleValue.create)
    ..a<$0.DoubleValue>(8, 'averageCost', $pb.PbFieldType.OM, $0.DoubleValue.getDefault, $0.DoubleValue.create)
    ..a<$0.DoubleValue>(9, 'averageCpc', $pb.PbFieldType.OM, $0.DoubleValue.getDefault, $0.DoubleValue.create)
    ..a<$0.DoubleValue>(10, 'averageCpm', $pb.PbFieldType.OM, $0.DoubleValue.getDefault, $0.DoubleValue.create)
    ..a<$0.DoubleValue>(11, 'averageCpv', $pb.PbFieldType.OM, $0.DoubleValue.getDefault, $0.DoubleValue.create)
    ..a<$0.DoubleValue>(12, 'averageFrequency', $pb.PbFieldType.OM, $0.DoubleValue.getDefault, $0.DoubleValue.create)
    ..a<$0.DoubleValue>(13, 'averagePosition', $pb.PbFieldType.OM, $0.DoubleValue.getDefault, $0.DoubleValue.create)
  ...
  Metrics() : super();
  Metrics.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  Metrics.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  Metrics clone() => Metrics()..mergeFromMessage(this);
  Metrics copyWith(void Function(Metrics) updates) => super.copyWith((message) => updates(message as Metrics));
  ...
  set activeViewMeasurableCostMicros($0.Int64Value v) { setField(3, v); }
  ...
  set activeViewMeasurableImpressions($0.Int64Value v) { setField(4, v); }
  ...
  set benchmarkAverageMaxCpc($0.DoubleValue v) { setField(14, v); }
  ...
  set contentImpressionShare($0.DoubleValue v) { setField(21, v); }
  ...
  set contentRankLostImpressionShare($0.DoubleValue v) { setField(22, v); }
  ...
  set searchBudgetLostImpressionShare($0.DoubleValue v) { setField(47, v); }
  ...
  set searchClickShare($0.DoubleValue v) { setField(48, v); }
  ...
  set searchExactMatchImpressionShare($0.DoubleValue v) { setField(49, v); }
  ...
  set searchImpressionShare($0.DoubleValue v) { setField(50, v); }
  ...
  set searchRankLostImpressionShare($0.DoubleValue v) { setField(51, v); }
  ...
  set valuePerAllConversions($0.DoubleValue v) { setField(52, v); }
  ...
  set valuePerConversion($0.DoubleValue v) { setField(53, v); }
  ...
  set videoQuartile100Rate($0.DoubleValue v) { setField(54, v); }
  ...
  set videoQuartile25Rate($0.DoubleValue v) { setField(55, v); }
  ...
  set videoQuartile50Rate($0.DoubleValue v) { setField(56, v); }
  ...
  set videoQuartile75Rate($0.DoubleValue v) { setField(57, v); }
  ...
  set allConversionsValuePerCost($0.DoubleValue v) { setField(62, v); }
  ...
  set allConversionsFromInteractionsRate($0.DoubleValue v) { setField(65, v); }
  ...
  set allConversionsValue($0.DoubleValue v) { setField(66, v); }
  $core.bool hasAllConversionsValue() => $_has(51);
  void clearAllConversionsValue() => clearField(66);

  $0.DoubleValue get allConversionsFromInteractionsValuePerInteraction => $_getN(52);
  set allConversionsFromInteractionsValuePerInteraction($0.DoubleValue v) { setField(67, v); }
  $core.bool hasAllConversionsFromInteractionsValuePerInteraction() => $_has(52);
  void clearAllConversionsFromInteractionsValuePerInteraction() => clearField(67);

  $0.DoubleValue get costPerAllConversions => $_getN(53);
  set costPerAllConversions($0.DoubleValue v) { setField(68, v); }
  ...
  set conversionsFromInteractionsRate($0.DoubleValue v) { setField(69, v); }
  ...
  set conversionsValue($0.DoubleValue v) { setField(70, v); }
  ...
  set conversionsValuePerCost($0.DoubleValue v) { setField(71, v); }
  $core.bool hasConversionsValuePerCost() => $_has(56);
  void clearConversionsValuePerCost() => clearField(71);

  $0.DoubleValue get conversionsFromInteractionsValuePerInteraction => $_getN(57);
  set conversionsFromInteractionsValuePerInteraction($0.DoubleValue v) { setField(72, v); }
  ...
  set conversionLastReceivedRequestDateTime($0.StringValue v) { setField(73, v); }
  ...
  set conversionLastConversionDate($0.StringValue v) { setField(74, v); }
  ...
  set hotelAverageLeadValueMicros($0.DoubleValue v) { setField(75, v); }
  ...
  set benchmarkCtr($0.DoubleValue v) { setField(77, v); }
  ...
  set searchAbsoluteTopImpressionShare($0.DoubleValue v) { setField(78, v); }
  ...
  set activeViewCtr($0.DoubleValue v) { setField(79, v); }
  $core.bool hasActiveViewCtr() => $_has(63);
  void clearActiveViewCtr() => clearField(79);

  $1.QualityScoreBucketEnum_QualityScoreBucket get historicalCreativeQualityScore => $_getN(64);
  set historicalCreativeQualityScore($1.QualityScoreBucketEnum_QualityScoreBucket v) { setField(80, v); }
  $core.bool hasHistoricalCreativeQualityScore() => $_has(64);
  void clearHistoricalCreativeQualityScore() => clearField(80);

  $1.QualityScoreBucketEnum_QualityScoreBucket get historicalLandingPageQualityScore => $_getN(65);
  set historicalLandingPageQualityScore($1.QualityScoreBucketEnum_QualityScoreBucket v) { setField(81, v); }
  ...
  set historicalQualityScore($0.Int64Value v) { setField(82, v); }
  $core.bool hasHistoricalQualityScore() => $_has(66);
  void clearHistoricalQualityScore() => clearField(82);

  $1.QualityScoreBucketEnum_QualityScoreBucket get historicalSearchPredictedCtr => $_getN(67);
  set historicalSearchPredictedCtr($1.QualityScoreBucketEnum_QualityScoreBucket v) { setField(83, v); }
  ...
  set searchBudgetLostAbsoluteTopImpressionShare($0.DoubleValue v) { setField(88, v); }
  ...
  set searchBudgetLostTopImpressionShare($0.DoubleValue v) { setField(89, v); }
  ...
  set searchRankLostAbsoluteTopImpressionShare($0.DoubleValue v) { setField(90, v); }
  ...
  set searchRankLostTopImpressionShare($0.DoubleValue v) { setField(91, v); }
  ...
  set searchTopImpressionShare($0.DoubleValue v) { setField(92, v); }
  ...
  set topImpressionPercentage($0.DoubleValue v) { setField(93, v); }
  ...
  set valuePerCurrentModelAttributedConversion($0.DoubleValue v) { setField(94, v); }
  ...
  set absoluteTopImpressionPercentage($0.DoubleValue v) { setField(95, v); }
  ...
  set activeViewMeasurability($0.DoubleValue v) { setField(96, v); }
  ...
  set activeViewViewability($0.DoubleValue v) { setField(97, v); }
  ...
  set averageCpe($0.DoubleValue v) { setField(98, v); }
  $core.bool hasAverageCpe() => $_has(82);
  void clearAverageCpe() => clearField(98);

  $0.DoubleValue get averagePageViews => $_getN(83);
  set averagePageViews($0.DoubleValue v) { setField(99, v); }
  $core.bool hasAveragePageViews() => $_has(83);
  void clearAveragePageViews() => clearField(99);

  $core.List<$2.InteractionEventTypeEnum_InteractionEventType> get interactionEventTypes => $_getList(84);

  $0.DoubleValue get currentModelAttributedConversions => $_getN(85);
  set currentModelAttributedConversions($0.DoubleValue v) { setField(101, v); }
  $core.bool hasCurrentModelAttributedConversions() => $_has(85);
  void clearCurrentModelAttributedConversions() => clearField(101);

  $0.DoubleValue get currentModelAttributedConversionsFromInteractionsRate => $_getN(86);
  set currentModelAttributedConversionsFromInteractionsRate($0.DoubleValue v) { setField(102, v); }
  $core.bool hasCurrentModelAttributedConversionsFromInteractionsRate() => $_has(86);
  void clearCurrentModelAttributedConversionsFromInteractionsRate() => clearField(102);

  $0.DoubleValue get currentModelAttributedConversionsFromInteractionsValuePerInteraction => $_getN(87);
  set currentModelAttributedConversionsFromInteractionsValuePerInteraction($0.DoubleValue v) { setField(103, v); }
  $core.bool hasCurrentModelAttributedConversionsFromInteractionsValuePerInteraction() => $_has(87);
  void clearCurrentModelAttributedConversionsFromInteractionsValuePerInteraction() => clearField(103);

  $0.DoubleValue get currentModelAttributedConversionsValue => $_getN(88);
  set currentModelAttributedConversionsValue($0.DoubleValue v) { setField(104, v); }
  ...
  $0.DoubleValue get currentModelAttributedConversionsValuePerCost => $_getN(89);
  set currentModelAttributedConversionsValuePerCost($0.DoubleValue v) { setField(105, v); }
  ...
  set costPerCurrentModelAttributedConversion($0.DoubleValue v) { setField(106, v); }
  ...
  set speedScore($0.Int64Value v) { setField(107, v); }
  ...
  set validAcceleratedMobilePagesClicksPercentage($0.DoubleValue v) { setField(108, v); }
  ...
  set mobileFriendlyClicksPercentage($0.DoubleValue v) { setField(109, v); }
  ...
  set organicImpressions($0.Int64Value v) { setField(112, v); }
  ...
  set organicImpressionsPerQuery($0.DoubleValue v) { setField(113, v); }
  ...
  set combinedClicksPerQuery($0.DoubleValue v) { setField(116, v); }
  ...
  set combinedQueries($0.Int64Value v) { setField(117, v); }
  ...
  set allConversionsFromClickToCall($0.DoubleValue v) { setField(118, v); }
  ...
  set allConversionsFromDirections($0.DoubleValue v) { setField(119, v); }
  ...
  set allConversionsFromMenu($0.DoubleValue v) { setField(120, v); }
  ...
  set allConversionsFromOrder($0.DoubleValue v) { setField(121, v); }
  ...
  set allConversionsFromOtherEngagement($0.DoubleValue v) { setField(122, v); }
  ...
  set allConversionsFromStoreVisit($0.DoubleValue v) { setField(123, v); }
  ...
  set allConversionsFromStoreWebsite($0.DoubleValue v) { setField(124, v); }
  ...
  set impressionsFromStoreReach($0.Int64Value v) { setField(125, v); }
