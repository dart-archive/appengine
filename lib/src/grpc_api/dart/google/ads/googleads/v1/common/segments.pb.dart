...
class Segments extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Segments', package: const $pb.PackageName('google.ads.googleads.v1.common'))
    ..e<$2.DeviceEnum_Device>(1, 'device', $pb.PbFieldType.OE, $2.DeviceEnum_Device.UNSPECIFIED, $2.DeviceEnum_Device.valueOf, $2.DeviceEnum_Device.values)
    ..e<$3.ConversionAttributionEventTypeEnum_ConversionAttributionEventType>(2, 'conversionAttributionEventType', $pb.PbFieldType.OE, $3.ConversionAttributionEventTypeEnum_ConversionAttributionEventType.UNSPECIFIED, $3.ConversionAttributionEventTypeEnum_ConversionAttributionEventType.valueOf, $3.ConversionAttributionEventTypeEnum_ConversionAttributionEventType.values)
    ..e<$4.AdNetworkTypeEnum_AdNetworkType>(3, 'adNetworkType', $pb.PbFieldType.OE, $4.AdNetworkTypeEnum_AdNetworkType.UNSPECIFIED, $4.AdNetworkTypeEnum_AdNetworkType.valueOf, $4.AdNetworkTypeEnum_AdNetworkType.values)
    ..a<$0.StringValue>(4, 'date', $pb.PbFieldType.OM, $0.StringValue.getDefault, $0.StringValue.create)
    ..e<$5.DayOfWeekEnum_DayOfWeek>(5, 'dayOfWeek', $pb.PbFieldType.OE, $5.DayOfWeekEnum_DayOfWeek.UNSPECIFIED, $5.DayOfWeekEnum_DayOfWeek.valueOf, $5.DayOfWeekEnum_DayOfWeek.values)
    ...
    ..a<$0.StringValue>(73, 'hotelRateRuleId', $pb.PbFieldType.OM, $0.StringValue.getDefault, $0.StringValue.create)
    ..e<$20.HotelRateTypeEnum_HotelRateType>(74, 'hotelRateType', $pb.PbFieldType.OE, $20.HotelRateTypeEnum_HotelRateType.UNSPECIFIED, $20.HotelRateTypeEnum_HotelRateType.valueOf, $20.HotelRateTypeEnum_HotelRateType.values)
    ..a<$0.StringValue>(75, 'geoTargetProvince', $pb.PbFieldType.OM, $0.StringValue.getDefault, $0.StringValue.create)
    ..hasRequiredFields = false
  ;

  Segments() : super();
  Segments.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  Segments.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  Segments clone() => Segments()..mergeFromMessage(this);
  Segments copyWith(void Function(Segments) updates) => super.copyWith((message) => updates(message as Segments));
  ...
  set device($2.DeviceEnum_Device v) { setField(1, v); }
  $core.bool hasDevice() => $_has(0);
  void clearDevice() => clearField(1);

  $3.ConversionAttributionEventTypeEnum_ConversionAttributionEventType get conversionAttributionEventType => $_getN(1);
  set conversionAttributionEventType($3.ConversionAttributionEventTypeEnum_ConversionAttributionEventType v) { setField(2, v); }
  ...
  set productAggregatorId($0.UInt64Value v) { setField(28, v); }
  ...
  set productBrand($0.StringValue v) { setField(29, v); }
  ...
  set productChannel($12.ProductChannelEnum_ProductChannel v) { setField(30, v); }
  $core.bool hasProductChannel() => $_has(29);
  void clearProductChannel() => clearField(30);

  $13.ProductChannelExclusivityEnum_ProductChannelExclusivity get productChannelExclusivity => $_getN(30);
  set productChannelExclusivity($13.ProductChannelExclusivityEnum_ProductChannelExclusivity v) { setField(31, v); }
  ...
  set productCondition($14.ProductConditionEnum_ProductCondition v) { setField(32, v); }
  $core.bool hasProductCondition() => $_has(31);
  void clearProductCondition() => clearField(32);

  $0.StringValue get productCountry => $_getN(32);
  set productCountry($0.StringValue v) { setField(33, v); }
  ...
  set productCustomAttribute0($0.StringValue v) { setField(34, v); }
  ...
  set productCustomAttribute1($0.StringValue v) { setField(35, v); }
  ...
  set productCustomAttribute2($0.StringValue v) { setField(36, v); }
  ...
  set productCustomAttribute3($0.StringValue v) { setField(37, v); }
  ...
  set productCustomAttribute4($0.StringValue v) { setField(38, v); }
  ...
  set interactionOnThisExtension($0.BoolValue v) { setField(49, v); }
  $core.bool hasInteractionOnThisExtension() => $_has(48);
  void clearInteractionOnThisExtension() => clearField(49);

  $15.ConversionLagBucketEnum_ConversionLagBucket get conversionLagBucket => $_getN(49);
  set conversionLagBucket($15.ConversionLagBucketEnum_ConversionLagBucket v) { setField(50, v); }
  $core.bool hasConversionLagBucket() => $_has(49);
  void clearConversionLagBucket() => clearField(50);

  $16.ConversionOrAdjustmentLagBucketEnum_ConversionOrAdjustmentLagBucket get conversionOrAdjustmentLagBucket => $_getN(50);
  set conversionOrAdjustmentLagBucket($16.ConversionOrAdjustmentLagBucketEnum_ConversionOrAdjustmentLagBucket v) { setField(51, v); }
  ...
  set conversionAction($0.StringValue v) { setField(52, v); }
  $core.bool hasConversionAction() => $_has(51);
  void clearConversionAction() => clearField(52);

  $17.ConversionActionCategoryEnum_ConversionActionCategory get conversionActionCategory => $_getN(52);
  set conversionActionCategory($17.ConversionActionCategoryEnum_ConversionActionCategory v) { setField(53, v); }
  ...
  set conversionActionName($0.StringValue v) { setField(54, v); }
  $core.bool hasConversionActionName() => $_has(53);
  void clearConversionActionName() => clearField(54);

  $18.ExternalConversionSourceEnum_ExternalConversionSource get externalConversionSource => $_getN(54);
  set externalConversionSource($18.ExternalConversionSourceEnum_ExternalConversionSource v) { setField(55, v); }
  ...
  set productBiddingCategoryLevel1($0.StringValue v) { setField(56, v); }
  ...
  set productBiddingCategoryLevel2($0.StringValue v) { setField(57, v); }
  ...
  set productBiddingCategoryLevel3($0.StringValue v) { setField(58, v); }
  ...
  set productBiddingCategoryLevel4($0.StringValue v) { setField(59, v); }
  ...
  set productBiddingCategoryLevel5($0.StringValue v) { setField(60, v); }
  ...
  set geoTargetPostalCode($0.StringValue v) { setField(71, v); }
  ...
  set geoTargetMostSpecificLocation($0.StringValue v) { setField(72, v); }
  ...
  set hotelRateRuleId($0.StringValue v) { setField(73, v); }
  ...
  set hotelRateType($20.HotelRateTypeEnum_HotelRateType v) { setField(74, v); }
  $core.bool hasHotelRateType() => $_has(73);
  void clearHotelRateType() => clearField(74);

  $0.StringValue get geoTargetProvince => $_getN(74);
  set geoTargetProvince($0.StringValue v) { setField(75, v); }
  $core.bool hasGeoTargetProvince() => $_has(74);
  void clearGeoTargetProvince() => clearField(75);
}

class Keyword extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Keyword', package: const $pb.PackageName('google.ads.googleads.v1.common'))
    ..a<$0.StringValue>(1, 'adGroupCriterion', $pb.PbFieldType.OM, $0.StringValue.getDefault, $0.StringValue.create)
    ..a<$1.KeywordInfo>(2, 'info', $pb.PbFieldType.OM, $1.KeywordInfo.getDefault, $1.KeywordInfo.create)
    ..hasRequiredFields = false
  ;

  Keyword() : super();
  Keyword.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  Keyword.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
