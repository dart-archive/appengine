...
class CampaignBidModifier extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('CampaignBidModifier', package: const $pb.PackageName('google.ads.googleads.v1.resources'))
    ..aOS(1, 'resourceName')
    ...
    ..a<$1.InteractionTypeInfo>(5, 'interactionType', $pb.PbFieldType.OM, $1.InteractionTypeInfo.getDefault, $1.InteractionTypeInfo.create)
    ..oo(0, [5])
    ..hasRequiredFields = false
  ;

  CampaignBidModifier() : super();
  CampaignBidModifier.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  CampaignBidModifier.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  CampaignBidModifier clone() => CampaignBidModifier()..mergeFromMessage(this);
  CampaignBidModifier copyWith(void Function(CampaignBidModifier) updates) => super.copyWith((message) => updates(message as CampaignBidModifier));
  $pb.BuilderInfo get info_ => _i;
  static CampaignBidModifier create() => CampaignBidModifier();
  ...
  static CampaignBidModifier getDefault() => _defaultInstance ??= create()..freeze();
  ...
  set interactionType($1.InteractionTypeInfo v) { setField(5, v); }
