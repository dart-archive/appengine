...
class CallPlaceholderFieldEnum extends $pb.GeneratedMessage {
  ...
  CallPlaceholderFieldEnum() : super();
  CallPlaceholderFieldEnum.fromBuffer($core.List<$core.int> i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);
  CallPlaceholderFieldEnum.fromJson($core.String i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromJson(i, r);
  ...
  static CallPlaceholderFieldEnum create() => CallPlaceholderFieldEnum();
