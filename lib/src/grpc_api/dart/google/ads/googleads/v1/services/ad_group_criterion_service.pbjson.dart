...
const AdGroupCriterionServiceBase$json = {
  '1': 'AdGroupCriterionService',
  '2': [
    {
      '1': 'GetAdGroupCriterion',
      '2': '.google.ads.googleads.v1.services.GetAdGroupCriterionRequest',
      '3': '.google.ads.googleads.v1.resources.AdGroupCriterion',
      '4': {}
    },
    {
      '1': 'MutateAdGroupCriteria',
      '2': '.google.ads.googleads.v1.services.MutateAdGroupCriteriaRequest',
      '3': '.google.ads.googleads.v1.services.MutateAdGroupCriteriaResponse',
      '4': {}
    },
  ],
};

const AdGroupCriterionServiceBase$messageJson = {
  '.google.ads.googleads.v1.services.GetAdGroupCriterionRequest':
      GetAdGroupCriterionRequest$json,
  '.google.ads.googleads.v1.resources.AdGroupCriterion':
      $0.AdGroupCriterion$json,
  '.google.ads.googleads.v1.resources.AdGroupCriterion.QualityInfo':
      $0.AdGroupCriterion_QualityInfo$json,
  ...
  '.google.ads.googleads.v1.resources.AdGroupCriterion.PositionEstimates':
      $0.AdGroupCriterion_PositionEstimates$json,
  ...
  '.google.ads.googleads.v1.common.MobileAppCategoryInfo':
      $6.MobileAppCategoryInfo$json,
  '.google.ads.googleads.v1.common.MobileApplicationInfo':
      $6.MobileApplicationInfo$json,
  ...
  '.google.ads.googleads.v1.common.ProductBiddingCategoryInfo':
      $6.ProductBiddingCategoryInfo$json,
  '.google.ads.googleads.v1.common.UnknownListingDimensionInfo':
      $6.UnknownListingDimensionInfo$json,
  ...
  '.google.ads.googleads.v1.services.MutateAdGroupCriteriaRequest':
      MutateAdGroupCriteriaRequest$json,
  '.google.ads.googleads.v1.services.AdGroupCriterionOperation':
      AdGroupCriterionOperation$json,
  ...
  '.google.ads.googleads.v1.services.MutateAdGroupCriteriaResponse':
      MutateAdGroupCriteriaResponse$json,
  '.google.ads.googleads.v1.services.MutateAdGroupCriterionResult':
      MutateAdGroupCriterionResult$json,
