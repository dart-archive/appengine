...
class CustomerErrorEnum_CustomerError extends $pb.ProtobufEnum {
  static const CustomerErrorEnum_CustomerError UNSPECIFIED = CustomerErrorEnum_CustomerError._(0, 'UNSPECIFIED');
  static const CustomerErrorEnum_CustomerError UNKNOWN = CustomerErrorEnum_CustomerError._(1, 'UNKNOWN');
  static const CustomerErrorEnum_CustomerError STATUS_CHANGE_DISALLOWED = CustomerErrorEnum_CustomerError._(2, 'STATUS_CHANGE_DISALLOWED');
  static const CustomerErrorEnum_CustomerError ACCOUNT_NOT_SET_UP = CustomerErrorEnum_CustomerError._(3, 'ACCOUNT_NOT_SET_UP');
