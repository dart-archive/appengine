...
class CustomerNegativeCriterion extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('CustomerNegativeCriterion', package: const $pb.PackageName('google.ads.googleads.v1.resources'))
    ..aOS(1, 'resourceName')
    ..a<$0.Int64Value>(2, 'id', $pb.PbFieldType.OM, $0.Int64Value.getDefault, $0.Int64Value.create)
    ..e<$2.CriterionTypeEnum_CriterionType>(3, 'type', $pb.PbFieldType.OE, $2.CriterionTypeEnum_CriterionType.UNSPECIFIED, $2.CriterionTypeEnum_CriterionType.valueOf, $2.CriterionTypeEnum_CriterionType.values)
    ..a<$1.ContentLabelInfo>(4, 'contentLabel', $pb.PbFieldType.OM, $1.ContentLabelInfo.getDefault, $1.ContentLabelInfo.create)
    ..a<$1.MobileApplicationInfo>(5, 'mobileApplication', $pb.PbFieldType.OM, $1.MobileApplicationInfo.getDefault, $1.MobileApplicationInfo.create)
    ..a<$1.MobileAppCategoryInfo>(6, 'mobileAppCategory', $pb.PbFieldType.OM, $1.MobileAppCategoryInfo.getDefault, $1.MobileAppCategoryInfo.create)
    ..a<$1.PlacementInfo>(7, 'placement', $pb.PbFieldType.OM, $1.PlacementInfo.getDefault, $1.PlacementInfo.create)
    ..a<$1.YouTubeVideoInfo>(8, 'youtubeVideo', $pb.PbFieldType.OM, $1.YouTubeVideoInfo.getDefault, $1.YouTubeVideoInfo.create)
    ..a<$1.YouTubeChannelInfo>(9, 'youtubeChannel', $pb.PbFieldType.OM, $1.YouTubeChannelInfo.getDefault, $1.YouTubeChannelInfo.create)
    ..oo(0, [4, 5, 6, 7, 8, 9])
    ..hasRequiredFields = false
  ;

  CustomerNegativeCriterion() : super();
  CustomerNegativeCriterion.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  CustomerNegativeCriterion.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  CustomerNegativeCriterion clone() => CustomerNegativeCriterion()..mergeFromMessage(this);
  CustomerNegativeCriterion copyWith(void Function(CustomerNegativeCriterion) updates) => super.copyWith((message) => updates(message as CustomerNegativeCriterion));
  ...
  static CustomerNegativeCriterion getDefault() => _defaultInstance ??= create()..freeze();
  ...
  set mobileAppCategory($1.MobileAppCategoryInfo v) { setField(6, v); }
