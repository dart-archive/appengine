...
class MatchingFunctionContextTypeEnum extends $pb.GeneratedMessage {
  ...
  MatchingFunctionContextTypeEnum() : super();
  MatchingFunctionContextTypeEnum.fromBuffer($core.List<$core.int> i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);
  MatchingFunctionContextTypeEnum.fromJson($core.String i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromJson(i, r);
