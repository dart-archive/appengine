...
class LabelStatusEnum_LabelStatus extends $pb.ProtobufEnum {
  static const LabelStatusEnum_LabelStatus UNSPECIFIED = LabelStatusEnum_LabelStatus._(0, 'UNSPECIFIED');
  static const LabelStatusEnum_LabelStatus UNKNOWN = LabelStatusEnum_LabelStatus._(1, 'UNKNOWN');
  static const LabelStatusEnum_LabelStatus ENABLED = LabelStatusEnum_LabelStatus._(2, 'ENABLED');
  static const LabelStatusEnum_LabelStatus REMOVED = LabelStatusEnum_LabelStatus._(3, 'REMOVED');
