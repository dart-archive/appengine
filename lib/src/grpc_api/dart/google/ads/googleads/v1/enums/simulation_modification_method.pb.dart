...
class SimulationModificationMethodEnum extends $pb.GeneratedMessage {
  ...
  SimulationModificationMethodEnum() : super();
  SimulationModificationMethodEnum.fromBuffer($core.List<$core.int> i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);
  SimulationModificationMethodEnum.fromJson($core.String i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromJson(i, r);
