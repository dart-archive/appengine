...
class LocalPlaceholderFieldEnum extends $pb.GeneratedMessage {
  ...
  LocalPlaceholderFieldEnum() : super();
  LocalPlaceholderFieldEnum.fromBuffer($core.List<$core.int> i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);
  LocalPlaceholderFieldEnum.fromJson($core.String i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromJson(i, r);
  ...
  static LocalPlaceholderFieldEnum create() => LocalPlaceholderFieldEnum();
  ...
  static LocalPlaceholderFieldEnum getDefault() =>
