...
class UserListRuleTypeEnum_UserListRuleType extends $pb.ProtobufEnum {
  static const UserListRuleTypeEnum_UserListRuleType UNSPECIFIED = UserListRuleTypeEnum_UserListRuleType._(0, 'UNSPECIFIED');
  static const UserListRuleTypeEnum_UserListRuleType UNKNOWN = UserListRuleTypeEnum_UserListRuleType._(1, 'UNKNOWN');
  static const UserListRuleTypeEnum_UserListRuleType AND_OF_ORS = UserListRuleTypeEnum_UserListRuleType._(2, 'AND_OF_ORS');
  static const UserListRuleTypeEnum_UserListRuleType OR_OF_ANDS = UserListRuleTypeEnum_UserListRuleType._(3, 'OR_OF_ANDS');
