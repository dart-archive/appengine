...
import '../resources/campaign_criterion_simulation.pbjson.dart' as $0;
import '../../../../protobuf/wrappers.pbjson.dart' as $1;
import '../common/simulation.pbjson.dart' as $2;

const GetCampaignCriterionSimulationRequest$json = {
...
const CampaignCriterionSimulationServiceBase$json = {
  '1': 'CampaignCriterionSimulationService',
  '2': [
    {
      '1': 'GetCampaignCriterionSimulation',
      '2':
          '.google.ads.googleads.v1.services.GetCampaignCriterionSimulationRequest',
      '3': '.google.ads.googleads.v1.resources.CampaignCriterionSimulation',
      '4': {}
    },
  ],
};

const CampaignCriterionSimulationServiceBase$messageJson = {
  '.google.ads.googleads.v1.services.GetCampaignCriterionSimulationRequest':
      GetCampaignCriterionSimulationRequest$json,
  '.google.ads.googleads.v1.resources.CampaignCriterionSimulation':
      $0.CampaignCriterionSimulation$json,
  ...
  '.google.ads.googleads.v1.common.BidModifierSimulationPointList':
      $2.BidModifierSimulationPointList$json,
  '.google.ads.googleads.v1.common.BidModifierSimulationPoint':
      $2.BidModifierSimulationPoint$json,
