...
class WebpageConditionOperatorEnum extends $pb.GeneratedMessage {
  ...
  WebpageConditionOperatorEnum() : super();
  WebpageConditionOperatorEnum.fromBuffer($core.List<$core.int> i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);
  WebpageConditionOperatorEnum.fromJson($core.String i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromJson(i, r);
  ...
  static WebpageConditionOperatorEnum getDefault() =>
