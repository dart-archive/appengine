...
class KeywordPlanNetworkEnum extends $pb.GeneratedMessage {
  ...
  KeywordPlanNetworkEnum() : super();
  KeywordPlanNetworkEnum.fromBuffer($core.List<$core.int> i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);
  KeywordPlanNetworkEnum.fromJson($core.String i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromJson(i, r);
  ...
  static KeywordPlanNetworkEnum create() => KeywordPlanNetworkEnum();
  ...
  static KeywordPlanNetworkEnum getDefault() =>
