...
abstract class MobileDeviceConstantServiceBase extends $pb.GeneratedService {
  $async.Future<$0.MobileDeviceConstant> getMobileDeviceConstant(
      $pb.ServerContext ctx, GetMobileDeviceConstantRequest request);

  $pb.GeneratedMessage createRequest($core.String method) {
    switch (method) {
      case 'GetMobileDeviceConstant':
        return GetMobileDeviceConstantRequest();
      default:
  ...
  $async.Future<$pb.GeneratedMessage> handleCall($pb.ServerContext ctx,
    ...
    switch (method) {
      case 'GetMobileDeviceConstant':
        return this.getMobileDeviceConstant(ctx, request);
      default:
        throw $core.ArgumentError('Unknown method: $method');
    }
  }
  ...
  $core.Map<$core.String, $core.dynamic> get $json =>
      MobileDeviceConstantServiceBase$json;
  $core.Map<$core.String, $core.Map<$core.String, $core.dynamic>>
      get $messageJson => MobileDeviceConstantServiceBase$messageJson;
}
