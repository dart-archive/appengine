...
class FeedItemTarget extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('FeedItemTarget', package: const $pb.PackageName('google.ads.googleads.v1.resources'))
    ..aOS(1, 'resourceName')
    ..a<$0.StringValue>(2, 'feedItem', $pb.PbFieldType.OM, $0.StringValue.getDefault, $0.StringValue.create)
    ..e<$2.FeedItemTargetTypeEnum_FeedItemTargetType>(3, 'feedItemTargetType', $pb.PbFieldType.OE, $2.FeedItemTargetTypeEnum_FeedItemTargetType.UNSPECIFIED, $2.FeedItemTargetTypeEnum_FeedItemTargetType.valueOf, $2.FeedItemTargetTypeEnum_FeedItemTargetType.values)
    ...
    ..a<$0.Int64Value>(6, 'feedItemTargetId', $pb.PbFieldType.OM, $0.Int64Value.getDefault, $0.Int64Value.create)
    ..a<$1.KeywordInfo>(7, 'keyword', $pb.PbFieldType.OM, $1.KeywordInfo.getDefault, $1.KeywordInfo.create)
    ..a<$0.StringValue>(8, 'geoTargetConstant', $pb.PbFieldType.OM, $0.StringValue.getDefault, $0.StringValue.create)
    ..e<$3.FeedItemTargetDeviceEnum_FeedItemTargetDevice>(9, 'device', $pb.PbFieldType.OE, $3.FeedItemTargetDeviceEnum_FeedItemTargetDevice.UNSPECIFIED, $3.FeedItemTargetDeviceEnum_FeedItemTargetDevice.valueOf, $3.FeedItemTargetDeviceEnum_FeedItemTargetDevice.values)
    ..a<$1.AdScheduleInfo>(10, 'adSchedule', $pb.PbFieldType.OM, $1.AdScheduleInfo.getDefault, $1.AdScheduleInfo.create)
    ..oo(0, [4, 5, 7, 8, 9, 10])
    ..hasRequiredFields = false
  ;

  FeedItemTarget() : super();
  FeedItemTarget.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  FeedItemTarget.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  FeedItemTarget clone() => FeedItemTarget()..mergeFromMessage(this);
  FeedItemTarget copyWith(void Function(FeedItemTarget) updates) => super.copyWith((message) => updates(message as FeedItemTarget));
  ...
  set feedItem($0.StringValue v) { setField(2, v); }
  $core.bool hasFeedItem() => $_has(1);
  void clearFeedItem() => clearField(2);

  $2.FeedItemTargetTypeEnum_FeedItemTargetType get feedItemTargetType => $_getN(2);
  set feedItemTargetType($2.FeedItemTargetTypeEnum_FeedItemTargetType v) { setField(3, v); }
  ...
  set device($3.FeedItemTargetDeviceEnum_FeedItemTargetDevice v) { setField(9, v); }
  $core.bool hasDevice() => $_has(8);
  void clearDevice() => clearField(9);

  $1.AdScheduleInfo get adSchedule => $_getN(9);
  set adSchedule($1.AdScheduleInfo v) { setField(10, v); }
