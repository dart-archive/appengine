...
class ExtensionFeedItemServiceApi {
  ...
  $async.Future<$0.ExtensionFeedItem> getExtensionFeedItem(
      $pb.ClientContext ctx, GetExtensionFeedItemRequest request) {
    var emptyResponse = $0.ExtensionFeedItem();
    return _client.invoke<$0.ExtensionFeedItem>(ctx, 'ExtensionFeedItemService',
        'GetExtensionFeedItem', request, emptyResponse);
  }

  $async.Future<MutateExtensionFeedItemsResponse> mutateExtensionFeedItems(
      $pb.ClientContext ctx, MutateExtensionFeedItemsRequest request) {
    var emptyResponse = MutateExtensionFeedItemsResponse();
    return _client.invoke<MutateExtensionFeedItemsResponse>(
        ctx,
