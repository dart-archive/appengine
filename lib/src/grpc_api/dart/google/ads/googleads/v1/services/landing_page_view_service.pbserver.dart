...
abstract class LandingPageViewServiceBase extends $pb.GeneratedService {
  $async.Future<$0.LandingPageView> getLandingPageView(
      $pb.ServerContext ctx, GetLandingPageViewRequest request);

  $pb.GeneratedMessage createRequest($core.String method) {
    switch (method) {
      case 'GetLandingPageView':
        return GetLandingPageViewRequest();
      default:
  ...
  $async.Future<$pb.GeneratedMessage> handleCall($pb.ServerContext ctx,
    ...
    switch (method) {
      case 'GetLandingPageView':
        return this.getLandingPageView(ctx, request);
      default:
        throw $core.ArgumentError('Unknown method: $method');
    }
  }
  ...
  $core.Map<$core.String, $core.dynamic> get $json =>
      LandingPageViewServiceBase$json;
  $core.Map<$core.String, $core.Map<$core.String, $core.dynamic>>
      get $messageJson => LandingPageViewServiceBase$messageJson;
}
