...
class AdGroupFeed extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('AdGroupFeed', package: const $pb.PackageName('google.ads.googleads.v1.resources'))
    ..aOS(1, 'resourceName')
  ...
  AdGroupFeed() : super();
  AdGroupFeed.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  AdGroupFeed.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  AdGroupFeed clone() => AdGroupFeed()..mergeFromMessage(this);
  AdGroupFeed copyWith(void Function(AdGroupFeed) updates) => super.copyWith((message) => updates(message as AdGroupFeed));
  $pb.BuilderInfo get info_ => _i;
  static AdGroupFeed create() => AdGroupFeed();
