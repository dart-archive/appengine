...
abstract class AdGroupAdLabelServiceBase extends $pb.GeneratedService {
  $async.Future<$0.AdGroupAdLabel> getAdGroupAdLabel(
      $pb.ServerContext ctx, GetAdGroupAdLabelRequest request);
  $async.Future<MutateAdGroupAdLabelsResponse> mutateAdGroupAdLabels(
      $pb.ServerContext ctx, MutateAdGroupAdLabelsRequest request);

  $pb.GeneratedMessage createRequest($core.String method) {
    switch (method) {
      case 'GetAdGroupAdLabel':
        return GetAdGroupAdLabelRequest();
      case 'MutateAdGroupAdLabels':
        return MutateAdGroupAdLabelsRequest();
      default:
  ...
  $async.Future<$pb.GeneratedMessage> handleCall($pb.ServerContext ctx,
    ...
    switch (method) {
      case 'GetAdGroupAdLabel':
        return this.getAdGroupAdLabel(ctx, request);
      case 'MutateAdGroupAdLabels':
        return this.mutateAdGroupAdLabels(ctx, request);
      default:
        throw $core.ArgumentError('Unknown method: $method');
    }
  }
  ...
  $core.Map<$core.String, $core.dynamic> get $json =>
      AdGroupAdLabelServiceBase$json;
  $core.Map<$core.String, $core.Map<$core.String, $core.dynamic>>
      get $messageJson => AdGroupAdLabelServiceBase$messageJson;
}
