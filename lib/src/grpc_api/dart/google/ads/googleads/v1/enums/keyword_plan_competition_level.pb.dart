...
class KeywordPlanCompetitionLevelEnum extends $pb.GeneratedMessage {
  ...
  KeywordPlanCompetitionLevelEnum() : super();
  KeywordPlanCompetitionLevelEnum.fromBuffer($core.List<$core.int> i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);
  KeywordPlanCompetitionLevelEnum.fromJson($core.String i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromJson(i, r);
