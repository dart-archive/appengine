...
class FeedMapping extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('FeedMapping',
    ...
    ..e<$1.PlaceholderTypeEnum_PlaceholderType>(
        ...
        'placeholderType',
        $pb.PbFieldType.OE,
        $1.PlaceholderTypeEnum_PlaceholderType.UNSPECIFIED,
        $1.PlaceholderTypeEnum_PlaceholderType.valueOf,
        $1.PlaceholderTypeEnum_PlaceholderType.values)
    ..e<$2.FeedMappingCriterionTypeEnum_FeedMappingCriterionType>(
        4,
        'criterionType',
        $pb.PbFieldType.OE,
        $2.FeedMappingCriterionTypeEnum_FeedMappingCriterionType.UNSPECIFIED,
...
class AttributeFieldMapping extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('AttributeFieldMapping',
    ...
    ..e<$4.SitelinkPlaceholderFieldEnum_SitelinkPlaceholderField>(
        ...
        'sitelinkField',
        $pb.PbFieldType.OE,
        $4.SitelinkPlaceholderFieldEnum_SitelinkPlaceholderField.UNSPECIFIED,
    ...
    ..e<$5.CallPlaceholderFieldEnum_CallPlaceholderField>(
        ...
        $5.CallPlaceholderFieldEnum_CallPlaceholderField.valueOf,
        $5.CallPlaceholderFieldEnum_CallPlaceholderField.values)
    ..e<$6.AppPlaceholderFieldEnum_AppPlaceholderField>(
        5,
        'appField',
        $pb.PbFieldType.OE,
        $6.AppPlaceholderFieldEnum_AppPlaceholderField.UNSPECIFIED,
        $6.AppPlaceholderFieldEnum_AppPlaceholderField.valueOf,
        $6.AppPlaceholderFieldEnum_AppPlaceholderField.values)
    ..e<$7.LocationPlaceholderFieldEnum_LocationPlaceholderField>(
        6,
        'locationField',
        $pb.PbFieldType.OE,
        $7.LocationPlaceholderFieldEnum_LocationPlaceholderField.UNSPECIFIED,
  ...
  static AttributeFieldMapping getDefault() =>
