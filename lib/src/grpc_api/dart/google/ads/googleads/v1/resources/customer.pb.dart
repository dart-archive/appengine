...
import '../enums/customer_pay_per_conversion_eligibility_failure_reason.pbenum.dart' as $1;

class Customer extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Customer', package: const $pb.PackageName('google.ads.googleads.v1.resources'))
    ..aOS(1, 'resourceName')
    ..a<$0.Int64Value>(3, 'id', $pb.PbFieldType.OM, $0.Int64Value.getDefault, $0.Int64Value.create)
    ..a<$0.StringValue>(4, 'descriptiveName', $pb.PbFieldType.OM, $0.StringValue.getDefault, $0.StringValue.create)
    ..a<$0.StringValue>(5, 'currencyCode', $pb.PbFieldType.OM, $0.StringValue.getDefault, $0.StringValue.create)
    ..a<$0.StringValue>(6, 'timeZone', $pb.PbFieldType.OM, $0.StringValue.getDefault, $0.StringValue.create)
    ..a<$0.StringValue>(7, 'trackingUrlTemplate', $pb.PbFieldType.OM, $0.StringValue.getDefault, $0.StringValue.create)
    ..a<$0.BoolValue>(8, 'autoTaggingEnabled', $pb.PbFieldType.OM, $0.BoolValue.getDefault, $0.BoolValue.create)
    ..a<$0.BoolValue>(9, 'hasPartnersBadge', $pb.PbFieldType.OM, $0.BoolValue.getDefault, $0.BoolValue.create)
    ..a<CallReportingSetting>(10, 'callReportingSetting', $pb.PbFieldType.OM, CallReportingSetting.getDefault, CallReportingSetting.create)
    ..a<$0.StringValue>(11, 'finalUrlSuffix', $pb.PbFieldType.OM, $0.StringValue.getDefault, $0.StringValue.create)
    ..a<$0.BoolValue>(12, 'manager', $pb.PbFieldType.OM, $0.BoolValue.getDefault, $0.BoolValue.create)
  ...
  $core.List<$1.CustomerPayPerConversionEligibilityFailureReasonEnum_CustomerPayPerConversionEligibilityFailureReason> get payPerConversionEligibilityFailureReasons => $_getList(14);
}

class CallReportingSetting extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('CallReportingSetting', package: const $pb.PackageName('google.ads.googleads.v1.resources'))
    ..a<$0.BoolValue>(1, 'callReportingEnabled', $pb.PbFieldType.OM, $0.BoolValue.getDefault, $0.BoolValue.create)
    ..a<$0.BoolValue>(2, 'callConversionReportingEnabled', $pb.PbFieldType.OM, $0.BoolValue.getDefault, $0.BoolValue.create)
    ..a<$0.StringValue>(9, 'callConversionAction', $pb.PbFieldType.OM, $0.StringValue.getDefault, $0.StringValue.create)
    ..hasRequiredFields = false
  ;

  CallReportingSetting() : super();
  CallReportingSetting.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  CallReportingSetting.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  CallReportingSetting clone() => CallReportingSetting()..mergeFromMessage(this);
  CallReportingSetting copyWith(void Function(CallReportingSetting) updates) => super.copyWith((message) => updates(message as CallReportingSetting));
  $pb.BuilderInfo get info_ => _i;
  ...
  static CallReportingSetting getDefault() => _defaultInstance ??= create()..freeze();
  static CallReportingSetting _defaultInstance;

  $0.BoolValue get callReportingEnabled => $_getN(0);
  set callReportingEnabled($0.BoolValue v) { setField(1, v); }
  ...
  set callConversionReportingEnabled($0.BoolValue v) { setField(2, v); }
  ...
  set callConversionAction($0.StringValue v) { setField(9, v); }
...
class ConversionTrackingSetting extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ConversionTrackingSetting', package: const $pb.PackageName('google.ads.googleads.v1.resources'))
    ..a<$0.Int64Value>(1, 'conversionTrackingId', $pb.PbFieldType.OM, $0.Int64Value.getDefault, $0.Int64Value.create)
    ..a<$0.Int64Value>(2, 'crossAccountConversionTrackingId', $pb.PbFieldType.OM, $0.Int64Value.getDefault, $0.Int64Value.create)
    ..hasRequiredFields = false
  ;

  ConversionTrackingSetting() : super();
  ConversionTrackingSetting.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  ConversionTrackingSetting.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ConversionTrackingSetting clone() => ConversionTrackingSetting()..mergeFromMessage(this);
  ConversionTrackingSetting copyWith(void Function(ConversionTrackingSetting) updates) => super.copyWith((message) => updates(message as ConversionTrackingSetting));
  $pb.BuilderInfo get info_ => _i;
  ...
  static ConversionTrackingSetting getDefault() => _defaultInstance ??= create()..freeze();
  static ConversionTrackingSetting _defaultInstance;

  $0.Int64Value get conversionTrackingId => $_getN(0);
  set conversionTrackingId($0.Int64Value v) { setField(1, v); }
  ...
  set crossAccountConversionTrackingId($0.Int64Value v) { setField(2, v); }
...
class RemarketingSetting extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('RemarketingSetting', package: const $pb.PackageName('google.ads.googleads.v1.resources'))
    ..a<$0.StringValue>(1, 'googleGlobalSiteTag', $pb.PbFieldType.OM, $0.StringValue.getDefault, $0.StringValue.create)
    ..hasRequiredFields = false
  ;

  RemarketingSetting() : super();
  RemarketingSetting.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  RemarketingSetting.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  RemarketingSetting clone() => RemarketingSetting()..mergeFromMessage(this);
  RemarketingSetting copyWith(void Function(RemarketingSetting) updates) => super.copyWith((message) => updates(message as RemarketingSetting));
  $pb.BuilderInfo get info_ => _i;
  ...
  static RemarketingSetting getDefault() => _defaultInstance ??= create()..freeze();
  static RemarketingSetting _defaultInstance;

  $0.StringValue get googleGlobalSiteTag => $_getN(0);
  set googleGlobalSiteTag($0.StringValue v) { setField(1, v); }
