...
class TargetImpressionShareLocationEnum extends $pb.GeneratedMessage {
  ...
  TargetImpressionShareLocationEnum() : super();
  TargetImpressionShareLocationEnum.fromBuffer($core.List<$core.int> i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);
  TargetImpressionShareLocationEnum.fromJson($core.String i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromJson(i, r);
