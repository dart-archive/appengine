...
class VanityPharmaDisplayUrlModeEnum extends $pb.GeneratedMessage {
  ...
  VanityPharmaDisplayUrlModeEnum() : super();
  VanityPharmaDisplayUrlModeEnum.fromBuffer($core.List<$core.int> i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);
  VanityPharmaDisplayUrlModeEnum.fromJson($core.String i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromJson(i, r);
