...
abstract class DomainCategoryServiceBase extends $pb.GeneratedService {
  $async.Future<$0.DomainCategory> getDomainCategory(
      $pb.ServerContext ctx, GetDomainCategoryRequest request);

  $pb.GeneratedMessage createRequest($core.String method) {
    switch (method) {
      case 'GetDomainCategory':
        return GetDomainCategoryRequest();
      default:
  ...
  $async.Future<$pb.GeneratedMessage> handleCall($pb.ServerContext ctx,
    ...
    switch (method) {
      case 'GetDomainCategory':
        return this.getDomainCategory(ctx, request);
      default:
        throw $core.ArgumentError('Unknown method: $method');
    }
  }
  ...
  $core.Map<$core.String, $core.dynamic> get $json =>
      DomainCategoryServiceBase$json;
  $core.Map<$core.String, $core.Map<$core.String, $core.dynamic>>
      get $messageJson => DomainCategoryServiceBase$messageJson;
}
