...
class SharedCriterion extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('SharedCriterion', package: const $pb.PackageName('google.ads.googleads.v1.resources'))
    ..aOS(1, 'resourceName')
    ..a<$0.StringValue>(2, 'sharedSet', $pb.PbFieldType.OM, $0.StringValue.getDefault, $0.StringValue.create)
    ..a<$1.KeywordInfo>(3, 'keyword', $pb.PbFieldType.OM, $1.KeywordInfo.getDefault, $1.KeywordInfo.create)
    ..e<$2.CriterionTypeEnum_CriterionType>(4, 'type', $pb.PbFieldType.OE, $2.CriterionTypeEnum_CriterionType.UNSPECIFIED, $2.CriterionTypeEnum_CriterionType.valueOf, $2.CriterionTypeEnum_CriterionType.values)
    ..a<$1.YouTubeVideoInfo>(5, 'youtubeVideo', $pb.PbFieldType.OM, $1.YouTubeVideoInfo.getDefault, $1.YouTubeVideoInfo.create)
    ..a<$1.YouTubeChannelInfo>(6, 'youtubeChannel', $pb.PbFieldType.OM, $1.YouTubeChannelInfo.getDefault, $1.YouTubeChannelInfo.create)
    ..a<$1.PlacementInfo>(7, 'placement', $pb.PbFieldType.OM, $1.PlacementInfo.getDefault, $1.PlacementInfo.create)
    ..a<$1.MobileAppCategoryInfo>(8, 'mobileAppCategory', $pb.PbFieldType.OM, $1.MobileAppCategoryInfo.getDefault, $1.MobileAppCategoryInfo.create)
    ..a<$1.MobileApplicationInfo>(9, 'mobileApplication', $pb.PbFieldType.OM, $1.MobileApplicationInfo.getDefault, $1.MobileApplicationInfo.create)
  ...
  SharedCriterion.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  SharedCriterion.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  SharedCriterion clone() => SharedCriterion()..mergeFromMessage(this);
  SharedCriterion copyWith(void Function(SharedCriterion) updates) => super.copyWith((message) => updates(message as SharedCriterion));
  ...
  static SharedCriterion getDefault() => _defaultInstance ??= create()..freeze();
  ...
  set mobileApplication($1.MobileApplicationInfo v) { setField(9, v); }
