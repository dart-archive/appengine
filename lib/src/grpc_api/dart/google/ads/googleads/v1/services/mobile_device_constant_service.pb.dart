...
class GetMobileDeviceConstantRequest extends $pb.GeneratedMessage {
  ...
  GetMobileDeviceConstantRequest.fromBuffer($core.List<$core.int> i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);
  GetMobileDeviceConstantRequest.fromJson($core.String i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromJson(i, r);
...
class MobileDeviceConstantServiceApi {
  ...
  $async.Future<$0.MobileDeviceConstant> getMobileDeviceConstant(
      $pb.ClientContext ctx, GetMobileDeviceConstantRequest request) {
    var emptyResponse = $0.MobileDeviceConstant();
    return _client.invoke<$0.MobileDeviceConstant>(
        ctx,
