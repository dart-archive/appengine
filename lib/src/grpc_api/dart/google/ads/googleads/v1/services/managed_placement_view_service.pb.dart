...
class GetManagedPlacementViewRequest extends $pb.GeneratedMessage {
  ...
  GetManagedPlacementViewRequest.fromBuffer($core.List<$core.int> i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);
  GetManagedPlacementViewRequest.fromJson($core.String i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromJson(i, r);
...
class ManagedPlacementViewServiceApi {
  ...
  $async.Future<$0.ManagedPlacementView> getManagedPlacementView(
      $pb.ClientContext ctx, GetManagedPlacementViewRequest request) {
    var emptyResponse = $0.ManagedPlacementView();
    return _client.invoke<$0.ManagedPlacementView>(
        ctx,
