...
class BillingSetup_PaymentsAccountInfo extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..a<$0.StringValue>(1, 'paymentsAccountId', $pb.PbFieldType.OM,
        $0.StringValue.getDefault, $0.StringValue.create)
    ..a<$0.StringValue>(2, 'paymentsAccountName', $pb.PbFieldType.OM,
        $0.StringValue.getDefault, $0.StringValue.create)
    ..a<$0.StringValue>(3, 'paymentsProfileId', $pb.PbFieldType.OM,
        $0.StringValue.getDefault, $0.StringValue.create)
    ..a<$0.StringValue>(4, 'paymentsProfileName', $pb.PbFieldType.OM,
        $0.StringValue.getDefault, $0.StringValue.create)
    ..a<$0.StringValue>(5, 'secondaryPaymentsProfileId', $pb.PbFieldType.OM,
        $0.StringValue.getDefault, $0.StringValue.create)
    ..hasRequiredFields = false;

  BillingSetup_PaymentsAccountInfo() : super();
  BillingSetup_PaymentsAccountInfo.fromBuffer($core.List<$core.int> i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);
  BillingSetup_PaymentsAccountInfo.fromJson($core.String i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromJson(i, r);
  ...
  static BillingSetup_PaymentsAccountInfo getDefault() =>
...
class BillingSetup extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('BillingSetup',
    ...
    ..e<$1.BillingSetupStatusEnum_BillingSetupStatus>(
        ...
        $1.BillingSetupStatusEnum_BillingSetupStatus.valueOf,
        $1.BillingSetupStatusEnum_BillingSetupStatus.values)
    ..a<$0.StringValue>(9, 'startDateTime', $pb.PbFieldType.OM,
        $0.StringValue.getDefault, $0.StringValue.create)
    ...
    ..a<$0.StringValue>(11, 'paymentsAccount', $pb.PbFieldType.OM,
        $0.StringValue.getDefault, $0.StringValue.create)
    ..a<BillingSetup_PaymentsAccountInfo>(
        12,
        'paymentsAccountInfo',
        $pb.PbFieldType.OM,
        BillingSetup_PaymentsAccountInfo.getDefault,
        BillingSetup_PaymentsAccountInfo.create)
    ..a<$0.StringValue>(13, 'endDateTime', $pb.PbFieldType.OM,
        $0.StringValue.getDefault, $0.StringValue.create)
    ..e<$2.TimeTypeEnum_TimeType>(
        14,
        'endTimeType',
  ...
  BillingSetup() : super();
  BillingSetup.fromBuffer($core.List<$core.int> i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);
  BillingSetup.fromJson($core.String i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromJson(i, r);
