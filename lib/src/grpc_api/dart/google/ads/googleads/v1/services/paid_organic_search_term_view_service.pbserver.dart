...
abstract class PaidOrganicSearchTermViewServiceBase
    extends $pb.GeneratedService {
  $async.Future<$0.PaidOrganicSearchTermView> getPaidOrganicSearchTermView(
      $pb.ServerContext ctx, GetPaidOrganicSearchTermViewRequest request);

  $pb.GeneratedMessage createRequest($core.String method) {
    switch (method) {
      case 'GetPaidOrganicSearchTermView':
        return GetPaidOrganicSearchTermViewRequest();
      default:
  ...
  $async.Future<$pb.GeneratedMessage> handleCall($pb.ServerContext ctx,
    ...
    switch (method) {
      case 'GetPaidOrganicSearchTermView':
        return this.getPaidOrganicSearchTermView(ctx, request);
      default:
        throw $core.ArgumentError('Unknown method: $method');
    }
  }
  ...
  $core.Map<$core.String, $core.dynamic> get $json =>
      PaidOrganicSearchTermViewServiceBase$json;
  $core.Map<$core.String, $core.Map<$core.String, $core.dynamic>>
      get $messageJson => PaidOrganicSearchTermViewServiceBase$messageJson;
}
