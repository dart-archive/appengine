...
class GetHotelGroupViewRequest extends $pb.GeneratedMessage {
  ...
  GetHotelGroupViewRequest.fromBuffer($core.List<$core.int> i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);
  GetHotelGroupViewRequest.fromJson($core.String i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromJson(i, r);
...
class HotelGroupViewServiceApi {
  ...
  $async.Future<$0.HotelGroupView> getHotelGroupView(
      $pb.ClientContext ctx, GetHotelGroupViewRequest request) {
    var emptyResponse = $0.HotelGroupView();
    return _client.invoke<$0.HotelGroupView>(ctx, 'HotelGroupViewService',
        'GetHotelGroupView', request, emptyResponse);
  }
}
