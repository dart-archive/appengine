...
class StructuredSnippetPlaceholderFieldEnum extends $pb.GeneratedMessage {
  ...
  StructuredSnippetPlaceholderFieldEnum() : super();
  StructuredSnippetPlaceholderFieldEnum.fromBuffer($core.List<$core.int> i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);
  StructuredSnippetPlaceholderFieldEnum.fromJson($core.String i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromJson(i, r);
