...
class CampaignSharedSetStatusEnum extends $pb.GeneratedMessage {
  ...
  CampaignSharedSetStatusEnum() : super();
  CampaignSharedSetStatusEnum.fromBuffer($core.List<$core.int> i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);
  CampaignSharedSetStatusEnum.fromJson($core.String i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromJson(i, r);
  ...
  static CampaignSharedSetStatusEnum create() => CampaignSharedSetStatusEnum();
