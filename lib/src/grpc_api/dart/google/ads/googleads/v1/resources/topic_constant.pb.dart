...
class TopicConstant extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('TopicConstant', package: const $pb.PackageName('google.ads.googleads.v1.resources'))
    ..aOS(1, 'resourceName')
    ..a<$0.Int64Value>(2, 'id', $pb.PbFieldType.OM, $0.Int64Value.getDefault, $0.Int64Value.create)
    ..a<$0.StringValue>(3, 'topicConstantParent', $pb.PbFieldType.OM, $0.StringValue.getDefault, $0.StringValue.create)
    ..pc<$0.StringValue>(4, 'path', $pb.PbFieldType.PM,$0.StringValue.create)
    ..hasRequiredFields = false
  ;

  TopicConstant() : super();
  TopicConstant.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  TopicConstant.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  TopicConstant clone() => TopicConstant()..mergeFromMessage(this);
  TopicConstant copyWith(void Function(TopicConstant) updates) => super.copyWith((message) => updates(message as TopicConstant));
  ...
  set topicConstantParent($0.StringValue v) { setField(3, v); }
