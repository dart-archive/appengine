...
const GetCampaignSharedSetRequest$json = {
...
const CampaignSharedSetServiceBase$json = {
  '1': 'CampaignSharedSetService',
  '2': [
    {
      '1': 'GetCampaignSharedSet',
      '2': '.google.ads.googleads.v1.services.GetCampaignSharedSetRequest',
      '3': '.google.ads.googleads.v1.resources.CampaignSharedSet',
      '4': {}
    },
    {
      '1': 'MutateCampaignSharedSets',
      '2': '.google.ads.googleads.v1.services.MutateCampaignSharedSetsRequest',
      '3': '.google.ads.googleads.v1.services.MutateCampaignSharedSetsResponse',
      '4': {}
    },
  ],
};

const CampaignSharedSetServiceBase$messageJson = {
  '.google.ads.googleads.v1.services.GetCampaignSharedSetRequest':
      GetCampaignSharedSetRequest$json,
  '.google.ads.googleads.v1.resources.CampaignSharedSet':
      $0.CampaignSharedSet$json,
  '.google.protobuf.StringValue': $2.StringValue$json,
  '.google.ads.googleads.v1.services.MutateCampaignSharedSetsRequest':
      MutateCampaignSharedSetsRequest$json,
  '.google.ads.googleads.v1.services.CampaignSharedSetOperation':
      CampaignSharedSetOperation$json,
  '.google.ads.googleads.v1.services.MutateCampaignSharedSetsResponse':
      MutateCampaignSharedSetsResponse$json,
  '.google.ads.googleads.v1.services.MutateCampaignSharedSetResult':
      MutateCampaignSharedSetResult$json,
