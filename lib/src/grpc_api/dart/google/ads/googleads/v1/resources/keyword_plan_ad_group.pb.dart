...
class KeywordPlanAdGroup extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('KeywordPlanAdGroup', package: const $pb.PackageName('google.ads.googleads.v1.resources'))
    ..aOS(1, 'resourceName')
    ...
    ..a<$0.Int64Value>(5, 'cpcBidMicros', $pb.PbFieldType.OM, $0.Int64Value.getDefault, $0.Int64Value.create)
    ..hasRequiredFields = false
  ;

  KeywordPlanAdGroup() : super();
  KeywordPlanAdGroup.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  KeywordPlanAdGroup.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  KeywordPlanAdGroup clone() => KeywordPlanAdGroup()..mergeFromMessage(this);
  KeywordPlanAdGroup copyWith(void Function(KeywordPlanAdGroup) updates) => super.copyWith((message) => updates(message as KeywordPlanAdGroup));
  ...
  static KeywordPlanAdGroup getDefault() => _defaultInstance ??= create()..freeze();
  ...
  set cpcBidMicros($0.Int64Value v) { setField(5, v); }
