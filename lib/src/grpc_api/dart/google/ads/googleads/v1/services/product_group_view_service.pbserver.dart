...
abstract class ProductGroupViewServiceBase extends $pb.GeneratedService {
  $async.Future<$0.ProductGroupView> getProductGroupView(
      $pb.ServerContext ctx, GetProductGroupViewRequest request);

  $pb.GeneratedMessage createRequest($core.String method) {
    switch (method) {
      case 'GetProductGroupView':
        return GetProductGroupViewRequest();
      default:
  ...
  $async.Future<$pb.GeneratedMessage> handleCall($pb.ServerContext ctx,
    ...
    switch (method) {
      case 'GetProductGroupView':
        return this.getProductGroupView(ctx, request);
      default:
        throw $core.ArgumentError('Unknown method: $method');
    }
  }
  ...
  $core.Map<$core.String, $core.dynamic> get $json =>
      ProductGroupViewServiceBase$json;
  $core.Map<$core.String, $core.Map<$core.String, $core.dynamic>>
      get $messageJson => ProductGroupViewServiceBase$messageJson;
}
