...
abstract class SharedCriterionServiceBase extends $pb.GeneratedService {
  $async.Future<$0.SharedCriterion> getSharedCriterion(
      $pb.ServerContext ctx, GetSharedCriterionRequest request);
  $async.Future<MutateSharedCriteriaResponse> mutateSharedCriteria(
      $pb.ServerContext ctx, MutateSharedCriteriaRequest request);

  $pb.GeneratedMessage createRequest($core.String method) {
    switch (method) {
      case 'GetSharedCriterion':
        return GetSharedCriterionRequest();
      case 'MutateSharedCriteria':
        return MutateSharedCriteriaRequest();
      default:
  ...
  $async.Future<$pb.GeneratedMessage> handleCall($pb.ServerContext ctx,
    ...
    switch (method) {
      case 'GetSharedCriterion':
        return this.getSharedCriterion(ctx, request);
      case 'MutateSharedCriteria':
        return this.mutateSharedCriteria(ctx, request);
      default:
        throw $core.ArgumentError('Unknown method: $method');
    }
  }
  ...
  $core.Map<$core.String, $core.dynamic> get $json =>
      SharedCriterionServiceBase$json;
  $core.Map<$core.String, $core.Map<$core.String, $core.dynamic>>
      get $messageJson => SharedCriterionServiceBase$messageJson;
}
