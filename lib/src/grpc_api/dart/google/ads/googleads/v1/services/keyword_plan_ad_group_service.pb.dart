...
class KeywordPlanAdGroupServiceApi {
  ...
  $async.Future<$0.KeywordPlanAdGroup> getKeywordPlanAdGroup(
      $pb.ClientContext ctx, GetKeywordPlanAdGroupRequest request) {
    var emptyResponse = $0.KeywordPlanAdGroup();
    return _client.invoke<$0.KeywordPlanAdGroup>(
        ctx,
  ...
  $async.Future<MutateKeywordPlanAdGroupsResponse> mutateKeywordPlanAdGroups(
      $pb.ClientContext ctx, MutateKeywordPlanAdGroupsRequest request) {
    var emptyResponse = MutateKeywordPlanAdGroupsResponse();
    return _client.invoke<MutateKeywordPlanAdGroupsResponse>(
        ctx,
        'KeywordPlanAdGroupService',
