...
class ServedAssetFieldTypeEnum extends $pb.GeneratedMessage {
  ...
  ServedAssetFieldTypeEnum() : super();
  ServedAssetFieldTypeEnum.fromBuffer($core.List<$core.int> i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);
  ServedAssetFieldTypeEnum.fromJson($core.String i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromJson(i, r);
  ...
  static ServedAssetFieldTypeEnum create() => ServedAssetFieldTypeEnum();
