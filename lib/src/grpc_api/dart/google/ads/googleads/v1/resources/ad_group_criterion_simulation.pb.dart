...
class AdGroupCriterionSimulation extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('AdGroupCriterionSimulation', package: const $pb.PackageName('google.ads.googleads.v1.resources'))
    ..aOS(1, 'resourceName')
  ...
  AdGroupCriterionSimulation.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  AdGroupCriterionSimulation.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  AdGroupCriterionSimulation clone() => AdGroupCriterionSimulation()..mergeFromMessage(this);
  AdGroupCriterionSimulation copyWith(void Function(AdGroupCriterionSimulation) updates) => super.copyWith((message) => updates(message as AdGroupCriterionSimulation));
  ...
  static AdGroupCriterionSimulation getDefault() => _defaultInstance ??= create()..freeze();
