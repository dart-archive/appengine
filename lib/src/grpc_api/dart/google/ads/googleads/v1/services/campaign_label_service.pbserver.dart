...
abstract class CampaignLabelServiceBase extends $pb.GeneratedService {
  $async.Future<$0.CampaignLabel> getCampaignLabel(
      $pb.ServerContext ctx, GetCampaignLabelRequest request);
  $async.Future<MutateCampaignLabelsResponse> mutateCampaignLabels(
      $pb.ServerContext ctx, MutateCampaignLabelsRequest request);

  $pb.GeneratedMessage createRequest($core.String method) {
    switch (method) {
      case 'GetCampaignLabel':
        return GetCampaignLabelRequest();
      case 'MutateCampaignLabels':
        return MutateCampaignLabelsRequest();
      default:
  ...
  $async.Future<$pb.GeneratedMessage> handleCall($pb.ServerContext ctx,
    ...
    switch (method) {
      case 'GetCampaignLabel':
        return this.getCampaignLabel(ctx, request);
      case 'MutateCampaignLabels':
        return this.mutateCampaignLabels(ctx, request);
      default:
        throw $core.ArgumentError('Unknown method: $method');
    }
  }
  ...
  $core.Map<$core.String, $core.dynamic> get $json =>
      CampaignLabelServiceBase$json;
  $core.Map<$core.String, $core.Map<$core.String, $core.dynamic>>
      get $messageJson => CampaignLabelServiceBase$messageJson;
}
