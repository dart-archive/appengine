...
class BiddingStrategy extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('BiddingStrategy', package: const $pb.PackageName('google.ads.googleads.v1.resources'))
    ..aOS(1, 'resourceName')
    ...
    ..e<$2.BiddingStrategyTypeEnum_BiddingStrategyType>(5, 'type', $pb.PbFieldType.OE, $2.BiddingStrategyTypeEnum_BiddingStrategyType.UNSPECIFIED, $2.BiddingStrategyTypeEnum_BiddingStrategyType.valueOf, $2.BiddingStrategyTypeEnum_BiddingStrategyType.values)
    ..a<$1.EnhancedCpc>(7, 'enhancedCpc', $pb.PbFieldType.OM, $1.EnhancedCpc.getDefault, $1.EnhancedCpc.create)
    ..a<$1.PageOnePromoted>(8, 'pageOnePromoted', $pb.PbFieldType.OM, $1.PageOnePromoted.getDefault, $1.PageOnePromoted.create)
    ..a<$1.TargetCpa>(9, 'targetCpa', $pb.PbFieldType.OM, $1.TargetCpa.getDefault, $1.TargetCpa.create)
    ..a<$1.TargetOutrankShare>(10, 'targetOutrankShare', $pb.PbFieldType.OM, $1.TargetOutrankShare.getDefault, $1.TargetOutrankShare.create)
    ..a<$1.TargetRoas>(11, 'targetRoas', $pb.PbFieldType.OM, $1.TargetRoas.getDefault, $1.TargetRoas.create)
    ..a<$1.TargetSpend>(12, 'targetSpend', $pb.PbFieldType.OM, $1.TargetSpend.getDefault, $1.TargetSpend.create)
    ..a<$0.Int64Value>(13, 'campaignCount', $pb.PbFieldType.OM, $0.Int64Value.getDefault, $0.Int64Value.create)
  ...
  BiddingStrategy.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  BiddingStrategy.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  BiddingStrategy clone() => BiddingStrategy()..mergeFromMessage(this);
  BiddingStrategy copyWith(void Function(BiddingStrategy) updates) => super.copyWith((message) => updates(message as BiddingStrategy));
  ...
  static BiddingStrategy getDefault() => _defaultInstance ??= create()..freeze();
  ...
  set status($3.BiddingStrategyStatusEnum_BiddingStrategyStatus v) { setField(15, v); }
