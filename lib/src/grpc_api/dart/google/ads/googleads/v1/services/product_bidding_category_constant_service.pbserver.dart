...
abstract class ProductBiddingCategoryConstantServiceBase
    extends $pb.GeneratedService {
  $async.Future<$0.ProductBiddingCategoryConstant>
      getProductBiddingCategoryConstant($pb.ServerContext ctx,
          GetProductBiddingCategoryConstantRequest request);

  $pb.GeneratedMessage createRequest($core.String method) {
    switch (method) {
      case 'GetProductBiddingCategoryConstant':
        return GetProductBiddingCategoryConstantRequest();
      default:
  ...
  $async.Future<$pb.GeneratedMessage> handleCall($pb.ServerContext ctx,
    ...
    switch (method) {
      case 'GetProductBiddingCategoryConstant':
        return this.getProductBiddingCategoryConstant(ctx, request);
      default:
        throw $core.ArgumentError('Unknown method: $method');
    }
  }
  ...
  $core.Map<$core.String, $core.dynamic> get $json =>
      ProductBiddingCategoryConstantServiceBase$json;
  $core.Map<$core.String, $core.Map<$core.String, $core.dynamic>>
      get $messageJson => ProductBiddingCategoryConstantServiceBase$messageJson;
}
