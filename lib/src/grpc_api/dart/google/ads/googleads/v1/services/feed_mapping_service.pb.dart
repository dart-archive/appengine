...
class GetFeedMappingRequest extends $pb.GeneratedMessage {
  ...
  GetFeedMappingRequest.fromBuffer($core.List<$core.int> i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);
  GetFeedMappingRequest.fromJson($core.String i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromJson(i, r);
...
class MutateFeedMappingsRequest extends $pb.GeneratedMessage {
  ...
  MutateFeedMappingsRequest.fromBuffer($core.List<$core.int> i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);
  MutateFeedMappingsRequest.fromJson($core.String i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromJson(i, r);
...
class FeedMappingOperation extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('FeedMappingOperation',
      package: const $pb.PackageName('google.ads.googleads.v1.services'))
    ..a<$0.FeedMapping>(1, 'create_1', $pb.PbFieldType.OM,
        $0.FeedMapping.getDefault, $0.FeedMapping.create)
    ..aOS(3, 'remove')
    ..oo(0, [1, 3])
    ..hasRequiredFields = false;

  FeedMappingOperation() : super();
  FeedMappingOperation.fromBuffer($core.List<$core.int> i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);
  FeedMappingOperation.fromJson($core.String i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromJson(i, r);
...
class MutateFeedMappingsResponse extends $pb.GeneratedMessage {
  ...
  MutateFeedMappingsResponse.fromBuffer($core.List<$core.int> i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);
  MutateFeedMappingsResponse.fromJson($core.String i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromJson(i, r);
...
class MutateFeedMappingResult extends $pb.GeneratedMessage {
  ...
  MutateFeedMappingResult.fromBuffer($core.List<$core.int> i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);
  MutateFeedMappingResult.fromJson($core.String i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromJson(i, r);
...
class FeedMappingServiceApi {
  ...
  $async.Future<$0.FeedMapping> getFeedMapping(
      $pb.ClientContext ctx, GetFeedMappingRequest request) {
    var emptyResponse = $0.FeedMapping();
    return _client.invoke<$0.FeedMapping>(
        ctx, 'FeedMappingService', 'GetFeedMapping', request, emptyResponse);
  }

  $async.Future<MutateFeedMappingsResponse> mutateFeedMappings(
      $pb.ClientContext ctx, MutateFeedMappingsRequest request) {
    var emptyResponse = MutateFeedMappingsResponse();
    return _client.invoke<MutateFeedMappingsResponse>(ctx, 'FeedMappingService',
        'MutateFeedMappings', request, emptyResponse);
  }
}
