...
import '../resources/ad_group_criterion_simulation.pbjson.dart' as $0;
import '../../../../protobuf/wrappers.pbjson.dart' as $1;
import '../common/simulation.pbjson.dart' as $2;

const GetAdGroupCriterionSimulationRequest$json = {
...
const AdGroupCriterionSimulationServiceBase$json = {
  '1': 'AdGroupCriterionSimulationService',
  '2': [
    {
      '1': 'GetAdGroupCriterionSimulation',
      '2':
          '.google.ads.googleads.v1.services.GetAdGroupCriterionSimulationRequest',
      '3': '.google.ads.googleads.v1.resources.AdGroupCriterionSimulation',
      '4': {}
    },
  ],
};

const AdGroupCriterionSimulationServiceBase$messageJson = {
  '.google.ads.googleads.v1.services.GetAdGroupCriterionSimulationRequest':
      GetAdGroupCriterionSimulationRequest$json,
  '.google.ads.googleads.v1.resources.AdGroupCriterionSimulation':
      $0.AdGroupCriterionSimulation$json,
