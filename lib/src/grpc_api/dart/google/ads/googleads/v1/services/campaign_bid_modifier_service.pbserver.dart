...
abstract class CampaignBidModifierServiceBase extends $pb.GeneratedService {
  $async.Future<$0.CampaignBidModifier> getCampaignBidModifier(
      $pb.ServerContext ctx, GetCampaignBidModifierRequest request);
  $async.Future<MutateCampaignBidModifiersResponse> mutateCampaignBidModifiers(
      $pb.ServerContext ctx, MutateCampaignBidModifiersRequest request);

  $pb.GeneratedMessage createRequest($core.String method) {
    switch (method) {
      case 'GetCampaignBidModifier':
        return GetCampaignBidModifierRequest();
      case 'MutateCampaignBidModifiers':
        return MutateCampaignBidModifiersRequest();
      default:
  ...
  $async.Future<$pb.GeneratedMessage> handleCall($pb.ServerContext ctx,
    ...
    switch (method) {
      case 'GetCampaignBidModifier':
        return this.getCampaignBidModifier(ctx, request);
      case 'MutateCampaignBidModifiers':
        return this.mutateCampaignBidModifiers(ctx, request);
      default:
        throw $core.ArgumentError('Unknown method: $method');
    }
  }
  ...
  $core.Map<$core.String, $core.dynamic> get $json =>
      CampaignBidModifierServiceBase$json;
  $core.Map<$core.String, $core.Map<$core.String, $core.dynamic>>
      get $messageJson => CampaignBidModifierServiceBase$messageJson;
}
