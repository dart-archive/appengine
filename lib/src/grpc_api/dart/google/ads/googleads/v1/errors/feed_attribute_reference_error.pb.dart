...
class FeedAttributeReferenceErrorEnum extends $pb.GeneratedMessage {
  ...
  FeedAttributeReferenceErrorEnum() : super();
  FeedAttributeReferenceErrorEnum.fromBuffer($core.List<$core.int> i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);
  FeedAttributeReferenceErrorEnum.fromJson($core.String i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromJson(i, r);
