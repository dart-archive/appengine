...
class UrlCollection extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('UrlCollection',
    ...
    ..a<$0.StringValue>(1, 'urlCollectionId', $pb.PbFieldType.OM,
        $0.StringValue.getDefault, $0.StringValue.create)
    ..pc<$0.StringValue>(
        2, 'finalUrls', $pb.PbFieldType.PM, $0.StringValue.create)
    ..pc<$0.StringValue>(
        3, 'finalMobileUrls', $pb.PbFieldType.PM, $0.StringValue.create)
    ..a<$0.StringValue>(4, 'trackingUrlTemplate', $pb.PbFieldType.OM,
        $0.StringValue.getDefault, $0.StringValue.create)
    ..hasRequiredFields = false;

  UrlCollection() : super();
  UrlCollection.fromBuffer($core.List<$core.int> i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);
  UrlCollection.fromJson($core.String i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromJson(i, r);
