...
class Ad extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Ad', package: const $pb.PackageName('google.ads.googleads.v1.resources'))
    ...
    ..a<$0.StringValue>(4, 'displayUrl', $pb.PbFieldType.OM, $0.StringValue.getDefault, $0.StringValue.create)
    ..e<$5.AdTypeEnum_AdType>(5, 'type', $pb.PbFieldType.OE, $5.AdTypeEnum_AdType.UNSPECIFIED, $5.AdTypeEnum_AdType.valueOf, $5.AdTypeEnum_AdType.values)
    ..a<$1.TextAdInfo>(6, 'textAd', $pb.PbFieldType.OM, $1.TextAdInfo.getDefault, $1.TextAdInfo.create)
    ..a<$1.ExpandedTextAdInfo>(7, 'expandedTextAd', $pb.PbFieldType.OM, $1.ExpandedTextAdInfo.getDefault, $1.ExpandedTextAdInfo.create)
    ..pc<$2.CustomParameter>(10, 'urlCustomParameters', $pb.PbFieldType.PM,$2.CustomParameter.create)
  ...
  Ad() : super();
  Ad.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  Ad.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  Ad clone() => Ad()..mergeFromMessage(this);
  Ad copyWith(void Function(Ad) updates) => super.copyWith((message) => updates(message as Ad));
  ...
  set callOnlyAd($1.CallOnlyAdInfo v) { setField(13, v); }
  ...
  set expandedDynamicSearchAd($1.ExpandedDynamicSearchAdInfo v) { setField(14, v); }
  ...
  set hotelAd($1.HotelAdInfo v) { setField(15, v); }
  ...
  set shoppingSmartAd($1.ShoppingSmartAdInfo v) { setField(17, v); }
  ...
  $7.SystemManagedResourceSourceEnum_SystemManagedResourceSource get systemManagedResourceSource => $_getN(22);
  set systemManagedResourceSource($7.SystemManagedResourceSourceEnum_SystemManagedResourceSource v) { setField(27, v); }
  ...
  set legacyResponsiveDisplayAd($1.LegacyResponsiveDisplayAdInfo v) { setField(28, v); }
  ...
  set responsiveDisplayAd($1.ResponsiveDisplayAdInfo v) { setField(31, v); }
  ...
  set displayUploadAd($1.DisplayUploadAdInfo v) { setField(33, v); }
  ...
  set appEngagementAd($1.AppEngagementAdInfo v) { setField(34, v); }
  ...
  $1.ShoppingComparisonListingAdInfo get shoppingComparisonListingAd => $_getN(30);
  set shoppingComparisonListingAd($1.ShoppingComparisonListingAdInfo v) { setField(36, v); }
