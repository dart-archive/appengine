...
class PolicyFindingErrorEnum_PolicyFindingError extends $pb.ProtobufEnum {
  static const PolicyFindingErrorEnum_PolicyFindingError UNSPECIFIED = PolicyFindingErrorEnum_PolicyFindingError._(0, 'UNSPECIFIED');
  static const PolicyFindingErrorEnum_PolicyFindingError UNKNOWN = PolicyFindingErrorEnum_PolicyFindingError._(1, 'UNKNOWN');
  static const PolicyFindingErrorEnum_PolicyFindingError POLICY_FINDING = PolicyFindingErrorEnum_PolicyFindingError._(2, 'POLICY_FINDING');
  static const PolicyFindingErrorEnum_PolicyFindingError POLICY_TOPIC_NOT_FOUND = PolicyFindingErrorEnum_PolicyFindingError._(3, 'POLICY_TOPIC_NOT_FOUND');
