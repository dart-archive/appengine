...
abstract class MobileAppCategoryConstantServiceBase
    extends $pb.GeneratedService {
  $async.Future<$0.MobileAppCategoryConstant> getMobileAppCategoryConstant(
      $pb.ServerContext ctx, GetMobileAppCategoryConstantRequest request);

  $pb.GeneratedMessage createRequest($core.String method) {
    switch (method) {
      case 'GetMobileAppCategoryConstant':
        return GetMobileAppCategoryConstantRequest();
      default:
  ...
  $async.Future<$pb.GeneratedMessage> handleCall($pb.ServerContext ctx,
    ...
    switch (method) {
      case 'GetMobileAppCategoryConstant':
        return this.getMobileAppCategoryConstant(ctx, request);
      default:
        throw $core.ArgumentError('Unknown method: $method');
    }
  }
  ...
  $core.Map<$core.String, $core.dynamic> get $json =>
      MobileAppCategoryConstantServiceBase$json;
  $core.Map<$core.String, $core.Map<$core.String, $core.dynamic>>
      get $messageJson => MobileAppCategoryConstantServiceBase$messageJson;
}
