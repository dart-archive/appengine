...
class GetAdGroupExtensionSettingRequest extends $pb.GeneratedMessage {
  ...
  GetAdGroupExtensionSettingRequest.fromBuffer($core.List<$core.int> i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);
  GetAdGroupExtensionSettingRequest.fromJson($core.String i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromJson(i, r);
...
class MutateAdGroupExtensionSettingsRequest extends $pb.GeneratedMessage {
  ...
  MutateAdGroupExtensionSettingsRequest.fromBuffer($core.List<$core.int> i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);
  MutateAdGroupExtensionSettingsRequest.fromJson($core.String i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromJson(i, r);
...
class AdGroupExtensionSettingOperation extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName('google.ads.googleads.v1.services'))
    ..a<$0.AdGroupExtensionSetting>(
        1,
        'create_1',
        $pb.PbFieldType.OM,
        $0.AdGroupExtensionSetting.getDefault,
        $0.AdGroupExtensionSetting.create)
    ..a<$0.AdGroupExtensionSetting>(
        2,
        'update',
        $pb.PbFieldType.OM,
  ...
  AdGroupExtensionSettingOperation.fromBuffer($core.List<$core.int> i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);
  AdGroupExtensionSettingOperation.fromJson($core.String i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromJson(i, r);
  ...
  set create_1($0.AdGroupExtensionSetting v) {
    setField(1, v);
  }
  ...
  set update($0.AdGroupExtensionSetting v) {
    setField(2, v);
  }
...
class MutateAdGroupExtensionSettingsResponse extends $pb.GeneratedMessage {
  ...
  MutateAdGroupExtensionSettingsResponse.fromBuffer($core.List<$core.int> i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);
  MutateAdGroupExtensionSettingsResponse.fromJson($core.String i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromJson(i, r);
...
class MutateAdGroupExtensionSettingResult extends $pb.GeneratedMessage {
  ...
  MutateAdGroupExtensionSettingResult.fromBuffer($core.List<$core.int> i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);
  MutateAdGroupExtensionSettingResult.fromJson($core.String i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromJson(i, r);
...
class AdGroupExtensionSettingServiceApi {
  ...
  $async.Future<$0.AdGroupExtensionSetting> getAdGroupExtensionSetting(
      $pb.ClientContext ctx, GetAdGroupExtensionSettingRequest request) {
    var emptyResponse = $0.AdGroupExtensionSetting();
    return _client.invoke<$0.AdGroupExtensionSetting>(
        ctx,
  ...
  $async.Future<MutateAdGroupExtensionSettingsResponse>
      mutateAdGroupExtensionSettings($pb.ClientContext ctx,
          MutateAdGroupExtensionSettingsRequest request) {
    var emptyResponse = MutateAdGroupExtensionSettingsResponse();
    return _client.invoke<MutateAdGroupExtensionSettingsResponse>(
        ctx,
        'AdGroupExtensionSettingService',
