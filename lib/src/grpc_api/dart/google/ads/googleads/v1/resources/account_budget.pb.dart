...
class AccountBudget_PendingAccountBudgetProposal extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..e<$4.AccountBudgetProposalTypeEnum_AccountBudgetProposalType>(
        ...
        'proposalType',
        $pb.PbFieldType.OE,
        $4.AccountBudgetProposalTypeEnum_AccountBudgetProposalType.UNSPECIFIED,
    ...
    ..a<$0.Int64Value>(7, 'spendingLimitMicros', $pb.PbFieldType.OM,
...
class AccountBudget extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('AccountBudget',
    ...
    ..a<$0.Int64Value>(2, 'id', $pb.PbFieldType.OM, $0.Int64Value.getDefault,
        $0.Int64Value.create)
    ..a<$0.StringValue>(3, 'billingSetup', $pb.PbFieldType.OM,
        $0.StringValue.getDefault, $0.StringValue.create)
    ..e<$1.AccountBudgetStatusEnum_AccountBudgetStatus>(
        ...
        $1.AccountBudgetStatusEnum_AccountBudgetStatus.valueOf,
        $1.AccountBudgetStatusEnum_AccountBudgetStatus.values)
    ..a<$0.StringValue>(5, 'name', $pb.PbFieldType.OM,
        $0.StringValue.getDefault, $0.StringValue.create)
    ..a<$0.StringValue>(6, 'proposedStartDateTime', $pb.PbFieldType.OM,
        $0.StringValue.getDefault, $0.StringValue.create)
    ..a<$0.StringValue>(7, 'approvedStartDateTime', $pb.PbFieldType.OM,
        $0.StringValue.getDefault, $0.StringValue.create)
    ..a<$0.StringValue>(8, 'proposedEndDateTime', $pb.PbFieldType.OM,
        $0.StringValue.getDefault, $0.StringValue.create)
    ..e<$2.TimeTypeEnum_TimeType>(
        9,
        'proposedEndTimeType',
        ...
        $2.TimeTypeEnum_TimeType.valueOf,
        $2.TimeTypeEnum_TimeType.values)
    ..a<$0.StringValue>(10, 'approvedEndDateTime', $pb.PbFieldType.OM,
        $0.StringValue.getDefault, $0.StringValue.create)
    ..e<$2.TimeTypeEnum_TimeType>(
        11,
        'approvedEndTimeType',
