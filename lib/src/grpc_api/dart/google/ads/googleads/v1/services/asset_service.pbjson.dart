...
const MutateAssetsRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'operations', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v1.services.AssetOperation', '10': 'operations'},
  ],
};
...
const AssetOperation$json = const {
  '1': 'AssetOperation',
  '2': const [
    const {'1': 'create', '3': 1, '4': 1, '5': 11, '6': '.google.ads.googleads.v1.resources.Asset', '9': 0, '10': 'create'},
  ],
  '8': const [
    const {'1': 'operation'},
  ],
...
const MutateAssetsResponse$json = const {
  ...
  '2': const [
    const {'1': 'results', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v1.services.MutateAssetResult', '10': 'results'},
  ],
};
...
const AssetServiceBase$json = const {
  '1': 'AssetService',
  '2': const [
    const {'1': 'GetAsset', '2': '.google.ads.googleads.v1.services.GetAssetRequest', '3': '.google.ads.googleads.v1.resources.Asset', '4': const {}},
    const {'1': 'MutateAssets', '2': '.google.ads.googleads.v1.services.MutateAssetsRequest', '3': '.google.ads.googleads.v1.services.MutateAssetsResponse', '4': const {}},
  ],
};
...
const AssetServiceBase$messageJson = const {
  ...
  '.google.ads.googleads.v1.common.YoutubeVideoAsset': $2.YoutubeVideoAsset$json,
  ...
  '.google.ads.googleads.v1.services.MutateAssetsRequest': MutateAssetsRequest$json,
  '.google.ads.googleads.v1.services.AssetOperation': AssetOperation$json,
  '.google.ads.googleads.v1.services.MutateAssetsResponse': MutateAssetsResponse$json,
