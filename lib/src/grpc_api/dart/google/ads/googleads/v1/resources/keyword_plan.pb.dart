...
class KeywordPlan extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('KeywordPlan', package: const $pb.PackageName('google.ads.googleads.v1.resources'))
    ..aOS(1, 'resourceName')
    ...
    ..a<KeywordPlanForecastPeriod>(4, 'forecastPeriod', $pb.PbFieldType.OM, KeywordPlanForecastPeriod.getDefault, KeywordPlanForecastPeriod.create)
    ..hasRequiredFields = false
  ;

  KeywordPlan() : super();
  KeywordPlan.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  KeywordPlan.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  KeywordPlan clone() => KeywordPlan()..mergeFromMessage(this);
  KeywordPlan copyWith(void Function(KeywordPlan) updates) => super.copyWith((message) => updates(message as KeywordPlan));
...
class KeywordPlanForecastPeriod extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('KeywordPlanForecastPeriod', package: const $pb.PackageName('google.ads.googleads.v1.resources'))
    ..e<$2.KeywordPlanForecastIntervalEnum_KeywordPlanForecastInterval>(1, 'dateInterval', $pb.PbFieldType.OE, $2.KeywordPlanForecastIntervalEnum_KeywordPlanForecastInterval.UNSPECIFIED, $2.KeywordPlanForecastIntervalEnum_KeywordPlanForecastInterval.valueOf, $2.KeywordPlanForecastIntervalEnum_KeywordPlanForecastInterval.values)
    ..a<$1.DateRange>(2, 'dateRange', $pb.PbFieldType.OM, $1.DateRange.getDefault, $1.DateRange.create)
    ..oo(0, [1, 2])
    ..hasRequiredFields = false
  ;

  KeywordPlanForecastPeriod() : super();
  KeywordPlanForecastPeriod.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  KeywordPlanForecastPeriod.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  KeywordPlanForecastPeriod clone() => KeywordPlanForecastPeriod()..mergeFromMessage(this);
  KeywordPlanForecastPeriod copyWith(void Function(KeywordPlanForecastPeriod) updates) => super.copyWith((message) => updates(message as KeywordPlanForecastPeriod));
  $pb.BuilderInfo get info_ => _i;
  ...
  static KeywordPlanForecastPeriod getDefault() => _defaultInstance ??= create()..freeze();
  ...
  $2.KeywordPlanForecastIntervalEnum_KeywordPlanForecastInterval get dateInterval => $_getN(0);
  set dateInterval($2.KeywordPlanForecastIntervalEnum_KeywordPlanForecastInterval v) { setField(1, v); }
  $core.bool hasDateInterval() => $_has(0);
  void clearDateInterval() => clearField(1);

  $1.DateRange get dateRange => $_getN(1);
  set dateRange($1.DateRange v) { setField(2, v); }
