...
class AppStoreEnum_AppStore extends $pb.ProtobufEnum {
  static const AppStoreEnum_AppStore UNSPECIFIED = AppStoreEnum_AppStore._(0, 'UNSPECIFIED');
  static const AppStoreEnum_AppStore UNKNOWN = AppStoreEnum_AppStore._(1, 'UNKNOWN');
  static const AppStoreEnum_AppStore APPLE_ITUNES = AppStoreEnum_AppStore._(2, 'APPLE_ITUNES');
  static const AppStoreEnum_AppStore GOOGLE_PLAY = AppStoreEnum_AppStore._(3, 'GOOGLE_PLAY');
