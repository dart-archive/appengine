...
class KeywordPlanAdGroupErrorEnum_KeywordPlanAdGroupError extends $pb.ProtobufEnum {
  static const KeywordPlanAdGroupErrorEnum_KeywordPlanAdGroupError UNSPECIFIED = KeywordPlanAdGroupErrorEnum_KeywordPlanAdGroupError._(0, 'UNSPECIFIED');
  static const KeywordPlanAdGroupErrorEnum_KeywordPlanAdGroupError UNKNOWN = KeywordPlanAdGroupErrorEnum_KeywordPlanAdGroupError._(1, 'UNKNOWN');
  static const KeywordPlanAdGroupErrorEnum_KeywordPlanAdGroupError INVALID_NAME = KeywordPlanAdGroupErrorEnum_KeywordPlanAdGroupError._(2, 'INVALID_NAME');
  static const KeywordPlanAdGroupErrorEnum_KeywordPlanAdGroupError DUPLICATE_NAME = KeywordPlanAdGroupErrorEnum_KeywordPlanAdGroupError._(3, 'DUPLICATE_NAME');
