...
class AdGroupBidModifier extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('AdGroupBidModifier', package: const $pb.PackageName('google.ads.googleads.v1.resources'))
    ..aOS(1, 'resourceName')
    ...
    ..a<$0.DoubleValue>(4, 'bidModifier', $pb.PbFieldType.OM, $0.DoubleValue.getDefault, $0.DoubleValue.create)
    ..a<$1.HotelDateSelectionTypeInfo>(5, 'hotelDateSelectionType', $pb.PbFieldType.OM, $1.HotelDateSelectionTypeInfo.getDefault, $1.HotelDateSelectionTypeInfo.create)
    ..a<$1.HotelAdvanceBookingWindowInfo>(6, 'hotelAdvanceBookingWindow', $pb.PbFieldType.OM, $1.HotelAdvanceBookingWindowInfo.getDefault, $1.HotelAdvanceBookingWindowInfo.create)
    ..a<$1.HotelLengthOfStayInfo>(7, 'hotelLengthOfStay', $pb.PbFieldType.OM, $1.HotelLengthOfStayInfo.getDefault, $1.HotelLengthOfStayInfo.create)
    ..a<$1.HotelCheckInDayInfo>(8, 'hotelCheckInDay', $pb.PbFieldType.OM, $1.HotelCheckInDayInfo.getDefault, $1.HotelCheckInDayInfo.create)
    ..a<$0.StringValue>(9, 'baseAdGroup', $pb.PbFieldType.OM, $0.StringValue.getDefault, $0.StringValue.create)
    ..e<$2.BidModifierSourceEnum_BidModifierSource>(10, 'bidModifierSource', $pb.PbFieldType.OE, $2.BidModifierSourceEnum_BidModifierSource.UNSPECIFIED, $2.BidModifierSourceEnum_BidModifierSource.valueOf, $2.BidModifierSourceEnum_BidModifierSource.values)
    ..a<$1.DeviceInfo>(11, 'device', $pb.PbFieldType.OM, $1.DeviceInfo.getDefault, $1.DeviceInfo.create)
  ...
  AdGroupBidModifier.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  AdGroupBidModifier.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  AdGroupBidModifier clone() => AdGroupBidModifier()..mergeFromMessage(this);
  AdGroupBidModifier copyWith(void Function(AdGroupBidModifier) updates) => super.copyWith((message) => updates(message as AdGroupBidModifier));
  ...
  static AdGroupBidModifier getDefault() => _defaultInstance ??= create()..freeze();
  ...
  set bidModifier($0.DoubleValue v) { setField(4, v); }
  ...
  set hotelDateSelectionType($1.HotelDateSelectionTypeInfo v) { setField(5, v); }
  ...
  set hotelAdvanceBookingWindow($1.HotelAdvanceBookingWindowInfo v) { setField(6, v); }
  ...
  set hotelLengthOfStay($1.HotelLengthOfStayInfo v) { setField(7, v); }
