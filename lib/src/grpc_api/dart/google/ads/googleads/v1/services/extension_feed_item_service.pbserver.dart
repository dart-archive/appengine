...
abstract class ExtensionFeedItemServiceBase extends $pb.GeneratedService {
  $async.Future<$0.ExtensionFeedItem> getExtensionFeedItem(
      $pb.ServerContext ctx, GetExtensionFeedItemRequest request);
  $async.Future<MutateExtensionFeedItemsResponse> mutateExtensionFeedItems(
      $pb.ServerContext ctx, MutateExtensionFeedItemsRequest request);

  $pb.GeneratedMessage createRequest($core.String method) {
    switch (method) {
      case 'GetExtensionFeedItem':
        return GetExtensionFeedItemRequest();
      case 'MutateExtensionFeedItems':
        return MutateExtensionFeedItemsRequest();
      default:
  ...
  $async.Future<$pb.GeneratedMessage> handleCall($pb.ServerContext ctx,
    ...
    switch (method) {
      case 'GetExtensionFeedItem':
        return this.getExtensionFeedItem(ctx, request);
      case 'MutateExtensionFeedItems':
        return this.mutateExtensionFeedItems(ctx, request);
      default:
        throw $core.ArgumentError('Unknown method: $method');
    }
  }
  ...
  $core.Map<$core.String, $core.dynamic> get $json =>
      ExtensionFeedItemServiceBase$json;
  $core.Map<$core.String, $core.Map<$core.String, $core.dynamic>>
      get $messageJson => ExtensionFeedItemServiceBase$messageJson;
}
