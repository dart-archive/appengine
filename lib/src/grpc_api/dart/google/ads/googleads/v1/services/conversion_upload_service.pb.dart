...
class UploadClickConversionsRequest extends $pb.GeneratedMessage {
  ...
  UploadClickConversionsRequest.fromBuffer($core.List<$core.int> i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);
  UploadClickConversionsRequest.fromJson($core.String i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromJson(i, r);
...
class UploadClickConversionsResponse extends $pb.GeneratedMessage {
  ...
  UploadClickConversionsResponse.fromBuffer($core.List<$core.int> i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);
  UploadClickConversionsResponse.fromJson($core.String i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromJson(i, r);
...
class UploadCallConversionsRequest extends $pb.GeneratedMessage {
  ...
  UploadCallConversionsRequest.fromBuffer($core.List<$core.int> i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);
  UploadCallConversionsRequest.fromJson($core.String i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromJson(i, r);
...
class UploadCallConversionsResponse extends $pb.GeneratedMessage {
  ...
  UploadCallConversionsResponse.fromBuffer($core.List<$core.int> i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);
  UploadCallConversionsResponse.fromJson($core.String i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromJson(i, r);
...
class ClickConversion extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ClickConversion',
    ...
    ..a<$1.StringValue>(2, 'conversionAction', $pb.PbFieldType.OM,
        $1.StringValue.getDefault, $1.StringValue.create)
    ..a<$1.StringValue>(3, 'conversionDateTime', $pb.PbFieldType.OM,
        $1.StringValue.getDefault, $1.StringValue.create)
    ..a<$1.DoubleValue>(4, 'conversionValue', $pb.PbFieldType.OM,
        $1.DoubleValue.getDefault, $1.DoubleValue.create)
    ..a<$1.StringValue>(5, 'currencyCode', $pb.PbFieldType.OM,
        $1.StringValue.getDefault, $1.StringValue.create)
    ..a<$1.StringValue>(6, 'orderId', $pb.PbFieldType.OM,
        $1.StringValue.getDefault, $1.StringValue.create)
  ...
  ClickConversion.fromBuffer($core.List<$core.int> i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);
  ClickConversion.fromJson($core.String i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromJson(i, r);
  ...
  set conversionValue($1.DoubleValue v) {
    setField(4, v);
  }
...
class CallConversion extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('CallConversion',
      package: const $pb.PackageName('google.ads.googleads.v1.services'))
    ..a<$1.StringValue>(1, 'callerId', $pb.PbFieldType.OM,
        $1.StringValue.getDefault, $1.StringValue.create)
    ..a<$1.StringValue>(2, 'callStartDateTime', $pb.PbFieldType.OM,
        $1.StringValue.getDefault, $1.StringValue.create)
    ..a<$1.StringValue>(3, 'conversionAction', $pb.PbFieldType.OM,
        $1.StringValue.getDefault, $1.StringValue.create)
    ..a<$1.StringValue>(4, 'conversionDateTime', $pb.PbFieldType.OM,
        $1.StringValue.getDefault, $1.StringValue.create)
    ..a<$1.DoubleValue>(5, 'conversionValue', $pb.PbFieldType.OM,
        $1.DoubleValue.getDefault, $1.DoubleValue.create)
    ..a<$1.StringValue>(6, 'currencyCode', $pb.PbFieldType.OM,
        $1.StringValue.getDefault, $1.StringValue.create)
    ..hasRequiredFields = false;

  CallConversion() : super();
  CallConversion.fromBuffer($core.List<$core.int> i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);
  CallConversion.fromJson($core.String i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromJson(i, r);
  ...
  set callStartDateTime($1.StringValue v) {
    setField(2, v);
  }
...
class ExternalAttributionData extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ExternalAttributionData',
      package: const $pb.PackageName('google.ads.googleads.v1.services'))
    ..a<$1.DoubleValue>(1, 'externalAttributionCredit', $pb.PbFieldType.OM,
        $1.DoubleValue.getDefault, $1.DoubleValue.create)
    ..a<$1.StringValue>(2, 'externalAttributionModel', $pb.PbFieldType.OM,
        $1.StringValue.getDefault, $1.StringValue.create)
    ..hasRequiredFields = false;

  ExternalAttributionData() : super();
  ExternalAttributionData.fromBuffer($core.List<$core.int> i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);
  ExternalAttributionData.fromJson($core.String i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromJson(i, r);
  ...
  set externalAttributionCredit($1.DoubleValue v) {
    setField(1, v);
  }
  ...
  set externalAttributionModel($1.StringValue v) {
    setField(2, v);
  }
...
class ClickConversionResult extends $pb.GeneratedMessage {
  ...
  ClickConversionResult.fromBuffer($core.List<$core.int> i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);
  ClickConversionResult.fromJson($core.String i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromJson(i, r);
...
class CallConversionResult extends $pb.GeneratedMessage {
  ...
  CallConversionResult.fromBuffer($core.List<$core.int> i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);
  CallConversionResult.fromJson($core.String i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromJson(i, r);
