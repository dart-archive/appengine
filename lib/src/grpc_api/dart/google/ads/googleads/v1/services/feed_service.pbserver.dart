...
abstract class FeedServiceBase extends $pb.GeneratedService {
  ...
  $async.Future<MutateFeedsResponse> mutateFeeds(
      $pb.ServerContext ctx, MutateFeedsRequest request);
  ...
  $async.Future<$pb.GeneratedMessage> handleCall($pb.ServerContext ctx,
    ...
    switch (method) {
      case 'GetFeed':
        return this.getFeed(ctx, request);
      case 'MutateFeeds':
        return this.mutateFeeds(ctx, request);
      default:
        throw $core.ArgumentError('Unknown method: $method');
    }
  }
  ...
  $core.Map<$core.String, $core.Map<$core.String, $core.dynamic>>
      get $messageJson => FeedServiceBase$messageJson;
}
