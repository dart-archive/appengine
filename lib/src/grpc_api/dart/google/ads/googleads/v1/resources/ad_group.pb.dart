...
class AdGroup extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('AdGroup',
    ...
    ..e<$4.AdGroupStatusEnum_AdGroupStatus>(
        5,
        'status',
        $pb.PbFieldType.OE,
        $4.AdGroupStatusEnum_AdGroupStatus.UNSPECIFIED,
        $4.AdGroupStatusEnum_AdGroupStatus.valueOf,
        $4.AdGroupStatusEnum_AdGroupStatus.values)
    ..pc<$1.CustomParameter>(
        6, 'urlCustomParameters', $pb.PbFieldType.PM, $1.CustomParameter.create)
    ..a<$0.StringValue>(10, 'campaign', $pb.PbFieldType.OM,
        $0.StringValue.getDefault, $0.StringValue.create)
    ..e<$5.AdGroupTypeEnum_AdGroupType>(
        12,
        'type',
        $pb.PbFieldType.OE,
        $5.AdGroupTypeEnum_AdGroupType.UNSPECIFIED,
        $5.AdGroupTypeEnum_AdGroupType.valueOf,
        $5.AdGroupTypeEnum_AdGroupType.values)
    ..a<$0.StringValue>(13, 'trackingUrlTemplate', $pb.PbFieldType.OM,
        $0.StringValue.getDefault, $0.StringValue.create)
    ..a<$0.Int64Value>(14, 'cpcBidMicros', $pb.PbFieldType.OM,
        $0.Int64Value.getDefault, $0.Int64Value.create)
    ..a<$0.Int64Value>(15, 'cpmBidMicros', $pb.PbFieldType.OM,
        $0.Int64Value.getDefault, $0.Int64Value.create)
    ..a<$0.Int64Value>(17, 'cpvBidMicros', $pb.PbFieldType.OM,
        $0.Int64Value.getDefault, $0.Int64Value.create)
  ...
  $0.Int64Value get percentCpcBidMicros => $_getN(11);
  set percentCpcBidMicros($0.Int64Value v) {
    setField(20, v);
  }

  $core.bool hasPercentCpcBidMicros() => $_has(11);
  ...
  $core.bool hasExplorerAutoOptimizerSetting() => $_has(12);
  ...
  $core.bool hasAdRotationMode() => $_has(13);
  ...
  $core.bool hasDisplayCustomBidDimension() => $_has(14);
  void clearDisplayCustomBidDimension() => clearField(23);

  $0.StringValue get finalUrlSuffix => $_getN(15);
  set finalUrlSuffix($0.StringValue v) {
    setField(24, v);
  }

  $core.bool hasFinalUrlSuffix() => $_has(15);
  void clearFinalUrlSuffix() => clearField(24);

  $3.TargetingSetting get targetingSetting => $_getN(16);
  set targetingSetting($3.TargetingSetting v) {
    setField(25, v);
  }

  $core.bool hasTargetingSetting() => $_has(16);
  void clearTargetingSetting() => clearField(25);

  $0.Int64Value get targetCpmMicros => $_getN(17);
  set targetCpmMicros($0.Int64Value v) {
    setField(26, v);
  }

  $core.bool hasTargetCpmMicros() => $_has(17);
  void clearTargetCpmMicros() => clearField(26);

  $0.Int64Value get targetCpaMicros => $_getN(18);
  set targetCpaMicros($0.Int64Value v) {
    setField(27, v);
  }

  $core.bool hasTargetCpaMicros() => $_has(18);
  void clearTargetCpaMicros() => clearField(27);

  $0.Int64Value get effectiveTargetCpaMicros => $_getN(19);
  set effectiveTargetCpaMicros($0.Int64Value v) {
    setField(28, v);
  }

  $core.bool hasEffectiveTargetCpaMicros() => $_has(19);
  void clearEffectiveTargetCpaMicros() => clearField(28);

  $8.BiddingSourceEnum_BiddingSource get effectiveTargetCpaSource => $_getN(20);
  set effectiveTargetCpaSource($8.BiddingSourceEnum_BiddingSource v) {
    setField(29, v);
  }

  $core.bool hasEffectiveTargetCpaSource() => $_has(20);
  void clearEffectiveTargetCpaSource() => clearField(29);

  $0.DoubleValue get targetRoas => $_getN(21);
  set targetRoas($0.DoubleValue v) {
    setField(30, v);
  }

  $core.bool hasTargetRoas() => $_has(21);
  void clearTargetRoas() => clearField(30);

  $0.DoubleValue get effectiveTargetRoas => $_getN(22);
  set effectiveTargetRoas($0.DoubleValue v) {
    setField(31, v);
  }

  $core.bool hasEffectiveTargetRoas() => $_has(22);
  ...
  $core.bool hasEffectiveTargetRoasSource() => $_has(23);
