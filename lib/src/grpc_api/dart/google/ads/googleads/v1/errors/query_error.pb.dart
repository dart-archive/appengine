...
class QueryErrorEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('QueryErrorEnum', package: const $pb.PackageName('google.ads.googleads.v1.errors'))
    ..hasRequiredFields = false
  ;

  QueryErrorEnum() : super();
  QueryErrorEnum.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  QueryErrorEnum.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  QueryErrorEnum clone() => QueryErrorEnum()..mergeFromMessage(this);
  QueryErrorEnum copyWith(void Function(QueryErrorEnum) updates) => super.copyWith((message) => updates(message as QueryErrorEnum));
