...
class NullErrorEnum_NullError extends $pb.ProtobufEnum {
  static const NullErrorEnum_NullError UNSPECIFIED = NullErrorEnum_NullError._(0, 'UNSPECIFIED');
  static const NullErrorEnum_NullError UNKNOWN = NullErrorEnum_NullError._(1, 'UNKNOWN');
  static const NullErrorEnum_NullError NULL_CONTENT = NullErrorEnum_NullError._(2, 'NULL_CONTENT');
