...
class GetAdGroupFeedRequest extends $pb.GeneratedMessage {
  ...
  GetAdGroupFeedRequest.fromBuffer($core.List<$core.int> i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);
  GetAdGroupFeedRequest.fromJson($core.String i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromJson(i, r);
...
class MutateAdGroupFeedsRequest extends $pb.GeneratedMessage {
  ...
  MutateAdGroupFeedsRequest.fromBuffer($core.List<$core.int> i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);
  MutateAdGroupFeedsRequest.fromJson($core.String i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromJson(i, r);
...
class AdGroupFeedOperation extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('AdGroupFeedOperation',
      package: const $pb.PackageName('google.ads.googleads.v1.services'))
    ..a<$0.AdGroupFeed>(1, 'create_1', $pb.PbFieldType.OM,
        $0.AdGroupFeed.getDefault, $0.AdGroupFeed.create)
    ..a<$0.AdGroupFeed>(2, 'update', $pb.PbFieldType.OM,
        $0.AdGroupFeed.getDefault, $0.AdGroupFeed.create)
    ..aOS(3, 'remove')
  ...
  AdGroupFeedOperation.fromBuffer($core.List<$core.int> i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);
  AdGroupFeedOperation.fromJson($core.String i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromJson(i, r);
...
class MutateAdGroupFeedsResponse extends $pb.GeneratedMessage {
  ...
  MutateAdGroupFeedsResponse.fromBuffer($core.List<$core.int> i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);
  MutateAdGroupFeedsResponse.fromJson($core.String i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromJson(i, r);
...
class MutateAdGroupFeedResult extends $pb.GeneratedMessage {
  ...
  MutateAdGroupFeedResult.fromBuffer($core.List<$core.int> i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);
  MutateAdGroupFeedResult.fromJson($core.String i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromJson(i, r);
...
class AdGroupFeedServiceApi {
  ...
  $async.Future<$0.AdGroupFeed> getAdGroupFeed(
      $pb.ClientContext ctx, GetAdGroupFeedRequest request) {
    var emptyResponse = $0.AdGroupFeed();
    return _client.invoke<$0.AdGroupFeed>(
        ctx, 'AdGroupFeedService', 'GetAdGroupFeed', request, emptyResponse);
  }

  $async.Future<MutateAdGroupFeedsResponse> mutateAdGroupFeeds(
      $pb.ClientContext ctx, MutateAdGroupFeedsRequest request) {
    var emptyResponse = MutateAdGroupFeedsResponse();
    return _client.invoke<MutateAdGroupFeedsResponse>(ctx, 'AdGroupFeedService',
        'MutateAdGroupFeeds', request, emptyResponse);
  }
}
