...
class FeedLinkStatusEnum_FeedLinkStatus extends $pb.ProtobufEnum {
  static const FeedLinkStatusEnum_FeedLinkStatus UNSPECIFIED = FeedLinkStatusEnum_FeedLinkStatus._(0, 'UNSPECIFIED');
  static const FeedLinkStatusEnum_FeedLinkStatus UNKNOWN = FeedLinkStatusEnum_FeedLinkStatus._(1, 'UNKNOWN');
  static const FeedLinkStatusEnum_FeedLinkStatus ENABLED = FeedLinkStatusEnum_FeedLinkStatus._(2, 'ENABLED');
  static const FeedLinkStatusEnum_FeedLinkStatus REMOVED = FeedLinkStatusEnum_FeedLinkStatus._(3, 'REMOVED');
