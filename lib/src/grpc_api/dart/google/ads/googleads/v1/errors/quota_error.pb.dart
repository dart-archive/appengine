...
class QuotaErrorEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('QuotaErrorEnum', package: const $pb.PackageName('google.ads.googleads.v1.errors'))
    ..hasRequiredFields = false
  ;

  QuotaErrorEnum() : super();
  QuotaErrorEnum.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  QuotaErrorEnum.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  QuotaErrorEnum clone() => QuotaErrorEnum()..mergeFromMessage(this);
  QuotaErrorEnum copyWith(void Function(QuotaErrorEnum) updates) => super.copyWith((message) => updates(message as QuotaErrorEnum));
