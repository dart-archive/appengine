...
class NegativeGeoTargetTypeEnum extends $pb.GeneratedMessage {
  ...
  NegativeGeoTargetTypeEnum() : super();
  NegativeGeoTargetTypeEnum.fromBuffer($core.List<$core.int> i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);
  NegativeGeoTargetTypeEnum.fromJson($core.String i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromJson(i, r);
  ...
  static NegativeGeoTargetTypeEnum create() => NegativeGeoTargetTypeEnum();
