...
class ProductChannelExclusivityEnum extends $pb.GeneratedMessage {
  ...
  ProductChannelExclusivityEnum() : super();
  ProductChannelExclusivityEnum.fromBuffer($core.List<$core.int> i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);
  ProductChannelExclusivityEnum.fromJson($core.String i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromJson(i, r);
  ...
  static ProductChannelExclusivityEnum getDefault() =>
