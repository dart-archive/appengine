...
class Asset extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Asset', package: const $pb.PackageName('google.ads.googleads.v1.resources'))
    ..aOS(1, 'resourceName')
    ...
    ..e<$2.AssetTypeEnum_AssetType>(4, 'type', $pb.PbFieldType.OE, $2.AssetTypeEnum_AssetType.UNSPECIFIED, $2.AssetTypeEnum_AssetType.valueOf, $2.AssetTypeEnum_AssetType.values)
    ..a<$1.YoutubeVideoAsset>(5, 'youtubeVideoAsset', $pb.PbFieldType.OM, $1.YoutubeVideoAsset.getDefault, $1.YoutubeVideoAsset.create)
    ..a<$1.MediaBundleAsset>(6, 'mediaBundleAsset', $pb.PbFieldType.OM, $1.MediaBundleAsset.getDefault, $1.MediaBundleAsset.create)
    ..a<$1.ImageAsset>(7, 'imageAsset', $pb.PbFieldType.OM, $1.ImageAsset.getDefault, $1.ImageAsset.create)
    ..a<$1.TextAsset>(8, 'textAsset', $pb.PbFieldType.OM, $1.TextAsset.getDefault, $1.TextAsset.create)
    ..oo(0, [5, 6, 7, 8])
  ...
  set type($2.AssetTypeEnum_AssetType v) { setField(4, v); }
  $core.bool hasType() => $_has(3);
  void clearType() => clearField(4);

  $1.YoutubeVideoAsset get youtubeVideoAsset => $_getN(4);
  set youtubeVideoAsset($1.YoutubeVideoAsset v) { setField(5, v); }
