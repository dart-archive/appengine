...
class IdErrorEnum_IdError extends $pb.ProtobufEnum {
  static const IdErrorEnum_IdError UNSPECIFIED = IdErrorEnum_IdError._(0, 'UNSPECIFIED');
  static const IdErrorEnum_IdError UNKNOWN = IdErrorEnum_IdError._(1, 'UNKNOWN');
  static const IdErrorEnum_IdError NOT_FOUND = IdErrorEnum_IdError._(2, 'NOT_FOUND');
