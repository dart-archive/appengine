...
class ExtensionFeedItem extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ExtensionFeedItem', package: const $pb.PackageName('google.ads.googleads.v1.resources'))
    ..aOS(1, 'resourceName')
    ..a<$0.SitelinkFeedItem>(2, 'sitelinkFeedItem', $pb.PbFieldType.OM, $0.SitelinkFeedItem.getDefault, $0.SitelinkFeedItem.create)
    ..a<$0.StructuredSnippetFeedItem>(3, 'structuredSnippetFeedItem', $pb.PbFieldType.OM, $0.StructuredSnippetFeedItem.getDefault, $0.StructuredSnippetFeedItem.create)
    ..e<$3.FeedItemStatusEnum_FeedItemStatus>(4, 'status', $pb.PbFieldType.OE, $3.FeedItemStatusEnum_FeedItemStatus.UNSPECIFIED, $3.FeedItemStatusEnum_FeedItemStatus.valueOf, $3.FeedItemStatusEnum_FeedItemStatus.values)
    ..a<$1.StringValue>(5, 'startDateTime', $pb.PbFieldType.OM, $1.StringValue.getDefault, $1.StringValue.create)
    ..a<$1.StringValue>(6, 'endDateTime', $pb.PbFieldType.OM, $1.StringValue.getDefault, $1.StringValue.create)
    ..a<$0.AppFeedItem>(7, 'appFeedItem', $pb.PbFieldType.OM, $0.AppFeedItem.getDefault, $0.AppFeedItem.create)
    ..a<$0.CallFeedItem>(8, 'callFeedItem', $pb.PbFieldType.OM, $0.CallFeedItem.getDefault, $0.CallFeedItem.create)
    ..a<$0.CalloutFeedItem>(9, 'calloutFeedItem', $pb.PbFieldType.OM, $0.CalloutFeedItem.getDefault, $0.CalloutFeedItem.create)
    ..a<$0.TextMessageFeedItem>(10, 'textMessageFeedItem', $pb.PbFieldType.OM, $0.TextMessageFeedItem.getDefault, $0.TextMessageFeedItem.create)
    ..a<$0.PriceFeedItem>(11, 'priceFeedItem', $pb.PbFieldType.OM, $0.PriceFeedItem.getDefault, $0.PriceFeedItem.create)
  ...
  ExtensionFeedItem.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  ExtensionFeedItem.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ExtensionFeedItem clone() => ExtensionFeedItem()..mergeFromMessage(this);
  ExtensionFeedItem copyWith(void Function(ExtensionFeedItem) updates) => super.copyWith((message) => updates(message as ExtensionFeedItem));
  ...
  static ExtensionFeedItem getDefault() => _defaultInstance ??= create()..freeze();
  ...
  set extensionType($4.ExtensionTypeEnum_ExtensionType v) { setField(13, v); }
  ...
  set targetedGeoTargetConstant($1.StringValue v) { setField(20, v); }
