...
abstract class AdGroupCriterionServiceBase extends $pb.GeneratedService {
  $async.Future<$0.AdGroupCriterion> getAdGroupCriterion(
      $pb.ServerContext ctx, GetAdGroupCriterionRequest request);
  $async.Future<MutateAdGroupCriteriaResponse> mutateAdGroupCriteria(
      $pb.ServerContext ctx, MutateAdGroupCriteriaRequest request);

  $pb.GeneratedMessage createRequest($core.String method) {
    switch (method) {
      case 'GetAdGroupCriterion':
        return GetAdGroupCriterionRequest();
      case 'MutateAdGroupCriteria':
        return MutateAdGroupCriteriaRequest();
      default:
  ...
  $async.Future<$pb.GeneratedMessage> handleCall($pb.ServerContext ctx,
    ...
    switch (method) {
      case 'GetAdGroupCriterion':
        return this.getAdGroupCriterion(ctx, request);
      case 'MutateAdGroupCriteria':
        return this.mutateAdGroupCriteria(ctx, request);
      default:
        throw $core.ArgumentError('Unknown method: $method');
    }
  }
  ...
  $core.Map<$core.String, $core.dynamic> get $json =>
      AdGroupCriterionServiceBase$json;
  $core.Map<$core.String, $core.Map<$core.String, $core.dynamic>>
      get $messageJson => AdGroupCriterionServiceBase$messageJson;
}
