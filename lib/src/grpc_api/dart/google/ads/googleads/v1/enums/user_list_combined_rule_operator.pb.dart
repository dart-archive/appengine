...
class UserListCombinedRuleOperatorEnum extends $pb.GeneratedMessage {
  ...
  UserListCombinedRuleOperatorEnum() : super();
  UserListCombinedRuleOperatorEnum.fromBuffer($core.List<$core.int> i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);
  UserListCombinedRuleOperatorEnum.fromJson($core.String i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromJson(i, r);
  ...
  static UserListCombinedRuleOperatorEnum getDefault() =>
