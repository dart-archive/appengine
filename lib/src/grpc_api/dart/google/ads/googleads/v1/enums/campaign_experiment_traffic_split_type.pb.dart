...
class CampaignExperimentTrafficSplitTypeEnum extends $pb.GeneratedMessage {
  ...
  CampaignExperimentTrafficSplitTypeEnum() : super();
  CampaignExperimentTrafficSplitTypeEnum.fromBuffer($core.List<$core.int> i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);
  CampaignExperimentTrafficSplitTypeEnum.fromJson($core.String i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromJson(i, r);
