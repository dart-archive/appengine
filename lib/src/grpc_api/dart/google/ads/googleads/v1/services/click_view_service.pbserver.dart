...
abstract class ClickViewServiceBase extends $pb.GeneratedService {
  $async.Future<$0.ClickView> getClickView($pb.ServerContext ctx, GetClickViewRequest request);

  $pb.GeneratedMessage createRequest($core.String method) {
    switch (method) {
      case 'GetClickView': return GetClickViewRequest();
  ...
  $async.Future<$pb.GeneratedMessage> handleCall($pb.ServerContext ctx, $core.String method, $pb.GeneratedMessage request) {
    switch (method) {
      case 'GetClickView': return this.getClickView(ctx, request);
      default: throw $core.ArgumentError('Unknown method: $method');
    }
  }

  $core.Map<$core.String, $core.dynamic> get $json => ClickViewServiceBase$json;
  $core.Map<$core.String, $core.Map<$core.String, $core.dynamic>> get $messageJson => ClickViewServiceBase$messageJson;
}
