  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Campaign.VanityPharma',
    ...
    ..e<$15.VanityPharmaDisplayUrlModeEnum_VanityPharmaDisplayUrlMode>(
        ...
        $15.VanityPharmaDisplayUrlModeEnum_VanityPharmaDisplayUrlMode
            .UNSPECIFIED,
        $15.VanityPharmaDisplayUrlModeEnum_VanityPharmaDisplayUrlMode.valueOf,
        $15.VanityPharmaDisplayUrlModeEnum_VanityPharmaDisplayUrlMode.values)
    ..e<$16.VanityPharmaTextEnum_VanityPharmaText>(
        2,
        'vanityPharmaText',
        $pb.PbFieldType.OE,
        $16.VanityPharmaTextEnum_VanityPharmaText.UNSPECIFIED,
        $16.VanityPharmaTextEnum_VanityPharmaText.valueOf,
...
class Campaign_GeoTargetTypeSetting extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName('google.ads.googleads.v1.resources'))
    ..e<$19.PositiveGeoTargetTypeEnum_PositiveGeoTargetType>(
        1,
        'positiveGeoTargetType',
        $pb.PbFieldType.OE,
        $19.PositiveGeoTargetTypeEnum_PositiveGeoTargetType.UNSPECIFIED,
        $19.PositiveGeoTargetTypeEnum_PositiveGeoTargetType.valueOf,
        $19.PositiveGeoTargetTypeEnum_PositiveGeoTargetType.values)
    ..e<$20.NegativeGeoTargetTypeEnum_NegativeGeoTargetType>(
        2,
        'negativeGeoTargetType',
        $pb.PbFieldType.OE,
        $20.NegativeGeoTargetTypeEnum_NegativeGeoTargetType.UNSPECIFIED,
        $20.NegativeGeoTargetTypeEnum_NegativeGeoTargetType.valueOf,
  ...
  $19.PositiveGeoTargetTypeEnum_PositiveGeoTargetType
      get positiveGeoTargetType => $_getN(0);
  set positiveGeoTargetType(
      $19.PositiveGeoTargetTypeEnum_PositiveGeoTargetType v) {
    setField(1, v);
  }
  ...
  $20.NegativeGeoTargetTypeEnum_NegativeGeoTargetType
      get negativeGeoTargetType => $_getN(1);
  set negativeGeoTargetType(
      $20.NegativeGeoTargetTypeEnum_NegativeGeoTargetType v) {
    setField(2, v);
  }
