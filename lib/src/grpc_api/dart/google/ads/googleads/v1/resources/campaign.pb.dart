...
import '../enums/positive_geo_target_type.pbenum.dart' as $19;
import '../enums/negative_geo_target_type.pbenum.dart' as $20;

class Campaign_NetworkSettings extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Campaign.NetworkSettings', package: const $pb.PackageName('google.ads.googleads.v1.resources'))
    ..a<$0.BoolValue>(1, 'targetGoogleSearch', $pb.PbFieldType.OM, $0.BoolValue.getDefault, $0.BoolValue.create)
    ..a<$0.BoolValue>(2, 'targetSearchNetwork', $pb.PbFieldType.OM, $0.BoolValue.getDefault, $0.BoolValue.create)
    ..a<$0.BoolValue>(3, 'targetContentNetwork', $pb.PbFieldType.OM, $0.BoolValue.getDefault, $0.BoolValue.create)
    ..a<$0.BoolValue>(4, 'targetPartnerSearchNetwork', $pb.PbFieldType.OM, $0.BoolValue.getDefault, $0.BoolValue.create)
    ..hasRequiredFields = false
  ;

  Campaign_NetworkSettings() : super();
  Campaign_NetworkSettings.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  Campaign_NetworkSettings.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  Campaign_NetworkSettings clone() => Campaign_NetworkSettings()..mergeFromMessage(this);
  Campaign_NetworkSettings copyWith(void Function(Campaign_NetworkSettings) updates) => super.copyWith((message) => updates(message as Campaign_NetworkSettings));
  ...
  static Campaign_NetworkSettings getDefault() => _defaultInstance ??= create()..freeze();
  static Campaign_NetworkSettings _defaultInstance;

  $0.BoolValue get targetGoogleSearch => $_getN(0);
  set targetGoogleSearch($0.BoolValue v) { setField(1, v); }
  ...
  set targetSearchNetwork($0.BoolValue v) { setField(2, v); }
  ...
  set targetContentNetwork($0.BoolValue v) { setField(3, v); }
  ...
  set targetPartnerSearchNetwork($0.BoolValue v) { setField(4, v); }
...
class Campaign_HotelSettingInfo extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Campaign.HotelSettingInfo', package: const $pb.PackageName('google.ads.googleads.v1.resources'))
    ..a<$0.Int64Value>(1, 'hotelCenterId', $pb.PbFieldType.OM, $0.Int64Value.getDefault, $0.Int64Value.create)
    ..hasRequiredFields = false
  ;

  Campaign_HotelSettingInfo() : super();
  Campaign_HotelSettingInfo.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  Campaign_HotelSettingInfo.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  Campaign_HotelSettingInfo clone() => Campaign_HotelSettingInfo()..mergeFromMessage(this);
  Campaign_HotelSettingInfo copyWith(void Function(Campaign_HotelSettingInfo) updates) => super.copyWith((message) => updates(message as Campaign_HotelSettingInfo));
  $pb.BuilderInfo get info_ => _i;
  ...
  static Campaign_HotelSettingInfo getDefault() => _defaultInstance ??= create()..freeze();
  static Campaign_HotelSettingInfo _defaultInstance;

  $0.Int64Value get hotelCenterId => $_getN(0);
  set hotelCenterId($0.Int64Value v) { setField(1, v); }
...
class Campaign_VanityPharma extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Campaign.VanityPharma', package: const $pb.PackageName('google.ads.googleads.v1.resources'))
    ..e<$15.VanityPharmaDisplayUrlModeEnum_VanityPharmaDisplayUrlMode>(1, 'vanityPharmaDisplayUrlMode', $pb.PbFieldType.OE, $15.VanityPharmaDisplayUrlModeEnum_VanityPharmaDisplayUrlMode.UNSPECIFIED, $15.VanityPharmaDisplayUrlModeEnum_VanityPharmaDisplayUrlMode.valueOf, $15.VanityPharmaDisplayUrlModeEnum_VanityPharmaDisplayUrlMode.values)
    ..e<$16.VanityPharmaTextEnum_VanityPharmaText>(2, 'vanityPharmaText', $pb.PbFieldType.OE, $16.VanityPharmaTextEnum_VanityPharmaText.UNSPECIFIED, $16.VanityPharmaTextEnum_VanityPharmaText.valueOf, $16.VanityPharmaTextEnum_VanityPharmaText.values)
    ..hasRequiredFields = false
  ;

  Campaign_VanityPharma() : super();
  Campaign_VanityPharma.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  Campaign_VanityPharma.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  Campaign_VanityPharma clone() => Campaign_VanityPharma()..mergeFromMessage(this);
  Campaign_VanityPharma copyWith(void Function(Campaign_VanityPharma) updates) => super.copyWith((message) => updates(message as Campaign_VanityPharma));
  $pb.BuilderInfo get info_ => _i;
  ...
  static Campaign_VanityPharma getDefault() => _defaultInstance ??= create()..freeze();
  static Campaign_VanityPharma _defaultInstance;

  $15.VanityPharmaDisplayUrlModeEnum_VanityPharmaDisplayUrlMode get vanityPharmaDisplayUrlMode => $_getN(0);
  set vanityPharmaDisplayUrlMode($15.VanityPharmaDisplayUrlModeEnum_VanityPharmaDisplayUrlMode v) { setField(1, v); }
  ...
  set vanityPharmaText($16.VanityPharmaTextEnum_VanityPharmaText v) { setField(2, v); }
...
class Campaign_DynamicSearchAdsSetting extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Campaign.DynamicSearchAdsSetting', package: const $pb.PackageName('google.ads.googleads.v1.resources'))
    ..a<$0.StringValue>(1, 'domainName', $pb.PbFieldType.OM, $0.StringValue.getDefault, $0.StringValue.create)
    ..a<$0.StringValue>(2, 'languageCode', $pb.PbFieldType.OM, $0.StringValue.getDefault, $0.StringValue.create)
    ..a<$0.BoolValue>(3, 'useSuppliedUrlsOnly', $pb.PbFieldType.OM, $0.BoolValue.getDefault, $0.BoolValue.create)
    ..pc<$0.StringValue>(5, 'feeds', $pb.PbFieldType.PM,$0.StringValue.create)
    ..hasRequiredFields = false
  ;

  Campaign_DynamicSearchAdsSetting() : super();
  Campaign_DynamicSearchAdsSetting.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  Campaign_DynamicSearchAdsSetting.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  Campaign_DynamicSearchAdsSetting clone() => Campaign_DynamicSearchAdsSetting()..mergeFromMessage(this);
  Campaign_DynamicSearchAdsSetting copyWith(void Function(Campaign_DynamicSearchAdsSetting) updates) => super.copyWith((message) => updates(message as Campaign_DynamicSearchAdsSetting));
  $pb.BuilderInfo get info_ => _i;
  static Campaign_DynamicSearchAdsSetting create() => Campaign_DynamicSearchAdsSetting();
...
class Campaign_ShoppingSetting extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Campaign.ShoppingSetting', package: const $pb.PackageName('google.ads.googleads.v1.resources'))
    ..a<$0.Int64Value>(1, 'merchantId', $pb.PbFieldType.OM, $0.Int64Value.getDefault, $0.Int64Value.create)
    ..a<$0.StringValue>(2, 'salesCountry', $pb.PbFieldType.OM, $0.StringValue.getDefault, $0.StringValue.create)
    ..a<$0.Int32Value>(3, 'campaignPriority', $pb.PbFieldType.OM, $0.Int32Value.getDefault, $0.Int32Value.create)
    ..a<$0.BoolValue>(4, 'enableLocal', $pb.PbFieldType.OM, $0.BoolValue.getDefault, $0.BoolValue.create)
    ..hasRequiredFields = false
  ;

  Campaign_ShoppingSetting() : super();
  Campaign_ShoppingSetting.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  Campaign_ShoppingSetting.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  Campaign_ShoppingSetting clone() => Campaign_ShoppingSetting()..mergeFromMessage(this);
  Campaign_ShoppingSetting copyWith(void Function(Campaign_ShoppingSetting) updates) => super.copyWith((message) => updates(message as Campaign_ShoppingSetting));
  $pb.BuilderInfo get info_ => _i;
...
class Campaign_TrackingSetting extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Campaign.TrackingSetting', package: const $pb.PackageName('google.ads.googleads.v1.resources'))
    ..a<$0.StringValue>(1, 'trackingUrl', $pb.PbFieldType.OM, $0.StringValue.getDefault, $0.StringValue.create)
    ..hasRequiredFields = false
  ;

  Campaign_TrackingSetting() : super();
  Campaign_TrackingSetting.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  Campaign_TrackingSetting.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  Campaign_TrackingSetting clone() => Campaign_TrackingSetting()..mergeFromMessage(this);
  Campaign_TrackingSetting copyWith(void Function(Campaign_TrackingSetting) updates) => super.copyWith((message) => updates(message as Campaign_TrackingSetting));
  $pb.BuilderInfo get info_ => _i;
  ...
  static Campaign_TrackingSetting getDefault() => _defaultInstance ??= create()..freeze();
  static Campaign_TrackingSetting _defaultInstance;

  $0.StringValue get trackingUrl => $_getN(0);
  set trackingUrl($0.StringValue v) { setField(1, v); }
...
class Campaign_SelectiveOptimization extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Campaign.SelectiveOptimization', package: const $pb.PackageName('google.ads.googleads.v1.resources'))
    ..pc<$0.StringValue>(1, 'conversionActions', $pb.PbFieldType.PM,$0.StringValue.create)
    ..hasRequiredFields = false
  ;

  Campaign_SelectiveOptimization() : super();
  Campaign_SelectiveOptimization.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  Campaign_SelectiveOptimization.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  Campaign_SelectiveOptimization clone() => Campaign_SelectiveOptimization()..mergeFromMessage(this);
  Campaign_SelectiveOptimization copyWith(void Function(Campaign_SelectiveOptimization) updates) => super.copyWith((message) => updates(message as Campaign_SelectiveOptimization));
  $pb.BuilderInfo get info_ => _i;
  static Campaign_SelectiveOptimization create() => Campaign_SelectiveOptimization();
  ...
  static Campaign_SelectiveOptimization getDefault() => _defaultInstance ??= create()..freeze();
...
class Campaign_AppCampaignSetting extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Campaign.AppCampaignSetting', package: const $pb.PackageName('google.ads.googleads.v1.resources'))
    ..e<$17.AppCampaignBiddingStrategyGoalTypeEnum_AppCampaignBiddingStrategyGoalType>(1, 'biddingStrategyGoalType', $pb.PbFieldType.OE, $17.AppCampaignBiddingStrategyGoalTypeEnum_AppCampaignBiddingStrategyGoalType.UNSPECIFIED, $17.AppCampaignBiddingStrategyGoalTypeEnum_AppCampaignBiddingStrategyGoalType.valueOf, $17.AppCampaignBiddingStrategyGoalTypeEnum_AppCampaignBiddingStrategyGoalType.values)
    ..a<$0.StringValue>(2, 'appId', $pb.PbFieldType.OM, $0.StringValue.getDefault, $0.StringValue.create)
    ..e<$18.AppCampaignAppStoreEnum_AppCampaignAppStore>(3, 'appStore', $pb.PbFieldType.OE, $18.AppCampaignAppStoreEnum_AppCampaignAppStore.UNSPECIFIED, $18.AppCampaignAppStoreEnum_AppCampaignAppStore.valueOf, $18.AppCampaignAppStoreEnum_AppCampaignAppStore.values)
    ..hasRequiredFields = false
  ;

  Campaign_AppCampaignSetting() : super();
  Campaign_AppCampaignSetting.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  Campaign_AppCampaignSetting.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  Campaign_AppCampaignSetting clone() => Campaign_AppCampaignSetting()..mergeFromMessage(this);
  Campaign_AppCampaignSetting copyWith(void Function(Campaign_AppCampaignSetting) updates) => super.copyWith((message) => updates(message as Campaign_AppCampaignSetting));
  $pb.BuilderInfo get info_ => _i;
  ...
  static Campaign_AppCampaignSetting getDefault() => _defaultInstance ??= create()..freeze();
  static Campaign_AppCampaignSetting _defaultInstance;

  $17.AppCampaignBiddingStrategyGoalTypeEnum_AppCampaignBiddingStrategyGoalType get biddingStrategyGoalType => $_getN(0);
  set biddingStrategyGoalType($17.AppCampaignBiddingStrategyGoalTypeEnum_AppCampaignBiddingStrategyGoalType v) { setField(1, v); }
  ...
  set appStore($18.AppCampaignAppStoreEnum_AppCampaignAppStore v) { setField(3, v); }
...
class Campaign_GeoTargetTypeSetting extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Campaign.GeoTargetTypeSetting', package: const $pb.PackageName('google.ads.googleads.v1.resources'))
    ..e<$19.PositiveGeoTargetTypeEnum_PositiveGeoTargetType>(1, 'positiveGeoTargetType', $pb.PbFieldType.OE, $19.PositiveGeoTargetTypeEnum_PositiveGeoTargetType.UNSPECIFIED, $19.PositiveGeoTargetTypeEnum_PositiveGeoTargetType.valueOf, $19.PositiveGeoTargetTypeEnum_PositiveGeoTargetType.values)
    ..e<$20.NegativeGeoTargetTypeEnum_NegativeGeoTargetType>(2, 'negativeGeoTargetType', $pb.PbFieldType.OE, $20.NegativeGeoTargetTypeEnum_NegativeGeoTargetType.UNSPECIFIED, $20.NegativeGeoTargetTypeEnum_NegativeGeoTargetType.valueOf, $20.NegativeGeoTargetTypeEnum_NegativeGeoTargetType.values)
    ..hasRequiredFields = false
  ;

  Campaign_GeoTargetTypeSetting() : super();
  Campaign_GeoTargetTypeSetting.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  Campaign_GeoTargetTypeSetting.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  Campaign_GeoTargetTypeSetting clone() => Campaign_GeoTargetTypeSetting()..mergeFromMessage(this);
  Campaign_GeoTargetTypeSetting copyWith(void Function(Campaign_GeoTargetTypeSetting) updates) => super.copyWith((message) => updates(message as Campaign_GeoTargetTypeSetting));
  $pb.BuilderInfo get info_ => _i;
  static Campaign_GeoTargetTypeSetting create() => Campaign_GeoTargetTypeSetting();
  ...
  static Campaign_GeoTargetTypeSetting getDefault() => _defaultInstance ??= create()..freeze();
  static Campaign_GeoTargetTypeSetting _defaultInstance;

  $19.PositiveGeoTargetTypeEnum_PositiveGeoTargetType get positiveGeoTargetType => $_getN(0);
  set positiveGeoTargetType($19.PositiveGeoTargetTypeEnum_PositiveGeoTargetType v) { setField(1, v); }
  $core.bool hasPositiveGeoTargetType() => $_has(0);
  void clearPositiveGeoTargetType() => clearField(1);

  $20.NegativeGeoTargetTypeEnum_NegativeGeoTargetType get negativeGeoTargetType => $_getN(1);
  set negativeGeoTargetType($20.NegativeGeoTargetTypeEnum_NegativeGeoTargetType v) { setField(2, v); }
...
class Campaign extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Campaign', package: const $pb.PackageName('google.ads.googleads.v1.resources'))
    ..aOS(1, 'resourceName')
    ...
    ..e<$6.CampaignStatusEnum_CampaignStatus>(5, 'status', $pb.PbFieldType.OE, $6.CampaignStatusEnum_CampaignStatus.UNSPECIFIED, $6.CampaignStatusEnum_CampaignStatus.valueOf, $6.CampaignStatusEnum_CampaignStatus.values)
    ..a<$0.StringValue>(6, 'campaignBudget', $pb.PbFieldType.OM, $0.StringValue.getDefault, $0.StringValue.create)
    ..e<$7.AdServingOptimizationStatusEnum_AdServingOptimizationStatus>(8, 'adServingOptimizationStatus', $pb.PbFieldType.OE, $7.AdServingOptimizationStatusEnum_AdServingOptimizationStatus.UNSPECIFIED, $7.AdServingOptimizationStatusEnum_AdServingOptimizationStatus.valueOf, $7.AdServingOptimizationStatusEnum_AdServingOptimizationStatus.values)
    ..e<$8.AdvertisingChannelTypeEnum_AdvertisingChannelType>(9, 'advertisingChannelType', $pb.PbFieldType.OE, $8.AdvertisingChannelTypeEnum_AdvertisingChannelType.UNSPECIFIED, $8.AdvertisingChannelTypeEnum_AdvertisingChannelType.valueOf, $8.AdvertisingChannelTypeEnum_AdvertisingChannelType.values)
    ..e<$9.AdvertisingChannelSubTypeEnum_AdvertisingChannelSubType>(10, 'advertisingChannelSubType', $pb.PbFieldType.OE, $9.AdvertisingChannelSubTypeEnum_AdvertisingChannelSubType.UNSPECIFIED, $9.AdvertisingChannelSubTypeEnum_AdvertisingChannelSubType.valueOf, $9.AdvertisingChannelSubTypeEnum_AdvertisingChannelSubType.values)
    ..a<$0.StringValue>(11, 'trackingUrlTemplate', $pb.PbFieldType.OM, $0.StringValue.getDefault, $0.StringValue.create)
    ..pc<$1.CustomParameter>(12, 'urlCustomParameters', $pb.PbFieldType.PM,$1.CustomParameter.create)
  ...
  Campaign() : super();
  Campaign.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  Campaign.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ...
  set status($6.CampaignStatusEnum_CampaignStatus v) { setField(5, v); }
  $core.bool hasStatus() => $_has(3);
  void clearStatus() => clearField(5);

  $0.StringValue get campaignBudget => $_getN(4);
  set campaignBudget($0.StringValue v) { setField(6, v); }
  $core.bool hasCampaignBudget() => $_has(4);
  void clearCampaignBudget() => clearField(6);

  $7.AdServingOptimizationStatusEnum_AdServingOptimizationStatus get adServingOptimizationStatus => $_getN(5);
  set adServingOptimizationStatus($7.AdServingOptimizationStatusEnum_AdServingOptimizationStatus v) { setField(8, v); }
  $core.bool hasAdServingOptimizationStatus() => $_has(5);
  void clearAdServingOptimizationStatus() => clearField(8);

  $8.AdvertisingChannelTypeEnum_AdvertisingChannelType get advertisingChannelType => $_getN(6);
  set advertisingChannelType($8.AdvertisingChannelTypeEnum_AdvertisingChannelType v) { setField(9, v); }
  $core.bool hasAdvertisingChannelType() => $_has(6);
  void clearAdvertisingChannelType() => clearField(9);

  $9.AdvertisingChannelSubTypeEnum_AdvertisingChannelSubType get advertisingChannelSubType => $_getN(7);
  set advertisingChannelSubType($9.AdvertisingChannelSubTypeEnum_AdvertisingChannelSubType v) { setField(10, v); }
  ...
  set trackingUrlTemplate($0.StringValue v) { setField(11, v); }
  ...
  $10.CampaignExperimentTypeEnum_CampaignExperimentType get experimentType => $_getN(11);
  set experimentType($10.CampaignExperimentTypeEnum_CampaignExperimentType v) { setField(17, v); }
  $core.bool hasExperimentType() => $_has(11);
  void clearExperimentType() => clearField(17);

  $0.StringValue get startDate => $_getN(12);
  set startDate($0.StringValue v) { setField(19, v); }
  $core.bool hasStartDate() => $_has(12);
  void clearStartDate() => clearField(19);

  $0.StringValue get endDate => $_getN(13);
  set endDate($0.StringValue v) { setField(20, v); }
  $core.bool hasEndDate() => $_has(13);
  void clearEndDate() => clearField(20);

  $11.CampaignServingStatusEnum_CampaignServingStatus get servingStatus => $_getN(14);
  set servingStatus($11.CampaignServingStatusEnum_CampaignServingStatus v) { setField(21, v); }
  $core.bool hasServingStatus() => $_has(14);
  void clearServingStatus() => clearField(21);

  $12.BiddingStrategyTypeEnum_BiddingStrategyType get biddingStrategyType => $_getN(15);
  set biddingStrategyType($12.BiddingStrategyTypeEnum_BiddingStrategyType v) { setField(22, v); }
  ...
  set maximizeConversionValue($2.MaximizeConversionValue v) { setField(31, v); }
  ...
  set percentCpc($2.PercentCpc v) { setField(34, v); }
  ...
  set realTimeBiddingSetting($3.RealTimeBiddingSetting v) { setField(39, v); }
  ...
  set targetCpm($2.TargetCpm v) { setField(41, v); }
  $core.bool hasTargetCpm() => $_has(33);
  void clearTargetCpm() => clearField(41);

  $13.BrandSafetySuitabilityEnum_BrandSafetySuitability get videoBrandSafetySuitability => $_getN(34);
  set videoBrandSafetySuitability($13.BrandSafetySuitabilityEnum_BrandSafetySuitability v) { setField(42, v); }
  ...
  set targetingSetting($5.TargetingSetting v) { setField(43, v); }
  ...
  set targetImpressionShare($2.TargetImpressionShare v) { setField(48, v); }
  ...
  set commission($2.Commission v) { setField(49, v); }
  ...
  set paymentMode($14.PaymentModeEnum_PaymentMode v) { setField(52, v); }
