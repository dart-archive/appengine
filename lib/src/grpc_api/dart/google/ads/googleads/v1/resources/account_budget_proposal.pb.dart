...
class AccountBudgetProposal extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('AccountBudgetProposal', package: const $pb.PackageName('google.ads.googleads.v1.resources'))
    ..aOS(1, 'resourceName')
    ..a<$0.StringValue>(2, 'billingSetup', $pb.PbFieldType.OM, $0.StringValue.getDefault, $0.StringValue.create)
    ..a<$0.StringValue>(3, 'accountBudget', $pb.PbFieldType.OM, $0.StringValue.getDefault, $0.StringValue.create)
    ..e<$1.AccountBudgetProposalTypeEnum_AccountBudgetProposalType>(4, 'proposalType', $pb.PbFieldType.OE, $1.AccountBudgetProposalTypeEnum_AccountBudgetProposalType.UNSPECIFIED, $1.AccountBudgetProposalTypeEnum_AccountBudgetProposalType.valueOf, $1.AccountBudgetProposalTypeEnum_AccountBudgetProposalType.values)
    ..a<$0.StringValue>(5, 'proposedName', $pb.PbFieldType.OM, $0.StringValue.getDefault, $0.StringValue.create)
    ..e<$2.TimeTypeEnum_TimeType>(7, 'proposedStartTimeType', $pb.PbFieldType.OE, $2.TimeTypeEnum_TimeType.UNSPECIFIED, $2.TimeTypeEnum_TimeType.valueOf, $2.TimeTypeEnum_TimeType.values)
    ...
    ..a<$0.Int64Value>(10, 'proposedSpendingLimitMicros', $pb.PbFieldType.OM, $0.Int64Value.getDefault, $0.Int64Value.create)
    ..e<$3.SpendingLimitTypeEnum_SpendingLimitType>(11, 'proposedSpendingLimitType', $pb.PbFieldType.OE, $3.SpendingLimitTypeEnum_SpendingLimitType.UNSPECIFIED, $3.SpendingLimitTypeEnum_SpendingLimitType.valueOf, $3.SpendingLimitTypeEnum_SpendingLimitType.values)
    ..a<$0.StringValue>(12, 'proposedPurchaseOrderNumber', $pb.PbFieldType.OM, $0.StringValue.getDefault, $0.StringValue.create)
  ...
  AccountBudgetProposal.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  AccountBudgetProposal.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  AccountBudgetProposal clone() => AccountBudgetProposal()..mergeFromMessage(this);
  AccountBudgetProposal copyWith(void Function(AccountBudgetProposal) updates) => super.copyWith((message) => updates(message as AccountBudgetProposal));
  ...
  static AccountBudgetProposal getDefault() => _defaultInstance ??= create()..freeze();
  ...
  set billingSetup($0.StringValue v) { setField(2, v); }
  $core.bool hasBillingSetup() => $_has(1);
  void clearBillingSetup() => clearField(2);

  $0.StringValue get accountBudget => $_getN(2);
  set accountBudget($0.StringValue v) { setField(3, v); }
  $core.bool hasAccountBudget() => $_has(2);
  void clearAccountBudget() => clearField(3);

  $1.AccountBudgetProposalTypeEnum_AccountBudgetProposalType get proposalType => $_getN(3);
  set proposalType($1.AccountBudgetProposalTypeEnum_AccountBudgetProposalType v) { setField(4, v); }
  $core.bool hasProposalType() => $_has(3);
  void clearProposalType() => clearField(4);

  $0.StringValue get proposedName => $_getN(4);
  set proposedName($0.StringValue v) { setField(5, v); }
  ...
  set proposedStartTimeType($2.TimeTypeEnum_TimeType v) { setField(7, v); }
  ...
  set proposedSpendingLimitMicros($0.Int64Value v) { setField(10, v); }
  $core.bool hasProposedSpendingLimitMicros() => $_has(7);
  void clearProposedSpendingLimitMicros() => clearField(10);

  $3.SpendingLimitTypeEnum_SpendingLimitType get proposedSpendingLimitType => $_getN(8);
  set proposedSpendingLimitType($3.SpendingLimitTypeEnum_SpendingLimitType v) { setField(11, v); }
  ...
  set proposedPurchaseOrderNumber($0.StringValue v) { setField(12, v); }
  ...
  set proposedNotes($0.StringValue v) { setField(13, v); }
  $core.bool hasProposedNotes() => $_has(10);
  void clearProposedNotes() => clearField(13);

  $0.Int64Value get id => $_getN(11);
  set id($0.Int64Value v) { setField(14, v); }
  $core.bool hasId() => $_has(11);
  void clearId() => clearField(14);

  $4.AccountBudgetProposalStatusEnum_AccountBudgetProposalStatus get status => $_getN(12);
  set status($4.AccountBudgetProposalStatusEnum_AccountBudgetProposalStatus v) { setField(15, v); }
  $core.bool hasStatus() => $_has(12);
  void clearStatus() => clearField(15);

  $0.StringValue get creationDateTime => $_getN(13);
  set creationDateTime($0.StringValue v) { setField(16, v); }
  $core.bool hasCreationDateTime() => $_has(13);
  void clearCreationDateTime() => clearField(16);

  $0.StringValue get approvalDateTime => $_getN(14);
  set approvalDateTime($0.StringValue v) { setField(17, v); }
  ...
  set proposedStartDateTime($0.StringValue v) { setField(18, v); }
  ...
  set proposedEndDateTime($0.StringValue v) { setField(19, v); }
  ...
  set approvedStartDateTime($0.StringValue v) { setField(20, v); }
  ...
  set approvedEndDateTime($0.StringValue v) { setField(21, v); }
  ...
  set approvedEndTimeType($2.TimeTypeEnum_TimeType v) { setField(22, v); }
  ...
  set approvedSpendingLimitMicros($0.Int64Value v) { setField(23, v); }
  $core.bool hasApprovedSpendingLimitMicros() => $_has(20);
  void clearApprovedSpendingLimitMicros() => clearField(23);

  $3.SpendingLimitTypeEnum_SpendingLimitType get approvedSpendingLimitType => $_getN(21);
  set approvedSpendingLimitType($3.SpendingLimitTypeEnum_SpendingLimitType v) { setField(24, v); }
