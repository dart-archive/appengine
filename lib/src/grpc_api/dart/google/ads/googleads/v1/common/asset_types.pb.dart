...
class YoutubeVideoAsset extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('YoutubeVideoAsset',
    ...
    ..a<$0.StringValue>(1, 'youtubeVideoId', $pb.PbFieldType.OM,
  ...
  static YoutubeVideoAsset getDefault() =>
...
class MediaBundleAsset extends $pb.GeneratedMessage {
  ...
  static MediaBundleAsset getDefault() =>
      _defaultInstance ??= create()..freeze();
...
class ImageAsset extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ImageAsset',
    ...
    ..a<$0.BytesValue>(1, 'data', $pb.PbFieldType.OM, $0.BytesValue.getDefault,
        $0.BytesValue.create)
    ..a<$0.Int64Value>(2, 'fileSize', $pb.PbFieldType.OM,
        $0.Int64Value.getDefault, $0.Int64Value.create)
    ..e<$1.MimeTypeEnum_MimeType>(
        3,
        'mimeType',
        $pb.PbFieldType.OE,
        $1.MimeTypeEnum_MimeType.UNSPECIFIED,
        $1.MimeTypeEnum_MimeType.valueOf,
        $1.MimeTypeEnum_MimeType.values)
    ..a<ImageDimension>(4, 'fullSize', $pb.PbFieldType.OM,
...
class ImageDimension extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ImageDimension',
      package: const $pb.PackageName('google.ads.googleads.v1.common'))
    ..a<$0.Int64Value>(1, 'heightPixels', $pb.PbFieldType.OM,
        $0.Int64Value.getDefault, $0.Int64Value.create)
    ..a<$0.Int64Value>(2, 'widthPixels', $pb.PbFieldType.OM,
        $0.Int64Value.getDefault, $0.Int64Value.create)
    ..a<$0.StringValue>(3, 'url', $pb.PbFieldType.OM, $0.StringValue.getDefault,
