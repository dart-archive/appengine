...
abstract class CustomerFeedServiceBase extends $pb.GeneratedService {
  $async.Future<$0.CustomerFeed> getCustomerFeed(
      $pb.ServerContext ctx, GetCustomerFeedRequest request);
  $async.Future<MutateCustomerFeedsResponse> mutateCustomerFeeds(
      $pb.ServerContext ctx, MutateCustomerFeedsRequest request);

  $pb.GeneratedMessage createRequest($core.String method) {
    switch (method) {
      case 'GetCustomerFeed':
        return GetCustomerFeedRequest();
      case 'MutateCustomerFeeds':
        return MutateCustomerFeedsRequest();
      default:
  ...
  $async.Future<$pb.GeneratedMessage> handleCall($pb.ServerContext ctx,
    ...
    switch (method) {
      case 'GetCustomerFeed':
        return this.getCustomerFeed(ctx, request);
      case 'MutateCustomerFeeds':
        return this.mutateCustomerFeeds(ctx, request);
      default:
        throw $core.ArgumentError('Unknown method: $method');
    }
  }
  ...
  $core.Map<$core.String, $core.dynamic> get $json =>
      CustomerFeedServiceBase$json;
  $core.Map<$core.String, $core.Map<$core.String, $core.dynamic>>
      get $messageJson => CustomerFeedServiceBase$messageJson;
}
