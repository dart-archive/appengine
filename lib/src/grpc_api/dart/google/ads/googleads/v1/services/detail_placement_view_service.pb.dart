...
class GetDetailPlacementViewRequest extends $pb.GeneratedMessage {
  ...
  GetDetailPlacementViewRequest.fromBuffer($core.List<$core.int> i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);
  GetDetailPlacementViewRequest.fromJson($core.String i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromJson(i, r);
...
class DetailPlacementViewServiceApi {
  ...
  $async.Future<$0.DetailPlacementView> getDetailPlacementView(
      $pb.ClientContext ctx, GetDetailPlacementViewRequest request) {
    var emptyResponse = $0.DetailPlacementView();
    return _client.invoke<$0.DetailPlacementView>(
        ctx,
