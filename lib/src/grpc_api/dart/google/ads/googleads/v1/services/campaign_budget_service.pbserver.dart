...
abstract class CampaignBudgetServiceBase extends $pb.GeneratedService {
  $async.Future<$0.CampaignBudget> getCampaignBudget(
      $pb.ServerContext ctx, GetCampaignBudgetRequest request);
  $async.Future<MutateCampaignBudgetsResponse> mutateCampaignBudgets(
      $pb.ServerContext ctx, MutateCampaignBudgetsRequest request);

  $pb.GeneratedMessage createRequest($core.String method) {
    switch (method) {
      case 'GetCampaignBudget':
        return GetCampaignBudgetRequest();
      case 'MutateCampaignBudgets':
        return MutateCampaignBudgetsRequest();
      default:
  ...
  $async.Future<$pb.GeneratedMessage> handleCall($pb.ServerContext ctx,
    ...
    switch (method) {
      case 'GetCampaignBudget':
        return this.getCampaignBudget(ctx, request);
      case 'MutateCampaignBudgets':
        return this.mutateCampaignBudgets(ctx, request);
      default:
        throw $core.ArgumentError('Unknown method: $method');
    }
  }
  ...
  $core.Map<$core.String, $core.dynamic> get $json =>
      CampaignBudgetServiceBase$json;
  $core.Map<$core.String, $core.Map<$core.String, $core.dynamic>>
      get $messageJson => CampaignBudgetServiceBase$messageJson;
}
