...
abstract class UserInterestServiceBase extends $pb.GeneratedService {
  $async.Future<$0.UserInterest> getUserInterest(
      $pb.ServerContext ctx, GetUserInterestRequest request);

  $pb.GeneratedMessage createRequest($core.String method) {
    switch (method) {
      case 'GetUserInterest':
        return GetUserInterestRequest();
      default:
  ...
  $async.Future<$pb.GeneratedMessage> handleCall($pb.ServerContext ctx,
    ...
    switch (method) {
      case 'GetUserInterest':
        return this.getUserInterest(ctx, request);
      default:
        throw $core.ArgumentError('Unknown method: $method');
    }
  }
  ...
  $core.Map<$core.String, $core.dynamic> get $json =>
      UserInterestServiceBase$json;
  $core.Map<$core.String, $core.Map<$core.String, $core.dynamic>>
      get $messageJson => UserInterestServiceBase$messageJson;
}
