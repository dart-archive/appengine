...
class Label extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Label', package: const $pb.PackageName('google.ads.googleads.v1.resources'))
    ..aOS(1, 'resourceName')
    ...
    ..e<$2.LabelStatusEnum_LabelStatus>(4, 'status', $pb.PbFieldType.OE, $2.LabelStatusEnum_LabelStatus.UNSPECIFIED, $2.LabelStatusEnum_LabelStatus.valueOf, $2.LabelStatusEnum_LabelStatus.values)
    ..a<$1.TextLabel>(5, 'textLabel', $pb.PbFieldType.OM, $1.TextLabel.getDefault, $1.TextLabel.create)
    ..hasRequiredFields = false
  ;

  Label() : super();
  Label.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  Label.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ...
  set status($2.LabelStatusEnum_LabelStatus v) { setField(4, v); }
  $core.bool hasStatus() => $_has(3);
  void clearStatus() => clearField(4);

  $1.TextLabel get textLabel => $_getN(4);
  set textLabel($1.TextLabel v) { setField(5, v); }
