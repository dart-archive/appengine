...
class UserList extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('UserList', package: const $pb.PackageName('google.ads.googleads.v1.resources'))
    ..aOS(1, 'resourceName')
    ..a<$0.Int64Value>(2, 'id', $pb.PbFieldType.OM, $0.Int64Value.getDefault, $0.Int64Value.create)
    ..a<$0.BoolValue>(3, 'readOnly', $pb.PbFieldType.OM, $0.BoolValue.getDefault, $0.BoolValue.create)
    ..a<$0.StringValue>(4, 'name', $pb.PbFieldType.OM, $0.StringValue.getDefault, $0.StringValue.create)
    ..a<$0.StringValue>(5, 'description', $pb.PbFieldType.OM, $0.StringValue.getDefault, $0.StringValue.create)
    ..e<$2.UserListMembershipStatusEnum_UserListMembershipStatus>(6, 'membershipStatus', $pb.PbFieldType.OE, $2.UserListMembershipStatusEnum_UserListMembershipStatus.UNSPECIFIED, $2.UserListMembershipStatusEnum_UserListMembershipStatus.valueOf, $2.UserListMembershipStatusEnum_UserListMembershipStatus.values)
    ..a<$0.StringValue>(7, 'integrationCode', $pb.PbFieldType.OM, $0.StringValue.getDefault, $0.StringValue.create)
    ..a<$0.Int64Value>(8, 'membershipLifeSpan', $pb.PbFieldType.OM, $0.Int64Value.getDefault, $0.Int64Value.create)
    ..a<$0.Int64Value>(9, 'sizeForDisplay', $pb.PbFieldType.OM, $0.Int64Value.getDefault, $0.Int64Value.create)
    ..e<$3.UserListSizeRangeEnum_UserListSizeRange>(10, 'sizeRangeForDisplay', $pb.PbFieldType.OE, $3.UserListSizeRangeEnum_UserListSizeRange.UNSPECIFIED, $3.UserListSizeRangeEnum_UserListSizeRange.valueOf, $3.UserListSizeRangeEnum_UserListSizeRange.values)
    ..a<$0.Int64Value>(11, 'sizeForSearch', $pb.PbFieldType.OM, $0.Int64Value.getDefault, $0.Int64Value.create)
  ...
  UserList() : super();
  UserList.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  UserList.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ...
  set readOnly($0.BoolValue v) { setField(3, v); }
  ...
  set description($0.StringValue v) { setField(5, v); }
  $core.bool hasDescription() => $_has(4);
  void clearDescription() => clearField(5);

  $2.UserListMembershipStatusEnum_UserListMembershipStatus get membershipStatus => $_getN(5);
  set membershipStatus($2.UserListMembershipStatusEnum_UserListMembershipStatus v) { setField(6, v); }
  $core.bool hasMembershipStatus() => $_has(5);
  void clearMembershipStatus() => clearField(6);

  $0.StringValue get integrationCode => $_getN(6);
  set integrationCode($0.StringValue v) { setField(7, v); }
  $core.bool hasIntegrationCode() => $_has(6);
  void clearIntegrationCode() => clearField(7);

  $0.Int64Value get membershipLifeSpan => $_getN(7);
  set membershipLifeSpan($0.Int64Value v) { setField(8, v); }
  $core.bool hasMembershipLifeSpan() => $_has(7);
  void clearMembershipLifeSpan() => clearField(8);

  $0.Int64Value get sizeForDisplay => $_getN(8);
  set sizeForDisplay($0.Int64Value v) { setField(9, v); }
  $core.bool hasSizeForDisplay() => $_has(8);
  void clearSizeForDisplay() => clearField(9);

  $3.UserListSizeRangeEnum_UserListSizeRange get sizeRangeForDisplay => $_getN(9);
  set sizeRangeForDisplay($3.UserListSizeRangeEnum_UserListSizeRange v) { setField(10, v); }
  ...
  set sizeForSearch($0.Int64Value v) { setField(11, v); }
  $core.bool hasSizeForSearch() => $_has(10);
  void clearSizeForSearch() => clearField(11);

  $3.UserListSizeRangeEnum_UserListSizeRange get sizeRangeForSearch => $_getN(11);
  set sizeRangeForSearch($3.UserListSizeRangeEnum_UserListSizeRange v) { setField(12, v); }
  ...
  set type($4.UserListTypeEnum_UserListType v) { setField(13, v); }
  $core.bool hasType() => $_has(12);
  void clearType() => clearField(13);

  $5.UserListClosingReasonEnum_UserListClosingReason get closingReason => $_getN(13);
  set closingReason($5.UserListClosingReasonEnum_UserListClosingReason v) { setField(14, v); }
  ...
  set accessReason($6.AccessReasonEnum_AccessReason v) { setField(15, v); }
  $core.bool hasAccessReason() => $_has(14);
  void clearAccessReason() => clearField(15);

  $7.UserListAccessStatusEnum_UserListAccessStatus get accountUserListStatus => $_getN(15);
  set accountUserListStatus($7.UserListAccessStatusEnum_UserListAccessStatus v) { setField(16, v); }
  ...
  set eligibleForSearch($0.BoolValue v) { setField(17, v); }
  ...
  set eligibleForDisplay($0.BoolValue v) { setField(18, v); }
  ...
  set crmBasedUserList($1.CrmBasedUserListInfo v) { setField(19, v); }
  ...
  set similarUserList($1.SimilarUserListInfo v) { setField(20, v); }
  ...
  set ruleBasedUserList($1.RuleBasedUserListInfo v) { setField(21, v); }
  ...
  set logicalUserList($1.LogicalUserListInfo v) { setField(22, v); }
  ...
  set basicUserList($1.BasicUserListInfo v) { setField(23, v); }
