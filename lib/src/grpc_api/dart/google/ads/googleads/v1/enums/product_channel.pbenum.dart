...
class ProductChannelEnum_ProductChannel extends $pb.ProtobufEnum {
  static const ProductChannelEnum_ProductChannel UNSPECIFIED = ProductChannelEnum_ProductChannel._(0, 'UNSPECIFIED');
  static const ProductChannelEnum_ProductChannel UNKNOWN = ProductChannelEnum_ProductChannel._(1, 'UNKNOWN');
  static const ProductChannelEnum_ProductChannel ONLINE = ProductChannelEnum_ProductChannel._(2, 'ONLINE');
  static const ProductChannelEnum_ProductChannel LOCAL = ProductChannelEnum_ProductChannel._(3, 'LOCAL');
