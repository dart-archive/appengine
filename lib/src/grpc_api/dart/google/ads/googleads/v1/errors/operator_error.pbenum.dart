...
class OperatorErrorEnum_OperatorError extends $pb.ProtobufEnum {
  static const OperatorErrorEnum_OperatorError UNSPECIFIED = OperatorErrorEnum_OperatorError._(0, 'UNSPECIFIED');
  static const OperatorErrorEnum_OperatorError UNKNOWN = OperatorErrorEnum_OperatorError._(1, 'UNKNOWN');
  static const OperatorErrorEnum_OperatorError OPERATOR_NOT_SUPPORTED = OperatorErrorEnum_OperatorError._(2, 'OPERATOR_NOT_SUPPORTED');
