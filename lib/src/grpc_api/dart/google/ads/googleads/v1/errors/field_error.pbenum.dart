...
class FieldErrorEnum_FieldError extends $pb.ProtobufEnum {
  static const FieldErrorEnum_FieldError UNSPECIFIED =
      FieldErrorEnum_FieldError._(0, 'UNSPECIFIED');
  static const FieldErrorEnum_FieldError UNKNOWN =
      FieldErrorEnum_FieldError._(1, 'UNKNOWN');
  static const FieldErrorEnum_FieldError REQUIRED =
      FieldErrorEnum_FieldError._(2, 'REQUIRED');
  static const FieldErrorEnum_FieldError IMMUTABLE_FIELD =
      FieldErrorEnum_FieldError._(3, 'IMMUTABLE_FIELD');
  static const FieldErrorEnum_FieldError INVALID_VALUE =
      FieldErrorEnum_FieldError._(4, 'INVALID_VALUE');
  static const FieldErrorEnum_FieldError VALUE_MUST_BE_UNSET =
      FieldErrorEnum_FieldError._(5, 'VALUE_MUST_BE_UNSET');
  static const FieldErrorEnum_FieldError REQUIRED_NONEMPTY_LIST =
      FieldErrorEnum_FieldError._(6, 'REQUIRED_NONEMPTY_LIST');
  static const FieldErrorEnum_FieldError FIELD_CANNOT_BE_CLEARED =
      FieldErrorEnum_FieldError._(7, 'FIELD_CANNOT_BE_CLEARED');
  static const FieldErrorEnum_FieldError BLACKLISTED_VALUE =
      FieldErrorEnum_FieldError._(8, 'BLACKLISTED_VALUE');
