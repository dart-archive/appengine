...
class HotelRateTypeEnum extends $pb.GeneratedMessage {
  ...
  HotelRateTypeEnum() : super();
  HotelRateTypeEnum.fromBuffer($core.List<$core.int> i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);
  HotelRateTypeEnum.fromJson($core.String i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromJson(i, r);
  ...
  static HotelRateTypeEnum create() => HotelRateTypeEnum();
