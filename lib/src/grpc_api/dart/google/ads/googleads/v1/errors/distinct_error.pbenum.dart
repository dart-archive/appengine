...
class DistinctErrorEnum_DistinctError extends $pb.ProtobufEnum {
  static const DistinctErrorEnum_DistinctError UNSPECIFIED = DistinctErrorEnum_DistinctError._(0, 'UNSPECIFIED');
  static const DistinctErrorEnum_DistinctError UNKNOWN = DistinctErrorEnum_DistinctError._(1, 'UNKNOWN');
  static const DistinctErrorEnum_DistinctError DUPLICATE_ELEMENT = DistinctErrorEnum_DistinctError._(2, 'DUPLICATE_ELEMENT');
  static const DistinctErrorEnum_DistinctError DUPLICATE_TYPE = DistinctErrorEnum_DistinctError._(3, 'DUPLICATE_TYPE');
