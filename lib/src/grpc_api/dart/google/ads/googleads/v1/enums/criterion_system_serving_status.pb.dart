...
class CriterionSystemServingStatusEnum extends $pb.GeneratedMessage {
  ...
  CriterionSystemServingStatusEnum() : super();
  CriterionSystemServingStatusEnum.fromBuffer($core.List<$core.int> i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);
  CriterionSystemServingStatusEnum.fromJson($core.String i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromJson(i, r);
