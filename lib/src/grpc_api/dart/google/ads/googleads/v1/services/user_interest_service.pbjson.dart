...
const GetUserInterestRequest$json = {
...
const UserInterestServiceBase$json = {
  '1': 'UserInterestService',
  '2': [
    {
      '1': 'GetUserInterest',
      '2': '.google.ads.googleads.v1.services.GetUserInterestRequest',
      '3': '.google.ads.googleads.v1.resources.UserInterest',
      '4': {}
    },
  ],
};

const UserInterestServiceBase$messageJson = {
  '.google.ads.googleads.v1.services.GetUserInterestRequest':
      GetUserInterestRequest$json,
