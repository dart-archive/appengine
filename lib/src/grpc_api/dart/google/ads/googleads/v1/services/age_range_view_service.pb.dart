...
class GetAgeRangeViewRequest extends $pb.GeneratedMessage {
  ...
  GetAgeRangeViewRequest.fromBuffer($core.List<$core.int> i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);
  GetAgeRangeViewRequest.fromJson($core.String i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromJson(i, r);
...
class AgeRangeViewServiceApi {
  ...
  $async.Future<$0.AgeRangeView> getAgeRangeView(
      $pb.ClientContext ctx, GetAgeRangeViewRequest request) {
    var emptyResponse = $0.AgeRangeView();
    return _client.invoke<$0.AgeRangeView>(
        ctx, 'AgeRangeViewService', 'GetAgeRangeView', request, emptyResponse);
  }
}
