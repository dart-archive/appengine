...
abstract class AdGroupExtensionSettingServiceBase extends $pb.GeneratedService {
  $async.Future<$0.AdGroupExtensionSetting> getAdGroupExtensionSetting(
      $pb.ServerContext ctx, GetAdGroupExtensionSettingRequest request);
  $async.Future<MutateAdGroupExtensionSettingsResponse>
      mutateAdGroupExtensionSettings(
          $pb.ServerContext ctx, MutateAdGroupExtensionSettingsRequest request);

  $pb.GeneratedMessage createRequest($core.String method) {
    switch (method) {
      case 'GetAdGroupExtensionSetting':
        return GetAdGroupExtensionSettingRequest();
      case 'MutateAdGroupExtensionSettings':
        return MutateAdGroupExtensionSettingsRequest();
      default:
  ...
  $async.Future<$pb.GeneratedMessage> handleCall($pb.ServerContext ctx,
    ...
    switch (method) {
      case 'GetAdGroupExtensionSetting':
        return this.getAdGroupExtensionSetting(ctx, request);
      case 'MutateAdGroupExtensionSettings':
        return this.mutateAdGroupExtensionSettings(ctx, request);
      default:
        throw $core.ArgumentError('Unknown method: $method');
    }
  }
  ...
  $core.Map<$core.String, $core.dynamic> get $json =>
      AdGroupExtensionSettingServiceBase$json;
  $core.Map<$core.String, $core.Map<$core.String, $core.dynamic>>
      get $messageJson => AdGroupExtensionSettingServiceBase$messageJson;
}
