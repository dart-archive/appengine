...
abstract class KeywordPlanAdGroupServiceBase extends $pb.GeneratedService {
  $async.Future<$0.KeywordPlanAdGroup> getKeywordPlanAdGroup(
      $pb.ServerContext ctx, GetKeywordPlanAdGroupRequest request);
  $async.Future<MutateKeywordPlanAdGroupsResponse> mutateKeywordPlanAdGroups(
      $pb.ServerContext ctx, MutateKeywordPlanAdGroupsRequest request);

  $pb.GeneratedMessage createRequest($core.String method) {
    switch (method) {
      case 'GetKeywordPlanAdGroup':
        return GetKeywordPlanAdGroupRequest();
      case 'MutateKeywordPlanAdGroups':
        return MutateKeywordPlanAdGroupsRequest();
      default:
  ...
  $async.Future<$pb.GeneratedMessage> handleCall($pb.ServerContext ctx,
    ...
    switch (method) {
      case 'GetKeywordPlanAdGroup':
        return this.getKeywordPlanAdGroup(ctx, request);
      case 'MutateKeywordPlanAdGroups':
        return this.mutateKeywordPlanAdGroups(ctx, request);
      default:
        throw $core.ArgumentError('Unknown method: $method');
    }
  }
  ...
  $core.Map<$core.String, $core.dynamic> get $json =>
      KeywordPlanAdGroupServiceBase$json;
  $core.Map<$core.String, $core.Map<$core.String, $core.dynamic>>
      get $messageJson => KeywordPlanAdGroupServiceBase$messageJson;
}
