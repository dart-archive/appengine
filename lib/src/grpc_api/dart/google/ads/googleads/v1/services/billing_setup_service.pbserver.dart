...
abstract class BillingSetupServiceBase extends $pb.GeneratedService {
  $async.Future<$0.BillingSetup> getBillingSetup(
      $pb.ServerContext ctx, GetBillingSetupRequest request);
  $async.Future<MutateBillingSetupResponse> mutateBillingSetup(
      $pb.ServerContext ctx, MutateBillingSetupRequest request);

  $pb.GeneratedMessage createRequest($core.String method) {
    switch (method) {
      case 'GetBillingSetup':
        return GetBillingSetupRequest();
      case 'MutateBillingSetup':
  ...
  $async.Future<$pb.GeneratedMessage> handleCall($pb.ServerContext ctx,
    ...
    switch (method) {
      case 'GetBillingSetup':
        return this.getBillingSetup(ctx, request);
      case 'MutateBillingSetup':
        return this.mutateBillingSetup(ctx, request);
      default:
        throw $core.ArgumentError('Unknown method: $method');
    }
  }
  ...
  $core.Map<$core.String, $core.dynamic> get $json =>
      BillingSetupServiceBase$json;
  $core.Map<$core.String, $core.Map<$core.String, $core.dynamic>>
      get $messageJson => BillingSetupServiceBase$messageJson;
}
