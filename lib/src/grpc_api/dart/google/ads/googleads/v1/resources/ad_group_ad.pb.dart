...
class AdGroupAd extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('AdGroupAd',
    ...
    ..aOS(1, 'resourceName')
    ..e<$3.AdGroupAdStatusEnum_AdGroupAdStatus>(
        3,
        'status',
        $pb.PbFieldType.OE,
        $3.AdGroupAdStatusEnum_AdGroupAdStatus.UNSPECIFIED,
        $3.AdGroupAdStatusEnum_AdGroupAdStatus.valueOf,
        $3.AdGroupAdStatusEnum_AdGroupAdStatus.values)
    ..a<$0.StringValue>(4, 'adGroup', $pb.PbFieldType.OM,
        $0.StringValue.getDefault, $0.StringValue.create)
    ..a<$1.Ad>(5, 'ad', $pb.PbFieldType.OM, $1.Ad.getDefault, $1.Ad.create)
    ..a<AdGroupAdPolicySummary>(6, 'policySummary', $pb.PbFieldType.OM,
        AdGroupAdPolicySummary.getDefault, AdGroupAdPolicySummary.create)
    ..e<$4.AdStrengthEnum_AdStrength>(
        7,
        'adStrength',
        $pb.PbFieldType.OE,
        $4.AdStrengthEnum_AdStrength.UNSPECIFIED,
        $4.AdStrengthEnum_AdStrength.valueOf,
...
class AdGroupAdPolicySummary extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('AdGroupAdPolicySummary',
    ...
    ..e<$5.PolicyReviewStatusEnum_PolicyReviewStatus>(
        ...
        $5.PolicyReviewStatusEnum_PolicyReviewStatus.valueOf,
        $5.PolicyReviewStatusEnum_PolicyReviewStatus.values)
    ..e<$6.PolicyApprovalStatusEnum_PolicyApprovalStatus>(
        3,
        'approvalStatus',
        $pb.PbFieldType.OE,
        $6.PolicyApprovalStatusEnum_PolicyApprovalStatus.UNSPECIFIED,
        $6.PolicyApprovalStatusEnum_PolicyApprovalStatus.valueOf,
  ...
  static AdGroupAdPolicySummary getDefault() =>
