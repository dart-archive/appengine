...
class CampaignBudget extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('CampaignBudget', package: const $pb.PackageName('google.ads.googleads.v1.resources'))
    ..aOS(1, 'resourceName')
    ...
    ..a<$0.Int64Value>(5, 'amountMicros', $pb.PbFieldType.OM, $0.Int64Value.getDefault, $0.Int64Value.create)
    ..e<$1.BudgetStatusEnum_BudgetStatus>(6, 'status', $pb.PbFieldType.OE, $1.BudgetStatusEnum_BudgetStatus.UNSPECIFIED, $1.BudgetStatusEnum_BudgetStatus.valueOf, $1.BudgetStatusEnum_BudgetStatus.values)
    ..e<$2.BudgetDeliveryMethodEnum_BudgetDeliveryMethod>(7, 'deliveryMethod', $pb.PbFieldType.OE, $2.BudgetDeliveryMethodEnum_BudgetDeliveryMethod.UNSPECIFIED, $2.BudgetDeliveryMethodEnum_BudgetDeliveryMethod.valueOf, $2.BudgetDeliveryMethodEnum_BudgetDeliveryMethod.values)
    ..a<$0.BoolValue>(8, 'explicitlyShared', $pb.PbFieldType.OM, $0.BoolValue.getDefault, $0.BoolValue.create)
    ..a<$0.Int64Value>(9, 'referenceCount', $pb.PbFieldType.OM, $0.Int64Value.getDefault, $0.Int64Value.create)
    ..a<$0.Int64Value>(10, 'totalAmountMicros', $pb.PbFieldType.OM, $0.Int64Value.getDefault, $0.Int64Value.create)
    ..a<$0.BoolValue>(11, 'hasRecommendedBudget', $pb.PbFieldType.OM, $0.BoolValue.getDefault, $0.BoolValue.create)
    ..a<$0.Int64Value>(12, 'recommendedBudgetAmountMicros', $pb.PbFieldType.OM, $0.Int64Value.getDefault, $0.Int64Value.create)
  ...
  CampaignBudget.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  CampaignBudget.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  CampaignBudget clone() => CampaignBudget()..mergeFromMessage(this);
  CampaignBudget copyWith(void Function(CampaignBudget) updates) => super.copyWith((message) => updates(message as CampaignBudget));
  ...
  set hasRecommendedBudget($0.BoolValue v) { setField(11, v); }
  ...
  set recommendedBudgetAmountMicros($0.Int64Value v) { setField(12, v); }
  ...
  set period($3.BudgetPeriodEnum_BudgetPeriod v) { setField(13, v); }
  ...
  set recommendedBudgetEstimatedChangeWeeklyClicks($0.Int64Value v) { setField(14, v); }
  ...
  $0.Int64Value get recommendedBudgetEstimatedChangeWeeklyCostMicros => $_getN(13);
  set recommendedBudgetEstimatedChangeWeeklyCostMicros($0.Int64Value v) { setField(15, v); }
  $core.bool hasRecommendedBudgetEstimatedChangeWeeklyCostMicros() => $_has(13);
  void clearRecommendedBudgetEstimatedChangeWeeklyCostMicros() => clearField(15);

  $0.Int64Value get recommendedBudgetEstimatedChangeWeeklyInteractions => $_getN(14);
  set recommendedBudgetEstimatedChangeWeeklyInteractions($0.Int64Value v) { setField(16, v); }
  $core.bool hasRecommendedBudgetEstimatedChangeWeeklyInteractions() => $_has(14);
  void clearRecommendedBudgetEstimatedChangeWeeklyInteractions() => clearField(16);

  $0.Int64Value get recommendedBudgetEstimatedChangeWeeklyViews => $_getN(15);
  set recommendedBudgetEstimatedChangeWeeklyViews($0.Int64Value v) { setField(17, v); }
  ...
  set type($4.BudgetTypeEnum_BudgetType v) { setField(18, v); }
