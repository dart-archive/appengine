...
abstract class SpannerServiceBase extends GeneratedService {
  ...
  Future<ListSessionsResponse> listSessions(ServerContext ctx, ListSessionsRequest request);
  ...
  Future<PartitionResponse> partitionQuery(ServerContext ctx, PartitionQueryRequest request);
  Future<PartitionResponse> partitionRead(ServerContext ctx, PartitionReadRequest request);

  GeneratedMessage createRequest(String method) {
    switch (method) {
      case 'CreateSession': return new CreateSessionRequest();
      case 'GetSession': return new GetSessionRequest();
      case 'ListSessions': return new ListSessionsRequest();
      ...
      case 'PartitionQuery': return new PartitionQueryRequest();
      case 'PartitionRead': return new PartitionReadRequest();
