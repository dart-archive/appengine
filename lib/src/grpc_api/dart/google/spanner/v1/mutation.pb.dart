...
class Mutation_Write extends GeneratedMessage {
  ...
  Mutation_Write.fromBuffer(List<int> i,
...
class Mutation_Delete extends GeneratedMessage {
  ...
  Mutation_Delete.fromBuffer(List<int> i,
      [ExtensionRegistry r = ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);
...
class _ReadonlyMutation_Delete extends Mutation_Delete
...
class Mutation extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('Mutation')
    ...
    ..a<Mutation_Write>(2, 'update', PbFieldType.OM, Mutation_Write.getDefault,
        Mutation_Write.create)
    ..a<Mutation_Write>(3, 'insertOrUpdate', PbFieldType.OM,
        Mutation_Write.getDefault, Mutation_Write.create)
    ..a<Mutation_Write>(4, 'replace', PbFieldType.OM, Mutation_Write.getDefault,
        Mutation_Write.create)
    ..a<Mutation_Delete>(5, 'delete', PbFieldType.OM,
