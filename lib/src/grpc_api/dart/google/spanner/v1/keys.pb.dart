...
class KeyRange extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('KeyRange', package: const $pb.PackageName('google.spanner.v1'))
    ..a<$0.ListValue>(1, 'startClosed', $pb.PbFieldType.OM, $0.ListValue.getDefault, $0.ListValue.create)
    ..a<$0.ListValue>(2, 'startOpen', $pb.PbFieldType.OM, $0.ListValue.getDefault, $0.ListValue.create)
    ..a<$0.ListValue>(3, 'endClosed', $pb.PbFieldType.OM, $0.ListValue.getDefault, $0.ListValue.create)
    ..a<$0.ListValue>(4, 'endOpen', $pb.PbFieldType.OM, $0.ListValue.getDefault, $0.ListValue.create)
    ..oo(0, [1, 2])
    ..oo(1, [3, 4])
  ...
  KeyRange() : super();
  KeyRange.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  KeyRange.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  KeyRange clone() => KeyRange()..mergeFromMessage(this);
  KeyRange copyWith(void Function(KeyRange) updates) => super.copyWith((message) => updates(message as KeyRange));
...
class KeySet extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('KeySet', package: const $pb.PackageName('google.spanner.v1'))
  ...
  KeySet() : super();
  KeySet.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  KeySet.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  KeySet clone() => KeySet()..mergeFromMessage(this);
  KeySet copyWith(void Function(KeySet) updates) => super.copyWith((message) => updates(message as KeySet));
  $pb.BuilderInfo get info_ => _i;
