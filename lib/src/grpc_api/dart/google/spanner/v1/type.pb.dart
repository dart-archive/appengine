...
class Type extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('Type')
    ...
    ..a<Type>(
        2, 'arrayElementType', PbFieldType.OM, Type.getDefault, Type.create)
    ..a<StructType>(3, 'structType', PbFieldType.OM, StructType.getDefault,
        StructType.create)
...
class StructType_Field extends GeneratedMessage {
  ...
  StructType_Field.fromBuffer(List<int> i,
...
class _ReadonlyStructType_Field extends StructType_Field
...
class StructType extends GeneratedMessage {
  ...
  StructType() : super();
  StructType.fromBuffer(List<int> i,
      [ExtensionRegistry r = ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);
