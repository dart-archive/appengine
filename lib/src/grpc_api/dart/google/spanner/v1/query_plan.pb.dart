...
class PlanNode_ChildLink extends GeneratedMessage {
  ...
  set childIndex(int v) { $_setSignedInt32(0, v); }
  ...
  set variable(String v) { $_setString(2, v); }
...
class PlanNode_ShortRepresentation extends GeneratedMessage {
  ...
  List<PlanNode_ShortRepresentation_SubqueriesEntry> get subqueries => $_getList(1);
}
...
class PlanNode extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('PlanNode')
    ...
    ..e<PlanNode_Kind>(2, 'kind', PbFieldType.OE, PlanNode_Kind.KIND_UNSPECIFIED, PlanNode_Kind.valueOf, PlanNode_Kind.values)
    ..aOS(3, 'displayName')
  ...
  set metadata($google$protobuf.Struct v) { setField(6, v); }
  bool hasMetadata() => $_has(5);
  void clearMetadata() => clearField(6);

  $google$protobuf.Struct get executionStats => $_getN(6);
  set executionStats($google$protobuf.Struct v) { setField(7, v); }
