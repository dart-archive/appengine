...
abstract class DatabaseAdminServiceBase extends GeneratedService {
  Future<ListDatabasesResponse> listDatabases(
      ServerContext ctx, ListDatabasesRequest request);
  Future<$google$longrunning.Operation> createDatabase(
      ServerContext ctx, CreateDatabaseRequest request);
  ...
  Future<$google$longrunning.Operation> updateDatabaseDdl(
      ServerContext ctx, UpdateDatabaseDdlRequest request);
  Future<$google$protobuf.Empty> dropDatabase(
      ServerContext ctx, DropDatabaseRequest request);
  Future<GetDatabaseDdlResponse> getDatabaseDdl(
      ServerContext ctx, GetDatabaseDdlRequest request);
