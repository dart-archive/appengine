...
abstract class DatabaseAdminServiceBase extends $pb.GeneratedService {
  $async.Future<ListDatabasesResponse> listDatabases($pb.ServerContext ctx, ListDatabasesRequest request);
  $async.Future<$1.Operation> createDatabase($pb.ServerContext ctx, CreateDatabaseRequest request);
  $async.Future<Database> getDatabase($pb.ServerContext ctx, GetDatabaseRequest request);
  $async.Future<$1.Operation> updateDatabaseDdl($pb.ServerContext ctx, UpdateDatabaseDdlRequest request);
  $async.Future<$2.Empty> dropDatabase($pb.ServerContext ctx, DropDatabaseRequest request);
  $async.Future<GetDatabaseDdlResponse> getDatabaseDdl($pb.ServerContext ctx, GetDatabaseDdlRequest request);
  ...
  $pb.GeneratedMessage createRequest($core.String method) {
    switch (method) {
      case 'ListDatabases': return ListDatabasesRequest();
      case 'CreateDatabase': return CreateDatabaseRequest();
      case 'GetDatabase': return GetDatabaseRequest();
      case 'UpdateDatabaseDdl': return UpdateDatabaseDdlRequest();
      case 'DropDatabase': return DropDatabaseRequest();
      case 'GetDatabaseDdl': return GetDatabaseDdlRequest();
  ...
  $core.Map<$core.String, $core.dynamic> get $json => DatabaseAdminServiceBase$json;
  $core.Map<$core.String, $core.Map<$core.String, $core.dynamic>> get $messageJson => DatabaseAdminServiceBase$messageJson;
}
