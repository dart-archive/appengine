...
class PartitionId extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('PartitionId', package: const $pb.PackageName('google.datastore.v1'))
    ..aOS(2, 'projectId')
    ..aOS(4, 'namespaceId')
...
class Key_PathElement extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Key.PathElement', package: const $pb.PackageName('google.datastore.v1'))
    ..aOS(1, 'kind')
    ..aInt64(2, 'id')
    ..aOS(3, 'name')
    ..oo(0, [2, 3])
...
class Key extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Key', package: const $pb.PackageName('google.datastore.v1'))
...
class ArrayValue extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ArrayValue', package: const $pb.PackageName('google.datastore.v1'))
...
class Value extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Value', package: const $pb.PackageName('google.datastore.v1'))
    ..aOB(1, 'booleanValue')
...
class Entity extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Entity', package: const $pb.PackageName('google.datastore.v1'))
    ..a<Key>(1, 'key', $pb.PbFieldType.OM, Key.getDefault, Key.create)
    ..m<$core.String, Value>(3, 'properties', 'Entity.PropertiesEntry',$pb.PbFieldType.OS, $pb.PbFieldType.OM, Value.create, null, null , const $pb.PackageName('google.datastore.v1'))
    ..hasRequiredFields = false
  ;
