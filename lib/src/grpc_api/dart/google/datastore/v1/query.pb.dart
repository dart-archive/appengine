...
class EntityResult extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('EntityResult', package: const $pb.PackageName('google.datastore.v1'))
...
class Query extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Query', package: const $pb.PackageName('google.datastore.v1'))
...
class KindExpression extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('KindExpression', package: const $pb.PackageName('google.datastore.v1'))
    ..aOS(1, 'name')
    ..hasRequiredFields = false
  ;
...
class PropertyReference extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('PropertyReference', package: const $pb.PackageName('google.datastore.v1'))
    ..aOS(2, 'name')
    ..hasRequiredFields = false
  ;
...
class Projection extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Projection', package: const $pb.PackageName('google.datastore.v1'))
...
class PropertyOrder extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('PropertyOrder', package: const $pb.PackageName('google.datastore.v1'))
    ..a<PropertyReference>(1, 'property', $pb.PbFieldType.OM, PropertyReference.getDefault, PropertyReference.create)
...
class Filter extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Filter', package: const $pb.PackageName('google.datastore.v1'))
...
class CompositeFilter extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('CompositeFilter', package: const $pb.PackageName('google.datastore.v1'))
...
class PropertyFilter extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('PropertyFilter', package: const $pb.PackageName('google.datastore.v1'))
    ..a<PropertyReference>(1, 'property', $pb.PbFieldType.OM, PropertyReference.getDefault, PropertyReference.create)
...
class GqlQuery extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('GqlQuery', package: const $pb.PackageName('google.datastore.v1'))
    ..aOS(1, 'queryString')
    ..aOB(2, 'allowLiterals')
    ..pc<GqlQueryParameter>(4, 'positionalBindings', $pb.PbFieldType.PM,GqlQueryParameter.create)
    ..m<$core.String, GqlQueryParameter>(5, 'namedBindings', 'GqlQuery.NamedBindingsEntry',$pb.PbFieldType.OS, $pb.PbFieldType.OM, GqlQueryParameter.create, null, null , const $pb.PackageName('google.datastore.v1'))
    ..hasRequiredFields = false
  ;
...
class GqlQueryParameter extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('GqlQueryParameter', package: const $pb.PackageName('google.datastore.v1'))
...
class QueryResultBatch extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('QueryResultBatch', package: const $pb.PackageName('google.datastore.v1'))
