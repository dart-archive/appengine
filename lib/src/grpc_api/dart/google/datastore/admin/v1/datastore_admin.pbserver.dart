...
abstract class DatastoreAdminServiceBase extends $pb.GeneratedService {
  $async.Future<$2.Operation> exportEntities($pb.ServerContext ctx, ExportEntitiesRequest request);
  $async.Future<$2.Operation> importEntities($pb.ServerContext ctx, ImportEntitiesRequest request);
