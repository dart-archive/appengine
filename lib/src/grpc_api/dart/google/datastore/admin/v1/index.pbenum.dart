...
class Index_AncestorMode extends $pb.ProtobufEnum {
  static const Index_AncestorMode ANCESTOR_MODE_UNSPECIFIED = Index_AncestorMode._(0, 'ANCESTOR_MODE_UNSPECIFIED');
  static const Index_AncestorMode NONE = Index_AncestorMode._(1, 'NONE');
  static const Index_AncestorMode ALL_ANCESTORS = Index_AncestorMode._(2, 'ALL_ANCESTORS');
...
class Index_Direction extends $pb.ProtobufEnum {
  static const Index_Direction DIRECTION_UNSPECIFIED = Index_Direction._(0, 'DIRECTION_UNSPECIFIED');
