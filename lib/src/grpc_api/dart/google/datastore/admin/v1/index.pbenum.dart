...
class Index_AncestorMode extends $pb.ProtobufEnum {
  ...
  static const Index_AncestorMode NONE = Index_AncestorMode._(
      1, $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'NONE');
...
class Index_State extends $pb.ProtobufEnum {
  static const Index_State STATE_UNSPECIFIED = Index_State._(
      ...
      $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'STATE_UNSPECIFIED');
  static const Index_State CREATING = Index_State._(1,
      $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'CREATING');
  static const Index_State READY = Index_State._(
      2, $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'READY');
  static const Index_State DELETING = Index_State._(3,
      $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'DELETING');
  static const Index_State ERROR = Index_State._(
      4, $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'ERROR');
