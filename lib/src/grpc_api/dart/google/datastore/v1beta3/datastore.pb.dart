...
class RunQueryRequest extends GeneratedMessage {
  ...
  set partitionId(PartitionId v) { setField(2, v); }
  ...
  set gqlQuery(GqlQuery v) { setField(7, v); }
...
class RunQueryResponse extends GeneratedMessage {
  ...
  set batch(QueryResultBatch v) { setField(1, v); }
...
class BeginTransactionRequest extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('BeginTransactionRequest')
    ..aOS(8, 'projectId')
    ..a<TransactionOptions>(10, 'transactionOptions', PbFieldType.OM, TransactionOptions.getDefault, TransactionOptions.create)
    ..hasRequiredFields = false
  ;
...
class CommitRequest extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('CommitRequest')
    ..a<List<int>>(1, 'transaction', PbFieldType.OY)
    ..e<CommitRequest_Mode>(5, 'mode', PbFieldType.OE, CommitRequest_Mode.MODE_UNSPECIFIED, CommitRequest_Mode.valueOf, CommitRequest_Mode.values)
...
class CommitResponse extends GeneratedMessage {
  ...
  set indexUpdates(int v) { $_setSignedInt32(1, v); }
...
class ReserveIdsRequest extends GeneratedMessage {
  ...
  ReserveIdsRequest.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  ReserveIdsRequest.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ReserveIdsRequest clone() => new ReserveIdsRequest()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static ReserveIdsRequest create() => new ReserveIdsRequest();
  static PbList<ReserveIdsRequest> createRepeated() => new PbList<ReserveIdsRequest>();
  static ReserveIdsRequest getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyReserveIdsRequest();
    return _defaultInstance;
  }
  ...
  set databaseId(String v) { $_setString(2, v); }
  bool hasDatabaseId() => $_has(2);
  void clearDatabaseId() => clearField(9);
}

class _ReadonlyReserveIdsRequest extends ReserveIdsRequest with ReadonlyMessageMixin {}
...
class ReserveIdsResponse extends GeneratedMessage {
  ...
  ReserveIdsResponse.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  ReserveIdsResponse.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ReserveIdsResponse clone() => new ReserveIdsResponse()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static ReserveIdsResponse create() => new ReserveIdsResponse();
  static PbList<ReserveIdsResponse> createRepeated() => new PbList<ReserveIdsResponse>();
  static ReserveIdsResponse getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyReserveIdsResponse();
    return _defaultInstance;
  }
...
class _ReadonlyReserveIdsResponse extends ReserveIdsResponse with ReadonlyMessageMixin {}
...
class MutationResult extends GeneratedMessage {
  ...
  set conflictDetected(bool v) { $_setBool(2, v); }
...
class ReadOptions extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('ReadOptions')
    ..e<ReadOptions_ReadConsistency>(1, 'readConsistency', PbFieldType.OE, ReadOptions_ReadConsistency.READ_CONSISTENCY_UNSPECIFIED, ReadOptions_ReadConsistency.valueOf, ReadOptions_ReadConsistency.values)
...
class TransactionOptions_ReadWrite extends GeneratedMessage {
  ...
  set previousTransaction(List<int> v) { $_setBytes(0, v); }
...
class DatastoreApi {
  ...
  Future<ReserveIdsResponse> reserveIds(ClientContext ctx, ReserveIdsRequest request) {
