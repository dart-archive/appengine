...
abstract class CloudTasksServiceBase extends $pb.GeneratedService {
  ...
  $async.Future<$3.Empty> deleteQueue($pb.ServerContext ctx, DeleteQueueRequest request);
  ...
  $async.Future<$3.Empty> deleteTask($pb.ServerContext ctx, DeleteTaskRequest request);
