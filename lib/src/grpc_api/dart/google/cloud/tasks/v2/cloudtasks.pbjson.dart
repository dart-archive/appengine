...
const CreateQueueRequest$json = const {
  ...
  '2': const [
    const {'1': 'parent', '3': 1, '4': 1, '5': 9, '10': 'parent'},
    const {'1': 'queue', '3': 2, '4': 1, '5': 11, '6': '.google.cloud.tasks.v2.Queue', '10': 'queue'},
  ],
};
...
const UpdateQueueRequest$json = const {
  ...
  '2': const [
    const {'1': 'queue', '3': 1, '4': 1, '5': 11, '6': '.google.cloud.tasks.v2.Queue', '10': 'queue'},
...
const CreateTaskRequest$json = const {
  ...
  '2': const [
    const {'1': 'parent', '3': 1, '4': 1, '5': 9, '10': 'parent'},
    const {'1': 'task', '3': 2, '4': 1, '5': 11, '6': '.google.cloud.tasks.v2.Task', '10': 'task'},
...
const CloudTasksServiceBase$json = const {
  '1': 'CloudTasks',
  '2': const [
    const {'1': 'ListQueues', '2': '.google.cloud.tasks.v2.ListQueuesRequest', '3': '.google.cloud.tasks.v2.ListQueuesResponse', '4': const {}},
    const {'1': 'GetQueue', '2': '.google.cloud.tasks.v2.GetQueueRequest', '3': '.google.cloud.tasks.v2.Queue', '4': const {}},
    const {'1': 'CreateQueue', '2': '.google.cloud.tasks.v2.CreateQueueRequest', '3': '.google.cloud.tasks.v2.Queue', '4': const {}},
    const {'1': 'UpdateQueue', '2': '.google.cloud.tasks.v2.UpdateQueueRequest', '3': '.google.cloud.tasks.v2.Queue', '4': const {}},
    const {'1': 'DeleteQueue', '2': '.google.cloud.tasks.v2.DeleteQueueRequest', '3': '.google.protobuf.Empty', '4': const {}},
    const {'1': 'PurgeQueue', '2': '.google.cloud.tasks.v2.PurgeQueueRequest', '3': '.google.cloud.tasks.v2.Queue', '4': const {}},
    const {'1': 'PauseQueue', '2': '.google.cloud.tasks.v2.PauseQueueRequest', '3': '.google.cloud.tasks.v2.Queue', '4': const {}},
    const {'1': 'ResumeQueue', '2': '.google.cloud.tasks.v2.ResumeQueueRequest', '3': '.google.cloud.tasks.v2.Queue', '4': const {}},
    ...
    const {'1': 'ListTasks', '2': '.google.cloud.tasks.v2.ListTasksRequest', '3': '.google.cloud.tasks.v2.ListTasksResponse', '4': const {}},
    const {'1': 'GetTask', '2': '.google.cloud.tasks.v2.GetTaskRequest', '3': '.google.cloud.tasks.v2.Task', '4': const {}},
    const {'1': 'CreateTask', '2': '.google.cloud.tasks.v2.CreateTaskRequest', '3': '.google.cloud.tasks.v2.Task', '4': const {}},
    const {'1': 'DeleteTask', '2': '.google.cloud.tasks.v2.DeleteTaskRequest', '3': '.google.protobuf.Empty', '4': const {}},
    const {'1': 'RunTask', '2': '.google.cloud.tasks.v2.RunTaskRequest', '3': '.google.cloud.tasks.v2.Task', '4': const {}},
  ],
};
...
const CloudTasksServiceBase$messageJson = const {
  ...
  '.google.cloud.tasks.v2.AppEngineHttpRequest.HeadersEntry': $6.AppEngineHttpRequest_HeadersEntry$json,
