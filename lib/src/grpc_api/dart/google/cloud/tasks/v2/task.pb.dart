...
class Task extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Task', package: const $pb.PackageName('google.cloud.tasks.v2'))
    ..aOS(1, 'name')
    ..a<$0.AppEngineHttpRequest>(2, 'appEngineHttpRequest', $pb.PbFieldType.OM, $0.AppEngineHttpRequest.getDefault, $0.AppEngineHttpRequest.create)
    ...
    ..a<$2.Duration>(6, 'dispatchDeadline', $pb.PbFieldType.OM, $2.Duration.getDefault, $2.Duration.create)
    ..a<$core.int>(7, 'dispatchCount', $pb.PbFieldType.O3)
    ..a<$core.int>(8, 'responseCount', $pb.PbFieldType.O3)
    ..a<Attempt>(9, 'firstAttempt', $pb.PbFieldType.OM, Attempt.getDefault, Attempt.create)
    ..a<Attempt>(10, 'lastAttempt', $pb.PbFieldType.OM, Attempt.getDefault, Attempt.create)
    ..e<Task_View>(11, 'view', $pb.PbFieldType.OE, Task_View.VIEW_UNSPECIFIED, Task_View.valueOf, Task_View.values)
    ..oo(0, [2])
  ...
  set dispatchCount($core.int v) { $_setSignedInt32(5, v); }
...
class Attempt extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Attempt', package: const $pb.PackageName('google.cloud.tasks.v2'))
