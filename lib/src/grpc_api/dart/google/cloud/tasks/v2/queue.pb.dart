...
class Queue extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Queue', package: const $pb.PackageName('google.cloud.tasks.v2'))
    ..aOS(1, 'name')
    ..a<$0.AppEngineRouting>(2, 'appEngineRoutingOverride', $pb.PbFieldType.OM, $0.AppEngineRouting.getDefault, $0.AppEngineRouting.create)
    ..a<RateLimits>(3, 'rateLimits', $pb.PbFieldType.OM, RateLimits.getDefault, RateLimits.create)
    ..a<RetryConfig>(4, 'retryConfig', $pb.PbFieldType.OM, RetryConfig.getDefault, RetryConfig.create)
    ..e<Queue_State>(5, 'state', $pb.PbFieldType.OE, Queue_State.STATE_UNSPECIFIED, Queue_State.valueOf, Queue_State.values)
    ..a<$1.Timestamp>(6, 'purgeTime', $pb.PbFieldType.OM, $1.Timestamp.getDefault, $1.Timestamp.create)
...
class RateLimits extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('RateLimits', package: const $pb.PackageName('google.cloud.tasks.v2'))
...
class RetryConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('RetryConfig', package: const $pb.PackageName('google.cloud.tasks.v2'))
