...
class ListQueuesRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ListQueuesRequest', package: const $pb.PackageName('google.cloud.tasks.v2beta2'))
    ..aOS(1, 'parent')
    ..aOS(2, 'filter')
...
class ListQueuesResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ListQueuesResponse', package: const $pb.PackageName('google.cloud.tasks.v2beta2'))
...
class GetQueueRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('GetQueueRequest', package: const $pb.PackageName('google.cloud.tasks.v2beta2'))
    ..aOS(1, 'name')
    ..hasRequiredFields = false
  ;
...
class CreateQueueRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('CreateQueueRequest', package: const $pb.PackageName('google.cloud.tasks.v2beta2'))
    ..aOS(1, 'parent')
...
class UpdateQueueRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('UpdateQueueRequest', package: const $pb.PackageName('google.cloud.tasks.v2beta2'))
...
class DeleteQueueRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('DeleteQueueRequest', package: const $pb.PackageName('google.cloud.tasks.v2beta2'))
    ..aOS(1, 'name')
    ..hasRequiredFields = false
  ;
...
class PurgeQueueRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('PurgeQueueRequest', package: const $pb.PackageName('google.cloud.tasks.v2beta2'))
    ..aOS(1, 'name')
    ..hasRequiredFields = false
  ;
...
class PauseQueueRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('PauseQueueRequest', package: const $pb.PackageName('google.cloud.tasks.v2beta2'))
    ..aOS(1, 'name')
    ..hasRequiredFields = false
  ;
...
class ResumeQueueRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ResumeQueueRequest', package: const $pb.PackageName('google.cloud.tasks.v2beta2'))
    ..aOS(1, 'name')
    ..hasRequiredFields = false
  ;
...
class ListTasksRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ListTasksRequest', package: const $pb.PackageName('google.cloud.tasks.v2beta2'))
    ..aOS(1, 'parent')
...
class ListTasksResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ListTasksResponse', package: const $pb.PackageName('google.cloud.tasks.v2beta2'))
...
class GetTaskRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('GetTaskRequest', package: const $pb.PackageName('google.cloud.tasks.v2beta2'))
    ..aOS(1, 'name')
    ..e<$2.Task_View>(2, 'responseView', $pb.PbFieldType.OE, $2.Task_View.VIEW_UNSPECIFIED, $2.Task_View.valueOf, $2.Task_View.values)
    ..hasRequiredFields = false
  ;
...
class CreateTaskRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('CreateTaskRequest', package: const $pb.PackageName('google.cloud.tasks.v2beta2'))
    ..aOS(1, 'parent')
...
class DeleteTaskRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('DeleteTaskRequest', package: const $pb.PackageName('google.cloud.tasks.v2beta2'))
    ..aOS(1, 'name')
    ..hasRequiredFields = false
  ;
...
class LeaseTasksRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('LeaseTasksRequest', package: const $pb.PackageName('google.cloud.tasks.v2beta2'))
    ..aOS(1, 'parent')
    ..a<$core.int>(2, 'maxTasks', $pb.PbFieldType.O3)
    ..a<$3.Duration>(3, 'leaseDuration', $pb.PbFieldType.OM, $3.Duration.getDefault, $3.Duration.create)
    ..e<$2.Task_View>(4, 'responseView', $pb.PbFieldType.OE, $2.Task_View.VIEW_UNSPECIFIED, $2.Task_View.valueOf, $2.Task_View.values)
    ..aOS(5, 'filter')
    ..hasRequiredFields = false
  ;

  LeaseTasksRequest() : super();
  LeaseTasksRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  LeaseTasksRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  LeaseTasksRequest clone() => LeaseTasksRequest()..mergeFromMessage(this);
  LeaseTasksRequest copyWith(void Function(LeaseTasksRequest) updates) => super.copyWith((message) => updates(message as LeaseTasksRequest));
  $pb.BuilderInfo get info_ => _i;
  ...
  static LeaseTasksRequest getDefault() => _defaultInstance ??= create()..freeze();
...
class LeaseTasksResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('LeaseTasksResponse', package: const $pb.PackageName('google.cloud.tasks.v2beta2'))
    ..pc<$2.Task>(1, 'tasks', $pb.PbFieldType.PM,$2.Task.create)
    ..hasRequiredFields = false
  ;

  LeaseTasksResponse() : super();
  LeaseTasksResponse.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  LeaseTasksResponse.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  LeaseTasksResponse clone() => LeaseTasksResponse()..mergeFromMessage(this);
  LeaseTasksResponse copyWith(void Function(LeaseTasksResponse) updates) => super.copyWith((message) => updates(message as LeaseTasksResponse));
  $pb.BuilderInfo get info_ => _i;
  ...
  static LeaseTasksResponse getDefault() => _defaultInstance ??= create()..freeze();
...
class AcknowledgeTaskRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('AcknowledgeTaskRequest', package: const $pb.PackageName('google.cloud.tasks.v2beta2'))
    ..aOS(1, 'name')
    ..a<$4.Timestamp>(2, 'scheduleTime', $pb.PbFieldType.OM, $4.Timestamp.getDefault, $4.Timestamp.create)
    ..hasRequiredFields = false
  ;

  AcknowledgeTaskRequest() : super();
  AcknowledgeTaskRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  AcknowledgeTaskRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  AcknowledgeTaskRequest clone() => AcknowledgeTaskRequest()..mergeFromMessage(this);
  AcknowledgeTaskRequest copyWith(void Function(AcknowledgeTaskRequest) updates) => super.copyWith((message) => updates(message as AcknowledgeTaskRequest));
  $pb.BuilderInfo get info_ => _i;
  ...
  static AcknowledgeTaskRequest getDefault() => _defaultInstance ??= create()..freeze();
  ...
  set scheduleTime($4.Timestamp v) { setField(2, v); }
  $core.bool hasScheduleTime() => $_has(1);
  void clearScheduleTime() => clearField(2);
}

class RenewLeaseRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('RenewLeaseRequest', package: const $pb.PackageName('google.cloud.tasks.v2beta2'))
    ..aOS(1, 'name')
    ..a<$4.Timestamp>(2, 'scheduleTime', $pb.PbFieldType.OM, $4.Timestamp.getDefault, $4.Timestamp.create)
    ..a<$3.Duration>(3, 'leaseDuration', $pb.PbFieldType.OM, $3.Duration.getDefault, $3.Duration.create)
    ..e<$2.Task_View>(4, 'responseView', $pb.PbFieldType.OE, $2.Task_View.VIEW_UNSPECIFIED, $2.Task_View.valueOf, $2.Task_View.values)
  ...
  RenewLeaseRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  RenewLeaseRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  RenewLeaseRequest clone() => RenewLeaseRequest()..mergeFromMessage(this);
  RenewLeaseRequest copyWith(void Function(RenewLeaseRequest) updates) => super.copyWith((message) => updates(message as RenewLeaseRequest));
  $pb.BuilderInfo get info_ => _i;
  ...
  static RenewLeaseRequest getDefault() => _defaultInstance ??= create()..freeze();
...
class CancelLeaseRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('CancelLeaseRequest', package: const $pb.PackageName('google.cloud.tasks.v2beta2'))
    ..aOS(1, 'name')
    ..a<$4.Timestamp>(2, 'scheduleTime', $pb.PbFieldType.OM, $4.Timestamp.getDefault, $4.Timestamp.create)
    ..e<$2.Task_View>(3, 'responseView', $pb.PbFieldType.OE, $2.Task_View.VIEW_UNSPECIFIED, $2.Task_View.valueOf, $2.Task_View.values)
    ..hasRequiredFields = false
  ...
  CancelLeaseRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  CancelLeaseRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  CancelLeaseRequest clone() => CancelLeaseRequest()..mergeFromMessage(this);
  CancelLeaseRequest copyWith(void Function(CancelLeaseRequest) updates) => super.copyWith((message) => updates(message as CancelLeaseRequest));
  $pb.BuilderInfo get info_ => _i;
  ...
  static CancelLeaseRequest getDefault() => _defaultInstance ??= create()..freeze();
...
class RunTaskRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('RunTaskRequest', package: const $pb.PackageName('google.cloud.tasks.v2beta2'))
    ..aOS(1, 'name')
    ..e<$2.Task_View>(2, 'responseView', $pb.PbFieldType.OE, $2.Task_View.VIEW_UNSPECIFIED, $2.Task_View.valueOf, $2.Task_View.values)
    ..hasRequiredFields = false
  ;
...
class CloudTasksApi {
  ...
  $async.Future<$5.Empty> deleteQueue($pb.ClientContext ctx, DeleteQueueRequest request) {
    var emptyResponse = $5.Empty();
    return _client.invoke<$5.Empty>(ctx, 'CloudTasks', 'DeleteQueue', request, emptyResponse);
  }
  ...
  $async.Future<$7.Policy> getIamPolicy($pb.ClientContext ctx, $6.GetIamPolicyRequest request) {
    var emptyResponse = $7.Policy();
    return _client.invoke<$7.Policy>(ctx, 'CloudTasks', 'GetIamPolicy', request, emptyResponse);
  }
  $async.Future<$7.Policy> setIamPolicy($pb.ClientContext ctx, $6.SetIamPolicyRequest request) {
    var emptyResponse = $7.Policy();
    return _client.invoke<$7.Policy>(ctx, 'CloudTasks', 'SetIamPolicy', request, emptyResponse);
  }
  $async.Future<$6.TestIamPermissionsResponse> testIamPermissions($pb.ClientContext ctx, $6.TestIamPermissionsRequest request) {
    var emptyResponse = $6.TestIamPermissionsResponse();
    return _client.invoke<$6.TestIamPermissionsResponse>(ctx, 'CloudTasks', 'TestIamPermissions', request, emptyResponse);
  }
  ...
  $async.Future<$5.Empty> deleteTask($pb.ClientContext ctx, DeleteTaskRequest request) {
    var emptyResponse = $5.Empty();
    return _client.invoke<$5.Empty>(ctx, 'CloudTasks', 'DeleteTask', request, emptyResponse);
  }
  $async.Future<LeaseTasksResponse> leaseTasks($pb.ClientContext ctx, LeaseTasksRequest request) {
  ...
  $async.Future<$5.Empty> acknowledgeTask($pb.ClientContext ctx, AcknowledgeTaskRequest request) {
    var emptyResponse = $5.Empty();
    return _client.invoke<$5.Empty>(ctx, 'CloudTasks', 'AcknowledgeTask', request, emptyResponse);
  }
  $async.Future<$2.Task> renewLease($pb.ClientContext ctx, RenewLeaseRequest request) {
    var emptyResponse = $2.Task();
    return _client.invoke<$2.Task>(ctx, 'CloudTasks', 'RenewLease', request, emptyResponse);
  }
  $async.Future<$2.Task> cancelLease($pb.ClientContext ctx, CancelLeaseRequest request) {
    var emptyResponse = $2.Task();
    return _client.invoke<$2.Task>(ctx, 'CloudTasks', 'CancelLease', request, emptyResponse);
  }
