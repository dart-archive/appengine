...
class Task extends GeneratedMessage {
  static final BuilderInfo _i = BuilderInfo('Task')
    ...
    ..a<PullMessage>(4, 'pullMessage', PbFieldType.OM, PullMessage.getDefault,
        PullMessage.create)
    ...
    ..a<$google$protobuf.Timestamp>(
        ...
        $google$protobuf.Timestamp.create)
    ..a<TaskStatus>(
        7, 'status', PbFieldType.OM, TaskStatus.getDefault, TaskStatus.create)
    ..e<Task_View>(8, 'view', PbFieldType.OE, Task_View.VIEW_UNSPECIFIED,
  ...
  set appEngineHttpRequest(AppEngineHttpRequest v) {
    setField(3, v);
  }
...
class TaskStatus extends GeneratedMessage {
  static final BuilderInfo _i = BuilderInfo('TaskStatus')
    ...
    ..a<AttemptStatus>(4, 'lastAttemptStatus', PbFieldType.OM,
        AttemptStatus.getDefault, AttemptStatus.create)
    ..hasRequiredFields = false;

  TaskStatus() : super();
  TaskStatus.fromBuffer(List<int> i,
  ...
  set attemptDispatchCount(int v) {
    $_setSignedInt32(0, v);
  }
  ...
  set attemptResponseCount(int v) {
    $_setSignedInt32(1, v);
  }
...
class AttemptStatus extends GeneratedMessage {
  static final BuilderInfo _i = BuilderInfo('AttemptStatus')
    ...
    ..a<$google$protobuf.Timestamp>(
        ...
        $google$protobuf.Timestamp.getDefault,
        $google$protobuf.Timestamp.create)
    ..a<$google$rpc.Status>(4, 'responseStatus', PbFieldType.OM,
        $google$rpc.Status.getDefault, $google$rpc.Status.create)
    ..hasRequiredFields = false;

  AttemptStatus() : super();
  AttemptStatus.fromBuffer(List<int> i,
      [ExtensionRegistry r = ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);
  ...
  set dispatchTime($google$protobuf.Timestamp v) {
    setField(2, v);
  }
  ...
  set responseTime($google$protobuf.Timestamp v) {
    setField(3, v);
  }
  ...
  set responseStatus($google$rpc.Status v) {
    setField(4, v);
  }
