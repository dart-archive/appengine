...
class Task extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Task', package: const $pb.PackageName('google.cloud.tasks.v2beta2'))
    ..aOS(1, 'name')
    ..a<$0.AppEngineHttpRequest>(3, 'appEngineHttpRequest', $pb.PbFieldType.OM, $0.AppEngineHttpRequest.getDefault, $0.AppEngineHttpRequest.create)
    ..a<$0.PullMessage>(4, 'pullMessage', $pb.PbFieldType.OM, $0.PullMessage.getDefault, $0.PullMessage.create)
    ..a<$1.Timestamp>(5, 'scheduleTime', $pb.PbFieldType.OM, $1.Timestamp.getDefault, $1.Timestamp.create)
    ..a<$1.Timestamp>(6, 'createTime', $pb.PbFieldType.OM, $1.Timestamp.getDefault, $1.Timestamp.create)
    ..a<TaskStatus>(7, 'status', $pb.PbFieldType.OM, TaskStatus.getDefault, TaskStatus.create)
    ..e<Task_View>(8, 'view', $pb.PbFieldType.OE, Task_View.VIEW_UNSPECIFIED, Task_View.valueOf, Task_View.values)
    ..oo(0, [3, 4])
...
class TaskStatus extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('TaskStatus', package: const $pb.PackageName('google.cloud.tasks.v2beta2'))
    ..a<$core.int>(1, 'attemptDispatchCount', $pb.PbFieldType.O3)
    ..a<$core.int>(2, 'attemptResponseCount', $pb.PbFieldType.O3)
    ..a<AttemptStatus>(3, 'firstAttemptStatus', $pb.PbFieldType.OM, AttemptStatus.getDefault, AttemptStatus.create)
    ..a<AttemptStatus>(4, 'lastAttemptStatus', $pb.PbFieldType.OM, AttemptStatus.getDefault, AttemptStatus.create)
    ..hasRequiredFields = false
  ;

  TaskStatus() : super();
  TaskStatus.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  TaskStatus.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  TaskStatus clone() => TaskStatus()..mergeFromMessage(this);
  TaskStatus copyWith(void Function(TaskStatus) updates) => super.copyWith((message) => updates(message as TaskStatus));
  $pb.BuilderInfo get info_ => _i;
...
class AttemptStatus extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('AttemptStatus', package: const $pb.PackageName('google.cloud.tasks.v2beta2'))
    ..a<$1.Timestamp>(1, 'scheduleTime', $pb.PbFieldType.OM, $1.Timestamp.getDefault, $1.Timestamp.create)
    ..a<$1.Timestamp>(2, 'dispatchTime', $pb.PbFieldType.OM, $1.Timestamp.getDefault, $1.Timestamp.create)
    ..a<$1.Timestamp>(3, 'responseTime', $pb.PbFieldType.OM, $1.Timestamp.getDefault, $1.Timestamp.create)
    ..a<$2.Status>(4, 'responseStatus', $pb.PbFieldType.OM, $2.Status.getDefault, $2.Status.create)
    ..hasRequiredFields = false
  ;

  AttemptStatus() : super();
  AttemptStatus.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  AttemptStatus.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  AttemptStatus clone() => AttemptStatus()..mergeFromMessage(this);
  AttemptStatus copyWith(void Function(AttemptStatus) updates) => super.copyWith((message) => updates(message as AttemptStatus));
  $pb.BuilderInfo get info_ => _i;
