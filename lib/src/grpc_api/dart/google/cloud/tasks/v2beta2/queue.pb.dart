...
class Queue extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('Queue')
    ..aOS(1, 'name')
    ..a<AppEngineHttpTarget>(3, 'appEngineHttpTarget', PbFieldType.OM, AppEngineHttpTarget.getDefault, AppEngineHttpTarget.create)
    ..a<PullTarget>(4, 'pullTarget', PbFieldType.OM, PullTarget.getDefault, PullTarget.create)
    ..a<RateLimits>(5, 'rateLimits', PbFieldType.OM, RateLimits.getDefault, RateLimits.create)
    ..a<RetryConfig>(6, 'retryConfig', PbFieldType.OM, RetryConfig.getDefault, RetryConfig.create)
    ..e<Queue_State>(7, 'state', PbFieldType.OE, Queue_State.STATE_UNSPECIFIED, Queue_State.valueOf, Queue_State.values)
    ..a<$google$protobuf.Timestamp>(8, 'purgeTime', PbFieldType.OM, $google$protobuf.Timestamp.getDefault, $google$protobuf.Timestamp.create)
    ..hasRequiredFields = false
  ;

  Queue() : super();
  Queue.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  Queue.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ...
  set purgeTime($google$protobuf.Timestamp v) { setField(8, v); }
...
class RateLimits extends GeneratedMessage {
  ...
  RateLimits() : super();
  RateLimits.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  RateLimits.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ...
  set maxTasksDispatchedPerSecond(double v) { $_setDouble(0, v); }
...
class RetryConfig extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('RetryConfig')
    ...
    ..a<$google$protobuf.Duration>(3, 'maxRetryDuration', PbFieldType.OM, $google$protobuf.Duration.getDefault, $google$protobuf.Duration.create)
    ..a<$google$protobuf.Duration>(4, 'minBackoff', PbFieldType.OM, $google$protobuf.Duration.getDefault, $google$protobuf.Duration.create)
    ..a<$google$protobuf.Duration>(5, 'maxBackoff', PbFieldType.OM, $google$protobuf.Duration.getDefault, $google$protobuf.Duration.create)
    ..a<int>(6, 'maxDoublings', PbFieldType.O3)
    ..hasRequiredFields = false
  ;

  RetryConfig() : super();
  RetryConfig.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  RetryConfig.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
