...
class Queue extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Queue', package: const $pb.PackageName('google.cloud.tasks.v2beta2'))
    ..aOS(1, 'name')
    ..a<$0.AppEngineHttpTarget>(3, 'appEngineHttpTarget', $pb.PbFieldType.OM, $0.AppEngineHttpTarget.getDefault, $0.AppEngineHttpTarget.create)
    ..a<$0.PullTarget>(4, 'pullTarget', $pb.PbFieldType.OM, $0.PullTarget.getDefault, $0.PullTarget.create)
    ..a<RateLimits>(5, 'rateLimits', $pb.PbFieldType.OM, RateLimits.getDefault, RateLimits.create)
    ..a<RetryConfig>(6, 'retryConfig', $pb.PbFieldType.OM, RetryConfig.getDefault, RetryConfig.create)
    ..e<Queue_State>(7, 'state', $pb.PbFieldType.OE, Queue_State.STATE_UNSPECIFIED, Queue_State.valueOf, Queue_State.values)
    ..a<$1.Timestamp>(8, 'purgeTime', $pb.PbFieldType.OM, $1.Timestamp.getDefault, $1.Timestamp.create)
    ..oo(0, [3, 4])
...
class RateLimits extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('RateLimits', package: const $pb.PackageName('google.cloud.tasks.v2beta2'))
...
class RetryConfig extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('RetryConfig', package: const $pb.PackageName('google.cloud.tasks.v2beta2'))
    ..a<$core.int>(1, 'maxAttempts', $pb.PbFieldType.O3)
    ..aOB(2, 'unlimitedAttempts')
    ..a<$2.Duration>(3, 'maxRetryDuration', $pb.PbFieldType.OM, $2.Duration.getDefault, $2.Duration.create)
    ..a<$2.Duration>(4, 'minBackoff', $pb.PbFieldType.OM, $2.Duration.getDefault, $2.Duration.create)
    ..a<$2.Duration>(5, 'maxBackoff', $pb.PbFieldType.OM, $2.Duration.getDefault, $2.Duration.create)
