...
class PullTarget extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('PullTarget', package: const $pb.PackageName('google.cloud.tasks.v2beta2'))
    ..hasRequiredFields = false
  ;

  PullTarget() : super();
  PullTarget.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  PullTarget.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  PullTarget clone() => PullTarget()..mergeFromMessage(this);
  PullTarget copyWith(void Function(PullTarget) updates) => super.copyWith((message) => updates(message as PullTarget));
...
class PullMessage extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('PullMessage', package: const $pb.PackageName('google.cloud.tasks.v2beta2'))
  ...
  PullMessage() : super();
  PullMessage.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  PullMessage.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  PullMessage clone() => PullMessage()..mergeFromMessage(this);
  PullMessage copyWith(void Function(PullMessage) updates) => super.copyWith((message) => updates(message as PullMessage));
  $pb.BuilderInfo get info_ => _i;
...
class AppEngineHttpTarget extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('AppEngineHttpTarget', package: const $pb.PackageName('google.cloud.tasks.v2beta2'))
...
class AppEngineHttpRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('AppEngineHttpRequest', package: const $pb.PackageName('google.cloud.tasks.v2beta2'))
    ...
    ..aOS(3, 'relativeUrl')
    ..m<$core.String, $core.String>(4, 'headers', 'AppEngineHttpRequest.HeadersEntry',$pb.PbFieldType.OS, $pb.PbFieldType.OS, null, null, null , const $pb.PackageName('google.cloud.tasks.v2beta2'))
...
class AppEngineRouting extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('AppEngineRouting', package: const $pb.PackageName('google.cloud.tasks.v2beta2'))
    ..aOS(1, 'service')
    ..aOS(2, 'version')
    ..aOS(3, 'instance')
    ..aOS(4, 'host')
