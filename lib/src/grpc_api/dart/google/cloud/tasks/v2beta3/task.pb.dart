...
class Task extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Task', package: const $pb.PackageName('google.cloud.tasks.v2beta3'))
    ..aOS(1, 'name')
    ...
    ..a<$1.Timestamp>(4, 'scheduleTime', $pb.PbFieldType.OM, $1.Timestamp.getDefault, $1.Timestamp.create)
    ...
    ..a<Attempt>(8, 'firstAttempt', $pb.PbFieldType.OM, Attempt.getDefault, Attempt.create)
    ..a<Attempt>(9, 'lastAttempt', $pb.PbFieldType.OM, Attempt.getDefault, Attempt.create)
    ..e<Task_View>(10, 'view', $pb.PbFieldType.OE, Task_View.VIEW_UNSPECIFIED, Task_View.valueOf, Task_View.values)
    ..a<$0.HttpRequest>(11, 'httpRequest', $pb.PbFieldType.OM, $0.HttpRequest.getDefault, $0.HttpRequest.create)
    ..a<$2.Duration>(12, 'dispatchDeadline', $pb.PbFieldType.OM, $2.Duration.getDefault, $2.Duration.create)
    ..oo(0, [3, 11])
...
class Attempt extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Attempt', package: const $pb.PackageName('google.cloud.tasks.v2beta3'))
    ...
    ..a<$3.Status>(4, 'responseStatus', $pb.PbFieldType.OM, $3.Status.getDefault, $3.Status.create)
    ..hasRequiredFields = false
  ;

  Attempt() : super();
  Attempt.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  Attempt.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  Attempt clone() => Attempt()..mergeFromMessage(this);
  Attempt copyWith(void Function(Attempt) updates) => super.copyWith((message) => updates(message as Attempt));
  $pb.BuilderInfo get info_ => _i;
