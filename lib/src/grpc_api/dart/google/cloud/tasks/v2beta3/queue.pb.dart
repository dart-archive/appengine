...
class Queue extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Queue',
    ...
    ..a<RateLimits>(4, 'rateLimits', $pb.PbFieldType.OM, RateLimits.getDefault,
        RateLimits.create)
    ..a<RetryConfig>(5, 'retryConfig', $pb.PbFieldType.OM,
    ...
    ..a<$1.Timestamp>(7, 'purgeTime', $pb.PbFieldType.OM,
        $1.Timestamp.getDefault, $1.Timestamp.create)
    ..a<StackdriverLoggingConfig>(
        10,
...
class StackdriverLoggingConfig extends $pb.GeneratedMessage {
  ...
  static StackdriverLoggingConfig getDefault() =>
