...
class HttpRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('HttpRequest', package: const $pb.PackageName('google.cloud.tasks.v2beta3'))
    ..aOS(1, 'url')
    ..e<HttpMethod>(2, 'httpMethod', $pb.PbFieldType.OE, HttpMethod.HTTP_METHOD_UNSPECIFIED, HttpMethod.valueOf, HttpMethod.values)
    ..m<$core.String, $core.String>(3, 'headers', 'HttpRequest.HeadersEntry',$pb.PbFieldType.OS, $pb.PbFieldType.OS, null, null, null , const $pb.PackageName('google.cloud.tasks.v2beta3'))
  ...
  HttpRequest() : super();
  HttpRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  HttpRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  HttpRequest clone() => HttpRequest()..mergeFromMessage(this);
  HttpRequest copyWith(void Function(HttpRequest) updates) => super.copyWith((message) => updates(message as HttpRequest));
...
class AppEngineHttpQueue extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('AppEngineHttpQueue', package: const $pb.PackageName('google.cloud.tasks.v2beta3'))
    ..a<AppEngineRouting>(1, 'appEngineRoutingOverride', $pb.PbFieldType.OM, AppEngineRouting.getDefault, AppEngineRouting.create)
    ..hasRequiredFields = false
  ;

  AppEngineHttpQueue() : super();
  AppEngineHttpQueue.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  AppEngineHttpQueue.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  AppEngineHttpQueue clone() => AppEngineHttpQueue()..mergeFromMessage(this);
  AppEngineHttpQueue copyWith(void Function(AppEngineHttpQueue) updates) => super.copyWith((message) => updates(message as AppEngineHttpQueue));
  $pb.BuilderInfo get info_ => _i;
  ...
  static AppEngineHttpQueue getDefault() => _defaultInstance ??= create()..freeze();
...
class AppEngineHttpRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('AppEngineHttpRequest', package: const $pb.PackageName('google.cloud.tasks.v2beta3'))
    ...
    ..aOS(3, 'relativeUri')
    ..m<$core.String, $core.String>(4, 'headers', 'AppEngineHttpRequest.HeadersEntry',$pb.PbFieldType.OS, $pb.PbFieldType.OS, null, null, null , const $pb.PackageName('google.cloud.tasks.v2beta3'))
    ..a<$core.List<$core.int>>(5, 'body', $pb.PbFieldType.OY)
    ..hasRequiredFields = false
  ;

  AppEngineHttpRequest() : super();
  AppEngineHttpRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  AppEngineHttpRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  AppEngineHttpRequest clone() => AppEngineHttpRequest()..mergeFromMessage(this);
  AppEngineHttpRequest copyWith(void Function(AppEngineHttpRequest) updates) => super.copyWith((message) => updates(message as AppEngineHttpRequest));
  $pb.BuilderInfo get info_ => _i;
  ...
  static AppEngineHttpRequest getDefault() => _defaultInstance ??= create()..freeze();
...
class AppEngineRouting extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('AppEngineRouting', package: const $pb.PackageName('google.cloud.tasks.v2beta3'))
    ..aOS(1, 'service')
    ..aOS(2, 'version')
    ..aOS(3, 'instance')
    ..aOS(4, 'host')
...
class OAuthToken extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('OAuthToken', package: const $pb.PackageName('google.cloud.tasks.v2beta3'))
...
class OidcToken extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('OidcToken', package: const $pb.PackageName('google.cloud.tasks.v2beta3'))
    ..aOS(1, 'serviceAccountEmail')
    ..aOS(2, 'audience')
    ..hasRequiredFields = false
  ;
