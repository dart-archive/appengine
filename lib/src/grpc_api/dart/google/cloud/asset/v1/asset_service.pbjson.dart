...
const ExportAssetsRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'output_config', '3': 5, '4': 1, '5': 11, '6': '.google.cloud.asset.v1.OutputConfig', '10': 'outputConfig'},
  ],
};
...
const BatchGetAssetsHistoryRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'content_type', '3': 3, '4': 1, '5': 14, '6': '.google.cloud.asset.v1.ContentType', '10': 'contentType'},
    const {'1': 'read_time_window', '3': 4, '4': 1, '5': 11, '6': '.google.cloud.asset.v1.TimeWindow', '10': 'readTimeWindow'},
  ],
};
...
const AssetServiceBase$json = const {
  '1': 'AssetService',
  '2': const [
    const {'1': 'ExportAssets', '2': '.google.cloud.asset.v1.ExportAssetsRequest', '3': '.google.longrunning.Operation', '4': const {}},
    const {'1': 'BatchGetAssetsHistory', '2': '.google.cloud.asset.v1.BatchGetAssetsHistoryRequest', '3': '.google.cloud.asset.v1.BatchGetAssetsHistoryResponse', '4': const {}},
  ],
};
...
const AssetServiceBase$messageJson = const {
  ...
  '.google.cloud.asset.v1.BatchGetAssetsHistoryRequest': BatchGetAssetsHistoryRequest$json,
  '.google.cloud.asset.v1.TimeWindow': $1.TimeWindow$json,
  '.google.cloud.asset.v1.BatchGetAssetsHistoryResponse': BatchGetAssetsHistoryResponse$json,
