...
class TemporalAsset extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('TemporalAsset',
    ...
    ..a<TimeWindow>(1, 'window', $pb.PbFieldType.OM, TimeWindow.getDefault,
        TimeWindow.create)
    ..aOB(2, 'deleted')
...
class Asset extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Asset',
    ...
    ..aOS(2, 'assetType')
    ..a<Resource>(
        3, 'resource', $pb.PbFieldType.OM, Resource.getDefault, Resource.create)
    ..a<$1.Policy>(4, 'iamPolicy', $pb.PbFieldType.OM, $1.Policy.getDefault,
        $1.Policy.create)
    ..a<$core.List<$core.int>>(5, 'iamPolicyName', $pb.PbFieldType.OY)
    ..pPS(6, 'ancestors')
    ..hasRequiredFields = false;
  ...
  $core.List<$core.int> get iamPolicyName => $_getN(4);
  set iamPolicyName($core.List<$core.int> v) {
    $_setBytes(4, v);
  }

  $core.bool hasIamPolicyName() => $_has(4);
  void clearIamPolicyName() => clearField(5);

  $core.List<$core.String> get ancestors => $_getList(5);
}
...
class Resource extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Resource',
    ...
    ..a<$3.Any>(
        7, 'internalData', $pb.PbFieldType.OM, $3.Any.getDefault, $3.Any.create)
    ..hasRequiredFields = false;
  ...
  $3.Any get internalData => $_getN(6);
  set internalData($3.Any v) {
    setField(7, v);
  }

  $core.bool hasInternalData() => $_has(6);
  void clearInternalData() => clearField(7);
}
