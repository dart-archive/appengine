...
class TemporalAsset extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('TemporalAsset', package: const $pb.PackageName('google.cloud.asset.v1beta1'))
...
class TimeWindow extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('TimeWindow', package: const $pb.PackageName('google.cloud.asset.v1beta1'))
...
class Asset extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Asset', package: const $pb.PackageName('google.cloud.asset.v1beta1'))
    ..aOS(1, 'name')
    ..aOS(2, 'assetType')
...
class Resource extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Resource', package: const $pb.PackageName('google.cloud.asset.v1beta1'))
    ..aOS(1, 'version')
