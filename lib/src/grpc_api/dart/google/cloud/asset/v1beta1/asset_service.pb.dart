...
class ExportAssetsRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ExportAssetsRequest', package: const $pb.PackageName('google.cloud.asset.v1beta1'))
    ..aOS(1, 'parent')
    ..a<$0.Timestamp>(2, 'readTime', $pb.PbFieldType.OM, $0.Timestamp.getDefault, $0.Timestamp.create)
    ..pPS(3, 'assetTypes')
    ..e<ContentType>(4, 'contentType', $pb.PbFieldType.OE, ContentType.CONTENT_TYPE_UNSPECIFIED, ContentType.valueOf, ContentType.values)
    ..a<OutputConfig>(5, 'outputConfig', $pb.PbFieldType.OM, OutputConfig.getDefault, OutputConfig.create)
    ..hasRequiredFields = false
  ;

  ExportAssetsRequest() : super();
  ExportAssetsRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  ExportAssetsRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ExportAssetsRequest clone() => ExportAssetsRequest()..mergeFromMessage(this);
  ExportAssetsRequest copyWith(void Function(ExportAssetsRequest) updates) => super.copyWith((message) => updates(message as ExportAssetsRequest));
  ...
  static ExportAssetsRequest getDefault() => _defaultInstance ??= create()..freeze();
...
class ExportAssetsResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ExportAssetsResponse', package: const $pb.PackageName('google.cloud.asset.v1beta1'))
    ..a<$0.Timestamp>(1, 'readTime', $pb.PbFieldType.OM, $0.Timestamp.getDefault, $0.Timestamp.create)
    ..a<OutputConfig>(2, 'outputConfig', $pb.PbFieldType.OM, OutputConfig.getDefault, OutputConfig.create)
    ..hasRequiredFields = false
  ;

  ExportAssetsResponse() : super();
  ExportAssetsResponse.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  ExportAssetsResponse.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ExportAssetsResponse clone() => ExportAssetsResponse()..mergeFromMessage(this);
  ExportAssetsResponse copyWith(void Function(ExportAssetsResponse) updates) => super.copyWith((message) => updates(message as ExportAssetsResponse));
  $pb.BuilderInfo get info_ => _i;
  ...
  static ExportAssetsResponse getDefault() => _defaultInstance ??= create()..freeze();
  static ExportAssetsResponse _defaultInstance;

  $0.Timestamp get readTime => $_getN(0);
  set readTime($0.Timestamp v) { setField(1, v); }
...
class BatchGetAssetsHistoryRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('BatchGetAssetsHistoryRequest', package: const $pb.PackageName('google.cloud.asset.v1beta1'))
    ..aOS(1, 'parent')
    ..pPS(2, 'assetNames')
    ..e<ContentType>(3, 'contentType', $pb.PbFieldType.OE, ContentType.CONTENT_TYPE_UNSPECIFIED, ContentType.valueOf, ContentType.values)
    ..a<$1.TimeWindow>(4, 'readTimeWindow', $pb.PbFieldType.OM, $1.TimeWindow.getDefault, $1.TimeWindow.create)
    ..hasRequiredFields = false
  ;

  BatchGetAssetsHistoryRequest() : super();
  BatchGetAssetsHistoryRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  BatchGetAssetsHistoryRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  BatchGetAssetsHistoryRequest clone() => BatchGetAssetsHistoryRequest()..mergeFromMessage(this);
  BatchGetAssetsHistoryRequest copyWith(void Function(BatchGetAssetsHistoryRequest) updates) => super.copyWith((message) => updates(message as BatchGetAssetsHistoryRequest));
  $pb.BuilderInfo get info_ => _i;
  static BatchGetAssetsHistoryRequest create() => BatchGetAssetsHistoryRequest();
  ...
  static BatchGetAssetsHistoryRequest getDefault() => _defaultInstance ??= create()..freeze();
  ...
  set readTimeWindow($1.TimeWindow v) { setField(4, v); }
...
class BatchGetAssetsHistoryResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('BatchGetAssetsHistoryResponse', package: const $pb.PackageName('google.cloud.asset.v1beta1'))
    ..pc<$1.TemporalAsset>(1, 'assets', $pb.PbFieldType.PM,$1.TemporalAsset.create)
    ..hasRequiredFields = false
  ;

  BatchGetAssetsHistoryResponse() : super();
  BatchGetAssetsHistoryResponse.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  BatchGetAssetsHistoryResponse.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  BatchGetAssetsHistoryResponse clone() => BatchGetAssetsHistoryResponse()..mergeFromMessage(this);
  BatchGetAssetsHistoryResponse copyWith(void Function(BatchGetAssetsHistoryResponse) updates) => super.copyWith((message) => updates(message as BatchGetAssetsHistoryResponse));
  $pb.BuilderInfo get info_ => _i;
  static BatchGetAssetsHistoryResponse create() => BatchGetAssetsHistoryResponse();
  ...
  static BatchGetAssetsHistoryResponse getDefault() => _defaultInstance ??= create()..freeze();
...
class OutputConfig extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('OutputConfig', package: const $pb.PackageName('google.cloud.asset.v1beta1'))
...
class GcsDestination extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('GcsDestination', package: const $pb.PackageName('google.cloud.asset.v1beta1'))
    ..aOS(1, 'uri')
    ..oo(0, [1])
    ..hasRequiredFields = false
  ;
...
class AssetServiceApi {
  ...
  $async.Future<$2.Operation> exportAssets($pb.ClientContext ctx, ExportAssetsRequest request) {
    var emptyResponse = $2.Operation();
    return _client.invoke<$2.Operation>(ctx, 'AssetService', 'ExportAssets', request, emptyResponse);
  }
  $async.Future<BatchGetAssetsHistoryResponse> batchGetAssetsHistory($pb.ClientContext ctx, BatchGetAssetsHistoryRequest request) {
    var emptyResponse = BatchGetAssetsHistoryResponse();
    return _client.invoke<BatchGetAssetsHistoryResponse>(ctx, 'AssetService', 'BatchGetAssetsHistory', request, emptyResponse);
  }
}
