...
const Instance$json = const {
  ...
  '2': const [
    ...
    const {'1': 'state', '3': 14, '4': 1, '5': 14, '6': '.google.cloud.redis.v1.Instance.State', '10': 'state'},
    const {'1': 'status_message', '3': 15, '4': 1, '5': 9, '10': 'statusMessage'},
    const {'1': 'redis_configs', '3': 16, '4': 3, '5': 11, '6': '.google.cloud.redis.v1.Instance.RedisConfigsEntry', '10': 'redisConfigs'},
    const {'1': 'tier', '3': 17, '4': 1, '5': 14, '6': '.google.cloud.redis.v1.Instance.Tier', '10': 'tier'},
...
const CreateInstanceRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'instance', '3': 3, '4': 1, '5': 11, '6': '.google.cloud.redis.v1.Instance', '10': 'instance'},
  ],
};
...
const UpdateInstanceRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'instance', '3': 2, '4': 1, '5': 11, '6': '.google.cloud.redis.v1.Instance', '10': 'instance'},
  ],
};
...
const FailoverInstanceRequest$json = const {
  ...
  '2': const [
    const {'1': 'name', '3': 1, '4': 1, '5': 9, '10': 'name'},
    const {'1': 'data_protection_mode', '3': 2, '4': 1, '5': 14, '6': '.google.cloud.redis.v1.FailoverInstanceRequest.DataProtectionMode', '10': 'dataProtectionMode'},
  ],
...
const LocationMetadata$json = const {
  '1': 'LocationMetadata',
  '2': const [
    const {'1': 'available_zones', '3': 1, '4': 3, '5': 11, '6': '.google.cloud.redis.v1.LocationMetadata.AvailableZonesEntry', '10': 'availableZones'},
  ],
...
const CloudRedisServiceBase$json = const {
  '1': 'CloudRedis',
  '2': const [
    const {'1': 'ListInstances', '2': '.google.cloud.redis.v1.ListInstancesRequest', '3': '.google.cloud.redis.v1.ListInstancesResponse', '4': const {}},
    const {'1': 'GetInstance', '2': '.google.cloud.redis.v1.GetInstanceRequest', '3': '.google.cloud.redis.v1.Instance', '4': const {}},
    const {'1': 'CreateInstance', '2': '.google.cloud.redis.v1.CreateInstanceRequest', '3': '.google.longrunning.Operation', '4': const {}},
    const {'1': 'UpdateInstance', '2': '.google.cloud.redis.v1.UpdateInstanceRequest', '3': '.google.longrunning.Operation', '4': const {}},
    const {'1': 'FailoverInstance', '2': '.google.cloud.redis.v1.FailoverInstanceRequest', '3': '.google.longrunning.Operation', '4': const {}},
    const {'1': 'DeleteInstance', '2': '.google.cloud.redis.v1.DeleteInstanceRequest', '3': '.google.longrunning.Operation', '4': const {}},
  ],
};

const CloudRedisServiceBase$messageJson = const {
  '.google.cloud.redis.v1.ListInstancesRequest': ListInstancesRequest$json,
  '.google.cloud.redis.v1.ListInstancesResponse': ListInstancesResponse$json,
  '.google.cloud.redis.v1.Instance': Instance$json,
  '.google.cloud.redis.v1.Instance.LabelsEntry': Instance_LabelsEntry$json,
  '.google.protobuf.Timestamp': $0.Timestamp$json,
  '.google.cloud.redis.v1.Instance.RedisConfigsEntry': Instance_RedisConfigsEntry$json,
  '.google.cloud.redis.v1.GetInstanceRequest': GetInstanceRequest$json,
  '.google.cloud.redis.v1.CreateInstanceRequest': CreateInstanceRequest$json,
  '.google.longrunning.Operation': $2.Operation$json,
  '.google.protobuf.Any': $3.Any$json,
  '.google.rpc.Status': $4.Status$json,
  '.google.cloud.redis.v1.UpdateInstanceRequest': UpdateInstanceRequest$json,
  '.google.protobuf.FieldMask': $1.FieldMask$json,
  '.google.cloud.redis.v1.FailoverInstanceRequest': FailoverInstanceRequest$json,
  '.google.cloud.redis.v1.DeleteInstanceRequest': DeleteInstanceRequest$json,
};
