...
class Instance_State extends $pb.ProtobufEnum {
  ...
  static const Instance_State FAILING_OVER = Instance_State._(10, 'FAILING_OVER');
...
class Instance_Tier extends $pb.ProtobufEnum {
  static const Instance_Tier TIER_UNSPECIFIED = Instance_Tier._(0, 'TIER_UNSPECIFIED');
...
class FailoverInstanceRequest_DataProtectionMode extends $pb.ProtobufEnum {
  static const FailoverInstanceRequest_DataProtectionMode DATA_PROTECTION_MODE_UNSPECIFIED = FailoverInstanceRequest_DataProtectionMode._(0, 'DATA_PROTECTION_MODE_UNSPECIFIED');
  static const FailoverInstanceRequest_DataProtectionMode LIMITED_DATA_LOSS = FailoverInstanceRequest_DataProtectionMode._(1, 'LIMITED_DATA_LOSS');
  static const FailoverInstanceRequest_DataProtectionMode FORCE_DATA_LOSS = FailoverInstanceRequest_DataProtectionMode._(2, 'FORCE_DATA_LOSS');
