...
class Instance_RedisConfigsEntry extends GeneratedMessage {
  ...
  Instance_RedisConfigsEntry.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  Instance_RedisConfigsEntry.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  Instance_RedisConfigsEntry clone() => new Instance_RedisConfigsEntry()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static Instance_RedisConfigsEntry create() => new Instance_RedisConfigsEntry();
  static PbList<Instance_RedisConfigsEntry> createRepeated() => new PbList<Instance_RedisConfigsEntry>();
  static Instance_RedisConfigsEntry getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyInstance_RedisConfigsEntry();
    return _defaultInstance;
  }
  static Instance_RedisConfigsEntry _defaultInstance;
  static void $checkItem(Instance_RedisConfigsEntry v) {
    if (v is! Instance_RedisConfigsEntry) checkItemFailed(v, 'Instance_RedisConfigsEntry');
  }
...
class _ReadonlyInstance_RedisConfigsEntry extends Instance_RedisConfigsEntry with ReadonlyMessageMixin {}

class Instance extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('Instance')
    ..aOS(1, 'name')
    ..aOS(2, 'displayName')
    ..pp<Instance_LabelsEntry>(3, 'labels', PbFieldType.PM, Instance_LabelsEntry.$checkItem, Instance_LabelsEntry.create)
    ..aOS(4, 'locationId')
    ...
    ..e<Instance_State>(14, 'state', PbFieldType.OE, Instance_State.STATE_UNSPECIFIED, Instance_State.valueOf, Instance_State.values)
    ..aOS(15, 'statusMessage')
    ..pp<Instance_RedisConfigsEntry>(16, 'redisConfigs', PbFieldType.PM, Instance_RedisConfigsEntry.$checkItem, Instance_RedisConfigsEntry.create)
    ..e<Instance_Tier>(17, 'tier', PbFieldType.OE, Instance_Tier.TIER_UNSPECIFIED, Instance_Tier.valueOf, Instance_Tier.values)
  ...
  set statusMessage(String v) { $_setString(12, v); }
...
class UpdateInstanceRequest extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('UpdateInstanceRequest')
    ..a<$google$protobuf.FieldMask>(1, 'updateMask', PbFieldType.OM, $google$protobuf.FieldMask.getDefault, $google$protobuf.FieldMask.create)
    ..a<Instance>(2, 'instance', PbFieldType.OM, Instance.getDefault, Instance.create)
    ..hasRequiredFields = false
  ;
  ...
  set updateMask($google$protobuf.FieldMask v) { setField(1, v); }
...
class LocationMetadata_AvailableZonesEntry extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('LocationMetadata_AvailableZonesEntry')
    ..aOS(1, 'key')
    ..a<ZoneMetadata>(2, 'value', PbFieldType.OM, ZoneMetadata.getDefault, ZoneMetadata.create)
    ..hasRequiredFields = false
  ;

  LocationMetadata_AvailableZonesEntry() : super();
  LocationMetadata_AvailableZonesEntry.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  LocationMetadata_AvailableZonesEntry.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  LocationMetadata_AvailableZonesEntry clone() => new LocationMetadata_AvailableZonesEntry()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static LocationMetadata_AvailableZonesEntry create() => new LocationMetadata_AvailableZonesEntry();
  static PbList<LocationMetadata_AvailableZonesEntry> createRepeated() => new PbList<LocationMetadata_AvailableZonesEntry>();
  static LocationMetadata_AvailableZonesEntry getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyLocationMetadata_AvailableZonesEntry();
    return _defaultInstance;
  }
  static LocationMetadata_AvailableZonesEntry _defaultInstance;
  static void $checkItem(LocationMetadata_AvailableZonesEntry v) {
    if (v is! LocationMetadata_AvailableZonesEntry) checkItemFailed(v, 'LocationMetadata_AvailableZonesEntry');
  }
  ...
  set value(ZoneMetadata v) { setField(2, v); }
  bool hasValue() => $_has(1);
  void clearValue() => clearField(2);
}

class _ReadonlyLocationMetadata_AvailableZonesEntry extends LocationMetadata_AvailableZonesEntry with ReadonlyMessageMixin {}

class LocationMetadata extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('LocationMetadata')
    ..pp<LocationMetadata_AvailableZonesEntry>(1, 'availableZones', PbFieldType.PM, LocationMetadata_AvailableZonesEntry.$checkItem, LocationMetadata_AvailableZonesEntry.create)
    ..hasRequiredFields = false
  ;
...
class ZoneMetadata extends GeneratedMessage {
  ...
  ZoneMetadata() : super();
  ZoneMetadata.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  ZoneMetadata.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ...
  static ZoneMetadata getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyZoneMetadata();
    return _defaultInstance;
  }
...
class CloudRedisApi {
  ...
  Future<$google$longrunning.Operation> createInstance(ClientContext ctx, CreateInstanceRequest request) {
    ...
    return _client.invoke<$google$longrunning.Operation>(ctx, 'CloudRedis', 'CreateInstance', request, emptyResponse);
  }
  Future<$google$longrunning.Operation> updateInstance(ClientContext ctx, UpdateInstanceRequest request) {
    var emptyResponse = new $google$longrunning.Operation();
    return _client.invoke<$google$longrunning.Operation>(ctx, 'CloudRedis', 'UpdateInstance', request, emptyResponse);
  }
  Future<$google$longrunning.Operation> deleteInstance(ClientContext ctx, DeleteInstanceRequest request) {
    var emptyResponse = new $google$longrunning.Operation();
    return _client.invoke<$google$longrunning.Operation>(ctx, 'CloudRedis', 'DeleteInstance', request, emptyResponse);
  }
}
