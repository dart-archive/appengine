...
class KeyManagementServiceApi {
  ...
  $async.Future<ListKeyRingsResponse> listKeyRings(
      $pb.ClientContext ctx, ListKeyRingsRequest request) {
    var emptyResponse = ListKeyRingsResponse();
    return _client.invoke<ListKeyRingsResponse>(
        ctx, 'KeyManagementService', 'ListKeyRings', request, emptyResponse);
  }

  $async.Future<ListCryptoKeysResponse> listCryptoKeys(
      $pb.ClientContext ctx, ListCryptoKeysRequest request) {
    var emptyResponse = ListCryptoKeysResponse();
    return _client.invoke<ListCryptoKeysResponse>(
        ctx, 'KeyManagementService', 'ListCryptoKeys', request, emptyResponse);
  }

  $async.Future<ListCryptoKeyVersionsResponse> listCryptoKeyVersions(
      $pb.ClientContext ctx, ListCryptoKeyVersionsRequest request) {
    var emptyResponse = ListCryptoKeyVersionsResponse();
    return _client.invoke<ListCryptoKeyVersionsResponse>(
        ctx,
  ...
  $async.Future<$0.KeyRing> getKeyRing(
      $pb.ClientContext ctx, GetKeyRingRequest request) {
    var emptyResponse = $0.KeyRing();
    return _client.invoke<$0.KeyRing>(
        ctx, 'KeyManagementService', 'GetKeyRing', request, emptyResponse);
  }

  $async.Future<$0.CryptoKey> getCryptoKey(
      $pb.ClientContext ctx, GetCryptoKeyRequest request) {
    var emptyResponse = $0.CryptoKey();
    return _client.invoke<$0.CryptoKey>(
        ctx, 'KeyManagementService', 'GetCryptoKey', request, emptyResponse);
  }

  $async.Future<$0.CryptoKeyVersion> getCryptoKeyVersion(
      $pb.ClientContext ctx, GetCryptoKeyVersionRequest request) {
    var emptyResponse = $0.CryptoKeyVersion();
    return _client.invoke<$0.CryptoKeyVersion>(ctx, 'KeyManagementService',
        'GetCryptoKeyVersion', request, emptyResponse);
  }

  $async.Future<$0.PublicKey> getPublicKey(
      $pb.ClientContext ctx, GetPublicKeyRequest request) {
    var emptyResponse = $0.PublicKey();
    return _client.invoke<$0.PublicKey>(
        ctx, 'KeyManagementService', 'GetPublicKey', request, emptyResponse);
  }

  $async.Future<$0.KeyRing> createKeyRing(
      $pb.ClientContext ctx, CreateKeyRingRequest request) {
    var emptyResponse = $0.KeyRing();
    return _client.invoke<$0.KeyRing>(
        ctx, 'KeyManagementService', 'CreateKeyRing', request, emptyResponse);
  }

  $async.Future<$0.CryptoKey> createCryptoKey(
      $pb.ClientContext ctx, CreateCryptoKeyRequest request) {
    var emptyResponse = $0.CryptoKey();
    return _client.invoke<$0.CryptoKey>(
        ctx, 'KeyManagementService', 'CreateCryptoKey', request, emptyResponse);
  }

  $async.Future<$0.CryptoKeyVersion> createCryptoKeyVersion(
      $pb.ClientContext ctx, CreateCryptoKeyVersionRequest request) {
    var emptyResponse = $0.CryptoKeyVersion();
    return _client.invoke<$0.CryptoKeyVersion>(ctx, 'KeyManagementService',
        'CreateCryptoKeyVersion', request, emptyResponse);
  }

  $async.Future<$0.CryptoKey> updateCryptoKey(
      $pb.ClientContext ctx, UpdateCryptoKeyRequest request) {
    var emptyResponse = $0.CryptoKey();
    return _client.invoke<$0.CryptoKey>(
        ctx, 'KeyManagementService', 'UpdateCryptoKey', request, emptyResponse);
  }

  $async.Future<$0.CryptoKeyVersion> updateCryptoKeyVersion(
      $pb.ClientContext ctx, UpdateCryptoKeyVersionRequest request) {
    var emptyResponse = $0.CryptoKeyVersion();
    return _client.invoke<$0.CryptoKeyVersion>(ctx, 'KeyManagementService',
        'UpdateCryptoKeyVersion', request, emptyResponse);
  }

  $async.Future<EncryptResponse> encrypt(
      $pb.ClientContext ctx, EncryptRequest request) {
    var emptyResponse = EncryptResponse();
    return _client.invoke<EncryptResponse>(
        ctx, 'KeyManagementService', 'Encrypt', request, emptyResponse);
  }

  $async.Future<DecryptResponse> decrypt(
      $pb.ClientContext ctx, DecryptRequest request) {
    var emptyResponse = DecryptResponse();
    return _client.invoke<DecryptResponse>(
        ctx, 'KeyManagementService', 'Decrypt', request, emptyResponse);
  }

  $async.Future<AsymmetricSignResponse> asymmetricSign(
      $pb.ClientContext ctx, AsymmetricSignRequest request) {
    var emptyResponse = AsymmetricSignResponse();
    return _client.invoke<AsymmetricSignResponse>(
        ctx, 'KeyManagementService', 'AsymmetricSign', request, emptyResponse);
  }

  $async.Future<AsymmetricDecryptResponse> asymmetricDecrypt(
      $pb.ClientContext ctx, AsymmetricDecryptRequest request) {
    var emptyResponse = AsymmetricDecryptResponse();
    return _client.invoke<AsymmetricDecryptResponse>(ctx,
        'KeyManagementService', 'AsymmetricDecrypt', request, emptyResponse);
  }

  $async.Future<$0.CryptoKey> updateCryptoKeyPrimaryVersion(
      $pb.ClientContext ctx, UpdateCryptoKeyPrimaryVersionRequest request) {
    var emptyResponse = $0.CryptoKey();
    return _client.invoke<$0.CryptoKey>(ctx, 'KeyManagementService',
        'UpdateCryptoKeyPrimaryVersion', request, emptyResponse);
  }

  $async.Future<$0.CryptoKeyVersion> destroyCryptoKeyVersion(
      $pb.ClientContext ctx, DestroyCryptoKeyVersionRequest request) {
    var emptyResponse = $0.CryptoKeyVersion();
    return _client.invoke<$0.CryptoKeyVersion>(ctx, 'KeyManagementService',
        'DestroyCryptoKeyVersion', request, emptyResponse);
  }

  $async.Future<$0.CryptoKeyVersion> restoreCryptoKeyVersion(
      $pb.ClientContext ctx, RestoreCryptoKeyVersionRequest request) {
    var emptyResponse = $0.CryptoKeyVersion();
    return _client.invoke<$0.CryptoKeyVersion>(ctx, 'KeyManagementService',
        'RestoreCryptoKeyVersion', request, emptyResponse);
  }
}
