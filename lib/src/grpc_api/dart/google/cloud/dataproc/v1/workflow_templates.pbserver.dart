...
abstract class WorkflowTemplateServiceBase extends $pb.GeneratedService {
  $async.Future<WorkflowTemplate> createWorkflowTemplate(
      $pb.ServerContext ctx, CreateWorkflowTemplateRequest request);
  $async.Future<WorkflowTemplate> getWorkflowTemplate(
      $pb.ServerContext ctx, GetWorkflowTemplateRequest request);
  $async.Future<$3.Operation> instantiateWorkflowTemplate(
      $pb.ServerContext ctx, InstantiateWorkflowTemplateRequest request);
  $async.Future<$3.Operation> instantiateInlineWorkflowTemplate(
      $pb.ServerContext ctx, InstantiateInlineWorkflowTemplateRequest request);
  $async.Future<WorkflowTemplate> updateWorkflowTemplate(
      $pb.ServerContext ctx, UpdateWorkflowTemplateRequest request);
  $async.Future<ListWorkflowTemplatesResponse> listWorkflowTemplates(
      $pb.ServerContext ctx, ListWorkflowTemplatesRequest request);
  $async.Future<$4.Empty> deleteWorkflowTemplate(
      $pb.ServerContext ctx, DeleteWorkflowTemplateRequest request);
  ...
  $async.Future<$pb.GeneratedMessage> handleCall($pb.ServerContext ctx,
    ...
    switch (method) {
      ...
      case 'InstantiateInlineWorkflowTemplate':
        return this.instantiateInlineWorkflowTemplate(ctx, request);
      case 'UpdateWorkflowTemplate':
  ...
  $core.Map<$core.String, $core.dynamic> get $json =>
      WorkflowTemplateServiceBase$json;
  $core.Map<$core.String, $core.Map<$core.String, $core.dynamic>>
      get $messageJson => WorkflowTemplateServiceBase$messageJson;
}
