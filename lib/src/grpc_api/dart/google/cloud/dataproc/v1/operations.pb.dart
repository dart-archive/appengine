...
class ClusterOperationStatus extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ClusterOperationStatus',
    ...
    ..aOS(2, 'innerState')
    ..aOS(3, 'details')
    ..a<$0.Timestamp>(4, 'stateStartTime', $pb.PbFieldType.OM,
...
class ClusterOperationMetadata extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ClusterOperationMetadata',
    ...
    ..aOS(7, 'clusterName')
    ..aOS(8, 'clusterUuid')
    ..a<ClusterOperationStatus>(9, 'status', $pb.PbFieldType.OM,
        ClusterOperationStatus.getDefault, ClusterOperationStatus.create)
    ..pc<ClusterOperationStatus>(
        10, 'statusHistory', $pb.PbFieldType.PM, ClusterOperationStatus.create)
    ..aOS(11, 'operationType')
    ..aOS(12, 'description')
    ..m<$core.String, $core.String>(
        13,
        'labels',
        'ClusterOperationMetadata.LabelsEntry',
        $pb.PbFieldType.OS,
        $pb.PbFieldType.OS,
        null,
        null,
