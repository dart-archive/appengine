...
class ClusterOperationStatus_State extends $pb.ProtobufEnum {
  static const ClusterOperationStatus_State UNKNOWN = ClusterOperationStatus_State._(0, 'UNKNOWN');
  static const ClusterOperationStatus_State PENDING = ClusterOperationStatus_State._(1, 'PENDING');
  static const ClusterOperationStatus_State RUNNING = ClusterOperationStatus_State._(2, 'RUNNING');
  static const ClusterOperationStatus_State DONE = ClusterOperationStatus_State._(3, 'DONE');
