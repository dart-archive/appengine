...
class LoggingConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('LoggingConfig', package: const $pb.PackageName('google.cloud.dataproc.v1beta2'))
    ..m<$core.String, LoggingConfig_Level>(2, 'driverLogLevels', 'LoggingConfig.DriverLogLevelsEntry',$pb.PbFieldType.OS, $pb.PbFieldType.OE, null, LoggingConfig_Level.valueOf, LoggingConfig_Level.values , const $pb.PackageName('google.cloud.dataproc.v1beta2'))
    ..hasRequiredFields = false
  ;

  LoggingConfig() : super();
  LoggingConfig.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  LoggingConfig.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
...
class HadoopJob extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('HadoopJob', package: const $pb.PackageName('google.cloud.dataproc.v1beta2'))
    ...
    ..pPS(5, 'fileUris')
    ..pPS(6, 'archiveUris')
    ..m<$core.String, $core.String>(7, 'properties', 'HadoopJob.PropertiesEntry',$pb.PbFieldType.OS, $pb.PbFieldType.OS, null, null, null , const $pb.PackageName('google.cloud.dataproc.v1beta2'))
    ..a<LoggingConfig>(8, 'loggingConfig', $pb.PbFieldType.OM, LoggingConfig.getDefault, LoggingConfig.create)
    ..oo(0, [1, 2])
    ..hasRequiredFields = false
  ;

  HadoopJob() : super();
  HadoopJob.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  HadoopJob.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  HadoopJob clone() => HadoopJob()..mergeFromMessage(this);
  HadoopJob copyWith(void Function(HadoopJob) updates) => super.copyWith((message) => updates(message as HadoopJob));
  $pb.BuilderInfo get info_ => _i;
...
class SparkJob extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('SparkJob', package: const $pb.PackageName('google.cloud.dataproc.v1beta2'))
    ..aOS(1, 'mainJarFileUri')
    ..aOS(2, 'mainClass')
    ..pPS(3, 'args')
    ..pPS(4, 'jarFileUris')
    ..pPS(5, 'fileUris')
    ..pPS(6, 'archiveUris')
    ..m<$core.String, $core.String>(7, 'properties', 'SparkJob.PropertiesEntry',$pb.PbFieldType.OS, $pb.PbFieldType.OS, null, null, null , const $pb.PackageName('google.cloud.dataproc.v1beta2'))
    ..a<LoggingConfig>(8, 'loggingConfig', $pb.PbFieldType.OM, LoggingConfig.getDefault, LoggingConfig.create)
    ..oo(0, [1, 2])
    ..hasRequiredFields = false
  ;
  ...
  SparkJob() : super();
  SparkJob.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  SparkJob.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  SparkJob clone() => SparkJob()..mergeFromMessage(this);
  SparkJob copyWith(void Function(SparkJob) updates) => super.copyWith((message) => updates(message as SparkJob));
  $pb.BuilderInfo get info_ => _i;
...
class PySparkJob extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('PySparkJob', package: const $pb.PackageName('google.cloud.dataproc.v1beta2'))
    ...
    ..pPS(5, 'fileUris')
    ..pPS(6, 'archiveUris')
    ..m<$core.String, $core.String>(7, 'properties', 'PySparkJob.PropertiesEntry',$pb.PbFieldType.OS, $pb.PbFieldType.OS, null, null, null , const $pb.PackageName('google.cloud.dataproc.v1beta2'))
    ..a<LoggingConfig>(8, 'loggingConfig', $pb.PbFieldType.OM, LoggingConfig.getDefault, LoggingConfig.create)
    ..hasRequiredFields = false
  ;

  PySparkJob() : super();
  PySparkJob.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  PySparkJob.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  PySparkJob clone() => PySparkJob()..mergeFromMessage(this);
  PySparkJob copyWith(void Function(PySparkJob) updates) => super.copyWith((message) => updates(message as PySparkJob));
  $pb.BuilderInfo get info_ => _i;
...
class QueryList extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('QueryList', package: const $pb.PackageName('google.cloud.dataproc.v1beta2'))
    ..pPS(1, 'queries')
    ..hasRequiredFields = false
  ;

  QueryList() : super();
  QueryList.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  QueryList.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  QueryList clone() => QueryList()..mergeFromMessage(this);
  QueryList copyWith(void Function(QueryList) updates) => super.copyWith((message) => updates(message as QueryList));
  $pb.BuilderInfo get info_ => _i;
...
class HiveJob extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('HiveJob', package: const $pb.PackageName('google.cloud.dataproc.v1beta2'))
    ..aOS(1, 'queryFileUri')
    ..a<QueryList>(2, 'queryList', $pb.PbFieldType.OM, QueryList.getDefault, QueryList.create)
    ..aOB(3, 'continueOnFailure')
    ..m<$core.String, $core.String>(4, 'scriptVariables', 'HiveJob.ScriptVariablesEntry',$pb.PbFieldType.OS, $pb.PbFieldType.OS, null, null, null , const $pb.PackageName('google.cloud.dataproc.v1beta2'))
    ..m<$core.String, $core.String>(5, 'properties', 'HiveJob.PropertiesEntry',$pb.PbFieldType.OS, $pb.PbFieldType.OS, null, null, null , const $pb.PackageName('google.cloud.dataproc.v1beta2'))
    ..pPS(6, 'jarFileUris')
    ..oo(0, [1, 2])
    ..hasRequiredFields = false
  ;
  ...
  HiveJob() : super();
  HiveJob.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  HiveJob.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  HiveJob clone() => HiveJob()..mergeFromMessage(this);
  HiveJob copyWith(void Function(HiveJob) updates) => super.copyWith((message) => updates(message as HiveJob));
  $pb.BuilderInfo get info_ => _i;
...
class SparkSqlJob extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('SparkSqlJob', package: const $pb.PackageName('google.cloud.dataproc.v1beta2'))
    ..aOS(1, 'queryFileUri')
    ..a<QueryList>(2, 'queryList', $pb.PbFieldType.OM, QueryList.getDefault, QueryList.create)
    ..m<$core.String, $core.String>(3, 'scriptVariables', 'SparkSqlJob.ScriptVariablesEntry',$pb.PbFieldType.OS, $pb.PbFieldType.OS, null, null, null , const $pb.PackageName('google.cloud.dataproc.v1beta2'))
    ..m<$core.String, $core.String>(4, 'properties', 'SparkSqlJob.PropertiesEntry',$pb.PbFieldType.OS, $pb.PbFieldType.OS, null, null, null , const $pb.PackageName('google.cloud.dataproc.v1beta2'))
    ..a<LoggingConfig>(6, 'loggingConfig', $pb.PbFieldType.OM, LoggingConfig.getDefault, LoggingConfig.create)
    ..pPS(56, 'jarFileUris')
    ..oo(0, [1, 2])
    ..hasRequiredFields = false
  ;
  ...
  SparkSqlJob() : super();
  SparkSqlJob.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  SparkSqlJob.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  SparkSqlJob clone() => SparkSqlJob()..mergeFromMessage(this);
  SparkSqlJob copyWith(void Function(SparkSqlJob) updates) => super.copyWith((message) => updates(message as SparkSqlJob));
  $pb.BuilderInfo get info_ => _i;
...
class PigJob extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('PigJob', package: const $pb.PackageName('google.cloud.dataproc.v1beta2'))
    ..aOS(1, 'queryFileUri')
    ..a<QueryList>(2, 'queryList', $pb.PbFieldType.OM, QueryList.getDefault, QueryList.create)
    ..aOB(3, 'continueOnFailure')
    ..m<$core.String, $core.String>(4, 'scriptVariables', 'PigJob.ScriptVariablesEntry',$pb.PbFieldType.OS, $pb.PbFieldType.OS, null, null, null , const $pb.PackageName('google.cloud.dataproc.v1beta2'))
    ..m<$core.String, $core.String>(5, 'properties', 'PigJob.PropertiesEntry',$pb.PbFieldType.OS, $pb.PbFieldType.OS, null, null, null , const $pb.PackageName('google.cloud.dataproc.v1beta2'))
    ..pPS(6, 'jarFileUris')
    ..a<LoggingConfig>(7, 'loggingConfig', $pb.PbFieldType.OM, LoggingConfig.getDefault, LoggingConfig.create)
    ..oo(0, [1, 2])
    ..hasRequiredFields = false
  ;

  PigJob() : super();
  PigJob.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  PigJob.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  PigJob clone() => PigJob()..mergeFromMessage(this);
  PigJob copyWith(void Function(PigJob) updates) => super.copyWith((message) => updates(message as PigJob));
  $pb.BuilderInfo get info_ => _i;
...
class SparkRJob extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('SparkRJob', package: const $pb.PackageName('google.cloud.dataproc.v1beta2'))
    ..aOS(1, 'mainRFileUri')
    ..pPS(2, 'args')
    ..pPS(3, 'fileUris')
    ..pPS(4, 'archiveUris')
    ..m<$core.String, $core.String>(5, 'properties', 'SparkRJob.PropertiesEntry',$pb.PbFieldType.OS, $pb.PbFieldType.OS, null, null, null , const $pb.PackageName('google.cloud.dataproc.v1beta2'))
    ..a<LoggingConfig>(6, 'loggingConfig', $pb.PbFieldType.OM, LoggingConfig.getDefault, LoggingConfig.create)
    ..hasRequiredFields = false
  ;

  SparkRJob() : super();
  SparkRJob.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  SparkRJob.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  SparkRJob clone() => SparkRJob()..mergeFromMessage(this);
  SparkRJob copyWith(void Function(SparkRJob) updates) => super.copyWith((message) => updates(message as SparkRJob));
  $pb.BuilderInfo get info_ => _i;
...
class JobPlacement extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('JobPlacement', package: const $pb.PackageName('google.cloud.dataproc.v1beta2'))
    ..aOS(1, 'clusterName')
    ..aOS(2, 'clusterUuid')
    ..hasRequiredFields = false
  ;
  ...
  JobPlacement() : super();
  JobPlacement.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  JobPlacement.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  JobPlacement clone() => JobPlacement()..mergeFromMessage(this);
  JobPlacement copyWith(void Function(JobPlacement) updates) => super.copyWith((message) => updates(message as JobPlacement));
  $pb.BuilderInfo get info_ => _i;
...
class JobStatus extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('JobStatus', package: const $pb.PackageName('google.cloud.dataproc.v1beta2'))
    ..e<JobStatus_State>(1, 'state', $pb.PbFieldType.OE, JobStatus_State.STATE_UNSPECIFIED, JobStatus_State.valueOf, JobStatus_State.values)
    ..aOS(2, 'details')
    ..a<$0.Timestamp>(6, 'stateStartTime', $pb.PbFieldType.OM, $0.Timestamp.getDefault, $0.Timestamp.create)
    ..e<JobStatus_Substate>(7, 'substate', $pb.PbFieldType.OE, JobStatus_Substate.UNSPECIFIED, JobStatus_Substate.valueOf, JobStatus_Substate.values)
    ..hasRequiredFields = false
  ;
  ...
  set stateStartTime($0.Timestamp v) { setField(6, v); }
...
class JobReference extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('JobReference', package: const $pb.PackageName('google.cloud.dataproc.v1beta2'))
    ..aOS(1, 'projectId')
    ..aOS(2, 'jobId')
    ..hasRequiredFields = false
  ;
  ...
  JobReference() : super();
  JobReference.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  JobReference.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  JobReference clone() => JobReference()..mergeFromMessage(this);
  JobReference copyWith(void Function(JobReference) updates) => super.copyWith((message) => updates(message as JobReference));
  $pb.BuilderInfo get info_ => _i;
...
class YarnApplication extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('YarnApplication', package: const $pb.PackageName('google.cloud.dataproc.v1beta2'))
    ..aOS(1, 'name')
    ..e<YarnApplication_State>(2, 'state', $pb.PbFieldType.OE, YarnApplication_State.STATE_UNSPECIFIED, YarnApplication_State.valueOf, YarnApplication_State.values)
  ...
  YarnApplication.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  YarnApplication.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  YarnApplication clone() => YarnApplication()..mergeFromMessage(this);
  YarnApplication copyWith(void Function(YarnApplication) updates) => super.copyWith((message) => updates(message as YarnApplication));
  $pb.BuilderInfo get info_ => _i;
  ...
  static YarnApplication getDefault() => _defaultInstance ??= create()..freeze();
...
class Job extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Job', package: const $pb.PackageName('google.cloud.dataproc.v1beta2'))
    ..a<JobReference>(1, 'reference', $pb.PbFieldType.OM, JobReference.getDefault, JobReference.create)
    ..a<JobPlacement>(2, 'placement', $pb.PbFieldType.OM, JobPlacement.getDefault, JobPlacement.create)
    ..a<HadoopJob>(3, 'hadoopJob', $pb.PbFieldType.OM, HadoopJob.getDefault, HadoopJob.create)
    ..a<SparkJob>(4, 'sparkJob', $pb.PbFieldType.OM, SparkJob.getDefault, SparkJob.create)
    ..a<PySparkJob>(5, 'pysparkJob', $pb.PbFieldType.OM, PySparkJob.getDefault, PySparkJob.create)
    ..a<HiveJob>(6, 'hiveJob', $pb.PbFieldType.OM, HiveJob.getDefault, HiveJob.create)
    ..a<PigJob>(7, 'pigJob', $pb.PbFieldType.OM, PigJob.getDefault, PigJob.create)
    ..a<JobStatus>(8, 'status', $pb.PbFieldType.OM, JobStatus.getDefault, JobStatus.create)
    ..pc<YarnApplication>(9, 'yarnApplications', $pb.PbFieldType.PM,YarnApplication.create)
    ..aOS(10, 'submittedBy')
    ..a<SparkSqlJob>(12, 'sparkSqlJob', $pb.PbFieldType.OM, SparkSqlJob.getDefault, SparkSqlJob.create)
    ...
    ..m<$core.String, $core.String>(18, 'labels', 'Job.LabelsEntry',$pb.PbFieldType.OS, $pb.PbFieldType.OS, null, null, null , const $pb.PackageName('google.cloud.dataproc.v1beta2'))
    ..a<JobScheduling>(20, 'scheduling', $pb.PbFieldType.OM, JobScheduling.getDefault, JobScheduling.create)
    ..a<SparkRJob>(21, 'sparkRJob', $pb.PbFieldType.OM, SparkRJob.getDefault, SparkRJob.create)
    ..aOS(22, 'jobUuid')
  ...
  set submittedBy($core.String v) { $_setString(9, v); }
  ...
  set driverControlFilesUri($core.String v) { $_setString(12, v); }
  ...
  set driverOutputResourceUri($core.String v) { $_setString(13, v); }
  ...
  set jobUuid($core.String v) { $_setString(17, v); }
  $core.bool hasJobUuid() => $_has(17);
  void clearJobUuid() => clearField(22);
}

class JobScheduling extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('JobScheduling', package: const $pb.PackageName('google.cloud.dataproc.v1beta2'))
    ..a<$core.int>(1, 'maxFailuresPerHour', $pb.PbFieldType.O3)
    ..hasRequiredFields = false
  ;

  JobScheduling() : super();
  JobScheduling.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  JobScheduling.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  JobScheduling clone() => JobScheduling()..mergeFromMessage(this);
  JobScheduling copyWith(void Function(JobScheduling) updates) => super.copyWith((message) => updates(message as JobScheduling));
  $pb.BuilderInfo get info_ => _i;
...
class SubmitJobRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('SubmitJobRequest', package: const $pb.PackageName('google.cloud.dataproc.v1beta2'))
    ..aOS(1, 'projectId')
...
class GetJobRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('GetJobRequest', package: const $pb.PackageName('google.cloud.dataproc.v1beta2'))
    ..aOS(1, 'projectId')
    ..aOS(2, 'jobId')
    ..aOS(3, 'region')
    ..hasRequiredFields = false
  ...
  GetJobRequest() : super();
  GetJobRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  GetJobRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  GetJobRequest clone() => GetJobRequest()..mergeFromMessage(this);
  GetJobRequest copyWith(void Function(GetJobRequest) updates) => super.copyWith((message) => updates(message as GetJobRequest));
  $pb.BuilderInfo get info_ => _i;
...
class ListJobsRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ListJobsRequest', package: const $pb.PackageName('google.cloud.dataproc.v1beta2'))
    ..aOS(1, 'projectId')
    ..a<$core.int>(2, 'pageSize', $pb.PbFieldType.O3)
    ..aOS(3, 'pageToken')
    ..aOS(4, 'clusterName')
    ..e<ListJobsRequest_JobStateMatcher>(5, 'jobStateMatcher', $pb.PbFieldType.OE, ListJobsRequest_JobStateMatcher.ALL, ListJobsRequest_JobStateMatcher.valueOf, ListJobsRequest_JobStateMatcher.values)
    ..aOS(6, 'region')
    ..aOS(7, 'filter')
    ..hasRequiredFields = false
  ;
...
class UpdateJobRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('UpdateJobRequest', package: const $pb.PackageName('google.cloud.dataproc.v1beta2'))
    ..aOS(1, 'projectId')
    ..aOS(2, 'region')
    ..aOS(3, 'jobId')
  ...
  UpdateJobRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  UpdateJobRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  UpdateJobRequest clone() => UpdateJobRequest()..mergeFromMessage(this);
  UpdateJobRequest copyWith(void Function(UpdateJobRequest) updates) => super.copyWith((message) => updates(message as UpdateJobRequest));
  $pb.BuilderInfo get info_ => _i;
  ...
  static UpdateJobRequest getDefault() => _defaultInstance ??= create()..freeze();
...
class ListJobsResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ListJobsResponse', package: const $pb.PackageName('google.cloud.dataproc.v1beta2'))
...
class CancelJobRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('CancelJobRequest', package: const $pb.PackageName('google.cloud.dataproc.v1beta2'))
    ..aOS(1, 'projectId')
    ..aOS(2, 'jobId')
    ..aOS(3, 'region')
    ..hasRequiredFields = false
  ...
  CancelJobRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  CancelJobRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  CancelJobRequest clone() => CancelJobRequest()..mergeFromMessage(this);
  CancelJobRequest copyWith(void Function(CancelJobRequest) updates) => super.copyWith((message) => updates(message as CancelJobRequest));
  $pb.BuilderInfo get info_ => _i;
  ...
  static CancelJobRequest getDefault() => _defaultInstance ??= create()..freeze();
...
class DeleteJobRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('DeleteJobRequest', package: const $pb.PackageName('google.cloud.dataproc.v1beta2'))
    ..aOS(1, 'projectId')
    ..aOS(2, 'jobId')
    ..aOS(3, 'region')
    ..hasRequiredFields = false
...
class JobControllerApi {
  ...
  $async.Future<Job> submitJob($pb.ClientContext ctx, SubmitJobRequest request) {
  ...
  $async.Future<Job> updateJob($pb.ClientContext ctx, UpdateJobRequest request) {
    var emptyResponse = Job();
    return _client.invoke<Job>(ctx, 'JobController', 'UpdateJob', request, emptyResponse);
  }
  $async.Future<Job> cancelJob($pb.ClientContext ctx, CancelJobRequest request) {
    var emptyResponse = Job();
    return _client.invoke<Job>(ctx, 'JobController', 'CancelJob', request, emptyResponse);
  }
  $async.Future<$2.Empty> deleteJob($pb.ClientContext ctx, DeleteJobRequest request) {
    var emptyResponse = $2.Empty();
    return _client.invoke<$2.Empty>(ctx, 'JobController', 'DeleteJob', request, emptyResponse);
  }
}
