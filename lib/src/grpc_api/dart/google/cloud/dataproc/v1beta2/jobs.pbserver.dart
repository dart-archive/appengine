...
abstract class JobControllerServiceBase extends $pb.GeneratedService {
  ...
  $pb.GeneratedMessage createRequest($core.String method) {
    switch (method) {
      ...
      case 'CancelJob': return CancelJobRequest();
  ...
  $core.Map<$core.String, $core.dynamic> get $json => JobControllerServiceBase$json;
  $core.Map<$core.String, $core.Map<$core.String, $core.dynamic>> get $messageJson => JobControllerServiceBase$messageJson;
}
