...
class ClusterStatus_State extends $pb.ProtobufEnum {
  static const ClusterStatus_State UNKNOWN = ClusterStatus_State._(0, 'UNKNOWN');
  static const ClusterStatus_State CREATING = ClusterStatus_State._(1, 'CREATING');
  static const ClusterStatus_State RUNNING = ClusterStatus_State._(2, 'RUNNING');
  static const ClusterStatus_State ERROR = ClusterStatus_State._(3, 'ERROR');
  static const ClusterStatus_State DELETING = ClusterStatus_State._(4, 'DELETING');
  static const ClusterStatus_State UPDATING = ClusterStatus_State._(5, 'UPDATING');
...
class ClusterStatus_Substate extends $pb.ProtobufEnum {
  static const ClusterStatus_Substate UNSPECIFIED = ClusterStatus_Substate._(0, 'UNSPECIFIED');
  static const ClusterStatus_Substate UNHEALTHY = ClusterStatus_Substate._(1, 'UNHEALTHY');
  static const ClusterStatus_Substate STALE_STATUS = ClusterStatus_Substate._(2, 'STALE_STATUS');
...
class ReservationAffinity_Type extends $pb.ProtobufEnum {
  static const ReservationAffinity_Type TYPE_UNSPECIFIED = ReservationAffinity_Type._(0, 'TYPE_UNSPECIFIED');
  static const ReservationAffinity_Type NO_RESERVATION = ReservationAffinity_Type._(1, 'NO_RESERVATION');
  static const ReservationAffinity_Type ANY_RESERVATION = ReservationAffinity_Type._(2, 'ANY_RESERVATION');
  static const ReservationAffinity_Type SPECIFIC_RESERVATION = ReservationAffinity_Type._(3, 'SPECIFIC_RESERVATION');
