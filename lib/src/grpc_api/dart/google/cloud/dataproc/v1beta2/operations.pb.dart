...
class ClusterOperationStatus extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('ClusterOperationStatus')
    ..e<ClusterOperationStatus_State>(1, 'state', PbFieldType.OE, ClusterOperationStatus_State.UNKNOWN, ClusterOperationStatus_State.valueOf, ClusterOperationStatus_State.values)
    ..aOS(2, 'innerState')
    ..aOS(3, 'details')
  ...
  set innerState(String v) { $_setString(1, v); }
  ...
  set stateStartTime($google$protobuf.Timestamp v) { setField(4, v); }
...
class ClusterOperationMetadata_LabelsEntry extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('ClusterOperationMetadata_LabelsEntry')
    ..aOS(1, 'key')
    ..aOS(2, 'value')
    ..hasRequiredFields = false
  ;
  ...
  ClusterOperationMetadata_LabelsEntry.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  ClusterOperationMetadata_LabelsEntry.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ClusterOperationMetadata_LabelsEntry clone() => new ClusterOperationMetadata_LabelsEntry()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static ClusterOperationMetadata_LabelsEntry create() => new ClusterOperationMetadata_LabelsEntry();
  static PbList<ClusterOperationMetadata_LabelsEntry> createRepeated() => new PbList<ClusterOperationMetadata_LabelsEntry>();
  static ClusterOperationMetadata_LabelsEntry getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyClusterOperationMetadata_LabelsEntry();
    return _defaultInstance;
  }
  static ClusterOperationMetadata_LabelsEntry _defaultInstance;
  static void $checkItem(ClusterOperationMetadata_LabelsEntry v) {
    if (v is! ClusterOperationMetadata_LabelsEntry) checkItemFailed(v, 'ClusterOperationMetadata_LabelsEntry');
  }
...
class _ReadonlyClusterOperationMetadata_LabelsEntry extends ClusterOperationMetadata_LabelsEntry with ReadonlyMessageMixin {}
...
class ClusterOperationMetadata extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('ClusterOperationMetadata')
    ...
    ..aOS(12, 'description')
    ..pp<ClusterOperationMetadata_LabelsEntry>(13, 'labels', PbFieldType.PM, ClusterOperationMetadata_LabelsEntry.$checkItem, ClusterOperationMetadata_LabelsEntry.create)
    ..pPS(14, 'warnings')
    ..hasRequiredFields = false
  ;
  ...
  set operationType(String v) { $_setString(4, v); }
