...
class JobStatus_State extends ProtobufEnum {
  ...
  static const JobStatus_State ATTEMPT_FAILURE = const JobStatus_State._(9, 'ATTEMPT_FAILURE');
...
class JobStatus_Substate extends ProtobufEnum {
  static const JobStatus_Substate UNSPECIFIED = const JobStatus_Substate._(0, 'UNSPECIFIED');
  static const JobStatus_Substate SUBMITTED = const JobStatus_Substate._(1, 'SUBMITTED');
  static const JobStatus_Substate QUEUED = const JobStatus_Substate._(2, 'QUEUED');
  static const JobStatus_Substate STALE_STATUS = const JobStatus_Substate._(3, 'STALE_STATUS');
  ...
  static final Map<int, dynamic> _byValue = ProtobufEnum.initByValue(values);
  static JobStatus_Substate valueOf(int value) => _byValue[value] as JobStatus_Substate;
...
class YarnApplication_State extends ProtobufEnum {
  static const YarnApplication_State STATE_UNSPECIFIED = const YarnApplication_State._(0, 'STATE_UNSPECIFIED');
  static const YarnApplication_State NEW = const YarnApplication_State._(1, 'NEW');
  static const YarnApplication_State NEW_SAVING = const YarnApplication_State._(2, 'NEW_SAVING');
  static const YarnApplication_State SUBMITTED = const YarnApplication_State._(3, 'SUBMITTED');
  static const YarnApplication_State ACCEPTED = const YarnApplication_State._(4, 'ACCEPTED');
  static const YarnApplication_State RUNNING = const YarnApplication_State._(5, 'RUNNING');
  static const YarnApplication_State FINISHED = const YarnApplication_State._(6, 'FINISHED');
  static const YarnApplication_State FAILED = const YarnApplication_State._(7, 'FAILED');
  static const YarnApplication_State KILLED = const YarnApplication_State._(8, 'KILLED');

  static const List<YarnApplication_State> values = const <YarnApplication_State> [
    STATE_UNSPECIFIED,
    NEW,
    NEW_SAVING,
    SUBMITTED,
  ...
  static final Map<int, dynamic> _byValue = ProtobufEnum.initByValue(values);
  static YarnApplication_State valueOf(int value) => _byValue[value] as YarnApplication_State;
  static void $checkItem(YarnApplication_State v) {
    if (v is! YarnApplication_State) checkItemFailed(v, 'YarnApplication_State');
  }
