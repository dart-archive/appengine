...
const ClusterOperationStatus$json = const {
  ...
  '2': const [
    const {'1': 'state', '3': 1, '4': 1, '5': 14, '6': '.google.cloud.dataproc.v1beta2.ClusterOperationStatus.State', '10': 'state'},
    const {'1': 'inner_state', '3': 2, '4': 1, '5': 9, '10': 'innerState'},
    const {'1': 'details', '3': 3, '4': 1, '5': 9, '10': 'details'},
    const {'1': 'state_start_time', '3': 4, '4': 1, '5': 11, '6': '.google.protobuf.Timestamp', '10': 'stateStartTime'},
  ],
...
const ClusterOperationMetadata$json = const {
  ...
  '2': const [
    ...
    const {'1': 'status', '3': 9, '4': 1, '5': 11, '6': '.google.cloud.dataproc.v1beta2.ClusterOperationStatus', '10': 'status'},
    const {'1': 'status_history', '3': 10, '4': 3, '5': 11, '6': '.google.cloud.dataproc.v1beta2.ClusterOperationStatus', '10': 'statusHistory'},
    const {'1': 'operation_type', '3': 11, '4': 1, '5': 9, '10': 'operationType'},
    const {'1': 'description', '3': 12, '4': 1, '5': 9, '10': 'description'},
    const {'1': 'labels', '3': 13, '4': 3, '5': 11, '6': '.google.cloud.dataproc.v1beta2.ClusterOperationMetadata.LabelsEntry', '10': 'labels'},
