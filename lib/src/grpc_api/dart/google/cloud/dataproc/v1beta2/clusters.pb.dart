...
class Cluster_LabelsEntry extends GeneratedMessage {
  ...
  Cluster_LabelsEntry.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  Cluster_LabelsEntry.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  Cluster_LabelsEntry clone() => new Cluster_LabelsEntry()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static Cluster_LabelsEntry create() => new Cluster_LabelsEntry();
  static PbList<Cluster_LabelsEntry> createRepeated() => new PbList<Cluster_LabelsEntry>();
  static Cluster_LabelsEntry getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyCluster_LabelsEntry();
...
class _ReadonlyCluster_LabelsEntry extends Cluster_LabelsEntry with ReadonlyMessageMixin {}
...
class Cluster extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('Cluster')
    ...
    ..pp<Cluster_LabelsEntry>(8, 'labels', PbFieldType.PM, Cluster_LabelsEntry.$checkItem, Cluster_LabelsEntry.create)
    ..a<ClusterMetrics>(9, 'metrics', PbFieldType.OM, ClusterMetrics.getDefault, ClusterMetrics.create)
    ..hasRequiredFields = false
  ;
  ...
  set clusterName(String v) { $_setString(1, v); }
  ...
  set clusterUuid(String v) { $_setString(4, v); }
...
class ClusterConfig extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('ClusterConfig')
    ...
    ..a<LifecycleConfig>(14, 'lifecycleConfig', PbFieldType.OM, LifecycleConfig.getDefault, LifecycleConfig.create)
    ..hasRequiredFields = false
  ;
  ...
  set configBucket(String v) { $_setString(0, v); }
  ...
  bool hasLifecycleConfig() => $_has(7);
...
class InstanceGroupConfig extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('InstanceGroupConfig')
    ...
    ..pp<AcceleratorConfig>(8, 'accelerators', PbFieldType.PM, AcceleratorConfig.$checkItem, AcceleratorConfig.create)
    ..hasRequiredFields = false
  ;
  ...
  set numInstances(int v) { $_setSignedInt32(0, v); }
  ...
  set machineTypeUri(String v) { $_setString(3, v); }
  ...
  set isPreemptible(bool v) { $_setBool(5, v); }
...
class ManagedGroupConfig extends GeneratedMessage {
  ...
  set instanceTemplateName(String v) { $_setString(0, v); }
  ...
  set instanceGroupManagerName(String v) { $_setString(1, v); }
...
class LifecycleConfig extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('LifecycleConfig')
    ..a<$google$protobuf.Duration>(1, 'idleDeleteTtl', PbFieldType.OM, $google$protobuf.Duration.getDefault, $google$protobuf.Duration.create)
    ..a<$google$protobuf.Timestamp>(2, 'autoDeleteTime', PbFieldType.OM, $google$protobuf.Timestamp.getDefault, $google$protobuf.Timestamp.create)
    ..a<$google$protobuf.Duration>(3, 'autoDeleteTtl', PbFieldType.OM, $google$protobuf.Duration.getDefault, $google$protobuf.Duration.create)
    ..hasRequiredFields = false
  ;

  LifecycleConfig() : super();
  LifecycleConfig.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  LifecycleConfig.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  LifecycleConfig clone() => new LifecycleConfig()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static LifecycleConfig create() => new LifecycleConfig();
  static PbList<LifecycleConfig> createRepeated() => new PbList<LifecycleConfig>();
  static LifecycleConfig getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyLifecycleConfig();
    return _defaultInstance;
  }
  static LifecycleConfig _defaultInstance;
  static void $checkItem(LifecycleConfig v) {
    if (v is! LifecycleConfig) checkItemFailed(v, 'LifecycleConfig');
  }

  $google$protobuf.Duration get idleDeleteTtl => $_getN(0);
  set idleDeleteTtl($google$protobuf.Duration v) { setField(1, v); }
  bool hasIdleDeleteTtl() => $_has(0);
  void clearIdleDeleteTtl() => clearField(1);

  $google$protobuf.Timestamp get autoDeleteTime => $_getN(1);
  set autoDeleteTime($google$protobuf.Timestamp v) { setField(2, v); }
  bool hasAutoDeleteTime() => $_has(1);
  void clearAutoDeleteTime() => clearField(2);

  $google$protobuf.Duration get autoDeleteTtl => $_getN(2);
  set autoDeleteTtl($google$protobuf.Duration v) { setField(3, v); }
  bool hasAutoDeleteTtl() => $_has(2);
  void clearAutoDeleteTtl() => clearField(3);
}

class _ReadonlyLifecycleConfig extends LifecycleConfig with ReadonlyMessageMixin {}
...
class ClusterStatus extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('ClusterStatus')
    ..e<ClusterStatus_State>(1, 'state', PbFieldType.OE, ClusterStatus_State.UNKNOWN, ClusterStatus_State.valueOf, ClusterStatus_State.values)
    ..aOS(2, 'detail')
    ...
    ..e<ClusterStatus_Substate>(4, 'substate', PbFieldType.OE, ClusterStatus_Substate.UNSPECIFIED, ClusterStatus_Substate.valueOf, ClusterStatus_Substate.values)
    ..hasRequiredFields = false
  ;
  ...
  set stateStartTime($google$protobuf.Timestamp v) { setField(3, v); }
...
class SoftwareConfig extends GeneratedMessage {
  ...
  set imageVersion(String v) { $_setString(0, v); }
...
class ClusterMetrics_HdfsMetricsEntry extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('ClusterMetrics_HdfsMetricsEntry')
    ..aOS(1, 'key')
    ..aInt64(2, 'value')
    ..hasRequiredFields = false
  ;
  ...
  ClusterMetrics_HdfsMetricsEntry.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  ClusterMetrics_HdfsMetricsEntry.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ClusterMetrics_HdfsMetricsEntry clone() => new ClusterMetrics_HdfsMetricsEntry()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static ClusterMetrics_HdfsMetricsEntry create() => new ClusterMetrics_HdfsMetricsEntry();
  static PbList<ClusterMetrics_HdfsMetricsEntry> createRepeated() => new PbList<ClusterMetrics_HdfsMetricsEntry>();
  static ClusterMetrics_HdfsMetricsEntry getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyClusterMetrics_HdfsMetricsEntry();
    return _defaultInstance;
  }
  static ClusterMetrics_HdfsMetricsEntry _defaultInstance;
  static void $checkItem(ClusterMetrics_HdfsMetricsEntry v) {
    if (v is! ClusterMetrics_HdfsMetricsEntry) checkItemFailed(v, 'ClusterMetrics_HdfsMetricsEntry');
  }
...
class _ReadonlyClusterMetrics_HdfsMetricsEntry extends ClusterMetrics_HdfsMetricsEntry with ReadonlyMessageMixin {}

class ClusterMetrics_YarnMetricsEntry extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('ClusterMetrics_YarnMetricsEntry')
    ..aOS(1, 'key')
    ..aInt64(2, 'value')
    ..hasRequiredFields = false
  ;
  ...
  ClusterMetrics_YarnMetricsEntry.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  ClusterMetrics_YarnMetricsEntry.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ClusterMetrics_YarnMetricsEntry clone() => new ClusterMetrics_YarnMetricsEntry()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static ClusterMetrics_YarnMetricsEntry create() => new ClusterMetrics_YarnMetricsEntry();
  static PbList<ClusterMetrics_YarnMetricsEntry> createRepeated() => new PbList<ClusterMetrics_YarnMetricsEntry>();
  static ClusterMetrics_YarnMetricsEntry getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyClusterMetrics_YarnMetricsEntry();
    return _defaultInstance;
  }
  static ClusterMetrics_YarnMetricsEntry _defaultInstance;
  static void $checkItem(ClusterMetrics_YarnMetricsEntry v) {
    if (v is! ClusterMetrics_YarnMetricsEntry) checkItemFailed(v, 'ClusterMetrics_YarnMetricsEntry');
  }
...
class _ReadonlyClusterMetrics_YarnMetricsEntry extends ClusterMetrics_YarnMetricsEntry with ReadonlyMessageMixin {}

class ClusterMetrics extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('ClusterMetrics')
    ..pp<ClusterMetrics_HdfsMetricsEntry>(1, 'hdfsMetrics', PbFieldType.PM, ClusterMetrics_HdfsMetricsEntry.$checkItem, ClusterMetrics_HdfsMetricsEntry.create)
    ..pp<ClusterMetrics_YarnMetricsEntry>(2, 'yarnMetrics', PbFieldType.PM, ClusterMetrics_YarnMetricsEntry.$checkItem, ClusterMetrics_YarnMetricsEntry.create)
    ..hasRequiredFields = false
  ;

  ClusterMetrics() : super();
  ClusterMetrics.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  ClusterMetrics.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ClusterMetrics clone() => new ClusterMetrics()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static ClusterMetrics create() => new ClusterMetrics();
  static PbList<ClusterMetrics> createRepeated() => new PbList<ClusterMetrics>();
  static ClusterMetrics getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyClusterMetrics();
    return _defaultInstance;
  }
...
class UpdateClusterRequest extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('UpdateClusterRequest')
    ...
    ..aOS(5, 'region')
    ..a<$google$protobuf.Duration>(6, 'gracefulDecommissionTimeout', PbFieldType.OM, $google$protobuf.Duration.getDefault, $google$protobuf.Duration.create)
    ..hasRequiredFields = false
  ;
  ...
  set region(String v) { $_setString(4, v); }
  bool hasRegion() => $_has(4);
  void clearRegion() => clearField(5);

  $google$protobuf.Duration get gracefulDecommissionTimeout => $_getN(5);
  set gracefulDecommissionTimeout($google$protobuf.Duration v) { setField(6, v); }
  bool hasGracefulDecommissionTimeout() => $_has(5);
...
class DeleteClusterRequest extends GeneratedMessage {
  ...
  String get clusterUuid => $_getS(3, '');
  set clusterUuid(String v) { $_setString(3, v); }
  bool hasClusterUuid() => $_has(3);
...
class ListClustersRequest extends GeneratedMessage {
  ...
  set region(String v) { $_setString(3, v); }
...
class DiagnoseClusterResults extends GeneratedMessage {
  ...
  set outputUri(String v) { $_setString(0, v); }
...
class ClusterControllerApi {
  ...
  Future<$google$longrunning.Operation> createCluster(ClientContext ctx, CreateClusterRequest request) {
    ...
    return _client.invoke<$google$longrunning.Operation>(ctx, 'ClusterController', 'CreateCluster', request, emptyResponse);
  }
  Future<$google$longrunning.Operation> updateCluster(ClientContext ctx, UpdateClusterRequest request) {
    var emptyResponse = new $google$longrunning.Operation();
    return _client.invoke<$google$longrunning.Operation>(ctx, 'ClusterController', 'UpdateCluster', request, emptyResponse);
  }
  Future<$google$longrunning.Operation> deleteCluster(ClientContext ctx, DeleteClusterRequest request) {
    var emptyResponse = new $google$longrunning.Operation();
    return _client.invoke<$google$longrunning.Operation>(ctx, 'ClusterController', 'DeleteCluster', request, emptyResponse);
  }
  ...
  Future<$google$longrunning.Operation> diagnoseCluster(ClientContext ctx, DiagnoseClusterRequest request) {
    var emptyResponse = new $google$longrunning.Operation();
    return _client.invoke<$google$longrunning.Operation>(ctx, 'ClusterController', 'DiagnoseCluster', request, emptyResponse);
  }
}
