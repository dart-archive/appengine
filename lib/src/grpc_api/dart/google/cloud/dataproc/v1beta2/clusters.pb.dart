...
import 'shared.pbenum.dart' as $4;

export 'clusters.pbenum.dart';

class Cluster extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Cluster', package: const $pb.PackageName('google.cloud.dataproc.v1beta2'))
    ..aOS(1, 'projectId')
    ..aOS(2, 'clusterName')
    ..a<ClusterConfig>(3, 'config', $pb.PbFieldType.OM, ClusterConfig.getDefault, ClusterConfig.create)
    ..a<ClusterStatus>(4, 'status', $pb.PbFieldType.OM, ClusterStatus.getDefault, ClusterStatus.create)
    ..aOS(6, 'clusterUuid')
    ..pc<ClusterStatus>(7, 'statusHistory', $pb.PbFieldType.PM,ClusterStatus.create)
    ..m<$core.String, $core.String>(8, 'labels', 'Cluster.LabelsEntry',$pb.PbFieldType.OS, $pb.PbFieldType.OS, null, null, null , const $pb.PackageName('google.cloud.dataproc.v1beta2'))
    ..a<ClusterMetrics>(9, 'metrics', $pb.PbFieldType.OM, ClusterMetrics.getDefault, ClusterMetrics.create)
...
class ClusterConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ClusterConfig', package: const $pb.PackageName('google.cloud.dataproc.v1beta2'))
    ..aOS(1, 'configBucket')
    ..a<GceClusterConfig>(8, 'gceClusterConfig', $pb.PbFieldType.OM, GceClusterConfig.getDefault, GceClusterConfig.create)
    ..a<InstanceGroupConfig>(9, 'masterConfig', $pb.PbFieldType.OM, InstanceGroupConfig.getDefault, InstanceGroupConfig.create)
    ..a<InstanceGroupConfig>(10, 'workerConfig', $pb.PbFieldType.OM, InstanceGroupConfig.getDefault, InstanceGroupConfig.create)
    ..pc<NodeInitializationAction>(11, 'initializationActions', $pb.PbFieldType.PM,NodeInitializationAction.create)
    ..a<InstanceGroupConfig>(12, 'secondaryWorkerConfig', $pb.PbFieldType.OM, InstanceGroupConfig.getDefault, InstanceGroupConfig.create)
    ..a<SoftwareConfig>(13, 'softwareConfig', $pb.PbFieldType.OM, SoftwareConfig.getDefault, SoftwareConfig.create)
    ..a<LifecycleConfig>(14, 'lifecycleConfig', $pb.PbFieldType.OM, LifecycleConfig.getDefault, LifecycleConfig.create)
    ..a<EncryptionConfig>(15, 'encryptionConfig', $pb.PbFieldType.OM, EncryptionConfig.getDefault, EncryptionConfig.create)
    ..a<AutoscalingConfig>(16, 'autoscalingConfig', $pb.PbFieldType.OM, AutoscalingConfig.getDefault, AutoscalingConfig.create)
    ..a<EndpointConfig>(17, 'endpointConfig', $pb.PbFieldType.OM, EndpointConfig.getDefault, EndpointConfig.create)
    ..a<SecurityConfig>(18, 'securityConfig', $pb.PbFieldType.OM, SecurityConfig.getDefault, SecurityConfig.create)
    ..hasRequiredFields = false
  ;

  ClusterConfig() : super();
  ClusterConfig.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  ClusterConfig.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ClusterConfig clone() => ClusterConfig()..mergeFromMessage(this);
  ClusterConfig copyWith(void Function(ClusterConfig) updates) => super.copyWith((message) => updates(message as ClusterConfig));
  $pb.BuilderInfo get info_ => _i;
  ...
  $core.List<NodeInitializationAction> get initializationActions => $_getList(4);
  ...
  set lifecycleConfig(LifecycleConfig v) { setField(14, v); }
...
class EndpointConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('EndpointConfig', package: const $pb.PackageName('google.cloud.dataproc.v1beta2'))
    ..m<$core.String, $core.String>(1, 'httpPorts', 'EndpointConfig.HttpPortsEntry',$pb.PbFieldType.OS, $pb.PbFieldType.OS, null, null, null , const $pb.PackageName('google.cloud.dataproc.v1beta2'))
    ..aOB(2, 'enableHttpPortAccess')
    ..hasRequiredFields = false
  ;

  EndpointConfig() : super();
  EndpointConfig.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  EndpointConfig.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  EndpointConfig clone() => EndpointConfig()..mergeFromMessage(this);
  EndpointConfig copyWith(void Function(EndpointConfig) updates) => super.copyWith((message) => updates(message as EndpointConfig));
  $pb.BuilderInfo get info_ => _i;
...
class AutoscalingConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('AutoscalingConfig', package: const $pb.PackageName('google.cloud.dataproc.v1beta2'))
    ..aOS(1, 'policyUri')
    ..hasRequiredFields = false
  ;

  AutoscalingConfig() : super();
  AutoscalingConfig.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  AutoscalingConfig.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  AutoscalingConfig clone() => AutoscalingConfig()..mergeFromMessage(this);
  AutoscalingConfig copyWith(void Function(AutoscalingConfig) updates) => super.copyWith((message) => updates(message as AutoscalingConfig));
  $pb.BuilderInfo get info_ => _i;
  ...
  static AutoscalingConfig getDefault() => _defaultInstance ??= create()..freeze();
...
class EncryptionConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('EncryptionConfig', package: const $pb.PackageName('google.cloud.dataproc.v1beta2'))
    ..aOS(1, 'gcePdKmsKeyName')
    ..hasRequiredFields = false
  ;

  EncryptionConfig() : super();
  EncryptionConfig.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  EncryptionConfig.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  EncryptionConfig clone() => EncryptionConfig()..mergeFromMessage(this);
  EncryptionConfig copyWith(void Function(EncryptionConfig) updates) => super.copyWith((message) => updates(message as EncryptionConfig));
  $pb.BuilderInfo get info_ => _i;
  ...
  static EncryptionConfig getDefault() => _defaultInstance ??= create()..freeze();
...
class GceClusterConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('GceClusterConfig', package: const $pb.PackageName('google.cloud.dataproc.v1beta2'))
    ..aOS(1, 'zoneUri')
    ..aOS(2, 'networkUri')
    ..pPS(3, 'serviceAccountScopes')
    ..pPS(4, 'tags')
    ..m<$core.String, $core.String>(5, 'metadata', 'GceClusterConfig.MetadataEntry',$pb.PbFieldType.OS, $pb.PbFieldType.OS, null, null, null , const $pb.PackageName('google.cloud.dataproc.v1beta2'))
    ..aOS(6, 'subnetworkUri')
    ..aOB(7, 'internalIpOnly')
    ..aOS(8, 'serviceAccount')
    ..a<ReservationAffinity>(11, 'reservationAffinity', $pb.PbFieldType.OM, ReservationAffinity.getDefault, ReservationAffinity.create)
    ..hasRequiredFields = false
  ;

  GceClusterConfig() : super();
  GceClusterConfig.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  GceClusterConfig.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  GceClusterConfig clone() => GceClusterConfig()..mergeFromMessage(this);
  GceClusterConfig copyWith(void Function(GceClusterConfig) updates) => super.copyWith((message) => updates(message as GceClusterConfig));
  $pb.BuilderInfo get info_ => _i;
  ...
  static GceClusterConfig getDefault() => _defaultInstance ??= create()..freeze();
...
class InstanceGroupConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('InstanceGroupConfig', package: const $pb.PackageName('google.cloud.dataproc.v1beta2'))
    ..a<$core.int>(1, 'numInstances', $pb.PbFieldType.O3)
    ..pPS(2, 'instanceNames')
    ..aOS(3, 'imageUri')
    ..aOS(4, 'machineTypeUri')
    ..a<DiskConfig>(5, 'diskConfig', $pb.PbFieldType.OM, DiskConfig.getDefault, DiskConfig.create)
    ..aOB(6, 'isPreemptible')
    ..a<ManagedGroupConfig>(7, 'managedGroupConfig', $pb.PbFieldType.OM, ManagedGroupConfig.getDefault, ManagedGroupConfig.create)
    ..pc<AcceleratorConfig>(8, 'accelerators', $pb.PbFieldType.PM,AcceleratorConfig.create)
    ..aOS(9, 'minCpuPlatform')
    ..hasRequiredFields = false
  ;

  InstanceGroupConfig() : super();
  InstanceGroupConfig.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  InstanceGroupConfig.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  InstanceGroupConfig clone() => InstanceGroupConfig()..mergeFromMessage(this);
  InstanceGroupConfig copyWith(void Function(InstanceGroupConfig) updates) => super.copyWith((message) => updates(message as InstanceGroupConfig));
  $pb.BuilderInfo get info_ => _i;
  ...
  static InstanceGroupConfig getDefault() => _defaultInstance ??= create()..freeze();
...
class ManagedGroupConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ManagedGroupConfig', package: const $pb.PackageName('google.cloud.dataproc.v1beta2'))
  ...
  ManagedGroupConfig.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  ManagedGroupConfig.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ManagedGroupConfig clone() => ManagedGroupConfig()..mergeFromMessage(this);
  ManagedGroupConfig copyWith(void Function(ManagedGroupConfig) updates) => super.copyWith((message) => updates(message as ManagedGroupConfig));
  $pb.BuilderInfo get info_ => _i;
  ...
  static ManagedGroupConfig getDefault() => _defaultInstance ??= create()..freeze();
...
class AcceleratorConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('AcceleratorConfig', package: const $pb.PackageName('google.cloud.dataproc.v1beta2'))
...
class DiskConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('DiskConfig', package: const $pb.PackageName('google.cloud.dataproc.v1beta2'))
  ...
  DiskConfig() : super();
  DiskConfig.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  DiskConfig.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  DiskConfig clone() => DiskConfig()..mergeFromMessage(this);
  DiskConfig copyWith(void Function(DiskConfig) updates) => super.copyWith((message) => updates(message as DiskConfig));
  $pb.BuilderInfo get info_ => _i;
...
class LifecycleConfig extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('LifecycleConfig', package: const $pb.PackageName('google.cloud.dataproc.v1beta2'))
    ..a<$0.Duration>(1, 'idleDeleteTtl', $pb.PbFieldType.OM, $0.Duration.getDefault, $0.Duration.create)
    ..a<$1.Timestamp>(2, 'autoDeleteTime', $pb.PbFieldType.OM, $1.Timestamp.getDefault, $1.Timestamp.create)
    ..a<$0.Duration>(3, 'autoDeleteTtl', $pb.PbFieldType.OM, $0.Duration.getDefault, $0.Duration.create)
    ..oo(0, [2, 3])
    ..hasRequiredFields = false
  ;

  LifecycleConfig() : super();
  LifecycleConfig.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  LifecycleConfig.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  LifecycleConfig clone() => LifecycleConfig()..mergeFromMessage(this);
  LifecycleConfig copyWith(void Function(LifecycleConfig) updates) => super.copyWith((message) => updates(message as LifecycleConfig));
  $pb.BuilderInfo get info_ => _i;
  ...
  static LifecycleConfig getDefault() => _defaultInstance ??= create()..freeze();
  ...
  $0.Duration get idleDeleteTtl => $_getN(0);
  set idleDeleteTtl($0.Duration v) { setField(1, v); }
  $core.bool hasIdleDeleteTtl() => $_has(0);
  void clearIdleDeleteTtl() => clearField(1);

  $1.Timestamp get autoDeleteTime => $_getN(1);
  set autoDeleteTime($1.Timestamp v) { setField(2, v); }
  $core.bool hasAutoDeleteTime() => $_has(1);
  void clearAutoDeleteTime() => clearField(2);

  $0.Duration get autoDeleteTtl => $_getN(2);
  set autoDeleteTtl($0.Duration v) { setField(3, v); }
  $core.bool hasAutoDeleteTtl() => $_has(2);
  void clearAutoDeleteTtl() => clearField(3);
}

class SecurityConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('SecurityConfig', package: const $pb.PackageName('google.cloud.dataproc.v1beta2'))
    ..a<KerberosConfig>(1, 'kerberosConfig', $pb.PbFieldType.OM, KerberosConfig.getDefault, KerberosConfig.create)
    ..hasRequiredFields = false
  ;
...
class KerberosConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('KerberosConfig', package: const $pb.PackageName('google.cloud.dataproc.v1beta2'))
  ...
  KerberosConfig.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  KerberosConfig.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  KerberosConfig clone() => KerberosConfig()..mergeFromMessage(this);
  KerberosConfig copyWith(void Function(KerberosConfig) updates) => super.copyWith((message) => updates(message as KerberosConfig));
  $pb.BuilderInfo get info_ => _i;
...
class NodeInitializationAction extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('NodeInitializationAction', package: const $pb.PackageName('google.cloud.dataproc.v1beta2'))
    ..aOS(1, 'executableFile')
    ..a<$0.Duration>(2, 'executionTimeout', $pb.PbFieldType.OM, $0.Duration.getDefault, $0.Duration.create)
    ..hasRequiredFields = false
  ;

  NodeInitializationAction() : super();
  NodeInitializationAction.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  NodeInitializationAction.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  NodeInitializationAction clone() => NodeInitializationAction()..mergeFromMessage(this);
  NodeInitializationAction copyWith(void Function(NodeInitializationAction) updates) => super.copyWith((message) => updates(message as NodeInitializationAction));
  $pb.BuilderInfo get info_ => _i;
  ...
  static NodeInitializationAction getDefault() => _defaultInstance ??= create()..freeze();
  ...
  set executionTimeout($0.Duration v) { setField(2, v); }
...
class ClusterStatus extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ClusterStatus', package: const $pb.PackageName('google.cloud.dataproc.v1beta2'))
    ..e<ClusterStatus_State>(1, 'state', $pb.PbFieldType.OE, ClusterStatus_State.UNKNOWN, ClusterStatus_State.valueOf, ClusterStatus_State.values)
    ..aOS(2, 'detail')
    ..a<$1.Timestamp>(3, 'stateStartTime', $pb.PbFieldType.OM, $1.Timestamp.getDefault, $1.Timestamp.create)
    ..e<ClusterStatus_Substate>(4, 'substate', $pb.PbFieldType.OE, ClusterStatus_Substate.UNSPECIFIED, ClusterStatus_Substate.valueOf, ClusterStatus_Substate.values)
    ..hasRequiredFields = false
  ;

  ClusterStatus() : super();
  ClusterStatus.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  ClusterStatus.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ClusterStatus clone() => ClusterStatus()..mergeFromMessage(this);
  ClusterStatus copyWith(void Function(ClusterStatus) updates) => super.copyWith((message) => updates(message as ClusterStatus));
  $pb.BuilderInfo get info_ => _i;
  ...
  set stateStartTime($1.Timestamp v) { setField(3, v); }
...
class SoftwareConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('SoftwareConfig', package: const $pb.PackageName('google.cloud.dataproc.v1beta2'))
    ..aOS(1, 'imageVersion')
    ..m<$core.String, $core.String>(2, 'properties', 'SoftwareConfig.PropertiesEntry',$pb.PbFieldType.OS, $pb.PbFieldType.OS, null, null, null , const $pb.PackageName('google.cloud.dataproc.v1beta2'))
    ..pc<$4.Component>(3, 'optionalComponents', $pb.PbFieldType.PE, null, $4.Component.valueOf, $4.Component.values)
    ..hasRequiredFields = false
  ;

  SoftwareConfig() : super();
  SoftwareConfig.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  SoftwareConfig.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  SoftwareConfig clone() => SoftwareConfig()..mergeFromMessage(this);
  SoftwareConfig copyWith(void Function(SoftwareConfig) updates) => super.copyWith((message) => updates(message as SoftwareConfig));
  $pb.BuilderInfo get info_ => _i;
  ...
  $core.List<$4.Component> get optionalComponents => $_getList(2);
}

class ClusterMetrics extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ClusterMetrics', package: const $pb.PackageName('google.cloud.dataproc.v1beta2'))
    ..m<$core.String, Int64>(1, 'hdfsMetrics', 'ClusterMetrics.HdfsMetricsEntry',$pb.PbFieldType.OS, $pb.PbFieldType.O6, null, null, null , const $pb.PackageName('google.cloud.dataproc.v1beta2'))
    ..m<$core.String, Int64>(2, 'yarnMetrics', 'ClusterMetrics.YarnMetricsEntry',$pb.PbFieldType.OS, $pb.PbFieldType.O6, null, null, null , const $pb.PackageName('google.cloud.dataproc.v1beta2'))
    ..hasRequiredFields = false
  ;

  ClusterMetrics() : super();
  ClusterMetrics.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  ClusterMetrics.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ClusterMetrics clone() => ClusterMetrics()..mergeFromMessage(this);
  ClusterMetrics copyWith(void Function(ClusterMetrics) updates) => super.copyWith((message) => updates(message as ClusterMetrics));
  $pb.BuilderInfo get info_ => _i;
...
class CreateClusterRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('CreateClusterRequest', package: const $pb.PackageName('google.cloud.dataproc.v1beta2'))
    ..aOS(1, 'projectId')
    ..a<Cluster>(2, 'cluster', $pb.PbFieldType.OM, Cluster.getDefault, Cluster.create)
    ..aOS(3, 'region')
    ..aOS(4, 'requestId')
    ..hasRequiredFields = false
  ;
...
class UpdateClusterRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('UpdateClusterRequest', package: const $pb.PackageName('google.cloud.dataproc.v1beta2'))
    ..aOS(1, 'projectId')
    ..aOS(2, 'clusterName')
    ...
    ..aOS(5, 'region')
    ..a<$0.Duration>(6, 'gracefulDecommissionTimeout', $pb.PbFieldType.OM, $0.Duration.getDefault, $0.Duration.create)
    ..aOS(7, 'requestId')
    ..hasRequiredFields = false
  ;
  ...
  set gracefulDecommissionTimeout($0.Duration v) { setField(6, v); }
...
class DeleteClusterRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('DeleteClusterRequest', package: const $pb.PackageName('google.cloud.dataproc.v1beta2'))
    ..aOS(1, 'projectId')
    ..aOS(2, 'clusterName')
    ..aOS(3, 'region')
    ..aOS(4, 'clusterUuid')
...
class GetClusterRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('GetClusterRequest', package: const $pb.PackageName('google.cloud.dataproc.v1beta2'))
    ..aOS(1, 'projectId')
    ..aOS(2, 'clusterName')
    ..aOS(3, 'region')
    ..hasRequiredFields = false
...
class ListClustersRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ListClustersRequest', package: const $pb.PackageName('google.cloud.dataproc.v1beta2'))
    ..aOS(1, 'projectId')
...
class ListClustersResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ListClustersResponse', package: const $pb.PackageName('google.cloud.dataproc.v1beta2'))
...
class DiagnoseClusterRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('DiagnoseClusterRequest', package: const $pb.PackageName('google.cloud.dataproc.v1beta2'))
    ..aOS(1, 'projectId')
    ..aOS(2, 'clusterName')
    ..aOS(3, 'region')
    ..hasRequiredFields = false
  ...
  DiagnoseClusterRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  DiagnoseClusterRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  DiagnoseClusterRequest clone() => DiagnoseClusterRequest()..mergeFromMessage(this);
  DiagnoseClusterRequest copyWith(void Function(DiagnoseClusterRequest) updates) => super.copyWith((message) => updates(message as DiagnoseClusterRequest));
  $pb.BuilderInfo get info_ => _i;
  ...
  static DiagnoseClusterRequest getDefault() => _defaultInstance ??= create()..freeze();
...
class DiagnoseClusterResults extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('DiagnoseClusterResults', package: const $pb.PackageName('google.cloud.dataproc.v1beta2'))
    ..aOS(1, 'outputUri')
    ..hasRequiredFields = false
  ;

  DiagnoseClusterResults() : super();
  DiagnoseClusterResults.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  DiagnoseClusterResults.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  DiagnoseClusterResults clone() => DiagnoseClusterResults()..mergeFromMessage(this);
  DiagnoseClusterResults copyWith(void Function(DiagnoseClusterResults) updates) => super.copyWith((message) => updates(message as DiagnoseClusterResults));
  $pb.BuilderInfo get info_ => _i;
  ...
  static DiagnoseClusterResults getDefault() => _defaultInstance ??= create()..freeze();
...
class ReservationAffinity extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ReservationAffinity', package: const $pb.PackageName('google.cloud.dataproc.v1beta2'))
    ..e<ReservationAffinity_Type>(1, 'consumeReservationType', $pb.PbFieldType.OE, ReservationAffinity_Type.TYPE_UNSPECIFIED, ReservationAffinity_Type.valueOf, ReservationAffinity_Type.values)
    ..aOS(2, 'key')
    ..pPS(3, 'values')
    ..hasRequiredFields = false
  ;
  ...
  ReservationAffinity.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  ReservationAffinity.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ReservationAffinity clone() => ReservationAffinity()..mergeFromMessage(this);
  ReservationAffinity copyWith(void Function(ReservationAffinity) updates) => super.copyWith((message) => updates(message as ReservationAffinity));
  $pb.BuilderInfo get info_ => _i;
  ...
  static ReservationAffinity getDefault() => _defaultInstance ??= create()..freeze();
...
class ClusterControllerApi {
  ...
  $async.Future<$3.Operation> createCluster($pb.ClientContext ctx, CreateClusterRequest request) {
    ...
    return _client.invoke<$3.Operation>(ctx, 'ClusterController', 'CreateCluster', request, emptyResponse);
  }
  $async.Future<$3.Operation> updateCluster($pb.ClientContext ctx, UpdateClusterRequest request) {
    var emptyResponse = $3.Operation();
    return _client.invoke<$3.Operation>(ctx, 'ClusterController', 'UpdateCluster', request, emptyResponse);
  }
  $async.Future<$3.Operation> deleteCluster($pb.ClientContext ctx, DeleteClusterRequest request) {
    var emptyResponse = $3.Operation();
    return _client.invoke<$3.Operation>(ctx, 'ClusterController', 'DeleteCluster', request, emptyResponse);
  }
  $async.Future<Cluster> getCluster($pb.ClientContext ctx, GetClusterRequest request) {
    var emptyResponse = Cluster();
    return _client.invoke<Cluster>(ctx, 'ClusterController', 'GetCluster', request, emptyResponse);
  }
  $async.Future<ListClustersResponse> listClusters($pb.ClientContext ctx, ListClustersRequest request) {
    ...
    return _client.invoke<ListClustersResponse>(ctx, 'ClusterController', 'ListClusters', request, emptyResponse);
  }
  $async.Future<$3.Operation> diagnoseCluster($pb.ClientContext ctx, DiagnoseClusterRequest request) {
    var emptyResponse = $3.Operation();
    return _client.invoke<$3.Operation>(ctx, 'ClusterController', 'DiagnoseCluster', request, emptyResponse);
  }
}
