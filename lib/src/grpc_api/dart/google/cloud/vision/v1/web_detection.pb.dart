...
class WebDetection_WebEntity extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('WebDetection.WebEntity', package: const $pb.PackageName('google.cloud.vision.v1'))
    ..aOS(1, 'entityId')
...
class WebDetection_WebImage extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('WebDetection.WebImage', package: const $pb.PackageName('google.cloud.vision.v1'))
    ..aOS(1, 'url')
    ..a<$core.double>(2, 'score', $pb.PbFieldType.OF)
    ..hasRequiredFields = false
  ;
...
class WebDetection_WebLabel extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('WebDetection.WebLabel', package: const $pb.PackageName('google.cloud.vision.v1'))
    ..aOS(1, 'label')
    ..aOS(2, 'languageCode')
    ..hasRequiredFields = false
  ;
...
class WebDetection_WebPage extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('WebDetection.WebPage', package: const $pb.PackageName('google.cloud.vision.v1'))
    ..aOS(1, 'url')
    ..a<$core.double>(2, 'score', $pb.PbFieldType.OF)
    ..aOS(3, 'pageTitle')
...
class WebDetection extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('WebDetection', package: const $pb.PackageName('google.cloud.vision.v1'))
