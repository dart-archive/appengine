...
const BatchAnnotateFilesRequest$json = const {
  ...
  '2': const [
    const {'1': 'requests', '3': 1, '4': 3, '5': 11, '6': '.google.cloud.vision.v1.AnnotateFileRequest', '10': 'requests'},
  ],
};
...
const AsyncBatchAnnotateImagesRequest$json = const {
  ...
  '2': const [
    const {'1': 'requests', '3': 1, '4': 3, '5': 11, '6': '.google.cloud.vision.v1.AnnotateImageRequest', '10': 'requests'},
    const {'1': 'output_config', '3': 2, '4': 1, '5': 11, '6': '.google.cloud.vision.v1.OutputConfig', '10': 'outputConfig'},
  ],
};
...
const ImageAnnotatorServiceBase$json = const {
  ...
  '2': const [
    ...
    const {'1': 'BatchAnnotateFiles', '2': '.google.cloud.vision.v1.BatchAnnotateFilesRequest', '3': '.google.cloud.vision.v1.BatchAnnotateFilesResponse', '4': const {}},
    const {'1': 'AsyncBatchAnnotateImages', '2': '.google.cloud.vision.v1.AsyncBatchAnnotateImagesRequest', '3': '.google.longrunning.Operation', '4': const {}},
...
const ImageAnnotatorServiceBase$messageJson = const {
  ...
  '.google.cloud.vision.v1.ProductSearchParams': $3.ProductSearchParams$json,
  '.google.cloud.vision.v1.BoundingPoly': $0.BoundingPoly$json,
  '.google.cloud.vision.v1.Vertex': $0.Vertex$json,
  '.google.cloud.vision.v1.NormalizedVertex': $0.NormalizedVertex$json,
  ...
  '.google.cloud.vision.v1.Position': $0.Position$json,
  ...
  '.google.cloud.vision.v1.TextAnnotation': $5.TextAnnotation$json,
  '.google.cloud.vision.v1.Page': $5.Page$json,
  '.google.cloud.vision.v1.TextAnnotation.TextProperty': $5.TextAnnotation_TextProperty$json,
  '.google.cloud.vision.v1.TextAnnotation.DetectedLanguage': $5.TextAnnotation_DetectedLanguage$json,
  '.google.cloud.vision.v1.TextAnnotation.DetectedBreak': $5.TextAnnotation_DetectedBreak$json,
  '.google.cloud.vision.v1.Block': $5.Block$json,
  '.google.cloud.vision.v1.Paragraph': $5.Paragraph$json,
  '.google.cloud.vision.v1.Word': $5.Word$json,
  '.google.cloud.vision.v1.Symbol': $5.Symbol$json,
  '.google.cloud.vision.v1.WebDetection': $6.WebDetection$json,
  '.google.cloud.vision.v1.WebDetection.WebEntity': $6.WebDetection_WebEntity$json,
  '.google.cloud.vision.v1.WebDetection.WebImage': $6.WebDetection_WebImage$json,
  '.google.cloud.vision.v1.WebDetection.WebPage': $6.WebDetection_WebPage$json,
  '.google.cloud.vision.v1.WebDetection.WebLabel': $6.WebDetection_WebLabel$json,
  '.google.cloud.vision.v1.ProductSearchResults': $3.ProductSearchResults$json,
  '.google.protobuf.Timestamp': $7.Timestamp$json,
  '.google.cloud.vision.v1.ProductSearchResults.Result': $3.ProductSearchResults_Result$json,
  '.google.cloud.vision.v1.Product': $11.Product$json,
  '.google.cloud.vision.v1.Product.KeyValue': $11.Product_KeyValue$json,
  '.google.cloud.vision.v1.ProductSearchResults.GroupedResult': $3.ProductSearchResults_GroupedResult$json,
  '.google.cloud.vision.v1.ImageAnnotationContext': ImageAnnotationContext$json,
  '.google.cloud.vision.v1.LocalizedObjectAnnotation': LocalizedObjectAnnotation$json,
  '.google.cloud.vision.v1.BatchAnnotateFilesRequest': BatchAnnotateFilesRequest$json,
  '.google.cloud.vision.v1.AnnotateFileRequest': AnnotateFileRequest$json,
  '.google.cloud.vision.v1.InputConfig': InputConfig$json,
  '.google.cloud.vision.v1.GcsSource': GcsSource$json,
  '.google.cloud.vision.v1.BatchAnnotateFilesResponse': BatchAnnotateFilesResponse$json,
  '.google.cloud.vision.v1.AnnotateFileResponse': AnnotateFileResponse$json,
  '.google.cloud.vision.v1.AsyncBatchAnnotateImagesRequest': AsyncBatchAnnotateImagesRequest$json,
