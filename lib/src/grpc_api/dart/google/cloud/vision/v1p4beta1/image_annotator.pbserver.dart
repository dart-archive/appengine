...
abstract class ImageAnnotatorServiceBase extends $pb.GeneratedService {
  ...
  $async.Future<BatchAnnotateFilesResponse> batchAnnotateFiles(
      $pb.ServerContext ctx, BatchAnnotateFilesRequest request);
  $async.Future<$8.Operation> asyncBatchAnnotateImages(
      $pb.ServerContext ctx, AsyncBatchAnnotateImagesRequest request);
  ...
  $async.Future<$pb.GeneratedMessage> handleCall($pb.ServerContext ctx,
    ...
    switch (method) {
      ...
      case 'BatchAnnotateFiles':
        return this.batchAnnotateFiles(ctx, request);
      case 'AsyncBatchAnnotateImages':
        return this.asyncBatchAnnotateImages(ctx, request);
      case 'AsyncBatchAnnotateFiles':
