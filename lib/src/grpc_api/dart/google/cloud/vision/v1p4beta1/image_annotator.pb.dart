...
import 'product_search.pb.dart' as $3;
...
class Feature extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Feature', package: const $pb.PackageName('google.cloud.vision.v1p4beta1'))
    ..e<Feature_Type>(1, 'type', $pb.PbFieldType.OE, Feature_Type.TYPE_UNSPECIFIED, Feature_Type.valueOf, Feature_Type.values)
...
class ImageSource extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ImageSource', package: const $pb.PackageName('google.cloud.vision.v1p4beta1'))
    ..aOS(1, 'gcsImageUri')
    ..aOS(2, 'imageUri')
    ..hasRequiredFields = false
  ;
  ...
  ImageSource() : super();
  ImageSource.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  ImageSource.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
...
class Image extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Image', package: const $pb.PackageName('google.cloud.vision.v1p4beta1'))
    ..a<$core.List<$core.int>>(1, 'content', $pb.PbFieldType.OY)
    ..a<ImageSource>(2, 'source', $pb.PbFieldType.OM, ImageSource.getDefault, ImageSource.create)
    ..hasRequiredFields = false
  ;
...
class FaceAnnotation_Landmark extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('FaceAnnotation.Landmark', package: const $pb.PackageName('google.cloud.vision.v1p4beta1'))
    ..e<FaceAnnotation_Landmark_Type>(3, 'type', $pb.PbFieldType.OE, FaceAnnotation_Landmark_Type.UNKNOWN_LANDMARK, FaceAnnotation_Landmark_Type.valueOf, FaceAnnotation_Landmark_Type.values)
    ..a<$0.Position>(4, 'position', $pb.PbFieldType.OM, $0.Position.getDefault, $0.Position.create)
    ..hasRequiredFields = false
  ;

  FaceAnnotation_Landmark() : super();
  FaceAnnotation_Landmark.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  FaceAnnotation_Landmark.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  FaceAnnotation_Landmark clone() => FaceAnnotation_Landmark()..mergeFromMessage(this);
  FaceAnnotation_Landmark copyWith(void Function(FaceAnnotation_Landmark) updates) => super.copyWith((message) => updates(message as FaceAnnotation_Landmark));
  $pb.BuilderInfo get info_ => _i;
  ...
  static FaceAnnotation_Landmark getDefault() => _defaultInstance ??= create()..freeze();
...
class FaceAnnotation extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('FaceAnnotation', package: const $pb.PackageName('google.cloud.vision.v1p4beta1'))
    ..a<$0.BoundingPoly>(1, 'boundingPoly', $pb.PbFieldType.OM, $0.BoundingPoly.getDefault, $0.BoundingPoly.create)
    ..a<$0.BoundingPoly>(2, 'fdBoundingPoly', $pb.PbFieldType.OM, $0.BoundingPoly.getDefault, $0.BoundingPoly.create)
    ..pc<FaceAnnotation_Landmark>(3, 'landmarks', $pb.PbFieldType.PM,FaceAnnotation_Landmark.create)
    ...
    ..e<Likelihood>(9, 'joyLikelihood', $pb.PbFieldType.OE, Likelihood.UNKNOWN, Likelihood.valueOf, Likelihood.values)
    ..e<Likelihood>(10, 'sorrowLikelihood', $pb.PbFieldType.OE, Likelihood.UNKNOWN, Likelihood.valueOf, Likelihood.values)
    ..e<Likelihood>(11, 'angerLikelihood', $pb.PbFieldType.OE, Likelihood.UNKNOWN, Likelihood.valueOf, Likelihood.values)
    ..e<Likelihood>(12, 'surpriseLikelihood', $pb.PbFieldType.OE, Likelihood.UNKNOWN, Likelihood.valueOf, Likelihood.values)
    ..e<Likelihood>(13, 'underExposedLikelihood', $pb.PbFieldType.OE, Likelihood.UNKNOWN, Likelihood.valueOf, Likelihood.values)
    ..e<Likelihood>(14, 'blurredLikelihood', $pb.PbFieldType.OE, Likelihood.UNKNOWN, Likelihood.valueOf, Likelihood.values)
    ..e<Likelihood>(15, 'headwearLikelihood', $pb.PbFieldType.OE, Likelihood.UNKNOWN, Likelihood.valueOf, Likelihood.values)
    ..hasRequiredFields = false
  ;
...
class LocationInfo extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('LocationInfo', package: const $pb.PackageName('google.cloud.vision.v1p4beta1'))
    ..a<$1.LatLng>(1, 'latLng', $pb.PbFieldType.OM, $1.LatLng.getDefault, $1.LatLng.create)
    ..hasRequiredFields = false
  ;
  ...
  set latLng($1.LatLng v) { setField(1, v); }
  $core.bool hasLatLng() => $_has(0);
  void clearLatLng() => clearField(1);
}

class Property extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Property', package: const $pb.PackageName('google.cloud.vision.v1p4beta1'))
    ..aOS(1, 'name')
    ..aOS(2, 'value')
...
class EntityAnnotation extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('EntityAnnotation', package: const $pb.PackageName('google.cloud.vision.v1p4beta1'))
    ..aOS(1, 'mid')
    ..aOS(2, 'locale')
    ..aOS(3, 'description')
    ...
    ..a<$0.BoundingPoly>(7, 'boundingPoly', $pb.PbFieldType.OM, $0.BoundingPoly.getDefault, $0.BoundingPoly.create)
  ...
  EntityAnnotation.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  EntityAnnotation.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  EntityAnnotation clone() => EntityAnnotation()..mergeFromMessage(this);
  EntityAnnotation copyWith(void Function(EntityAnnotation) updates) => super.copyWith((message) => updates(message as EntityAnnotation));
  $pb.BuilderInfo get info_ => _i;
  ...
  static EntityAnnotation getDefault() => _defaultInstance ??= create()..freeze();
  ...
  set boundingPoly($0.BoundingPoly v) { setField(7, v); }
...
class LocalizedObjectAnnotation extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('LocalizedObjectAnnotation', package: const $pb.PackageName('google.cloud.vision.v1p4beta1'))
    ..aOS(1, 'mid')
    ..aOS(2, 'languageCode')
    ..aOS(3, 'name')
    ..a<$core.double>(4, 'score', $pb.PbFieldType.OF)
    ..a<$0.BoundingPoly>(5, 'boundingPoly', $pb.PbFieldType.OM, $0.BoundingPoly.getDefault, $0.BoundingPoly.create)
    ..hasRequiredFields = false
  ;

  LocalizedObjectAnnotation() : super();
  LocalizedObjectAnnotation.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  LocalizedObjectAnnotation.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  LocalizedObjectAnnotation clone() => LocalizedObjectAnnotation()..mergeFromMessage(this);
  LocalizedObjectAnnotation copyWith(void Function(LocalizedObjectAnnotation) updates) => super.copyWith((message) => updates(message as LocalizedObjectAnnotation));
  $pb.BuilderInfo get info_ => _i;
  ...
  static LocalizedObjectAnnotation getDefault() => _defaultInstance ??= create()..freeze();
  ...
  $0.BoundingPoly get boundingPoly => $_getN(4);
  set boundingPoly($0.BoundingPoly v) { setField(5, v); }
...
class SafeSearchAnnotation extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('SafeSearchAnnotation', package: const $pb.PackageName('google.cloud.vision.v1p4beta1'))
    ..e<Likelihood>(1, 'adult', $pb.PbFieldType.OE, Likelihood.UNKNOWN, Likelihood.valueOf, Likelihood.values)
    ..e<Likelihood>(2, 'spoof', $pb.PbFieldType.OE, Likelihood.UNKNOWN, Likelihood.valueOf, Likelihood.values)
    ..e<Likelihood>(3, 'medical', $pb.PbFieldType.OE, Likelihood.UNKNOWN, Likelihood.valueOf, Likelihood.values)
    ..e<Likelihood>(4, 'violence', $pb.PbFieldType.OE, Likelihood.UNKNOWN, Likelihood.valueOf, Likelihood.values)
    ..e<Likelihood>(9, 'racy', $pb.PbFieldType.OE, Likelihood.UNKNOWN, Likelihood.valueOf, Likelihood.values)
    ..hasRequiredFields = false
  ;

  SafeSearchAnnotation() : super();
  SafeSearchAnnotation.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  SafeSearchAnnotation.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  SafeSearchAnnotation clone() => SafeSearchAnnotation()..mergeFromMessage(this);
  SafeSearchAnnotation copyWith(void Function(SafeSearchAnnotation) updates) => super.copyWith((message) => updates(message as SafeSearchAnnotation));
  $pb.BuilderInfo get info_ => _i;
  ...
  static SafeSearchAnnotation getDefault() => _defaultInstance ??= create()..freeze();
...
class LatLongRect extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('LatLongRect', package: const $pb.PackageName('google.cloud.vision.v1p4beta1'))
    ..a<$1.LatLng>(1, 'minLatLng', $pb.PbFieldType.OM, $1.LatLng.getDefault, $1.LatLng.create)
    ..a<$1.LatLng>(2, 'maxLatLng', $pb.PbFieldType.OM, $1.LatLng.getDefault, $1.LatLng.create)
    ..hasRequiredFields = false
  ;

  LatLongRect() : super();
  LatLongRect.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  LatLongRect.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  LatLongRect clone() => LatLongRect()..mergeFromMessage(this);
  LatLongRect copyWith(void Function(LatLongRect) updates) => super.copyWith((message) => updates(message as LatLongRect));
  $pb.BuilderInfo get info_ => _i;
  ...
  set minLatLng($1.LatLng v) { setField(1, v); }
  $core.bool hasMinLatLng() => $_has(0);
  void clearMinLatLng() => clearField(1);

  $1.LatLng get maxLatLng => $_getN(1);
  set maxLatLng($1.LatLng v) { setField(2, v); }
  $core.bool hasMaxLatLng() => $_has(1);
  void clearMaxLatLng() => clearField(2);
}

class ColorInfo extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ColorInfo', package: const $pb.PackageName('google.cloud.vision.v1p4beta1'))
    ..a<$2.Color>(1, 'color', $pb.PbFieldType.OM, $2.Color.getDefault, $2.Color.create)
  ...
  ColorInfo() : super();
  ColorInfo.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  ColorInfo.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ColorInfo clone() => ColorInfo()..mergeFromMessage(this);
  ColorInfo copyWith(void Function(ColorInfo) updates) => super.copyWith((message) => updates(message as ColorInfo));
  $pb.BuilderInfo get info_ => _i;
  ...
  set color($2.Color v) { setField(1, v); }
...
class DominantColorsAnnotation extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('DominantColorsAnnotation', package: const $pb.PackageName('google.cloud.vision.v1p4beta1'))
    ..pc<ColorInfo>(1, 'colors', $pb.PbFieldType.PM,ColorInfo.create)
    ..hasRequiredFields = false
  ;

  DominantColorsAnnotation() : super();
  DominantColorsAnnotation.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  DominantColorsAnnotation.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  DominantColorsAnnotation clone() => DominantColorsAnnotation()..mergeFromMessage(this);
  DominantColorsAnnotation copyWith(void Function(DominantColorsAnnotation) updates) => super.copyWith((message) => updates(message as DominantColorsAnnotation));
  $pb.BuilderInfo get info_ => _i;
  ...
  static DominantColorsAnnotation getDefault() => _defaultInstance ??= create()..freeze();
...
class ImageProperties extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ImageProperties', package: const $pb.PackageName('google.cloud.vision.v1p4beta1'))
    ..a<DominantColorsAnnotation>(1, 'dominantColors', $pb.PbFieldType.OM, DominantColorsAnnotation.getDefault, DominantColorsAnnotation.create)
    ..hasRequiredFields = false
  ;

  ImageProperties() : super();
  ImageProperties.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  ImageProperties.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ...
  static ImageProperties getDefault() => _defaultInstance ??= create()..freeze();
...
class CropHint extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('CropHint', package: const $pb.PackageName('google.cloud.vision.v1p4beta1'))
    ..a<$0.BoundingPoly>(1, 'boundingPoly', $pb.PbFieldType.OM, $0.BoundingPoly.getDefault, $0.BoundingPoly.create)
  ...
  CropHint() : super();
  CropHint.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  CropHint.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  CropHint clone() => CropHint()..mergeFromMessage(this);
  CropHint copyWith(void Function(CropHint) updates) => super.copyWith((message) => updates(message as CropHint));
  $pb.BuilderInfo get info_ => _i;
...
class CropHintsAnnotation extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('CropHintsAnnotation', package: const $pb.PackageName('google.cloud.vision.v1p4beta1'))
    ..pc<CropHint>(1, 'cropHints', $pb.PbFieldType.PM,CropHint.create)
    ..hasRequiredFields = false
  ;

  CropHintsAnnotation() : super();
  CropHintsAnnotation.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  CropHintsAnnotation.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  CropHintsAnnotation clone() => CropHintsAnnotation()..mergeFromMessage(this);
  CropHintsAnnotation copyWith(void Function(CropHintsAnnotation) updates) => super.copyWith((message) => updates(message as CropHintsAnnotation));
  $pb.BuilderInfo get info_ => _i;
  ...
  static CropHintsAnnotation getDefault() => _defaultInstance ??= create()..freeze();
...
class CropHintsParams extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('CropHintsParams', package: const $pb.PackageName('google.cloud.vision.v1p4beta1'))
    ..p<$core.double>(1, 'aspectRatios', $pb.PbFieldType.PF)
    ..hasRequiredFields = false
  ;

  CropHintsParams() : super();
  CropHintsParams.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  CropHintsParams.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  CropHintsParams clone() => CropHintsParams()..mergeFromMessage(this);
  CropHintsParams copyWith(void Function(CropHintsParams) updates) => super.copyWith((message) => updates(message as CropHintsParams));
  $pb.BuilderInfo get info_ => _i;
  ...
  static CropHintsParams getDefault() => _defaultInstance ??= create()..freeze();
...
class WebDetectionParams extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('WebDetectionParams', package: const $pb.PackageName('google.cloud.vision.v1p4beta1'))
    ..aOB(2, 'includeGeoResults')
    ..hasRequiredFields = false
  ;

  WebDetectionParams() : super();
  WebDetectionParams.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  WebDetectionParams.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  WebDetectionParams clone() => WebDetectionParams()..mergeFromMessage(this);
  WebDetectionParams copyWith(void Function(WebDetectionParams) updates) => super.copyWith((message) => updates(message as WebDetectionParams));
  $pb.BuilderInfo get info_ => _i;
  ...
  static WebDetectionParams getDefault() => _defaultInstance ??= create()..freeze();
...
class ImageContext extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ImageContext', package: const $pb.PackageName('google.cloud.vision.v1p4beta1'))
    ..a<LatLongRect>(1, 'latLongRect', $pb.PbFieldType.OM, LatLongRect.getDefault, LatLongRect.create)
    ..pPS(2, 'languageHints')
    ..a<CropHintsParams>(4, 'cropHintsParams', $pb.PbFieldType.OM, CropHintsParams.getDefault, CropHintsParams.create)
    ..a<$3.ProductSearchParams>(5, 'productSearchParams', $pb.PbFieldType.OM, $3.ProductSearchParams.getDefault, $3.ProductSearchParams.create)
    ..a<WebDetectionParams>(6, 'webDetectionParams', $pb.PbFieldType.OM, WebDetectionParams.getDefault, WebDetectionParams.create)
    ..hasRequiredFields = false
  ;

  ImageContext() : super();
  ImageContext.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  ImageContext.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ImageContext clone() => ImageContext()..mergeFromMessage(this);
  ImageContext copyWith(void Function(ImageContext) updates) => super.copyWith((message) => updates(message as ImageContext));
  $pb.BuilderInfo get info_ => _i;
  ...
  $3.ProductSearchParams get productSearchParams => $_getN(3);
  set productSearchParams($3.ProductSearchParams v) { setField(5, v); }
...
class AnnotateImageRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('AnnotateImageRequest', package: const $pb.PackageName('google.cloud.vision.v1p4beta1'))
    ..a<Image>(1, 'image', $pb.PbFieldType.OM, Image.getDefault, Image.create)
    ..pc<Feature>(2, 'features', $pb.PbFieldType.PM,Feature.create)
    ..a<ImageContext>(3, 'imageContext', $pb.PbFieldType.OM, ImageContext.getDefault, ImageContext.create)
    ..hasRequiredFields = false
  ;

  AnnotateImageRequest() : super();
  AnnotateImageRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  AnnotateImageRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  AnnotateImageRequest clone() => AnnotateImageRequest()..mergeFromMessage(this);
  AnnotateImageRequest copyWith(void Function(AnnotateImageRequest) updates) => super.copyWith((message) => updates(message as AnnotateImageRequest));
  $pb.BuilderInfo get info_ => _i;
  ...
  static AnnotateImageRequest getDefault() => _defaultInstance ??= create()..freeze();
...
class ImageAnnotationContext extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ImageAnnotationContext', package: const $pb.PackageName('google.cloud.vision.v1p4beta1'))
    ..aOS(1, 'uri')
  ...
  ImageAnnotationContext.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  ImageAnnotationContext.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ImageAnnotationContext clone() => ImageAnnotationContext()..mergeFromMessage(this);
  ImageAnnotationContext copyWith(void Function(ImageAnnotationContext) updates) => super.copyWith((message) => updates(message as ImageAnnotationContext));
  $pb.BuilderInfo get info_ => _i;
  ...
  static ImageAnnotationContext getDefault() => _defaultInstance ??= create()..freeze();
...
class AnnotateImageResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('AnnotateImageResponse', package: const $pb.PackageName('google.cloud.vision.v1p4beta1'))
    ..pc<FaceAnnotation>(1, 'faceAnnotations', $pb.PbFieldType.PM,FaceAnnotation.create)
    ..pc<EntityAnnotation>(2, 'landmarkAnnotations', $pb.PbFieldType.PM,EntityAnnotation.create)
    ..pc<EntityAnnotation>(3, 'logoAnnotations', $pb.PbFieldType.PM,EntityAnnotation.create)
    ..pc<EntityAnnotation>(4, 'labelAnnotations', $pb.PbFieldType.PM,EntityAnnotation.create)
    ..pc<EntityAnnotation>(5, 'textAnnotations', $pb.PbFieldType.PM,EntityAnnotation.create)
    ..a<SafeSearchAnnotation>(6, 'safeSearchAnnotation', $pb.PbFieldType.OM, SafeSearchAnnotation.getDefault, SafeSearchAnnotation.create)
    ..a<ImageProperties>(8, 'imagePropertiesAnnotation', $pb.PbFieldType.OM, ImageProperties.getDefault, ImageProperties.create)
    ..a<$4.Status>(9, 'error', $pb.PbFieldType.OM, $4.Status.getDefault, $4.Status.create)
    ..a<CropHintsAnnotation>(11, 'cropHintsAnnotation', $pb.PbFieldType.OM, CropHintsAnnotation.getDefault, CropHintsAnnotation.create)
    ..a<$5.TextAnnotation>(12, 'fullTextAnnotation', $pb.PbFieldType.OM, $5.TextAnnotation.getDefault, $5.TextAnnotation.create)
    ..a<$6.WebDetection>(13, 'webDetection', $pb.PbFieldType.OM, $6.WebDetection.getDefault, $6.WebDetection.create)
    ..a<$3.ProductSearchResults>(14, 'productSearchResults', $pb.PbFieldType.OM, $3.ProductSearchResults.getDefault, $3.ProductSearchResults.create)
  ...
  AnnotateImageResponse.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  AnnotateImageResponse.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  AnnotateImageResponse clone() => AnnotateImageResponse()..mergeFromMessage(this);
  AnnotateImageResponse copyWith(void Function(AnnotateImageResponse) updates) => super.copyWith((message) => updates(message as AnnotateImageResponse));
  $pb.BuilderInfo get info_ => _i;
  ...
  static AnnotateImageResponse getDefault() => _defaultInstance ??= create()..freeze();
  ...
  $3.ProductSearchResults get productSearchResults => $_getN(11);
  set productSearchResults($3.ProductSearchResults v) { setField(14, v); }
...
class AnnotateFileResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('AnnotateFileResponse', package: const $pb.PackageName('google.cloud.vision.v1p4beta1'))
    ..a<InputConfig>(1, 'inputConfig', $pb.PbFieldType.OM, InputConfig.getDefault, InputConfig.create)
    ..pc<AnnotateImageResponse>(2, 'responses', $pb.PbFieldType.PM,AnnotateImageResponse.create)
    ..a<$core.int>(3, 'totalPages', $pb.PbFieldType.O3)
    ..hasRequiredFields = false
  ;

  AnnotateFileResponse() : super();
  AnnotateFileResponse.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  AnnotateFileResponse.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  AnnotateFileResponse clone() => AnnotateFileResponse()..mergeFromMessage(this);
  AnnotateFileResponse copyWith(void Function(AnnotateFileResponse) updates) => super.copyWith((message) => updates(message as AnnotateFileResponse));
  $pb.BuilderInfo get info_ => _i;
  ...
  static AnnotateFileResponse getDefault() => _defaultInstance ??= create()..freeze();
...
class BatchAnnotateImagesRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('BatchAnnotateImagesRequest', package: const $pb.PackageName('google.cloud.vision.v1p4beta1'))
    ..pc<AnnotateImageRequest>(1, 'requests', $pb.PbFieldType.PM,AnnotateImageRequest.create)
    ..hasRequiredFields = false
  ;

  BatchAnnotateImagesRequest() : super();
  BatchAnnotateImagesRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  BatchAnnotateImagesRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  BatchAnnotateImagesRequest clone() => BatchAnnotateImagesRequest()..mergeFromMessage(this);
  BatchAnnotateImagesRequest copyWith(void Function(BatchAnnotateImagesRequest) updates) => super.copyWith((message) => updates(message as BatchAnnotateImagesRequest));
  $pb.BuilderInfo get info_ => _i;
  ...
  static BatchAnnotateImagesRequest getDefault() => _defaultInstance ??= create()..freeze();
...
class BatchAnnotateImagesResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('BatchAnnotateImagesResponse', package: const $pb.PackageName('google.cloud.vision.v1p4beta1'))
    ..pc<AnnotateImageResponse>(1, 'responses', $pb.PbFieldType.PM,AnnotateImageResponse.create)
    ..hasRequiredFields = false
  ;

  BatchAnnotateImagesResponse() : super();
  BatchAnnotateImagesResponse.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  BatchAnnotateImagesResponse.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  BatchAnnotateImagesResponse clone() => BatchAnnotateImagesResponse()..mergeFromMessage(this);
  BatchAnnotateImagesResponse copyWith(void Function(BatchAnnotateImagesResponse) updates) => super.copyWith((message) => updates(message as BatchAnnotateImagesResponse));
  $pb.BuilderInfo get info_ => _i;
  ...
  static BatchAnnotateImagesResponse getDefault() => _defaultInstance ??= create()..freeze();
...
class AnnotateFileRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('AnnotateFileRequest', package: const $pb.PackageName('google.cloud.vision.v1p4beta1'))
    ..a<InputConfig>(1, 'inputConfig', $pb.PbFieldType.OM, InputConfig.getDefault, InputConfig.create)
    ..pc<Feature>(2, 'features', $pb.PbFieldType.PM,Feature.create)
    ..a<ImageContext>(3, 'imageContext', $pb.PbFieldType.OM, ImageContext.getDefault, ImageContext.create)
  ...
  AnnotateFileRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  AnnotateFileRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  AnnotateFileRequest clone() => AnnotateFileRequest()..mergeFromMessage(this);
  AnnotateFileRequest copyWith(void Function(AnnotateFileRequest) updates) => super.copyWith((message) => updates(message as AnnotateFileRequest));
  $pb.BuilderInfo get info_ => _i;
  ...
  static AnnotateFileRequest getDefault() => _defaultInstance ??= create()..freeze();
...
class BatchAnnotateFilesRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('BatchAnnotateFilesRequest', package: const $pb.PackageName('google.cloud.vision.v1p4beta1'))
    ..pc<AnnotateFileRequest>(1, 'requests', $pb.PbFieldType.PM,AnnotateFileRequest.create)
    ..hasRequiredFields = false
  ;

  BatchAnnotateFilesRequest() : super();
  BatchAnnotateFilesRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  BatchAnnotateFilesRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  BatchAnnotateFilesRequest clone() => BatchAnnotateFilesRequest()..mergeFromMessage(this);
  BatchAnnotateFilesRequest copyWith(void Function(BatchAnnotateFilesRequest) updates) => super.copyWith((message) => updates(message as BatchAnnotateFilesRequest));
  $pb.BuilderInfo get info_ => _i;
  ...
  static BatchAnnotateFilesRequest getDefault() => _defaultInstance ??= create()..freeze();
...
class BatchAnnotateFilesResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('BatchAnnotateFilesResponse', package: const $pb.PackageName('google.cloud.vision.v1p4beta1'))
    ..pc<AnnotateFileResponse>(1, 'responses', $pb.PbFieldType.PM,AnnotateFileResponse.create)
    ..hasRequiredFields = false
  ;

  BatchAnnotateFilesResponse() : super();
  BatchAnnotateFilesResponse.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  BatchAnnotateFilesResponse.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  BatchAnnotateFilesResponse clone() => BatchAnnotateFilesResponse()..mergeFromMessage(this);
  BatchAnnotateFilesResponse copyWith(void Function(BatchAnnotateFilesResponse) updates) => super.copyWith((message) => updates(message as BatchAnnotateFilesResponse));
  $pb.BuilderInfo get info_ => _i;
  ...
  static BatchAnnotateFilesResponse getDefault() => _defaultInstance ??= create()..freeze();
...
class AsyncAnnotateFileRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('AsyncAnnotateFileRequest', package: const $pb.PackageName('google.cloud.vision.v1p4beta1'))
    ..a<InputConfig>(1, 'inputConfig', $pb.PbFieldType.OM, InputConfig.getDefault, InputConfig.create)
    ..pc<Feature>(2, 'features', $pb.PbFieldType.PM,Feature.create)
    ..a<ImageContext>(3, 'imageContext', $pb.PbFieldType.OM, ImageContext.getDefault, ImageContext.create)
    ..a<OutputConfig>(4, 'outputConfig', $pb.PbFieldType.OM, OutputConfig.getDefault, OutputConfig.create)
    ..hasRequiredFields = false
  ;

  AsyncAnnotateFileRequest() : super();
  AsyncAnnotateFileRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  AsyncAnnotateFileRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  AsyncAnnotateFileRequest clone() => AsyncAnnotateFileRequest()..mergeFromMessage(this);
  AsyncAnnotateFileRequest copyWith(void Function(AsyncAnnotateFileRequest) updates) => super.copyWith((message) => updates(message as AsyncAnnotateFileRequest));
  $pb.BuilderInfo get info_ => _i;
  ...
  static AsyncAnnotateFileRequest getDefault() => _defaultInstance ??= create()..freeze();
...
class AsyncAnnotateFileResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('AsyncAnnotateFileResponse', package: const $pb.PackageName('google.cloud.vision.v1p4beta1'))
    ..a<OutputConfig>(1, 'outputConfig', $pb.PbFieldType.OM, OutputConfig.getDefault, OutputConfig.create)
    ..hasRequiredFields = false
  ;

  AsyncAnnotateFileResponse() : super();
  AsyncAnnotateFileResponse.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  AsyncAnnotateFileResponse.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  AsyncAnnotateFileResponse clone() => AsyncAnnotateFileResponse()..mergeFromMessage(this);
  AsyncAnnotateFileResponse copyWith(void Function(AsyncAnnotateFileResponse) updates) => super.copyWith((message) => updates(message as AsyncAnnotateFileResponse));
  $pb.BuilderInfo get info_ => _i;
  ...
  static AsyncAnnotateFileResponse getDefault() => _defaultInstance ??= create()..freeze();
...
class AsyncBatchAnnotateImagesRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('AsyncBatchAnnotateImagesRequest', package: const $pb.PackageName('google.cloud.vision.v1p4beta1'))
    ..pc<AnnotateImageRequest>(1, 'requests', $pb.PbFieldType.PM,AnnotateImageRequest.create)
    ..a<OutputConfig>(2, 'outputConfig', $pb.PbFieldType.OM, OutputConfig.getDefault, OutputConfig.create)
    ..hasRequiredFields = false
  ;

  AsyncBatchAnnotateImagesRequest() : super();
  AsyncBatchAnnotateImagesRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  AsyncBatchAnnotateImagesRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  AsyncBatchAnnotateImagesRequest clone() => AsyncBatchAnnotateImagesRequest()..mergeFromMessage(this);
  AsyncBatchAnnotateImagesRequest copyWith(void Function(AsyncBatchAnnotateImagesRequest) updates) => super.copyWith((message) => updates(message as AsyncBatchAnnotateImagesRequest));
  $pb.BuilderInfo get info_ => _i;
  static AsyncBatchAnnotateImagesRequest create() => AsyncBatchAnnotateImagesRequest();
  ...
  static AsyncBatchAnnotateImagesRequest getDefault() => _defaultInstance ??= create()..freeze();
...
class AsyncBatchAnnotateImagesResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('AsyncBatchAnnotateImagesResponse', package: const $pb.PackageName('google.cloud.vision.v1p4beta1'))
    ..a<OutputConfig>(1, 'outputConfig', $pb.PbFieldType.OM, OutputConfig.getDefault, OutputConfig.create)
    ..hasRequiredFields = false
  ;

  AsyncBatchAnnotateImagesResponse() : super();
  AsyncBatchAnnotateImagesResponse.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  AsyncBatchAnnotateImagesResponse.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  AsyncBatchAnnotateImagesResponse clone() => AsyncBatchAnnotateImagesResponse()..mergeFromMessage(this);
  AsyncBatchAnnotateImagesResponse copyWith(void Function(AsyncBatchAnnotateImagesResponse) updates) => super.copyWith((message) => updates(message as AsyncBatchAnnotateImagesResponse));
  $pb.BuilderInfo get info_ => _i;
  static AsyncBatchAnnotateImagesResponse create() => AsyncBatchAnnotateImagesResponse();
  ...
  static AsyncBatchAnnotateImagesResponse getDefault() => _defaultInstance ??= create()..freeze();
...
class AsyncBatchAnnotateFilesRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('AsyncBatchAnnotateFilesRequest', package: const $pb.PackageName('google.cloud.vision.v1p4beta1'))
    ..pc<AsyncAnnotateFileRequest>(1, 'requests', $pb.PbFieldType.PM,AsyncAnnotateFileRequest.create)
    ..hasRequiredFields = false
  ;

  AsyncBatchAnnotateFilesRequest() : super();
  AsyncBatchAnnotateFilesRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  AsyncBatchAnnotateFilesRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  AsyncBatchAnnotateFilesRequest clone() => AsyncBatchAnnotateFilesRequest()..mergeFromMessage(this);
  AsyncBatchAnnotateFilesRequest copyWith(void Function(AsyncBatchAnnotateFilesRequest) updates) => super.copyWith((message) => updates(message as AsyncBatchAnnotateFilesRequest));
  $pb.BuilderInfo get info_ => _i;
  static AsyncBatchAnnotateFilesRequest create() => AsyncBatchAnnotateFilesRequest();
  ...
  static AsyncBatchAnnotateFilesRequest getDefault() => _defaultInstance ??= create()..freeze();
...
class AsyncBatchAnnotateFilesResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('AsyncBatchAnnotateFilesResponse', package: const $pb.PackageName('google.cloud.vision.v1p4beta1'))
    ..pc<AsyncAnnotateFileResponse>(1, 'responses', $pb.PbFieldType.PM,AsyncAnnotateFileResponse.create)
    ..hasRequiredFields = false
  ;

  AsyncBatchAnnotateFilesResponse() : super();
  AsyncBatchAnnotateFilesResponse.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  AsyncBatchAnnotateFilesResponse.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  AsyncBatchAnnotateFilesResponse clone() => AsyncBatchAnnotateFilesResponse()..mergeFromMessage(this);
  AsyncBatchAnnotateFilesResponse copyWith(void Function(AsyncBatchAnnotateFilesResponse) updates) => super.copyWith((message) => updates(message as AsyncBatchAnnotateFilesResponse));
  $pb.BuilderInfo get info_ => _i;
  static AsyncBatchAnnotateFilesResponse create() => AsyncBatchAnnotateFilesResponse();
  ...
  static AsyncBatchAnnotateFilesResponse getDefault() => _defaultInstance ??= create()..freeze();
...
class InputConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('InputConfig', package: const $pb.PackageName('google.cloud.vision.v1p4beta1'))
...
class OutputConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('OutputConfig', package: const $pb.PackageName('google.cloud.vision.v1p4beta1'))
...
class GcsSource extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('GcsSource', package: const $pb.PackageName('google.cloud.vision.v1p4beta1'))
    ..aOS(1, 'uri')
    ..hasRequiredFields = false
  ;
...
class GcsDestination extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('GcsDestination', package: const $pb.PackageName('google.cloud.vision.v1p4beta1'))
    ..aOS(1, 'uri')
    ..hasRequiredFields = false
  ;
...
class OperationMetadata extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('OperationMetadata', package: const $pb.PackageName('google.cloud.vision.v1p4beta1'))
    ..e<OperationMetadata_State>(1, 'state', $pb.PbFieldType.OE, OperationMetadata_State.STATE_UNSPECIFIED, OperationMetadata_State.valueOf, OperationMetadata_State.values)
    ..a<$7.Timestamp>(5, 'createTime', $pb.PbFieldType.OM, $7.Timestamp.getDefault, $7.Timestamp.create)
    ..a<$7.Timestamp>(6, 'updateTime', $pb.PbFieldType.OM, $7.Timestamp.getDefault, $7.Timestamp.create)
    ..hasRequiredFields = false
  ;
  ...
  set createTime($7.Timestamp v) { setField(5, v); }
  $core.bool hasCreateTime() => $_has(1);
  void clearCreateTime() => clearField(5);

  $7.Timestamp get updateTime => $_getN(2);
  set updateTime($7.Timestamp v) { setField(6, v); }
...
class ImageAnnotatorApi {
  ...
  $async.Future<BatchAnnotateImagesResponse> batchAnnotateImages($pb.ClientContext ctx, BatchAnnotateImagesRequest request) {
  ...
  $async.Future<BatchAnnotateFilesResponse> batchAnnotateFiles($pb.ClientContext ctx, BatchAnnotateFilesRequest request) {
    var emptyResponse = BatchAnnotateFilesResponse();
    return _client.invoke<BatchAnnotateFilesResponse>(ctx, 'ImageAnnotator', 'BatchAnnotateFiles', request, emptyResponse);
  }
  $async.Future<$8.Operation> asyncBatchAnnotateImages($pb.ClientContext ctx, AsyncBatchAnnotateImagesRequest request) {
    var emptyResponse = $8.Operation();
    return _client.invoke<$8.Operation>(ctx, 'ImageAnnotator', 'AsyncBatchAnnotateImages', request, emptyResponse);
  }
  $async.Future<$8.Operation> asyncBatchAnnotateFiles($pb.ClientContext ctx, AsyncBatchAnnotateFilesRequest request) {
    var emptyResponse = $8.Operation();
    return _client.invoke<$8.Operation>(ctx, 'ImageAnnotator', 'AsyncBatchAnnotateFiles', request, emptyResponse);
  }
}
