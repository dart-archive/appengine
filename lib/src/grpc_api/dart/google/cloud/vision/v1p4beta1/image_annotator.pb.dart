...
class LocalizedObjectAnnotation extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('LocalizedObjectAnnotation',
    ...
    ..aOS(3, 'name')
    ..a<$core.double>(4, 'score', $pb.PbFieldType.OF)
    ..a<$0.BoundingPoly>(5, 'boundingPoly', $pb.PbFieldType.OM,
        $0.BoundingPoly.getDefault, $0.BoundingPoly.create)
    ..hasRequiredFields = false;
...
class ImageContext extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ImageContext',
    ...
    ..a<$3.ProductSearchParams>(5, 'productSearchParams', $pb.PbFieldType.OM,
        $3.ProductSearchParams.getDefault, $3.ProductSearchParams.create)
  ...
  set productSearchParams($3.ProductSearchParams v) {
    setField(5, v);
  }
...
class AnnotateImageResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('AnnotateImageResponse',
    ...
    ..a<$3.ProductSearchResults>(14, 'productSearchResults', $pb.PbFieldType.OM,
        $3.ProductSearchResults.getDefault, $3.ProductSearchResults.create)
  ...
  set productSearchResults($3.ProductSearchResults v) {
    setField(14, v);
  }
...
class OperationMetadata extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('OperationMetadata',
    ...
    ..a<$7.Timestamp>(5, 'createTime', $pb.PbFieldType.OM,
        $7.Timestamp.getDefault, $7.Timestamp.create)
    ..a<$7.Timestamp>(6, 'updateTime', $pb.PbFieldType.OM,
        $7.Timestamp.getDefault, $7.Timestamp.create)
    ..hasRequiredFields = false;
...
class ImageAnnotatorApi {
  ...
  $async.Future<BatchAnnotateFilesResponse> batchAnnotateFiles(
      $pb.ClientContext ctx, BatchAnnotateFilesRequest request) {
    var emptyResponse = BatchAnnotateFilesResponse();
    return _client.invoke<BatchAnnotateFilesResponse>(
        ctx, 'ImageAnnotator', 'BatchAnnotateFiles', request, emptyResponse);
  }

  $async.Future<$8.Operation> asyncBatchAnnotateImages(
      $pb.ClientContext ctx, AsyncBatchAnnotateImagesRequest request) {
    var emptyResponse = $8.Operation();
    return _client.invoke<$8.Operation>(ctx, 'ImageAnnotator',
        'AsyncBatchAnnotateImages', request, emptyResponse);
  }
