...
class WebDetection_WebPage extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('WebDetection_WebPage')
    ...
    ..a<double>(2, 'score', PbFieldType.OF)
    ..aOS(3, 'pageTitle')
    ..pp<WebDetection_WebImage>(4, 'fullMatchingImages', PbFieldType.PM, WebDetection_WebImage.$checkItem, WebDetection_WebImage.create)
    ..pp<WebDetection_WebImage>(5, 'partialMatchingImages', PbFieldType.PM, WebDetection_WebImage.$checkItem, WebDetection_WebImage.create)
    ..hasRequiredFields = false
  ;
  ...
  set pageTitle(String v) { $_setString(2, v); }
...
class WebDetection_WebLabel extends GeneratedMessage {
  ...
  WebDetection_WebLabel.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  WebDetection_WebLabel.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  WebDetection_WebLabel clone() => new WebDetection_WebLabel()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static WebDetection_WebLabel create() => new WebDetection_WebLabel();
  static PbList<WebDetection_WebLabel> createRepeated() => new PbList<WebDetection_WebLabel>();
  static WebDetection_WebLabel getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyWebDetection_WebLabel();
    return _defaultInstance;
  }
  static WebDetection_WebLabel _defaultInstance;
  static void $checkItem(WebDetection_WebLabel v) {
    if (v is! WebDetection_WebLabel) checkItemFailed(v, 'WebDetection_WebLabel');
  }
...
class _ReadonlyWebDetection_WebLabel extends WebDetection_WebLabel with ReadonlyMessageMixin {}
...
class WebDetection extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('WebDetection')
    ...
    ..pp<WebDetection_WebImage>(6, 'visuallySimilarImages', PbFieldType.PM, WebDetection_WebImage.$checkItem, WebDetection_WebImage.create)
    ..pp<WebDetection_WebLabel>(8, 'bestGuessLabels', PbFieldType.PM, WebDetection_WebLabel.$checkItem, WebDetection_WebLabel.create)
    ..hasRequiredFields = false
  ;
