...
class Feature_Type extends ProtobufEnum {
  ...
  static const Feature_Type DOCUMENT_TEXT_DETECTION = const Feature_Type._(11, 'DOCUMENT_TEXT_DETECTION');
  ...
  static const Feature_Type WEB_DETECTION = const Feature_Type._(10, 'WEB_DETECTION');
...
class OperationMetadata_State extends ProtobufEnum {
  static const OperationMetadata_State STATE_UNSPECIFIED = const OperationMetadata_State._(0, 'STATE_UNSPECIFIED');
  static const OperationMetadata_State CREATED = const OperationMetadata_State._(1, 'CREATED');
  static const OperationMetadata_State RUNNING = const OperationMetadata_State._(2, 'RUNNING');
  static const OperationMetadata_State DONE = const OperationMetadata_State._(3, 'DONE');
  static const OperationMetadata_State CANCELLED = const OperationMetadata_State._(4, 'CANCELLED');

  static const List<OperationMetadata_State> values = const <OperationMetadata_State> [
    STATE_UNSPECIFIED,
    CREATED,
    RUNNING,
    DONE,
  ...
  static final Map<int, dynamic> _byValue = ProtobufEnum.initByValue(values);
  static OperationMetadata_State valueOf(int value) => _byValue[value] as OperationMetadata_State;
  static void $checkItem(OperationMetadata_State v) {
    if (v is! OperationMetadata_State) checkItemFailed(v, 'OperationMetadata_State');
  }
