...
class ImageAnnotationContext extends GeneratedMessage {
  ...
  ImageAnnotationContext.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  ImageAnnotationContext.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ImageAnnotationContext clone() => new ImageAnnotationContext()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static ImageAnnotationContext create() => new ImageAnnotationContext();
  static PbList<ImageAnnotationContext> createRepeated() => new PbList<ImageAnnotationContext>();
  static ImageAnnotationContext getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyImageAnnotationContext();
    return _defaultInstance;
  }
  static ImageAnnotationContext _defaultInstance;
  static void $checkItem(ImageAnnotationContext v) {
    if (v is! ImageAnnotationContext) checkItemFailed(v, 'ImageAnnotationContext');
  }
  ...
  set pageNumber(int v) { $_setSignedInt32(1, v); }
  bool hasPageNumber() => $_has(1);
  void clearPageNumber() => clearField(2);
}

class _ReadonlyImageAnnotationContext extends ImageAnnotationContext with ReadonlyMessageMixin {}
...
class AnnotateImageResponse extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('AnnotateImageResponse')
    ...
    ..a<ImageAnnotationContext>(21, 'context', PbFieldType.OM, ImageAnnotationContext.getDefault, ImageAnnotationContext.create)
    ..hasRequiredFields = false
  ;
...
class AnnotateFileResponse extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('AnnotateFileResponse')
    ..a<InputConfig>(1, 'inputConfig', PbFieldType.OM, InputConfig.getDefault, InputConfig.create)
    ..pp<AnnotateImageResponse>(2, 'responses', PbFieldType.PM, AnnotateImageResponse.$checkItem, AnnotateImageResponse.create)
    ..hasRequiredFields = false
  ;

  AnnotateFileResponse() : super();
  AnnotateFileResponse.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  AnnotateFileResponse.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  AnnotateFileResponse clone() => new AnnotateFileResponse()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static AnnotateFileResponse create() => new AnnotateFileResponse();
  static PbList<AnnotateFileResponse> createRepeated() => new PbList<AnnotateFileResponse>();
  static AnnotateFileResponse getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyAnnotateFileResponse();
    return _defaultInstance;
  }
...
class _ReadonlyAnnotateFileResponse extends AnnotateFileResponse with ReadonlyMessageMixin {}
...
class AsyncAnnotateFileRequest extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('AsyncAnnotateFileRequest')
    ...
    ..pp<Feature>(2, 'features', PbFieldType.PM, Feature.$checkItem, Feature.create)
    ..a<ImageContext>(3, 'imageContext', PbFieldType.OM, ImageContext.getDefault, ImageContext.create)
    ..a<OutputConfig>(4, 'outputConfig', PbFieldType.OM, OutputConfig.getDefault, OutputConfig.create)
    ..hasRequiredFields = false
  ;

  AsyncAnnotateFileRequest() : super();
  AsyncAnnotateFileRequest.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  AsyncAnnotateFileRequest.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  AsyncAnnotateFileRequest clone() => new AsyncAnnotateFileRequest()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static AsyncAnnotateFileRequest create() => new AsyncAnnotateFileRequest();
  static PbList<AsyncAnnotateFileRequest> createRepeated() => new PbList<AsyncAnnotateFileRequest>();
  static AsyncAnnotateFileRequest getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyAsyncAnnotateFileRequest();
    return _defaultInstance;
  }
  static AsyncAnnotateFileRequest _defaultInstance;
  static void $checkItem(AsyncAnnotateFileRequest v) {
    if (v is! AsyncAnnotateFileRequest) checkItemFailed(v, 'AsyncAnnotateFileRequest');
  }
...
class _ReadonlyAsyncAnnotateFileRequest extends AsyncAnnotateFileRequest with ReadonlyMessageMixin {}
...
class AsyncAnnotateFileResponse extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('AsyncAnnotateFileResponse')
    ..a<OutputConfig>(1, 'outputConfig', PbFieldType.OM, OutputConfig.getDefault, OutputConfig.create)
    ..hasRequiredFields = false
  ;

  AsyncAnnotateFileResponse() : super();
  AsyncAnnotateFileResponse.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  AsyncAnnotateFileResponse.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  AsyncAnnotateFileResponse clone() => new AsyncAnnotateFileResponse()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static AsyncAnnotateFileResponse create() => new AsyncAnnotateFileResponse();
  static PbList<AsyncAnnotateFileResponse> createRepeated() => new PbList<AsyncAnnotateFileResponse>();
  static AsyncAnnotateFileResponse getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyAsyncAnnotateFileResponse();
    return _defaultInstance;
  }
  static AsyncAnnotateFileResponse _defaultInstance;
  static void $checkItem(AsyncAnnotateFileResponse v) {
    if (v is! AsyncAnnotateFileResponse) checkItemFailed(v, 'AsyncAnnotateFileResponse');
  }
...
class _ReadonlyAsyncAnnotateFileResponse extends AsyncAnnotateFileResponse with ReadonlyMessageMixin {}

class AsyncBatchAnnotateFilesRequest extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('AsyncBatchAnnotateFilesRequest')
    ..pp<AsyncAnnotateFileRequest>(1, 'requests', PbFieldType.PM, AsyncAnnotateFileRequest.$checkItem, AsyncAnnotateFileRequest.create)
    ..hasRequiredFields = false
  ;

  AsyncBatchAnnotateFilesRequest() : super();
  AsyncBatchAnnotateFilesRequest.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  AsyncBatchAnnotateFilesRequest.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  AsyncBatchAnnotateFilesRequest clone() => new AsyncBatchAnnotateFilesRequest()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static AsyncBatchAnnotateFilesRequest create() => new AsyncBatchAnnotateFilesRequest();
  static PbList<AsyncBatchAnnotateFilesRequest> createRepeated() => new PbList<AsyncBatchAnnotateFilesRequest>();
  static AsyncBatchAnnotateFilesRequest getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyAsyncBatchAnnotateFilesRequest();
    return _defaultInstance;
  }
  static AsyncBatchAnnotateFilesRequest _defaultInstance;
  static void $checkItem(AsyncBatchAnnotateFilesRequest v) {
    if (v is! AsyncBatchAnnotateFilesRequest) checkItemFailed(v, 'AsyncBatchAnnotateFilesRequest');
  }

  List<AsyncAnnotateFileRequest> get requests => $_getList(0);
}

class _ReadonlyAsyncBatchAnnotateFilesRequest extends AsyncBatchAnnotateFilesRequest with ReadonlyMessageMixin {}

class AsyncBatchAnnotateFilesResponse extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('AsyncBatchAnnotateFilesResponse')
    ..pp<AsyncAnnotateFileResponse>(1, 'responses', PbFieldType.PM, AsyncAnnotateFileResponse.$checkItem, AsyncAnnotateFileResponse.create)
    ..hasRequiredFields = false
  ;

  AsyncBatchAnnotateFilesResponse() : super();
  AsyncBatchAnnotateFilesResponse.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  AsyncBatchAnnotateFilesResponse.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  AsyncBatchAnnotateFilesResponse clone() => new AsyncBatchAnnotateFilesResponse()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static AsyncBatchAnnotateFilesResponse create() => new AsyncBatchAnnotateFilesResponse();
  static PbList<AsyncBatchAnnotateFilesResponse> createRepeated() => new PbList<AsyncBatchAnnotateFilesResponse>();
  static AsyncBatchAnnotateFilesResponse getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyAsyncBatchAnnotateFilesResponse();
    return _defaultInstance;
  }
  static AsyncBatchAnnotateFilesResponse _defaultInstance;
  static void $checkItem(AsyncBatchAnnotateFilesResponse v) {
    if (v is! AsyncBatchAnnotateFilesResponse) checkItemFailed(v, 'AsyncBatchAnnotateFilesResponse');
  }

  List<AsyncAnnotateFileResponse> get responses => $_getList(0);
}

class _ReadonlyAsyncBatchAnnotateFilesResponse extends AsyncBatchAnnotateFilesResponse with ReadonlyMessageMixin {}

class InputConfig extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('InputConfig')
    ..a<GcsSource>(1, 'gcsSource', PbFieldType.OM, GcsSource.getDefault, GcsSource.create)
    ..aOS(2, 'mimeType')
    ..hasRequiredFields = false
  ;

  InputConfig() : super();
  InputConfig.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  InputConfig.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
...
class OutputConfig extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('OutputConfig')
    ..a<GcsDestination>(1, 'gcsDestination', PbFieldType.OM, GcsDestination.getDefault, GcsDestination.create)
    ..a<int>(2, 'batchSize', PbFieldType.O3)
    ..hasRequiredFields = false
  ;

  OutputConfig() : super();
  OutputConfig.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  OutputConfig.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ...
  static OutputConfig getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyOutputConfig();
    return _defaultInstance;
  }
  ...
  set batchSize(int v) { $_setSignedInt32(1, v); }
...
class GcsSource extends GeneratedMessage {
  ...
  GcsSource() : super();
  GcsSource.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  GcsSource.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
...
class GcsDestination extends GeneratedMessage {
  ...
  GcsDestination.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  GcsDestination.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  GcsDestination clone() => new GcsDestination()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static GcsDestination create() => new GcsDestination();
  static PbList<GcsDestination> createRepeated() => new PbList<GcsDestination>();
  static GcsDestination getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyGcsDestination();
    return _defaultInstance;
  }
...
class OperationMetadata extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('OperationMetadata')
    ..e<OperationMetadata_State>(1, 'state', PbFieldType.OE, OperationMetadata_State.STATE_UNSPECIFIED, OperationMetadata_State.valueOf, OperationMetadata_State.values)
...
class ImageAnnotatorApi {
  ...
  Future<$google$longrunning.Operation> asyncBatchAnnotateFiles(ClientContext ctx, AsyncBatchAnnotateFilesRequest request) {
    var emptyResponse = new $google$longrunning.Operation();
    return _client.invoke<$google$longrunning.Operation>(ctx, 'ImageAnnotator', 'AsyncBatchAnnotateFiles', request, emptyResponse);
  }
}
