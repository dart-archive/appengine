...
class Vertex extends GeneratedMessage {
  ...
  int get x => $_get(0, 0);
  set x(int v) { $_setSignedInt32(0, v); }
  bool hasX() => $_has(0);
  void clearX() => clearField(1);

  int get y => $_get(1, 0);
  set y(int v) { $_setSignedInt32(1, v); }
  bool hasY() => $_has(1);
...
class NormalizedVertex extends GeneratedMessage {
  ...
  NormalizedVertex.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  NormalizedVertex.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  NormalizedVertex clone() => new NormalizedVertex()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static NormalizedVertex create() => new NormalizedVertex();
  static PbList<NormalizedVertex> createRepeated() => new PbList<NormalizedVertex>();
  static NormalizedVertex getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyNormalizedVertex();
    return _defaultInstance;
  }
...
class _ReadonlyNormalizedVertex extends NormalizedVertex with ReadonlyMessageMixin {}
...
class BoundingPoly extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('BoundingPoly')
    ...
    ..pp<NormalizedVertex>(2, 'normalizedVertices', PbFieldType.PM, NormalizedVertex.$checkItem, NormalizedVertex.create)
    ..hasRequiredFields = false
  ;
