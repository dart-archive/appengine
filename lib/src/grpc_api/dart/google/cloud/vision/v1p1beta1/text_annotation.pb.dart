...
class TextAnnotation_DetectedLanguage extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('TextAnnotation.DetectedLanguage', package: const $pb.PackageName('google.cloud.vision.v1p1beta1'))
    ..aOS(1, 'languageCode')
  ...
  TextAnnotation_DetectedLanguage.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  TextAnnotation_DetectedLanguage.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  TextAnnotation_DetectedLanguage clone() => TextAnnotation_DetectedLanguage()..mergeFromMessage(this);
  TextAnnotation_DetectedLanguage copyWith(void Function(TextAnnotation_DetectedLanguage) updates) => super.copyWith((message) => updates(message as TextAnnotation_DetectedLanguage));
  $pb.BuilderInfo get info_ => _i;
  static TextAnnotation_DetectedLanguage create() => TextAnnotation_DetectedLanguage();
  ...
  static TextAnnotation_DetectedLanguage getDefault() => _defaultInstance ??= create()..freeze();
...
class TextAnnotation_DetectedBreak extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('TextAnnotation.DetectedBreak', package: const $pb.PackageName('google.cloud.vision.v1p1beta1'))
    ..e<TextAnnotation_DetectedBreak_BreakType>(1, 'type', $pb.PbFieldType.OE, TextAnnotation_DetectedBreak_BreakType.UNKNOWN, TextAnnotation_DetectedBreak_BreakType.valueOf, TextAnnotation_DetectedBreak_BreakType.values)
    ..aOB(2, 'isPrefix')
    ..hasRequiredFields = false
  ;

  TextAnnotation_DetectedBreak() : super();
  TextAnnotation_DetectedBreak.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  TextAnnotation_DetectedBreak.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  TextAnnotation_DetectedBreak clone() => TextAnnotation_DetectedBreak()..mergeFromMessage(this);
  TextAnnotation_DetectedBreak copyWith(void Function(TextAnnotation_DetectedBreak) updates) => super.copyWith((message) => updates(message as TextAnnotation_DetectedBreak));
  $pb.BuilderInfo get info_ => _i;
  static TextAnnotation_DetectedBreak create() => TextAnnotation_DetectedBreak();
  ...
  static TextAnnotation_DetectedBreak getDefault() => _defaultInstance ??= create()..freeze();
...
class TextAnnotation_TextProperty extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('TextAnnotation.TextProperty', package: const $pb.PackageName('google.cloud.vision.v1p1beta1'))
    ..pc<TextAnnotation_DetectedLanguage>(1, 'detectedLanguages', $pb.PbFieldType.PM,TextAnnotation_DetectedLanguage.create)
    ..a<TextAnnotation_DetectedBreak>(2, 'detectedBreak', $pb.PbFieldType.OM, TextAnnotation_DetectedBreak.getDefault, TextAnnotation_DetectedBreak.create)
    ..hasRequiredFields = false
  ;

  TextAnnotation_TextProperty() : super();
  TextAnnotation_TextProperty.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  TextAnnotation_TextProperty.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  TextAnnotation_TextProperty clone() => TextAnnotation_TextProperty()..mergeFromMessage(this);
  TextAnnotation_TextProperty copyWith(void Function(TextAnnotation_TextProperty) updates) => super.copyWith((message) => updates(message as TextAnnotation_TextProperty));
  $pb.BuilderInfo get info_ => _i;
  ...
  static TextAnnotation_TextProperty getDefault() => _defaultInstance ??= create()..freeze();
...
class TextAnnotation extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('TextAnnotation', package: const $pb.PackageName('google.cloud.vision.v1p1beta1'))
...
class Page extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Page', package: const $pb.PackageName('google.cloud.vision.v1p1beta1'))
    ..a<TextAnnotation_TextProperty>(1, 'property', $pb.PbFieldType.OM, TextAnnotation_TextProperty.getDefault, TextAnnotation_TextProperty.create)
...
class Block extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Block', package: const $pb.PackageName('google.cloud.vision.v1p1beta1'))
    ..a<TextAnnotation_TextProperty>(1, 'property', $pb.PbFieldType.OM, TextAnnotation_TextProperty.getDefault, TextAnnotation_TextProperty.create)
    ..a<$0.BoundingPoly>(2, 'boundingBox', $pb.PbFieldType.OM, $0.BoundingPoly.getDefault, $0.BoundingPoly.create)
    ..pc<Paragraph>(3, 'paragraphs', $pb.PbFieldType.PM,Paragraph.create)
    ..e<Block_BlockType>(4, 'blockType', $pb.PbFieldType.OE, Block_BlockType.UNKNOWN, Block_BlockType.valueOf, Block_BlockType.values)
    ..a<$core.double>(5, 'confidence', $pb.PbFieldType.OF)
    ..hasRequiredFields = false
  ;

  Block() : super();
  Block.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  Block.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
...
class Paragraph extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Paragraph', package: const $pb.PackageName('google.cloud.vision.v1p1beta1'))
    ..a<TextAnnotation_TextProperty>(1, 'property', $pb.PbFieldType.OM, TextAnnotation_TextProperty.getDefault, TextAnnotation_TextProperty.create)
    ..a<$0.BoundingPoly>(2, 'boundingBox', $pb.PbFieldType.OM, $0.BoundingPoly.getDefault, $0.BoundingPoly.create)
  ...
  Paragraph() : super();
  Paragraph.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  Paragraph.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
...
class Word extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Word', package: const $pb.PackageName('google.cloud.vision.v1p1beta1'))
    ..a<TextAnnotation_TextProperty>(1, 'property', $pb.PbFieldType.OM, TextAnnotation_TextProperty.getDefault, TextAnnotation_TextProperty.create)
    ..a<$0.BoundingPoly>(2, 'boundingBox', $pb.PbFieldType.OM, $0.BoundingPoly.getDefault, $0.BoundingPoly.create)
  ...
  Word() : super();
  Word.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  Word.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
...
class Symbol extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Symbol', package: const $pb.PackageName('google.cloud.vision.v1p1beta1'))
    ..a<TextAnnotation_TextProperty>(1, 'property', $pb.PbFieldType.OM, TextAnnotation_TextProperty.getDefault, TextAnnotation_TextProperty.create)
    ..a<$0.BoundingPoly>(2, 'boundingBox', $pb.PbFieldType.OM, $0.BoundingPoly.getDefault, $0.BoundingPoly.create)
    ..aOS(3, 'text')
    ..a<$core.double>(4, 'confidence', $pb.PbFieldType.OF)
  ...
  Symbol() : super();
  Symbol.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  Symbol.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  Symbol clone() => Symbol()..mergeFromMessage(this);
  Symbol copyWith(void Function(Symbol) updates) => super.copyWith((message) => updates(message as Symbol));
  $pb.BuilderInfo get info_ => _i;
