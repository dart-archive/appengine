...
class TextAnnotation_DetectedBreak extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('TextAnnotation_DetectedBreak')
    ..e<TextAnnotation_DetectedBreak_BreakType>(1, 'type', PbFieldType.OE, TextAnnotation_DetectedBreak_BreakType.UNKNOWN, TextAnnotation_DetectedBreak_BreakType.valueOf, TextAnnotation_DetectedBreak_BreakType.values)
    ..aOB(2, 'isPrefix')
    ..hasRequiredFields = false
  ;
  ...
  set isPrefix(bool v) { $_setBool(1, v); }
...
class Page extends GeneratedMessage {
  ...
  set width(int v) { $_setSignedInt32(1, v); }
...
class Block extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('Block')
    ...
    ..e<Block_BlockType>(4, 'blockType', PbFieldType.OE, Block_BlockType.UNKNOWN, Block_BlockType.valueOf, Block_BlockType.values)
    ..a<double>(5, 'confidence', PbFieldType.OF)
    ..hasRequiredFields = false
  ;
  ...
  set boundingBox(BoundingPoly v) { setField(2, v); }
...
class Symbol extends GeneratedMessage {
  ...
  set text(String v) { $_setString(2, v); }
  bool hasText() => $_has(2);
