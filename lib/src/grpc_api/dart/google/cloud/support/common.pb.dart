...
class Case extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Case',
    ...
    ..e<Case_State>(12, 'state', $pb.PbFieldType.OE,
        Case_State.STATE_UNSPECIFIED, Case_State.valueOf, Case_State.values)
    ..a<$0.Timestamp>(13, 'createTime', $pb.PbFieldType.OM,
        $0.Timestamp.getDefault, $0.Timestamp.create)
    ..a<$0.Timestamp>(14, 'updateTime', $pb.PbFieldType.OM,
        $0.Timestamp.getDefault, $0.Timestamp.create)
    ..aOS(15, 'creatorEmail')
    ..aOS(16, 'category')
    ..hasRequiredFields = false;
...
class CustomerIssue extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('CustomerIssue',
    ...
    ..a<$0.Timestamp>(3, 'createTime', $pb.PbFieldType.OM,
        $0.Timestamp.getDefault, $0.Timestamp.create)
    ..a<$0.Timestamp>(4, 'resolveTime', $pb.PbFieldType.OM,
        $0.Timestamp.getDefault, $0.Timestamp.create)
...
class IssueTaxonomy_Category extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('IssueTaxonomy.Category',
    ...
    ..m<$core.String, IssueTaxonomy_Component>(
        2,
        'components',
        'IssueTaxonomy.Category.ComponentsEntry',
        $pb.PbFieldType.OS,
        $pb.PbFieldType.OM,
        IssueTaxonomy_Component.create,
        null,
        null,
...
class IssueTaxonomy extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('IssueTaxonomy',
    ...
    ..m<$core.String, IssueTaxonomy_Category>(
        1,
        'categories',
        'IssueTaxonomy.CategoriesEntry',
        $pb.PbFieldType.OS,
        $pb.PbFieldType.OM,
        IssueTaxonomy_Category.create,
        null,
        null,
        const $pb.PackageName('google.cloud.support.common'))
    ..hasRequiredFields = false;
