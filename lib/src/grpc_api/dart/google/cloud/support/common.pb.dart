...
class SupportAccount extends GeneratedMessage {
  static final BuilderInfo _i = BuilderInfo('SupportAccount')
    ...
    ..e<SupportAccount_State>(
        ...
        'state',
        PbFieldType.OE,
        SupportAccount_State.STATE_UNSPECIFIED,
        SupportAccount_State.valueOf,
        SupportAccount_State.values)
    ...
    ..e<SupportAccount_PricingModel>(
        ...
        'pricingModel',
        PbFieldType.OE,
        SupportAccount_PricingModel.PRICING_MODEL_UNKNOWN,
        SupportAccount_PricingModel.valueOf,
        SupportAccount_PricingModel.values)
    ..hasRequiredFields = false;

  SupportAccount() : super();
  SupportAccount.fromBuffer(List<int> i,
...
class Case extends GeneratedMessage {
  static final BuilderInfo _i = BuilderInfo('Case')
    ...
    ..pPS(7, 'ccAddresses')
    ..aOS(8, 'projectId')
    ..pp<CustomerIssue>(10, 'issues', PbFieldType.PM, CustomerIssue.$checkItem,
        CustomerIssue.create)
    ..e<Case_Priority>(
        11,
        'priority',
        PbFieldType.OE,
        Case_Priority.PRIORITY_UNSPECIFIED,
        Case_Priority.valueOf,
        Case_Priority.values)
    ..e<Case_State>(12, 'state', PbFieldType.OE, Case_State.STATE_UNSPECIFIED,
        Case_State.valueOf, Case_State.values)
    ..a<$google$protobuf.Timestamp>(
        13,
        'createTime',
        PbFieldType.OM,
  ...
  Case() : super();
  Case.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);
...
class CustomerIssue extends GeneratedMessage {
  static final BuilderInfo _i = BuilderInfo('CustomerIssue')
    ...
    ..e<CustomerIssue_IssueState>(
        ...
        'state',
        PbFieldType.OE,
        CustomerIssue_IssueState.ISSUE_STATE_UNSPECIFIED,
        CustomerIssue_IssueState.valueOf,
        CustomerIssue_IssueState.values)
    ..a<$google$protobuf.Timestamp>(
        3,
        'createTime',
        PbFieldType.OM,
  ...
  CustomerIssue() : super();
  CustomerIssue.fromBuffer(List<int> i,
      [ExtensionRegistry r = ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);
  ...
  set resolveTime($google$protobuf.Timestamp v) {
    setField(4, v);
  }
...
class SupportRole extends GeneratedMessage {
  static final BuilderInfo _i = BuilderInfo('SupportRole')
    ...
    ..e<SupportRole_Role>(
        ...
        'role',
        PbFieldType.OE,
        SupportRole_Role.ROLE_UNSPECIFIED,
        SupportRole_Role.valueOf,
        SupportRole_Role.values)
    ..hasRequiredFields = false;

  SupportRole() : super();
  SupportRole.fromBuffer(List<int> i,
      [ExtensionRegistry r = ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);
...
class IssueTaxonomy_Component extends GeneratedMessage {
  static final BuilderInfo _i = BuilderInfo('IssueTaxonomy_Component')
    ...
    ..pPS(2, 'languages')
    ..aOS(3, 'template')
    ..pp<IssueTaxonomy_Component>(4, 'subcomponents', PbFieldType.PM,
        IssueTaxonomy_Component.$checkItem, IssueTaxonomy_Component.create)
    ..hasRequiredFields = false;

  IssueTaxonomy_Component() : super();
  IssueTaxonomy_Component.fromBuffer(List<int> i,
      [ExtensionRegistry r = ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);
  IssueTaxonomy_Component.fromJson(String i,
      [ExtensionRegistry r = ExtensionRegistry.EMPTY])
      : super.fromJson(i, r);
  ...
  static void $checkItem(IssueTaxonomy_Component v) {
    if (v is! IssueTaxonomy_Component)
      checkItemFailed(v, 'IssueTaxonomy_Component');
  }
...
class _ReadonlyIssueTaxonomy_Component extends IssueTaxonomy_Component
...
class IssueTaxonomy_Category_ComponentsEntry extends GeneratedMessage {
  ...
  IssueTaxonomy_Category_ComponentsEntry.fromBuffer(List<int> i,
      [ExtensionRegistry r = ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);
  IssueTaxonomy_Category_ComponentsEntry.fromJson(String i,
      [ExtensionRegistry r = ExtensionRegistry.EMPTY])
      : super.fromJson(i, r);
  ...
  static void $checkItem(IssueTaxonomy_Category_ComponentsEntry v) {
    if (v is! IssueTaxonomy_Category_ComponentsEntry)
      checkItemFailed(v, 'IssueTaxonomy_Category_ComponentsEntry');
  }
  ...
  set value(IssueTaxonomy_Component v) {
    setField(2, v);
  }
...
class _ReadonlyIssueTaxonomy_Category_ComponentsEntry
...
class IssueTaxonomy_Category extends GeneratedMessage {
  static final BuilderInfo _i = BuilderInfo('IssueTaxonomy_Category')
    ...
    ..pp<IssueTaxonomy_Category_ComponentsEntry>(
        ...
        'components',
        PbFieldType.PM,
        IssueTaxonomy_Category_ComponentsEntry.$checkItem,
        IssueTaxonomy_Category_ComponentsEntry.create)
    ..hasRequiredFields = false;

  IssueTaxonomy_Category() : super();
  IssueTaxonomy_Category.fromBuffer(List<int> i,
      [ExtensionRegistry r = ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);
  IssueTaxonomy_Category.fromJson(String i,
      [ExtensionRegistry r = ExtensionRegistry.EMPTY])
      : super.fromJson(i, r);
  ...
  static void $checkItem(IssueTaxonomy_Category v) {
    if (v is! IssueTaxonomy_Category)
      checkItemFailed(v, 'IssueTaxonomy_Category');
  }
...
class _ReadonlyIssueTaxonomy_Category extends IssueTaxonomy_Category
    with ReadonlyMessageMixin {}
...
class IssueTaxonomy_CategoriesEntry extends GeneratedMessage {
  ...
  IssueTaxonomy_CategoriesEntry.fromBuffer(List<int> i,
      [ExtensionRegistry r = ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);
  IssueTaxonomy_CategoriesEntry.fromJson(String i,
      [ExtensionRegistry r = ExtensionRegistry.EMPTY])
      : super.fromJson(i, r);
  ...
  static void $checkItem(IssueTaxonomy_CategoriesEntry v) {
    if (v is! IssueTaxonomy_CategoriesEntry)
      checkItemFailed(v, 'IssueTaxonomy_CategoriesEntry');
  }
  ...
  set value(IssueTaxonomy_Category v) {
    setField(2, v);
  }
...
class _ReadonlyIssueTaxonomy_CategoriesEntry
...
class IssueTaxonomy extends GeneratedMessage {
  static final BuilderInfo _i = BuilderInfo('IssueTaxonomy')
    ..pp<IssueTaxonomy_CategoriesEntry>(
        ...
        'categories',
        PbFieldType.PM,
        IssueTaxonomy_CategoriesEntry.$checkItem,
        IssueTaxonomy_CategoriesEntry.create)
    ..hasRequiredFields = false;

  IssueTaxonomy() : super();
  IssueTaxonomy.fromBuffer(List<int> i,
      [ExtensionRegistry r = ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);
