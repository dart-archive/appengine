...
const CloudSupport$messageJson = const {
  ...
  '.google.cloud.support.common.SupportAccount': $google$cloud$support$common.SupportAccount$json,
  ...
  '.google.cloud.support.common.CustomerIssue': $google$cloud$support$common.CustomerIssue$json,
  ...
  '.google.cloud.support.common.Comment': $google$cloud$support$common.Comment$json,
  ...
  '.google.cloud.support.common.IssueTaxonomy': $google$cloud$support$common.IssueTaxonomy$json,
  '.google.cloud.support.common.IssueTaxonomy.CategoriesEntry': $google$cloud$support$common.IssueTaxonomy_CategoriesEntry$json,
  '.google.cloud.support.common.IssueTaxonomy.Category': $google$cloud$support$common.IssueTaxonomy_Category$json,
  '.google.cloud.support.common.IssueTaxonomy.Category.ComponentsEntry': $google$cloud$support$common.IssueTaxonomy_Category_ComponentsEntry$json,
  '.google.cloud.support.common.IssueTaxonomy.Component': $google$cloud$support$common.IssueTaxonomy_Component$json,
};
