...
abstract class CloudSupportServiceBase extends $pb.GeneratedService {
  $async.Future<$0.SupportAccount> getSupportAccount(
      $pb.ServerContext ctx, GetSupportAccountRequest request);
  $async.Future<ListSupportAccountsResponse> listSupportAccounts(
      $pb.ServerContext ctx, ListSupportAccountsRequest request);
  $async.Future<$0.Case> getCase($pb.ServerContext ctx, GetCaseRequest request);
  $async.Future<ListCasesResponse> listCases(
      $pb.ServerContext ctx, ListCasesRequest request);
  $async.Future<ListCommentsResponse> listComments(
      $pb.ServerContext ctx, ListCommentsRequest request);
  $async.Future<$0.Case> createCase(
      $pb.ServerContext ctx, CreateCaseRequest request);
  $async.Future<$0.Case> updateCase(
      $pb.ServerContext ctx, UpdateCaseRequest request);
  $async.Future<$0.Comment> createComment(
      $pb.ServerContext ctx, CreateCommentRequest request);
  $async.Future<$0.IssueTaxonomy> getIssueTaxonomy(
      $pb.ServerContext ctx, GetIssueTaxonomyRequest request);
  ...
  $core.Map<$core.String, $core.dynamic> get $json =>
      CloudSupportServiceBase$json;
  $core.Map<$core.String, $core.Map<$core.String, $core.dynamic>>
      get $messageJson => CloudSupportServiceBase$messageJson;
}
