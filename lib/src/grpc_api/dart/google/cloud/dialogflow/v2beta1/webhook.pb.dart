...
class WebhookRequest extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('WebhookRequest')
    ...
    ..a<OriginalDetectIntentRequest>(3, 'originalDetectIntentRequest', PbFieldType.OM, OriginalDetectIntentRequest.getDefault, OriginalDetectIntentRequest.create)
    ..aOS(4, 'session')
    ..hasRequiredFields = false
  ;

  WebhookRequest() : super();
  WebhookRequest.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  WebhookRequest.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  WebhookRequest clone() => new WebhookRequest()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static WebhookRequest create() => new WebhookRequest();
  static PbList<WebhookRequest> createRepeated() => new PbList<WebhookRequest>();
  static WebhookRequest getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyWebhookRequest();
  ...
  set session(String v) { $_setString(3, v); }
...
class WebhookResponse extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('WebhookResponse')
    ...
    ..pp<Intent_Message>(2, 'fulfillmentMessages', PbFieldType.PM, Intent_Message.$checkItem, Intent_Message.create)
    ..aOS(3, 'source')
    ..a<$google$protobuf.Struct>(4, 'payload', PbFieldType.OM, $google$protobuf.Struct.getDefault, $google$protobuf.Struct.create)
    ..pp<Context>(5, 'outputContexts', PbFieldType.PM, Context.$checkItem, Context.create)
    ..a<EventInput>(6, 'followupEventInput', PbFieldType.OM, EventInput.getDefault, EventInput.create)
    ..hasRequiredFields = false
  ;

  WebhookResponse() : super();
  WebhookResponse.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  WebhookResponse.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  WebhookResponse clone() => new WebhookResponse()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static WebhookResponse create() => new WebhookResponse();
  static PbList<WebhookResponse> createRepeated() => new PbList<WebhookResponse>();
  static WebhookResponse getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyWebhookResponse();
    return _defaultInstance;
  }
  ...
  set fulfillmentText(String v) { $_setString(0, v); }
  ...
  set payload($google$protobuf.Struct v) { setField(4, v); }
  ...
  set followupEventInput(EventInput v) { setField(6, v); }
  bool hasFollowupEventInput() => $_has(5);
  void clearFollowupEventInput() => clearField(6);
}

class _ReadonlyWebhookResponse extends WebhookResponse with ReadonlyMessageMixin {}
...
class OriginalDetectIntentRequest extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('OriginalDetectIntentRequest')
    ..aOS(1, 'source')
    ..a<$google$protobuf.Struct>(3, 'payload', PbFieldType.OM, $google$protobuf.Struct.getDefault, $google$protobuf.Struct.create)
    ..hasRequiredFields = false
  ;

  OriginalDetectIntentRequest() : super();
  OriginalDetectIntentRequest.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  OriginalDetectIntentRequest.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  OriginalDetectIntentRequest clone() => new OriginalDetectIntentRequest()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static OriginalDetectIntentRequest create() => new OriginalDetectIntentRequest();
  static PbList<OriginalDetectIntentRequest> createRepeated() => new PbList<OriginalDetectIntentRequest>();
  static OriginalDetectIntentRequest getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyOriginalDetectIntentRequest();
    return _defaultInstance;
  }
  static OriginalDetectIntentRequest _defaultInstance;
  static void $checkItem(OriginalDetectIntentRequest v) {
    if (v is! OriginalDetectIntentRequest) checkItemFailed(v, 'OriginalDetectIntentRequest');
  }
  ...
  set payload($google$protobuf.Struct v) { setField(3, v); }
  bool hasPayload() => $_has(1);
  void clearPayload() => clearField(3);
}

class _ReadonlyOriginalDetectIntentRequest extends OriginalDetectIntentRequest with ReadonlyMessageMixin {}
