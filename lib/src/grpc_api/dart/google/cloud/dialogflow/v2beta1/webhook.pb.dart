...
class WebhookRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('WebhookRequest', package: const $pb.PackageName('google.cloud.dialogflow.v2beta1'))
    ..aOS(1, 'responseId')
    ...
    ..aOS(4, 'session')
    ..pc<$0.QueryResult>(5, 'alternativeQueryResults', $pb.PbFieldType.PM,$0.QueryResult.create)
  ...
  $core.List<$0.QueryResult> get alternativeQueryResults => $_getList(4);
}

class WebhookResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('WebhookResponse', package: const $pb.PackageName('google.cloud.dialogflow.v2beta1'))
  ...
  set endInteraction($core.bool v) { $_setBool(6, v); }
...
class OriginalDetectIntentRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('OriginalDetectIntentRequest', package: const $pb.PackageName('google.cloud.dialogflow.v2beta1'))
    ..aOS(1, 'source')
    ..aOS(2, 'version')
