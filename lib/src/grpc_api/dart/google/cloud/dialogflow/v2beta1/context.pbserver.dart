...
abstract class ContextsServiceBase extends $pb.GeneratedService {
  $async.Future<ListContextsResponse> listContexts(
      $pb.ServerContext ctx, ListContextsRequest request);
  $async.Future<Context> getContext(
      $pb.ServerContext ctx, GetContextRequest request);
  $async.Future<Context> createContext(
      $pb.ServerContext ctx, CreateContextRequest request);
  $async.Future<Context> updateContext(
      $pb.ServerContext ctx, UpdateContextRequest request);
  $async.Future<$2.Empty> deleteContext(
      $pb.ServerContext ctx, DeleteContextRequest request);
  $async.Future<$2.Empty> deleteAllContexts(
      $pb.ServerContext ctx, DeleteAllContextsRequest request);
  ...
  $core.Map<$core.String, $core.Map<$core.String, $core.dynamic>>
      get $messageJson => ContextsServiceBase$messageJson;
}
