...
class DetectIntentRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('DetectIntentRequest', package: const $pb.PackageName('google.cloud.dialogflow.v2beta1'))
    ..aOS(1, 'session')
    ..a<QueryParameters>(2, 'queryParams', $pb.PbFieldType.OM, QueryParameters.getDefault, QueryParameters.create)
    ..a<QueryInput>(3, 'queryInput', $pb.PbFieldType.OM, QueryInput.getDefault, QueryInput.create)
    ..a<$0.OutputAudioConfig>(4, 'outputAudioConfig', $pb.PbFieldType.OM, $0.OutputAudioConfig.getDefault, $0.OutputAudioConfig.create)
    ..a<$core.List<$core.int>>(5, 'inputAudio', $pb.PbFieldType.OY)
    ..hasRequiredFields = false
  ;

  DetectIntentRequest() : super();
  DetectIntentRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  DetectIntentRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ...
  static DetectIntentRequest getDefault() => _defaultInstance ??= create()..freeze();
  ...
  set outputAudioConfig($0.OutputAudioConfig v) { setField(4, v); }
...
class DetectIntentResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('DetectIntentResponse', package: const $pb.PackageName('google.cloud.dialogflow.v2beta1'))
    ..aOS(1, 'responseId')
    ..a<QueryResult>(2, 'queryResult', $pb.PbFieldType.OM, QueryResult.getDefault, QueryResult.create)
    ..a<$1.Status>(3, 'webhookStatus', $pb.PbFieldType.OM, $1.Status.getDefault, $1.Status.create)
    ..a<$core.List<$core.int>>(4, 'outputAudio', $pb.PbFieldType.OY)
    ..pc<QueryResult>(5, 'alternativeQueryResults', $pb.PbFieldType.PM,QueryResult.create)
    ..a<$0.OutputAudioConfig>(6, 'outputAudioConfig', $pb.PbFieldType.OM, $0.OutputAudioConfig.getDefault, $0.OutputAudioConfig.create)
    ..hasRequiredFields = false
  ;

  DetectIntentResponse() : super();
  DetectIntentResponse.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  DetectIntentResponse.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ...
  static DetectIntentResponse getDefault() => _defaultInstance ??= create()..freeze();
  ...
  set webhookStatus($1.Status v) { setField(3, v); }
  ...
  set outputAudioConfig($0.OutputAudioConfig v) { setField(6, v); }
...
class QueryParameters extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('QueryParameters', package: const $pb.PackageName('google.cloud.dialogflow.v2beta1'))
    ..aOS(1, 'timeZone')
    ..a<$2.LatLng>(2, 'geoLocation', $pb.PbFieldType.OM, $2.LatLng.getDefault, $2.LatLng.create)
    ..pc<$3.Context>(3, 'contexts', $pb.PbFieldType.PM,$3.Context.create)
    ..aOB(4, 'resetContexts')
    ..pc<$4.SessionEntityType>(5, 'sessionEntityTypes', $pb.PbFieldType.PM,$4.SessionEntityType.create)
    ..a<$5.Struct>(6, 'payload', $pb.PbFieldType.OM, $5.Struct.getDefault, $5.Struct.create)
    ..a<SentimentAnalysisRequestConfig>(10, 'sentimentAnalysisRequestConfig', $pb.PbFieldType.OM, SentimentAnalysisRequestConfig.getDefault, SentimentAnalysisRequestConfig.create)
    ..pPS(12, 'knowledgeBaseNames')
    ..hasRequiredFields = false
  ;

  QueryParameters() : super();
  QueryParameters.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  QueryParameters.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ...
  static QueryParameters getDefault() => _defaultInstance ??= create()..freeze();
  ...
  set geoLocation($2.LatLng v) { setField(2, v); }
  ...
  set payload($5.Struct v) { setField(6, v); }
...
class QueryInput extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('QueryInput', package: const $pb.PackageName('google.cloud.dialogflow.v2beta1'))
    ..a<$0.InputAudioConfig>(1, 'audioConfig', $pb.PbFieldType.OM, $0.InputAudioConfig.getDefault, $0.InputAudioConfig.create)
    ..a<TextInput>(2, 'text', $pb.PbFieldType.OM, TextInput.getDefault, TextInput.create)
    ..a<EventInput>(3, 'event', $pb.PbFieldType.OM, EventInput.getDefault, EventInput.create)
    ..oo(0, [1, 2, 3])
    ..hasRequiredFields = false
  ;

  QueryInput() : super();
  QueryInput.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  QueryInput.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ...
  set audioConfig($0.InputAudioConfig v) { setField(1, v); }
...
class QueryResult extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('QueryResult', package: const $pb.PackageName('google.cloud.dialogflow.v2beta1'))
    ..aOS(1, 'queryText')
    ..a<$core.double>(2, 'speechRecognitionConfidence', $pb.PbFieldType.OF)
    ..aOS(3, 'action')
    ..a<$5.Struct>(4, 'parameters', $pb.PbFieldType.OM, $5.Struct.getDefault, $5.Struct.create)
    ..aOB(5, 'allRequiredParamsPresent')
    ..aOS(6, 'fulfillmentText')
    ..pc<$6.Intent_Message>(7, 'fulfillmentMessages', $pb.PbFieldType.PM,$6.Intent_Message.create)
    ..aOS(8, 'webhookSource')
    ..a<$5.Struct>(9, 'webhookPayload', $pb.PbFieldType.OM, $5.Struct.getDefault, $5.Struct.create)
    ..pc<$3.Context>(10, 'outputContexts', $pb.PbFieldType.PM,$3.Context.create)
    ..a<$6.Intent>(11, 'intent', $pb.PbFieldType.OM, $6.Intent.getDefault, $6.Intent.create)
    ..a<$core.double>(12, 'intentDetectionConfidence', $pb.PbFieldType.OF)
    ..a<$5.Struct>(14, 'diagnosticInfo', $pb.PbFieldType.OM, $5.Struct.getDefault, $5.Struct.create)
    ..aOS(15, 'languageCode')
    ..a<SentimentAnalysisResult>(17, 'sentimentAnalysisResult', $pb.PbFieldType.OM, SentimentAnalysisResult.getDefault, SentimentAnalysisResult.create)
    ..a<KnowledgeAnswers>(18, 'knowledgeAnswers', $pb.PbFieldType.OM, KnowledgeAnswers.getDefault, KnowledgeAnswers.create)
    ..hasRequiredFields = false
  ;

  QueryResult() : super();
  QueryResult.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  QueryResult.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ...
  set parameters($5.Struct v) { setField(4, v); }
  ...
  set webhookPayload($5.Struct v) { setField(9, v); }
  ...
  set diagnosticInfo($5.Struct v) { setField(14, v); }
...
class KnowledgeAnswers_Answer extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('KnowledgeAnswers.Answer', package: const $pb.PackageName('google.cloud.dialogflow.v2beta1'))
    ..aOS(1, 'source')
    ..aOS(2, 'faqQuestion')
    ..aOS(3, 'answer')
    ..e<KnowledgeAnswers_Answer_MatchConfidenceLevel>(4, 'matchConfidenceLevel', $pb.PbFieldType.OE, KnowledgeAnswers_Answer_MatchConfidenceLevel.MATCH_CONFIDENCE_LEVEL_UNSPECIFIED, KnowledgeAnswers_Answer_MatchConfidenceLevel.valueOf, KnowledgeAnswers_Answer_MatchConfidenceLevel.values)
    ..a<$core.double>(5, 'matchConfidence', $pb.PbFieldType.OF)
    ..hasRequiredFields = false
  ;

  KnowledgeAnswers_Answer() : super();
  KnowledgeAnswers_Answer.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  KnowledgeAnswers_Answer.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ...
  static KnowledgeAnswers_Answer getDefault() => _defaultInstance ??= create()..freeze();
...
class KnowledgeAnswers extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('KnowledgeAnswers', package: const $pb.PackageName('google.cloud.dialogflow.v2beta1'))
    ..pc<KnowledgeAnswers_Answer>(1, 'answers', $pb.PbFieldType.PM,KnowledgeAnswers_Answer.create)
    ..hasRequiredFields = false
  ;

  KnowledgeAnswers() : super();
  KnowledgeAnswers.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  KnowledgeAnswers.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ...
  static KnowledgeAnswers getDefault() => _defaultInstance ??= create()..freeze();
...
class StreamingDetectIntentRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('StreamingDetectIntentRequest', package: const $pb.PackageName('google.cloud.dialogflow.v2beta1'))
    ..aOS(1, 'session')
    ..a<QueryParameters>(2, 'queryParams', $pb.PbFieldType.OM, QueryParameters.getDefault, QueryParameters.create)
    ..a<QueryInput>(3, 'queryInput', $pb.PbFieldType.OM, QueryInput.getDefault, QueryInput.create)
    ..aOB(4, 'singleUtterance')
    ..a<$0.OutputAudioConfig>(5, 'outputAudioConfig', $pb.PbFieldType.OM, $0.OutputAudioConfig.getDefault, $0.OutputAudioConfig.create)
    ..a<$core.List<$core.int>>(6, 'inputAudio', $pb.PbFieldType.OY)
    ..hasRequiredFields = false
  ;

  StreamingDetectIntentRequest() : super();
  StreamingDetectIntentRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  StreamingDetectIntentRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ...
  $pb.BuilderInfo get info_ => _i;
  static StreamingDetectIntentRequest create() => StreamingDetectIntentRequest();
  ...
  static StreamingDetectIntentRequest getDefault() => _defaultInstance ??= create()..freeze();
  ...
  set outputAudioConfig($0.OutputAudioConfig v) { setField(5, v); }
...
class StreamingDetectIntentResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('StreamingDetectIntentResponse', package: const $pb.PackageName('google.cloud.dialogflow.v2beta1'))
    ..aOS(1, 'responseId')
    ..a<StreamingRecognitionResult>(2, 'recognitionResult', $pb.PbFieldType.OM, StreamingRecognitionResult.getDefault, StreamingRecognitionResult.create)
    ..a<QueryResult>(3, 'queryResult', $pb.PbFieldType.OM, QueryResult.getDefault, QueryResult.create)
    ..a<$1.Status>(4, 'webhookStatus', $pb.PbFieldType.OM, $1.Status.getDefault, $1.Status.create)
    ..a<$core.List<$core.int>>(5, 'outputAudio', $pb.PbFieldType.OY)
    ..a<$0.OutputAudioConfig>(6, 'outputAudioConfig', $pb.PbFieldType.OM, $0.OutputAudioConfig.getDefault, $0.OutputAudioConfig.create)
    ..pc<QueryResult>(7, 'alternativeQueryResults', $pb.PbFieldType.PM,QueryResult.create)
    ..hasRequiredFields = false
  ;

  StreamingDetectIntentResponse() : super();
  StreamingDetectIntentResponse.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  StreamingDetectIntentResponse.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ...
  $pb.BuilderInfo get info_ => _i;
  static StreamingDetectIntentResponse create() => StreamingDetectIntentResponse();
  ...
  static StreamingDetectIntentResponse getDefault() => _defaultInstance ??= create()..freeze();
  ...
  set webhookStatus($1.Status v) { setField(4, v); }
...
class StreamingRecognitionResult extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('StreamingRecognitionResult', package: const $pb.PackageName('google.cloud.dialogflow.v2beta1'))
    ..e<StreamingRecognitionResult_MessageType>(1, 'messageType', $pb.PbFieldType.OE, StreamingRecognitionResult_MessageType.MESSAGE_TYPE_UNSPECIFIED, StreamingRecognitionResult_MessageType.valueOf, StreamingRecognitionResult_MessageType.values)
    ..aOS(2, 'transcript')
    ..aOB(3, 'isFinal')
  ...
  StreamingRecognitionResult.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  StreamingRecognitionResult.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ...
  static StreamingRecognitionResult getDefault() => _defaultInstance ??= create()..freeze();
...
class TextInput extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('TextInput', package: const $pb.PackageName('google.cloud.dialogflow.v2beta1'))
    ..aOS(1, 'text')
    ..aOS(2, 'languageCode')
    ..hasRequiredFields = false
  ;
...
class EventInput extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('EventInput', package: const $pb.PackageName('google.cloud.dialogflow.v2beta1'))
    ..aOS(1, 'name')
    ..a<$5.Struct>(2, 'parameters', $pb.PbFieldType.OM, $5.Struct.getDefault, $5.Struct.create)
    ..aOS(3, 'languageCode')
    ..hasRequiredFields = false
  ;

  EventInput() : super();
  EventInput.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  EventInput.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
...
class SentimentAnalysisRequestConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('SentimentAnalysisRequestConfig', package: const $pb.PackageName('google.cloud.dialogflow.v2beta1'))
    ..aOB(1, 'analyzeQueryTextSentiment')
    ..hasRequiredFields = false
  ;

  SentimentAnalysisRequestConfig() : super();
  SentimentAnalysisRequestConfig.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  SentimentAnalysisRequestConfig.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ...
  $pb.BuilderInfo get info_ => _i;
  static SentimentAnalysisRequestConfig create() => SentimentAnalysisRequestConfig();
  ...
  static SentimentAnalysisRequestConfig getDefault() => _defaultInstance ??= create()..freeze();
...
class SentimentAnalysisResult extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('SentimentAnalysisResult', package: const $pb.PackageName('google.cloud.dialogflow.v2beta1'))
    ..a<Sentiment>(1, 'queryTextSentiment', $pb.PbFieldType.OM, Sentiment.getDefault, Sentiment.create)
    ..hasRequiredFields = false
  ;

  SentimentAnalysisResult() : super();
  SentimentAnalysisResult.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  SentimentAnalysisResult.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ...
  static SentimentAnalysisResult getDefault() => _defaultInstance ??= create()..freeze();
...
class Sentiment extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Sentiment', package: const $pb.PackageName('google.cloud.dialogflow.v2beta1'))
  ...
  Sentiment() : super();
  Sentiment.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  Sentiment.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
...
class SessionsApi {
  ...
  $async.Future<DetectIntentResponse> detectIntent($pb.ClientContext ctx, DetectIntentRequest request) {
  ...
  $async.Future<StreamingDetectIntentResponse> streamingDetectIntent($pb.ClientContext ctx, StreamingDetectIntentRequest request) {
