...
class ListContextsRequest extends GeneratedMessage {
  ...
  ListContextsRequest.fromBuffer(List<int> i,
      [ExtensionRegistry r = ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);
...
class _ReadonlyListContextsRequest extends ListContextsRequest
...
class ListContextsResponse extends GeneratedMessage {
  ...
  ListContextsResponse.fromBuffer(List<int> i,
      [ExtensionRegistry r = ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);
  ListContextsResponse.fromJson(String i,
      [ExtensionRegistry r = ExtensionRegistry.EMPTY])
      : super.fromJson(i, r);
...
class _ReadonlyListContextsResponse extends ListContextsResponse
    with ReadonlyMessageMixin {}
...
class GetContextRequest extends GeneratedMessage {
  ...
  GetContextRequest.fromBuffer(List<int> i,
      [ExtensionRegistry r = ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);
...
class _ReadonlyGetContextRequest extends GetContextRequest
    with ReadonlyMessageMixin {}
...
class CreateContextRequest extends GeneratedMessage {
  ...
  CreateContextRequest.fromBuffer(List<int> i,
      [ExtensionRegistry r = ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);
  CreateContextRequest.fromJson(String i,
      [ExtensionRegistry r = ExtensionRegistry.EMPTY])
      : super.fromJson(i, r);
...
class _ReadonlyCreateContextRequest extends CreateContextRequest
    with ReadonlyMessageMixin {}
...
class UpdateContextRequest extends GeneratedMessage {
  ...
  UpdateContextRequest.fromBuffer(List<int> i,
      [ExtensionRegistry r = ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);
  UpdateContextRequest.fromJson(String i,
      [ExtensionRegistry r = ExtensionRegistry.EMPTY])
      : super.fromJson(i, r);
...
class _ReadonlyUpdateContextRequest extends UpdateContextRequest
    with ReadonlyMessageMixin {}
...
class DeleteContextRequest extends GeneratedMessage {
  ...
  DeleteContextRequest.fromBuffer(List<int> i,
      [ExtensionRegistry r = ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);
  DeleteContextRequest.fromJson(String i,
      [ExtensionRegistry r = ExtensionRegistry.EMPTY])
      : super.fromJson(i, r);
...
class _ReadonlyDeleteContextRequest extends DeleteContextRequest
    with ReadonlyMessageMixin {}
...
class DeleteAllContextsRequest extends GeneratedMessage {
  ...
  DeleteAllContextsRequest.fromBuffer(List<int> i,
      [ExtensionRegistry r = ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);
  DeleteAllContextsRequest.fromJson(String i,
      [ExtensionRegistry r = ExtensionRegistry.EMPTY])
      : super.fromJson(i, r);
  ...
  static void $checkItem(DeleteAllContextsRequest v) {
    if (v is! DeleteAllContextsRequest)
      checkItemFailed(v, 'DeleteAllContextsRequest');
  }
...
class _ReadonlyDeleteAllContextsRequest extends DeleteAllContextsRequest
    with ReadonlyMessageMixin {}
