...
const Intent$json = const {
  ...
  '2': const [
    ...
    const {'1': 'webhook_state', '3': 6, '4': 1, '5': 14, '6': '.google.cloud.dialogflow.v2beta1.Intent.WebhookState', '10': 'webhookState'},
    ...
    const {'1': 'end_interaction', '3': 21, '4': 1, '5': 8, '10': 'endInteraction'},
    const {'1': 'input_context_names', '3': 7, '4': 3, '5': 9, '10': 'inputContextNames'},
    const {'1': 'events', '3': 8, '4': 3, '5': 9, '10': 'events'},
    const {'1': 'training_phrases', '3': 9, '4': 3, '5': 11, '6': '.google.cloud.dialogflow.v2beta1.Intent.TrainingPhrase', '10': 'trainingPhrases'},
    const {'1': 'action', '3': 10, '4': 1, '5': 9, '10': 'action'},
    const {'1': 'output_contexts', '3': 11, '4': 3, '5': 11, '6': '.google.cloud.dialogflow.v2beta1.Context', '10': 'outputContexts'},
    const {'1': 'reset_contexts', '3': 12, '4': 1, '5': 8, '10': 'resetContexts'},
    const {'1': 'parameters', '3': 13, '4': 3, '5': 11, '6': '.google.cloud.dialogflow.v2beta1.Intent.Parameter', '10': 'parameters'},
    const {'1': 'messages', '3': 14, '4': 3, '5': 11, '6': '.google.cloud.dialogflow.v2beta1.Intent.Message', '10': 'messages'},
    const {'1': 'default_response_platforms', '3': 15, '4': 3, '5': 14, '6': '.google.cloud.dialogflow.v2beta1.Intent.Message.Platform', '10': 'defaultResponsePlatforms'},
    ...
    const {'1': 'followup_intent_info', '3': 18, '4': 3, '5': 11, '6': '.google.cloud.dialogflow.v2beta1.Intent.FollowupIntentInfo', '10': 'followupIntentInfo'},
  ],
...
const Intent_TrainingPhrase$json = const {
  ...
  '2': const [
    const {'1': 'name', '3': 1, '4': 1, '5': 9, '10': 'name'},
    const {'1': 'type', '3': 2, '4': 1, '5': 14, '6': '.google.cloud.dialogflow.v2beta1.Intent.TrainingPhrase.Type', '10': 'type'},
    const {'1': 'parts', '3': 3, '4': 3, '5': 11, '6': '.google.cloud.dialogflow.v2beta1.Intent.TrainingPhrase.Part', '10': 'parts'},
...
const CreateIntentRequest$json = const {
  ...
  '2': const [
    const {'1': 'parent', '3': 1, '4': 1, '5': 9, '10': 'parent'},
    const {'1': 'intent', '3': 2, '4': 1, '5': 11, '6': '.google.cloud.dialogflow.v2beta1.Intent', '10': 'intent'},
...
const UpdateIntentRequest$json = const {
  ...
  '2': const [
    const {'1': 'intent', '3': 1, '4': 1, '5': 11, '6': '.google.cloud.dialogflow.v2beta1.Intent', '10': 'intent'},
    const {'1': 'language_code', '3': 2, '4': 1, '5': 9, '10': 'languageCode'},
...
const BatchDeleteIntentsRequest$json = const {
  ...
  '2': const [
    const {'1': 'parent', '3': 1, '4': 1, '5': 9, '10': 'parent'},
    const {'1': 'intents', '3': 2, '4': 3, '5': 11, '6': '.google.cloud.dialogflow.v2beta1.Intent', '10': 'intents'},
  ],
};
...
const IntentsServiceBase$json = const {
  '1': 'Intents',
  '2': const [
    const {'1': 'ListIntents', '2': '.google.cloud.dialogflow.v2beta1.ListIntentsRequest', '3': '.google.cloud.dialogflow.v2beta1.ListIntentsResponse', '4': const {}},
    const {'1': 'GetIntent', '2': '.google.cloud.dialogflow.v2beta1.GetIntentRequest', '3': '.google.cloud.dialogflow.v2beta1.Intent', '4': const {}},
    const {'1': 'CreateIntent', '2': '.google.cloud.dialogflow.v2beta1.CreateIntentRequest', '3': '.google.cloud.dialogflow.v2beta1.Intent', '4': const {}},
    const {'1': 'UpdateIntent', '2': '.google.cloud.dialogflow.v2beta1.UpdateIntentRequest', '3': '.google.cloud.dialogflow.v2beta1.Intent', '4': const {}},
    const {'1': 'DeleteIntent', '2': '.google.cloud.dialogflow.v2beta1.DeleteIntentRequest', '3': '.google.protobuf.Empty', '4': const {}},
    const {'1': 'BatchUpdateIntents', '2': '.google.cloud.dialogflow.v2beta1.BatchUpdateIntentsRequest', '3': '.google.longrunning.Operation', '4': const {}},
    const {'1': 'BatchDeleteIntents', '2': '.google.cloud.dialogflow.v2beta1.BatchDeleteIntentsRequest', '3': '.google.longrunning.Operation', '4': const {}},
  ],
};

const IntentsServiceBase$messageJson = const {
  '.google.cloud.dialogflow.v2beta1.ListIntentsRequest': ListIntentsRequest$json,
  '.google.cloud.dialogflow.v2beta1.ListIntentsResponse': ListIntentsResponse$json,
  '.google.cloud.dialogflow.v2beta1.Intent': Intent$json,
  '.google.cloud.dialogflow.v2beta1.Intent.TrainingPhrase': Intent_TrainingPhrase$json,
  '.google.cloud.dialogflow.v2beta1.Intent.TrainingPhrase.Part': Intent_TrainingPhrase_Part$json,
  '.google.cloud.dialogflow.v2beta1.Context': $0.Context$json,
  ...
  '.google.cloud.dialogflow.v2beta1.Intent.Message.Text': Intent_Message_Text$json,
  '.google.cloud.dialogflow.v2beta1.Intent.Message.Image': Intent_Message_Image$json,
  '.google.cloud.dialogflow.v2beta1.Intent.Message.QuickReplies': Intent_Message_QuickReplies$json,
  '.google.cloud.dialogflow.v2beta1.Intent.Message.Card': Intent_Message_Card$json,
  '.google.cloud.dialogflow.v2beta1.Intent.Message.Card.Button': Intent_Message_Card_Button$json,
  '.google.cloud.dialogflow.v2beta1.Intent.Message.SimpleResponses': Intent_Message_SimpleResponses$json,
  '.google.cloud.dialogflow.v2beta1.Intent.Message.SimpleResponse': Intent_Message_SimpleResponse$json,
  '.google.cloud.dialogflow.v2beta1.Intent.Message.BasicCard': Intent_Message_BasicCard$json,
  '.google.cloud.dialogflow.v2beta1.Intent.Message.BasicCard.Button': Intent_Message_BasicCard_Button$json,
  '.google.cloud.dialogflow.v2beta1.Intent.Message.BasicCard.Button.OpenUriAction': Intent_Message_BasicCard_Button_OpenUriAction$json,
  '.google.cloud.dialogflow.v2beta1.Intent.Message.Suggestions': Intent_Message_Suggestions$json,
  '.google.cloud.dialogflow.v2beta1.Intent.Message.Suggestion': Intent_Message_Suggestion$json,
  '.google.cloud.dialogflow.v2beta1.Intent.Message.LinkOutSuggestion': Intent_Message_LinkOutSuggestion$json,
  '.google.cloud.dialogflow.v2beta1.Intent.Message.ListSelect': Intent_Message_ListSelect$json,
  '.google.cloud.dialogflow.v2beta1.Intent.Message.ListSelect.Item': Intent_Message_ListSelect_Item$json,
  '.google.cloud.dialogflow.v2beta1.Intent.Message.SelectItemInfo': Intent_Message_SelectItemInfo$json,
  '.google.cloud.dialogflow.v2beta1.Intent.Message.CarouselSelect': Intent_Message_CarouselSelect$json,
  '.google.cloud.dialogflow.v2beta1.Intent.Message.CarouselSelect.Item': Intent_Message_CarouselSelect_Item$json,
  '.google.cloud.dialogflow.v2beta1.Intent.Message.TelephonyPlayAudio': Intent_Message_TelephonyPlayAudio$json,
  '.google.cloud.dialogflow.v2beta1.Intent.Message.TelephonySynthesizeSpeech': Intent_Message_TelephonySynthesizeSpeech$json,
  '.google.cloud.dialogflow.v2beta1.Intent.Message.TelephonyTransferCall': Intent_Message_TelephonyTransferCall$json,
  '.google.cloud.dialogflow.v2beta1.Intent.FollowupIntentInfo': Intent_FollowupIntentInfo$json,
  '.google.cloud.dialogflow.v2beta1.GetIntentRequest': GetIntentRequest$json,
  '.google.cloud.dialogflow.v2beta1.CreateIntentRequest': CreateIntentRequest$json,
  '.google.cloud.dialogflow.v2beta1.UpdateIntentRequest': UpdateIntentRequest$json,
  '.google.protobuf.FieldMask': $2.FieldMask$json,
  '.google.cloud.dialogflow.v2beta1.DeleteIntentRequest': DeleteIntentRequest$json,
  '.google.protobuf.Empty': $3.Empty$json,
  '.google.cloud.dialogflow.v2beta1.BatchUpdateIntentsRequest': BatchUpdateIntentsRequest$json,
  '.google.cloud.dialogflow.v2beta1.IntentBatch': IntentBatch$json,
  '.google.longrunning.Operation': $4.Operation$json,
  '.google.protobuf.Any': $5.Any$json,
  '.google.rpc.Status': $6.Status$json,
  '.google.cloud.dialogflow.v2beta1.BatchDeleteIntentsRequest': BatchDeleteIntentsRequest$json,
};
