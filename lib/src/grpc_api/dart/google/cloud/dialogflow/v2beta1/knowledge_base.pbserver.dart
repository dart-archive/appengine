...
abstract class KnowledgeBasesServiceBase extends $pb.GeneratedService {
  $async.Future<ListKnowledgeBasesResponse> listKnowledgeBases(
      $pb.ServerContext ctx, ListKnowledgeBasesRequest request);
  $async.Future<KnowledgeBase> getKnowledgeBase(
      $pb.ServerContext ctx, GetKnowledgeBaseRequest request);
  $async.Future<KnowledgeBase> createKnowledgeBase(
      $pb.ServerContext ctx, CreateKnowledgeBaseRequest request);
  $async.Future<$1.Empty> deleteKnowledgeBase(
      $pb.ServerContext ctx, DeleteKnowledgeBaseRequest request);
  $async.Future<KnowledgeBase> updateKnowledgeBase(
      $pb.ServerContext ctx, UpdateKnowledgeBaseRequest request);
  ...
  $async.Future<$pb.GeneratedMessage> handleCall($pb.ServerContext ctx,
    ...
    switch (method) {
      case 'ListKnowledgeBases':
        return this.listKnowledgeBases(ctx, request);
      case 'GetKnowledgeBase':
        return this.getKnowledgeBase(ctx, request);
      case 'CreateKnowledgeBase':
        return this.createKnowledgeBase(ctx, request);
      case 'DeleteKnowledgeBase':
        return this.deleteKnowledgeBase(ctx, request);
      case 'UpdateKnowledgeBase':
        return this.updateKnowledgeBase(ctx, request);
      default:
        throw $core.ArgumentError('Unknown method: $method');
    }
  }
  ...
  $core.Map<$core.String, $core.dynamic> get $json =>
      KnowledgeBasesServiceBase$json;
  $core.Map<$core.String, $core.Map<$core.String, $core.dynamic>>
      get $messageJson => KnowledgeBasesServiceBase$messageJson;
}
