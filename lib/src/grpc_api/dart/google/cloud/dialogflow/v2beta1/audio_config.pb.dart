...
class InputAudioConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('InputAudioConfig', package: const $pb.PackageName('google.cloud.dialogflow.v2beta1'))
    ...
    ..pPS(4, 'phraseHints')
    ..aOS(7, 'model')
    ..e<SpeechModelVariant>(10, 'modelVariant', $pb.PbFieldType.OE, SpeechModelVariant.SPEECH_MODEL_VARIANT_UNSPECIFIED, SpeechModelVariant.valueOf, SpeechModelVariant.values)
    ..hasRequiredFields = false
  ;

  InputAudioConfig() : super();
  InputAudioConfig.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  InputAudioConfig.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ...
  static InputAudioConfig getDefault() => _defaultInstance ??= create()..freeze();
...
class VoiceSelectionParams extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('VoiceSelectionParams', package: const $pb.PackageName('google.cloud.dialogflow.v2beta1'))
    ..aOS(1, 'name')
    ..e<SsmlVoiceGender>(2, 'ssmlGender', $pb.PbFieldType.OE, SsmlVoiceGender.SSML_VOICE_GENDER_UNSPECIFIED, SsmlVoiceGender.valueOf, SsmlVoiceGender.values)
    ..hasRequiredFields = false
  ;
...
class SynthesizeSpeechConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('SynthesizeSpeechConfig', package: const $pb.PackageName('google.cloud.dialogflow.v2beta1'))
    ...
    ..a<VoiceSelectionParams>(4, 'voice', $pb.PbFieldType.OM, VoiceSelectionParams.getDefault, VoiceSelectionParams.create)
    ..pPS(5, 'effectsProfileId')
    ..hasRequiredFields = false
  ;

  SynthesizeSpeechConfig() : super();
  SynthesizeSpeechConfig.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  SynthesizeSpeechConfig.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ...
  static SynthesizeSpeechConfig getDefault() => _defaultInstance ??= create()..freeze();
...
class OutputAudioConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('OutputAudioConfig', package: const $pb.PackageName('google.cloud.dialogflow.v2beta1'))
    ..e<OutputAudioEncoding>(1, 'audioEncoding', $pb.PbFieldType.OE, OutputAudioEncoding.OUTPUT_AUDIO_ENCODING_UNSPECIFIED, OutputAudioEncoding.valueOf, OutputAudioEncoding.values)
    ..a<$core.int>(2, 'sampleRateHertz', $pb.PbFieldType.O3)
    ..a<SynthesizeSpeechConfig>(3, 'synthesizeSpeechConfig', $pb.PbFieldType.OM, SynthesizeSpeechConfig.getDefault, SynthesizeSpeechConfig.create)
    ..hasRequiredFields = false
  ;

  OutputAudioConfig() : super();
  OutputAudioConfig.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  OutputAudioConfig.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ...
  static OutputAudioConfig getDefault() => _defaultInstance ??= create()..freeze();
