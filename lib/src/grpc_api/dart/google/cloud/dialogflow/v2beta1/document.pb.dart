...
class Document extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Document', package: const $pb.PackageName('google.cloud.dialogflow.v2beta1'))
    ..aOS(1, 'name')
    ..aOS(2, 'displayName')
    ..aOS(3, 'mimeType')
    ..pc<Document_KnowledgeType>(4, 'knowledgeTypes', $pb.PbFieldType.PE, null, Document_KnowledgeType.valueOf, Document_KnowledgeType.values)
    ..aOS(5, 'contentUri')
    ..aOS(6, 'content')
...
class ListDocumentsRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ListDocumentsRequest', package: const $pb.PackageName('google.cloud.dialogflow.v2beta1'))
    ..aOS(1, 'parent')
...
class ListDocumentsResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ListDocumentsResponse', package: const $pb.PackageName('google.cloud.dialogflow.v2beta1'))
...
class GetDocumentRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('GetDocumentRequest', package: const $pb.PackageName('google.cloud.dialogflow.v2beta1'))
    ..aOS(1, 'name')
    ..hasRequiredFields = false
  ;
...
class CreateDocumentRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('CreateDocumentRequest', package: const $pb.PackageName('google.cloud.dialogflow.v2beta1'))
    ..aOS(1, 'parent')
...
class DeleteDocumentRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('DeleteDocumentRequest', package: const $pb.PackageName('google.cloud.dialogflow.v2beta1'))
    ..aOS(1, 'name')
    ..hasRequiredFields = false
  ;
...
class UpdateDocumentRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('UpdateDocumentRequest', package: const $pb.PackageName('google.cloud.dialogflow.v2beta1'))
...
class KnowledgeOperationMetadata extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('KnowledgeOperationMetadata', package: const $pb.PackageName('google.cloud.dialogflow.v2beta1'))
    ..e<KnowledgeOperationMetadata_State>(1, 'state', $pb.PbFieldType.OE, KnowledgeOperationMetadata_State.STATE_UNSPECIFIED, KnowledgeOperationMetadata_State.valueOf, KnowledgeOperationMetadata_State.values)
    ..hasRequiredFields = false
  ;

  KnowledgeOperationMetadata() : super();
  KnowledgeOperationMetadata.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  KnowledgeOperationMetadata.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ...
  static KnowledgeOperationMetadata getDefault() => _defaultInstance ??= create()..freeze();
...
class ReloadDocumentRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ReloadDocumentRequest', package: const $pb.PackageName('google.cloud.dialogflow.v2beta1'))
    ..aOS(1, 'name')
    ..hasRequiredFields = false
  ;

  ReloadDocumentRequest() : super();
  ReloadDocumentRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  ReloadDocumentRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ...
  static ReloadDocumentRequest getDefault() => _defaultInstance ??= create()..freeze();
...
class DocumentsApi {
  ...
  $async.Future<ListDocumentsResponse> listDocuments($pb.ClientContext ctx, ListDocumentsRequest request) {
    ...
    return _client.invoke<ListDocumentsResponse>(ctx, 'Documents', 'ListDocuments', request, emptyResponse);
  }
  $async.Future<Document> getDocument($pb.ClientContext ctx, GetDocumentRequest request) {
    var emptyResponse = Document();
    return _client.invoke<Document>(ctx, 'Documents', 'GetDocument', request, emptyResponse);
  }
  $async.Future<$1.Operation> createDocument($pb.ClientContext ctx, CreateDocumentRequest request) {
    var emptyResponse = $1.Operation();
    return _client.invoke<$1.Operation>(ctx, 'Documents', 'CreateDocument', request, emptyResponse);
  }
  $async.Future<$1.Operation> deleteDocument($pb.ClientContext ctx, DeleteDocumentRequest request) {
    var emptyResponse = $1.Operation();
    return _client.invoke<$1.Operation>(ctx, 'Documents', 'DeleteDocument', request, emptyResponse);
  }
  $async.Future<$1.Operation> updateDocument($pb.ClientContext ctx, UpdateDocumentRequest request) {
    var emptyResponse = $1.Operation();
    return _client.invoke<$1.Operation>(ctx, 'Documents', 'UpdateDocument', request, emptyResponse);
  }
  $async.Future<$1.Operation> reloadDocument($pb.ClientContext ctx, ReloadDocumentRequest request) {
    var emptyResponse = $1.Operation();
    return _client.invoke<$1.Operation>(ctx, 'Documents', 'ReloadDocument', request, emptyResponse);
  }
}
