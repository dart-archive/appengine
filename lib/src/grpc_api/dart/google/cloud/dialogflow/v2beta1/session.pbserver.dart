...
abstract class SessionsServiceBase extends GeneratedService {
  Future<DetectIntentResponse> detectIntent(ServerContext ctx, DetectIntentRequest request);
  Future<StreamingDetectIntentResponse> streamingDetectIntent(ServerContext ctx, StreamingDetectIntentRequest request);

  GeneratedMessage createRequest(String method) {
    switch (method) {
      case 'DetectIntent': return new DetectIntentRequest();
      case 'StreamingDetectIntent': return new StreamingDetectIntentRequest();
