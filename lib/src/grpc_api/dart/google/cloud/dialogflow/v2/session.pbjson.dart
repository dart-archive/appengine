...
const Sessions$json = const {
  ...
  '2': const [
    ...
    const {'1': 'StreamingDetectIntent', '2': '.google.cloud.dialogflow.v2.StreamingDetectIntentRequest', '3': '.google.cloud.dialogflow.v2.StreamingDetectIntentResponse', '5': true, '6': true},
  ],
};
