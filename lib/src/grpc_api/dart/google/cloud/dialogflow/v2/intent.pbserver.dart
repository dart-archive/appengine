...
abstract class IntentsServiceBase extends GeneratedService {
  ...
  Future<GeneratedMessage> handleCall(
    ...
    switch (method) {
      ...
      case 'GetIntent':
        return this.getIntent(ctx, request);
      case 'CreateIntent':
        return this.createIntent(ctx, request);
      case 'UpdateIntent':
        return this.updateIntent(ctx, request);
      case 'DeleteIntent':
        return this.deleteIntent(ctx, request);
      case 'BatchUpdateIntents':
        return this.batchUpdateIntents(ctx, request);
      case 'BatchDeleteIntents':
