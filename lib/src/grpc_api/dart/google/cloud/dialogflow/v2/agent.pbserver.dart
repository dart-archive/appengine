...
abstract class AgentsServiceBase extends $pb.GeneratedService {
  ...
  $async.Future<SearchAgentsResponse> searchAgents(
      $pb.ServerContext ctx, SearchAgentsRequest request);
  $async.Future<$0.Operation> trainAgent(
      $pb.ServerContext ctx, TrainAgentRequest request);
  $async.Future<$0.Operation> exportAgent(
      $pb.ServerContext ctx, ExportAgentRequest request);
  $async.Future<$0.Operation> importAgent(
      $pb.ServerContext ctx, ImportAgentRequest request);
  $async.Future<$0.Operation> restoreAgent(
      $pb.ServerContext ctx, RestoreAgentRequest request);
  ...
  $core.Map<$core.String, $core.Map<$core.String, $core.dynamic>>
      get $messageJson => AgentsServiceBase$messageJson;
}
