...
class Document_Type extends $pb.ProtobufEnum {
  static const Document_Type TYPE_UNSPECIFIED = Document_Type._(0, 'TYPE_UNSPECIFIED');
...
class PartOfSpeech_Aspect extends $pb.ProtobufEnum {
  static const PartOfSpeech_Aspect ASPECT_UNKNOWN = PartOfSpeech_Aspect._(0, 'ASPECT_UNKNOWN');
  static const PartOfSpeech_Aspect PERFECTIVE = PartOfSpeech_Aspect._(1, 'PERFECTIVE');
  static const PartOfSpeech_Aspect IMPERFECTIVE = PartOfSpeech_Aspect._(2, 'IMPERFECTIVE');
  static const PartOfSpeech_Aspect PROGRESSIVE = PartOfSpeech_Aspect._(3, 'PROGRESSIVE');
...
class PartOfSpeech_Case extends $pb.ProtobufEnum {
  static const PartOfSpeech_Case CASE_UNKNOWN = PartOfSpeech_Case._(0, 'CASE_UNKNOWN');
  static const PartOfSpeech_Case ACCUSATIVE = PartOfSpeech_Case._(1, 'ACCUSATIVE');
  static const PartOfSpeech_Case ADVERBIAL = PartOfSpeech_Case._(2, 'ADVERBIAL');
  static const PartOfSpeech_Case COMPLEMENTIVE = PartOfSpeech_Case._(3, 'COMPLEMENTIVE');
  ...
  static const PartOfSpeech_Case INSTRUMENTAL = PartOfSpeech_Case._(6, 'INSTRUMENTAL');
  static const PartOfSpeech_Case LOCATIVE = PartOfSpeech_Case._(7, 'LOCATIVE');
  static const PartOfSpeech_Case NOMINATIVE = PartOfSpeech_Case._(8, 'NOMINATIVE');
  static const PartOfSpeech_Case OBLIQUE = PartOfSpeech_Case._(9, 'OBLIQUE');
  static const PartOfSpeech_Case PARTITIVE = PartOfSpeech_Case._(10, 'PARTITIVE');
  static const PartOfSpeech_Case PREPOSITIONAL = PartOfSpeech_Case._(11, 'PREPOSITIONAL');
  static const PartOfSpeech_Case REFLEXIVE_CASE = PartOfSpeech_Case._(12, 'REFLEXIVE_CASE');
  static const PartOfSpeech_Case RELATIVE_CASE = PartOfSpeech_Case._(13, 'RELATIVE_CASE');
...
class PartOfSpeech_Form extends $pb.ProtobufEnum {
  static const PartOfSpeech_Form FORM_UNKNOWN = PartOfSpeech_Form._(0, 'FORM_UNKNOWN');
  static const PartOfSpeech_Form ADNOMIAL = PartOfSpeech_Form._(1, 'ADNOMIAL');
  static const PartOfSpeech_Form AUXILIARY = PartOfSpeech_Form._(2, 'AUXILIARY');
  static const PartOfSpeech_Form COMPLEMENTIZER = PartOfSpeech_Form._(3, 'COMPLEMENTIZER');
  static const PartOfSpeech_Form FINAL_ENDING = PartOfSpeech_Form._(4, 'FINAL_ENDING');
...
class PartOfSpeech_Gender extends $pb.ProtobufEnum {
  static const PartOfSpeech_Gender GENDER_UNKNOWN = PartOfSpeech_Gender._(0, 'GENDER_UNKNOWN');
  static const PartOfSpeech_Gender FEMININE = PartOfSpeech_Gender._(1, 'FEMININE');
  static const PartOfSpeech_Gender MASCULINE = PartOfSpeech_Gender._(2, 'MASCULINE');
...
class PartOfSpeech_Mood extends $pb.ProtobufEnum {
  static const PartOfSpeech_Mood MOOD_UNKNOWN = PartOfSpeech_Mood._(0, 'MOOD_UNKNOWN');
  static const PartOfSpeech_Mood CONDITIONAL_MOOD = PartOfSpeech_Mood._(1, 'CONDITIONAL_MOOD');
  static const PartOfSpeech_Mood IMPERATIVE = PartOfSpeech_Mood._(2, 'IMPERATIVE');
  static const PartOfSpeech_Mood INDICATIVE = PartOfSpeech_Mood._(3, 'INDICATIVE');
  static const PartOfSpeech_Mood INTERROGATIVE = PartOfSpeech_Mood._(4, 'INTERROGATIVE');
  static const PartOfSpeech_Mood JUSSIVE = PartOfSpeech_Mood._(5, 'JUSSIVE');
  static const PartOfSpeech_Mood SUBJUNCTIVE = PartOfSpeech_Mood._(6, 'SUBJUNCTIVE');
...
class PartOfSpeech_Number extends $pb.ProtobufEnum {
  static const PartOfSpeech_Number NUMBER_UNKNOWN = PartOfSpeech_Number._(0, 'NUMBER_UNKNOWN');
  static const PartOfSpeech_Number SINGULAR = PartOfSpeech_Number._(1, 'SINGULAR');
...
class PartOfSpeech_Person extends $pb.ProtobufEnum {
  static const PartOfSpeech_Person PERSON_UNKNOWN = PartOfSpeech_Person._(0, 'PERSON_UNKNOWN');
  ...
  static const PartOfSpeech_Person REFLEXIVE_PERSON = PartOfSpeech_Person._(4, 'REFLEXIVE_PERSON');
...
class PartOfSpeech_Proper extends $pb.ProtobufEnum {
  static const PartOfSpeech_Proper PROPER_UNKNOWN = PartOfSpeech_Proper._(0, 'PROPER_UNKNOWN');
  static const PartOfSpeech_Proper PROPER = PartOfSpeech_Proper._(1, 'PROPER');
  static const PartOfSpeech_Proper NOT_PROPER = PartOfSpeech_Proper._(2, 'NOT_PROPER');
...
class PartOfSpeech_Reciprocity extends $pb.ProtobufEnum {
  static const PartOfSpeech_Reciprocity RECIPROCITY_UNKNOWN = PartOfSpeech_Reciprocity._(0, 'RECIPROCITY_UNKNOWN');
  static const PartOfSpeech_Reciprocity RECIPROCAL = PartOfSpeech_Reciprocity._(1, 'RECIPROCAL');
  static const PartOfSpeech_Reciprocity NON_RECIPROCAL = PartOfSpeech_Reciprocity._(2, 'NON_RECIPROCAL');
...
class PartOfSpeech_Tense extends $pb.ProtobufEnum {
  static const PartOfSpeech_Tense TENSE_UNKNOWN = PartOfSpeech_Tense._(0, 'TENSE_UNKNOWN');
  static const PartOfSpeech_Tense CONDITIONAL_TENSE = PartOfSpeech_Tense._(1, 'CONDITIONAL_TENSE');
  ...
  static const PartOfSpeech_Tense IMPERFECT = PartOfSpeech_Tense._(5, 'IMPERFECT');
  static const PartOfSpeech_Tense PLUPERFECT = PartOfSpeech_Tense._(6, 'PLUPERFECT');
...
class PartOfSpeech_Voice extends $pb.ProtobufEnum {
  static const PartOfSpeech_Voice VOICE_UNKNOWN = PartOfSpeech_Voice._(0, 'VOICE_UNKNOWN');
  static const PartOfSpeech_Voice ACTIVE = PartOfSpeech_Voice._(1, 'ACTIVE');
  static const PartOfSpeech_Voice CAUSATIVE = PartOfSpeech_Voice._(2, 'CAUSATIVE');
...
class DependencyEdge_Label extends $pb.ProtobufEnum {
  static const DependencyEdge_Label UNKNOWN = DependencyEdge_Label._(0, 'UNKNOWN');
  static const DependencyEdge_Label ABBREV = DependencyEdge_Label._(1, 'ABBREV');
  ...
  static const DependencyEdge_Label ADVMOD = DependencyEdge_Label._(4, 'ADVMOD');
  ...
  static const DependencyEdge_Label AUXPASS = DependencyEdge_Label._(9, 'AUXPASS');
  ...
  static const DependencyEdge_Label CSUBJPASS = DependencyEdge_Label._(14, 'CSUBJPASS');
  ...
  static const DependencyEdge_Label DISCOURSE = DependencyEdge_Label._(17, 'DISCOURSE');
  ...
  static const DependencyEdge_Label GOESWITH = DependencyEdge_Label._(20, 'GOESWITH');
  ...
  static const DependencyEdge_Label NPADVMOD = DependencyEdge_Label._(27, 'NPADVMOD');
  static const DependencyEdge_Label NSUBJ = DependencyEdge_Label._(28, 'NSUBJ');
  static const DependencyEdge_Label NSUBJPASS = DependencyEdge_Label._(29, 'NSUBJPASS');
  static const DependencyEdge_Label NUM = DependencyEdge_Label._(30, 'NUM');
  static const DependencyEdge_Label NUMBER = DependencyEdge_Label._(31, 'NUMBER');
  static const DependencyEdge_Label P = DependencyEdge_Label._(32, 'P');
  static const DependencyEdge_Label PARATAXIS = DependencyEdge_Label._(33, 'PARATAXIS');
  static const DependencyEdge_Label PARTMOD = DependencyEdge_Label._(34, 'PARTMOD');
  ...
  static const DependencyEdge_Label POSTNEG = DependencyEdge_Label._(38, 'POSTNEG');
  static const DependencyEdge_Label PRECOMP = DependencyEdge_Label._(39, 'PRECOMP');
  static const DependencyEdge_Label PRECONJ = DependencyEdge_Label._(40, 'PRECONJ');
  static const DependencyEdge_Label PREDET = DependencyEdge_Label._(41, 'PREDET');
  ...
  static const DependencyEdge_Label QUANTMOD = DependencyEdge_Label._(47, 'QUANTMOD');
  static const DependencyEdge_Label RCMOD = DependencyEdge_Label._(48, 'RCMOD');
  static const DependencyEdge_Label RCMODREL = DependencyEdge_Label._(49, 'RCMODREL');
  ...
  static const DependencyEdge_Label REMNANT = DependencyEdge_Label._(52, 'REMNANT');
  static const DependencyEdge_Label REPARANDUM = DependencyEdge_Label._(53, 'REPARANDUM');
  ...
  static const DependencyEdge_Label VOCATIVE = DependencyEdge_Label._(60, 'VOCATIVE');
  static const DependencyEdge_Label XCOMP = DependencyEdge_Label._(61, 'XCOMP');
  static const DependencyEdge_Label SUFFIX = DependencyEdge_Label._(62, 'SUFFIX');
  static const DependencyEdge_Label TITLE = DependencyEdge_Label._(63, 'TITLE');
  static const DependencyEdge_Label ADVPHMOD = DependencyEdge_Label._(64, 'ADVPHMOD');
  static const DependencyEdge_Label AUXCAUS = DependencyEdge_Label._(65, 'AUXCAUS');
  ...
  static const DependencyEdge_Label FOREIGN = DependencyEdge_Label._(68, 'FOREIGN');
  ...
  static const DependencyEdge_Label NOMCSUBJ = DependencyEdge_Label._(72, 'NOMCSUBJ');
  static const DependencyEdge_Label NOMCSUBJPASS = DependencyEdge_Label._(73, 'NOMCSUBJPASS');
  ...
  static const DependencyEdge_Label DISLOCATED = DependencyEdge_Label._(76, 'DISLOCATED');
  ...
  static const DependencyEdge_Label INFMOD = DependencyEdge_Label._(80, 'INFMOD');
...
class EntityMention_Type extends $pb.ProtobufEnum {
  static const EntityMention_Type TYPE_UNKNOWN = EntityMention_Type._(0, 'TYPE_UNKNOWN');
