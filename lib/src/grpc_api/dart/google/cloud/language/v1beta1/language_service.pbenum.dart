...
class EncodingType extends ProtobufEnum {
  ...
  static const List<EncodingType> values = <EncodingType>[
    NONE,
    UTF8,
    UTF16,
    UTF32,
...
class Document_Type extends ProtobufEnum {
  ...
  static const List<Document_Type> values = <Document_Type>[
    TYPE_UNSPECIFIED,
    PLAIN_TEXT,
    HTML,
  ];
...
class Entity_Type extends ProtobufEnum {
  ...
  static const List<Entity_Type> values = <Entity_Type>[
    UNKNOWN,
    PERSON,
    LOCATION,
    ORGANIZATION,
...
class PartOfSpeech_Tag extends ProtobufEnum {
  ...
  static const List<PartOfSpeech_Tag> values = <PartOfSpeech_Tag>[
    UNKNOWN,
    ADJ,
    ADP,
    ADV,
...
class PartOfSpeech_Aspect extends ProtobufEnum {
  ...
  static const List<PartOfSpeech_Aspect> values = <PartOfSpeech_Aspect>[
    ASPECT_UNKNOWN,
    PERFECTIVE,
    IMPERFECTIVE,
    PROGRESSIVE,
...
class PartOfSpeech_Case extends ProtobufEnum {
  ...
  static const List<PartOfSpeech_Case> values = <PartOfSpeech_Case>[
    CASE_UNKNOWN,
    ACCUSATIVE,
    ADVERBIAL,
    COMPLEMENTIVE,
...
class PartOfSpeech_Form extends ProtobufEnum {
  ...
  static const List<PartOfSpeech_Form> values = <PartOfSpeech_Form>[
    FORM_UNKNOWN,
    ADNOMIAL,
    AUXILIARY,
    COMPLEMENTIZER,
...
class PartOfSpeech_Gender extends ProtobufEnum {
  ...
  static const List<PartOfSpeech_Gender> values = <PartOfSpeech_Gender>[
    GENDER_UNKNOWN,
    FEMININE,
    MASCULINE,
    NEUTER,
...
class PartOfSpeech_Mood extends ProtobufEnum {
  ...
  static const List<PartOfSpeech_Mood> values = <PartOfSpeech_Mood>[
    MOOD_UNKNOWN,
    CONDITIONAL_MOOD,
    IMPERATIVE,
    INDICATIVE,
...
class PartOfSpeech_Number extends ProtobufEnum {
  ...
  static const List<PartOfSpeech_Number> values = <PartOfSpeech_Number>[
    NUMBER_UNKNOWN,
    SINGULAR,
    PLURAL,
    DUAL,
...
class PartOfSpeech_Person extends ProtobufEnum {
  ...
  static const List<PartOfSpeech_Person> values = <PartOfSpeech_Person>[
    PERSON_UNKNOWN,
    FIRST,
    SECOND,
    THIRD,
...
class PartOfSpeech_Proper extends ProtobufEnum {
  ...
  static const List<PartOfSpeech_Proper> values = <PartOfSpeech_Proper>[
    PROPER_UNKNOWN,
    PROPER,
    NOT_PROPER,
  ];
...
class PartOfSpeech_Tense extends ProtobufEnum {
  ...
  static const List<PartOfSpeech_Tense> values = <PartOfSpeech_Tense>[
    TENSE_UNKNOWN,
    CONDITIONAL_TENSE,
    FUTURE,
    PAST,
...
class PartOfSpeech_Voice extends ProtobufEnum {
  ...
  static const List<PartOfSpeech_Voice> values = <PartOfSpeech_Voice>[
    VOICE_UNKNOWN,
    ACTIVE,
    CAUSATIVE,
    PASSIVE,
...
class DependencyEdge_Label extends ProtobufEnum {
  ...
  static const List<DependencyEdge_Label> values = <DependencyEdge_Label>[
    UNKNOWN,
    ABBREV,
    ACOMP,
    ADVCL,
...
class EntityMention_Type extends ProtobufEnum {
  ...
  static const List<EntityMention_Type> values = <EntityMention_Type>[
    TYPE_UNKNOWN,
    PROPER,
    COMMON,
  ];
