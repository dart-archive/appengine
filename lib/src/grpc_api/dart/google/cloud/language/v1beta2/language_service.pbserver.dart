...
abstract class LanguageServiceBase extends GeneratedService {
  ...
  Future<AnalyzeEntitySentimentResponse> analyzeEntitySentiment(ServerContext ctx, AnalyzeEntitySentimentRequest request);
  Future<AnalyzeSyntaxResponse> analyzeSyntax(ServerContext ctx, AnalyzeSyntaxRequest request);
  Future<ClassifyTextResponse> classifyText(ServerContext ctx, ClassifyTextRequest request);
  ...
  GeneratedMessage createRequest(String method) {
    switch (method) {
      ...
      case 'AnalyzeEntitySentiment': return new AnalyzeEntitySentimentRequest();
      case 'AnalyzeSyntax': return new AnalyzeSyntaxRequest();
      case 'ClassifyText': return new ClassifyTextRequest();
