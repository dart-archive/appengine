...
const SpeechServiceBase$json = const {
  '1': 'Speech',
  '2': const [
    ...
    const {'1': 'StreamingRecognize', '2': '.google.cloud.speech.v1.StreamingRecognizeRequest', '3': '.google.cloud.speech.v1.StreamingRecognizeResponse', '4': const {}, '5': true, '6': true},
  ],
};

const SpeechServiceBase$messageJson = const {
  ...
  '.google.cloud.speech.v1.RecognitionMetadata': RecognitionMetadata$json,
