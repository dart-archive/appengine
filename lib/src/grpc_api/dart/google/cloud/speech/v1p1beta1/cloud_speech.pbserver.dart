...
abstract class SpeechServiceBase extends GeneratedService {
  Future<RecognizeResponse> recognize(ServerContext ctx, RecognizeRequest request);
  Future<$google$longrunning.Operation> longRunningRecognize(ServerContext ctx, LongRunningRecognizeRequest request);
  Future<StreamingRecognizeResponse> streamingRecognize(ServerContext ctx, StreamingRecognizeRequest request);

  GeneratedMessage createRequest(String method) {
    switch (method) {
      case 'Recognize': return new RecognizeRequest();
      case 'LongRunningRecognize': return new LongRunningRecognizeRequest();
