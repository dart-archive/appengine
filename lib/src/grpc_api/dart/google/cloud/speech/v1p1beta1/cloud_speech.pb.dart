...
class RecognitionConfig extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('RecognitionConfig')
    ...
    ..a<RecognitionMetadata>(9, 'metadata', PbFieldType.OM, RecognitionMetadata.getDefault, RecognitionMetadata.create)
  ...
  set enableAutomaticPunctuation(bool v) { $_setBool(9, v); }
  ...
  set enableSeparateRecognitionPerChannel(bool v) { $_setBool(10, v); }
  ...
  set enableSpeakerDiarization(bool v) { $_setBool(14, v); }
  ...
  set diarizationSpeakerCount(int v) { $_setSignedInt32(15, v); }
...
class RecognitionMetadata extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('RecognitionMetadata')
    ..e<RecognitionMetadata_InteractionType>(1, 'interactionType', PbFieldType.OE, RecognitionMetadata_InteractionType.INTERACTION_TYPE_UNSPECIFIED, RecognitionMetadata_InteractionType.valueOf, RecognitionMetadata_InteractionType.values)
    ..a<int>(3, 'industryNaicsCodeOfAudio', PbFieldType.OU3)
    ..e<RecognitionMetadata_MicrophoneDistance>(4, 'microphoneDistance', PbFieldType.OE, RecognitionMetadata_MicrophoneDistance.MICROPHONE_DISTANCE_UNSPECIFIED, RecognitionMetadata_MicrophoneDistance.valueOf, RecognitionMetadata_MicrophoneDistance.values)
    ..e<RecognitionMetadata_OriginalMediaType>(5, 'originalMediaType', PbFieldType.OE, RecognitionMetadata_OriginalMediaType.ORIGINAL_MEDIA_TYPE_UNSPECIFIED, RecognitionMetadata_OriginalMediaType.valueOf, RecognitionMetadata_OriginalMediaType.values)
    ..e<RecognitionMetadata_RecordingDeviceType>(6, 'recordingDeviceType', PbFieldType.OE, RecognitionMetadata_RecordingDeviceType.RECORDING_DEVICE_TYPE_UNSPECIFIED, RecognitionMetadata_RecordingDeviceType.valueOf, RecognitionMetadata_RecordingDeviceType.values)
  ...
  RecognitionMetadata.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  RecognitionMetadata.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  RecognitionMetadata clone() => new RecognitionMetadata()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static RecognitionMetadata create() => new RecognitionMetadata();
  static PbList<RecognitionMetadata> createRepeated() => new PbList<RecognitionMetadata>();
  static RecognitionMetadata getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyRecognitionMetadata();
    return _defaultInstance;
  }
  ...
  set industryNaicsCodeOfAudio(int v) { $_setUnsignedInt32(1, v); }
  ...
  set audioTopic(String v) { $_setString(8, v); }
  bool hasAudioTopic() => $_has(8);
  void clearAudioTopic() => clearField(10);
}

class _ReadonlyRecognitionMetadata extends RecognitionMetadata with ReadonlyMessageMixin {}
...
class SpeechRecognitionResult extends GeneratedMessage {
  ...
  set channelTag(int v) { $_setSignedInt32(1, v); }
...
class WordInfo extends GeneratedMessage {
  ...
  set speakerTag(int v) { $_setSignedInt32(4, v); }
