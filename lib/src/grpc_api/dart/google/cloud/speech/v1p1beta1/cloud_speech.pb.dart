...
class RecognizeRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('RecognizeRequest', package: const $pb.PackageName('google.cloud.speech.v1p1beta1'))
    ..a<RecognitionConfig>(1, 'config', $pb.PbFieldType.OM, RecognitionConfig.getDefault, RecognitionConfig.create)
    ..a<RecognitionAudio>(2, 'audio', $pb.PbFieldType.OM, RecognitionAudio.getDefault, RecognitionAudio.create)
    ..hasRequiredFields = false
  ;

  RecognizeRequest() : super();
  RecognizeRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  RecognizeRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ...
  static RecognizeRequest getDefault() => _defaultInstance ??= create()..freeze();
...
class LongRunningRecognizeRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('LongRunningRecognizeRequest', package: const $pb.PackageName('google.cloud.speech.v1p1beta1'))
    ..a<RecognitionConfig>(1, 'config', $pb.PbFieldType.OM, RecognitionConfig.getDefault, RecognitionConfig.create)
    ..a<RecognitionAudio>(2, 'audio', $pb.PbFieldType.OM, RecognitionAudio.getDefault, RecognitionAudio.create)
    ..hasRequiredFields = false
  ;
  ...
  LongRunningRecognizeRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  LongRunningRecognizeRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ...
  static LongRunningRecognizeRequest getDefault() => _defaultInstance ??= create()..freeze();
...
class StreamingRecognizeRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('StreamingRecognizeRequest', package: const $pb.PackageName('google.cloud.speech.v1p1beta1'))
    ..a<StreamingRecognitionConfig>(1, 'streamingConfig', $pb.PbFieldType.OM, StreamingRecognitionConfig.getDefault, StreamingRecognitionConfig.create)
  ...
  StreamingRecognizeRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  StreamingRecognizeRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ...
  static StreamingRecognizeRequest getDefault() => _defaultInstance ??= create()..freeze();
...
class StreamingRecognitionConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('StreamingRecognitionConfig', package: const $pb.PackageName('google.cloud.speech.v1p1beta1'))
    ..a<RecognitionConfig>(1, 'config', $pb.PbFieldType.OM, RecognitionConfig.getDefault, RecognitionConfig.create)
  ...
  StreamingRecognitionConfig.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  StreamingRecognitionConfig.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ...
  static StreamingRecognitionConfig getDefault() => _defaultInstance ??= create()..freeze();
...
class RecognitionConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('RecognitionConfig', package: const $pb.PackageName('google.cloud.speech.v1p1beta1'))
    ..e<RecognitionConfig_AudioEncoding>(1, 'encoding', $pb.PbFieldType.OE, RecognitionConfig_AudioEncoding.ENCODING_UNSPECIFIED, RecognitionConfig_AudioEncoding.valueOf, RecognitionConfig_AudioEncoding.values)
    ..a<$core.int>(2, 'sampleRateHertz', $pb.PbFieldType.O3)
    ..aOS(3, 'languageCode')
    ..a<$core.int>(4, 'maxAlternatives', $pb.PbFieldType.O3)
    ..aOB(5, 'profanityFilter')
    ..pc<SpeechContext>(6, 'speechContexts', $pb.PbFieldType.PM,SpeechContext.create)
    ..a<$core.int>(7, 'audioChannelCount', $pb.PbFieldType.O3)
    ..aOB(8, 'enableWordTimeOffsets')
    ..a<RecognitionMetadata>(9, 'metadata', $pb.PbFieldType.OM, RecognitionMetadata.getDefault, RecognitionMetadata.create)
  ...
  RecognitionConfig.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  RecognitionConfig.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ...
  static RecognitionConfig getDefault() => _defaultInstance ??= create()..freeze();
...
class RecognitionMetadata extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('RecognitionMetadata', package: const $pb.PackageName('google.cloud.speech.v1p1beta1'))
    ..e<RecognitionMetadata_InteractionType>(1, 'interactionType', $pb.PbFieldType.OE, RecognitionMetadata_InteractionType.INTERACTION_TYPE_UNSPECIFIED, RecognitionMetadata_InteractionType.valueOf, RecognitionMetadata_InteractionType.values)
    ..a<$core.int>(3, 'industryNaicsCodeOfAudio', $pb.PbFieldType.OU3)
    ..e<RecognitionMetadata_MicrophoneDistance>(4, 'microphoneDistance', $pb.PbFieldType.OE, RecognitionMetadata_MicrophoneDistance.MICROPHONE_DISTANCE_UNSPECIFIED, RecognitionMetadata_MicrophoneDistance.valueOf, RecognitionMetadata_MicrophoneDistance.values)
    ..e<RecognitionMetadata_OriginalMediaType>(5, 'originalMediaType', $pb.PbFieldType.OE, RecognitionMetadata_OriginalMediaType.ORIGINAL_MEDIA_TYPE_UNSPECIFIED, RecognitionMetadata_OriginalMediaType.valueOf, RecognitionMetadata_OriginalMediaType.values)
    ..e<RecognitionMetadata_RecordingDeviceType>(6, 'recordingDeviceType', $pb.PbFieldType.OE, RecognitionMetadata_RecordingDeviceType.RECORDING_DEVICE_TYPE_UNSPECIFIED, RecognitionMetadata_RecordingDeviceType.valueOf, RecognitionMetadata_RecordingDeviceType.values)
  ...
  RecognitionMetadata.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  RecognitionMetadata.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ...
  static RecognitionMetadata getDefault() => _defaultInstance ??= create()..freeze();
  ...
  set obfuscatedId(Int64 v) { $_setInt64(7, v); }
...
class SpeechContext extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('SpeechContext', package: const $pb.PackageName('google.cloud.speech.v1p1beta1'))
    ..pPS(1, 'phrases')
...
class RecognitionAudio extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('RecognitionAudio', package: const $pb.PackageName('google.cloud.speech.v1p1beta1'))
  ...
  RecognitionAudio.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  RecognitionAudio.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ...
  static RecognitionAudio getDefault() => _defaultInstance ??= create()..freeze();
...
class RecognizeResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('RecognizeResponse', package: const $pb.PackageName('google.cloud.speech.v1p1beta1'))
    ..pc<SpeechRecognitionResult>(2, 'results', $pb.PbFieldType.PM,SpeechRecognitionResult.create)
    ..hasRequiredFields = false
  ;

  RecognizeResponse() : super();
  RecognizeResponse.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  RecognizeResponse.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ...
  static RecognizeResponse getDefault() => _defaultInstance ??= create()..freeze();
...
class LongRunningRecognizeResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('LongRunningRecognizeResponse', package: const $pb.PackageName('google.cloud.speech.v1p1beta1'))
    ..pc<SpeechRecognitionResult>(2, 'results', $pb.PbFieldType.PM,SpeechRecognitionResult.create)
    ..hasRequiredFields = false
  ;

  LongRunningRecognizeResponse() : super();
  LongRunningRecognizeResponse.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  LongRunningRecognizeResponse.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ...
  $pb.BuilderInfo get info_ => _i;
  static LongRunningRecognizeResponse create() => LongRunningRecognizeResponse();
  ...
  static LongRunningRecognizeResponse getDefault() => _defaultInstance ??= create()..freeze();
...
class LongRunningRecognizeMetadata extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('LongRunningRecognizeMetadata', package: const $pb.PackageName('google.cloud.speech.v1p1beta1'))
    ...
    ..a<$0.Timestamp>(3, 'lastUpdateTime', $pb.PbFieldType.OM, $0.Timestamp.getDefault, $0.Timestamp.create)
    ..hasRequiredFields = false
  ;

  LongRunningRecognizeMetadata() : super();
  LongRunningRecognizeMetadata.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  LongRunningRecognizeMetadata.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ...
  $pb.BuilderInfo get info_ => _i;
  static LongRunningRecognizeMetadata create() => LongRunningRecognizeMetadata();
  ...
  static LongRunningRecognizeMetadata getDefault() => _defaultInstance ??= create()..freeze();
  ...
  set lastUpdateTime($0.Timestamp v) { setField(3, v); }
...
class StreamingRecognizeResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('StreamingRecognizeResponse', package: const $pb.PackageName('google.cloud.speech.v1p1beta1'))
    ..a<$1.Status>(1, 'error', $pb.PbFieldType.OM, $1.Status.getDefault, $1.Status.create)
    ..pc<StreamingRecognitionResult>(2, 'results', $pb.PbFieldType.PM,StreamingRecognitionResult.create)
    ..e<StreamingRecognizeResponse_SpeechEventType>(4, 'speechEventType', $pb.PbFieldType.OE, StreamingRecognizeResponse_SpeechEventType.SPEECH_EVENT_UNSPECIFIED, StreamingRecognizeResponse_SpeechEventType.valueOf, StreamingRecognizeResponse_SpeechEventType.values)
    ..hasRequiredFields = false
  ;

  StreamingRecognizeResponse() : super();
  StreamingRecognizeResponse.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  StreamingRecognizeResponse.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ...
  static StreamingRecognizeResponse getDefault() => _defaultInstance ??= create()..freeze();
...
class StreamingRecognitionResult extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('StreamingRecognitionResult', package: const $pb.PackageName('google.cloud.speech.v1p1beta1'))
    ...
    ..a<$2.Duration>(4, 'resultEndTime', $pb.PbFieldType.OM, $2.Duration.getDefault, $2.Duration.create)
  ...
  set resultEndTime($2.Duration v) { setField(4, v); }
...
class SpeechRecognitionResult extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('SpeechRecognitionResult', package: const $pb.PackageName('google.cloud.speech.v1p1beta1'))
    ..pc<SpeechRecognitionAlternative>(1, 'alternatives', $pb.PbFieldType.PM,SpeechRecognitionAlternative.create)
  ...
  SpeechRecognitionResult.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  SpeechRecognitionResult.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ...
  static SpeechRecognitionResult getDefault() => _defaultInstance ??= create()..freeze();
...
class SpeechRecognitionAlternative extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('SpeechRecognitionAlternative', package: const $pb.PackageName('google.cloud.speech.v1p1beta1'))
    ..aOS(1, 'transcript')
...
class WordInfo extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('WordInfo', package: const $pb.PackageName('google.cloud.speech.v1p1beta1'))
    ..a<$2.Duration>(1, 'startTime', $pb.PbFieldType.OM, $2.Duration.getDefault, $2.Duration.create)
    ..a<$2.Duration>(2, 'endTime', $pb.PbFieldType.OM, $2.Duration.getDefault, $2.Duration.create)
    ..aOS(3, 'word')
  ...
  set startTime($2.Duration v) { setField(1, v); }
  $core.bool hasStartTime() => $_has(0);
  void clearStartTime() => clearField(1);

  $2.Duration get endTime => $_getN(1);
  set endTime($2.Duration v) { setField(2, v); }
...
class SpeechApi {
  ...
  $async.Future<$3.Operation> longRunningRecognize($pb.ClientContext ctx, LongRunningRecognizeRequest request) {
    var emptyResponse = $3.Operation();
    return _client.invoke<$3.Operation>(ctx, 'Speech', 'LongRunningRecognize', request, emptyResponse);
  }
  $async.Future<StreamingRecognizeResponse> streamingRecognize($pb.ClientContext ctx, StreamingRecognizeRequest request) {
