...
const SpeechServiceBase$json = const {
  ...
  '2': const [
    ...
    const {'1': 'StreamingRecognize', '2': '.google.cloud.speech.v1p1beta1.StreamingRecognizeRequest', '3': '.google.cloud.speech.v1p1beta1.StreamingRecognizeResponse', '4': const {}, '5': true, '6': true},
  ],
};
