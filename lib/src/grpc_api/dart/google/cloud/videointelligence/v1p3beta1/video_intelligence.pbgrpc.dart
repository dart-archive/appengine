...
class StreamingVideoIntelligenceServiceClient extends $grpc.Client {
  static final _$streamingAnnotateVideo = $grpc.ClientMethod<
      ...
      (StreamingAnnotateVideoRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) =>
          StreamingAnnotateVideoResponse.fromBuffer(value));

  StreamingVideoIntelligenceServiceClient($grpc.ClientChannel channel,
      {$grpc.CallOptions options})
      : super(channel, options: options);

  $grpc.ResponseStream<StreamingAnnotateVideoResponse> streamingAnnotateVideo(
      $async.Stream<StreamingAnnotateVideoRequest> request,
      {$grpc.CallOptions options}) {
    final call =
...
abstract class StreamingVideoIntelligenceServiceBase extends $grpc.Service {
  ...
  StreamingVideoIntelligenceServiceBase() {
    $addMethod($grpc.ServiceMethod<StreamingAnnotateVideoRequest,
        ...
        true,
        ($core.List<$core.int> value) =>
            StreamingAnnotateVideoRequest.fromBuffer(value),
        (StreamingAnnotateVideoResponse value) => value.writeToBuffer()));
  }

  $async.Stream<StreamingAnnotateVideoResponse> streamingAnnotateVideo(
