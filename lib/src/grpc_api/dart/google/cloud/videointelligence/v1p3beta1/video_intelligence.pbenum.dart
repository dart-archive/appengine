...
class Feature extends $pb.ProtobufEnum {
  ...
  static const Feature SHOT_CHANGE_DETECTION = Feature._(2, 'SHOT_CHANGE_DETECTION');
  static const Feature EXPLICIT_CONTENT_DETECTION = Feature._(3, 'EXPLICIT_CONTENT_DETECTION');
...
class StreamingFeature extends $pb.ProtobufEnum {
  static const StreamingFeature STREAMING_FEATURE_UNSPECIFIED = StreamingFeature._(0, 'STREAMING_FEATURE_UNSPECIFIED');
  static const StreamingFeature STREAMING_LABEL_DETECTION = StreamingFeature._(1, 'STREAMING_LABEL_DETECTION');
  static const StreamingFeature STREAMING_SHOT_CHANGE_DETECTION = StreamingFeature._(2, 'STREAMING_SHOT_CHANGE_DETECTION');
  static const StreamingFeature STREAMING_EXPLICIT_CONTENT_DETECTION = StreamingFeature._(3, 'STREAMING_EXPLICIT_CONTENT_DETECTION');
  static const StreamingFeature STREAMING_OBJECT_TRACKING = StreamingFeature._(4, 'STREAMING_OBJECT_TRACKING');
