...
class AnnotateVideoRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('AnnotateVideoRequest', package: const $pb.PackageName('google.cloud.videointelligence.v1p3beta1'))
    ..aOS(1, 'inputUri')
...
class VideoContext extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('VideoContext', package: const $pb.PackageName('google.cloud.videointelligence.v1p3beta1'))
    ...
    ..a<TextDetectionConfig>(8, 'textDetectionConfig', $pb.PbFieldType.OM, TextDetectionConfig.getDefault, TextDetectionConfig.create)
    ..hasRequiredFields = false
  ;
...
class LabelDetectionConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('LabelDetectionConfig', package: const $pb.PackageName('google.cloud.videointelligence.v1p3beta1'))
...
class ShotChangeDetectionConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ShotChangeDetectionConfig', package: const $pb.PackageName('google.cloud.videointelligence.v1p3beta1'))
    ..aOS(1, 'model')
    ..hasRequiredFields = false
  ;
...
class ExplicitContentDetectionConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ExplicitContentDetectionConfig', package: const $pb.PackageName('google.cloud.videointelligence.v1p3beta1'))
    ..aOS(1, 'model')
    ..hasRequiredFields = false
  ;
...
class TextDetectionConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('TextDetectionConfig', package: const $pb.PackageName('google.cloud.videointelligence.v1p3beta1'))
    ..pPS(1, 'languageHints')
    ..hasRequiredFields = false
  ;

  TextDetectionConfig() : super();
  TextDetectionConfig.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  TextDetectionConfig.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  TextDetectionConfig clone() => TextDetectionConfig()..mergeFromMessage(this);
  TextDetectionConfig copyWith(void Function(TextDetectionConfig) updates) => super.copyWith((message) => updates(message as TextDetectionConfig));
  $pb.BuilderInfo get info_ => _i;
  ...
  static TextDetectionConfig getDefault() => _defaultInstance ??= create()..freeze();
...
class VideoSegment extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('VideoSegment', package: const $pb.PackageName('google.cloud.videointelligence.v1p3beta1'))
...
class LabelSegment extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('LabelSegment', package: const $pb.PackageName('google.cloud.videointelligence.v1p3beta1'))
...
class LabelFrame extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('LabelFrame', package: const $pb.PackageName('google.cloud.videointelligence.v1p3beta1'))
...
class Entity extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Entity', package: const $pb.PackageName('google.cloud.videointelligence.v1p3beta1'))
    ..aOS(1, 'entityId')
    ..aOS(2, 'description')
    ..aOS(3, 'languageCode')
    ..hasRequiredFields = false
...
class LabelAnnotation extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('LabelAnnotation', package: const $pb.PackageName('google.cloud.videointelligence.v1p3beta1'))
...
class ExplicitContentFrame extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ExplicitContentFrame', package: const $pb.PackageName('google.cloud.videointelligence.v1p3beta1'))
    ..a<$0.Duration>(1, 'timeOffset', $pb.PbFieldType.OM, $0.Duration.getDefault, $0.Duration.create)
...
class ExplicitContentAnnotation extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ExplicitContentAnnotation', package: const $pb.PackageName('google.cloud.videointelligence.v1p3beta1'))
...
class NormalizedBoundingBox extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('NormalizedBoundingBox', package: const $pb.PackageName('google.cloud.videointelligence.v1p3beta1'))
...
class VideoAnnotationResults extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('VideoAnnotationResults', package: const $pb.PackageName('google.cloud.videointelligence.v1p3beta1'))
    ..aOS(1, 'inputUri')
    ...
    ..pc<TextAnnotation>(12, 'textAnnotations', $pb.PbFieldType.PM,TextAnnotation.create)
    ..pc<ObjectTrackingAnnotation>(14, 'objectAnnotations', $pb.PbFieldType.PM,ObjectTrackingAnnotation.create)
    ..hasRequiredFields = false
  ;
...
class AnnotateVideoResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('AnnotateVideoResponse', package: const $pb.PackageName('google.cloud.videointelligence.v1p3beta1'))
...
class VideoAnnotationProgress extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('VideoAnnotationProgress', package: const $pb.PackageName('google.cloud.videointelligence.v1p3beta1'))
    ..aOS(1, 'inputUri')
...
class AnnotateVideoProgress extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('AnnotateVideoProgress', package: const $pb.PackageName('google.cloud.videointelligence.v1p3beta1'))
...
class NormalizedVertex extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('NormalizedVertex', package: const $pb.PackageName('google.cloud.videointelligence.v1p3beta1'))
...
class NormalizedBoundingPoly extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('NormalizedBoundingPoly', package: const $pb.PackageName('google.cloud.videointelligence.v1p3beta1'))
    ..pc<NormalizedVertex>(1, 'vertices', $pb.PbFieldType.PM,NormalizedVertex.create)
    ..hasRequiredFields = false
  ;
...
class TextSegment extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('TextSegment', package: const $pb.PackageName('google.cloud.videointelligence.v1p3beta1'))
    ..a<VideoSegment>(1, 'segment', $pb.PbFieldType.OM, VideoSegment.getDefault, VideoSegment.create)
    ..a<$core.double>(2, 'confidence', $pb.PbFieldType.OF)
  ...
  TextSegment() : super();
  TextSegment.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  TextSegment.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  TextSegment clone() => TextSegment()..mergeFromMessage(this);
  TextSegment copyWith(void Function(TextSegment) updates) => super.copyWith((message) => updates(message as TextSegment));
  $pb.BuilderInfo get info_ => _i;
...
class TextFrame extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('TextFrame', package: const $pb.PackageName('google.cloud.videointelligence.v1p3beta1'))
    ..a<NormalizedBoundingPoly>(1, 'rotatedBoundingBox', $pb.PbFieldType.OM, NormalizedBoundingPoly.getDefault, NormalizedBoundingPoly.create)
    ..a<$0.Duration>(2, 'timeOffset', $pb.PbFieldType.OM, $0.Duration.getDefault, $0.Duration.create)
    ..hasRequiredFields = false
  ;

  TextFrame() : super();
  TextFrame.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  TextFrame.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  TextFrame clone() => TextFrame()..mergeFromMessage(this);
  TextFrame copyWith(void Function(TextFrame) updates) => super.copyWith((message) => updates(message as TextFrame));
  $pb.BuilderInfo get info_ => _i;
...
class TextAnnotation extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('TextAnnotation', package: const $pb.PackageName('google.cloud.videointelligence.v1p3beta1'))
    ..aOS(1, 'text')
  ...
  TextAnnotation.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  TextAnnotation.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  TextAnnotation clone() => TextAnnotation()..mergeFromMessage(this);
  TextAnnotation copyWith(void Function(TextAnnotation) updates) => super.copyWith((message) => updates(message as TextAnnotation));
  $pb.BuilderInfo get info_ => _i;
...
class ObjectTrackingFrame extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ObjectTrackingFrame', package: const $pb.PackageName('google.cloud.videointelligence.v1p3beta1'))
    ..a<NormalizedBoundingBox>(1, 'normalizedBoundingBox', $pb.PbFieldType.OM, NormalizedBoundingBox.getDefault, NormalizedBoundingBox.create)
    ..a<$0.Duration>(2, 'timeOffset', $pb.PbFieldType.OM, $0.Duration.getDefault, $0.Duration.create)
    ..hasRequiredFields = false
  ;
...
class ObjectTrackingAnnotation extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ObjectTrackingAnnotation', package: const $pb.PackageName('google.cloud.videointelligence.v1p3beta1'))
    ..a<Entity>(1, 'entity', $pb.PbFieldType.OM, Entity.getDefault, Entity.create)
    ..pc<ObjectTrackingFrame>(2, 'frames', $pb.PbFieldType.PM,ObjectTrackingFrame.create)
    ..a<VideoSegment>(3, 'segment', $pb.PbFieldType.OM, VideoSegment.getDefault, VideoSegment.create)
  ...
  ObjectTrackingAnnotation.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  ObjectTrackingAnnotation.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ObjectTrackingAnnotation clone() => ObjectTrackingAnnotation()..mergeFromMessage(this);
  ObjectTrackingAnnotation copyWith(void Function(ObjectTrackingAnnotation) updates) => super.copyWith((message) => updates(message as ObjectTrackingAnnotation));
  $pb.BuilderInfo get info_ => _i;
  ...
  static ObjectTrackingAnnotation getDefault() => _defaultInstance ??= create()..freeze();
  ...
  set trackId(Int64 v) { $_setInt64(4, v); }
...
class StreamingAnnotateVideoRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('StreamingAnnotateVideoRequest', package: const $pb.PackageName('google.cloud.videointelligence.v1p3beta1'))
    ..a<StreamingVideoConfig>(1, 'videoConfig', $pb.PbFieldType.OM, StreamingVideoConfig.getDefault, StreamingVideoConfig.create)
  ...
  StreamingAnnotateVideoRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  StreamingAnnotateVideoRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  StreamingAnnotateVideoRequest clone() => StreamingAnnotateVideoRequest()..mergeFromMessage(this);
  StreamingAnnotateVideoRequest copyWith(void Function(StreamingAnnotateVideoRequest) updates) => super.copyWith((message) => updates(message as StreamingAnnotateVideoRequest));
  $pb.BuilderInfo get info_ => _i;
  static StreamingAnnotateVideoRequest create() => StreamingAnnotateVideoRequest();
  ...
  static StreamingAnnotateVideoRequest getDefault() => _defaultInstance ??= create()..freeze();
...
class StreamingAnnotateVideoResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('StreamingAnnotateVideoResponse', package: const $pb.PackageName('google.cloud.videointelligence.v1p3beta1'))
    ..a<$1.Status>(1, 'error', $pb.PbFieldType.OM, $1.Status.getDefault, $1.Status.create)
    ..a<StreamingVideoAnnotationResults>(2, 'annotationResults', $pb.PbFieldType.OM, StreamingVideoAnnotationResults.getDefault, StreamingVideoAnnotationResults.create)
    ..aOS(3, 'annotationResultsUri')
    ..hasRequiredFields = false
  ;

  StreamingAnnotateVideoResponse() : super();
  StreamingAnnotateVideoResponse.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  StreamingAnnotateVideoResponse.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  StreamingAnnotateVideoResponse clone() => StreamingAnnotateVideoResponse()..mergeFromMessage(this);
  StreamingAnnotateVideoResponse copyWith(void Function(StreamingAnnotateVideoResponse) updates) => super.copyWith((message) => updates(message as StreamingAnnotateVideoResponse));
  $pb.BuilderInfo get info_ => _i;
  static StreamingAnnotateVideoResponse create() => StreamingAnnotateVideoResponse();
  ...
  static StreamingAnnotateVideoResponse getDefault() => _defaultInstance ??= create()..freeze();
...
class StreamingExplicitContentDetectionConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('StreamingExplicitContentDetectionConfig', package: const $pb.PackageName('google.cloud.videointelligence.v1p3beta1'))
    ..hasRequiredFields = false
  ;

  StreamingExplicitContentDetectionConfig() : super();
  StreamingExplicitContentDetectionConfig.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  StreamingExplicitContentDetectionConfig.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  StreamingExplicitContentDetectionConfig clone() => StreamingExplicitContentDetectionConfig()..mergeFromMessage(this);
  StreamingExplicitContentDetectionConfig copyWith(void Function(StreamingExplicitContentDetectionConfig) updates) => super.copyWith((message) => updates(message as StreamingExplicitContentDetectionConfig));
  $pb.BuilderInfo get info_ => _i;
  static StreamingExplicitContentDetectionConfig create() => StreamingExplicitContentDetectionConfig();
  ...
  static StreamingExplicitContentDetectionConfig getDefault() => _defaultInstance ??= create()..freeze();
...
class StreamingLabelDetectionConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('StreamingLabelDetectionConfig', package: const $pb.PackageName('google.cloud.videointelligence.v1p3beta1'))
    ..aOB(1, 'stationaryCamera')
    ..hasRequiredFields = false
  ;

  StreamingLabelDetectionConfig() : super();
  StreamingLabelDetectionConfig.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  StreamingLabelDetectionConfig.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  StreamingLabelDetectionConfig clone() => StreamingLabelDetectionConfig()..mergeFromMessage(this);
  StreamingLabelDetectionConfig copyWith(void Function(StreamingLabelDetectionConfig) updates) => super.copyWith((message) => updates(message as StreamingLabelDetectionConfig));
  $pb.BuilderInfo get info_ => _i;
  static StreamingLabelDetectionConfig create() => StreamingLabelDetectionConfig();
  ...
  static StreamingLabelDetectionConfig getDefault() => _defaultInstance ??= create()..freeze();
...
class StreamingObjectTrackingConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('StreamingObjectTrackingConfig', package: const $pb.PackageName('google.cloud.videointelligence.v1p3beta1'))
    ..hasRequiredFields = false
  ;

  StreamingObjectTrackingConfig() : super();
  StreamingObjectTrackingConfig.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  StreamingObjectTrackingConfig.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  StreamingObjectTrackingConfig clone() => StreamingObjectTrackingConfig()..mergeFromMessage(this);
  StreamingObjectTrackingConfig copyWith(void Function(StreamingObjectTrackingConfig) updates) => super.copyWith((message) => updates(message as StreamingObjectTrackingConfig));
  $pb.BuilderInfo get info_ => _i;
  static StreamingObjectTrackingConfig create() => StreamingObjectTrackingConfig();
  ...
  static StreamingObjectTrackingConfig getDefault() => _defaultInstance ??= create()..freeze();
...
class StreamingShotChangeDetectionConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('StreamingShotChangeDetectionConfig', package: const $pb.PackageName('google.cloud.videointelligence.v1p3beta1'))
    ..hasRequiredFields = false
  ;

  StreamingShotChangeDetectionConfig() : super();
  StreamingShotChangeDetectionConfig.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  StreamingShotChangeDetectionConfig.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  StreamingShotChangeDetectionConfig clone() => StreamingShotChangeDetectionConfig()..mergeFromMessage(this);
  StreamingShotChangeDetectionConfig copyWith(void Function(StreamingShotChangeDetectionConfig) updates) => super.copyWith((message) => updates(message as StreamingShotChangeDetectionConfig));
  $pb.BuilderInfo get info_ => _i;
  static StreamingShotChangeDetectionConfig create() => StreamingShotChangeDetectionConfig();
  ...
  static StreamingShotChangeDetectionConfig getDefault() => _defaultInstance ??= create()..freeze();
  static StreamingShotChangeDetectionConfig _defaultInstance;
}

class StreamingStorageConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('StreamingStorageConfig', package: const $pb.PackageName('google.cloud.videointelligence.v1p3beta1'))
  ...
  StreamingStorageConfig.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  StreamingStorageConfig.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  StreamingStorageConfig clone() => StreamingStorageConfig()..mergeFromMessage(this);
  StreamingStorageConfig copyWith(void Function(StreamingStorageConfig) updates) => super.copyWith((message) => updates(message as StreamingStorageConfig));
  $pb.BuilderInfo get info_ => _i;
  ...
  static StreamingStorageConfig getDefault() => _defaultInstance ??= create()..freeze();
...
class StreamingVideoAnnotationResults extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('StreamingVideoAnnotationResults', package: const $pb.PackageName('google.cloud.videointelligence.v1p3beta1'))
    ..pc<VideoSegment>(1, 'shotAnnotations', $pb.PbFieldType.PM,VideoSegment.create)
    ..pc<LabelAnnotation>(2, 'labelAnnotations', $pb.PbFieldType.PM,LabelAnnotation.create)
    ..a<ExplicitContentAnnotation>(3, 'explicitAnnotation', $pb.PbFieldType.OM, ExplicitContentAnnotation.getDefault, ExplicitContentAnnotation.create)
    ..pc<ObjectTrackingAnnotation>(4, 'objectAnnotations', $pb.PbFieldType.PM,ObjectTrackingAnnotation.create)
    ..hasRequiredFields = false
  ;

  StreamingVideoAnnotationResults() : super();
  StreamingVideoAnnotationResults.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  StreamingVideoAnnotationResults.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  StreamingVideoAnnotationResults clone() => StreamingVideoAnnotationResults()..mergeFromMessage(this);
  StreamingVideoAnnotationResults copyWith(void Function(StreamingVideoAnnotationResults) updates) => super.copyWith((message) => updates(message as StreamingVideoAnnotationResults));
  $pb.BuilderInfo get info_ => _i;
  static StreamingVideoAnnotationResults create() => StreamingVideoAnnotationResults();
  ...
  static StreamingVideoAnnotationResults getDefault() => _defaultInstance ??= create()..freeze();
...
class StreamingVideoConfig extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('StreamingVideoConfig', package: const $pb.PackageName('google.cloud.videointelligence.v1p3beta1'))
    ..e<StreamingFeature>(1, 'feature', $pb.PbFieldType.OE, StreamingFeature.STREAMING_FEATURE_UNSPECIFIED, StreamingFeature.valueOf, StreamingFeature.values)
    ..a<StreamingShotChangeDetectionConfig>(2, 'shotChangeDetectionConfig', $pb.PbFieldType.OM, StreamingShotChangeDetectionConfig.getDefault, StreamingShotChangeDetectionConfig.create)
    ..a<StreamingLabelDetectionConfig>(3, 'labelDetectionConfig', $pb.PbFieldType.OM, StreamingLabelDetectionConfig.getDefault, StreamingLabelDetectionConfig.create)
    ..a<StreamingExplicitContentDetectionConfig>(4, 'explicitContentDetectionConfig', $pb.PbFieldType.OM, StreamingExplicitContentDetectionConfig.getDefault, StreamingExplicitContentDetectionConfig.create)
    ..a<StreamingObjectTrackingConfig>(5, 'objectTrackingConfig', $pb.PbFieldType.OM, StreamingObjectTrackingConfig.getDefault, StreamingObjectTrackingConfig.create)
    ..a<StreamingStorageConfig>(30, 'storageConfig', $pb.PbFieldType.OM, StreamingStorageConfig.getDefault, StreamingStorageConfig.create)
    ..oo(0, [2, 3, 4, 5])
    ..hasRequiredFields = false
  ;

  StreamingVideoConfig() : super();
  StreamingVideoConfig.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  StreamingVideoConfig.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  StreamingVideoConfig clone() => StreamingVideoConfig()..mergeFromMessage(this);
  StreamingVideoConfig copyWith(void Function(StreamingVideoConfig) updates) => super.copyWith((message) => updates(message as StreamingVideoConfig));
  $pb.BuilderInfo get info_ => _i;
  ...
  static StreamingVideoConfig getDefault() => _defaultInstance ??= create()..freeze();
...
class StreamingVideoIntelligenceServiceApi {
  ...
  $async.Future<StreamingAnnotateVideoResponse> streamingAnnotateVideo($pb.ClientContext ctx, StreamingAnnotateVideoRequest request) {
    var emptyResponse = StreamingAnnotateVideoResponse();
    return _client.invoke<StreamingAnnotateVideoResponse>(ctx, 'StreamingVideoIntelligenceService', 'StreamingAnnotateVideo', request, emptyResponse);
  }
}
