...
class AnnotateVideoRequest extends GeneratedMessage {
  ...
  set inputContent(String v) { $_setString(5, v); }
...
class VideoContext extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('VideoContext')
    ...
    ..e<LabelDetectionMode>(2, 'labelDetectionMode', PbFieldType.OE, LabelDetectionMode.LABEL_DETECTION_MODE_UNSPECIFIED, LabelDetectionMode.valueOf, LabelDetectionMode.values)
  ...
  set safeSearchDetectionModel(String v) { $_setString(6, v); }
...
class LabelLocation extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('LabelLocation')
    ..a<VideoSegment>(1, 'segment', PbFieldType.OM, VideoSegment.getDefault, VideoSegment.create)
    ..a<double>(2, 'confidence', PbFieldType.OF)
    ..e<LabelLevel>(3, 'level', PbFieldType.OE, LabelLevel.LABEL_LEVEL_UNSPECIFIED, LabelLevel.valueOf, LabelLevel.values)
    ..hasRequiredFields = false
  ;

  LabelLocation() : super();
  LabelLocation.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  LabelLocation.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  LabelLocation clone() => new LabelLocation()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static LabelLocation create() => new LabelLocation();
  static PbList<LabelLocation> createRepeated() => new PbList<LabelLocation>();
  static LabelLocation getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyLabelLocation();
    return _defaultInstance;
  }
  ...
  set level(LabelLevel v) { setField(3, v); }
...
class LabelAnnotation extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('LabelAnnotation')
    ..aOS(1, 'description')
    ..aOS(2, 'languageCode')
    ..pp<LabelLocation>(3, 'locations', PbFieldType.PM, LabelLocation.$checkItem, LabelLocation.create)
    ..hasRequiredFields = false
  ;
...
class SafeSearchAnnotation extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('SafeSearchAnnotation')
    ...
    ..e<Likelihood>(4, 'violent', PbFieldType.OE, Likelihood.UNKNOWN, Likelihood.valueOf, Likelihood.values)
    ..e<Likelihood>(5, 'racy', PbFieldType.OE, Likelihood.UNKNOWN, Likelihood.valueOf, Likelihood.values)
    ..aInt64(6, 'timeOffset')
    ..hasRequiredFields = false
  ;
...
class FaceLocation extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('FaceLocation')
    ..a<BoundingBox>(1, 'boundingBox', PbFieldType.OM, BoundingBox.getDefault, BoundingBox.create)
    ..aInt64(2, 'timeOffset')
    ..hasRequiredFields = false
  ;

  FaceLocation() : super();
  FaceLocation.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  FaceLocation.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  FaceLocation clone() => new FaceLocation()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static FaceLocation create() => new FaceLocation();
  static PbList<FaceLocation> createRepeated() => new PbList<FaceLocation>();
  static FaceLocation getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyFaceLocation();
    return _defaultInstance;
  }
  ...
  set timeOffset(Int64 v) { $_setInt64(1, v); }
...
class FaceAnnotation extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('FaceAnnotation')
    ..aOS(1, 'thumbnail')
    ..pp<VideoSegment>(2, 'segments', PbFieldType.PM, VideoSegment.$checkItem, VideoSegment.create)
    ..pp<FaceLocation>(3, 'locations', PbFieldType.PM, FaceLocation.$checkItem, FaceLocation.create)
    ..hasRequiredFields = false
  ;
  ...
  set thumbnail(String v) { $_setString(0, v); }
...
class VideoAnnotationResults extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('VideoAnnotationResults')
    ..aOS(1, 'inputUri')
    ..pp<LabelAnnotation>(2, 'labelAnnotations', PbFieldType.PM, LabelAnnotation.$checkItem, LabelAnnotation.create)
    ..pp<FaceAnnotation>(3, 'faceAnnotations', PbFieldType.PM, FaceAnnotation.$checkItem, FaceAnnotation.create)
    ..pp<VideoSegment>(4, 'shotAnnotations', PbFieldType.PM, VideoSegment.$checkItem, VideoSegment.create)
    ..a<$google$rpc.Status>(5, 'error', PbFieldType.OM, $google$rpc.Status.getDefault, $google$rpc.Status.create)
    ..pp<SafeSearchAnnotation>(6, 'safeSearchAnnotations', PbFieldType.PM, SafeSearchAnnotation.$checkItem, SafeSearchAnnotation.create)
    ..hasRequiredFields = false
  ;
  ...
  set error($google$rpc.Status v) { setField(5, v); }
