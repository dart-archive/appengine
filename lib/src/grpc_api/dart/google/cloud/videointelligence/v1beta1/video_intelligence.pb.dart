...
class AnnotateVideoRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('AnnotateVideoRequest', package: const $pb.PackageName('google.cloud.videointelligence.v1beta1'))
    ..aOS(1, 'inputUri')
  ...
  set inputContent($core.String v) { $_setString(5, v); }
  $core.bool hasInputContent() => $_has(5);
  void clearInputContent() => clearField(6);
}

class VideoContext extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('VideoContext', package: const $pb.PackageName('google.cloud.videointelligence.v1beta1'))
    ..pc<VideoSegment>(1, 'segments', $pb.PbFieldType.PM,VideoSegment.create)
    ..e<LabelDetectionMode>(2, 'labelDetectionMode', $pb.PbFieldType.OE, LabelDetectionMode.LABEL_DETECTION_MODE_UNSPECIFIED, LabelDetectionMode.valueOf, LabelDetectionMode.values)
  ...
  set faceDetectionModel($core.String v) { $_setString(4, v); }
  ...
  set shotChangeDetectionModel($core.String v) { $_setString(5, v); }
  ...
  set safeSearchDetectionModel($core.String v) { $_setString(6, v); }
...
class VideoSegment extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('VideoSegment', package: const $pb.PackageName('google.cloud.videointelligence.v1beta1'))
...
class LabelLocation extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('LabelLocation', package: const $pb.PackageName('google.cloud.videointelligence.v1beta1'))
    ...
    ..e<LabelLevel>(3, 'level', $pb.PbFieldType.OE, LabelLevel.LABEL_LEVEL_UNSPECIFIED, LabelLevel.valueOf, LabelLevel.values)
    ..hasRequiredFields = false
  ;

  LabelLocation() : super();
  LabelLocation.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  LabelLocation.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  LabelLocation clone() => LabelLocation()..mergeFromMessage(this);
  LabelLocation copyWith(void Function(LabelLocation) updates) => super.copyWith((message) => updates(message as LabelLocation));
  $pb.BuilderInfo get info_ => _i;
  static LabelLocation create() => LabelLocation();
  LabelLocation createEmptyInstance() => create();
  static $pb.PbList<LabelLocation> createRepeated() => $pb.PbList<LabelLocation>();
...
class LabelAnnotation extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('LabelAnnotation', package: const $pb.PackageName('google.cloud.videointelligence.v1beta1'))
    ..aOS(1, 'description')
    ..aOS(2, 'languageCode')
    ..pc<LabelLocation>(3, 'locations', $pb.PbFieldType.PM,LabelLocation.create)
    ..hasRequiredFields = false
  ;
...
class SafeSearchAnnotation extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('SafeSearchAnnotation', package: const $pb.PackageName('google.cloud.videointelligence.v1beta1'))
    ...
    ..e<Likelihood>(4, 'violent', $pb.PbFieldType.OE, Likelihood.UNKNOWN, Likelihood.valueOf, Likelihood.values)
    ..e<Likelihood>(5, 'racy', $pb.PbFieldType.OE, Likelihood.UNKNOWN, Likelihood.valueOf, Likelihood.values)
    ..aInt64(6, 'timeOffset')
    ..hasRequiredFields = false
  ;
...
class BoundingBox extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('BoundingBox', package: const $pb.PackageName('google.cloud.videointelligence.v1beta1'))
  ...
  set right($core.int v) { $_setSignedInt32(1, v); }
  $core.bool hasRight() => $_has(1);
  void clearRight() => clearField(2);

  $core.int get bottom => $_get(2, 0);
  set bottom($core.int v) { $_setSignedInt32(2, v); }
  $core.bool hasBottom() => $_has(2);
  void clearBottom() => clearField(3);

  $core.int get top => $_get(3, 0);
  set top($core.int v) { $_setSignedInt32(3, v); }
  $core.bool hasTop() => $_has(3);
  void clearTop() => clearField(4);
}

class FaceLocation extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('FaceLocation', package: const $pb.PackageName('google.cloud.videointelligence.v1beta1'))
    ..a<BoundingBox>(1, 'boundingBox', $pb.PbFieldType.OM, BoundingBox.getDefault, BoundingBox.create)
    ..aInt64(2, 'timeOffset')
    ..hasRequiredFields = false
  ;

  FaceLocation() : super();
  FaceLocation.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  FaceLocation.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  FaceLocation clone() => FaceLocation()..mergeFromMessage(this);
  FaceLocation copyWith(void Function(FaceLocation) updates) => super.copyWith((message) => updates(message as FaceLocation));
  $pb.BuilderInfo get info_ => _i;
  static FaceLocation create() => FaceLocation();
  FaceLocation createEmptyInstance() => create();
  static $pb.PbList<FaceLocation> createRepeated() => $pb.PbList<FaceLocation>();
...
class FaceAnnotation extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('FaceAnnotation', package: const $pb.PackageName('google.cloud.videointelligence.v1beta1'))
    ..aOS(1, 'thumbnail')
...
class VideoAnnotationResults extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('VideoAnnotationResults', package: const $pb.PackageName('google.cloud.videointelligence.v1beta1'))
    ..aOS(1, 'inputUri')
    ..pc<LabelAnnotation>(2, 'labelAnnotations', $pb.PbFieldType.PM,LabelAnnotation.create)
    ..pc<FaceAnnotation>(3, 'faceAnnotations', $pb.PbFieldType.PM,FaceAnnotation.create)
    ..pc<VideoSegment>(4, 'shotAnnotations', $pb.PbFieldType.PM,VideoSegment.create)
    ..a<$0.Status>(5, 'error', $pb.PbFieldType.OM, $0.Status.getDefault, $0.Status.create)
    ..pc<SafeSearchAnnotation>(6, 'safeSearchAnnotations', $pb.PbFieldType.PM,SafeSearchAnnotation.create)
    ..hasRequiredFields = false
  ;
...
class AnnotateVideoResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('AnnotateVideoResponse', package: const $pb.PackageName('google.cloud.videointelligence.v1beta1'))
...
class VideoAnnotationProgress extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('VideoAnnotationProgress', package: const $pb.PackageName('google.cloud.videointelligence.v1beta1'))
    ..aOS(1, 'inputUri')
    ..a<$core.int>(2, 'progressPercent', $pb.PbFieldType.O3)
    ..a<$1.Timestamp>(3, 'startTime', $pb.PbFieldType.OM, $1.Timestamp.getDefault, $1.Timestamp.create)
  ...
  set startTime($1.Timestamp v) { setField(3, v); }
...
class AnnotateVideoProgress extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('AnnotateVideoProgress', package: const $pb.PackageName('google.cloud.videointelligence.v1beta1'))
...
class VideoIntelligenceServiceApi {
  ...
  $async.Future<$2.Operation> annotateVideo($pb.ClientContext ctx, AnnotateVideoRequest request) {
    var emptyResponse = $2.Operation();
    return _client.invoke<$2.Operation>(ctx, 'VideoIntelligenceService', 'AnnotateVideo', request, emptyResponse);
  }
}
