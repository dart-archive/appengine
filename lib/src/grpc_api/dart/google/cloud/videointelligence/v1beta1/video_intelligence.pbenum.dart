...
class Feature extends ProtobufEnum {
  static const Feature FEATURE_UNSPECIFIED = const Feature._(0, 'FEATURE_UNSPECIFIED');
  ...
  static const Feature SHOT_CHANGE_DETECTION = const Feature._(3, 'SHOT_CHANGE_DETECTION');
  static const Feature SAFE_SEARCH_DETECTION = const Feature._(4, 'SAFE_SEARCH_DETECTION');
...
class LabelLevel extends ProtobufEnum {
  static const LabelLevel LABEL_LEVEL_UNSPECIFIED = const LabelLevel._(0, 'LABEL_LEVEL_UNSPECIFIED');
  static const LabelLevel VIDEO_LEVEL = const LabelLevel._(1, 'VIDEO_LEVEL');
  static const LabelLevel SEGMENT_LEVEL = const LabelLevel._(2, 'SEGMENT_LEVEL');
  ...
  static final Map<int, dynamic> _byValue = ProtobufEnum.initByValue(values);
  static LabelLevel valueOf(int value) => _byValue[value] as LabelLevel;
  static void $checkItem(LabelLevel v) {
    if (v is! LabelLevel) checkItemFailed(v, 'LabelLevel');
  }

  const LabelLevel._(int v, String n) : super(v, n);
}

class LabelDetectionMode extends ProtobufEnum {
  static const LabelDetectionMode LABEL_DETECTION_MODE_UNSPECIFIED = const LabelDetectionMode._(0, 'LABEL_DETECTION_MODE_UNSPECIFIED');
  static const LabelDetectionMode SHOT_MODE = const LabelDetectionMode._(1, 'SHOT_MODE');
  static const LabelDetectionMode FRAME_MODE = const LabelDetectionMode._(2, 'FRAME_MODE');
  static const LabelDetectionMode SHOT_AND_FRAME_MODE = const LabelDetectionMode._(3, 'SHOT_AND_FRAME_MODE');
  ...
  static final Map<int, dynamic> _byValue = ProtobufEnum.initByValue(values);
  static LabelDetectionMode valueOf(int value) => _byValue[value] as LabelDetectionMode;
