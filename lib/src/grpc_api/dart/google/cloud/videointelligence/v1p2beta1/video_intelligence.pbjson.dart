...
const AnnotateVideoRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'features', '3': 2, '4': 3, '5': 14, '6': '.google.cloud.videointelligence.v1p2beta1.Feature', '10': 'features'},
...
const ObjectTrackingAnnotation$json = const {
  ...
  '2': const [
    ...
    const {'1': 'segment', '3': 3, '4': 1, '5': 11, '6': '.google.cloud.videointelligence.v1p2beta1.VideoSegment', '10': 'segment'},
  ],
};
...
const VideoIntelligenceServiceBase$json = const {
  ...
  '2': const [
    const {'1': 'AnnotateVideo', '2': '.google.cloud.videointelligence.v1p2beta1.AnnotateVideoRequest', '3': '.google.longrunning.Operation', '4': const {}},
  ],
};

const VideoIntelligenceServiceBase$messageJson = const {
  '.google.cloud.videointelligence.v1p2beta1.AnnotateVideoRequest': AnnotateVideoRequest$json,
  ...
  '.google.cloud.videointelligence.v1p2beta1.LabelDetectionConfig': LabelDetectionConfig$json,
  '.google.cloud.videointelligence.v1p2beta1.ShotChangeDetectionConfig': ShotChangeDetectionConfig$json,
  '.google.cloud.videointelligence.v1p2beta1.ExplicitContentDetectionConfig': ExplicitContentDetectionConfig$json,
  '.google.cloud.videointelligence.v1p2beta1.TextDetectionConfig': TextDetectionConfig$json,
