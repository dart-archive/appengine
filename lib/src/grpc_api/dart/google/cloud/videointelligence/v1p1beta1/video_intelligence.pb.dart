...
class VideoContext extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('VideoContext')
    ...
    ..a<SpeechTranscriptionConfig>(6, 'speechTranscriptionConfig', PbFieldType.OM, SpeechTranscriptionConfig.getDefault, SpeechTranscriptionConfig.create)
    ..hasRequiredFields = false
  ;
...
class VideoAnnotationResults extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('VideoAnnotationResults')
    ...
    ..pp<SpeechTranscription>(11, 'speechTranscriptions', PbFieldType.PM, SpeechTranscription.$checkItem, SpeechTranscription.create)
    ..hasRequiredFields = false
  ;
...
class SpeechTranscriptionConfig extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('SpeechTranscriptionConfig')
    ...
    ..pp<SpeechContext>(4, 'speechContexts', PbFieldType.PM, SpeechContext.$checkItem, SpeechContext.create)
    ..p<int>(6, 'audioTracks', PbFieldType.P3)
    ..hasRequiredFields = false
  ;

  SpeechTranscriptionConfig() : super();
  SpeechTranscriptionConfig.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  SpeechTranscriptionConfig.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  SpeechTranscriptionConfig clone() => new SpeechTranscriptionConfig()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static SpeechTranscriptionConfig create() => new SpeechTranscriptionConfig();
  static PbList<SpeechTranscriptionConfig> createRepeated() => new PbList<SpeechTranscriptionConfig>();
  static SpeechTranscriptionConfig getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlySpeechTranscriptionConfig();
    return _defaultInstance;
  }
  static SpeechTranscriptionConfig _defaultInstance;
  static void $checkItem(SpeechTranscriptionConfig v) {
    if (v is! SpeechTranscriptionConfig) checkItemFailed(v, 'SpeechTranscriptionConfig');
  }
...
class _ReadonlySpeechTranscriptionConfig extends SpeechTranscriptionConfig with ReadonlyMessageMixin {}
...
class SpeechTranscription extends GeneratedMessage {
  ...
  SpeechTranscription.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  SpeechTranscription.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  SpeechTranscription clone() => new SpeechTranscription()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static SpeechTranscription create() => new SpeechTranscription();
  static PbList<SpeechTranscription> createRepeated() => new PbList<SpeechTranscription>();
  static SpeechTranscription getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlySpeechTranscription();
    return _defaultInstance;
  }
...
class _ReadonlySpeechTranscription extends SpeechTranscription with ReadonlyMessageMixin {}
