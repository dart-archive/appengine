...
class AnnotateVideoRequest extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('AnnotateVideoRequest')
    ..aOS(1, 'inputUri')
    ..pp<Feature>(2, 'features', PbFieldType.PE, Feature.$checkItem, null, Feature.valueOf, Feature.values)
    ..a<VideoContext>(3, 'videoContext', PbFieldType.OM, VideoContext.getDefault, VideoContext.create)
    ..aOS(4, 'outputUri')
    ..aOS(5, 'locationId')
  ...
  AnnotateVideoRequest.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  AnnotateVideoRequest.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  AnnotateVideoRequest clone() => new AnnotateVideoRequest()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static AnnotateVideoRequest create() => new AnnotateVideoRequest();
  static PbList<AnnotateVideoRequest> createRepeated() => new PbList<AnnotateVideoRequest>();
  static AnnotateVideoRequest getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyAnnotateVideoRequest();
  ...
  set outputUri(String v) { $_setString(3, v); }
  ...
  set inputContent(List<int> v) { $_setBytes(5, v); }
  bool hasInputContent() => $_has(5);
  void clearInputContent() => clearField(6);
}

class _ReadonlyAnnotateVideoRequest extends AnnotateVideoRequest with ReadonlyMessageMixin {}

class VideoContext extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('VideoContext')
    ..pp<VideoSegment>(1, 'segments', PbFieldType.PM, VideoSegment.$checkItem, VideoSegment.create)
    ..a<LabelDetectionConfig>(2, 'labelDetectionConfig', PbFieldType.OM, LabelDetectionConfig.getDefault, LabelDetectionConfig.create)
    ..a<ShotChangeDetectionConfig>(3, 'shotChangeDetectionConfig', PbFieldType.OM, ShotChangeDetectionConfig.getDefault, ShotChangeDetectionConfig.create)
    ..a<ExplicitContentDetectionConfig>(4, 'explicitContentDetectionConfig', PbFieldType.OM, ExplicitContentDetectionConfig.getDefault, ExplicitContentDetectionConfig.create)
    ..a<FaceDetectionConfig>(5, 'faceDetectionConfig', PbFieldType.OM, FaceDetectionConfig.getDefault, FaceDetectionConfig.create)
    ..hasRequiredFields = false
  ;

  VideoContext() : super();
  VideoContext.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  VideoContext.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ...
  static VideoContext getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyVideoContext();
    return _defaultInstance;
  }
...
class LabelDetectionConfig extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('LabelDetectionConfig')
    ..e<LabelDetectionMode>(1, 'labelDetectionMode', PbFieldType.OE, LabelDetectionMode.LABEL_DETECTION_MODE_UNSPECIFIED, LabelDetectionMode.valueOf, LabelDetectionMode.values)
  ...
  LabelDetectionConfig.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  LabelDetectionConfig.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  LabelDetectionConfig clone() => new LabelDetectionConfig()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static LabelDetectionConfig create() => new LabelDetectionConfig();
  static PbList<LabelDetectionConfig> createRepeated() => new PbList<LabelDetectionConfig>();
  static LabelDetectionConfig getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyLabelDetectionConfig();
    return _defaultInstance;
  }
  ...
  set stationaryCamera(bool v) { $_setBool(1, v); }
...
class _ReadonlyLabelDetectionConfig extends LabelDetectionConfig with ReadonlyMessageMixin {}
...
class ShotChangeDetectionConfig extends GeneratedMessage {
  ...
  ShotChangeDetectionConfig.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  ShotChangeDetectionConfig.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ShotChangeDetectionConfig clone() => new ShotChangeDetectionConfig()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static ShotChangeDetectionConfig create() => new ShotChangeDetectionConfig();
  static PbList<ShotChangeDetectionConfig> createRepeated() => new PbList<ShotChangeDetectionConfig>();
  static ShotChangeDetectionConfig getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyShotChangeDetectionConfig();
    return _defaultInstance;
  }
  static ShotChangeDetectionConfig _defaultInstance;
  static void $checkItem(ShotChangeDetectionConfig v) {
    if (v is! ShotChangeDetectionConfig) checkItemFailed(v, 'ShotChangeDetectionConfig');
  }
...
class _ReadonlyShotChangeDetectionConfig extends ShotChangeDetectionConfig with ReadonlyMessageMixin {}

class ExplicitContentDetectionConfig extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('ExplicitContentDetectionConfig')
    ..aOS(1, 'model')
    ..hasRequiredFields = false
  ;

  ExplicitContentDetectionConfig() : super();
  ExplicitContentDetectionConfig.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  ExplicitContentDetectionConfig.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ExplicitContentDetectionConfig clone() => new ExplicitContentDetectionConfig()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static ExplicitContentDetectionConfig create() => new ExplicitContentDetectionConfig();
  static PbList<ExplicitContentDetectionConfig> createRepeated() => new PbList<ExplicitContentDetectionConfig>();
  static ExplicitContentDetectionConfig getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyExplicitContentDetectionConfig();
    return _defaultInstance;
  }
  static ExplicitContentDetectionConfig _defaultInstance;
  static void $checkItem(ExplicitContentDetectionConfig v) {
    if (v is! ExplicitContentDetectionConfig) checkItemFailed(v, 'ExplicitContentDetectionConfig');
  }
...
class _ReadonlyExplicitContentDetectionConfig extends ExplicitContentDetectionConfig with ReadonlyMessageMixin {}
...
class FaceDetectionConfig extends GeneratedMessage {
  ...
  FaceDetectionConfig.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  FaceDetectionConfig.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  FaceDetectionConfig clone() => new FaceDetectionConfig()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static FaceDetectionConfig create() => new FaceDetectionConfig();
  static PbList<FaceDetectionConfig> createRepeated() => new PbList<FaceDetectionConfig>();
  static FaceDetectionConfig getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyFaceDetectionConfig();
    return _defaultInstance;
  }
  ...
  set includeBoundingBoxes(bool v) { $_setBool(1, v); }
  bool hasIncludeBoundingBoxes() => $_has(1);
  void clearIncludeBoundingBoxes() => clearField(2);
}

class _ReadonlyFaceDetectionConfig extends FaceDetectionConfig with ReadonlyMessageMixin {}

class VideoSegment extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('VideoSegment')
    ..a<$google$protobuf.Duration>(1, 'startTimeOffset', PbFieldType.OM, $google$protobuf.Duration.getDefault, $google$protobuf.Duration.create)
    ..a<$google$protobuf.Duration>(2, 'endTimeOffset', PbFieldType.OM, $google$protobuf.Duration.getDefault, $google$protobuf.Duration.create)
    ..hasRequiredFields = false
  ;

  VideoSegment() : super();
  VideoSegment.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  VideoSegment.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ...
  static VideoSegment getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyVideoSegment();
    return _defaultInstance;
  }
...
class LabelSegment extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('LabelSegment')
    ..a<VideoSegment>(1, 'segment', PbFieldType.OM, VideoSegment.getDefault, VideoSegment.create)
    ..a<double>(2, 'confidence', PbFieldType.OF)
    ..hasRequiredFields = false
  ;

  LabelSegment() : super();
  LabelSegment.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  LabelSegment.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ...
  static LabelSegment getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyLabelSegment();
    return _defaultInstance;
  }
...
class LabelFrame extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('LabelFrame')
    ..a<$google$protobuf.Duration>(1, 'timeOffset', PbFieldType.OM, $google$protobuf.Duration.getDefault, $google$protobuf.Duration.create)
    ..a<double>(2, 'confidence', PbFieldType.OF)
    ..hasRequiredFields = false
  ;

  LabelFrame() : super();
  LabelFrame.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  LabelFrame.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ...
  set timeOffset($google$protobuf.Duration v) { setField(1, v); }
...
class LabelAnnotation extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('LabelAnnotation')
    ...
    ..pp<Entity>(2, 'categoryEntities', PbFieldType.PM, Entity.$checkItem, Entity.create)
    ..pp<LabelSegment>(3, 'segments', PbFieldType.PM, LabelSegment.$checkItem, LabelSegment.create)
    ..pp<LabelFrame>(4, 'frames', PbFieldType.PM, LabelFrame.$checkItem, LabelFrame.create)
    ..hasRequiredFields = false
  ;

  LabelAnnotation() : super();
  LabelAnnotation.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  LabelAnnotation.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  LabelAnnotation clone() => new LabelAnnotation()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static LabelAnnotation create() => new LabelAnnotation();
  static PbList<LabelAnnotation> createRepeated() => new PbList<LabelAnnotation>();
  static LabelAnnotation getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyLabelAnnotation();
    return _defaultInstance;
  }
...
class _ReadonlyLabelAnnotation extends LabelAnnotation with ReadonlyMessageMixin {}

class ExplicitContentFrame extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('ExplicitContentFrame')
    ..a<$google$protobuf.Duration>(1, 'timeOffset', PbFieldType.OM, $google$protobuf.Duration.getDefault, $google$protobuf.Duration.create)
    ..e<Likelihood>(2, 'pornographyLikelihood', PbFieldType.OE, Likelihood.LIKELIHOOD_UNSPECIFIED, Likelihood.valueOf, Likelihood.values)
    ..hasRequiredFields = false
  ;

  ExplicitContentFrame() : super();
  ExplicitContentFrame.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  ExplicitContentFrame.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ExplicitContentFrame clone() => new ExplicitContentFrame()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static ExplicitContentFrame create() => new ExplicitContentFrame();
  static PbList<ExplicitContentFrame> createRepeated() => new PbList<ExplicitContentFrame>();
  static ExplicitContentFrame getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyExplicitContentFrame();
    return _defaultInstance;
  }
...
class _ReadonlyExplicitContentFrame extends ExplicitContentFrame with ReadonlyMessageMixin {}
...
class ExplicitContentAnnotation extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('ExplicitContentAnnotation')
    ..pp<ExplicitContentFrame>(1, 'frames', PbFieldType.PM, ExplicitContentFrame.$checkItem, ExplicitContentFrame.create)
    ..hasRequiredFields = false
  ;

  ExplicitContentAnnotation() : super();
  ExplicitContentAnnotation.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  ExplicitContentAnnotation.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ExplicitContentAnnotation clone() => new ExplicitContentAnnotation()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static ExplicitContentAnnotation create() => new ExplicitContentAnnotation();
  static PbList<ExplicitContentAnnotation> createRepeated() => new PbList<ExplicitContentAnnotation>();
  static ExplicitContentAnnotation getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyExplicitContentAnnotation();
    return _defaultInstance;
  }
  static ExplicitContentAnnotation _defaultInstance;
  static void $checkItem(ExplicitContentAnnotation v) {
    if (v is! ExplicitContentAnnotation) checkItemFailed(v, 'ExplicitContentAnnotation');
  }

  List<ExplicitContentFrame> get frames => $_getList(0);
}

class _ReadonlyExplicitContentAnnotation extends ExplicitContentAnnotation with ReadonlyMessageMixin {}
...
class NormalizedBoundingBox extends GeneratedMessage {
  ...
  NormalizedBoundingBox.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  NormalizedBoundingBox.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  NormalizedBoundingBox clone() => new NormalizedBoundingBox()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static NormalizedBoundingBox create() => new NormalizedBoundingBox();
  static PbList<NormalizedBoundingBox> createRepeated() => new PbList<NormalizedBoundingBox>();
  static NormalizedBoundingBox getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyNormalizedBoundingBox();
    return _defaultInstance;
  }
  static NormalizedBoundingBox _defaultInstance;
  static void $checkItem(NormalizedBoundingBox v) {
    if (v is! NormalizedBoundingBox) checkItemFailed(v, 'NormalizedBoundingBox');
  }

  double get left => $_getN(0);
  set left(double v) { $_setFloat(0, v); }
  bool hasLeft() => $_has(0);
  void clearLeft() => clearField(1);

  double get top => $_getN(1);
  set top(double v) { $_setFloat(1, v); }
  bool hasTop() => $_has(1);
  void clearTop() => clearField(2);

  double get right => $_getN(2);
  set right(double v) { $_setFloat(2, v); }
  bool hasRight() => $_has(2);
  void clearRight() => clearField(3);

  double get bottom => $_getN(3);
  set bottom(double v) { $_setFloat(3, v); }
  bool hasBottom() => $_has(3);
  void clearBottom() => clearField(4);
}

class _ReadonlyNormalizedBoundingBox extends NormalizedBoundingBox with ReadonlyMessageMixin {}
...
class FaceSegment extends GeneratedMessage {
  ...
  FaceSegment() : super();
  FaceSegment.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  FaceSegment.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
...
class FaceFrame extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('FaceFrame')
    ..pp<NormalizedBoundingBox>(1, 'normalizedBoundingBoxes', PbFieldType.PM, NormalizedBoundingBox.$checkItem, NormalizedBoundingBox.create)
    ..a<$google$protobuf.Duration>(2, 'timeOffset', PbFieldType.OM, $google$protobuf.Duration.getDefault, $google$protobuf.Duration.create)
    ..hasRequiredFields = false
  ;

  FaceFrame() : super();
  FaceFrame.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  FaceFrame.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ...
  set timeOffset($google$protobuf.Duration v) { setField(2, v); }
...
class FaceAnnotation extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('FaceAnnotation')
    ...
    ..pp<FaceSegment>(2, 'segments', PbFieldType.PM, FaceSegment.$checkItem, FaceSegment.create)
    ..pp<FaceFrame>(3, 'frames', PbFieldType.PM, FaceFrame.$checkItem, FaceFrame.create)
    ..hasRequiredFields = false
  ;
  ...
  set thumbnail(List<int> v) { $_setBytes(0, v); }
...
class VideoAnnotationResults extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('VideoAnnotationResults')
    ..aOS(1, 'inputUri')
    ..pp<LabelAnnotation>(2, 'segmentLabelAnnotations', PbFieldType.PM, LabelAnnotation.$checkItem, LabelAnnotation.create)
    ..pp<LabelAnnotation>(3, 'shotLabelAnnotations', PbFieldType.PM, LabelAnnotation.$checkItem, LabelAnnotation.create)
    ..pp<LabelAnnotation>(4, 'frameLabelAnnotations', PbFieldType.PM, LabelAnnotation.$checkItem, LabelAnnotation.create)
    ..pp<FaceAnnotation>(5, 'faceAnnotations', PbFieldType.PM, FaceAnnotation.$checkItem, FaceAnnotation.create)
    ..pp<VideoSegment>(6, 'shotAnnotations', PbFieldType.PM, VideoSegment.$checkItem, VideoSegment.create)
    ..a<ExplicitContentAnnotation>(7, 'explicitAnnotation', PbFieldType.OM, ExplicitContentAnnotation.getDefault, ExplicitContentAnnotation.create)
  ...
  VideoAnnotationResults.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  VideoAnnotationResults.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  VideoAnnotationResults clone() => new VideoAnnotationResults()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static VideoAnnotationResults create() => new VideoAnnotationResults();
  static PbList<VideoAnnotationResults> createRepeated() => new PbList<VideoAnnotationResults>();
  static VideoAnnotationResults getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyVideoAnnotationResults();
    return _defaultInstance;
  }
  static VideoAnnotationResults _defaultInstance;
  static void $checkItem(VideoAnnotationResults v) {
    if (v is! VideoAnnotationResults) checkItemFailed(v, 'VideoAnnotationResults');
  }
...
class _ReadonlyVideoAnnotationResults extends VideoAnnotationResults with ReadonlyMessageMixin {}

class AnnotateVideoResponse extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('AnnotateVideoResponse')
    ..pp<VideoAnnotationResults>(1, 'annotationResults', PbFieldType.PM, VideoAnnotationResults.$checkItem, VideoAnnotationResults.create)
    ..hasRequiredFields = false
  ;

  AnnotateVideoResponse() : super();
  AnnotateVideoResponse.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  AnnotateVideoResponse.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  AnnotateVideoResponse clone() => new AnnotateVideoResponse()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static AnnotateVideoResponse create() => new AnnotateVideoResponse();
  static PbList<AnnotateVideoResponse> createRepeated() => new PbList<AnnotateVideoResponse>();
  static AnnotateVideoResponse getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyAnnotateVideoResponse();
    return _defaultInstance;
  }
  static AnnotateVideoResponse _defaultInstance;
  static void $checkItem(AnnotateVideoResponse v) {
    if (v is! AnnotateVideoResponse) checkItemFailed(v, 'AnnotateVideoResponse');
  }

  List<VideoAnnotationResults> get annotationResults => $_getList(0);
}

class _ReadonlyAnnotateVideoResponse extends AnnotateVideoResponse with ReadonlyMessageMixin {}
...
class VideoAnnotationProgress extends GeneratedMessage {
  ...
  VideoAnnotationProgress.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  VideoAnnotationProgress.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  VideoAnnotationProgress clone() => new VideoAnnotationProgress()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static VideoAnnotationProgress create() => new VideoAnnotationProgress();
  static PbList<VideoAnnotationProgress> createRepeated() => new PbList<VideoAnnotationProgress>();
  static VideoAnnotationProgress getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyVideoAnnotationProgress();
    return _defaultInstance;
  }
  static VideoAnnotationProgress _defaultInstance;
  static void $checkItem(VideoAnnotationProgress v) {
    if (v is! VideoAnnotationProgress) checkItemFailed(v, 'VideoAnnotationProgress');
  }
  ...
  set progressPercent(int v) { $_setSignedInt32(1, v); }
...
class _ReadonlyVideoAnnotationProgress extends VideoAnnotationProgress with ReadonlyMessageMixin {}

class AnnotateVideoProgress extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('AnnotateVideoProgress')
    ..pp<VideoAnnotationProgress>(1, 'annotationProgress', PbFieldType.PM, VideoAnnotationProgress.$checkItem, VideoAnnotationProgress.create)
    ..hasRequiredFields = false
  ;

  AnnotateVideoProgress() : super();
  AnnotateVideoProgress.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  AnnotateVideoProgress.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  AnnotateVideoProgress clone() => new AnnotateVideoProgress()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static AnnotateVideoProgress create() => new AnnotateVideoProgress();
  static PbList<AnnotateVideoProgress> createRepeated() => new PbList<AnnotateVideoProgress>();
  static AnnotateVideoProgress getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyAnnotateVideoProgress();
    return _defaultInstance;
  }
  static AnnotateVideoProgress _defaultInstance;
  static void $checkItem(AnnotateVideoProgress v) {
    if (v is! AnnotateVideoProgress) checkItemFailed(v, 'AnnotateVideoProgress');
  }

  List<VideoAnnotationProgress> get annotationProgress => $_getList(0);
}

class _ReadonlyAnnotateVideoProgress extends AnnotateVideoProgress with ReadonlyMessageMixin {}

class VideoIntelligenceServiceApi {
  RpcClient _client;
  VideoIntelligenceServiceApi(this._client);

  Future<$google$longrunning.Operation> annotateVideo(ClientContext ctx, AnnotateVideoRequest request) {
    var emptyResponse = new $google$longrunning.Operation();
    return _client.invoke<$google$longrunning.Operation>(ctx, 'VideoIntelligenceService', 'AnnotateVideo', request, emptyResponse);
  }
}
