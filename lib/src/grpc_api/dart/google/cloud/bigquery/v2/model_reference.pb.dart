...
class ModelReference extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ModelReference', package: const $pb.PackageName('google.cloud.bigquery.v2'))
    ..aOS(1, 'projectId')
    ..aOS(2, 'datasetId')
    ..aOS(3, 'modelId')
  ...
  ModelReference.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  ModelReference.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ModelReference clone() => ModelReference()..mergeFromMessage(this);
  ModelReference copyWith(void Function(ModelReference) updates) => super.copyWith((message) => updates(message as ModelReference));
