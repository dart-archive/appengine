...
class Model_ModelType extends $pb.ProtobufEnum {
  static const Model_ModelType MODEL_TYPE_UNSPECIFIED = Model_ModelType._(0, 'MODEL_TYPE_UNSPECIFIED');
  static const Model_ModelType LINEAR_REGRESSION = Model_ModelType._(1, 'LINEAR_REGRESSION');
  static const Model_ModelType LOGISTIC_REGRESSION = Model_ModelType._(2, 'LOGISTIC_REGRESSION');
...
class Model_LossType extends $pb.ProtobufEnum {
  static const Model_LossType LOSS_TYPE_UNSPECIFIED = Model_LossType._(0, 'LOSS_TYPE_UNSPECIFIED');
  static const Model_LossType MEAN_SQUARED_LOSS = Model_LossType._(1, 'MEAN_SQUARED_LOSS');
  static const Model_LossType MEAN_LOG_LOSS = Model_LossType._(2, 'MEAN_LOG_LOSS');
...
class Model_DistanceType extends $pb.ProtobufEnum {
  static const Model_DistanceType DISTANCE_TYPE_UNSPECIFIED = Model_DistanceType._(0, 'DISTANCE_TYPE_UNSPECIFIED');
  static const Model_DistanceType EUCLIDEAN = Model_DistanceType._(1, 'EUCLIDEAN');
...
class Model_DataSplitMethod extends $pb.ProtobufEnum {
  static const Model_DataSplitMethod DATA_SPLIT_METHOD_UNSPECIFIED = Model_DataSplitMethod._(0, 'DATA_SPLIT_METHOD_UNSPECIFIED');
  static const Model_DataSplitMethod RANDOM = Model_DataSplitMethod._(1, 'RANDOM');
  static const Model_DataSplitMethod CUSTOM = Model_DataSplitMethod._(2, 'CUSTOM');
  static const Model_DataSplitMethod SEQUENTIAL = Model_DataSplitMethod._(3, 'SEQUENTIAL');
  static const Model_DataSplitMethod NO_SPLIT = Model_DataSplitMethod._(4, 'NO_SPLIT');
  static const Model_DataSplitMethod AUTO_SPLIT = Model_DataSplitMethod._(5, 'AUTO_SPLIT');
...
class Model_LearnRateStrategy extends $pb.ProtobufEnum {
  static const Model_LearnRateStrategy LEARN_RATE_STRATEGY_UNSPECIFIED = Model_LearnRateStrategy._(0, 'LEARN_RATE_STRATEGY_UNSPECIFIED');
  static const Model_LearnRateStrategy LINE_SEARCH = Model_LearnRateStrategy._(1, 'LINE_SEARCH');
  static const Model_LearnRateStrategy CONSTANT = Model_LearnRateStrategy._(2, 'CONSTANT');
