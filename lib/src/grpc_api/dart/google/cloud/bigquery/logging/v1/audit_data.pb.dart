...
class AuditData extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('AuditData')
    ..a<TableInsertRequest>(1, 'tableInsertRequest', PbFieldType.OM, TableInsertRequest.getDefault, TableInsertRequest.create)
    ..a<DatasetListRequest>(2, 'datasetListRequest', PbFieldType.OM, DatasetListRequest.getDefault, DatasetListRequest.create)
    ..a<DatasetInsertRequest>(3, 'datasetInsertRequest', PbFieldType.OM, DatasetInsertRequest.getDefault, DatasetInsertRequest.create)
    ..a<DatasetUpdateRequest>(4, 'datasetUpdateRequest', PbFieldType.OM, DatasetUpdateRequest.getDefault, DatasetUpdateRequest.create)
    ..a<JobInsertRequest>(5, 'jobInsertRequest', PbFieldType.OM, JobInsertRequest.getDefault, JobInsertRequest.create)
    ..a<JobQueryRequest>(6, 'jobQueryRequest', PbFieldType.OM, JobQueryRequest.getDefault, JobQueryRequest.create)
    ..a<JobGetQueryResultsRequest>(7, 'jobGetQueryResultsRequest', PbFieldType.OM, JobGetQueryResultsRequest.getDefault, JobGetQueryResultsRequest.create)
    ..a<TableDataListRequest>(8, 'tableDataListRequest', PbFieldType.OM, TableDataListRequest.getDefault, TableDataListRequest.create)
    ..a<TableInsertResponse>(9, 'tableInsertResponse', PbFieldType.OM, TableInsertResponse.getDefault, TableInsertResponse.create)
    ..a<TableUpdateResponse>(10, 'tableUpdateResponse', PbFieldType.OM, TableUpdateResponse.getDefault, TableUpdateResponse.create)
    ..a<DatasetInsertResponse>(11, 'datasetInsertResponse', PbFieldType.OM, DatasetInsertResponse.getDefault, DatasetInsertResponse.create)
    ..a<DatasetUpdateResponse>(12, 'datasetUpdateResponse', PbFieldType.OM, DatasetUpdateResponse.getDefault, DatasetUpdateResponse.create)
    ..a<JobQueryResponse>(13, 'jobQueryResponse', PbFieldType.OM, JobQueryResponse.getDefault, JobQueryResponse.create)
    ..a<JobGetQueryResultsResponse>(14, 'jobGetQueryResultsResponse', PbFieldType.OM, JobGetQueryResultsResponse.getDefault, JobGetQueryResultsResponse.create)
    ..a<JobQueryDoneResponse>(15, 'jobQueryDoneResponse', PbFieldType.OM, JobQueryDoneResponse.getDefault, JobQueryDoneResponse.create)
    ..a<TableUpdateRequest>(16, 'tableUpdateRequest', PbFieldType.OM, TableUpdateRequest.getDefault, TableUpdateRequest.create)
    ..a<JobCompletedEvent>(17, 'jobCompletedEvent', PbFieldType.OM, JobCompletedEvent.getDefault, JobCompletedEvent.create)
    ..a<JobInsertResponse>(18, 'jobInsertResponse', PbFieldType.OM, JobInsertResponse.getDefault, JobInsertResponse.create)
...
class TableInsertRequest extends GeneratedMessage {
  ...
  TableInsertRequest.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  TableInsertRequest.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  TableInsertRequest clone() => new TableInsertRequest()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static TableInsertRequest create() => new TableInsertRequest();
  static PbList<TableInsertRequest> createRepeated() => new PbList<TableInsertRequest>();
  static TableInsertRequest getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyTableInsertRequest();
    return _defaultInstance;
  }
...
class _ReadonlyTableInsertRequest extends TableInsertRequest with ReadonlyMessageMixin {}
...
class TableUpdateRequest extends GeneratedMessage {
  ...
  TableUpdateRequest.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  TableUpdateRequest.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  TableUpdateRequest clone() => new TableUpdateRequest()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static TableUpdateRequest create() => new TableUpdateRequest();
  static PbList<TableUpdateRequest> createRepeated() => new PbList<TableUpdateRequest>();
  static TableUpdateRequest getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyTableUpdateRequest();
    return _defaultInstance;
  }
...
class _ReadonlyTableUpdateRequest extends TableUpdateRequest with ReadonlyMessageMixin {}
...
class TableInsertResponse extends GeneratedMessage {
  ...
  TableInsertResponse.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  TableInsertResponse.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  TableInsertResponse clone() => new TableInsertResponse()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static TableInsertResponse create() => new TableInsertResponse();
  static PbList<TableInsertResponse> createRepeated() => new PbList<TableInsertResponse>();
  static TableInsertResponse getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyTableInsertResponse();
    return _defaultInstance;
  }
...
class _ReadonlyTableInsertResponse extends TableInsertResponse with ReadonlyMessageMixin {}
...
class TableUpdateResponse extends GeneratedMessage {
  ...
  TableUpdateResponse.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  TableUpdateResponse.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  TableUpdateResponse clone() => new TableUpdateResponse()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static TableUpdateResponse create() => new TableUpdateResponse();
  static PbList<TableUpdateResponse> createRepeated() => new PbList<TableUpdateResponse>();
  static TableUpdateResponse getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyTableUpdateResponse();
    return _defaultInstance;
  }
...
class _ReadonlyTableUpdateResponse extends TableUpdateResponse with ReadonlyMessageMixin {}
...
class DatasetListRequest extends GeneratedMessage {
  ...
  DatasetListRequest.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  DatasetListRequest.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  DatasetListRequest clone() => new DatasetListRequest()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static DatasetListRequest create() => new DatasetListRequest();
  static PbList<DatasetListRequest> createRepeated() => new PbList<DatasetListRequest>();
  static DatasetListRequest getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyDatasetListRequest();
    return _defaultInstance;
  }
  ...
  set listAll(bool v) { $_setBool(0, v); }
  bool hasListAll() => $_has(0);
  void clearListAll() => clearField(1);
}

class _ReadonlyDatasetListRequest extends DatasetListRequest with ReadonlyMessageMixin {}

class DatasetInsertRequest extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('DatasetInsertRequest')
    ..a<Dataset>(1, 'resource', PbFieldType.OM, Dataset.getDefault, Dataset.create)
    ..hasRequiredFields = false
  ;

  DatasetInsertRequest() : super();
  DatasetInsertRequest.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  DatasetInsertRequest.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  DatasetInsertRequest clone() => new DatasetInsertRequest()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static DatasetInsertRequest create() => new DatasetInsertRequest();
  static PbList<DatasetInsertRequest> createRepeated() => new PbList<DatasetInsertRequest>();
  static DatasetInsertRequest getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyDatasetInsertRequest();
    return _defaultInstance;
  }
...
class _ReadonlyDatasetInsertRequest extends DatasetInsertRequest with ReadonlyMessageMixin {}
...
class DatasetInsertResponse extends GeneratedMessage {
  ...
  DatasetInsertResponse.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  DatasetInsertResponse.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  DatasetInsertResponse clone() => new DatasetInsertResponse()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static DatasetInsertResponse create() => new DatasetInsertResponse();
  static PbList<DatasetInsertResponse> createRepeated() => new PbList<DatasetInsertResponse>();
  static DatasetInsertResponse getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyDatasetInsertResponse();
    return _defaultInstance;
  }
  static DatasetInsertResponse _defaultInstance;
  static void $checkItem(DatasetInsertResponse v) {
    if (v is! DatasetInsertResponse) checkItemFailed(v, 'DatasetInsertResponse');
  }
...
class _ReadonlyDatasetInsertResponse extends DatasetInsertResponse with ReadonlyMessageMixin {}
...
class DatasetUpdateRequest extends GeneratedMessage {
  ...
  DatasetUpdateRequest.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  DatasetUpdateRequest.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  DatasetUpdateRequest clone() => new DatasetUpdateRequest()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static DatasetUpdateRequest create() => new DatasetUpdateRequest();
  static PbList<DatasetUpdateRequest> createRepeated() => new PbList<DatasetUpdateRequest>();
  static DatasetUpdateRequest getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyDatasetUpdateRequest();
    return _defaultInstance;
  }
...
class _ReadonlyDatasetUpdateRequest extends DatasetUpdateRequest with ReadonlyMessageMixin {}
...
class DatasetUpdateResponse extends GeneratedMessage {
  ...
  DatasetUpdateResponse.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  DatasetUpdateResponse.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  DatasetUpdateResponse clone() => new DatasetUpdateResponse()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static DatasetUpdateResponse create() => new DatasetUpdateResponse();
  static PbList<DatasetUpdateResponse> createRepeated() => new PbList<DatasetUpdateResponse>();
  static DatasetUpdateResponse getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyDatasetUpdateResponse();
    return _defaultInstance;
  }
  static DatasetUpdateResponse _defaultInstance;
  static void $checkItem(DatasetUpdateResponse v) {
    if (v is! DatasetUpdateResponse) checkItemFailed(v, 'DatasetUpdateResponse');
  }
...
class _ReadonlyDatasetUpdateResponse extends DatasetUpdateResponse with ReadonlyMessageMixin {}
...
class JobInsertRequest extends GeneratedMessage {
  ...
  JobInsertRequest.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  JobInsertRequest.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  JobInsertRequest clone() => new JobInsertRequest()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static JobInsertRequest create() => new JobInsertRequest();
  static PbList<JobInsertRequest> createRepeated() => new PbList<JobInsertRequest>();
  static JobInsertRequest getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyJobInsertRequest();
    return _defaultInstance;
  }
...
class _ReadonlyJobInsertRequest extends JobInsertRequest with ReadonlyMessageMixin {}
...
class JobInsertResponse extends GeneratedMessage {
  ...
  JobInsertResponse.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  JobInsertResponse.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  JobInsertResponse clone() => new JobInsertResponse()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static JobInsertResponse create() => new JobInsertResponse();
  static PbList<JobInsertResponse> createRepeated() => new PbList<JobInsertResponse>();
  static JobInsertResponse getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyJobInsertResponse();
    return _defaultInstance;
  }
...
class _ReadonlyJobInsertResponse extends JobInsertResponse with ReadonlyMessageMixin {}
...
class JobQueryRequest extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('JobQueryRequest')
    ...
    ..a<DatasetName>(3, 'defaultDataset', PbFieldType.OM, DatasetName.getDefault, DatasetName.create)
    ..aOS(4, 'projectId')
    ..aOB(5, 'dryRun')
    ..hasRequiredFields = false
  ;
  ...
  JobQueryRequest.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  JobQueryRequest.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  JobQueryRequest clone() => new JobQueryRequest()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static JobQueryRequest create() => new JobQueryRequest();
  static PbList<JobQueryRequest> createRepeated() => new PbList<JobQueryRequest>();
  static JobQueryRequest getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyJobQueryRequest();
    return _defaultInstance;
  }
  ...
  set maxResults(int v) { $_setUnsignedInt32(1, v); }
  ...
  set projectId(String v) { $_setString(3, v); }
  bool hasProjectId() => $_has(3);
  void clearProjectId() => clearField(4);

  bool get dryRun => $_get(4, false);
  set dryRun(bool v) { $_setBool(4, v); }
  bool hasDryRun() => $_has(4);
  void clearDryRun() => clearField(5);
}

class _ReadonlyJobQueryRequest extends JobQueryRequest with ReadonlyMessageMixin {}
...
class JobQueryResponse extends GeneratedMessage {
  ...
  JobQueryResponse.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  JobQueryResponse.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  JobQueryResponse clone() => new JobQueryResponse()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static JobQueryResponse create() => new JobQueryResponse();
  static PbList<JobQueryResponse> createRepeated() => new PbList<JobQueryResponse>();
  static JobQueryResponse getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyJobQueryResponse();
    return _defaultInstance;
  }
...
class _ReadonlyJobQueryResponse extends JobQueryResponse with ReadonlyMessageMixin {}
...
class JobGetQueryResultsRequest extends GeneratedMessage {
  ...
  JobGetQueryResultsRequest.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  JobGetQueryResultsRequest.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  JobGetQueryResultsRequest clone() => new JobGetQueryResultsRequest()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static JobGetQueryResultsRequest create() => new JobGetQueryResultsRequest();
  static PbList<JobGetQueryResultsRequest> createRepeated() => new PbList<JobGetQueryResultsRequest>();
  static JobGetQueryResultsRequest getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyJobGetQueryResultsRequest();
    return _defaultInstance;
  }
  static JobGetQueryResultsRequest _defaultInstance;
  static void $checkItem(JobGetQueryResultsRequest v) {
    if (v is! JobGetQueryResultsRequest) checkItemFailed(v, 'JobGetQueryResultsRequest');
  }

  int get maxResults => $_get(0, 0);
  set maxResults(int v) { $_setUnsignedInt32(0, v); }
...
class _ReadonlyJobGetQueryResultsRequest extends JobGetQueryResultsRequest with ReadonlyMessageMixin {}
...
class JobGetQueryResultsResponse extends GeneratedMessage {
  ...
  JobGetQueryResultsResponse.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  JobGetQueryResultsResponse.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  JobGetQueryResultsResponse clone() => new JobGetQueryResultsResponse()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static JobGetQueryResultsResponse create() => new JobGetQueryResultsResponse();
  static PbList<JobGetQueryResultsResponse> createRepeated() => new PbList<JobGetQueryResultsResponse>();
  static JobGetQueryResultsResponse getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyJobGetQueryResultsResponse();
    return _defaultInstance;
  }
  static JobGetQueryResultsResponse _defaultInstance;
  static void $checkItem(JobGetQueryResultsResponse v) {
    if (v is! JobGetQueryResultsResponse) checkItemFailed(v, 'JobGetQueryResultsResponse');
  }
...
class _ReadonlyJobGetQueryResultsResponse extends JobGetQueryResultsResponse with ReadonlyMessageMixin {}
...
class JobQueryDoneResponse extends GeneratedMessage {
  ...
  JobQueryDoneResponse.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  JobQueryDoneResponse.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  JobQueryDoneResponse clone() => new JobQueryDoneResponse()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static JobQueryDoneResponse create() => new JobQueryDoneResponse();
  static PbList<JobQueryDoneResponse> createRepeated() => new PbList<JobQueryDoneResponse>();
  static JobQueryDoneResponse getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyJobQueryDoneResponse();
    return _defaultInstance;
  }
...
class _ReadonlyJobQueryDoneResponse extends JobQueryDoneResponse with ReadonlyMessageMixin {}
...
class JobCompletedEvent extends GeneratedMessage {
  ...
  JobCompletedEvent.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  JobCompletedEvent.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  JobCompletedEvent clone() => new JobCompletedEvent()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static JobCompletedEvent create() => new JobCompletedEvent();
  static PbList<JobCompletedEvent> createRepeated() => new PbList<JobCompletedEvent>();
  static JobCompletedEvent getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyJobCompletedEvent();
    return _defaultInstance;
  }
  ...
  set eventName(String v) { $_setString(0, v); }
...
class _ReadonlyJobCompletedEvent extends JobCompletedEvent with ReadonlyMessageMixin {}
...
class TableDataListRequest extends GeneratedMessage {
  ...
  TableDataListRequest.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  TableDataListRequest.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  TableDataListRequest clone() => new TableDataListRequest()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static TableDataListRequest create() => new TableDataListRequest();
  static PbList<TableDataListRequest> createRepeated() => new PbList<TableDataListRequest>();
  static TableDataListRequest getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyTableDataListRequest();
    return _defaultInstance;
  }
...
class _ReadonlyTableDataListRequest extends TableDataListRequest with ReadonlyMessageMixin {}

class Table extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('Table')
    ..a<TableName>(1, 'tableName', PbFieldType.OM, TableName.getDefault, TableName.create)
    ..a<TableInfo>(2, 'info', PbFieldType.OM, TableInfo.getDefault, TableInfo.create)
    ..a<TableViewDefinition>(4, 'view', PbFieldType.OM, TableViewDefinition.getDefault, TableViewDefinition.create)
    ...
    ..a<$google$protobuf.Timestamp>(7, 'truncateTime', PbFieldType.OM, $google$protobuf.Timestamp.getDefault, $google$protobuf.Timestamp.create)
    ..aOS(8, 'schemaJson')
    ..hasRequiredFields = false
  ;
  ...
  set truncateTime($google$protobuf.Timestamp v) { setField(7, v); }
  bool hasTruncateTime() => $_has(5);
  void clearTruncateTime() => clearField(7);

  String get schemaJson => $_getS(6, '');
  set schemaJson(String v) { $_setString(6, v); }
...
class TableInfo extends GeneratedMessage {
  ...
  TableInfo() : super();
  TableInfo.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  TableInfo.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ...
  set friendlyName(String v) { $_setString(0, v); }
...
class TableViewDefinition extends GeneratedMessage {
  ...
  TableViewDefinition.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  TableViewDefinition.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  TableViewDefinition clone() => new TableViewDefinition()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static TableViewDefinition create() => new TableViewDefinition();
  static PbList<TableViewDefinition> createRepeated() => new PbList<TableViewDefinition>();
  static TableViewDefinition getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyTableViewDefinition();
    return _defaultInstance;
  }
...
class _ReadonlyTableViewDefinition extends TableViewDefinition with ReadonlyMessageMixin {}

class Dataset extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('Dataset')
    ..a<DatasetName>(1, 'datasetName', PbFieldType.OM, DatasetName.getDefault, DatasetName.create)
    ..a<DatasetInfo>(2, 'info', PbFieldType.OM, DatasetInfo.getDefault, DatasetInfo.create)
    ...
    ..a<BigQueryAcl>(6, 'acl', PbFieldType.OM, BigQueryAcl.getDefault, BigQueryAcl.create)
    ..a<$google$protobuf.Duration>(8, 'defaultTableExpireDuration', PbFieldType.OM, $google$protobuf.Duration.getDefault, $google$protobuf.Duration.create)
    ..hasRequiredFields = false
  ;
  ...
  set defaultTableExpireDuration($google$protobuf.Duration v) { setField(8, v); }
...
class DatasetInfo extends GeneratedMessage {
  ...
  DatasetInfo() : super();
  DatasetInfo.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  DatasetInfo.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
...
class BigQueryAcl_Entry extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('BigQueryAcl_Entry')
    ...
    ..aOS(4, 'domain')
    ..aOS(5, 'specialGroup')
    ..a<TableName>(6, 'viewName', PbFieldType.OM, TableName.getDefault, TableName.create)
    ..hasRequiredFields = false
  ;

  BigQueryAcl_Entry() : super();
  BigQueryAcl_Entry.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  BigQueryAcl_Entry.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  BigQueryAcl_Entry clone() => new BigQueryAcl_Entry()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static BigQueryAcl_Entry create() => new BigQueryAcl_Entry();
  static PbList<BigQueryAcl_Entry> createRepeated() => new PbList<BigQueryAcl_Entry>();
  static BigQueryAcl_Entry getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyBigQueryAcl_Entry();
    return _defaultInstance;
  }
...
class _ReadonlyBigQueryAcl_Entry extends BigQueryAcl_Entry with ReadonlyMessageMixin {}

class BigQueryAcl extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('BigQueryAcl')
    ..pp<BigQueryAcl_Entry>(1, 'entries', PbFieldType.PM, BigQueryAcl_Entry.$checkItem, BigQueryAcl_Entry.create)
    ..hasRequiredFields = false
  ;

  BigQueryAcl() : super();
  BigQueryAcl.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  BigQueryAcl.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
...
class Job extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('Job')
    ..a<JobName>(1, 'jobName', PbFieldType.OM, JobName.getDefault, JobName.create)
    ..a<JobConfiguration>(2, 'jobConfiguration', PbFieldType.OM, JobConfiguration.getDefault, JobConfiguration.create)
    ..a<JobStatus>(3, 'jobStatus', PbFieldType.OM, JobStatus.getDefault, JobStatus.create)
    ..a<JobStatistics>(4, 'jobStatistics', PbFieldType.OM, JobStatistics.getDefault, JobStatistics.create)
    ..hasRequiredFields = false
  ;
...
class JobConfiguration_Query extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('JobConfiguration_Query')
    ..aOS(1, 'query')
    ..a<TableName>(2, 'destinationTable', PbFieldType.OM, TableName.getDefault, TableName.create)
    ..aOS(3, 'createDisposition')
    ..aOS(4, 'writeDisposition')
    ..a<DatasetName>(5, 'defaultDataset', PbFieldType.OM, DatasetName.getDefault, DatasetName.create)
    ..pp<TableDefinition>(6, 'tableDefinitions', PbFieldType.PM, TableDefinition.$checkItem, TableDefinition.create)
    ..hasRequiredFields = false
  ;

  JobConfiguration_Query() : super();
  JobConfiguration_Query.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  JobConfiguration_Query.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  JobConfiguration_Query clone() => new JobConfiguration_Query()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static JobConfiguration_Query create() => new JobConfiguration_Query();
  static PbList<JobConfiguration_Query> createRepeated() => new PbList<JobConfiguration_Query>();
  static JobConfiguration_Query getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyJobConfiguration_Query();
    return _defaultInstance;
  }
  static JobConfiguration_Query _defaultInstance;
  static void $checkItem(JobConfiguration_Query v) {
    if (v is! JobConfiguration_Query) checkItemFailed(v, 'JobConfiguration_Query');
  }
...
class _ReadonlyJobConfiguration_Query extends JobConfiguration_Query with ReadonlyMessageMixin {}

class JobConfiguration_Load extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('JobConfiguration_Load')
    ..pPS(1, 'sourceUris')
    ..a<TableName>(3, 'destinationTable', PbFieldType.OM, TableName.getDefault, TableName.create)
  ...
  JobConfiguration_Load.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  JobConfiguration_Load.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  JobConfiguration_Load clone() => new JobConfiguration_Load()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static JobConfiguration_Load create() => new JobConfiguration_Load();
  static PbList<JobConfiguration_Load> createRepeated() => new PbList<JobConfiguration_Load>();
  static JobConfiguration_Load getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyJobConfiguration_Load();
    return _defaultInstance;
  }
  static JobConfiguration_Load _defaultInstance;
  static void $checkItem(JobConfiguration_Load v) {
    if (v is! JobConfiguration_Load) checkItemFailed(v, 'JobConfiguration_Load');
  }
  ...
  set schemaJson(String v) { $_setString(4, v); }
  bool hasSchemaJson() => $_has(4);
  void clearSchemaJson() => clearField(6);
}

class _ReadonlyJobConfiguration_Load extends JobConfiguration_Load with ReadonlyMessageMixin {}
...
class JobConfiguration_Extract extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('JobConfiguration_Extract')
    ...
    ..a<TableName>(2, 'sourceTable', PbFieldType.OM, TableName.getDefault, TableName.create)
    ..hasRequiredFields = false
  ;

  JobConfiguration_Extract() : super();
  JobConfiguration_Extract.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  JobConfiguration_Extract.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  JobConfiguration_Extract clone() => new JobConfiguration_Extract()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static JobConfiguration_Extract create() => new JobConfiguration_Extract();
  static PbList<JobConfiguration_Extract> createRepeated() => new PbList<JobConfiguration_Extract>();
  static JobConfiguration_Extract getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyJobConfiguration_Extract();
    return _defaultInstance;
  }
  static JobConfiguration_Extract _defaultInstance;
  static void $checkItem(JobConfiguration_Extract v) {
    if (v is! JobConfiguration_Extract) checkItemFailed(v, 'JobConfiguration_Extract');
  }
...
class _ReadonlyJobConfiguration_Extract extends JobConfiguration_Extract with ReadonlyMessageMixin {}
...
class JobConfiguration_TableCopy extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('JobConfiguration_TableCopy')
    ..pp<TableName>(1, 'sourceTables', PbFieldType.PM, TableName.$checkItem, TableName.create)
    ..a<TableName>(2, 'destinationTable', PbFieldType.OM, TableName.getDefault, TableName.create)
    ..aOS(3, 'createDisposition')
    ..aOS(4, 'writeDisposition')
    ..hasRequiredFields = false
  ...
  JobConfiguration_TableCopy.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  JobConfiguration_TableCopy.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  JobConfiguration_TableCopy clone() => new JobConfiguration_TableCopy()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static JobConfiguration_TableCopy create() => new JobConfiguration_TableCopy();
  static PbList<JobConfiguration_TableCopy> createRepeated() => new PbList<JobConfiguration_TableCopy>();
  static JobConfiguration_TableCopy getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyJobConfiguration_TableCopy();
    return _defaultInstance;
  }
  static JobConfiguration_TableCopy _defaultInstance;
  static void $checkItem(JobConfiguration_TableCopy v) {
    if (v is! JobConfiguration_TableCopy) checkItemFailed(v, 'JobConfiguration_TableCopy');
  }
...
class _ReadonlyJobConfiguration_TableCopy extends JobConfiguration_TableCopy with ReadonlyMessageMixin {}

class JobConfiguration extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('JobConfiguration')
    ..a<JobConfiguration_Query>(5, 'query', PbFieldType.OM, JobConfiguration_Query.getDefault, JobConfiguration_Query.create)
    ..a<JobConfiguration_Load>(6, 'load', PbFieldType.OM, JobConfiguration_Load.getDefault, JobConfiguration_Load.create)
    ..a<JobConfiguration_Extract>(7, 'extract', PbFieldType.OM, JobConfiguration_Extract.getDefault, JobConfiguration_Extract.create)
    ..a<JobConfiguration_TableCopy>(8, 'tableCopy', PbFieldType.OM, JobConfiguration_TableCopy.getDefault, JobConfiguration_TableCopy.create)
    ..aOB(9, 'dryRun')
    ..hasRequiredFields = false
  ;

  JobConfiguration() : super();
  JobConfiguration.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  JobConfiguration.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  JobConfiguration clone() => new JobConfiguration()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static JobConfiguration create() => new JobConfiguration();
  static PbList<JobConfiguration> createRepeated() => new PbList<JobConfiguration>();
  static JobConfiguration getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyJobConfiguration();
    return _defaultInstance;
  }
...
class _ReadonlyJobConfiguration extends JobConfiguration with ReadonlyMessageMixin {}
...
class TableDefinition extends GeneratedMessage {
  ...
  TableDefinition.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  TableDefinition.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  TableDefinition clone() => new TableDefinition()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static TableDefinition create() => new TableDefinition();
  static PbList<TableDefinition> createRepeated() => new PbList<TableDefinition>();
  static TableDefinition getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyTableDefinition();
    return _defaultInstance;
  }
...
class _ReadonlyTableDefinition extends TableDefinition with ReadonlyMessageMixin {}

class JobStatus extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('JobStatus')
    ..aOS(1, 'state')
    ..a<$google$rpc.Status>(2, 'error', PbFieldType.OM, $google$rpc.Status.getDefault, $google$rpc.Status.create)
    ..hasRequiredFields = false
  ;
  ...
  set state(String v) { $_setString(0, v); }
  bool hasState() => $_has(0);
  void clearState() => clearField(1);

  $google$rpc.Status get error => $_getN(1);
  set error($google$rpc.Status v) { setField(2, v); }
...
class JobStatistics extends GeneratedMessage {
  ...
  JobStatistics() : super();
  JobStatistics.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  JobStatistics.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ...
  static JobStatistics getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyJobStatistics();
    return _defaultInstance;
  }
  ...
  set billingTier(int v) { $_setSignedInt32(5, v); }
...
class DatasetName extends GeneratedMessage {
  ...
  DatasetName() : super();
  DatasetName.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  DatasetName.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
...
class TableName extends GeneratedMessage {
  ...
  TableName() : super();
  TableName.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  TableName.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
...
class JobName extends GeneratedMessage {
  ...
  JobName() : super();
  JobName.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  JobName.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
