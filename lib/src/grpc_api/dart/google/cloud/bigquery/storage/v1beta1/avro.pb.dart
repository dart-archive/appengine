...
class AvroSchema extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('AvroSchema', package: const $pb.PackageName('google.cloud.bigquery.storage.v1beta1'))
    ..aOS(1, 'schema')
    ..hasRequiredFields = false
  ;

  AvroSchema() : super();
  AvroSchema.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  AvroSchema.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  AvroSchema clone() => AvroSchema()..mergeFromMessage(this);
  AvroSchema copyWith(void Function(AvroSchema) updates) => super.copyWith((message) => updates(message as AvroSchema));
...
class AvroRows extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('AvroRows', package: const $pb.PackageName('google.cloud.bigquery.storage.v1beta1'))
  ...
  AvroRows() : super();
  AvroRows.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  AvroRows.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  AvroRows clone() => AvroRows()..mergeFromMessage(this);
  AvroRows copyWith(void Function(AvroRows) updates) => super.copyWith((message) => updates(message as AvroRows));
  $pb.BuilderInfo get info_ => _i;
