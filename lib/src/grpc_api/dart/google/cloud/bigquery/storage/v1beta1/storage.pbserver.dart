...
abstract class BigQueryStorageServiceBase extends $pb.GeneratedService {
  $async.Future<ReadSession> createReadSession(
      $pb.ServerContext ctx, CreateReadSessionRequest request);
  $async.Future<ReadRowsResponse> readRows(
      $pb.ServerContext ctx, ReadRowsRequest request);
  $async.Future<BatchCreateReadSessionStreamsResponse>
      batchCreateReadSessionStreams(
          $pb.ServerContext ctx, BatchCreateReadSessionStreamsRequest request);
  $async.Future<$4.Empty> finalizeStream(
      $pb.ServerContext ctx, FinalizeStreamRequest request);
  $async.Future<SplitReadStreamResponse> splitReadStream(
      $pb.ServerContext ctx, SplitReadStreamRequest request);
  ...
  $async.Future<$pb.GeneratedMessage> handleCall($pb.ServerContext ctx,
    ...
    switch (method) {
      case 'CreateReadSession':
        return this.createReadSession(ctx, request);
      case 'ReadRows':
        return this.readRows(ctx, request);
      case 'BatchCreateReadSessionStreams':
        return this.batchCreateReadSessionStreams(ctx, request);
      case 'FinalizeStream':
        return this.finalizeStream(ctx, request);
      case 'SplitReadStream':
        return this.splitReadStream(ctx, request);
      default:
        throw $core.ArgumentError('Unknown method: $method');
    }
  }
  ...
  $core.Map<$core.String, $core.dynamic> get $json =>
      BigQueryStorageServiceBase$json;
  $core.Map<$core.String, $core.Map<$core.String, $core.dynamic>>
      get $messageJson => BigQueryStorageServiceBase$messageJson;
}
