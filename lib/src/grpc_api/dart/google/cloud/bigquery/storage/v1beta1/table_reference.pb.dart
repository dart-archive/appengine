...
class TableReference extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('TableReference', package: const $pb.PackageName('google.cloud.bigquery.storage.v1beta1'))
    ..aOS(1, 'projectId')
    ..aOS(2, 'datasetId')
    ..aOS(3, 'tableId')
  ...
  TableReference.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  TableReference.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  TableReference clone() => TableReference()..mergeFromMessage(this);
  TableReference copyWith(void Function(TableReference) updates) => super.copyWith((message) => updates(message as TableReference));
...
class TableModifiers extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('TableModifiers', package: const $pb.PackageName('google.cloud.bigquery.storage.v1beta1'))
    ..a<$0.Timestamp>(1, 'snapshotTime', $pb.PbFieldType.OM, $0.Timestamp.getDefault, $0.Timestamp.create)
    ..hasRequiredFields = false
  ;

  TableModifiers() : super();
  TableModifiers.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  TableModifiers.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  TableModifiers clone() => TableModifiers()..mergeFromMessage(this);
  TableModifiers copyWith(void Function(TableModifiers) updates) => super.copyWith((message) => updates(message as TableModifiers));
  $pb.BuilderInfo get info_ => _i;
