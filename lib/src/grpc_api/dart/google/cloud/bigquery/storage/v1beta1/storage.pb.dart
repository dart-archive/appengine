...
class Stream extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Stream', package: const $pb.PackageName('google.cloud.bigquery.storage.v1beta1'))
    ..aOS(1, 'name')
    ..aInt64(2, 'rowCount')
  ...
  Stream() : super();
  Stream.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  Stream.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ...
  set rowCount(Int64 v) { $_setInt64(1, v); }
  $core.bool hasRowCount() => $_has(1);
  void clearRowCount() => clearField(2);
}

class StreamPosition extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('StreamPosition', package: const $pb.PackageName('google.cloud.bigquery.storage.v1beta1'))
  ...
  StreamPosition.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  StreamPosition.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  StreamPosition clone() => StreamPosition()..mergeFromMessage(this);
  StreamPosition copyWith(void Function(StreamPosition) updates) => super.copyWith((message) => updates(message as StreamPosition));
  $pb.BuilderInfo get info_ => _i;
...
class ReadSession extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ReadSession', package: const $pb.PackageName('google.cloud.bigquery.storage.v1beta1'))
    ..aOS(1, 'name')
    ...
    ..a<$1.AvroSchema>(5, 'avroSchema', $pb.PbFieldType.OM, $1.AvroSchema.getDefault, $1.AvroSchema.create)
    ..a<$2.TableReference>(7, 'tableReference', $pb.PbFieldType.OM, $2.TableReference.getDefault, $2.TableReference.create)
    ..a<$2.TableModifiers>(8, 'tableModifiers', $pb.PbFieldType.OM, $2.TableModifiers.getDefault, $2.TableModifiers.create)
    ..oo(0, [5])
    ..hasRequiredFields = false
  ;

  ReadSession() : super();
  ReadSession.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  ReadSession.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ReadSession clone() => ReadSession()..mergeFromMessage(this);
  ReadSession copyWith(void Function(ReadSession) updates) => super.copyWith((message) => updates(message as ReadSession));
  $pb.BuilderInfo get info_ => _i;
...
class CreateReadSessionRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('CreateReadSessionRequest', package: const $pb.PackageName('google.cloud.bigquery.storage.v1beta1'))
    ..a<$2.TableReference>(1, 'tableReference', $pb.PbFieldType.OM, $2.TableReference.getDefault, $2.TableReference.create)
    ..a<$2.TableModifiers>(2, 'tableModifiers', $pb.PbFieldType.OM, $2.TableModifiers.getDefault, $2.TableModifiers.create)
    ..a<$core.int>(3, 'requestedStreams', $pb.PbFieldType.O3)
    ..a<$3.TableReadOptions>(4, 'readOptions', $pb.PbFieldType.OM, $3.TableReadOptions.getDefault, $3.TableReadOptions.create)
    ..e<DataFormat>(5, 'format', $pb.PbFieldType.OE, DataFormat.DATA_FORMAT_UNSPECIFIED, DataFormat.valueOf, DataFormat.values)
    ..aOS(6, 'parent')
    ..hasRequiredFields = false
  ;

  CreateReadSessionRequest() : super();
  CreateReadSessionRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  CreateReadSessionRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  CreateReadSessionRequest clone() => CreateReadSessionRequest()..mergeFromMessage(this);
  CreateReadSessionRequest copyWith(void Function(CreateReadSessionRequest) updates) => super.copyWith((message) => updates(message as CreateReadSessionRequest));
  $pb.BuilderInfo get info_ => _i;
  ...
  set readOptions($3.TableReadOptions v) { setField(4, v); }
...
class ReadRowsRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ReadRowsRequest', package: const $pb.PackageName('google.cloud.bigquery.storage.v1beta1'))
    ..a<StreamPosition>(1, 'readPosition', $pb.PbFieldType.OM, StreamPosition.getDefault, StreamPosition.create)
    ..hasRequiredFields = false
  ;
...
class StreamStatus extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('StreamStatus', package: const $pb.PackageName('google.cloud.bigquery.storage.v1beta1'))
    ..aInt64(1, 'estimatedRowCount')
    ..hasRequiredFields = false
  ;

  StreamStatus() : super();
  StreamStatus.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  StreamStatus.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  StreamStatus clone() => StreamStatus()..mergeFromMessage(this);
  StreamStatus copyWith(void Function(StreamStatus) updates) => super.copyWith((message) => updates(message as StreamStatus));
  $pb.BuilderInfo get info_ => _i;
  ...
  set estimatedRowCount(Int64 v) { $_setInt64(0, v); }
...
class ThrottleStatus extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ThrottleStatus', package: const $pb.PackageName('google.cloud.bigquery.storage.v1beta1'))
    ..a<$core.int>(1, 'throttlePercent', $pb.PbFieldType.O3)
    ..hasRequiredFields = false
  ;

  ThrottleStatus() : super();
  ThrottleStatus.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  ThrottleStatus.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ThrottleStatus clone() => ThrottleStatus()..mergeFromMessage(this);
  ThrottleStatus copyWith(void Function(ThrottleStatus) updates) => super.copyWith((message) => updates(message as ThrottleStatus));
  $pb.BuilderInfo get info_ => _i;
...
class ReadRowsResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ReadRowsResponse', package: const $pb.PackageName('google.cloud.bigquery.storage.v1beta1'))
    ..a<StreamStatus>(2, 'status', $pb.PbFieldType.OM, StreamStatus.getDefault, StreamStatus.create)
    ..a<$1.AvroRows>(3, 'avroRows', $pb.PbFieldType.OM, $1.AvroRows.getDefault, $1.AvroRows.create)
    ..a<ThrottleStatus>(5, 'throttleStatus', $pb.PbFieldType.OM, ThrottleStatus.getDefault, ThrottleStatus.create)
    ..oo(0, [3])
    ..hasRequiredFields = false
  ;
  ...
  set avroRows($1.AvroRows v) { setField(3, v); }
...
class BatchCreateReadSessionStreamsRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('BatchCreateReadSessionStreamsRequest', package: const $pb.PackageName('google.cloud.bigquery.storage.v1beta1'))
    ..a<ReadSession>(1, 'session', $pb.PbFieldType.OM, ReadSession.getDefault, ReadSession.create)
    ..a<$core.int>(2, 'requestedStreams', $pb.PbFieldType.O3)
    ..hasRequiredFields = false
  ;

  BatchCreateReadSessionStreamsRequest() : super();
  BatchCreateReadSessionStreamsRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  BatchCreateReadSessionStreamsRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  BatchCreateReadSessionStreamsRequest clone() => BatchCreateReadSessionStreamsRequest()..mergeFromMessage(this);
  BatchCreateReadSessionStreamsRequest copyWith(void Function(BatchCreateReadSessionStreamsRequest) updates) => super.copyWith((message) => updates(message as BatchCreateReadSessionStreamsRequest));
  $pb.BuilderInfo get info_ => _i;
  static BatchCreateReadSessionStreamsRequest create() => BatchCreateReadSessionStreamsRequest();
  ...
  static BatchCreateReadSessionStreamsRequest getDefault() => _defaultInstance ??= create()..freeze();
...
class BatchCreateReadSessionStreamsResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('BatchCreateReadSessionStreamsResponse', package: const $pb.PackageName('google.cloud.bigquery.storage.v1beta1'))
    ..pc<Stream>(1, 'streams', $pb.PbFieldType.PM,Stream.create)
    ..hasRequiredFields = false
  ;

  BatchCreateReadSessionStreamsResponse() : super();
  BatchCreateReadSessionStreamsResponse.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  BatchCreateReadSessionStreamsResponse.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  BatchCreateReadSessionStreamsResponse clone() => BatchCreateReadSessionStreamsResponse()..mergeFromMessage(this);
  BatchCreateReadSessionStreamsResponse copyWith(void Function(BatchCreateReadSessionStreamsResponse) updates) => super.copyWith((message) => updates(message as BatchCreateReadSessionStreamsResponse));
  $pb.BuilderInfo get info_ => _i;
  static BatchCreateReadSessionStreamsResponse create() => BatchCreateReadSessionStreamsResponse();
  ...
  static BatchCreateReadSessionStreamsResponse getDefault() => _defaultInstance ??= create()..freeze();
...
class FinalizeStreamRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('FinalizeStreamRequest', package: const $pb.PackageName('google.cloud.bigquery.storage.v1beta1'))
    ..a<Stream>(2, 'stream', $pb.PbFieldType.OM, Stream.getDefault, Stream.create)
    ..hasRequiredFields = false
  ;

  FinalizeStreamRequest() : super();
  FinalizeStreamRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  FinalizeStreamRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  FinalizeStreamRequest clone() => FinalizeStreamRequest()..mergeFromMessage(this);
  FinalizeStreamRequest copyWith(void Function(FinalizeStreamRequest) updates) => super.copyWith((message) => updates(message as FinalizeStreamRequest));
  $pb.BuilderInfo get info_ => _i;
  ...
  static FinalizeStreamRequest getDefault() => _defaultInstance ??= create()..freeze();
...
class SplitReadStreamRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('SplitReadStreamRequest', package: const $pb.PackageName('google.cloud.bigquery.storage.v1beta1'))
    ..a<Stream>(1, 'originalStream', $pb.PbFieldType.OM, Stream.getDefault, Stream.create)
    ..hasRequiredFields = false
  ;

  SplitReadStreamRequest() : super();
  SplitReadStreamRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  SplitReadStreamRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  SplitReadStreamRequest clone() => SplitReadStreamRequest()..mergeFromMessage(this);
  SplitReadStreamRequest copyWith(void Function(SplitReadStreamRequest) updates) => super.copyWith((message) => updates(message as SplitReadStreamRequest));
  $pb.BuilderInfo get info_ => _i;
  ...
  static SplitReadStreamRequest getDefault() => _defaultInstance ??= create()..freeze();
...
class SplitReadStreamResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('SplitReadStreamResponse', package: const $pb.PackageName('google.cloud.bigquery.storage.v1beta1'))
    ..a<Stream>(1, 'primaryStream', $pb.PbFieldType.OM, Stream.getDefault, Stream.create)
    ..a<Stream>(2, 'remainderStream', $pb.PbFieldType.OM, Stream.getDefault, Stream.create)
    ..hasRequiredFields = false
  ;

  SplitReadStreamResponse() : super();
  SplitReadStreamResponse.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  SplitReadStreamResponse.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  SplitReadStreamResponse clone() => SplitReadStreamResponse()..mergeFromMessage(this);
  SplitReadStreamResponse copyWith(void Function(SplitReadStreamResponse) updates) => super.copyWith((message) => updates(message as SplitReadStreamResponse));
  $pb.BuilderInfo get info_ => _i;
  ...
  static SplitReadStreamResponse getDefault() => _defaultInstance ??= create()..freeze();
...
class BigQueryStorageApi {
  ...
  $async.Future<ReadSession> createReadSession($pb.ClientContext ctx, CreateReadSessionRequest request) {
    var emptyResponse = ReadSession();
    return _client.invoke<ReadSession>(ctx, 'BigQueryStorage', 'CreateReadSession', request, emptyResponse);
  }
  $async.Future<ReadRowsResponse> readRows($pb.ClientContext ctx, ReadRowsRequest request) {
    var emptyResponse = ReadRowsResponse();
    return _client.invoke<ReadRowsResponse>(ctx, 'BigQueryStorage', 'ReadRows', request, emptyResponse);
  }
  $async.Future<BatchCreateReadSessionStreamsResponse> batchCreateReadSessionStreams($pb.ClientContext ctx, BatchCreateReadSessionStreamsRequest request) {
    var emptyResponse = BatchCreateReadSessionStreamsResponse();
    return _client.invoke<BatchCreateReadSessionStreamsResponse>(ctx, 'BigQueryStorage', 'BatchCreateReadSessionStreams', request, emptyResponse);
  }
  $async.Future<$4.Empty> finalizeStream($pb.ClientContext ctx, FinalizeStreamRequest request) {
    var emptyResponse = $4.Empty();
    return _client.invoke<$4.Empty>(ctx, 'BigQueryStorage', 'FinalizeStream', request, emptyResponse);
  }
  $async.Future<SplitReadStreamResponse> splitReadStream($pb.ClientContext ctx, SplitReadStreamRequest request) {
    var emptyResponse = SplitReadStreamResponse();
    return _client.invoke<SplitReadStreamResponse>(ctx, 'BigQueryStorage', 'SplitReadStream', request, emptyResponse);
  }
}
