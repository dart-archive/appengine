...
class TransferConfig extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('TransferConfig')
    ...
    ..a<$google$protobuf.Timestamp>(
        ...
        $google$protobuf.Timestamp.getDefault,
        $google$protobuf.Timestamp.create)
    ..a<$google$protobuf.Struct>(9, 'params', PbFieldType.OM,
  ...
  TransferConfig.fromBuffer(List<int> i,
  ...
  set destinationDatasetId(String v) {
    $_setString(1, v);
  }
  ...
  set nextRunTime($google$protobuf.Timestamp v) {
    setField(8, v);
  }
  ...
  set dataRefreshWindowDays(int v) {
...
class TransferRun extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('TransferRun')
    ...
    ..aInt64(11, 'userId')
    ..aOS(12, 'schedule')
    ..a<$google$rpc.Status>(21, 'errorStatus', PbFieldType.OM,
        $google$rpc.Status.getDefault, $google$rpc.Status.create)
    ..hasRequiredFields = false;

  TransferRun() : super();
  TransferRun.fromBuffer(List<int> i,
      [ExtensionRegistry r = ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);
  ...
  set runTime($google$protobuf.Timestamp v) {
    setField(10, v);
  }
  ...
  set errorStatus($google$rpc.Status v) {
    setField(21, v);
  }
...
class TransferMessage extends GeneratedMessage {
  ...
  TransferMessage.fromBuffer(List<int> i,
      [ExtensionRegistry r = ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);
  ...
  set messageTime($google$protobuf.Timestamp v) {
    setField(1, v);
  }
...
class _ReadonlyTransferMessage extends TransferMessage
