...
class TransferConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('TransferConfig', package: const $pb.PackageName('google.cloud.bigquery.datatransfer.v1'))
    ..aOS(1, 'name')
    ...
    ..aOS(5, 'dataSourceId')
    ..aOS(7, 'schedule')
    ..a<$0.Timestamp>(8, 'nextRunTime', $pb.PbFieldType.OM, $0.Timestamp.getDefault, $0.Timestamp.create)
    ..a<$1.Struct>(9, 'params', $pb.PbFieldType.OM, $1.Struct.getDefault, $1.Struct.create)
    ..e<TransferState>(10, 'state', $pb.PbFieldType.OE, TransferState.TRANSFER_STATE_UNSPECIFIED, TransferState.valueOf, TransferState.values)
    ..aInt64(11, 'userId')
  ...
  TransferConfig.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  TransferConfig.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  TransferConfig clone() => TransferConfig()..mergeFromMessage(this);
  TransferConfig copyWith(void Function(TransferConfig) updates) => super.copyWith((message) => updates(message as TransferConfig));
...
class TransferRun extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('TransferRun', package: const $pb.PackageName('google.cloud.bigquery.datatransfer.v1'))
    ..aOS(1, 'name')
    ..aOS(2, 'destinationDatasetId')
    ..a<$0.Timestamp>(3, 'scheduleTime', $pb.PbFieldType.OM, $0.Timestamp.getDefault, $0.Timestamp.create)
    ...
    ..aOS(7, 'dataSourceId')
    ..e<TransferState>(8, 'state', $pb.PbFieldType.OE, TransferState.TRANSFER_STATE_UNSPECIFIED, TransferState.valueOf, TransferState.values)
    ..a<$1.Struct>(9, 'params', $pb.PbFieldType.OM, $1.Struct.getDefault, $1.Struct.create)
    ..a<$0.Timestamp>(10, 'runTime', $pb.PbFieldType.OM, $0.Timestamp.getDefault, $0.Timestamp.create)
    ..aInt64(11, 'userId')
    ..aOS(12, 'schedule')
    ..a<$2.Status>(21, 'errorStatus', $pb.PbFieldType.OM, $2.Status.getDefault, $2.Status.create)
    ..hasRequiredFields = false
  ;

  TransferRun() : super();
  TransferRun.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  TransferRun.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  TransferRun clone() => TransferRun()..mergeFromMessage(this);
  TransferRun copyWith(void Function(TransferRun) updates) => super.copyWith((message) => updates(message as TransferRun));
  $pb.BuilderInfo get info_ => _i;
...
class TransferMessage extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('TransferMessage', package: const $pb.PackageName('google.cloud.bigquery.datatransfer.v1'))
    ..a<$0.Timestamp>(1, 'messageTime', $pb.PbFieldType.OM, $0.Timestamp.getDefault, $0.Timestamp.create)
    ..e<TransferMessage_MessageSeverity>(2, 'severity', $pb.PbFieldType.OE, TransferMessage_MessageSeverity.MESSAGE_SEVERITY_UNSPECIFIED, TransferMessage_MessageSeverity.valueOf, TransferMessage_MessageSeverity.values)
    ..aOS(3, 'messageText')
    ..hasRequiredFields = false
  ;

  TransferMessage() : super();
  TransferMessage.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  TransferMessage.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ...
  static TransferMessage getDefault() => _defaultInstance ??= create()..freeze();
