...
class DataSourceParameter_Type extends ProtobufEnum {
  ...
  static DataSourceParameter_Type valueOf(int value) =>
      _byValue[value] as DataSourceParameter_Type;
  static void $checkItem(DataSourceParameter_Type v) {
    if (v is! DataSourceParameter_Type)
      checkItemFailed(v, 'DataSourceParameter_Type');
  }
...
class DataSource_AuthorizationType extends ProtobufEnum {
  ...
  static final Map<int, dynamic> _byValue = ProtobufEnum.initByValue(values);
  static DataSource_AuthorizationType valueOf(int value) =>
      _byValue[value] as DataSource_AuthorizationType;
  static void $checkItem(DataSource_AuthorizationType v) {
    if (v is! DataSource_AuthorizationType)
      checkItemFailed(v, 'DataSource_AuthorizationType');
  }
...
class DataSource_DataRefreshType extends ProtobufEnum {
  ...
  static final Map<int, dynamic> _byValue = ProtobufEnum.initByValue(values);
  static DataSource_DataRefreshType valueOf(int value) =>
      _byValue[value] as DataSource_DataRefreshType;
  static void $checkItem(DataSource_DataRefreshType v) {
    if (v is! DataSource_DataRefreshType)
      checkItemFailed(v, 'DataSource_DataRefreshType');
  }
...
class ListTransferRunsRequest_RunAttempt extends ProtobufEnum {
  ...
  static final Map<int, dynamic> _byValue = ProtobufEnum.initByValue(values);
  static ListTransferRunsRequest_RunAttempt valueOf(int value) =>
      _byValue[value] as ListTransferRunsRequest_RunAttempt;
  static void $checkItem(ListTransferRunsRequest_RunAttempt v) {
    if (v is! ListTransferRunsRequest_RunAttempt)
      checkItemFailed(v, 'ListTransferRunsRequest_RunAttempt');
  }
