...
class DataSourceParameter_Type extends $pb.ProtobufEnum {
  static const DataSourceParameter_Type TYPE_UNSPECIFIED = DataSourceParameter_Type._(0, 'TYPE_UNSPECIFIED');
  static const DataSourceParameter_Type STRING = DataSourceParameter_Type._(1, 'STRING');
  static const DataSourceParameter_Type INTEGER = DataSourceParameter_Type._(2, 'INTEGER');
  static const DataSourceParameter_Type DOUBLE = DataSourceParameter_Type._(3, 'DOUBLE');
  static const DataSourceParameter_Type BOOLEAN = DataSourceParameter_Type._(4, 'BOOLEAN');
  static const DataSourceParameter_Type RECORD = DataSourceParameter_Type._(5, 'RECORD');
  static const DataSourceParameter_Type PLUS_PAGE = DataSourceParameter_Type._(6, 'PLUS_PAGE');
...
class DataSource_AuthorizationType extends $pb.ProtobufEnum {
  static const DataSource_AuthorizationType AUTHORIZATION_TYPE_UNSPECIFIED = DataSource_AuthorizationType._(0, 'AUTHORIZATION_TYPE_UNSPECIFIED');
  static const DataSource_AuthorizationType AUTHORIZATION_CODE = DataSource_AuthorizationType._(1, 'AUTHORIZATION_CODE');
  static const DataSource_AuthorizationType GOOGLE_PLUS_AUTHORIZATION_CODE = DataSource_AuthorizationType._(2, 'GOOGLE_PLUS_AUTHORIZATION_CODE');
...
class DataSource_DataRefreshType extends $pb.ProtobufEnum {
  static const DataSource_DataRefreshType DATA_REFRESH_TYPE_UNSPECIFIED = DataSource_DataRefreshType._(0, 'DATA_REFRESH_TYPE_UNSPECIFIED');
  static const DataSource_DataRefreshType SLIDING_WINDOW = DataSource_DataRefreshType._(1, 'SLIDING_WINDOW');
  static const DataSource_DataRefreshType CUSTOM_SLIDING_WINDOW = DataSource_DataRefreshType._(2, 'CUSTOM_SLIDING_WINDOW');
...
class ListTransferRunsRequest_RunAttempt extends $pb.ProtobufEnum {
  static const ListTransferRunsRequest_RunAttempt RUN_ATTEMPT_UNSPECIFIED = ListTransferRunsRequest_RunAttempt._(0, 'RUN_ATTEMPT_UNSPECIFIED');
  static const ListTransferRunsRequest_RunAttempt LATEST = ListTransferRunsRequest_RunAttempt._(1, 'LATEST');
