...
class TransferType extends $pb.ProtobufEnum {
  static const TransferType TRANSFER_TYPE_UNSPECIFIED = TransferType._(0, 'TRANSFER_TYPE_UNSPECIFIED');
...
class TransferState extends $pb.ProtobufEnum {
  static const TransferState TRANSFER_STATE_UNSPECIFIED = TransferState._(0, 'TRANSFER_STATE_UNSPECIFIED');
...
class TransferMessage_MessageSeverity extends $pb.ProtobufEnum {
  static const TransferMessage_MessageSeverity MESSAGE_SEVERITY_UNSPECIFIED = TransferMessage_MessageSeverity._(0, 'MESSAGE_SEVERITY_UNSPECIFIED');
  static const TransferMessage_MessageSeverity INFO = TransferMessage_MessageSeverity._(1, 'INFO');
  static const TransferMessage_MessageSeverity WARNING = TransferMessage_MessageSeverity._(2, 'WARNING');
  static const TransferMessage_MessageSeverity ERROR = TransferMessage_MessageSeverity._(3, 'ERROR');
