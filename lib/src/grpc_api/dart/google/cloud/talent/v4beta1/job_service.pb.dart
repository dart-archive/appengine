...
class CreateJobRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('CreateJobRequest', package: const $pb.PackageName('google.cloud.talent.v4beta1'))
    ..aOS(1, 'parent')
  ...
  set job($0.Job v) { setField(2, v); }
  $core.bool hasJob() => $_has(1);
  void clearJob() => clearField(2);
}

class GetJobRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('GetJobRequest', package: const $pb.PackageName('google.cloud.talent.v4beta1'))
    ..aOS(1, 'name')
    ..hasRequiredFields = false
  ;
...
class UpdateJobRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('UpdateJobRequest', package: const $pb.PackageName('google.cloud.talent.v4beta1'))
...
class DeleteJobRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('DeleteJobRequest', package: const $pb.PackageName('google.cloud.talent.v4beta1'))
    ..aOS(1, 'name')
    ..hasRequiredFields = false
  ;
...
class BatchDeleteJobsRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('BatchDeleteJobsRequest', package: const $pb.PackageName('google.cloud.talent.v4beta1'))
    ..aOS(1, 'parent')
    ..aOS(2, 'filter')
    ..hasRequiredFields = false
  ;
  ...
  BatchDeleteJobsRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  BatchDeleteJobsRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  BatchDeleteJobsRequest clone() => BatchDeleteJobsRequest()..mergeFromMessage(this);
  BatchDeleteJobsRequest copyWith(void Function(BatchDeleteJobsRequest) updates) => super.copyWith((message) => updates(message as BatchDeleteJobsRequest));
  $pb.BuilderInfo get info_ => _i;
  ...
  static BatchDeleteJobsRequest getDefault() => _defaultInstance ??= create()..freeze();
...
class ListJobsRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ListJobsRequest', package: const $pb.PackageName('google.cloud.talent.v4beta1'))
    ..aOS(1, 'parent')
    ..aOS(2, 'filter')
    ..aOS(3, 'pageToken')
    ..a<$core.int>(4, 'pageSize', $pb.PbFieldType.O3)
    ..e<JobView>(5, 'jobView', $pb.PbFieldType.OE, JobView.JOB_VIEW_UNSPECIFIED, JobView.valueOf, JobView.values)
    ..hasRequiredFields = false
  ;
...
class ListJobsResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ListJobsResponse', package: const $pb.PackageName('google.cloud.talent.v4beta1'))
...
class SearchJobsRequest_CustomRankingInfo extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('SearchJobsRequest.CustomRankingInfo', package: const $pb.PackageName('google.cloud.talent.v4beta1'))
    ..e<SearchJobsRequest_CustomRankingInfo_ImportanceLevel>(1, 'importanceLevel', $pb.PbFieldType.OE, SearchJobsRequest_CustomRankingInfo_ImportanceLevel.IMPORTANCE_LEVEL_UNSPECIFIED, SearchJobsRequest_CustomRankingInfo_ImportanceLevel.valueOf, SearchJobsRequest_CustomRankingInfo_ImportanceLevel.values)
    ..aOS(2, 'rankingExpression')
    ..hasRequiredFields = false
  ;

  SearchJobsRequest_CustomRankingInfo() : super();
  SearchJobsRequest_CustomRankingInfo.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  SearchJobsRequest_CustomRankingInfo.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  SearchJobsRequest_CustomRankingInfo clone() => SearchJobsRequest_CustomRankingInfo()..mergeFromMessage(this);
  SearchJobsRequest_CustomRankingInfo copyWith(void Function(SearchJobsRequest_CustomRankingInfo) updates) => super.copyWith((message) => updates(message as SearchJobsRequest_CustomRankingInfo));
  $pb.BuilderInfo get info_ => _i;
  static SearchJobsRequest_CustomRankingInfo create() => SearchJobsRequest_CustomRankingInfo();
  ...
  static SearchJobsRequest_CustomRankingInfo getDefault() => _defaultInstance ??= create()..freeze();
...
class SearchJobsRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('SearchJobsRequest', package: const $pb.PackageName('google.cloud.talent.v4beta1'))
    ..aOS(1, 'parent')
    ..e<SearchJobsRequest_SearchMode>(2, 'searchMode', $pb.PbFieldType.OE, SearchJobsRequest_SearchMode.SEARCH_MODE_UNSPECIFIED, SearchJobsRequest_SearchMode.valueOf, SearchJobsRequest_SearchMode.values)
    ..a<$2.RequestMetadata>(3, 'requestMetadata', $pb.PbFieldType.OM, $2.RequestMetadata.getDefault, $2.RequestMetadata.create)
    ..a<$3.JobQuery>(4, 'jobQuery', $pb.PbFieldType.OM, $3.JobQuery.getDefault, $3.JobQuery.create)
    ..aOB(5, 'enableBroadening')
    ..aOB(6, 'requirePreciseResultSize')
    ..pc<$4.HistogramQuery>(7, 'histogramQueries', $pb.PbFieldType.PM,$4.HistogramQuery.create)
    ..e<JobView>(8, 'jobView', $pb.PbFieldType.OE, JobView.JOB_VIEW_UNSPECIFIED, JobView.valueOf, JobView.values)
    ..a<$core.int>(9, 'offset', $pb.PbFieldType.O3)
    ..a<$core.int>(10, 'pageSize', $pb.PbFieldType.O3)
    ..aOS(11, 'pageToken')
    ..aOS(12, 'orderBy')
    ..e<SearchJobsRequest_DiversificationLevel>(13, 'diversificationLevel', $pb.PbFieldType.OE, SearchJobsRequest_DiversificationLevel.DIVERSIFICATION_LEVEL_UNSPECIFIED, SearchJobsRequest_DiversificationLevel.valueOf, SearchJobsRequest_DiversificationLevel.values)
    ..a<SearchJobsRequest_CustomRankingInfo>(14, 'customRankingInfo', $pb.PbFieldType.OM, SearchJobsRequest_CustomRankingInfo.getDefault, SearchJobsRequest_CustomRankingInfo.create)
    ..aOB(16, 'disableKeywordMatch')
    ..hasRequiredFields = false
  ;

  SearchJobsRequest() : super();
  SearchJobsRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  SearchJobsRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  SearchJobsRequest clone() => SearchJobsRequest()..mergeFromMessage(this);
  SearchJobsRequest copyWith(void Function(SearchJobsRequest) updates) => super.copyWith((message) => updates(message as SearchJobsRequest));
  $pb.BuilderInfo get info_ => _i;
  ...
  static SearchJobsRequest getDefault() => _defaultInstance ??= create()..freeze();
...
class SearchJobsResponse_MatchingJob extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('SearchJobsResponse.MatchingJob', package: const $pb.PackageName('google.cloud.talent.v4beta1'))
    ..a<$0.Job>(1, 'job', $pb.PbFieldType.OM, $0.Job.getDefault, $0.Job.create)
    ..aOS(2, 'jobSummary')
    ..aOS(3, 'jobTitleSnippet')
    ..aOS(4, 'searchTextSnippet')
    ..a<SearchJobsResponse_CommuteInfo>(5, 'commuteInfo', $pb.PbFieldType.OM, SearchJobsResponse_CommuteInfo.getDefault, SearchJobsResponse_CommuteInfo.create)
    ..hasRequiredFields = false
  ;

  SearchJobsResponse_MatchingJob() : super();
  SearchJobsResponse_MatchingJob.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  SearchJobsResponse_MatchingJob.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  SearchJobsResponse_MatchingJob clone() => SearchJobsResponse_MatchingJob()..mergeFromMessage(this);
  SearchJobsResponse_MatchingJob copyWith(void Function(SearchJobsResponse_MatchingJob) updates) => super.copyWith((message) => updates(message as SearchJobsResponse_MatchingJob));
  $pb.BuilderInfo get info_ => _i;
  static SearchJobsResponse_MatchingJob create() => SearchJobsResponse_MatchingJob();
  ...
  static SearchJobsResponse_MatchingJob getDefault() => _defaultInstance ??= create()..freeze();
...
class SearchJobsResponse_CommuteInfo extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('SearchJobsResponse.CommuteInfo', package: const $pb.PackageName('google.cloud.talent.v4beta1'))
    ..a<$2.Location>(1, 'jobLocation', $pb.PbFieldType.OM, $2.Location.getDefault, $2.Location.create)
    ..a<$5.Duration>(2, 'travelDuration', $pb.PbFieldType.OM, $5.Duration.getDefault, $5.Duration.create)
    ..hasRequiredFields = false
  ;

  SearchJobsResponse_CommuteInfo() : super();
  SearchJobsResponse_CommuteInfo.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  SearchJobsResponse_CommuteInfo.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  SearchJobsResponse_CommuteInfo clone() => SearchJobsResponse_CommuteInfo()..mergeFromMessage(this);
  SearchJobsResponse_CommuteInfo copyWith(void Function(SearchJobsResponse_CommuteInfo) updates) => super.copyWith((message) => updates(message as SearchJobsResponse_CommuteInfo));
  $pb.BuilderInfo get info_ => _i;
  static SearchJobsResponse_CommuteInfo create() => SearchJobsResponse_CommuteInfo();
...
class SearchJobsResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('SearchJobsResponse', package: const $pb.PackageName('google.cloud.talent.v4beta1'))
    ..pc<SearchJobsResponse_MatchingJob>(1, 'matchingJobs', $pb.PbFieldType.PM,SearchJobsResponse_MatchingJob.create)
    ..pc<$4.HistogramQueryResult>(2, 'histogramQueryResults', $pb.PbFieldType.PM,$4.HistogramQueryResult.create)
    ..aOS(3, 'nextPageToken')
    ..pc<$2.Location>(4, 'locationFilters', $pb.PbFieldType.PM,$2.Location.create)
    ..a<$core.int>(5, 'estimatedTotalSize', $pb.PbFieldType.O3)
    ..a<$core.int>(6, 'totalSize', $pb.PbFieldType.O3)
    ..a<$2.ResponseMetadata>(7, 'metadata', $pb.PbFieldType.OM, $2.ResponseMetadata.getDefault, $2.ResponseMetadata.create)
    ..a<$core.int>(8, 'broadenedQueryJobsCount', $pb.PbFieldType.O3)
    ..a<$2.SpellingCorrection>(9, 'spellCorrection', $pb.PbFieldType.OM, $2.SpellingCorrection.getDefault, $2.SpellingCorrection.create)
    ..hasRequiredFields = false
  ;

  SearchJobsResponse() : super();
  SearchJobsResponse.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  SearchJobsResponse.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  SearchJobsResponse clone() => SearchJobsResponse()..mergeFromMessage(this);
  SearchJobsResponse copyWith(void Function(SearchJobsResponse) updates) => super.copyWith((message) => updates(message as SearchJobsResponse));
  $pb.BuilderInfo get info_ => _i;
  ...
  static SearchJobsResponse getDefault() => _defaultInstance ??= create()..freeze();
  ...
  set metadata($2.ResponseMetadata v) { setField(7, v); }
  ...
  set spellCorrection($2.SpellingCorrection v) { setField(9, v); }
...
class JobServiceApi {
  ...
  $async.Future<$0.Job> createJob($pb.ClientContext ctx, CreateJobRequest request) {
    var emptyResponse = $0.Job();
    return _client.invoke<$0.Job>(ctx, 'JobService', 'CreateJob', request, emptyResponse);
  }
  $async.Future<$0.Job> getJob($pb.ClientContext ctx, GetJobRequest request) {
    var emptyResponse = $0.Job();
    return _client.invoke<$0.Job>(ctx, 'JobService', 'GetJob', request, emptyResponse);
  }
  $async.Future<$0.Job> updateJob($pb.ClientContext ctx, UpdateJobRequest request) {
    var emptyResponse = $0.Job();
    return _client.invoke<$0.Job>(ctx, 'JobService', 'UpdateJob', request, emptyResponse);
  }
  $async.Future<$6.Empty> deleteJob($pb.ClientContext ctx, DeleteJobRequest request) {
    var emptyResponse = $6.Empty();
    return _client.invoke<$6.Empty>(ctx, 'JobService', 'DeleteJob', request, emptyResponse);
  }
  ...
  $async.Future<$6.Empty> batchDeleteJobs($pb.ClientContext ctx, BatchDeleteJobsRequest request) {
    var emptyResponse = $6.Empty();
    return _client.invoke<$6.Empty>(ctx, 'JobService', 'BatchDeleteJobs', request, emptyResponse);
  }
  $async.Future<SearchJobsResponse> searchJobs($pb.ClientContext ctx, SearchJobsRequest request) {
    var emptyResponse = SearchJobsResponse();
    return _client.invoke<SearchJobsResponse>(ctx, 'JobService', 'SearchJobs', request, emptyResponse);
  }
  $async.Future<SearchJobsResponse> searchJobsForAlert($pb.ClientContext ctx, SearchJobsRequest request) {
    var emptyResponse = SearchJobsResponse();
    return _client.invoke<SearchJobsResponse>(ctx, 'JobService', 'SearchJobsForAlert', request, emptyResponse);
  }
}
