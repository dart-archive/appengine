...
class AvailabilitySignalType extends $pb.ProtobufEnum {
  static const AvailabilitySignalType AVAILABILITY_SIGNAL_TYPE_UNSPECIFIED =
      AvailabilitySignalType._(0, 'AVAILABILITY_SIGNAL_TYPE_UNSPECIFIED');
  static const AvailabilitySignalType JOB_APPLICATION =
      AvailabilitySignalType._(1, 'JOB_APPLICATION');
  static const AvailabilitySignalType RESUME_UPDATE =
      AvailabilitySignalType._(2, 'RESUME_UPDATE');
  static const AvailabilitySignalType CANDIDATE_UPDATE =
      AvailabilitySignalType._(3, 'CANDIDATE_UPDATE');
  static const AvailabilitySignalType CLIENT_SUBMISSION =
      AvailabilitySignalType._(4, 'CLIENT_SUBMISSION');
