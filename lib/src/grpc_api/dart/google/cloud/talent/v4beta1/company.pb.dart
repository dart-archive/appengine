...
class Company_DerivedInfo extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Company.DerivedInfo',
    ...
    ..a<$0.Location>(1, 'headquartersLocation', $pb.PbFieldType.OM,
  ...
  static Company_DerivedInfo getDefault() =>
...
class Company extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Company',
    ...
    ..e<$0.CompanySize>(
        ...
        'size',
        $pb.PbFieldType.OE,
        $0.CompanySize.COMPANY_SIZE_UNSPECIFIED,
        $0.CompanySize.valueOf,
        $0.CompanySize.values)
    ...
    ..a<Company_DerivedInfo>(12, 'derivedInfo', $pb.PbFieldType.OM,
        Company_DerivedInfo.getDefault, Company_DerivedInfo.create)
    ..aOB(13, 'suspended')
    ..hasRequiredFields = false;
