...
abstract class JobServiceBase extends $pb.GeneratedService {
  ...
  $async.Future<$6.Empty> batchDeleteJobs(
      $pb.ServerContext ctx, BatchDeleteJobsRequest request);
  $async.Future<SearchJobsResponse> searchJobs(
      $pb.ServerContext ctx, SearchJobsRequest request);
  ...
  $async.Future<$pb.GeneratedMessage> handleCall($pb.ServerContext ctx,
    ...
    switch (method) {
      ...
      case 'BatchDeleteJobs':
        return this.batchDeleteJobs(ctx, request);
      case 'SearchJobs':
        return this.searchJobs(ctx, request);
      case 'SearchJobsForAlert':
        return this.searchJobsForAlert(ctx, request);
      default:
        throw $core.ArgumentError('Unknown method: $method');
    }
  }
