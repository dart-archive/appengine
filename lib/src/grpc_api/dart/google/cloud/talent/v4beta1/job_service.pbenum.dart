...
class JobView extends $pb.ProtobufEnum {
  static const JobView JOB_VIEW_UNSPECIFIED = JobView._(0, 'JOB_VIEW_UNSPECIFIED');
...
class SearchJobsRequest_SearchMode extends $pb.ProtobufEnum {
  static const SearchJobsRequest_SearchMode SEARCH_MODE_UNSPECIFIED = SearchJobsRequest_SearchMode._(0, 'SEARCH_MODE_UNSPECIFIED');
  static const SearchJobsRequest_SearchMode JOB_SEARCH = SearchJobsRequest_SearchMode._(1, 'JOB_SEARCH');
  static const SearchJobsRequest_SearchMode FEATURED_JOB_SEARCH = SearchJobsRequest_SearchMode._(2, 'FEATURED_JOB_SEARCH');
...
class SearchJobsRequest_DiversificationLevel extends $pb.ProtobufEnum {
  static const SearchJobsRequest_DiversificationLevel DIVERSIFICATION_LEVEL_UNSPECIFIED = SearchJobsRequest_DiversificationLevel._(0, 'DIVERSIFICATION_LEVEL_UNSPECIFIED');
  static const SearchJobsRequest_DiversificationLevel DISABLED = SearchJobsRequest_DiversificationLevel._(1, 'DISABLED');
  static const SearchJobsRequest_DiversificationLevel SIMPLE = SearchJobsRequest_DiversificationLevel._(2, 'SIMPLE');
...
class SearchJobsRequest_CustomRankingInfo_ImportanceLevel extends $pb.ProtobufEnum {
  static const SearchJobsRequest_CustomRankingInfo_ImportanceLevel IMPORTANCE_LEVEL_UNSPECIFIED = SearchJobsRequest_CustomRankingInfo_ImportanceLevel._(0, 'IMPORTANCE_LEVEL_UNSPECIFIED');
  static const SearchJobsRequest_CustomRankingInfo_ImportanceLevel NONE = SearchJobsRequest_CustomRankingInfo_ImportanceLevel._(1, 'NONE');
  static const SearchJobsRequest_CustomRankingInfo_ImportanceLevel LOW = SearchJobsRequest_CustomRankingInfo_ImportanceLevel._(2, 'LOW');
  static const SearchJobsRequest_CustomRankingInfo_ImportanceLevel MILD = SearchJobsRequest_CustomRankingInfo_ImportanceLevel._(3, 'MILD');
  static const SearchJobsRequest_CustomRankingInfo_ImportanceLevel MEDIUM = SearchJobsRequest_CustomRankingInfo_ImportanceLevel._(4, 'MEDIUM');
  static const SearchJobsRequest_CustomRankingInfo_ImportanceLevel HIGH = SearchJobsRequest_CustomRankingInfo_ImportanceLevel._(5, 'HIGH');
  static const SearchJobsRequest_CustomRankingInfo_ImportanceLevel EXTREME = SearchJobsRequest_CustomRankingInfo_ImportanceLevel._(6, 'EXTREME');
