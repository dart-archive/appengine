...
class Profile extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Profile',
    ...
    ..aOS(4, 'uri')
    ..aOS(5, 'groupId')
    ..a<$0.BoolValue>(6, 'isHirable', $pb.PbFieldType.OM,
    ...
    ..pc<PersonalUri>(
        15, 'personalUris', $pb.PbFieldType.PM, PersonalUri.create)
    ..pc<AdditionalContactInfo>(16, 'additionalContactInfo', $pb.PbFieldType.PM,
        AdditionalContactInfo.create)
    ..pc<EmploymentRecord>(
        17, 'employmentRecords', $pb.PbFieldType.PM, EmploymentRecord.create)
    ..pc<EducationRecord>(
        18, 'educationRecords', $pb.PbFieldType.PM, EducationRecord.create)
    ..pc<$2.Skill>(19, 'skills', $pb.PbFieldType.PM, $2.Skill.create)
    ..pc<Activity>(20, 'activities', $pb.PbFieldType.PM, Activity.create)
    ..pc<Publication>(
        21, 'publications', $pb.PbFieldType.PM, Publication.create)
    ..pc<Patent>(22, 'patents', $pb.PbFieldType.PM, Patent.create)
    ..pc<$2.Certification>(
        23, 'certifications', $pb.PbFieldType.PM, $2.Certification.create)
    ..m<$core.String, $2.CustomAttribute>(
        26,
        'customAttributes',
        'Profile.CustomAttributesEntry',
        $pb.PbFieldType.OS,
        $pb.PbFieldType.OM,
        $2.CustomAttribute.create,
        null,
        null,
...
class Resume extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Resume',
    ...
    ..e<Resume_ResumeType>(
        ...
        'resumeType',
        $pb.PbFieldType.OE,
        Resume_ResumeType.RESUME_TYPE_UNSPECIFIED,
        Resume_ResumeType.valueOf,
        Resume_ResumeType.values)
    ..hasRequiredFields = false;

  Resume() : super();
  Resume.fromBuffer($core.List<$core.int> i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);
  Resume.fromJson($core.String i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromJson(i, r);
...
class PersonName_PersonStructuredName extends $pb.GeneratedMessage {
  ...
  PersonName_PersonStructuredName.fromBuffer($core.List<$core.int> i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);
  PersonName_PersonStructuredName.fromJson($core.String i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromJson(i, r);
  ...
  static PersonName_PersonStructuredName create() =>
      PersonName_PersonStructuredName();
  ...
  static PersonName_PersonStructuredName getDefault() =>
...
class PersonName extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('PersonName',
      package: const $pb.PackageName('google.cloud.talent.v4beta1'))
    ..aOS(1, 'formattedName')
    ..a<PersonName_PersonStructuredName>(
        2,
        'structuredName',
        $pb.PbFieldType.OM,
        PersonName_PersonStructuredName.getDefault,
        PersonName_PersonStructuredName.create)
    ..aOS(3, 'preferredName')
    ..oo(0, [1, 2])
    ..hasRequiredFields = false;

  PersonName() : super();
  PersonName.fromBuffer($core.List<$core.int> i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);
  PersonName.fromJson($core.String i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromJson(i, r);
...
class Address extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Address',
    ...
    ..e<$2.ContactInfoUsage>(
        ...
        'usage',
        $pb.PbFieldType.OE,
        $2.ContactInfoUsage.CONTACT_INFO_USAGE_UNSPECIFIED,
        $2.ContactInfoUsage.valueOf,
        $2.ContactInfoUsage.values)
    ..aOS(2, 'unstructuredAddress')
    ..a<$3.PostalAddress>(3, 'structuredAddress', $pb.PbFieldType.OM,
        $3.PostalAddress.getDefault, $3.PostalAddress.create)
    ..a<$0.BoolValue>(4, 'current', $pb.PbFieldType.OM, $0.BoolValue.getDefault,
        $0.BoolValue.create)
    ..oo(0, [2, 3])
    ..hasRequiredFields = false;

  Address() : super();
  Address.fromBuffer($core.List<$core.int> i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);
  Address.fromJson($core.String i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromJson(i, r);
...
class Email extends $pb.GeneratedMessage {
  ...
  Email() : super();
  Email.fromBuffer($core.List<$core.int> i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);
  Email.fromJson($core.String i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromJson(i, r);
...
class Phone extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Phone',
    ...
    ..e<Phone_PhoneType>(
        ...
        'type',
        $pb.PbFieldType.OE,
        Phone_PhoneType.PHONE_TYPE_UNSPECIFIED,
        Phone_PhoneType.valueOf,
        Phone_PhoneType.values)
    ..aOS(3, 'number')
    ..aOS(4, 'whenAvailable')
    ..hasRequiredFields = false;

  Phone() : super();
  Phone.fromBuffer($core.List<$core.int> i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);
  Phone.fromJson($core.String i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromJson(i, r);
...
class PersonalUri extends $pb.GeneratedMessage {
  ...
  PersonalUri() : super();
  PersonalUri.fromBuffer($core.List<$core.int> i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);
  PersonalUri.fromJson($core.String i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromJson(i, r);
...
class AdditionalContactInfo extends $pb.GeneratedMessage {
  ...
  AdditionalContactInfo.fromBuffer($core.List<$core.int> i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);
  AdditionalContactInfo.fromJson($core.String i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromJson(i, r);
  ...
  static AdditionalContactInfo getDefault() =>
      _defaultInstance ??= create()..freeze();
...
class EmploymentRecord extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('EmploymentRecord',
      package: const $pb.PackageName('google.cloud.talent.v4beta1'))
    ..a<$4.Date>(
        1, 'startDate', $pb.PbFieldType.OM, $4.Date.getDefault, $4.Date.create)
    ..a<$4.Date>(
        2, 'endDate', $pb.PbFieldType.OM, $4.Date.getDefault, $4.Date.create)
    ..aOS(3, 'employerName')
    ..aOS(4, 'divisionName')
    ..a<Address>(
        5, 'address', $pb.PbFieldType.OM, Address.getDefault, Address.create)
    ..aOS(6, 'jobTitle')
    ..aOS(7, 'jobDescription')
    ..a<$0.BoolValue>(8, 'isSupervisor', $pb.PbFieldType.OM,
        $0.BoolValue.getDefault, $0.BoolValue.create)
    ..a<$0.BoolValue>(9, 'isSelfEmployed', $pb.PbFieldType.OM,
        $0.BoolValue.getDefault, $0.BoolValue.create)
    ..a<$0.BoolValue>(10, 'isCurrent', $pb.PbFieldType.OM,
        $0.BoolValue.getDefault, $0.BoolValue.create)
  ...
  EmploymentRecord.fromBuffer($core.List<$core.int> i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);
  EmploymentRecord.fromJson($core.String i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromJson(i, r);
  ...
  static EmploymentRecord getDefault() =>
      _defaultInstance ??= create()..freeze();
...
class EducationRecord extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('EducationRecord',
    ...
    ..a<$4.Date>(
        2, 'endDate', $pb.PbFieldType.OM, $4.Date.getDefault, $4.Date.create)
    ..a<$4.Date>(3, 'expectedGraduationDate', $pb.PbFieldType.OM,
        $4.Date.getDefault, $4.Date.create)
    ..aOS(4, 'schoolName')
    ..a<Address>(
        5, 'address', $pb.PbFieldType.OM, Address.getDefault, Address.create)
    ..aOS(6, 'degreeDescription')
    ..a<Degree>(7, 'structuredDegree', $pb.PbFieldType.OM, Degree.getDefault,
        Degree.create)
    ..aOS(8, 'description')
    ..a<$0.BoolValue>(9, 'isCurrent', $pb.PbFieldType.OM,
        $0.BoolValue.getDefault, $0.BoolValue.create)
  ...
  EducationRecord.fromBuffer($core.List<$core.int> i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);
  EducationRecord.fromJson($core.String i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromJson(i, r);
  ...
  static EducationRecord getDefault() =>
      _defaultInstance ??= create()..freeze();
...
class Degree extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Degree',
    ...
    ..e<$2.DegreeType>(
        ...
        'degreeType',
        $pb.PbFieldType.OE,
        $2.DegreeType.DEGREE_TYPE_UNSPECIFIED,
        $2.DegreeType.valueOf,
        $2.DegreeType.values)
    ..aOS(2, 'degreeName')
    ..pPS(3, 'fieldsOfStudy')
    ..hasRequiredFields = false;
  ...
  Degree() : super();
  Degree.fromBuffer($core.List<$core.int> i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);
  Degree.fromJson($core.String i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromJson(i, r);
...
class Activity extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Activity',
    ...
    ..aOS(3, 'uri')
    ..a<$4.Date>(
        4, 'createDate', $pb.PbFieldType.OM, $4.Date.getDefault, $4.Date.create)
    ..a<$4.Date>(
        5, 'updateDate', $pb.PbFieldType.OM, $4.Date.getDefault, $4.Date.create)
    ..pPS(6, 'teamMembers')
  ...
  Activity() : super();
  Activity.fromBuffer($core.List<$core.int> i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);
  Activity.fromJson($core.String i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromJson(i, r);
...
class Publication extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Publication',
    ...
    ..aOS(5, 'volume')
    ..aOS(6, 'publisher')
    ..a<$4.Date>(7, 'publicationDate', $pb.PbFieldType.OM, $4.Date.getDefault,
        $4.Date.create)
  ...
  Publication() : super();
  Publication.fromBuffer($core.List<$core.int> i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);
  Publication.fromJson($core.String i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromJson(i, r);
...
class Patent extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Patent',
    ...
    ..pPS(2, 'inventors')
    ..aOS(3, 'patentStatus')
    ..a<$4.Date>(4, 'patentStatusDate', $pb.PbFieldType.OM, $4.Date.getDefault,
        $4.Date.create)
    ..a<$4.Date>(5, 'patentFilingDate', $pb.PbFieldType.OM, $4.Date.getDefault,
        $4.Date.create)
    ..aOS(6, 'patentOffice')
    ..aOS(7, 'patentNumber')
  ...
  Patent() : super();
  Patent.fromBuffer($core.List<$core.int> i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);
  Patent.fromJson($core.String i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromJson(i, r);
