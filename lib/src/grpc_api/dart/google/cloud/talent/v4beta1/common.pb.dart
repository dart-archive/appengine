...
class TimestampRange extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('TimestampRange', package: const $pb.PackageName('google.cloud.talent.v4beta1'))
...
class Location extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Location', package: const $pb.PackageName('google.cloud.talent.v4beta1'))
    ..e<Location_LocationType>(1, 'locationType', $pb.PbFieldType.OE, Location_LocationType.LOCATION_TYPE_UNSPECIFIED, Location_LocationType.valueOf, Location_LocationType.values)
    ..a<$1.PostalAddress>(2, 'postalAddress', $pb.PbFieldType.OM, $1.PostalAddress.getDefault, $1.PostalAddress.create)
...
class RequestMetadata extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('RequestMetadata', package: const $pb.PackageName('google.cloud.talent.v4beta1'))
    ..aOS(1, 'domain')
    ..aOS(2, 'sessionId')
    ..aOS(3, 'userId')
    ..aOB(4, 'allowMissingIds')
    ..a<DeviceInfo>(5, 'deviceInfo', $pb.PbFieldType.OM, DeviceInfo.getDefault, DeviceInfo.create)
    ..hasRequiredFields = false
  ;
...
class ResponseMetadata extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ResponseMetadata', package: const $pb.PackageName('google.cloud.talent.v4beta1'))
    ..aOS(1, 'requestId')
    ..hasRequiredFields = false
  ;

  ResponseMetadata() : super();
  ResponseMetadata.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  ResponseMetadata.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ResponseMetadata clone() => ResponseMetadata()..mergeFromMessage(this);
  ResponseMetadata copyWith(void Function(ResponseMetadata) updates) => super.copyWith((message) => updates(message as ResponseMetadata));
  $pb.BuilderInfo get info_ => _i;
  ...
  static ResponseMetadata getDefault() => _defaultInstance ??= create()..freeze();
...
class DeviceInfo extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('DeviceInfo', package: const $pb.PackageName('google.cloud.talent.v4beta1'))
    ..e<DeviceInfo_DeviceType>(1, 'deviceType', $pb.PbFieldType.OE, DeviceInfo_DeviceType.DEVICE_TYPE_UNSPECIFIED, DeviceInfo_DeviceType.valueOf, DeviceInfo_DeviceType.values)
    ..aOS(2, 'id')
    ..hasRequiredFields = false
  ;
...
class CustomAttribute extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('CustomAttribute', package: const $pb.PackageName('google.cloud.talent.v4beta1'))
    ..pPS(1, 'stringValues')
  ...
  CustomAttribute.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  CustomAttribute.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  CustomAttribute clone() => CustomAttribute()..mergeFromMessage(this);
  CustomAttribute copyWith(void Function(CustomAttribute) updates) => super.copyWith((message) => updates(message as CustomAttribute));
  $pb.BuilderInfo get info_ => _i;
  ...
  static CustomAttribute getDefault() => _defaultInstance ??= create()..freeze();
...
class SpellingCorrection extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('SpellingCorrection', package: const $pb.PackageName('google.cloud.talent.v4beta1'))
    ..aOB(1, 'corrected')
    ..aOS(2, 'correctedText')
    ..aOS(3, 'correctedHtml')
    ..hasRequiredFields = false
  ...
  SpellingCorrection.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  SpellingCorrection.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  SpellingCorrection clone() => SpellingCorrection()..mergeFromMessage(this);
  SpellingCorrection copyWith(void Function(SpellingCorrection) updates) => super.copyWith((message) => updates(message as SpellingCorrection));
  $pb.BuilderInfo get info_ => _i;
  ...
  static SpellingCorrection getDefault() => _defaultInstance ??= create()..freeze();
...
class CompensationInfo_CompensationEntry extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('CompensationInfo.CompensationEntry', package: const $pb.PackageName('google.cloud.talent.v4beta1'))
    ..e<CompensationInfo_CompensationType>(1, 'type', $pb.PbFieldType.OE, CompensationInfo_CompensationType.COMPENSATION_TYPE_UNSPECIFIED, CompensationInfo_CompensationType.valueOf, CompensationInfo_CompensationType.values)
    ..e<CompensationInfo_CompensationUnit>(2, 'unit', $pb.PbFieldType.OE, CompensationInfo_CompensationUnit.COMPENSATION_UNIT_UNSPECIFIED, CompensationInfo_CompensationUnit.valueOf, CompensationInfo_CompensationUnit.values)
    ..a<$3.Money>(3, 'amount', $pb.PbFieldType.OM, $3.Money.getDefault, $3.Money.create)
    ..a<CompensationInfo_CompensationRange>(4, 'range', $pb.PbFieldType.OM, CompensationInfo_CompensationRange.getDefault, CompensationInfo_CompensationRange.create)
    ..aOS(5, 'description')
    ..a<$4.DoubleValue>(6, 'expectedUnitsPerYear', $pb.PbFieldType.OM, $4.DoubleValue.getDefault, $4.DoubleValue.create)
    ..oo(0, [3, 4])
    ..hasRequiredFields = false
  ;

  CompensationInfo_CompensationEntry() : super();
  CompensationInfo_CompensationEntry.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  CompensationInfo_CompensationEntry.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  CompensationInfo_CompensationEntry clone() => CompensationInfo_CompensationEntry()..mergeFromMessage(this);
  CompensationInfo_CompensationEntry copyWith(void Function(CompensationInfo_CompensationEntry) updates) => super.copyWith((message) => updates(message as CompensationInfo_CompensationEntry));
  $pb.BuilderInfo get info_ => _i;
  static CompensationInfo_CompensationEntry create() => CompensationInfo_CompensationEntry();
  ...
  static CompensationInfo_CompensationEntry getDefault() => _defaultInstance ??= create()..freeze();
...
class CompensationInfo_CompensationRange extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('CompensationInfo.CompensationRange', package: const $pb.PackageName('google.cloud.talent.v4beta1'))
    ..a<$3.Money>(1, 'minCompensation', $pb.PbFieldType.OM, $3.Money.getDefault, $3.Money.create)
    ..a<$3.Money>(2, 'maxCompensation', $pb.PbFieldType.OM, $3.Money.getDefault, $3.Money.create)
    ..hasRequiredFields = false
  ;

  CompensationInfo_CompensationRange() : super();
  CompensationInfo_CompensationRange.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  CompensationInfo_CompensationRange.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  CompensationInfo_CompensationRange clone() => CompensationInfo_CompensationRange()..mergeFromMessage(this);
  CompensationInfo_CompensationRange copyWith(void Function(CompensationInfo_CompensationRange) updates) => super.copyWith((message) => updates(message as CompensationInfo_CompensationRange));
  $pb.BuilderInfo get info_ => _i;
  static CompensationInfo_CompensationRange create() => CompensationInfo_CompensationRange();
  ...
  static CompensationInfo_CompensationRange getDefault() => _defaultInstance ??= create()..freeze();
...
class CompensationInfo extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('CompensationInfo', package: const $pb.PackageName('google.cloud.talent.v4beta1'))
    ..pc<CompensationInfo_CompensationEntry>(1, 'entries', $pb.PbFieldType.PM,CompensationInfo_CompensationEntry.create)
    ..a<CompensationInfo_CompensationRange>(2, 'annualizedBaseCompensationRange', $pb.PbFieldType.OM, CompensationInfo_CompensationRange.getDefault, CompensationInfo_CompensationRange.create)
    ..a<CompensationInfo_CompensationRange>(3, 'annualizedTotalCompensationRange', $pb.PbFieldType.OM, CompensationInfo_CompensationRange.getDefault, CompensationInfo_CompensationRange.create)
    ..hasRequiredFields = false
  ;

  CompensationInfo() : super();
  CompensationInfo.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  CompensationInfo.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  CompensationInfo clone() => CompensationInfo()..mergeFromMessage(this);
  CompensationInfo copyWith(void Function(CompensationInfo) updates) => super.copyWith((message) => updates(message as CompensationInfo));
  $pb.BuilderInfo get info_ => _i;
  ...
  static CompensationInfo getDefault() => _defaultInstance ??= create()..freeze();
...
class Certification extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Certification', package: const $pb.PackageName('google.cloud.talent.v4beta1'))
    ..aOS(1, 'displayName')
    ..a<$5.Date>(2, 'acquireDate', $pb.PbFieldType.OM, $5.Date.getDefault, $5.Date.create)
    ..a<$5.Date>(3, 'expireDate', $pb.PbFieldType.OM, $5.Date.getDefault, $5.Date.create)
    ..aOS(4, 'authority')
    ..aOS(5, 'description')
    ..hasRequiredFields = false
  ;
  ...
  Certification() : super();
  Certification.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  Certification.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  Certification clone() => Certification()..mergeFromMessage(this);
  Certification copyWith(void Function(Certification) updates) => super.copyWith((message) => updates(message as Certification));
  $pb.BuilderInfo get info_ => _i;
...
class Skill extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Skill', package: const $pb.PackageName('google.cloud.talent.v4beta1'))
    ..aOS(1, 'displayName')
    ..a<$5.Date>(2, 'lastUsedDate', $pb.PbFieldType.OM, $5.Date.getDefault, $5.Date.create)
    ..e<SkillProficiencyLevel>(3, 'level', $pb.PbFieldType.OE, SkillProficiencyLevel.SKILL_PROFICIENCY_LEVEL_UNSPECIFIED, SkillProficiencyLevel.valueOf, SkillProficiencyLevel.values)
    ..aOS(4, 'context')
  ...
  Skill() : super();
  Skill.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  Skill.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
...
class Interview extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Interview', package: const $pb.PackageName('google.cloud.talent.v4beta1'))
    ..a<Rating>(6, 'rating', $pb.PbFieldType.OM, Rating.getDefault, Rating.create)
    ..e<Outcome>(7, 'outcome', $pb.PbFieldType.OE, Outcome.OUTCOME_UNSPECIFIED, Outcome.valueOf, Outcome.values)
    ..hasRequiredFields = false
  ;

  Interview() : super();
  Interview.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  Interview.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  Interview clone() => Interview()..mergeFromMessage(this);
  Interview copyWith(void Function(Interview) updates) => super.copyWith((message) => updates(message as Interview));
  $pb.BuilderInfo get info_ => _i;
...
class Rating extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Rating', package: const $pb.PackageName('google.cloud.talent.v4beta1'))
  ...
  Rating() : super();
  Rating.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  Rating.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  Rating clone() => Rating()..mergeFromMessage(this);
  Rating copyWith(void Function(Rating) updates) => super.copyWith((message) => updates(message as Rating));
  $pb.BuilderInfo get info_ => _i;
