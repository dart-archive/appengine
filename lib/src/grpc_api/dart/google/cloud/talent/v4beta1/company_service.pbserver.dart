...
abstract class CompanyServiceBase extends $pb.GeneratedService {
  $async.Future<$0.Company> createCompany(
      $pb.ServerContext ctx, CreateCompanyRequest request);
  $async.Future<$0.Company> getCompany(
      $pb.ServerContext ctx, GetCompanyRequest request);
  $async.Future<$0.Company> updateCompany(
      $pb.ServerContext ctx, UpdateCompanyRequest request);
  $async.Future<$3.Empty> deleteCompany(
      $pb.ServerContext ctx, DeleteCompanyRequest request);
  $async.Future<ListCompaniesResponse> listCompanies(
      $pb.ServerContext ctx, ListCompaniesRequest request);
  ...
  $async.Future<$pb.GeneratedMessage> handleCall($pb.ServerContext ctx,
    ...
    switch (method) {
      case 'CreateCompany':
        return this.createCompany(ctx, request);
      case 'GetCompany':
        return this.getCompany(ctx, request);
      case 'UpdateCompany':
        return this.updateCompany(ctx, request);
      case 'DeleteCompany':
        return this.deleteCompany(ctx, request);
      case 'ListCompanies':
        return this.listCompanies(ctx, request);
      default:
        throw $core.ArgumentError('Unknown method: $method');
    }
  }
