...
class LocationFilter_TelecommutePreference extends $pb.ProtobufEnum {
  ...
  static const LocationFilter_TelecommutePreference TELECOMMUTE_EXCLUDED =
      LocationFilter_TelecommutePreference._(1, 'TELECOMMUTE_EXCLUDED');
  static const LocationFilter_TelecommutePreference TELECOMMUTE_ALLOWED =
      LocationFilter_TelecommutePreference._(2, 'TELECOMMUTE_ALLOWED');
...
class CompensationFilter_FilterType extends $pb.ProtobufEnum {
  static const CompensationFilter_FilterType FILTER_TYPE_UNSPECIFIED =
      CompensationFilter_FilterType._(0, 'FILTER_TYPE_UNSPECIFIED');
  static const CompensationFilter_FilterType UNIT_ONLY =
      CompensationFilter_FilterType._(1, 'UNIT_ONLY');
  static const CompensationFilter_FilterType UNIT_AND_AMOUNT =
      CompensationFilter_FilterType._(2, 'UNIT_AND_AMOUNT');
  static const CompensationFilter_FilterType ANNUALIZED_BASE_AMOUNT =
      CompensationFilter_FilterType._(3, 'ANNUALIZED_BASE_AMOUNT');
  static const CompensationFilter_FilterType ANNUALIZED_TOTAL_AMOUNT =
      CompensationFilter_FilterType._(4, 'ANNUALIZED_TOTAL_AMOUNT');
...
class CommuteFilter_RoadTraffic extends $pb.ProtobufEnum {
  static const CommuteFilter_RoadTraffic ROAD_TRAFFIC_UNSPECIFIED =
      CommuteFilter_RoadTraffic._(0, 'ROAD_TRAFFIC_UNSPECIFIED');
  static const CommuteFilter_RoadTraffic TRAFFIC_FREE =
      CommuteFilter_RoadTraffic._(1, 'TRAFFIC_FREE');
  static const CommuteFilter_RoadTraffic BUSY_HOUR =
      CommuteFilter_RoadTraffic._(2, 'BUSY_HOUR');
...
class EmployerFilter_EmployerFilterMode extends $pb.ProtobufEnum {
  ...
  static const EmployerFilter_EmployerFilterMode ALL_EMPLOYMENT_RECORDS =
      EmployerFilter_EmployerFilterMode._(1, 'ALL_EMPLOYMENT_RECORDS');
  static const EmployerFilter_EmployerFilterMode
      CURRENT_EMPLOYMENT_RECORDS_ONLY =
      EmployerFilter_EmployerFilterMode._(2, 'CURRENT_EMPLOYMENT_RECORDS_ONLY');
  static const EmployerFilter_EmployerFilterMode PAST_EMPLOYMENT_RECORDS_ONLY =
      EmployerFilter_EmployerFilterMode._(3, 'PAST_EMPLOYMENT_RECORDS_ONLY');
...
class TimeFilter_TimeField extends $pb.ProtobufEnum {
  static const TimeFilter_TimeField TIME_FIELD_UNSPECIFIED =
      TimeFilter_TimeField._(0, 'TIME_FIELD_UNSPECIFIED');
  static const TimeFilter_TimeField CREATE_TIME =
      TimeFilter_TimeField._(1, 'CREATE_TIME');
  static const TimeFilter_TimeField UPDATE_TIME =
      TimeFilter_TimeField._(2, 'UPDATE_TIME');
