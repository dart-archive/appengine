...
class Resume_ResumeType extends $pb.ProtobufEnum {
  static const Resume_ResumeType RESUME_TYPE_UNSPECIFIED =
      Resume_ResumeType._(0, 'RESUME_TYPE_UNSPECIFIED');
  static const Resume_ResumeType HRXML = Resume_ResumeType._(1, 'HRXML');
  static const Resume_ResumeType OTHER_RESUME_TYPE =
      Resume_ResumeType._(2, 'OTHER_RESUME_TYPE');
...
class Phone_PhoneType extends $pb.ProtobufEnum {
  static const Phone_PhoneType PHONE_TYPE_UNSPECIFIED =
      Phone_PhoneType._(0, 'PHONE_TYPE_UNSPECIFIED');
  ...
  static const Phone_PhoneType MOBILE_OR_LANDLINE =
      Phone_PhoneType._(9, 'MOBILE_OR_LANDLINE');
