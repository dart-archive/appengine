...
class Tenant extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Tenant', package: const $pb.PackageName('google.cloud.talent.v4beta1'))
    ..aOS(1, 'name')
    ..aOS(2, 'externalId')
    ..e<Tenant_DataUsageType>(3, 'usageType', $pb.PbFieldType.OE, Tenant_DataUsageType.DATA_USAGE_TYPE_UNSPECIFIED, Tenant_DataUsageType.valueOf, Tenant_DataUsageType.values)
    ..pPS(4, 'keywordSearchableProfileCustomAttributes')
    ..hasRequiredFields = false
  ;

  Tenant() : super();
  Tenant.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  Tenant.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
