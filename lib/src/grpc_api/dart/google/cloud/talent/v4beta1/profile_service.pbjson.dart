...
const CreateProfileRequest$json = const {
  ...
  '2': const [
    const {'1': 'parent', '3': 1, '4': 1, '5': 9, '10': 'parent'},
    const {'1': 'profile', '3': 2, '4': 1, '5': 11, '6': '.google.cloud.talent.v4beta1.Profile', '10': 'profile'},
  ],
};
...
const UpdateProfileRequest$json = const {
  ...
  '2': const [
    const {'1': 'profile', '3': 1, '4': 1, '5': 11, '6': '.google.cloud.talent.v4beta1.Profile', '10': 'profile'},
...
const SearchProfilesRequest$json = const {
  ...
  '2': const [
    const {'1': 'parent', '3': 1, '4': 1, '5': 9, '10': 'parent'},
    const {'1': 'request_metadata', '3': 2, '4': 1, '5': 11, '6': '.google.cloud.talent.v4beta1.RequestMetadata', '10': 'requestMetadata'},
...
const ProfileServiceBase$json = const {
  '1': 'ProfileService',
  '2': const [
    const {'1': 'ListProfiles', '2': '.google.cloud.talent.v4beta1.ListProfilesRequest', '3': '.google.cloud.talent.v4beta1.ListProfilesResponse', '4': const {}},
    const {'1': 'CreateProfile', '2': '.google.cloud.talent.v4beta1.CreateProfileRequest', '3': '.google.cloud.talent.v4beta1.Profile', '4': const {}},
    const {'1': 'GetProfile', '2': '.google.cloud.talent.v4beta1.GetProfileRequest', '3': '.google.cloud.talent.v4beta1.Profile', '4': const {}},
    const {'1': 'UpdateProfile', '2': '.google.cloud.talent.v4beta1.UpdateProfileRequest', '3': '.google.cloud.talent.v4beta1.Profile', '4': const {}},
    const {'1': 'DeleteProfile', '2': '.google.cloud.talent.v4beta1.DeleteProfileRequest', '3': '.google.protobuf.Empty', '4': const {}},
    const {'1': 'SearchProfiles', '2': '.google.cloud.talent.v4beta1.SearchProfilesRequest', '3': '.google.cloud.talent.v4beta1.SearchProfilesResponse', '4': const {}},
  ],
};

const ProfileServiceBase$messageJson = const {
  '.google.cloud.talent.v4beta1.ListProfilesRequest': ListProfilesRequest$json,
  '.google.protobuf.FieldMask': $0.FieldMask$json,
  '.google.cloud.talent.v4beta1.ListProfilesResponse': ListProfilesResponse$json,
  ...
  '.google.cloud.talent.v4beta1.PersonName.PersonStructuredName': $1.PersonName_PersonStructuredName$json,
  ...
  '.google.cloud.talent.v4beta1.AdditionalContactInfo': $1.AdditionalContactInfo$json,
  ...
  '.google.cloud.talent.v4beta1.Profile.CustomAttributesEntry': $1.Profile_CustomAttributesEntry$json,
  '.google.cloud.talent.v4beta1.CustomAttribute': $2.CustomAttribute$json,
  '.google.cloud.talent.v4beta1.Resume': $1.Resume$json,
  '.google.cloud.talent.v4beta1.CreateProfileRequest': CreateProfileRequest$json,
  '.google.cloud.talent.v4beta1.GetProfileRequest': GetProfileRequest$json,
  '.google.cloud.talent.v4beta1.UpdateProfileRequest': UpdateProfileRequest$json,
  '.google.cloud.talent.v4beta1.DeleteProfileRequest': DeleteProfileRequest$json,
  '.google.protobuf.Empty': $5.Empty$json,
  '.google.cloud.talent.v4beta1.SearchProfilesRequest': SearchProfilesRequest$json,
  ...
  '.google.cloud.talent.v4beta1.WorkExperienceFilter': $3.WorkExperienceFilter$json,
  '.google.protobuf.Duration': $11.Duration$json,
  '.google.cloud.talent.v4beta1.TimeFilter': $3.TimeFilter$json,
  '.google.cloud.talent.v4beta1.ApplicationDateFilter': $3.ApplicationDateFilter$json,
  '.google.cloud.talent.v4beta1.ApplicationOutcomeNotesFilter': $3.ApplicationOutcomeNotesFilter$json,
  '.google.cloud.talent.v4beta1.ApplicationJobFilter': $3.ApplicationJobFilter$json,
  '.google.cloud.talent.v4beta1.HistogramQuery': $4.HistogramQuery$json,
  '.google.cloud.talent.v4beta1.SearchProfilesResponse': SearchProfilesResponse$json,
