...
class ListProfilesRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ListProfilesRequest', package: const $pb.PackageName('google.cloud.talent.v4beta1'))
    ..aOS(1, 'parent')
    ..aOS(2, 'pageToken')
    ..a<$core.int>(3, 'pageSize', $pb.PbFieldType.O3)
    ..a<$0.FieldMask>(4, 'readMask', $pb.PbFieldType.OM, $0.FieldMask.getDefault, $0.FieldMask.create)
    ..hasRequiredFields = false
  ;

  ListProfilesRequest() : super();
  ListProfilesRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  ListProfilesRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ListProfilesRequest clone() => ListProfilesRequest()..mergeFromMessage(this);
  ListProfilesRequest copyWith(void Function(ListProfilesRequest) updates) => super.copyWith((message) => updates(message as ListProfilesRequest));
  ...
  static ListProfilesRequest getDefault() => _defaultInstance ??= create()..freeze();
  ...
  set readMask($0.FieldMask v) { setField(4, v); }
  $core.bool hasReadMask() => $_has(3);
  void clearReadMask() => clearField(4);
}

class ListProfilesResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ListProfilesResponse', package: const $pb.PackageName('google.cloud.talent.v4beta1'))
  ...
  ListProfilesResponse.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  ListProfilesResponse.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ListProfilesResponse clone() => ListProfilesResponse()..mergeFromMessage(this);
  ListProfilesResponse copyWith(void Function(ListProfilesResponse) updates) => super.copyWith((message) => updates(message as ListProfilesResponse));
  $pb.BuilderInfo get info_ => _i;
  ...
  static ListProfilesResponse getDefault() => _defaultInstance ??= create()..freeze();
...
class CreateProfileRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('CreateProfileRequest', package: const $pb.PackageName('google.cloud.talent.v4beta1'))
    ..aOS(1, 'parent')
    ..a<$1.Profile>(2, 'profile', $pb.PbFieldType.OM, $1.Profile.getDefault, $1.Profile.create)
    ..hasRequiredFields = false
  ;
...
class GetProfileRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('GetProfileRequest', package: const $pb.PackageName('google.cloud.talent.v4beta1'))
    ..aOS(1, 'name')
    ..hasRequiredFields = false
  ;

  GetProfileRequest() : super();
  GetProfileRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  GetProfileRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
...
class UpdateProfileRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('UpdateProfileRequest', package: const $pb.PackageName('google.cloud.talent.v4beta1'))
    ..a<$1.Profile>(1, 'profile', $pb.PbFieldType.OM, $1.Profile.getDefault, $1.Profile.create)
...
class DeleteProfileRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('DeleteProfileRequest', package: const $pb.PackageName('google.cloud.talent.v4beta1'))
    ..aOS(1, 'name')
    ..hasRequiredFields = false
  ;

  DeleteProfileRequest() : super();
  DeleteProfileRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  DeleteProfileRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ...
  static DeleteProfileRequest getDefault() => _defaultInstance ??= create()..freeze();
...
class SearchProfilesRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('SearchProfilesRequest', package: const $pb.PackageName('google.cloud.talent.v4beta1'))
    ..aOS(1, 'parent')
    ..a<$2.RequestMetadata>(2, 'requestMetadata', $pb.PbFieldType.OM, $2.RequestMetadata.getDefault, $2.RequestMetadata.create)
    ..a<$3.ProfileQuery>(3, 'profileQuery', $pb.PbFieldType.OM, $3.ProfileQuery.getDefault, $3.ProfileQuery.create)
    ...
    ..pc<$4.HistogramQuery>(10, 'histogramQueries', $pb.PbFieldType.PM,$4.HistogramQuery.create)
    ..hasRequiredFields = false
  ;

  SearchProfilesRequest() : super();
  SearchProfilesRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  SearchProfilesRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  SearchProfilesRequest clone() => SearchProfilesRequest()..mergeFromMessage(this);
  SearchProfilesRequest copyWith(void Function(SearchProfilesRequest) updates) => super.copyWith((message) => updates(message as SearchProfilesRequest));
  $pb.BuilderInfo get info_ => _i;
  ...
  static SearchProfilesRequest getDefault() => _defaultInstance ??= create()..freeze();
...
class SearchProfilesResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('SearchProfilesResponse', package: const $pb.PackageName('google.cloud.talent.v4beta1'))
    ..aInt64(1, 'estimatedTotalSize')
    ..a<$2.SpellingCorrection>(2, 'spellCorrection', $pb.PbFieldType.OM, $2.SpellingCorrection.getDefault, $2.SpellingCorrection.create)
    ..a<$2.ResponseMetadata>(3, 'metadata', $pb.PbFieldType.OM, $2.ResponseMetadata.getDefault, $2.ResponseMetadata.create)
    ..aOS(4, 'nextPageToken')
    ..pc<$4.HistogramQueryResult>(5, 'histogramQueryResults', $pb.PbFieldType.PM,$4.HistogramQueryResult.create)
    ..pc<SummarizedProfile>(6, 'summarizedProfiles', $pb.PbFieldType.PM,SummarizedProfile.create)
    ..hasRequiredFields = false
  ;

  SearchProfilesResponse() : super();
  SearchProfilesResponse.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  SearchProfilesResponse.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  SearchProfilesResponse clone() => SearchProfilesResponse()..mergeFromMessage(this);
  SearchProfilesResponse copyWith(void Function(SearchProfilesResponse) updates) => super.copyWith((message) => updates(message as SearchProfilesResponse));
  $pb.BuilderInfo get info_ => _i;
  ...
  static SearchProfilesResponse getDefault() => _defaultInstance ??= create()..freeze();
  static SearchProfilesResponse _defaultInstance;

  Int64 get estimatedTotalSize => $_getI64(0);
  set estimatedTotalSize(Int64 v) { $_setInt64(0, v); }
  ...
  set spellCorrection($2.SpellingCorrection v) { setField(2, v); }
...
class SummarizedProfile extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('SummarizedProfile', package: const $pb.PackageName('google.cloud.talent.v4beta1'))
    ..pc<$1.Profile>(1, 'profiles', $pb.PbFieldType.PM,$1.Profile.create)
    ..a<$1.Profile>(2, 'summary', $pb.PbFieldType.OM, $1.Profile.getDefault, $1.Profile.create)
    ..hasRequiredFields = false
  ;

  SummarizedProfile() : super();
  SummarizedProfile.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  SummarizedProfile.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  SummarizedProfile clone() => SummarizedProfile()..mergeFromMessage(this);
  SummarizedProfile copyWith(void Function(SummarizedProfile) updates) => super.copyWith((message) => updates(message as SummarizedProfile));
  $pb.BuilderInfo get info_ => _i;
  ...
  static SummarizedProfile getDefault() => _defaultInstance ??= create()..freeze();
  static SummarizedProfile _defaultInstance;

  $core.List<$1.Profile> get profiles => $_getList(0);

  $1.Profile get summary => $_getN(1);
  set summary($1.Profile v) { setField(2, v); }
...
class ProfileServiceApi {
  ...
  $async.Future<ListProfilesResponse> listProfiles($pb.ClientContext ctx, ListProfilesRequest request) {
    var emptyResponse = ListProfilesResponse();
    return _client.invoke<ListProfilesResponse>(ctx, 'ProfileService', 'ListProfiles', request, emptyResponse);
  }
  $async.Future<$1.Profile> createProfile($pb.ClientContext ctx, CreateProfileRequest request) {
    var emptyResponse = $1.Profile();
    return _client.invoke<$1.Profile>(ctx, 'ProfileService', 'CreateProfile', request, emptyResponse);
  }
  $async.Future<$1.Profile> getProfile($pb.ClientContext ctx, GetProfileRequest request) {
    var emptyResponse = $1.Profile();
    return _client.invoke<$1.Profile>(ctx, 'ProfileService', 'GetProfile', request, emptyResponse);
  }
  $async.Future<$1.Profile> updateProfile($pb.ClientContext ctx, UpdateProfileRequest request) {
    var emptyResponse = $1.Profile();
    return _client.invoke<$1.Profile>(ctx, 'ProfileService', 'UpdateProfile', request, emptyResponse);
  }
  $async.Future<$5.Empty> deleteProfile($pb.ClientContext ctx, DeleteProfileRequest request) {
    var emptyResponse = $5.Empty();
    return _client.invoke<$5.Empty>(ctx, 'ProfileService', 'DeleteProfile', request, emptyResponse);
  }
  $async.Future<SearchProfilesResponse> searchProfiles($pb.ClientContext ctx, SearchProfilesRequest request) {
    var emptyResponse = SearchProfilesResponse();
    return _client.invoke<SearchProfilesResponse>(ctx, 'ProfileService', 'SearchProfiles', request, emptyResponse);
  }
}
