...
class Job_ApplicationInfo extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Job.ApplicationInfo', package: const $pb.PackageName('google.cloud.talent.v4beta1'))
    ..pPS(1, 'emails')
    ..aOS(2, 'instruction')
    ..pPS(3, 'uris')
  ...
  Job_ApplicationInfo.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  Job_ApplicationInfo.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  Job_ApplicationInfo clone() => Job_ApplicationInfo()..mergeFromMessage(this);
  Job_ApplicationInfo copyWith(void Function(Job_ApplicationInfo) updates) => super.copyWith((message) => updates(message as Job_ApplicationInfo));
  ...
  static Job_ApplicationInfo getDefault() => _defaultInstance ??= create()..freeze();
...
class Job_DerivedInfo extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Job.DerivedInfo', package: const $pb.PackageName('google.cloud.talent.v4beta1'))
    ..pc<$0.Location>(1, 'locations', $pb.PbFieldType.PM,$0.Location.create)
    ..pc<$0.JobCategory>(3, 'jobCategories', $pb.PbFieldType.PE, null, $0.JobCategory.valueOf, $0.JobCategory.values)
    ..hasRequiredFields = false
  ;

  Job_DerivedInfo() : super();
  Job_DerivedInfo.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  Job_DerivedInfo.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  Job_DerivedInfo clone() => Job_DerivedInfo()..mergeFromMessage(this);
  Job_DerivedInfo copyWith(void Function(Job_DerivedInfo) updates) => super.copyWith((message) => updates(message as Job_DerivedInfo));
  $pb.BuilderInfo get info_ => _i;
  ...
  static Job_DerivedInfo getDefault() => _defaultInstance ??= create()..freeze();
...
class Job_ProcessingOptions extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Job.ProcessingOptions', package: const $pb.PackageName('google.cloud.talent.v4beta1'))
    ..aOB(1, 'disableStreetAddressResolution')
    ..e<$0.HtmlSanitization>(2, 'htmlSanitization', $pb.PbFieldType.OE, $0.HtmlSanitization.HTML_SANITIZATION_UNSPECIFIED, $0.HtmlSanitization.valueOf, $0.HtmlSanitization.values)
    ..hasRequiredFields = false
  ;

  Job_ProcessingOptions() : super();
  Job_ProcessingOptions.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  Job_ProcessingOptions.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  Job_ProcessingOptions clone() => Job_ProcessingOptions()..mergeFromMessage(this);
  Job_ProcessingOptions copyWith(void Function(Job_ProcessingOptions) updates) => super.copyWith((message) => updates(message as Job_ProcessingOptions));
  $pb.BuilderInfo get info_ => _i;
  ...
  static Job_ProcessingOptions getDefault() => _defaultInstance ??= create()..freeze();
...
class Job extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Job', package: const $pb.PackageName('google.cloud.talent.v4beta1'))
    ..aOS(1, 'name')
    ..aOS(2, 'company')
    ..aOS(3, 'requisitionId')
    ..aOS(4, 'title')
    ..aOS(5, 'description')
    ..pPS(6, 'addresses')
    ..a<Job_ApplicationInfo>(7, 'applicationInfo', $pb.PbFieldType.OM, Job_ApplicationInfo.getDefault, Job_ApplicationInfo.create)
    ..pc<$0.JobBenefit>(8, 'jobBenefits', $pb.PbFieldType.PE, null, $0.JobBenefit.valueOf, $0.JobBenefit.values)
    ..a<$0.CompensationInfo>(9, 'compensationInfo', $pb.PbFieldType.OM, $0.CompensationInfo.getDefault, $0.CompensationInfo.create)
    ..m<$core.String, $0.CustomAttribute>(10, 'customAttributes', 'Job.CustomAttributesEntry',$pb.PbFieldType.OS, $pb.PbFieldType.OM, $0.CustomAttribute.create, null, null , const $pb.PackageName('google.cloud.talent.v4beta1'))
    ..pc<$0.DegreeType>(11, 'degreeTypes', $pb.PbFieldType.PE, null, $0.DegreeType.valueOf, $0.DegreeType.values)
    ..aOS(12, 'department')
    ..pc<$0.EmploymentType>(13, 'employmentTypes', $pb.PbFieldType.PE, null, $0.EmploymentType.valueOf, $0.EmploymentType.values)
    ..aOS(14, 'incentives')
    ..aOS(15, 'languageCode')
    ..e<$0.JobLevel>(16, 'jobLevel', $pb.PbFieldType.OE, $0.JobLevel.JOB_LEVEL_UNSPECIFIED, $0.JobLevel.valueOf, $0.JobLevel.values)
    ..a<$core.int>(17, 'promotionValue', $pb.PbFieldType.O3)
    ..aOS(18, 'qualifications')
    ..aOS(19, 'responsibilities')
    ..e<$0.PostingRegion>(20, 'postingRegion', $pb.PbFieldType.OE, $0.PostingRegion.POSTING_REGION_UNSPECIFIED, $0.PostingRegion.valueOf, $0.PostingRegion.values)
    ..e<$0.Visibility>(21, 'visibility', $pb.PbFieldType.OE, $0.Visibility.VISIBILITY_UNSPECIFIED, $0.Visibility.valueOf, $0.Visibility.values)
