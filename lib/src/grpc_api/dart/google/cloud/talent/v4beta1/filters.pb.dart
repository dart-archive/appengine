...
class JobQuery extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('JobQuery',
    ...
    ..pPS(2, 'companies')
    ..pc<LocationFilter>(
        3, 'locationFilters', $pb.PbFieldType.PM, LocationFilter.create)
    ..pc<$0.JobCategory>(4, 'jobCategories', $pb.PbFieldType.PE, null,
        $0.JobCategory.valueOf, $0.JobCategory.values)
    ..a<CommuteFilter>(5, 'commuteFilter', $pb.PbFieldType.OM,
        CommuteFilter.getDefault, CommuteFilter.create)
    ..pPS(6, 'companyDisplayNames')
    ..a<CompensationFilter>(7, 'compensationFilter', $pb.PbFieldType.OM,
        CompensationFilter.getDefault, CompensationFilter.create)
    ..aOS(8, 'customAttributeFilter')
    ..aOB(9, 'disableSpellCheck')
    ..pc<$0.EmploymentType>(10, 'employmentTypes', $pb.PbFieldType.PE, null,
        $0.EmploymentType.valueOf, $0.EmploymentType.values)
    ..pPS(11, 'languageCodes')
    ..a<$0.TimestampRange>(12, 'publishTimeRange', $pb.PbFieldType.OM,
        $0.TimestampRange.getDefault, $0.TimestampRange.create)
    ..pPS(13, 'excludedJobs')
...
class ProfileQuery extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ProfileQuery',
    ...
    ..aOS(1, 'query')
    ..pc<LocationFilter>(
        2, 'locationFilters', $pb.PbFieldType.PM, LocationFilter.create)
    ..pc<JobTitleFilter>(
        3, 'jobTitleFilters', $pb.PbFieldType.PM, JobTitleFilter.create)
    ..pc<EmployerFilter>(
        4, 'employerFilters', $pb.PbFieldType.PM, EmployerFilter.create)
    ..pc<EducationFilter>(
        5, 'educationFilters', $pb.PbFieldType.PM, EducationFilter.create)
    ...
    ..pc<WorkExperienceFilter>(7, 'workExperienceFilter', $pb.PbFieldType.PM,
        WorkExperienceFilter.create)
    ..pc<TimeFilter>(8, 'timeFilters', $pb.PbFieldType.PM, TimeFilter.create)
    ..a<$1.BoolValue>(9, 'hirableFilter', $pb.PbFieldType.OM,
        $1.BoolValue.getDefault, $1.BoolValue.create)
    ..pc<ApplicationDateFilter>(10, 'applicationDateFilters',
        $pb.PbFieldType.PM, ApplicationDateFilter.create)
    ..pc<ApplicationOutcomeNotesFilter>(11, 'applicationOutcomeNotesFilters',
        $pb.PbFieldType.PM, ApplicationOutcomeNotesFilter.create)
...
class LocationFilter extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('LocationFilter',
    ...
    ..e<LocationFilter_TelecommutePreference>(
        ...
        $pb.PbFieldType.OE,
        LocationFilter_TelecommutePreference.TELECOMMUTE_PREFERENCE_UNSPECIFIED,
        LocationFilter_TelecommutePreference.valueOf,
        LocationFilter_TelecommutePreference.values)
    ..aOB(6, 'negated')
    ..hasRequiredFields = false;
...
class CompensationFilter extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('CompensationFilter',
    ...
    ..e<CompensationFilter_FilterType>(
        ...
        'type',
        $pb.PbFieldType.OE,
        CompensationFilter_FilterType.FILTER_TYPE_UNSPECIFIED,
        CompensationFilter_FilterType.valueOf,
        CompensationFilter_FilterType.values)
    ..pc<$0.CompensationInfo_CompensationUnit>(
        2,
        'units',
        $pb.PbFieldType.PE,
        null,
        $0.CompensationInfo_CompensationUnit.valueOf,
        $0.CompensationInfo_CompensationUnit.values)
    ..a<$0.CompensationInfo_CompensationRange>(
        3,
        'range',
        $pb.PbFieldType.OM,
        $0.CompensationInfo_CompensationRange.getDefault,
        $0.CompensationInfo_CompensationRange.create)
  ...
  static CompensationFilter getDefault() =>
...
class CommuteFilter extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('CommuteFilter',
    ...
    ..e<$0.CommuteMethod>(
        ...
        'commuteMethod',
        $pb.PbFieldType.OE,
        $0.CommuteMethod.COMMUTE_METHOD_UNSPECIFIED,
        $0.CommuteMethod.valueOf,
        $0.CommuteMethod.values)
    ..a<$2.LatLng>(2, 'startCoordinates', $pb.PbFieldType.OM,
        $2.LatLng.getDefault, $2.LatLng.create)
    ..a<$3.Duration>(3, 'travelDuration', $pb.PbFieldType.OM,
    ...
    ..e<CommuteFilter_RoadTraffic>(
        ...
        'roadTraffic',
        $pb.PbFieldType.OE,
        CommuteFilter_RoadTraffic.ROAD_TRAFFIC_UNSPECIFIED,
        CommuteFilter_RoadTraffic.valueOf,
...
class EmployerFilter extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('EmployerFilter',
    ...
    ..e<EmployerFilter_EmployerFilterMode>(
        ...
        EmployerFilter_EmployerFilterMode.valueOf,
        EmployerFilter_EmployerFilterMode.values)
    ..aOB(3, 'negated')
    ..hasRequiredFields = false;
...
class EducationFilter extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('EducationFilter',
    ...
    ..e<$0.DegreeType>(
        ...
        'degreeType',
        $pb.PbFieldType.OE,
        $0.DegreeType.DEGREE_TYPE_UNSPECIFIED,
        $0.DegreeType.valueOf,
        $0.DegreeType.values)
    ..aOB(6, 'negated')
    ..hasRequiredFields = false;
  ...
  static EducationFilter getDefault() =>
      _defaultInstance ??= create()..freeze();
...
class WorkExperienceFilter extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('WorkExperienceFilter',
      package: const $pb.PackageName('google.cloud.talent.v4beta1'))
    ..a<$3.Duration>(1, 'minExperience', $pb.PbFieldType.OM,
        $3.Duration.getDefault, $3.Duration.create)
    ..a<$3.Duration>(2, 'maxExperience', $pb.PbFieldType.OM,
        $3.Duration.getDefault, $3.Duration.create)
    ..hasRequiredFields = false;
  ...
  static WorkExperienceFilter getDefault() =>
      _defaultInstance ??= create()..freeze();
...
class ApplicationDateFilter extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ApplicationDateFilter',
      package: const $pb.PackageName('google.cloud.talent.v4beta1'))
    ..a<$5.Date>(
        1, 'startDate', $pb.PbFieldType.OM, $5.Date.getDefault, $5.Date.create)
    ..a<$5.Date>(
  ...
  static ApplicationDateFilter getDefault() =>
      _defaultInstance ??= create()..freeze();
...
class ApplicationOutcomeNotesFilter extends $pb.GeneratedMessage {
  ...
  static ApplicationOutcomeNotesFilter getDefault() =>
      _defaultInstance ??= create()..freeze();
...
class ApplicationJobFilter extends $pb.GeneratedMessage {
  ...
  static ApplicationJobFilter getDefault() =>
      _defaultInstance ??= create()..freeze();
...
class TimeFilter extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('TimeFilter',
    ...
    ..e<TimeFilter_TimeField>(
        ...
        'timeField',
        $pb.PbFieldType.OE,
        TimeFilter_TimeField.TIME_FIELD_UNSPECIFIED,
        TimeFilter_TimeField.valueOf,
