...
class CreateTenantRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('CreateTenantRequest', package: const $pb.PackageName('google.cloud.talent.v4beta1'))
    ..aOS(1, 'parent')
    ..a<$0.Tenant>(2, 'tenant', $pb.PbFieldType.OM, $0.Tenant.getDefault, $0.Tenant.create)
    ..hasRequiredFields = false
  ;

  CreateTenantRequest() : super();
  CreateTenantRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  CreateTenantRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ...
  set tenant($0.Tenant v) { setField(2, v); }
  $core.bool hasTenant() => $_has(1);
  void clearTenant() => clearField(2);
}

class GetTenantRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('GetTenantRequest', package: const $pb.PackageName('google.cloud.talent.v4beta1'))
    ..aOS(1, 'name')
    ..hasRequiredFields = false
  ;

  GetTenantRequest() : super();
  GetTenantRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  GetTenantRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  GetTenantRequest clone() => GetTenantRequest()..mergeFromMessage(this);
  GetTenantRequest copyWith(void Function(GetTenantRequest) updates) => super.copyWith((message) => updates(message as GetTenantRequest));
  $pb.BuilderInfo get info_ => _i;
  ...
  static GetTenantRequest getDefault() => _defaultInstance ??= create()..freeze();
...
class UpdateTenantRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('UpdateTenantRequest', package: const $pb.PackageName('google.cloud.talent.v4beta1'))
    ..a<$0.Tenant>(1, 'tenant', $pb.PbFieldType.OM, $0.Tenant.getDefault, $0.Tenant.create)
    ..a<$1.FieldMask>(2, 'updateMask', $pb.PbFieldType.OM, $1.FieldMask.getDefault, $1.FieldMask.create)
    ..hasRequiredFields = false
  ;

  UpdateTenantRequest() : super();
  UpdateTenantRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  UpdateTenantRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ...
  set tenant($0.Tenant v) { setField(1, v); }
...
class DeleteTenantRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('DeleteTenantRequest', package: const $pb.PackageName('google.cloud.talent.v4beta1'))
    ..aOS(1, 'name')
    ..hasRequiredFields = false
  ;

  DeleteTenantRequest() : super();
  DeleteTenantRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  DeleteTenantRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
...
class ListTenantsRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ListTenantsRequest', package: const $pb.PackageName('google.cloud.talent.v4beta1'))
    ..aOS(1, 'parent')
    ..aOS(2, 'pageToken')
  ...
  ListTenantsRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  ListTenantsRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ListTenantsRequest clone() => ListTenantsRequest()..mergeFromMessage(this);
  ListTenantsRequest copyWith(void Function(ListTenantsRequest) updates) => super.copyWith((message) => updates(message as ListTenantsRequest));
  $pb.BuilderInfo get info_ => _i;
  ...
  static ListTenantsRequest getDefault() => _defaultInstance ??= create()..freeze();
...
class ListTenantsResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ListTenantsResponse', package: const $pb.PackageName('google.cloud.talent.v4beta1'))
  ...
  ListTenantsResponse.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  ListTenantsResponse.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
...
class TenantServiceApi {
  ...
  $async.Future<$0.Tenant> createTenant($pb.ClientContext ctx, CreateTenantRequest request) {
    var emptyResponse = $0.Tenant();
    return _client.invoke<$0.Tenant>(ctx, 'TenantService', 'CreateTenant', request, emptyResponse);
  }
  $async.Future<$0.Tenant> getTenant($pb.ClientContext ctx, GetTenantRequest request) {
    var emptyResponse = $0.Tenant();
    return _client.invoke<$0.Tenant>(ctx, 'TenantService', 'GetTenant', request, emptyResponse);
  }
  $async.Future<$0.Tenant> updateTenant($pb.ClientContext ctx, UpdateTenantRequest request) {
    var emptyResponse = $0.Tenant();
    return _client.invoke<$0.Tenant>(ctx, 'TenantService', 'UpdateTenant', request, emptyResponse);
  }
  $async.Future<$3.Empty> deleteTenant($pb.ClientContext ctx, DeleteTenantRequest request) {
    var emptyResponse = $3.Empty();
    return _client.invoke<$3.Empty>(ctx, 'TenantService', 'DeleteTenant', request, emptyResponse);
  }
  $async.Future<ListTenantsResponse> listTenants($pb.ClientContext ctx, ListTenantsRequest request) {
    ...
    return _client.invoke<ListTenantsResponse>(ctx, 'TenantService', 'ListTenants', request, emptyResponse);
  }
}
