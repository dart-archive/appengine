...
class CompleteQueryRequest_CompletionScope extends $pb.ProtobufEnum {
  static const CompleteQueryRequest_CompletionScope COMPLETION_SCOPE_UNSPECIFIED = CompleteQueryRequest_CompletionScope._(0, 'COMPLETION_SCOPE_UNSPECIFIED');
  static const CompleteQueryRequest_CompletionScope TENANT = CompleteQueryRequest_CompletionScope._(1, 'TENANT');
  static const CompleteQueryRequest_CompletionScope PUBLIC = CompleteQueryRequest_CompletionScope._(2, 'PUBLIC');
...
class CompleteQueryRequest_CompletionType extends $pb.ProtobufEnum {
  static const CompleteQueryRequest_CompletionType COMPLETION_TYPE_UNSPECIFIED = CompleteQueryRequest_CompletionType._(0, 'COMPLETION_TYPE_UNSPECIFIED');
  static const CompleteQueryRequest_CompletionType JOB_TITLE = CompleteQueryRequest_CompletionType._(1, 'JOB_TITLE');
  static const CompleteQueryRequest_CompletionType COMPANY_NAME = CompleteQueryRequest_CompletionType._(2, 'COMPANY_NAME');
  static const CompleteQueryRequest_CompletionType COMBINED = CompleteQueryRequest_CompletionType._(3, 'COMBINED');
