...
class FindingTypeStats extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('FindingTypeStats')
    ..e<Finding_FindingType>(1, 'findingType', PbFieldType.OE, Finding_FindingType.FINDING_TYPE_UNSPECIFIED, Finding_FindingType.valueOf, Finding_FindingType.values)
    ..a<int>(2, 'findingCount', PbFieldType.O3)
    ..hasRequiredFields = false
  ;

  FindingTypeStats() : super();
  FindingTypeStats.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  FindingTypeStats.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  FindingTypeStats clone() => new FindingTypeStats()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static FindingTypeStats create() => new FindingTypeStats();
  static PbList<FindingTypeStats> createRepeated() => new PbList<FindingTypeStats>();
  static FindingTypeStats getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyFindingTypeStats();
  ...
  set findingType(Finding_FindingType v) { setField(1, v); }
  bool hasFindingType() => $_has(0);
  void clearFindingType() => clearField(1);

  int get findingCount => $_get(1, 0);
  set findingCount(int v) { $_setSignedInt32(1, v); }
  bool hasFindingCount() => $_has(1);
  void clearFindingCount() => clearField(2);
}

class _ReadonlyFindingTypeStats extends FindingTypeStats with ReadonlyMessageMixin {}
