...
class ScanRun_ExecutionState extends $pb.ProtobufEnum {
  static const ScanRun_ExecutionState EXECUTION_STATE_UNSPECIFIED = ScanRun_ExecutionState._(0, 'EXECUTION_STATE_UNSPECIFIED');
  static const ScanRun_ExecutionState QUEUED = ScanRun_ExecutionState._(1, 'QUEUED');
  static const ScanRun_ExecutionState SCANNING = ScanRun_ExecutionState._(2, 'SCANNING');
  static const ScanRun_ExecutionState FINISHED = ScanRun_ExecutionState._(3, 'FINISHED');
...
class ScanRun_ResultState extends $pb.ProtobufEnum {
  static const ScanRun_ResultState RESULT_STATE_UNSPECIFIED = ScanRun_ResultState._(0, 'RESULT_STATE_UNSPECIFIED');
  static const ScanRun_ResultState SUCCESS = ScanRun_ResultState._(1, 'SUCCESS');
