...
class Finding extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('Finding')
    ..aOS(1, 'name')
    ..e<Finding_FindingType>(2, 'findingType', PbFieldType.OE, Finding_FindingType.FINDING_TYPE_UNSPECIFIED, Finding_FindingType.valueOf, Finding_FindingType.values)
    ..aOS(3, 'httpMethod')
    ..aOS(4, 'fuzzedUrl')
    ..aOS(5, 'body')
    ..aOS(6, 'description')
    ...
    ..aOS(9, 'finalUrl')
    ..aOS(10, 'trackingId')
    ..a<OutdatedLibrary>(11, 'outdatedLibrary', PbFieldType.OM, OutdatedLibrary.getDefault, OutdatedLibrary.create)
    ..a<ViolatingResource>(12, 'violatingResource', PbFieldType.OM, ViolatingResource.getDefault, ViolatingResource.create)
    ..a<VulnerableParameters>(13, 'vulnerableParameters', PbFieldType.OM, VulnerableParameters.getDefault, VulnerableParameters.create)
