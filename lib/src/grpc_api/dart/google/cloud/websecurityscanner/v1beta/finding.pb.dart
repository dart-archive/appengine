...
class Finding extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Finding', package: const $pb.PackageName('google.cloud.websecurityscanner.v1beta'))
    ..aOS(1, 'name')
    ..aOS(2, 'findingType')
    ..aOS(3, 'httpMethod')
    ..aOS(4, 'fuzzedUrl')
    ...
    ..a<$0.VulnerableHeaders>(15, 'vulnerableHeaders', $pb.PbFieldType.OM, $0.VulnerableHeaders.getDefault, $0.VulnerableHeaders.create)
    ..a<$0.Form>(16, 'form', $pb.PbFieldType.OM, $0.Form.getDefault, $0.Form.create)
