...
class ScanConfig_UserAgent extends $pb.ProtobufEnum {
  static const ScanConfig_UserAgent USER_AGENT_UNSPECIFIED = ScanConfig_UserAgent._(0, 'USER_AGENT_UNSPECIFIED');
  static const ScanConfig_UserAgent CHROME_LINUX = ScanConfig_UserAgent._(1, 'CHROME_LINUX');
  static const ScanConfig_UserAgent CHROME_ANDROID = ScanConfig_UserAgent._(2, 'CHROME_ANDROID');
  static const ScanConfig_UserAgent SAFARI_IPHONE = ScanConfig_UserAgent._(3, 'SAFARI_IPHONE');
...
class ScanConfig_TargetPlatform extends $pb.ProtobufEnum {
  static const ScanConfig_TargetPlatform TARGET_PLATFORM_UNSPECIFIED = ScanConfig_TargetPlatform._(0, 'TARGET_PLATFORM_UNSPECIFIED');
  static const ScanConfig_TargetPlatform APP_ENGINE = ScanConfig_TargetPlatform._(1, 'APP_ENGINE');
  static const ScanConfig_TargetPlatform COMPUTE = ScanConfig_TargetPlatform._(2, 'COMPUTE');
...
class ScanConfig_RiskLevel extends $pb.ProtobufEnum {
  static const ScanConfig_RiskLevel RISK_LEVEL_UNSPECIFIED = ScanConfig_RiskLevel._(0, 'RISK_LEVEL_UNSPECIFIED');
  static const ScanConfig_RiskLevel NORMAL = ScanConfig_RiskLevel._(1, 'NORMAL');
...
class ScanConfig_ExportToSecurityCommandCenter extends $pb.ProtobufEnum {
  static const ScanConfig_ExportToSecurityCommandCenter EXPORT_TO_SECURITY_COMMAND_CENTER_UNSPECIFIED = ScanConfig_ExportToSecurityCommandCenter._(0, 'EXPORT_TO_SECURITY_COMMAND_CENTER_UNSPECIFIED');
  static const ScanConfig_ExportToSecurityCommandCenter ENABLED = ScanConfig_ExportToSecurityCommandCenter._(1, 'ENABLED');
  static const ScanConfig_ExportToSecurityCommandCenter DISABLED = ScanConfig_ExportToSecurityCommandCenter._(2, 'DISABLED');
