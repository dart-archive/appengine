...
class ScanConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ScanConfig',
    ...
    ..e<ScanConfig_ExportToSecurityCommandCenter>(
        ...
        ScanConfig_ExportToSecurityCommandCenter.valueOf,
        ScanConfig_ExportToSecurityCommandCenter.values)
    ..a<$0.ScanRun>(11, 'latestRun', $pb.PbFieldType.OM, $0.ScanRun.getDefault,
        $0.ScanRun.create)
    ..e<ScanConfig_RiskLevel>(
        12,
        'riskLevel',
        $pb.PbFieldType.OE,
        ScanConfig_RiskLevel.RISK_LEVEL_UNSPECIFIED,
        ScanConfig_RiskLevel.valueOf,
        ScanConfig_RiskLevel.values)
    ..hasRequiredFields = false;
