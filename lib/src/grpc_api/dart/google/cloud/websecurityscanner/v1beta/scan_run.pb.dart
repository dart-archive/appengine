...
class ScanRun extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ScanRun', package: const $pb.PackageName('google.cloud.websecurityscanner.v1beta'))
    ..aOS(1, 'name')
    ..e<ScanRun_ExecutionState>(2, 'executionState', $pb.PbFieldType.OE, ScanRun_ExecutionState.EXECUTION_STATE_UNSPECIFIED, ScanRun_ExecutionState.valueOf, ScanRun_ExecutionState.values)
    ..e<ScanRun_ResultState>(3, 'resultState', $pb.PbFieldType.OE, ScanRun_ResultState.RESULT_STATE_UNSPECIFIED, ScanRun_ResultState.valueOf, ScanRun_ResultState.values)
    ...
    ..a<$1.ScanRunErrorTrace>(10, 'errorTrace', $pb.PbFieldType.OM, $1.ScanRunErrorTrace.getDefault, $1.ScanRunErrorTrace.create)
    ..pc<$2.ScanRunWarningTrace>(11, 'warningTraces', $pb.PbFieldType.PM,$2.ScanRunWarningTrace.create)
    ..hasRequiredFields = false
  ;

  ScanRun() : super();
  ScanRun.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  ScanRun.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ScanRun clone() => ScanRun()..mergeFromMessage(this);
  ScanRun copyWith(void Function(ScanRun) updates) => super.copyWith((message) => updates(message as ScanRun));
