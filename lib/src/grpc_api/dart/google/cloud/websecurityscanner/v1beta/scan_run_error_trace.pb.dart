...
class ScanRunErrorTrace extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ScanRunErrorTrace', package: const $pb.PackageName('google.cloud.websecurityscanner.v1beta'))
    ..e<ScanRunErrorTrace_Code>(1, 'code', $pb.PbFieldType.OE, ScanRunErrorTrace_Code.CODE_UNSPECIFIED, ScanRunErrorTrace_Code.valueOf, ScanRunErrorTrace_Code.values)
    ..a<$0.ScanConfigError>(2, 'scanConfigError', $pb.PbFieldType.OM, $0.ScanConfigError.getDefault, $0.ScanConfigError.create)
    ..a<$core.int>(3, 'mostCommonHttpErrorCode', $pb.PbFieldType.O3)
    ..hasRequiredFields = false
  ;

  ScanRunErrorTrace() : super();
  ScanRunErrorTrace.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  ScanRunErrorTrace.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ScanRunErrorTrace clone() => ScanRunErrorTrace()..mergeFromMessage(this);
  ScanRunErrorTrace copyWith(void Function(ScanRunErrorTrace) updates) => super.copyWith((message) => updates(message as ScanRunErrorTrace));
  ...
  static ScanRunErrorTrace getDefault() => _defaultInstance ??= create()..freeze();
