...
class AuditLog extends GeneratedMessage {
  ...
  set resourceName(String v) { $_setString(6, v); }
...
class AuthenticationInfo extends GeneratedMessage {
  ...
  set principalEmail(String v) { $_setString(0, v); }
