...
class PosixAccount extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('PosixAccount', package: const $pb.PackageName('google.cloud.oslogin.common'))
    ..aOB(1, 'primary')
    ..aOS(2, 'username')
    ..aInt64(3, 'uid')
    ..aInt64(4, 'gid')
  ...
  PosixAccount() : super();
  PosixAccount.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  PosixAccount.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  PosixAccount clone() => PosixAccount()..mergeFromMessage(this);
  PosixAccount copyWith(void Function(PosixAccount) updates) => super.copyWith((message) => updates(message as PosixAccount));
...
class SshPublicKey extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('SshPublicKey', package: const $pb.PackageName('google.cloud.oslogin.common'))
    ..aOS(1, 'key')
  ...
  SshPublicKey() : super();
  SshPublicKey.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  SshPublicKey.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  SshPublicKey clone() => SshPublicKey()..mergeFromMessage(this);
  SshPublicKey copyWith(void Function(SshPublicKey) updates) => super.copyWith((message) => updates(message as SshPublicKey));
  $pb.BuilderInfo get info_ => _i;
