...
class Model_DeploymentState extends $pb.ProtobufEnum {
  static const Model_DeploymentState DEPLOYMENT_STATE_UNSPECIFIED = Model_DeploymentState._(0, 'DEPLOYMENT_STATE_UNSPECIFIED');
  static const Model_DeploymentState DEPLOYED = Model_DeploymentState._(1, 'DEPLOYED');
  static const Model_DeploymentState UNDEPLOYED = Model_DeploymentState._(2, 'UNDEPLOYED');
