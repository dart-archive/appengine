...
class TextSentimentAnnotation extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('TextSentimentAnnotation', package: const $pb.PackageName('google.cloud.automl.v1beta1'))
    ..a<$core.int>(1, 'sentiment', $pb.PbFieldType.O3)
    ..hasRequiredFields = false
  ;

  TextSentimentAnnotation() : super();
  TextSentimentAnnotation.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  TextSentimentAnnotation.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  TextSentimentAnnotation clone() => TextSentimentAnnotation()..mergeFromMessage(this);
  TextSentimentAnnotation copyWith(void Function(TextSentimentAnnotation) updates) => super.copyWith((message) => updates(message as TextSentimentAnnotation));
  ...
  static TextSentimentAnnotation getDefault() => _defaultInstance ??= create()..freeze();
...
class TextSentimentEvaluationMetrics extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('TextSentimentEvaluationMetrics', package: const $pb.PackageName('google.cloud.automl.v1beta1'))
    ...
    ..a<$0.ClassificationEvaluationMetrics_ConfusionMatrix>(8, 'confusionMatrix', $pb.PbFieldType.OM, $0.ClassificationEvaluationMetrics_ConfusionMatrix.getDefault, $0.ClassificationEvaluationMetrics_ConfusionMatrix.create)
    ..pPS(9, 'annotationSpecId')
    ..hasRequiredFields = false
  ;

  TextSentimentEvaluationMetrics() : super();
  TextSentimentEvaluationMetrics.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  TextSentimentEvaluationMetrics.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  TextSentimentEvaluationMetrics clone() => TextSentimentEvaluationMetrics()..mergeFromMessage(this);
  TextSentimentEvaluationMetrics copyWith(void Function(TextSentimentEvaluationMetrics) updates) => super.copyWith((message) => updates(message as TextSentimentEvaluationMetrics));
  $pb.BuilderInfo get info_ => _i;
  static TextSentimentEvaluationMetrics create() => TextSentimentEvaluationMetrics();
  ...
  static TextSentimentEvaluationMetrics getDefault() => _defaultInstance ??= create()..freeze();
