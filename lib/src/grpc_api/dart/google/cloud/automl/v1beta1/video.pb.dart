...
class VideoClassificationDatasetMetadata extends $pb.GeneratedMessage {
  ...
  VideoClassificationDatasetMetadata.fromBuffer($core.List<$core.int> i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);
  VideoClassificationDatasetMetadata.fromJson($core.String i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromJson(i, r);
  ...
  VideoClassificationDatasetMetadata copyWith(
      ...
      super.copyWith(
          (message) => updates(message as VideoClassificationDatasetMetadata));
...
class VideoClassificationModelMetadata extends $pb.GeneratedMessage {
  ...
  VideoClassificationModelMetadata.fromBuffer($core.List<$core.int> i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);
  VideoClassificationModelMetadata.fromJson($core.String i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromJson(i, r);
