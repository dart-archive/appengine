...
class AnnotationPayload extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('AnnotationPayload',
    ...
    ..a<$1.ClassificationAnnotation>(
        3,
        'classification',
        $pb.PbFieldType.OM,
        $1.ClassificationAnnotation.getDefault,
        $1.ClassificationAnnotation.create)
    ..a<$2.ImageObjectDetectionAnnotation>(
        4,
        'imageObjectDetection',
        $pb.PbFieldType.OM,
        $2.ImageObjectDetectionAnnotation.getDefault,
        $2.ImageObjectDetectionAnnotation.create)
    ..aOS(5, 'displayName')
    ..a<$3.TextExtractionAnnotation>(
        6,
        'textExtraction',
        $pb.PbFieldType.OM,
        $3.TextExtractionAnnotation.getDefault,
        $3.TextExtractionAnnotation.create)
    ..a<$4.TextSentimentAnnotation>(
        7,
        'textSentiment',
        $pb.PbFieldType.OM,
    ...
    ..a<$1.VideoClassificationAnnotation>(
        ...
        'videoClassification',
        $pb.PbFieldType.OM,
        $1.VideoClassificationAnnotation.getDefault,
  ...
  static AnnotationPayload getDefault() =>
