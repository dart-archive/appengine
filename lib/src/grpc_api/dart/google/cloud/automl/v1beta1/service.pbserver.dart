...
abstract class AutoMlServiceBase extends $pb.GeneratedService {
  ...
  $async.Future<$0.AnnotationSpec> getAnnotationSpec(
      $pb.ServerContext ctx, GetAnnotationSpecRequest request);
  $async.Future<$3.TableSpec> getTableSpec(
      $pb.ServerContext ctx, GetTableSpecRequest request);
  $async.Future<ListTableSpecsResponse> listTableSpecs(
      $pb.ServerContext ctx, ListTableSpecsRequest request);
  $async.Future<$3.TableSpec> updateTableSpec(
      $pb.ServerContext ctx, UpdateTableSpecRequest request);
  $async.Future<$4.ColumnSpec> getColumnSpec(
      $pb.ServerContext ctx, GetColumnSpecRequest request);
  $async.Future<ListColumnSpecsResponse> listColumnSpecs(
      $pb.ServerContext ctx, ListColumnSpecsRequest request);
  $async.Future<$4.ColumnSpec> updateColumnSpec(
      $pb.ServerContext ctx, UpdateColumnSpecRequest request);
  $async.Future<$8.Operation> createModel(
      $pb.ServerContext ctx, CreateModelRequest request);
  $async.Future<$5.Model> getModel(
      $pb.ServerContext ctx, GetModelRequest request);
  ...
  $async.Future<$8.Operation> deployModel(
      $pb.ServerContext ctx, DeployModelRequest request);
  $async.Future<$8.Operation> undeployModel(
      $pb.ServerContext ctx, UndeployModelRequest request);
  $async.Future<$8.Operation> exportModel(
      $pb.ServerContext ctx, ExportModelRequest request);
  $async.Future<$8.Operation> exportEvaluatedExamples(
      $pb.ServerContext ctx, ExportEvaluatedExamplesRequest request);
  $async.Future<$7.ModelEvaluation> getModelEvaluation(
      $pb.ServerContext ctx, GetModelEvaluationRequest request);
  $async.Future<ListModelEvaluationsResponse> listModelEvaluations(
      $pb.ServerContext ctx, ListModelEvaluationsRequest request);
  ...
  $pb.GeneratedMessage createRequest($core.String method) {
    switch (method) {
      ...
      case 'GetTableSpec':
        return GetTableSpecRequest();
      case 'ListTableSpecs':
        return ListTableSpecsRequest();
      case 'UpdateTableSpec':
        return UpdateTableSpecRequest();
      case 'GetColumnSpec':
        return GetColumnSpecRequest();
      case 'ListColumnSpecs':
        return ListColumnSpecsRequest();
      case 'UpdateColumnSpec':
        return UpdateColumnSpecRequest();
      case 'CreateModel':
  ...
  $async.Future<$pb.GeneratedMessage> handleCall($pb.ServerContext ctx,
    ...
    switch (method) {
      ...
      case 'GetAnnotationSpec':
        return this.getAnnotationSpec(ctx, request);
      case 'GetTableSpec':
        return this.getTableSpec(ctx, request);
      case 'ListTableSpecs':
        return this.listTableSpecs(ctx, request);
      case 'UpdateTableSpec':
        return this.updateTableSpec(ctx, request);
      case 'GetColumnSpec':
        return this.getColumnSpec(ctx, request);
      case 'ListColumnSpecs':
        return this.listColumnSpecs(ctx, request);
      case 'UpdateColumnSpec':
        return this.updateColumnSpec(ctx, request);
      case 'CreateModel':
      ...
      case 'DeployModel':
        return this.deployModel(ctx, request);
      case 'UndeployModel':
        return this.undeployModel(ctx, request);
      case 'ExportModel':
        return this.exportModel(ctx, request);
      case 'ExportEvaluatedExamples':
        return this.exportEvaluatedExamples(ctx, request);
      case 'GetModelEvaluation':
        return this.getModelEvaluation(ctx, request);
      case 'ListModelEvaluations':
        return this.listModelEvaluations(ctx, request);
      default:
        throw $core.ArgumentError('Unknown method: $method');
    }
  }
  ...
  $core.Map<$core.String, $core.Map<$core.String, $core.dynamic>>
      get $messageJson => AutoMlServiceBase$messageJson;
}
