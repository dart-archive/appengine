...
class TablesDatasetMetadata extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('TablesDatasetMetadata', package: const $pb.PackageName('google.cloud.automl.v1beta1'))
    ..aOS(1, 'primaryTableSpecId')
    ..aOS(2, 'targetColumnSpecId')
    ..aOS(3, 'weightColumnSpecId')
    ..aOS(4, 'mlUseColumnSpecId')
    ..m<$core.String, $1.CorrelationStats>(6, 'targetColumnCorrelations', 'TablesDatasetMetadata.TargetColumnCorrelationsEntry',$pb.PbFieldType.OS, $pb.PbFieldType.OM, $1.CorrelationStats.create, null, null , const $pb.PackageName('google.cloud.automl.v1beta1'))
    ..a<$0.Timestamp>(7, 'statsUpdateTime', $pb.PbFieldType.OM, $0.Timestamp.getDefault, $0.Timestamp.create)
    ..hasRequiredFields = false
  ;

  TablesDatasetMetadata() : super();
  TablesDatasetMetadata.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  TablesDatasetMetadata.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  TablesDatasetMetadata clone() => TablesDatasetMetadata()..mergeFromMessage(this);
  TablesDatasetMetadata copyWith(void Function(TablesDatasetMetadata) updates) => super.copyWith((message) => updates(message as TablesDatasetMetadata));
  ...
  static TablesDatasetMetadata getDefault() => _defaultInstance ??= create()..freeze();
...
class TablesModelMetadata extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('TablesModelMetadata', package: const $pb.PackageName('google.cloud.automl.v1beta1'))
    ..a<$2.ColumnSpec>(2, 'targetColumnSpec', $pb.PbFieldType.OM, $2.ColumnSpec.getDefault, $2.ColumnSpec.create)
    ..pc<$2.ColumnSpec>(3, 'inputFeatureColumnSpecs', $pb.PbFieldType.PM,$2.ColumnSpec.create)
    ..aOS(4, 'optimizationObjective')
    ..pc<TablesModelColumnInfo>(5, 'tablesModelColumnInfo', $pb.PbFieldType.PM,TablesModelColumnInfo.create)
  ...
  TablesModelMetadata.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  TablesModelMetadata.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  TablesModelMetadata clone() => TablesModelMetadata()..mergeFromMessage(this);
  TablesModelMetadata copyWith(void Function(TablesModelMetadata) updates) => super.copyWith((message) => updates(message as TablesModelMetadata));
  $pb.BuilderInfo get info_ => _i;
  ...
  static TablesModelMetadata getDefault() => _defaultInstance ??= create()..freeze();
  ...
  set trainBudgetMilliNodeHours(Int64 v) { $_setInt64(4, v); }
  ...
  set trainCostMilliNodeHours(Int64 v) { $_setInt64(5, v); }
...
class TablesAnnotation extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('TablesAnnotation', package: const $pb.PackageName('google.cloud.automl.v1beta1'))
    ..a<$core.double>(1, 'score', $pb.PbFieldType.OF)
    ..a<$3.Value>(2, 'value', $pb.PbFieldType.OM, $3.Value.getDefault, $3.Value.create)
    ..pc<TablesModelColumnInfo>(3, 'tablesModelColumnInfo', $pb.PbFieldType.PM,TablesModelColumnInfo.create)
    ..a<$4.DoubleRange>(4, 'predictionInterval', $pb.PbFieldType.OM, $4.DoubleRange.getDefault, $4.DoubleRange.create)
    ..hasRequiredFields = false
  ;

  TablesAnnotation() : super();
  TablesAnnotation.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  TablesAnnotation.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  TablesAnnotation clone() => TablesAnnotation()..mergeFromMessage(this);
  TablesAnnotation copyWith(void Function(TablesAnnotation) updates) => super.copyWith((message) => updates(message as TablesAnnotation));
  $pb.BuilderInfo get info_ => _i;
  ...
  static TablesAnnotation getDefault() => _defaultInstance ??= create()..freeze();
...
class TablesModelColumnInfo extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('TablesModelColumnInfo', package: const $pb.PackageName('google.cloud.automl.v1beta1'))
  ...
  TablesModelColumnInfo.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  TablesModelColumnInfo.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  TablesModelColumnInfo clone() => TablesModelColumnInfo()..mergeFromMessage(this);
  TablesModelColumnInfo copyWith(void Function(TablesModelColumnInfo) updates) => super.copyWith((message) => updates(message as TablesModelColumnInfo));
  $pb.BuilderInfo get info_ => _i;
  ...
  static TablesModelColumnInfo getDefault() => _defaultInstance ??= create()..freeze();
