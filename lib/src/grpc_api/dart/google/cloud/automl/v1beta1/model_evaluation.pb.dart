...
class ModelEvaluation extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ModelEvaluation',
    ...
    ..a<$1.ClassificationEvaluationMetrics>(
        8,
        'classificationEvaluationMetrics',
        $pb.PbFieldType.OM,
        $1.ClassificationEvaluationMetrics.getDefault,
        $1.ClassificationEvaluationMetrics.create)
    ..a<$2.TranslationEvaluationMetrics>(
        9,
        'translationEvaluationMetrics',
        $pb.PbFieldType.OM,
        $2.TranslationEvaluationMetrics.getDefault,
        $2.TranslationEvaluationMetrics.create)
    ..a<$3.TextSentimentEvaluationMetrics>(
        11,
        'textSentimentEvaluationMetrics',
        $pb.PbFieldType.OM,
        $3.TextSentimentEvaluationMetrics.getDefault,
        $3.TextSentimentEvaluationMetrics.create)
    ..a<$4.ImageObjectDetectionEvaluationMetrics>(
        12,
        'imageObjectDetectionEvaluationMetrics',
        $pb.PbFieldType.OM,
        $4.ImageObjectDetectionEvaluationMetrics.getDefault,
        $4.ImageObjectDetectionEvaluationMetrics.create)
    ..a<$5.TextExtractionEvaluationMetrics>(
        13,
        'textExtractionEvaluationMetrics',
        $pb.PbFieldType.OM,
  ...
  static ModelEvaluation getDefault() =>
