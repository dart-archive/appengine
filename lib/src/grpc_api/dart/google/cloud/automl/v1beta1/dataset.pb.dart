...
class Dataset extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Dataset', package: const $pb.PackageName('google.cloud.automl.v1beta1'))
    ..aOS(1, 'name')
    ..aOS(2, 'displayName')
    ..aOS(3, 'description')
    ..a<$0.Timestamp>(14, 'createTime', $pb.PbFieldType.OM, $0.Timestamp.getDefault, $0.Timestamp.create)
    ..aOS(17, 'etag')
    ..a<$core.int>(21, 'exampleCount', $pb.PbFieldType.O3)
    ..a<$1.TranslationDatasetMetadata>(23, 'translationDatasetMetadata', $pb.PbFieldType.OM, $1.TranslationDatasetMetadata.getDefault, $1.TranslationDatasetMetadata.create)
    ..a<$2.ImageClassificationDatasetMetadata>(24, 'imageClassificationDatasetMetadata', $pb.PbFieldType.OM, $2.ImageClassificationDatasetMetadata.getDefault, $2.ImageClassificationDatasetMetadata.create)
    ..a<$3.TextClassificationDatasetMetadata>(25, 'textClassificationDatasetMetadata', $pb.PbFieldType.OM, $3.TextClassificationDatasetMetadata.getDefault, $3.TextClassificationDatasetMetadata.create)
    ..a<$2.ImageObjectDetectionDatasetMetadata>(26, 'imageObjectDetectionDatasetMetadata', $pb.PbFieldType.OM, $2.ImageObjectDetectionDatasetMetadata.getDefault, $2.ImageObjectDetectionDatasetMetadata.create)
    ..a<$3.TextExtractionDatasetMetadata>(28, 'textExtractionDatasetMetadata', $pb.PbFieldType.OM, $3.TextExtractionDatasetMetadata.getDefault, $3.TextExtractionDatasetMetadata.create)
    ..a<$3.TextSentimentDatasetMetadata>(30, 'textSentimentDatasetMetadata', $pb.PbFieldType.OM, $3.TextSentimentDatasetMetadata.getDefault, $3.TextSentimentDatasetMetadata.create)
    ..a<$4.VideoClassificationDatasetMetadata>(31, 'videoClassificationDatasetMetadata', $pb.PbFieldType.OM, $4.VideoClassificationDatasetMetadata.getDefault, $4.VideoClassificationDatasetMetadata.create)
    ..a<$5.TablesDatasetMetadata>(33, 'tablesDatasetMetadata', $pb.PbFieldType.OM, $5.TablesDatasetMetadata.getDefault, $5.TablesDatasetMetadata.create)
  ...
  $4.VideoClassificationDatasetMetadata get videoClassificationDatasetMetadata => $_getN(12);
...
class AnnotationSpec extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('AnnotationSpec', package: const $pb.PackageName('google.cloud.automl.v1beta1'))
    ..aOS(1, 'name')
    ..aOS(2, 'displayName')
