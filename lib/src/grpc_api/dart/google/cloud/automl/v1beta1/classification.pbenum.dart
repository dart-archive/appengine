...
class ClassificationType extends $pb.ProtobufEnum {
  static const ClassificationType CLASSIFICATION_TYPE_UNSPECIFIED = ClassificationType._(0, 'CLASSIFICATION_TYPE_UNSPECIFIED');
  static const ClassificationType MULTICLASS = ClassificationType._(1, 'MULTICLASS');
  static const ClassificationType MULTILABEL = ClassificationType._(2, 'MULTILABEL');
