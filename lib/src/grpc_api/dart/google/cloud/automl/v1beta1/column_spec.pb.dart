...
class ColumnSpec_CorrelatedColumn extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOS(1, 'columnSpecId')
    ..a<$1.CorrelationStats>(2, 'correlationStats', $pb.PbFieldType.OM,
  ...
  static ColumnSpec_CorrelatedColumn getDefault() =>
...
class ColumnSpec extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ColumnSpec',
      package: const $pb.PackageName('google.cloud.automl.v1beta1'))
    ..aOS(1, 'name')
    ..a<$0.DataType>(2, 'dataType', $pb.PbFieldType.OM, $0.DataType.getDefault,
        $0.DataType.create)
    ..aOS(3, 'displayName')
    ..a<$1.DataStats>(4, 'dataStats', $pb.PbFieldType.OM,
        $1.DataStats.getDefault, $1.DataStats.create)
    ..pc<ColumnSpec_CorrelatedColumn>(5, 'topCorrelatedColumns',
        $pb.PbFieldType.PM, ColumnSpec_CorrelatedColumn.create)
    ..aOS(6, 'etag')
    ..hasRequiredFields = false;
