...
class DoubleRange extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('DoubleRange', package: const $pb.PackageName('google.cloud.automl.v1beta1'))
  ...
  DoubleRange() : super();
  DoubleRange.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  DoubleRange.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  DoubleRange clone() => DoubleRange()..mergeFromMessage(this);
  DoubleRange copyWith(void Function(DoubleRange) updates) => super.copyWith((message) => updates(message as DoubleRange));
