...
class OperationMetadata extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('OperationMetadata', package: const $pb.PackageName('google.cloud.automl.v1beta1'))
    ..pc<$0.Status>(2, 'partialFailures', $pb.PbFieldType.PM,$0.Status.create)
    ..a<$1.Timestamp>(3, 'createTime', $pb.PbFieldType.OM, $1.Timestamp.getDefault, $1.Timestamp.create)
    ..a<$1.Timestamp>(4, 'updateTime', $pb.PbFieldType.OM, $1.Timestamp.getDefault, $1.Timestamp.create)
    ..a<DeleteOperationMetadata>(8, 'deleteDetails', $pb.PbFieldType.OM, DeleteOperationMetadata.getDefault, DeleteOperationMetadata.create)
    ..a<CreateModelOperationMetadata>(10, 'createModelDetails', $pb.PbFieldType.OM, CreateModelOperationMetadata.getDefault, CreateModelOperationMetadata.create)
    ..a<$core.int>(13, 'progressPercent', $pb.PbFieldType.O3)
    ..a<ImportDataOperationMetadata>(15, 'importDataDetails', $pb.PbFieldType.OM, ImportDataOperationMetadata.getDefault, ImportDataOperationMetadata.create)
    ..a<BatchPredictOperationMetadata>(16, 'batchPredictDetails', $pb.PbFieldType.OM, BatchPredictOperationMetadata.getDefault, BatchPredictOperationMetadata.create)
    ..a<ExportDataOperationMetadata>(21, 'exportDataDetails', $pb.PbFieldType.OM, ExportDataOperationMetadata.getDefault, ExportDataOperationMetadata.create)
    ..a<ExportModelOperationMetadata>(22, 'exportModelDetails', $pb.PbFieldType.OM, ExportModelOperationMetadata.getDefault, ExportModelOperationMetadata.create)
    ..a<DeployModelOperationMetadata>(24, 'deployModelDetails', $pb.PbFieldType.OM, DeployModelOperationMetadata.getDefault, DeployModelOperationMetadata.create)
    ..a<UndeployModelOperationMetadata>(25, 'undeployModelDetails', $pb.PbFieldType.OM, UndeployModelOperationMetadata.getDefault, UndeployModelOperationMetadata.create)
    ..a<ExportEvaluatedExamplesOperationMetadata>(26, 'exportEvaluatedExamplesDetails', $pb.PbFieldType.OM, ExportEvaluatedExamplesOperationMetadata.getDefault, ExportEvaluatedExamplesOperationMetadata.create)
...
class DeleteOperationMetadata extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('DeleteOperationMetadata', package: const $pb.PackageName('google.cloud.automl.v1beta1'))
    ..hasRequiredFields = false
  ;

  DeleteOperationMetadata() : super();
  DeleteOperationMetadata.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  DeleteOperationMetadata.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  DeleteOperationMetadata clone() => DeleteOperationMetadata()..mergeFromMessage(this);
  DeleteOperationMetadata copyWith(void Function(DeleteOperationMetadata) updates) => super.copyWith((message) => updates(message as DeleteOperationMetadata));
  $pb.BuilderInfo get info_ => _i;
  ...
  static DeleteOperationMetadata getDefault() => _defaultInstance ??= create()..freeze();
  static DeleteOperationMetadata _defaultInstance;
}

class DeployModelOperationMetadata extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('DeployModelOperationMetadata', package: const $pb.PackageName('google.cloud.automl.v1beta1'))
    ..hasRequiredFields = false
  ;

  DeployModelOperationMetadata() : super();
  DeployModelOperationMetadata.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  DeployModelOperationMetadata.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  DeployModelOperationMetadata clone() => DeployModelOperationMetadata()..mergeFromMessage(this);
  DeployModelOperationMetadata copyWith(void Function(DeployModelOperationMetadata) updates) => super.copyWith((message) => updates(message as DeployModelOperationMetadata));
  $pb.BuilderInfo get info_ => _i;
  static DeployModelOperationMetadata create() => DeployModelOperationMetadata();
  ...
  static DeployModelOperationMetadata getDefault() => _defaultInstance ??= create()..freeze();
  static DeployModelOperationMetadata _defaultInstance;
}

class UndeployModelOperationMetadata extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('UndeployModelOperationMetadata', package: const $pb.PackageName('google.cloud.automl.v1beta1'))
    ..hasRequiredFields = false
  ;

  UndeployModelOperationMetadata() : super();
  UndeployModelOperationMetadata.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  UndeployModelOperationMetadata.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  UndeployModelOperationMetadata clone() => UndeployModelOperationMetadata()..mergeFromMessage(this);
  UndeployModelOperationMetadata copyWith(void Function(UndeployModelOperationMetadata) updates) => super.copyWith((message) => updates(message as UndeployModelOperationMetadata));
  $pb.BuilderInfo get info_ => _i;
  static UndeployModelOperationMetadata create() => UndeployModelOperationMetadata();
  ...
  static UndeployModelOperationMetadata getDefault() => _defaultInstance ??= create()..freeze();
  static UndeployModelOperationMetadata _defaultInstance;
}

class CreateModelOperationMetadata extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('CreateModelOperationMetadata', package: const $pb.PackageName('google.cloud.automl.v1beta1'))
    ..hasRequiredFields = false
  ;

  CreateModelOperationMetadata() : super();
  CreateModelOperationMetadata.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  CreateModelOperationMetadata.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  CreateModelOperationMetadata clone() => CreateModelOperationMetadata()..mergeFromMessage(this);
  CreateModelOperationMetadata copyWith(void Function(CreateModelOperationMetadata) updates) => super.copyWith((message) => updates(message as CreateModelOperationMetadata));
  $pb.BuilderInfo get info_ => _i;
  static CreateModelOperationMetadata create() => CreateModelOperationMetadata();
  ...
  static CreateModelOperationMetadata getDefault() => _defaultInstance ??= create()..freeze();
  static CreateModelOperationMetadata _defaultInstance;
}

class ImportDataOperationMetadata extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ImportDataOperationMetadata', package: const $pb.PackageName('google.cloud.automl.v1beta1'))
    ..hasRequiredFields = false
  ;
...
class ExportDataOperationMetadata_ExportDataOutputInfo extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ExportDataOperationMetadata.ExportDataOutputInfo', package: const $pb.PackageName('google.cloud.automl.v1beta1'))
  ...
  ExportDataOperationMetadata_ExportDataOutputInfo.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  ExportDataOperationMetadata_ExportDataOutputInfo.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ...
  ExportDataOperationMetadata_ExportDataOutputInfo copyWith(void Function(ExportDataOperationMetadata_ExportDataOutputInfo) updates) => super.copyWith((message) => updates(message as ExportDataOperationMetadata_ExportDataOutputInfo));
  $pb.BuilderInfo get info_ => _i;
  static ExportDataOperationMetadata_ExportDataOutputInfo create() => ExportDataOperationMetadata_ExportDataOutputInfo();
  ...
  static ExportDataOperationMetadata_ExportDataOutputInfo getDefault() => _defaultInstance ??= create()..freeze();
...
class ExportDataOperationMetadata extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ExportDataOperationMetadata', package: const $pb.PackageName('google.cloud.automl.v1beta1'))
    ..a<ExportDataOperationMetadata_ExportDataOutputInfo>(1, 'outputInfo', $pb.PbFieldType.OM, ExportDataOperationMetadata_ExportDataOutputInfo.getDefault, ExportDataOperationMetadata_ExportDataOutputInfo.create)
    ..hasRequiredFields = false
  ;
...
class BatchPredictOperationMetadata_BatchPredictOutputInfo extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('BatchPredictOperationMetadata.BatchPredictOutputInfo', package: const $pb.PackageName('google.cloud.automl.v1beta1'))
    ..aOS(1, 'gcsOutputDirectory')
    ..aOS(2, 'bigqueryOutputDataset')
    ..oo(0, [1, 2])
    ..hasRequiredFields = false
  ...
  BatchPredictOperationMetadata_BatchPredictOutputInfo.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  BatchPredictOperationMetadata_BatchPredictOutputInfo.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ...
  BatchPredictOperationMetadata_BatchPredictOutputInfo copyWith(void Function(BatchPredictOperationMetadata_BatchPredictOutputInfo) updates) => super.copyWith((message) => updates(message as BatchPredictOperationMetadata_BatchPredictOutputInfo));
  $pb.BuilderInfo get info_ => _i;
  static BatchPredictOperationMetadata_BatchPredictOutputInfo create() => BatchPredictOperationMetadata_BatchPredictOutputInfo();
  ...
  static BatchPredictOperationMetadata_BatchPredictOutputInfo getDefault() => _defaultInstance ??= create()..freeze();
...
class BatchPredictOperationMetadata extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('BatchPredictOperationMetadata', package: const $pb.PackageName('google.cloud.automl.v1beta1'))
    ..a<$2.BatchPredictInputConfig>(1, 'inputConfig', $pb.PbFieldType.OM, $2.BatchPredictInputConfig.getDefault, $2.BatchPredictInputConfig.create)
    ..a<BatchPredictOperationMetadata_BatchPredictOutputInfo>(2, 'outputInfo', $pb.PbFieldType.OM, BatchPredictOperationMetadata_BatchPredictOutputInfo.getDefault, BatchPredictOperationMetadata_BatchPredictOutputInfo.create)
    ..hasRequiredFields = false
  ;

  BatchPredictOperationMetadata() : super();
  BatchPredictOperationMetadata.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  BatchPredictOperationMetadata.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  BatchPredictOperationMetadata clone() => BatchPredictOperationMetadata()..mergeFromMessage(this);
  BatchPredictOperationMetadata copyWith(void Function(BatchPredictOperationMetadata) updates) => super.copyWith((message) => updates(message as BatchPredictOperationMetadata));
  $pb.BuilderInfo get info_ => _i;
  static BatchPredictOperationMetadata create() => BatchPredictOperationMetadata();
  ...
  static BatchPredictOperationMetadata getDefault() => _defaultInstance ??= create()..freeze();
...
class ExportModelOperationMetadata_ExportModelOutputInfo extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ExportModelOperationMetadata.ExportModelOutputInfo', package: const $pb.PackageName('google.cloud.automl.v1beta1'))
    ..aOS(1, 'gcsOutputDirectory')
    ..hasRequiredFields = false
  ;

  ExportModelOperationMetadata_ExportModelOutputInfo() : super();
  ExportModelOperationMetadata_ExportModelOutputInfo.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  ExportModelOperationMetadata_ExportModelOutputInfo.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ...
  ExportModelOperationMetadata_ExportModelOutputInfo copyWith(void Function(ExportModelOperationMetadata_ExportModelOutputInfo) updates) => super.copyWith((message) => updates(message as ExportModelOperationMetadata_ExportModelOutputInfo));
  $pb.BuilderInfo get info_ => _i;
  static ExportModelOperationMetadata_ExportModelOutputInfo create() => ExportModelOperationMetadata_ExportModelOutputInfo();
  ...
  static ExportModelOperationMetadata_ExportModelOutputInfo getDefault() => _defaultInstance ??= create()..freeze();
...
class ExportModelOperationMetadata extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ExportModelOperationMetadata', package: const $pb.PackageName('google.cloud.automl.v1beta1'))
    ..a<ExportModelOperationMetadata_ExportModelOutputInfo>(2, 'outputInfo', $pb.PbFieldType.OM, ExportModelOperationMetadata_ExportModelOutputInfo.getDefault, ExportModelOperationMetadata_ExportModelOutputInfo.create)
    ..hasRequiredFields = false
  ;

  ExportModelOperationMetadata() : super();
  ExportModelOperationMetadata.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  ExportModelOperationMetadata.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ExportModelOperationMetadata clone() => ExportModelOperationMetadata()..mergeFromMessage(this);
  ExportModelOperationMetadata copyWith(void Function(ExportModelOperationMetadata) updates) => super.copyWith((message) => updates(message as ExportModelOperationMetadata));
  $pb.BuilderInfo get info_ => _i;
  static ExportModelOperationMetadata create() => ExportModelOperationMetadata();
  ...
  static ExportModelOperationMetadata getDefault() => _defaultInstance ??= create()..freeze();
...
class ExportEvaluatedExamplesOperationMetadata_ExportEvaluatedExamplesOutputInfo extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ExportEvaluatedExamplesOperationMetadata.ExportEvaluatedExamplesOutputInfo', package: const $pb.PackageName('google.cloud.automl.v1beta1'))
    ..aOS(2, 'bigqueryOutputDataset')
    ..hasRequiredFields = false
  ;

  ExportEvaluatedExamplesOperationMetadata_ExportEvaluatedExamplesOutputInfo() : super();
  ExportEvaluatedExamplesOperationMetadata_ExportEvaluatedExamplesOutputInfo.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  ExportEvaluatedExamplesOperationMetadata_ExportEvaluatedExamplesOutputInfo.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ...
  ExportEvaluatedExamplesOperationMetadata_ExportEvaluatedExamplesOutputInfo copyWith(void Function(ExportEvaluatedExamplesOperationMetadata_ExportEvaluatedExamplesOutputInfo) updates) => super.copyWith((message) => updates(message as ExportEvaluatedExamplesOperationMetadata_ExportEvaluatedExamplesOutputInfo));
  $pb.BuilderInfo get info_ => _i;
  static ExportEvaluatedExamplesOperationMetadata_ExportEvaluatedExamplesOutputInfo create() => ExportEvaluatedExamplesOperationMetadata_ExportEvaluatedExamplesOutputInfo();
  ...
  static ExportEvaluatedExamplesOperationMetadata_ExportEvaluatedExamplesOutputInfo getDefault() => _defaultInstance ??= create()..freeze();
...
class ExportEvaluatedExamplesOperationMetadata extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ExportEvaluatedExamplesOperationMetadata', package: const $pb.PackageName('google.cloud.automl.v1beta1'))
    ..a<ExportEvaluatedExamplesOperationMetadata_ExportEvaluatedExamplesOutputInfo>(2, 'outputInfo', $pb.PbFieldType.OM, ExportEvaluatedExamplesOperationMetadata_ExportEvaluatedExamplesOutputInfo.getDefault, ExportEvaluatedExamplesOperationMetadata_ExportEvaluatedExamplesOutputInfo.create)
    ..hasRequiredFields = false
  ;

  ExportEvaluatedExamplesOperationMetadata() : super();
  ExportEvaluatedExamplesOperationMetadata.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  ExportEvaluatedExamplesOperationMetadata.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ExportEvaluatedExamplesOperationMetadata clone() => ExportEvaluatedExamplesOperationMetadata()..mergeFromMessage(this);
  ExportEvaluatedExamplesOperationMetadata copyWith(void Function(ExportEvaluatedExamplesOperationMetadata) updates) => super.copyWith((message) => updates(message as ExportEvaluatedExamplesOperationMetadata));
  $pb.BuilderInfo get info_ => _i;
  static ExportEvaluatedExamplesOperationMetadata create() => ExportEvaluatedExamplesOperationMetadata();
  ...
  static ExportEvaluatedExamplesOperationMetadata getDefault() => _defaultInstance ??= create()..freeze();
