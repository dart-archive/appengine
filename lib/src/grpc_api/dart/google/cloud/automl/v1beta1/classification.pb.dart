...
class ClassificationAnnotation extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ClassificationAnnotation', package: const $pb.PackageName('google.cloud.automl.v1beta1'))
    ..a<$core.double>(1, 'score', $pb.PbFieldType.OF)
    ..hasRequiredFields = false
  ;

  ClassificationAnnotation() : super();
  ClassificationAnnotation.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  ClassificationAnnotation.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ClassificationAnnotation clone() => ClassificationAnnotation()..mergeFromMessage(this);
  ClassificationAnnotation copyWith(void Function(ClassificationAnnotation) updates) => super.copyWith((message) => updates(message as ClassificationAnnotation));
  ...
  static ClassificationAnnotation getDefault() => _defaultInstance ??= create()..freeze();
...
class VideoClassificationAnnotation extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('VideoClassificationAnnotation', package: const $pb.PackageName('google.cloud.automl.v1beta1'))
    ..aOS(1, 'type')
    ..a<ClassificationAnnotation>(2, 'classificationAnnotation', $pb.PbFieldType.OM, ClassificationAnnotation.getDefault, ClassificationAnnotation.create)
    ..a<$0.TimeSegment>(3, 'timeSegment', $pb.PbFieldType.OM, $0.TimeSegment.getDefault, $0.TimeSegment.create)
    ..hasRequiredFields = false
  ;
...
class ClassificationEvaluationMetrics_ConfidenceMetricsEntry extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ClassificationEvaluationMetrics.ConfidenceMetricsEntry', package: const $pb.PackageName('google.cloud.automl.v1beta1'))
  ...
  ClassificationEvaluationMetrics_ConfidenceMetricsEntry.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  ClassificationEvaluationMetrics_ConfidenceMetricsEntry.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ...
  ClassificationEvaluationMetrics_ConfidenceMetricsEntry copyWith(void Function(ClassificationEvaluationMetrics_ConfidenceMetricsEntry) updates) => super.copyWith((message) => updates(message as ClassificationEvaluationMetrics_ConfidenceMetricsEntry));
  $pb.BuilderInfo get info_ => _i;
  static ClassificationEvaluationMetrics_ConfidenceMetricsEntry create() => ClassificationEvaluationMetrics_ConfidenceMetricsEntry();
  ...
  static ClassificationEvaluationMetrics_ConfidenceMetricsEntry getDefault() => _defaultInstance ??= create()..freeze();
...
class ClassificationEvaluationMetrics_ConfusionMatrix_Row extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ClassificationEvaluationMetrics.ConfusionMatrix.Row', package: const $pb.PackageName('google.cloud.automl.v1beta1'))
    ..p<$core.int>(1, 'exampleCount', $pb.PbFieldType.P3)
    ..hasRequiredFields = false
  ;

  ClassificationEvaluationMetrics_ConfusionMatrix_Row() : super();
  ClassificationEvaluationMetrics_ConfusionMatrix_Row.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  ClassificationEvaluationMetrics_ConfusionMatrix_Row.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ...
  ClassificationEvaluationMetrics_ConfusionMatrix_Row copyWith(void Function(ClassificationEvaluationMetrics_ConfusionMatrix_Row) updates) => super.copyWith((message) => updates(message as ClassificationEvaluationMetrics_ConfusionMatrix_Row));
  $pb.BuilderInfo get info_ => _i;
  static ClassificationEvaluationMetrics_ConfusionMatrix_Row create() => ClassificationEvaluationMetrics_ConfusionMatrix_Row();
  ...
  static ClassificationEvaluationMetrics_ConfusionMatrix_Row getDefault() => _defaultInstance ??= create()..freeze();
...
class ClassificationEvaluationMetrics_ConfusionMatrix extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ClassificationEvaluationMetrics.ConfusionMatrix', package: const $pb.PackageName('google.cloud.automl.v1beta1'))
    ..pPS(1, 'annotationSpecId')
    ..pc<ClassificationEvaluationMetrics_ConfusionMatrix_Row>(2, 'row', $pb.PbFieldType.PM,ClassificationEvaluationMetrics_ConfusionMatrix_Row.create)
    ..hasRequiredFields = false
  ;

  ClassificationEvaluationMetrics_ConfusionMatrix() : super();
  ClassificationEvaluationMetrics_ConfusionMatrix.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  ClassificationEvaluationMetrics_ConfusionMatrix.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ...
  ClassificationEvaluationMetrics_ConfusionMatrix copyWith(void Function(ClassificationEvaluationMetrics_ConfusionMatrix) updates) => super.copyWith((message) => updates(message as ClassificationEvaluationMetrics_ConfusionMatrix));
  $pb.BuilderInfo get info_ => _i;
  static ClassificationEvaluationMetrics_ConfusionMatrix create() => ClassificationEvaluationMetrics_ConfusionMatrix();
  ...
  static ClassificationEvaluationMetrics_ConfusionMatrix getDefault() => _defaultInstance ??= create()..freeze();
...
class ClassificationEvaluationMetrics extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ClassificationEvaluationMetrics', package: const $pb.PackageName('google.cloud.automl.v1beta1'))
    ..a<$core.double>(1, 'auPrc', $pb.PbFieldType.OF)
    ..a<$core.double>(2, 'baseAuPrc', $pb.PbFieldType.OF)
    ..pc<ClassificationEvaluationMetrics_ConfidenceMetricsEntry>(3, 'confidenceMetricsEntry', $pb.PbFieldType.PM,ClassificationEvaluationMetrics_ConfidenceMetricsEntry.create)
    ..a<ClassificationEvaluationMetrics_ConfusionMatrix>(4, 'confusionMatrix', $pb.PbFieldType.OM, ClassificationEvaluationMetrics_ConfusionMatrix.getDefault, ClassificationEvaluationMetrics_ConfusionMatrix.create)
  ...
  ClassificationEvaluationMetrics.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  ClassificationEvaluationMetrics.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ClassificationEvaluationMetrics clone() => ClassificationEvaluationMetrics()..mergeFromMessage(this);
  ClassificationEvaluationMetrics copyWith(void Function(ClassificationEvaluationMetrics) updates) => super.copyWith((message) => updates(message as ClassificationEvaluationMetrics));
  $pb.BuilderInfo get info_ => _i;
  static ClassificationEvaluationMetrics create() => ClassificationEvaluationMetrics();
  ...
  static ClassificationEvaluationMetrics getDefault() => _defaultInstance ??= create()..freeze();
