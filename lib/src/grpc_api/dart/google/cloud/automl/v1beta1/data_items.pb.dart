...
class Image extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Image', package: const $pb.PackageName('google.cloud.automl.v1beta1'))
    ..a<$core.List<$core.int>>(1, 'imageBytes', $pb.PbFieldType.OY)
    ..aOS(4, 'thumbnailUri')
    ..a<$0.InputConfig>(6, 'inputConfig', $pb.PbFieldType.OM, $0.InputConfig.getDefault, $0.InputConfig.create)
    ..oo(0, [1, 6])
...
class TextSnippet extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('TextSnippet', package: const $pb.PackageName('google.cloud.automl.v1beta1'))
    ..aOS(1, 'content')
    ..aOS(2, 'mimeType')
    ..aOS(4, 'contentUri')
    ..hasRequiredFields = false
  ...
  TextSnippet() : super();
  TextSnippet.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  TextSnippet.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  TextSnippet clone() => TextSnippet()..mergeFromMessage(this);
  TextSnippet copyWith(void Function(TextSnippet) updates) => super.copyWith((message) => updates(message as TextSnippet));
  $pb.BuilderInfo get info_ => _i;
...
class Document extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Document', package: const $pb.PackageName('google.cloud.automl.v1beta1'))
    ..a<$0.DocumentInputConfig>(1, 'inputConfig', $pb.PbFieldType.OM, $0.DocumentInputConfig.getDefault, $0.DocumentInputConfig.create)
    ..hasRequiredFields = false
  ;
...
class Row extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Row', package: const $pb.PackageName('google.cloud.automl.v1beta1'))
    ..pPS(2, 'columnSpecIds')
...
class ExamplePayload extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ExamplePayload', package: const $pb.PackageName('google.cloud.automl.v1beta1'))
    ..a<Image>(1, 'image', $pb.PbFieldType.OM, Image.getDefault, Image.create)
    ..a<TextSnippet>(2, 'textSnippet', $pb.PbFieldType.OM, TextSnippet.getDefault, TextSnippet.create)
    ..a<Row>(3, 'row', $pb.PbFieldType.OM, Row.getDefault, Row.create)
    ..a<Document>(4, 'document', $pb.PbFieldType.OM, Document.getDefault, Document.create)
    ..oo(0, [1, 2, 3, 4])
    ..hasRequiredFields = false
  ;

  ExamplePayload() : super();
  ExamplePayload.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  ExamplePayload.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ExamplePayload clone() => ExamplePayload()..mergeFromMessage(this);
  ExamplePayload copyWith(void Function(ExamplePayload) updates) => super.copyWith((message) => updates(message as ExamplePayload));
  $pb.BuilderInfo get info_ => _i;
