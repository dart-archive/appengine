...
class TableSpec extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('TableSpec', package: const $pb.PackageName('google.cloud.automl.v1beta1'))
    ..aOS(1, 'name')
    ..aOS(2, 'timeColumnSpecId')
    ..aInt64(3, 'rowCount')
    ..pc<$0.InputConfig>(5, 'inputConfigs', $pb.PbFieldType.PM,$0.InputConfig.create)
    ..aOS(6, 'etag')
  ...
  TableSpec() : super();
  TableSpec.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  TableSpec.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  TableSpec clone() => TableSpec()..mergeFromMessage(this);
  TableSpec copyWith(void Function(TableSpec) updates) => super.copyWith((message) => updates(message as TableSpec));
  ...
  set rowCount(Int64 v) { $_setInt64(2, v); }
  ...
  set columnCount(Int64 v) { $_setInt64(5, v); }
