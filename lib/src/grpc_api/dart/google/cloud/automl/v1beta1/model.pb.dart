...
class Model extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Model', package: const $pb.PackageName('google.cloud.automl.v1beta1'))
    ..aOS(1, 'name')
    ..aOS(2, 'displayName')
    ..aOS(3, 'datasetId')
    ..a<$0.Timestamp>(7, 'createTime', $pb.PbFieldType.OM, $0.Timestamp.getDefault, $0.Timestamp.create)
    ..e<Model_DeploymentState>(8, 'deploymentState', $pb.PbFieldType.OE, Model_DeploymentState.DEPLOYMENT_STATE_UNSPECIFIED, Model_DeploymentState.valueOf, Model_DeploymentState.values)
    ..a<$0.Timestamp>(11, 'updateTime', $pb.PbFieldType.OM, $0.Timestamp.getDefault, $0.Timestamp.create)
    ..a<$1.ImageClassificationModelMetadata>(13, 'imageClassificationModelMetadata', $pb.PbFieldType.OM, $1.ImageClassificationModelMetadata.getDefault, $1.ImageClassificationModelMetadata.create)
    ..a<$2.TextClassificationModelMetadata>(14, 'textClassificationModelMetadata', $pb.PbFieldType.OM, $2.TextClassificationModelMetadata.getDefault, $2.TextClassificationModelMetadata.create)
    ..a<$3.TranslationModelMetadata>(15, 'translationModelMetadata', $pb.PbFieldType.OM, $3.TranslationModelMetadata.getDefault, $3.TranslationModelMetadata.create)
    ..a<$2.TextExtractionModelMetadata>(19, 'textExtractionModelMetadata', $pb.PbFieldType.OM, $2.TextExtractionModelMetadata.getDefault, $2.TextExtractionModelMetadata.create)
    ..a<$1.ImageObjectDetectionModelMetadata>(20, 'imageObjectDetectionModelMetadata', $pb.PbFieldType.OM, $1.ImageObjectDetectionModelMetadata.getDefault, $1.ImageObjectDetectionModelMetadata.create)
    ..a<$2.TextSentimentModelMetadata>(22, 'textSentimentModelMetadata', $pb.PbFieldType.OM, $2.TextSentimentModelMetadata.getDefault, $2.TextSentimentModelMetadata.create)
    ..a<$4.VideoClassificationModelMetadata>(23, 'videoClassificationModelMetadata', $pb.PbFieldType.OM, $4.VideoClassificationModelMetadata.getDefault, $4.VideoClassificationModelMetadata.create)
  ...
  $4.VideoClassificationModelMetadata get videoClassificationModelMetadata => $_getN(12);
