...
class Device extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Device', package: const $pb.PackageName('google.cloud.iot.v1'))
    ..aOS(1, 'id')
    ..aOS(2, 'name')
    ..a<Int64>(3, 'numId', $pb.PbFieldType.OU6, Int64.ZERO)
    ..a<$0.Timestamp>(7, 'lastHeartbeatTime', $pb.PbFieldType.OM, $0.Timestamp.getDefault, $0.Timestamp.create)
    ..a<$0.Timestamp>(8, 'lastEventTime', $pb.PbFieldType.OM, $0.Timestamp.getDefault, $0.Timestamp.create)
    ..a<$0.Timestamp>(10, 'lastErrorTime', $pb.PbFieldType.OM, $0.Timestamp.getDefault, $0.Timestamp.create)
    ..a<$1.Status>(11, 'lastErrorStatus', $pb.PbFieldType.OM, $1.Status.getDefault, $1.Status.create)
    ..pc<DeviceCredential>(12, 'credentials', $pb.PbFieldType.PM,DeviceCredential.create)
    ..a<DeviceConfig>(13, 'config', $pb.PbFieldType.OM, DeviceConfig.getDefault, DeviceConfig.create)
    ..a<$0.Timestamp>(14, 'lastConfigAckTime', $pb.PbFieldType.OM, $0.Timestamp.getDefault, $0.Timestamp.create)
    ..a<DeviceState>(16, 'state', $pb.PbFieldType.OM, DeviceState.getDefault, DeviceState.create)
    ..m<$core.String, $core.String>(17, 'metadata', 'Device.MetadataEntry',$pb.PbFieldType.OS, $pb.PbFieldType.OS, null, null, null , const $pb.PackageName('google.cloud.iot.v1'))
    ..a<$0.Timestamp>(18, 'lastConfigSendTime', $pb.PbFieldType.OM, $0.Timestamp.getDefault, $0.Timestamp.create)
    ..aOB(19, 'blocked')
    ..a<$0.Timestamp>(20, 'lastStateTime', $pb.PbFieldType.OM, $0.Timestamp.getDefault, $0.Timestamp.create)
...
class GatewayConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('GatewayConfig', package: const $pb.PackageName('google.cloud.iot.v1'))
    ..e<GatewayType>(1, 'gatewayType', $pb.PbFieldType.OE, GatewayType.GATEWAY_TYPE_UNSPECIFIED, GatewayType.valueOf, GatewayType.values)
    ..e<GatewayAuthMethod>(2, 'gatewayAuthMethod', $pb.PbFieldType.OE, GatewayAuthMethod.GATEWAY_AUTH_METHOD_UNSPECIFIED, GatewayAuthMethod.valueOf, GatewayAuthMethod.values)
    ..aOS(3, 'lastAccessedGatewayId')
    ..a<$0.Timestamp>(4, 'lastAccessedGatewayTime', $pb.PbFieldType.OM, $0.Timestamp.getDefault, $0.Timestamp.create)
    ..hasRequiredFields = false
  ;

  GatewayConfig() : super();
  GatewayConfig.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  GatewayConfig.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  GatewayConfig clone() => GatewayConfig()..mergeFromMessage(this);
  GatewayConfig copyWith(void Function(GatewayConfig) updates) => super.copyWith((message) => updates(message as GatewayConfig));
  $pb.BuilderInfo get info_ => _i;
...
class DeviceRegistry extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('DeviceRegistry', package: const $pb.PackageName('google.cloud.iot.v1'))
    ..aOS(1, 'id')
    ..aOS(2, 'name')
    ..a<MqttConfig>(4, 'mqttConfig', $pb.PbFieldType.OM, MqttConfig.getDefault, MqttConfig.create)
    ..a<StateNotificationConfig>(7, 'stateNotificationConfig', $pb.PbFieldType.OM, StateNotificationConfig.getDefault, StateNotificationConfig.create)
    ..pc<RegistryCredential>(8, 'credentials', $pb.PbFieldType.PM,RegistryCredential.create)
    ..a<HttpConfig>(9, 'httpConfig', $pb.PbFieldType.OM, HttpConfig.getDefault, HttpConfig.create)
    ..pc<EventNotificationConfig>(10, 'eventNotificationConfigs', $pb.PbFieldType.PM,EventNotificationConfig.create)
    ..e<LogLevel>(11, 'logLevel', $pb.PbFieldType.OE, LogLevel.LOG_LEVEL_UNSPECIFIED, LogLevel.valueOf, LogLevel.values)
    ..hasRequiredFields = false
  ;

  DeviceRegistry() : super();
  DeviceRegistry.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  DeviceRegistry.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  DeviceRegistry clone() => DeviceRegistry()..mergeFromMessage(this);
  DeviceRegistry copyWith(void Function(DeviceRegistry) updates) => super.copyWith((message) => updates(message as DeviceRegistry));
  $pb.BuilderInfo get info_ => _i;
...
class MqttConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('MqttConfig', package: const $pb.PackageName('google.cloud.iot.v1'))
    ..e<MqttState>(1, 'mqttEnabledState', $pb.PbFieldType.OE, MqttState.MQTT_STATE_UNSPECIFIED, MqttState.valueOf, MqttState.values)
    ..hasRequiredFields = false
  ;

  MqttConfig() : super();
  MqttConfig.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  MqttConfig.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  MqttConfig clone() => MqttConfig()..mergeFromMessage(this);
  MqttConfig copyWith(void Function(MqttConfig) updates) => super.copyWith((message) => updates(message as MqttConfig));
  $pb.BuilderInfo get info_ => _i;
...
class HttpConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('HttpConfig', package: const $pb.PackageName('google.cloud.iot.v1'))
    ..e<HttpState>(1, 'httpEnabledState', $pb.PbFieldType.OE, HttpState.HTTP_STATE_UNSPECIFIED, HttpState.valueOf, HttpState.values)
    ..hasRequiredFields = false
  ;
...
class EventNotificationConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('EventNotificationConfig', package: const $pb.PackageName('google.cloud.iot.v1'))
  ...
  EventNotificationConfig.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  EventNotificationConfig.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  EventNotificationConfig clone() => EventNotificationConfig()..mergeFromMessage(this);
  EventNotificationConfig copyWith(void Function(EventNotificationConfig) updates) => super.copyWith((message) => updates(message as EventNotificationConfig));
  $pb.BuilderInfo get info_ => _i;
  ...
  static EventNotificationConfig getDefault() => _defaultInstance ??= create()..freeze();
...
class StateNotificationConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('StateNotificationConfig', package: const $pb.PackageName('google.cloud.iot.v1'))
    ..aOS(1, 'pubsubTopicName')
    ..hasRequiredFields = false
  ;

  StateNotificationConfig() : super();
  StateNotificationConfig.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  StateNotificationConfig.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  StateNotificationConfig clone() => StateNotificationConfig()..mergeFromMessage(this);
  StateNotificationConfig copyWith(void Function(StateNotificationConfig) updates) => super.copyWith((message) => updates(message as StateNotificationConfig));
  $pb.BuilderInfo get info_ => _i;
  ...
  static StateNotificationConfig getDefault() => _defaultInstance ??= create()..freeze();
...
class RegistryCredential extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('RegistryCredential', package: const $pb.PackageName('google.cloud.iot.v1'))
    ..a<PublicKeyCertificate>(1, 'publicKeyCertificate', $pb.PbFieldType.OM, PublicKeyCertificate.getDefault, PublicKeyCertificate.create)
    ..oo(0, [1])
    ..hasRequiredFields = false
  ;

  RegistryCredential() : super();
  RegistryCredential.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  RegistryCredential.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  RegistryCredential clone() => RegistryCredential()..mergeFromMessage(this);
  RegistryCredential copyWith(void Function(RegistryCredential) updates) => super.copyWith((message) => updates(message as RegistryCredential));
  $pb.BuilderInfo get info_ => _i;
  ...
  static RegistryCredential getDefault() => _defaultInstance ??= create()..freeze();
...
class X509CertificateDetails extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('X509CertificateDetails', package: const $pb.PackageName('google.cloud.iot.v1'))
    ..aOS(1, 'issuer')
    ..aOS(2, 'subject')
    ..a<$0.Timestamp>(3, 'startTime', $pb.PbFieldType.OM, $0.Timestamp.getDefault, $0.Timestamp.create)
    ..a<$0.Timestamp>(4, 'expiryTime', $pb.PbFieldType.OM, $0.Timestamp.getDefault, $0.Timestamp.create)
  ...
  X509CertificateDetails.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  X509CertificateDetails.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  X509CertificateDetails clone() => X509CertificateDetails()..mergeFromMessage(this);
  X509CertificateDetails copyWith(void Function(X509CertificateDetails) updates) => super.copyWith((message) => updates(message as X509CertificateDetails));
  $pb.BuilderInfo get info_ => _i;
  ...
  static X509CertificateDetails getDefault() => _defaultInstance ??= create()..freeze();
...
class PublicKeyCertificate extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('PublicKeyCertificate', package: const $pb.PackageName('google.cloud.iot.v1'))
    ..e<PublicKeyCertificateFormat>(1, 'format', $pb.PbFieldType.OE, PublicKeyCertificateFormat.UNSPECIFIED_PUBLIC_KEY_CERTIFICATE_FORMAT, PublicKeyCertificateFormat.valueOf, PublicKeyCertificateFormat.values)
    ..aOS(2, 'certificate')
    ..a<X509CertificateDetails>(3, 'x509Details', $pb.PbFieldType.OM, X509CertificateDetails.getDefault, X509CertificateDetails.create)
    ..hasRequiredFields = false
  ;

  PublicKeyCertificate() : super();
  PublicKeyCertificate.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  PublicKeyCertificate.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  PublicKeyCertificate clone() => PublicKeyCertificate()..mergeFromMessage(this);
  PublicKeyCertificate copyWith(void Function(PublicKeyCertificate) updates) => super.copyWith((message) => updates(message as PublicKeyCertificate));
  $pb.BuilderInfo get info_ => _i;
  ...
  static PublicKeyCertificate getDefault() => _defaultInstance ??= create()..freeze();
...
class DeviceCredential extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('DeviceCredential', package: const $pb.PackageName('google.cloud.iot.v1'))
    ..a<PublicKeyCredential>(2, 'publicKey', $pb.PbFieldType.OM, PublicKeyCredential.getDefault, PublicKeyCredential.create)
  ...
  DeviceCredential.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  DeviceCredential.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  DeviceCredential clone() => DeviceCredential()..mergeFromMessage(this);
  DeviceCredential copyWith(void Function(DeviceCredential) updates) => super.copyWith((message) => updates(message as DeviceCredential));
  $pb.BuilderInfo get info_ => _i;
  ...
  static DeviceCredential getDefault() => _defaultInstance ??= create()..freeze();
...
class PublicKeyCredential extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('PublicKeyCredential', package: const $pb.PackageName('google.cloud.iot.v1'))
    ..e<PublicKeyFormat>(1, 'format', $pb.PbFieldType.OE, PublicKeyFormat.UNSPECIFIED_PUBLIC_KEY_FORMAT, PublicKeyFormat.valueOf, PublicKeyFormat.values)
    ..aOS(2, 'key')
    ..hasRequiredFields = false
  ;

  PublicKeyCredential() : super();
  PublicKeyCredential.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  PublicKeyCredential.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  PublicKeyCredential clone() => PublicKeyCredential()..mergeFromMessage(this);
  PublicKeyCredential copyWith(void Function(PublicKeyCredential) updates) => super.copyWith((message) => updates(message as PublicKeyCredential));
  $pb.BuilderInfo get info_ => _i;
  ...
  static PublicKeyCredential getDefault() => _defaultInstance ??= create()..freeze();
...
class DeviceConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('DeviceConfig', package: const $pb.PackageName('google.cloud.iot.v1'))
    ..aInt64(1, 'version')
    ..a<$0.Timestamp>(2, 'cloudUpdateTime', $pb.PbFieldType.OM, $0.Timestamp.getDefault, $0.Timestamp.create)
    ..a<$0.Timestamp>(3, 'deviceAckTime', $pb.PbFieldType.OM, $0.Timestamp.getDefault, $0.Timestamp.create)
    ..a<$core.List<$core.int>>(4, 'binaryData', $pb.PbFieldType.OY)
    ..hasRequiredFields = false
  ;

  DeviceConfig() : super();
  DeviceConfig.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  DeviceConfig.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
...
class DeviceState extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('DeviceState', package: const $pb.PackageName('google.cloud.iot.v1'))
  ...
  DeviceState() : super();
  DeviceState.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  DeviceState.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  DeviceState clone() => DeviceState()..mergeFromMessage(this);
  DeviceState copyWith(void Function(DeviceState) updates) => super.copyWith((message) => updates(message as DeviceState));
  $pb.BuilderInfo get info_ => _i;
