...
class HttpTarget extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('HttpTarget', package: const $pb.PackageName('google.cloud.scheduler.v1beta1'))
    ..aOS(1, 'uri')
    ..e<HttpMethod>(2, 'httpMethod', $pb.PbFieldType.OE, HttpMethod.HTTP_METHOD_UNSPECIFIED, HttpMethod.valueOf, HttpMethod.values)
    ..m<$core.String, $core.String>(3, 'headers', 'HttpTarget.HeadersEntry',$pb.PbFieldType.OS, $pb.PbFieldType.OS, null, null, null , const $pb.PackageName('google.cloud.scheduler.v1beta1'))
...
class AppEngineHttpTarget extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('AppEngineHttpTarget', package: const $pb.PackageName('google.cloud.scheduler.v1beta1'))
    ...
    ..aOS(3, 'relativeUri')
    ..m<$core.String, $core.String>(4, 'headers', 'AppEngineHttpTarget.HeadersEntry',$pb.PbFieldType.OS, $pb.PbFieldType.OS, null, null, null , const $pb.PackageName('google.cloud.scheduler.v1beta1'))
...
class PubsubTarget extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('PubsubTarget', package: const $pb.PackageName('google.cloud.scheduler.v1beta1'))
    ..aOS(1, 'topicName')
    ..a<$core.List<$core.int>>(3, 'data', $pb.PbFieldType.OY)
    ..m<$core.String, $core.String>(4, 'attributes', 'PubsubTarget.AttributesEntry',$pb.PbFieldType.OS, $pb.PbFieldType.OS, null, null, null , const $pb.PackageName('google.cloud.scheduler.v1beta1'))
    ..hasRequiredFields = false
  ;
...
class AppEngineRouting extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('AppEngineRouting', package: const $pb.PackageName('google.cloud.scheduler.v1beta1'))
    ..aOS(1, 'service')
    ..aOS(2, 'version')
    ..aOS(3, 'instance')
    ..aOS(4, 'host')
...
class OAuthToken extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('OAuthToken', package: const $pb.PackageName('google.cloud.scheduler.v1beta1'))
...
class OidcToken extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('OidcToken', package: const $pb.PackageName('google.cloud.scheduler.v1beta1'))
    ..aOS(1, 'serviceAccountEmail')
    ..aOS(2, 'audience')
    ..hasRequiredFields = false
  ;
