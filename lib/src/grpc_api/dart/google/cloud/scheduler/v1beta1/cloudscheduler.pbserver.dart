...
abstract class CloudSchedulerServiceBase extends $pb.GeneratedService {
  ...
  $async.Future<$2.Empty> deleteJob($pb.ServerContext ctx, DeleteJobRequest request);
  $async.Future<$0.Job> pauseJob($pb.ServerContext ctx, PauseJobRequest request);
  $async.Future<$0.Job> resumeJob($pb.ServerContext ctx, ResumeJobRequest request);
  ...
  $pb.GeneratedMessage createRequest($core.String method) {
    switch (method) {
      ...
      case 'PauseJob': return PauseJobRequest();
      case 'ResumeJob': return ResumeJobRequest();
      case 'RunJob': return RunJobRequest();
  ...
  $async.Future<$pb.GeneratedMessage> handleCall($pb.ServerContext ctx, $core.String method, $pb.GeneratedMessage request) {
    switch (method) {
      ...
      case 'PauseJob': return this.pauseJob(ctx, request);
      case 'ResumeJob': return this.resumeJob(ctx, request);
      case 'RunJob': return this.runJob(ctx, request);
      default: throw $core.ArgumentError('Unknown method: $method');
    }
  }

  $core.Map<$core.String, $core.dynamic> get $json => CloudSchedulerServiceBase$json;
  $core.Map<$core.String, $core.Map<$core.String, $core.dynamic>> get $messageJson => CloudSchedulerServiceBase$messageJson;
}
