...
class Job extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Job',
    ...
    ..a<$0.PubsubTarget>(4, 'pubsubTarget', $pb.PbFieldType.OM,
        $0.PubsubTarget.getDefault, $0.PubsubTarget.create)
    ..a<$0.AppEngineHttpTarget>(5, 'appEngineHttpTarget', $pb.PbFieldType.OM,
        $0.AppEngineHttpTarget.getDefault, $0.AppEngineHttpTarget.create)
    ..a<$0.HttpTarget>(6, 'httpTarget', $pb.PbFieldType.OM,
        $0.HttpTarget.getDefault, $0.HttpTarget.create)
    ..a<$1.Timestamp>(9, 'userUpdateTime', $pb.PbFieldType.OM,
        $1.Timestamp.getDefault, $1.Timestamp.create)
    ..e<Job_State>(10, 'state', $pb.PbFieldType.OE, Job_State.STATE_UNSPECIFIED,
        Job_State.valueOf, Job_State.values)
    ..a<$2.Status>(11, 'status', $pb.PbFieldType.OM, $2.Status.getDefault,
        $2.Status.create)
    ..a<$1.Timestamp>(17, 'scheduleTime', $pb.PbFieldType.OM,
        $1.Timestamp.getDefault, $1.Timestamp.create)
    ..a<$1.Timestamp>(18, 'lastAttemptTime', $pb.PbFieldType.OM,
        $1.Timestamp.getDefault, $1.Timestamp.create)
    ..a<RetryConfig>(19, 'retryConfig', $pb.PbFieldType.OM,
...
class RetryConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('RetryConfig',
    ...
    ..a<$3.Duration>(2, 'maxRetryDuration', $pb.PbFieldType.OM,
        $3.Duration.getDefault, $3.Duration.create)
    ..a<$3.Duration>(3, 'minBackoffDuration', $pb.PbFieldType.OM,
        $3.Duration.getDefault, $3.Duration.create)
    ..a<$3.Duration>(4, 'maxBackoffDuration', $pb.PbFieldType.OM,
        $3.Duration.getDefault, $3.Duration.create)
