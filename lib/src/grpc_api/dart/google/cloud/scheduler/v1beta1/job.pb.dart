...
class Job extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Job', package: const $pb.PackageName('google.cloud.scheduler.v1beta1'))
    ..aOS(1, 'name')
    ..aOS(2, 'description')
...
class RetryConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('RetryConfig', package: const $pb.PackageName('google.cloud.scheduler.v1beta1'))
