...
class ListJobsRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ListJobsRequest', package: const $pb.PackageName('google.cloud.scheduler.v1beta1'))
    ..aOS(1, 'parent')
...
class ListJobsResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ListJobsResponse', package: const $pb.PackageName('google.cloud.scheduler.v1beta1'))
...
class GetJobRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('GetJobRequest', package: const $pb.PackageName('google.cloud.scheduler.v1beta1'))
    ..aOS(1, 'name')
    ..hasRequiredFields = false
  ;
...
class CreateJobRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('CreateJobRequest', package: const $pb.PackageName('google.cloud.scheduler.v1beta1'))
    ..aOS(1, 'parent')
...
class UpdateJobRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('UpdateJobRequest', package: const $pb.PackageName('google.cloud.scheduler.v1beta1'))
...
class DeleteJobRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('DeleteJobRequest', package: const $pb.PackageName('google.cloud.scheduler.v1beta1'))
    ..aOS(1, 'name')
    ..hasRequiredFields = false
  ;
...
class PauseJobRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('PauseJobRequest', package: const $pb.PackageName('google.cloud.scheduler.v1beta1'))
    ..aOS(1, 'name')
    ..hasRequiredFields = false
  ;

  PauseJobRequest() : super();
  PauseJobRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  PauseJobRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  PauseJobRequest clone() => PauseJobRequest()..mergeFromMessage(this);
  PauseJobRequest copyWith(void Function(PauseJobRequest) updates) => super.copyWith((message) => updates(message as PauseJobRequest));
  $pb.BuilderInfo get info_ => _i;
  ...
  static PauseJobRequest getDefault() => _defaultInstance ??= create()..freeze();
...
class ResumeJobRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ResumeJobRequest', package: const $pb.PackageName('google.cloud.scheduler.v1beta1'))
    ..aOS(1, 'name')
    ..hasRequiredFields = false
  ;

  ResumeJobRequest() : super();
  ResumeJobRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  ResumeJobRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ResumeJobRequest clone() => ResumeJobRequest()..mergeFromMessage(this);
  ResumeJobRequest copyWith(void Function(ResumeJobRequest) updates) => super.copyWith((message) => updates(message as ResumeJobRequest));
  $pb.BuilderInfo get info_ => _i;
  ...
  static ResumeJobRequest getDefault() => _defaultInstance ??= create()..freeze();
...
class RunJobRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('RunJobRequest', package: const $pb.PackageName('google.cloud.scheduler.v1beta1'))
    ..aOS(1, 'name')
    ..hasRequiredFields = false
  ;

  RunJobRequest() : super();
  RunJobRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  RunJobRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  RunJobRequest clone() => RunJobRequest()..mergeFromMessage(this);
  RunJobRequest copyWith(void Function(RunJobRequest) updates) => super.copyWith((message) => updates(message as RunJobRequest));
  $pb.BuilderInfo get info_ => _i;
...
class CloudSchedulerApi {
  ...
  $async.Future<ListJobsResponse> listJobs($pb.ClientContext ctx, ListJobsRequest request) {
    ...
    return _client.invoke<ListJobsResponse>(ctx, 'CloudScheduler', 'ListJobs', request, emptyResponse);
  }
  $async.Future<$0.Job> getJob($pb.ClientContext ctx, GetJobRequest request) {
    var emptyResponse = $0.Job();
    return _client.invoke<$0.Job>(ctx, 'CloudScheduler', 'GetJob', request, emptyResponse);
  }
  $async.Future<$0.Job> createJob($pb.ClientContext ctx, CreateJobRequest request) {
    var emptyResponse = $0.Job();
    return _client.invoke<$0.Job>(ctx, 'CloudScheduler', 'CreateJob', request, emptyResponse);
  }
  $async.Future<$0.Job> updateJob($pb.ClientContext ctx, UpdateJobRequest request) {
    var emptyResponse = $0.Job();
    return _client.invoke<$0.Job>(ctx, 'CloudScheduler', 'UpdateJob', request, emptyResponse);
  }
  $async.Future<$2.Empty> deleteJob($pb.ClientContext ctx, DeleteJobRequest request) {
    var emptyResponse = $2.Empty();
    return _client.invoke<$2.Empty>(ctx, 'CloudScheduler', 'DeleteJob', request, emptyResponse);
  }
  $async.Future<$0.Job> pauseJob($pb.ClientContext ctx, PauseJobRequest request) {
    var emptyResponse = $0.Job();
    return _client.invoke<$0.Job>(ctx, 'CloudScheduler', 'PauseJob', request, emptyResponse);
  }
  $async.Future<$0.Job> resumeJob($pb.ClientContext ctx, ResumeJobRequest request) {
    var emptyResponse = $0.Job();
    return _client.invoke<$0.Job>(ctx, 'CloudScheduler', 'ResumeJob', request, emptyResponse);
  }
  $async.Future<$0.Job> runJob($pb.ClientContext ctx, RunJobRequest request) {
    var emptyResponse = $0.Job();
    return _client.invoke<$0.Job>(ctx, 'CloudScheduler', 'RunJob', request, emptyResponse);
  }
}
