...
const CreateJobRequest$json = const {
  ...
  '2': const [
    const {'1': 'parent', '3': 1, '4': 1, '5': 9, '10': 'parent'},
    const {'1': 'job', '3': 2, '4': 1, '5': 11, '6': '.google.cloud.scheduler.v1.Job', '10': 'job'},
  ],
};
...
const UpdateJobRequest$json = const {
  '1': 'UpdateJobRequest',
  '2': const [
    const {'1': 'job', '3': 1, '4': 1, '5': 11, '6': '.google.cloud.scheduler.v1.Job', '10': 'job'},
...
const CloudSchedulerServiceBase$json = const {
  '1': 'CloudScheduler',
  '2': const [
    const {'1': 'ListJobs', '2': '.google.cloud.scheduler.v1.ListJobsRequest', '3': '.google.cloud.scheduler.v1.ListJobsResponse', '4': const {}},
    const {'1': 'GetJob', '2': '.google.cloud.scheduler.v1.GetJobRequest', '3': '.google.cloud.scheduler.v1.Job', '4': const {}},
    const {'1': 'CreateJob', '2': '.google.cloud.scheduler.v1.CreateJobRequest', '3': '.google.cloud.scheduler.v1.Job', '4': const {}},
    const {'1': 'UpdateJob', '2': '.google.cloud.scheduler.v1.UpdateJobRequest', '3': '.google.cloud.scheduler.v1.Job', '4': const {}},
    const {'1': 'DeleteJob', '2': '.google.cloud.scheduler.v1.DeleteJobRequest', '3': '.google.protobuf.Empty', '4': const {}},
    const {'1': 'PauseJob', '2': '.google.cloud.scheduler.v1.PauseJobRequest', '3': '.google.cloud.scheduler.v1.Job', '4': const {}},
    const {'1': 'ResumeJob', '2': '.google.cloud.scheduler.v1.ResumeJobRequest', '3': '.google.cloud.scheduler.v1.Job', '4': const {}},
    const {'1': 'RunJob', '2': '.google.cloud.scheduler.v1.RunJobRequest', '3': '.google.cloud.scheduler.v1.Job', '4': const {}},
  ],
};
...
const CloudSchedulerServiceBase$messageJson = const {
  ...
  '.google.cloud.scheduler.v1.PubsubTarget.AttributesEntry': $3.PubsubTarget_AttributesEntry$json,
  ...
  '.google.cloud.scheduler.v1.AppEngineHttpTarget.HeadersEntry': $3.AppEngineHttpTarget_HeadersEntry$json,
  '.google.cloud.scheduler.v1.HttpTarget': $3.HttpTarget$json,
  '.google.cloud.scheduler.v1.HttpTarget.HeadersEntry': $3.HttpTarget_HeadersEntry$json,
