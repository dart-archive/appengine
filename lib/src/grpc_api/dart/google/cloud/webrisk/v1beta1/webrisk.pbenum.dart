...
class ThreatType extends $pb.ProtobufEnum {
  static const ThreatType THREAT_TYPE_UNSPECIFIED = ThreatType._(0, 'THREAT_TYPE_UNSPECIFIED');
  static const ThreatType MALWARE = ThreatType._(1, 'MALWARE');
  static const ThreatType SOCIAL_ENGINEERING = ThreatType._(2, 'SOCIAL_ENGINEERING');
  static const ThreatType UNWANTED_SOFTWARE = ThreatType._(3, 'UNWANTED_SOFTWARE');
...
class CompressionType extends $pb.ProtobufEnum {
  static const CompressionType COMPRESSION_TYPE_UNSPECIFIED = CompressionType._(0, 'COMPRESSION_TYPE_UNSPECIFIED');
...
class ComputeThreatListDiffResponse_ResponseType extends $pb.ProtobufEnum {
  static const ComputeThreatListDiffResponse_ResponseType RESPONSE_TYPE_UNSPECIFIED = ComputeThreatListDiffResponse_ResponseType._(0, 'RESPONSE_TYPE_UNSPECIFIED');
  static const ComputeThreatListDiffResponse_ResponseType DIFF = ComputeThreatListDiffResponse_ResponseType._(1, 'DIFF');
  static const ComputeThreatListDiffResponse_ResponseType RESET = ComputeThreatListDiffResponse_ResponseType._(2, 'RESET');
