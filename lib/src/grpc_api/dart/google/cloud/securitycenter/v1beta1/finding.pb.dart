...
class Finding extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Finding', package: const $pb.PackageName('google.cloud.securitycenter.v1beta1'))
    ..aOS(1, 'name')
    ..aOS(2, 'parent')
    ..aOS(3, 'resourceName')
    ..e<Finding_State>(4, 'state', $pb.PbFieldType.OE, Finding_State.STATE_UNSPECIFIED, Finding_State.valueOf, Finding_State.values)
    ..aOS(5, 'category')
    ..aOS(6, 'externalUri')
    ..m<$core.String, $2.Value>(7, 'sourceProperties', 'Finding.SourcePropertiesEntry',$pb.PbFieldType.OS, $pb.PbFieldType.OM, $2.Value.create, null, null , const $pb.PackageName('google.cloud.securitycenter.v1beta1'))
    ..a<$0.SecurityMarks>(8, 'securityMarks', $pb.PbFieldType.OM, $0.SecurityMarks.getDefault, $0.SecurityMarks.create)
    ..a<$1.Timestamp>(9, 'eventTime', $pb.PbFieldType.OM, $1.Timestamp.getDefault, $1.Timestamp.create)
    ..a<$1.Timestamp>(10, 'createTime', $pb.PbFieldType.OM, $1.Timestamp.getDefault, $1.Timestamp.create)
