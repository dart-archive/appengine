...
class Asset_SecurityCenterProperties extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Asset.SecurityCenterProperties', package: const $pb.PackageName('google.cloud.securitycenter.v1beta1'))
    ..aOS(1, 'resourceName')
    ..aOS(2, 'resourceType')
...
class Asset extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Asset', package: const $pb.PackageName('google.cloud.securitycenter.v1beta1'))
    ..aOS(1, 'name')
    ...
    ..m<$core.String, $2.Value>(7, 'resourceProperties', 'Asset.ResourcePropertiesEntry',$pb.PbFieldType.OS, $pb.PbFieldType.OM, $2.Value.create, null, null , const $pb.PackageName('google.cloud.securitycenter.v1beta1'))
