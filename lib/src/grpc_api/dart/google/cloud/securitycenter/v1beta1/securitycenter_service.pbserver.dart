...
abstract class SecurityCenterServiceBase extends $pb.GeneratedService {
  $async.Future<$1.Source> createSource(
      $pb.ServerContext ctx, CreateSourceRequest request);
  $async.Future<$0.Finding> createFinding(
      $pb.ServerContext ctx, CreateFindingRequest request);
  ...
  $async.Future<$7.OrganizationSettings> getOrganizationSettings(
      $pb.ServerContext ctx, GetOrganizationSettingsRequest request);
  $async.Future<$1.Source> getSource(
      $pb.ServerContext ctx, GetSourceRequest request);
  $async.Future<GroupAssetsResponse> groupAssets(
      $pb.ServerContext ctx, GroupAssetsRequest request);
  $async.Future<GroupFindingsResponse> groupFindings(
      $pb.ServerContext ctx, GroupFindingsRequest request);
  $async.Future<ListAssetsResponse> listAssets(
      $pb.ServerContext ctx, ListAssetsRequest request);
  ...
  $async.Future<ListSourcesResponse> listSources(
      $pb.ServerContext ctx, ListSourcesRequest request);
  $async.Future<$11.Operation> runAssetDiscovery(
      $pb.ServerContext ctx, RunAssetDiscoveryRequest request);
  $async.Future<$0.Finding> setFindingState(
      $pb.ServerContext ctx, SetFindingStateRequest request);
  ...
  $async.Future<$0.Finding> updateFinding(
      $pb.ServerContext ctx, UpdateFindingRequest request);
  $async.Future<$7.OrganizationSettings> updateOrganizationSettings(
      $pb.ServerContext ctx, UpdateOrganizationSettingsRequest request);
  $async.Future<$1.Source> updateSource(
      $pb.ServerContext ctx, UpdateSourceRequest request);
  $async.Future<$8.SecurityMarks> updateSecurityMarks(
      $pb.ServerContext ctx, UpdateSecurityMarksRequest request);
  ...
  $async.Future<$pb.GeneratedMessage> handleCall($pb.ServerContext ctx,
    ...
    switch (method) {
      case 'CreateSource':
        return this.createSource(ctx, request);
      case 'CreateFinding':
        return this.createFinding(ctx, request);
      case 'GetIamPolicy':
        return this.getIamPolicy(ctx, request);
      case 'GetOrganizationSettings':
        return this.getOrganizationSettings(ctx, request);
      case 'GetSource':
        return this.getSource(ctx, request);
      case 'GroupAssets':
        return this.groupAssets(ctx, request);
      case 'GroupFindings':
        return this.groupFindings(ctx, request);
      case 'ListAssets':
        return this.listAssets(ctx, request);
      case 'ListFindings':
        return this.listFindings(ctx, request);
      case 'ListSources':
        return this.listSources(ctx, request);
      case 'RunAssetDiscovery':
        return this.runAssetDiscovery(ctx, request);
      case 'SetFindingState':
        return this.setFindingState(ctx, request);
      case 'SetIamPolicy':
        return this.setIamPolicy(ctx, request);
      case 'TestIamPermissions':
        return this.testIamPermissions(ctx, request);
      case 'UpdateFinding':
        return this.updateFinding(ctx, request);
      case 'UpdateOrganizationSettings':
        return this.updateOrganizationSettings(ctx, request);
      case 'UpdateSource':
        return this.updateSource(ctx, request);
      case 'UpdateSecurityMarks':
        return this.updateSecurityMarks(ctx, request);
      default:
        throw $core.ArgumentError('Unknown method: $method');
    }
  }
  ...
  $core.Map<$core.String, $core.dynamic> get $json =>
      SecurityCenterServiceBase$json;
  $core.Map<$core.String, $core.Map<$core.String, $core.dynamic>>
      get $messageJson => SecurityCenterServiceBase$messageJson;
}
