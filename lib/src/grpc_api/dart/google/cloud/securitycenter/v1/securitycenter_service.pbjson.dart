...
const CreateFindingRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'finding', '3': 3, '4': 1, '5': 11, '6': '.google.cloud.securitycenter.v1.Finding', '10': 'finding'},
  ],
};
...
const CreateSourceRequest$json = const {
  ...
  '2': const [
    const {'1': 'parent', '3': 1, '4': 1, '5': 9, '10': 'parent'},
    const {'1': 'source', '3': 2, '4': 1, '5': 11, '6': '.google.cloud.securitycenter.v1.Source', '10': 'source'},
  ],
};
...
const SetFindingStateRequest$json = const {
  ...
  '2': const [
    const {'1': 'name', '3': 1, '4': 1, '5': 9, '10': 'name'},
    const {'1': 'state', '3': 2, '4': 1, '5': 14, '6': '.google.cloud.securitycenter.v1.Finding.State', '10': 'state'},
...
const UpdateOrganizationSettingsRequest$json = const {
  ...
  '2': const [
    const {'1': 'organization_settings', '3': 1, '4': 1, '5': 11, '6': '.google.cloud.securitycenter.v1.OrganizationSettings', '10': 'organizationSettings'},
    const {'1': 'update_mask', '3': 2, '4': 1, '5': 11, '6': '.google.protobuf.FieldMask', '10': 'updateMask'},
  ],
};
...
const UpdateSourceRequest$json = const {
  ...
  '2': const [
    const {'1': 'source', '3': 1, '4': 1, '5': 11, '6': '.google.cloud.securitycenter.v1.Source', '10': 'source'},
    const {'1': 'update_mask', '3': 2, '4': 1, '5': 11, '6': '.google.protobuf.FieldMask', '10': 'updateMask'},
  ],
};
...
const UpdateSecurityMarksRequest$json = const {
  ...
  '2': const [
    const {'1': 'security_marks', '3': 1, '4': 1, '5': 11, '6': '.google.cloud.securitycenter.v1.SecurityMarks', '10': 'securityMarks'},
    const {'1': 'update_mask', '3': 2, '4': 1, '5': 11, '6': '.google.protobuf.FieldMask', '10': 'updateMask'},
    const {'1': 'start_time', '3': 3, '4': 1, '5': 11, '6': '.google.protobuf.Timestamp', '10': 'startTime'},
  ],
};
...
const SecurityCenterServiceBase$json = const {
  '1': 'SecurityCenter',
  '2': const [
    const {'1': 'CreateSource', '2': '.google.cloud.securitycenter.v1.CreateSourceRequest', '3': '.google.cloud.securitycenter.v1.Source', '4': const {}},
    const {'1': 'CreateFinding', '2': '.google.cloud.securitycenter.v1.CreateFindingRequest', '3': '.google.cloud.securitycenter.v1.Finding', '4': const {}},
    const {'1': 'GetIamPolicy', '2': '.google.iam.v1.GetIamPolicyRequest', '3': '.google.iam.v1.Policy', '4': const {}},
    const {'1': 'GetOrganizationSettings', '2': '.google.cloud.securitycenter.v1.GetOrganizationSettingsRequest', '3': '.google.cloud.securitycenter.v1.OrganizationSettings', '4': const {}},
    const {'1': 'GetSource', '2': '.google.cloud.securitycenter.v1.GetSourceRequest', '3': '.google.cloud.securitycenter.v1.Source', '4': const {}},
    const {'1': 'GroupAssets', '2': '.google.cloud.securitycenter.v1.GroupAssetsRequest', '3': '.google.cloud.securitycenter.v1.GroupAssetsResponse', '4': const {}},
    const {'1': 'GroupFindings', '2': '.google.cloud.securitycenter.v1.GroupFindingsRequest', '3': '.google.cloud.securitycenter.v1.GroupFindingsResponse', '4': const {}},
    const {'1': 'ListAssets', '2': '.google.cloud.securitycenter.v1.ListAssetsRequest', '3': '.google.cloud.securitycenter.v1.ListAssetsResponse', '4': const {}},
    const {'1': 'ListFindings', '2': '.google.cloud.securitycenter.v1.ListFindingsRequest', '3': '.google.cloud.securitycenter.v1.ListFindingsResponse', '4': const {}},
    const {'1': 'ListSources', '2': '.google.cloud.securitycenter.v1.ListSourcesRequest', '3': '.google.cloud.securitycenter.v1.ListSourcesResponse', '4': const {}},
    const {'1': 'RunAssetDiscovery', '2': '.google.cloud.securitycenter.v1.RunAssetDiscoveryRequest', '3': '.google.longrunning.Operation', '4': const {}},
    const {'1': 'SetFindingState', '2': '.google.cloud.securitycenter.v1.SetFindingStateRequest', '3': '.google.cloud.securitycenter.v1.Finding', '4': const {}},
    ...
    const {'1': 'UpdateFinding', '2': '.google.cloud.securitycenter.v1.UpdateFindingRequest', '3': '.google.cloud.securitycenter.v1.Finding', '4': const {}},
    const {'1': 'UpdateOrganizationSettings', '2': '.google.cloud.securitycenter.v1.UpdateOrganizationSettingsRequest', '3': '.google.cloud.securitycenter.v1.OrganizationSettings', '4': const {}},
    const {'1': 'UpdateSource', '2': '.google.cloud.securitycenter.v1.UpdateSourceRequest', '3': '.google.cloud.securitycenter.v1.Source', '4': const {}},
    const {'1': 'UpdateSecurityMarks', '2': '.google.cloud.securitycenter.v1.UpdateSecurityMarksRequest', '3': '.google.cloud.securitycenter.v1.SecurityMarks', '4': const {}},
  ],
};

const SecurityCenterServiceBase$messageJson = const {
  '.google.cloud.securitycenter.v1.CreateSourceRequest': CreateSourceRequest$json,
  '.google.cloud.securitycenter.v1.Source': $1.Source$json,
  '.google.cloud.securitycenter.v1.CreateFindingRequest': CreateFindingRequest$json,
  '.google.cloud.securitycenter.v1.Finding': $0.Finding$json,
  '.google.cloud.securitycenter.v1.Finding.SourcePropertiesEntry': $0.Finding_SourcePropertiesEntry$json,
  ...
  '.google.cloud.securitycenter.v1.SecurityMarks': $8.SecurityMarks$json,
  '.google.cloud.securitycenter.v1.SecurityMarks.MarksEntry': $8.SecurityMarks_MarksEntry$json,
  ...
  '.google.cloud.securitycenter.v1.GetOrganizationSettingsRequest': GetOrganizationSettingsRequest$json,
  '.google.cloud.securitycenter.v1.OrganizationSettings': $7.OrganizationSettings$json,
  '.google.cloud.securitycenter.v1.OrganizationSettings.AssetDiscoveryConfig': $7.OrganizationSettings_AssetDiscoveryConfig$json,
  '.google.cloud.securitycenter.v1.GetSourceRequest': GetSourceRequest$json,
  '.google.cloud.securitycenter.v1.GroupAssetsRequest': GroupAssetsRequest$json,
  '.google.protobuf.Duration': $2.Duration$json,
  '.google.cloud.securitycenter.v1.GroupAssetsResponse': GroupAssetsResponse$json,
  '.google.cloud.securitycenter.v1.GroupResult': GroupResult$json,
  '.google.cloud.securitycenter.v1.GroupResult.PropertiesEntry': GroupResult_PropertiesEntry$json,
  '.google.cloud.securitycenter.v1.GroupFindingsRequest': GroupFindingsRequest$json,
  '.google.cloud.securitycenter.v1.GroupFindingsResponse': GroupFindingsResponse$json,
  '.google.cloud.securitycenter.v1.ListAssetsRequest': ListAssetsRequest$json,
  '.google.protobuf.FieldMask': $5.FieldMask$json,
  '.google.cloud.securitycenter.v1.ListAssetsResponse': ListAssetsResponse$json,
  '.google.cloud.securitycenter.v1.ListAssetsResponse.ListAssetsResult': ListAssetsResponse_ListAssetsResult$json,
  '.google.cloud.securitycenter.v1.Asset': $6.Asset$json,
  '.google.cloud.securitycenter.v1.Asset.SecurityCenterProperties': $6.Asset_SecurityCenterProperties$json,
  '.google.cloud.securitycenter.v1.Asset.ResourcePropertiesEntry': $6.Asset_ResourcePropertiesEntry$json,
  '.google.cloud.securitycenter.v1.Asset.IamPolicy': $6.Asset_IamPolicy$json,
  '.google.cloud.securitycenter.v1.ListFindingsRequest': ListFindingsRequest$json,
  '.google.cloud.securitycenter.v1.ListFindingsResponse': ListFindingsResponse$json,
  '.google.cloud.securitycenter.v1.ListFindingsResponse.ListFindingsResult': ListFindingsResponse_ListFindingsResult$json,
  '.google.cloud.securitycenter.v1.ListSourcesRequest': ListSourcesRequest$json,
  '.google.cloud.securitycenter.v1.ListSourcesResponse': ListSourcesResponse$json,
  '.google.cloud.securitycenter.v1.RunAssetDiscoveryRequest': RunAssetDiscoveryRequest$json,
  '.google.longrunning.Operation': $11.Operation$json,
  '.google.protobuf.Any': $13.Any$json,
  '.google.rpc.Status': $14.Status$json,
  '.google.cloud.securitycenter.v1.SetFindingStateRequest': SetFindingStateRequest$json,
  ...
  '.google.cloud.securitycenter.v1.UpdateFindingRequest': UpdateFindingRequest$json,
  '.google.cloud.securitycenter.v1.UpdateOrganizationSettingsRequest': UpdateOrganizationSettingsRequest$json,
  '.google.cloud.securitycenter.v1.UpdateSourceRequest': UpdateSourceRequest$json,
  '.google.cloud.securitycenter.v1.UpdateSecurityMarksRequest': UpdateSecurityMarksRequest$json,
};
