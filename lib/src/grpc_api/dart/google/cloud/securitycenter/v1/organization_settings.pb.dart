...
class OrganizationSettings_AssetDiscoveryConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('OrganizationSettings.AssetDiscoveryConfig', package: const $pb.PackageName('google.cloud.securitycenter.v1'))
    ..pPS(1, 'projectIds')
...
class OrganizationSettings extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('OrganizationSettings', package: const $pb.PackageName('google.cloud.securitycenter.v1'))
    ..aOS(1, 'name')
