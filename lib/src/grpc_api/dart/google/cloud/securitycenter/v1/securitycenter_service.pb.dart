...
class CreateFindingRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('CreateFindingRequest', package: const $pb.PackageName('google.cloud.securitycenter.v1'))
    ..aOS(1, 'parent')
    ..aOS(2, 'findingId')
...
class CreateSourceRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('CreateSourceRequest', package: const $pb.PackageName('google.cloud.securitycenter.v1'))
    ..aOS(1, 'parent')
...
class GetOrganizationSettingsRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('GetOrganizationSettingsRequest', package: const $pb.PackageName('google.cloud.securitycenter.v1'))
    ..aOS(1, 'name')
    ..hasRequiredFields = false
  ;
...
class GetSourceRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('GetSourceRequest', package: const $pb.PackageName('google.cloud.securitycenter.v1'))
    ..aOS(1, 'name')
    ..hasRequiredFields = false
  ;
...
class GroupAssetsRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('GroupAssetsRequest', package: const $pb.PackageName('google.cloud.securitycenter.v1'))
    ..aOS(1, 'parent')
    ..aOS(2, 'filter')
    ..aOS(3, 'groupBy')
...
class GroupAssetsResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('GroupAssetsResponse', package: const $pb.PackageName('google.cloud.securitycenter.v1'))
...
class GroupFindingsRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('GroupFindingsRequest', package: const $pb.PackageName('google.cloud.securitycenter.v1'))
    ..aOS(1, 'parent')
    ..aOS(2, 'filter')
    ..aOS(3, 'groupBy')
...
class GroupFindingsResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('GroupFindingsResponse', package: const $pb.PackageName('google.cloud.securitycenter.v1'))
    ..pc<GroupResult>(1, 'groupByResults', $pb.PbFieldType.PM,GroupResult.create)
    ..a<$3.Timestamp>(2, 'readTime', $pb.PbFieldType.OM, $3.Timestamp.getDefault, $3.Timestamp.create)
    ..aOS(3, 'nextPageToken')
    ..a<$core.int>(4, 'totalSize', $pb.PbFieldType.O3)
...
class GroupResult extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('GroupResult', package: const $pb.PackageName('google.cloud.securitycenter.v1'))
    ..m<$core.String, $4.Value>(1, 'properties', 'GroupResult.PropertiesEntry',$pb.PbFieldType.OS, $pb.PbFieldType.OM, $4.Value.create, null, null , const $pb.PackageName('google.cloud.securitycenter.v1'))
    ..aInt64(2, 'count')
    ..hasRequiredFields = false
  ;
...
class ListSourcesRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ListSourcesRequest', package: const $pb.PackageName('google.cloud.securitycenter.v1'))
    ..aOS(1, 'parent')
    ..aOS(2, 'pageToken')
...
class ListSourcesResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ListSourcesResponse', package: const $pb.PackageName('google.cloud.securitycenter.v1'))
...
class ListAssetsRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ListAssetsRequest', package: const $pb.PackageName('google.cloud.securitycenter.v1'))
    ..aOS(1, 'parent')
    ..aOS(2, 'filter')
    ..aOS(3, 'orderBy')
    ..a<$3.Timestamp>(4, 'readTime', $pb.PbFieldType.OM, $3.Timestamp.getDefault, $3.Timestamp.create)
...
class ListAssetsResponse_ListAssetsResult extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ListAssetsResponse.ListAssetsResult', package: const $pb.PackageName('google.cloud.securitycenter.v1'))
    ..a<$6.Asset>(1, 'asset', $pb.PbFieldType.OM, $6.Asset.getDefault, $6.Asset.create)
    ..e<ListAssetsResponse_ListAssetsResult_StateChange>(2, 'stateChange', $pb.PbFieldType.OE, ListAssetsResponse_ListAssetsResult_StateChange.UNUSED, ListAssetsResponse_ListAssetsResult_StateChange.valueOf, ListAssetsResponse_ListAssetsResult_StateChange.values)
    ..hasRequiredFields = false
  ;
...
class ListAssetsResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ListAssetsResponse', package: const $pb.PackageName('google.cloud.securitycenter.v1'))
...
class ListFindingsRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ListFindingsRequest', package: const $pb.PackageName('google.cloud.securitycenter.v1'))
    ..aOS(1, 'parent')
    ..aOS(2, 'filter')
    ..aOS(3, 'orderBy')
    ..a<$3.Timestamp>(4, 'readTime', $pb.PbFieldType.OM, $3.Timestamp.getDefault, $3.Timestamp.create)
...
class ListFindingsResponse_ListFindingsResult extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ListFindingsResponse.ListFindingsResult', package: const $pb.PackageName('google.cloud.securitycenter.v1'))
    ..a<$0.Finding>(1, 'finding', $pb.PbFieldType.OM, $0.Finding.getDefault, $0.Finding.create)
    ..e<ListFindingsResponse_ListFindingsResult_StateChange>(2, 'stateChange', $pb.PbFieldType.OE, ListFindingsResponse_ListFindingsResult_StateChange.UNUSED, ListFindingsResponse_ListFindingsResult_StateChange.valueOf, ListFindingsResponse_ListFindingsResult_StateChange.values)
    ..hasRequiredFields = false
  ;

  ListFindingsResponse_ListFindingsResult() : super();
  ListFindingsResponse_ListFindingsResult.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  ListFindingsResponse_ListFindingsResult.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ListFindingsResponse_ListFindingsResult clone() => ListFindingsResponse_ListFindingsResult()..mergeFromMessage(this);
  ListFindingsResponse_ListFindingsResult copyWith(void Function(ListFindingsResponse_ListFindingsResult) updates) => super.copyWith((message) => updates(message as ListFindingsResponse_ListFindingsResult));
  $pb.BuilderInfo get info_ => _i;
  static ListFindingsResponse_ListFindingsResult create() => ListFindingsResponse_ListFindingsResult();
  ...
  static ListFindingsResponse_ListFindingsResult getDefault() => _defaultInstance ??= create()..freeze();
...
class ListFindingsResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ListFindingsResponse', package: const $pb.PackageName('google.cloud.securitycenter.v1'))
    ..pc<ListFindingsResponse_ListFindingsResult>(1, 'listFindingsResults', $pb.PbFieldType.PM,ListFindingsResponse_ListFindingsResult.create)
    ..a<$3.Timestamp>(2, 'readTime', $pb.PbFieldType.OM, $3.Timestamp.getDefault, $3.Timestamp.create)
    ..aOS(3, 'nextPageToken')
    ..a<$core.int>(4, 'totalSize', $pb.PbFieldType.O3)
    ..hasRequiredFields = false
...
class SetFindingStateRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('SetFindingStateRequest', package: const $pb.PackageName('google.cloud.securitycenter.v1'))
    ..aOS(1, 'name')
...
class RunAssetDiscoveryRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('RunAssetDiscoveryRequest', package: const $pb.PackageName('google.cloud.securitycenter.v1'))
    ..aOS(1, 'parent')
    ..hasRequiredFields = false
  ;
...
class UpdateFindingRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('UpdateFindingRequest', package: const $pb.PackageName('google.cloud.securitycenter.v1'))
    ..a<$0.Finding>(1, 'finding', $pb.PbFieldType.OM, $0.Finding.getDefault, $0.Finding.create)
...
class UpdateOrganizationSettingsRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('UpdateOrganizationSettingsRequest', package: const $pb.PackageName('google.cloud.securitycenter.v1'))
...
class UpdateSourceRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('UpdateSourceRequest', package: const $pb.PackageName('google.cloud.securitycenter.v1'))
...
class UpdateSecurityMarksRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('UpdateSecurityMarksRequest', package: const $pb.PackageName('google.cloud.securitycenter.v1'))
