...
class Asset_SecurityCenterProperties extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Asset.SecurityCenterProperties', package: const $pb.PackageName('google.cloud.securitycenter.v1'))
    ..aOS(1, 'resourceName')
    ..aOS(2, 'resourceType')
  ...
  Asset_SecurityCenterProperties.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  Asset_SecurityCenterProperties.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  Asset_SecurityCenterProperties clone() => Asset_SecurityCenterProperties()..mergeFromMessage(this);
  Asset_SecurityCenterProperties copyWith(void Function(Asset_SecurityCenterProperties) updates) => super.copyWith((message) => updates(message as Asset_SecurityCenterProperties));
  $pb.BuilderInfo get info_ => _i;
  static Asset_SecurityCenterProperties create() => Asset_SecurityCenterProperties();
  ...
  static Asset_SecurityCenterProperties getDefault() => _defaultInstance ??= create()..freeze();
...
class Asset_IamPolicy extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Asset.IamPolicy', package: const $pb.PackageName('google.cloud.securitycenter.v1'))
    ..aOS(1, 'policyBlob')
    ..hasRequiredFields = false
  ;

  Asset_IamPolicy() : super();
  Asset_IamPolicy.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  Asset_IamPolicy.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  Asset_IamPolicy clone() => Asset_IamPolicy()..mergeFromMessage(this);
  Asset_IamPolicy copyWith(void Function(Asset_IamPolicy) updates) => super.copyWith((message) => updates(message as Asset_IamPolicy));
  $pb.BuilderInfo get info_ => _i;
  ...
  static Asset_IamPolicy getDefault() => _defaultInstance ??= create()..freeze();
...
class Asset extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Asset', package: const $pb.PackageName('google.cloud.securitycenter.v1'))
    ..aOS(1, 'name')
    ..a<Asset_SecurityCenterProperties>(2, 'securityCenterProperties', $pb.PbFieldType.OM, Asset_SecurityCenterProperties.getDefault, Asset_SecurityCenterProperties.create)
    ..m<$core.String, $2.Value>(7, 'resourceProperties', 'Asset.ResourcePropertiesEntry',$pb.PbFieldType.OS, $pb.PbFieldType.OM, $2.Value.create, null, null , const $pb.PackageName('google.cloud.securitycenter.v1'))
    ..a<$0.SecurityMarks>(8, 'securityMarks', $pb.PbFieldType.OM, $0.SecurityMarks.getDefault, $0.SecurityMarks.create)
    ...
    ..a<Asset_IamPolicy>(11, 'iamPolicy', $pb.PbFieldType.OM, Asset_IamPolicy.getDefault, Asset_IamPolicy.create)
    ..hasRequiredFields = false
  ;
