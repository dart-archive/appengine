...
class RunAssetDiscoveryResponse_State extends $pb.ProtobufEnum {
  static const RunAssetDiscoveryResponse_State STATE_UNSPECIFIED = RunAssetDiscoveryResponse_State._(0, 'STATE_UNSPECIFIED');
  static const RunAssetDiscoveryResponse_State COMPLETED = RunAssetDiscoveryResponse_State._(1, 'COMPLETED');
  static const RunAssetDiscoveryResponse_State SUPERSEDED = RunAssetDiscoveryResponse_State._(2, 'SUPERSEDED');
  static const RunAssetDiscoveryResponse_State TERMINATED = RunAssetDiscoveryResponse_State._(3, 'TERMINATED');
