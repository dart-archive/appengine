...
class Finding extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Finding', package: const $pb.PackageName('google.cloud.securitycenter.v1'))
    ..aOS(1, 'name')
    ..aOS(2, 'parent')
    ..aOS(3, 'resourceName')
    ...
    ..aOS(5, 'category')
    ..aOS(6, 'externalUri')
    ..m<$core.String, $2.Value>(7, 'sourceProperties', 'Finding.SourcePropertiesEntry',$pb.PbFieldType.OS, $pb.PbFieldType.OM, $2.Value.create, null, null , const $pb.PackageName('google.cloud.securitycenter.v1'))
