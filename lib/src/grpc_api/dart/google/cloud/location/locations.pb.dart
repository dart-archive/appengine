...
class ListLocationsRequest extends GeneratedMessage {
  ...
  ListLocationsRequest.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  ListLocationsRequest.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ListLocationsRequest clone() => new ListLocationsRequest()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static ListLocationsRequest create() => new ListLocationsRequest();
  static PbList<ListLocationsRequest> createRepeated() => new PbList<ListLocationsRequest>();
  static ListLocationsRequest getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyListLocationsRequest();
...
class _ReadonlyListLocationsRequest extends ListLocationsRequest with ReadonlyMessageMixin {}

class ListLocationsResponse extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('ListLocationsResponse')
    ..pp<Location>(1, 'locations', PbFieldType.PM, Location.$checkItem, Location.create)
    ..aOS(2, 'nextPageToken')
    ..hasRequiredFields = false
  ;

  ListLocationsResponse() : super();
  ListLocationsResponse.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  ListLocationsResponse.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ListLocationsResponse clone() => new ListLocationsResponse()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static ListLocationsResponse create() => new ListLocationsResponse();
  static PbList<ListLocationsResponse> createRepeated() => new PbList<ListLocationsResponse>();
  static ListLocationsResponse getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyListLocationsResponse();
    return _defaultInstance;
  }
  static ListLocationsResponse _defaultInstance;
  static void $checkItem(ListLocationsResponse v) {
    if (v is! ListLocationsResponse) checkItemFailed(v, 'ListLocationsResponse');
  }
...
class _ReadonlyListLocationsResponse extends ListLocationsResponse with ReadonlyMessageMixin {}
...
class GetLocationRequest extends GeneratedMessage {
  ...
  GetLocationRequest.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  GetLocationRequest.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  GetLocationRequest clone() => new GetLocationRequest()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static GetLocationRequest create() => new GetLocationRequest();
  static PbList<GetLocationRequest> createRepeated() => new PbList<GetLocationRequest>();
  static GetLocationRequest getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyGetLocationRequest();
    return _defaultInstance;
  }
...
class _ReadonlyGetLocationRequest extends GetLocationRequest with ReadonlyMessageMixin {}
...
class Location_LabelsEntry extends GeneratedMessage {
  ...
  Location_LabelsEntry.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  Location_LabelsEntry.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  Location_LabelsEntry clone() => new Location_LabelsEntry()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static Location_LabelsEntry create() => new Location_LabelsEntry();
  static PbList<Location_LabelsEntry> createRepeated() => new PbList<Location_LabelsEntry>();
  static Location_LabelsEntry getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyLocation_LabelsEntry();
    return _defaultInstance;
  }
...
class _ReadonlyLocation_LabelsEntry extends Location_LabelsEntry with ReadonlyMessageMixin {}

class Location extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('Location')
    ..aOS(1, 'name')
    ..pp<Location_LabelsEntry>(2, 'labels', PbFieldType.PM, Location_LabelsEntry.$checkItem, Location_LabelsEntry.create)
    ..a<$google$protobuf.Any>(3, 'metadata', PbFieldType.OM, $google$protobuf.Any.getDefault, $google$protobuf.Any.create)
    ..aOS(4, 'locationId')
    ..aOS(5, 'displayName')
    ..hasRequiredFields = false
  ;
  ...
  set metadata($google$protobuf.Any v) { setField(3, v); }
...
class LocationsApi {
  ...
  Future<ListLocationsResponse> listLocations(ClientContext ctx, ListLocationsRequest request) {
    var emptyResponse = new ListLocationsResponse();
    return _client.invoke<ListLocationsResponse>(ctx, 'Locations', 'ListLocations', request, emptyResponse);
  }
  Future<Location> getLocation(ClientContext ctx, GetLocationRequest request) {
    var emptyResponse = new Location();
    return _client.invoke<Location>(ctx, 'Locations', 'GetLocation', request, emptyResponse);
  }
}
