...
class ListLocationsRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ListLocationsRequest', package: const $pb.PackageName('google.cloud.location'))
    ..aOS(1, 'name')
    ..aOS(2, 'filter')
...
class ListLocationsResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ListLocationsResponse', package: const $pb.PackageName('google.cloud.location'))
...
class GetLocationRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('GetLocationRequest', package: const $pb.PackageName('google.cloud.location'))
    ..aOS(1, 'name')
    ..hasRequiredFields = false
  ;

  GetLocationRequest() : super();
  GetLocationRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  GetLocationRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  GetLocationRequest clone() => GetLocationRequest()..mergeFromMessage(this);
  GetLocationRequest copyWith(void Function(GetLocationRequest) updates) => super.copyWith((message) => updates(message as GetLocationRequest));
  $pb.BuilderInfo get info_ => _i;
  ...
  static GetLocationRequest getDefault() => _defaultInstance ??= create()..freeze();
...
class Location extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Location', package: const $pb.PackageName('google.cloud.location'))
    ..aOS(1, 'name')
    ..m<$core.String, $core.String>(2, 'labels', 'Location.LabelsEntry',$pb.PbFieldType.OS, $pb.PbFieldType.OS, null, null, null , const $pb.PackageName('google.cloud.location'))
    ..a<$0.Any>(3, 'metadata', $pb.PbFieldType.OM, $0.Any.getDefault, $0.Any.create)
    ..aOS(4, 'locationId')
    ..aOS(5, 'displayName')
    ..hasRequiredFields = false
  ;
  ...
  set metadata($0.Any v) { setField(3, v); }
