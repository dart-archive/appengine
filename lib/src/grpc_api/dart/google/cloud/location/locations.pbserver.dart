...
abstract class LocationsServiceBase extends GeneratedService {
  Future<ListLocationsResponse> listLocations(ServerContext ctx, ListLocationsRequest request);
  Future<Location> getLocation(ServerContext ctx, GetLocationRequest request);

  GeneratedMessage createRequest(String method) {
    switch (method) {
      case 'ListLocations': return new ListLocationsRequest();
      case 'GetLocation': return new GetLocationRequest();
