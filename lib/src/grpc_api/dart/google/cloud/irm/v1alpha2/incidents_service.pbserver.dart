...
abstract class IncidentServiceBase extends $pb.GeneratedService {
  $async.Future<$0.Incident> createIncident(
      $pb.ServerContext ctx, CreateIncidentRequest request);
  $async.Future<$0.Incident> getIncident(
      $pb.ServerContext ctx, GetIncidentRequest request);
  $async.Future<SearchIncidentsResponse> searchIncidents(
      $pb.ServerContext ctx, SearchIncidentsRequest request);
  $async.Future<$0.Incident> updateIncident(
      $pb.ServerContext ctx, UpdateIncidentRequest request);
  $async.Future<SearchSimilarIncidentsResponse> searchSimilarIncidents(
      $pb.ServerContext ctx, SearchSimilarIncidentsRequest request);
  $async.Future<$0.Annotation> createAnnotation(
      $pb.ServerContext ctx, CreateAnnotationRequest request);
  $async.Future<ListAnnotationsResponse> listAnnotations(
      $pb.ServerContext ctx, ListAnnotationsRequest request);
  $async.Future<$0.Tag> createTag(
      $pb.ServerContext ctx, CreateTagRequest request);
  $async.Future<$2.Empty> deleteTag(
      $pb.ServerContext ctx, DeleteTagRequest request);
  $async.Future<ListTagsResponse> listTags(
      $pb.ServerContext ctx, ListTagsRequest request);
  $async.Future<$0.Signal> createSignal(
      $pb.ServerContext ctx, CreateSignalRequest request);
  $async.Future<SearchSignalsResponse> searchSignals(
      $pb.ServerContext ctx, SearchSignalsRequest request);
  $async.Future<$0.Signal> getSignal(
      $pb.ServerContext ctx, GetSignalRequest request);
  $async.Future<$0.Signal> updateSignal(
      $pb.ServerContext ctx, UpdateSignalRequest request);
  $async.Future<EscalateIncidentResponse> escalateIncident(
      $pb.ServerContext ctx, EscalateIncidentRequest request);
  $async.Future<$0.Artifact> createArtifact(
      $pb.ServerContext ctx, CreateArtifactRequest request);
  $async.Future<ListArtifactsResponse> listArtifacts(
      $pb.ServerContext ctx, ListArtifactsRequest request);
  $async.Future<$0.Artifact> updateArtifact(
      $pb.ServerContext ctx, UpdateArtifactRequest request);
  $async.Future<$2.Empty> deleteArtifact(
      $pb.ServerContext ctx, DeleteArtifactRequest request);
  $async.Future<SendShiftHandoffResponse> sendShiftHandoff(
      $pb.ServerContext ctx, SendShiftHandoffRequest request);
  $async.Future<$0.Subscription> createSubscription(
      $pb.ServerContext ctx, CreateSubscriptionRequest request);
  ...
  $async.Future<$0.IncidentRoleAssignment> createIncidentRoleAssignment(
      $pb.ServerContext ctx, CreateIncidentRoleAssignmentRequest request);
  $async.Future<$2.Empty> deleteIncidentRoleAssignment(
      $pb.ServerContext ctx, DeleteIncidentRoleAssignmentRequest request);
  $async.Future<ListIncidentRoleAssignmentsResponse>
      listIncidentRoleAssignments(
          $pb.ServerContext ctx, ListIncidentRoleAssignmentsRequest request);
  $async.Future<$0.IncidentRoleAssignment> requestIncidentRoleHandover(
      $pb.ServerContext ctx, RequestIncidentRoleHandoverRequest request);
  $async.Future<$0.IncidentRoleAssignment> confirmIncidentRoleHandover(
      $pb.ServerContext ctx, ConfirmIncidentRoleHandoverRequest request);
  $async.Future<$0.IncidentRoleAssignment> forceIncidentRoleHandover(
      $pb.ServerContext ctx, ForceIncidentRoleHandoverRequest request);
  $async.Future<$0.IncidentRoleAssignment> cancelIncidentRoleHandover(
      $pb.ServerContext ctx, CancelIncidentRoleHandoverRequest request);
  ...
  $async.Future<$pb.GeneratedMessage> handleCall($pb.ServerContext ctx,
    ...
    switch (method) {
      case 'CreateIncident':
        return this.createIncident(ctx, request);
      case 'GetIncident':
        return this.getIncident(ctx, request);
      case 'SearchIncidents':
        return this.searchIncidents(ctx, request);
      case 'UpdateIncident':
        return this.updateIncident(ctx, request);
      case 'SearchSimilarIncidents':
        return this.searchSimilarIncidents(ctx, request);
      case 'CreateAnnotation':
        return this.createAnnotation(ctx, request);
      case 'ListAnnotations':
        return this.listAnnotations(ctx, request);
      case 'CreateTag':
        return this.createTag(ctx, request);
      case 'DeleteTag':
        return this.deleteTag(ctx, request);
      case 'ListTags':
        return this.listTags(ctx, request);
      case 'CreateSignal':
        return this.createSignal(ctx, request);
      case 'SearchSignals':
        return this.searchSignals(ctx, request);
      case 'GetSignal':
        return this.getSignal(ctx, request);
      case 'UpdateSignal':
        return this.updateSignal(ctx, request);
      case 'EscalateIncident':
        return this.escalateIncident(ctx, request);
      case 'CreateArtifact':
        return this.createArtifact(ctx, request);
      case 'ListArtifacts':
        return this.listArtifacts(ctx, request);
      case 'UpdateArtifact':
        return this.updateArtifact(ctx, request);
      case 'DeleteArtifact':
        return this.deleteArtifact(ctx, request);
      case 'SendShiftHandoff':
        return this.sendShiftHandoff(ctx, request);
      case 'CreateSubscription':
      ...
      case 'CreateIncidentRoleAssignment':
        return this.createIncidentRoleAssignment(ctx, request);
      case 'DeleteIncidentRoleAssignment':
        return this.deleteIncidentRoleAssignment(ctx, request);
      case 'ListIncidentRoleAssignments':
        return this.listIncidentRoleAssignments(ctx, request);
      case 'RequestIncidentRoleHandover':
        return this.requestIncidentRoleHandover(ctx, request);
      case 'ConfirmIncidentRoleHandover':
        return this.confirmIncidentRoleHandover(ctx, request);
      case 'ForceIncidentRoleHandover':
        return this.forceIncidentRoleHandover(ctx, request);
      case 'CancelIncidentRoleHandover':
        return this.cancelIncidentRoleHandover(ctx, request);
      default:
        throw $core.ArgumentError('Unknown method: $method');
    }
  }
  ...
  $core.Map<$core.String, $core.Map<$core.String, $core.dynamic>>
      get $messageJson => IncidentServiceBase$messageJson;
}
