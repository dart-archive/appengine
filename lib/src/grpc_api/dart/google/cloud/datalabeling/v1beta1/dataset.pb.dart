...
class Dataset extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Dataset', package: const $pb.PackageName('google.cloud.datalabeling.v1beta1'))
    ..aOS(1, 'name')
    ..aOS(2, 'displayName')
    ..aOS(3, 'description')
...
class InputConfig extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('InputConfig', package: const $pb.PackageName('google.cloud.datalabeling.v1beta1'))
    ..e<DataType>(1, 'dataType', $pb.PbFieldType.OE, DataType.DATA_TYPE_UNSPECIFIED, DataType.valueOf, DataType.values)
...
class GcsSource extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('GcsSource', package: const $pb.PackageName('google.cloud.datalabeling.v1beta1'))
    ..aOS(1, 'inputUri')
    ..aOS(2, 'mimeType')
    ..hasRequiredFields = false
  ;
...
class OutputConfig extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('OutputConfig', package: const $pb.PackageName('google.cloud.datalabeling.v1beta1'))
    ..a<GcsDestination>(1, 'gcsDestination', $pb.PbFieldType.OM, GcsDestination.getDefault, GcsDestination.create)
    ..a<GcsFolderDestination>(2, 'gcsFolderDestination', $pb.PbFieldType.OM, GcsFolderDestination.getDefault, GcsFolderDestination.create)
    ..oo(0, [1, 2])
    ..hasRequiredFields = false
  ;
...
class GcsDestination extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('GcsDestination', package: const $pb.PackageName('google.cloud.datalabeling.v1beta1'))
    ..aOS(1, 'outputUri')
    ..aOS(2, 'mimeType')
    ..hasRequiredFields = false
  ;
...
class GcsFolderDestination extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('GcsFolderDestination', package: const $pb.PackageName('google.cloud.datalabeling.v1beta1'))
    ..aOS(1, 'outputFolderUri')
    ..hasRequiredFields = false
  ;

  GcsFolderDestination() : super();
  GcsFolderDestination.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  GcsFolderDestination.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  GcsFolderDestination clone() => GcsFolderDestination()..mergeFromMessage(this);
  GcsFolderDestination copyWith(void Function(GcsFolderDestination) updates) => super.copyWith((message) => updates(message as GcsFolderDestination));
  $pb.BuilderInfo get info_ => _i;
  ...
  static GcsFolderDestination getDefault() => _defaultInstance ??= create()..freeze();
...
class DataItem extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('DataItem', package: const $pb.PackageName('google.cloud.datalabeling.v1beta1'))
    ..aOS(1, 'name')
    ..a<ImagePayload>(2, 'imagePayload', $pb.PbFieldType.OM, ImagePayload.getDefault, ImagePayload.create)
    ..a<TextPayload>(3, 'textPayload', $pb.PbFieldType.OM, TextPayload.getDefault, TextPayload.create)
    ..a<VideoPayload>(4, 'videoPayload', $pb.PbFieldType.OM, VideoPayload.getDefault, VideoPayload.create)
    ..a<AudioPayload>(5, 'audioPayload', $pb.PbFieldType.OM, AudioPayload.getDefault, AudioPayload.create)
    ..oo(0, [2, 3, 4, 5])
    ..hasRequiredFields = false
  ;

  DataItem() : super();
  DataItem.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  DataItem.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  DataItem clone() => DataItem()..mergeFromMessage(this);
  DataItem copyWith(void Function(DataItem) updates) => super.copyWith((message) => updates(message as DataItem));
  $pb.BuilderInfo get info_ => _i;
  ...
  set imagePayload(ImagePayload v) { setField(2, v); }
  $core.bool hasImagePayload() => $_has(1);
  void clearImagePayload() => clearField(2);

  TextPayload get textPayload => $_getN(2);
  set textPayload(TextPayload v) { setField(3, v); }
  $core.bool hasTextPayload() => $_has(2);
  void clearTextPayload() => clearField(3);

  VideoPayload get videoPayload => $_getN(3);
  set videoPayload(VideoPayload v) { setField(4, v); }
  $core.bool hasVideoPayload() => $_has(3);
  void clearVideoPayload() => clearField(4);

  AudioPayload get audioPayload => $_getN(4);
  set audioPayload(AudioPayload v) { setField(5, v); }
  $core.bool hasAudioPayload() => $_has(4);
  void clearAudioPayload() => clearField(5);
}

class AnnotatedDataset extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('AnnotatedDataset', package: const $pb.PackageName('google.cloud.datalabeling.v1beta1'))
    ..aOS(1, 'name')
    ..aOS(2, 'displayName')
    ..e<$2.AnnotationSource>(3, 'annotationSource', $pb.PbFieldType.OE, $2.AnnotationSource.ANNOTATION_SOURCE_UNSPECIFIED, $2.AnnotationSource.valueOf, $2.AnnotationSource.values)
    ..aInt64(4, 'exampleCount')
    ..aInt64(5, 'completedExampleCount')
    ..a<LabelStats>(6, 'labelStats', $pb.PbFieldType.OM, LabelStats.getDefault, LabelStats.create)
    ..a<$0.Timestamp>(7, 'createTime', $pb.PbFieldType.OM, $0.Timestamp.getDefault, $0.Timestamp.create)
    ..e<$2.AnnotationType>(8, 'annotationType', $pb.PbFieldType.OE, $2.AnnotationType.ANNOTATION_TYPE_UNSPECIFIED, $2.AnnotationType.valueOf, $2.AnnotationType.values)
    ..aOS(9, 'description')
    ..a<AnnotatedDatasetMetadata>(10, 'metadata', $pb.PbFieldType.OM, AnnotatedDatasetMetadata.getDefault, AnnotatedDatasetMetadata.create)
    ..hasRequiredFields = false
  ;

  AnnotatedDataset() : super();
  AnnotatedDataset.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  AnnotatedDataset.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  AnnotatedDataset clone() => AnnotatedDataset()..mergeFromMessage(this);
  AnnotatedDataset copyWith(void Function(AnnotatedDataset) updates) => super.copyWith((message) => updates(message as AnnotatedDataset));
  $pb.BuilderInfo get info_ => _i;
  ...
  static AnnotatedDataset getDefault() => _defaultInstance ??= create()..freeze();
  ...
  set annotationType($2.AnnotationType v) { setField(8, v); }
...
class AnnotatedDatasetMetadata extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('AnnotatedDatasetMetadata', package: const $pb.PackageName('google.cloud.datalabeling.v1beta1'))
    ..a<$1.HumanAnnotationConfig>(1, 'humanAnnotationConfig', $pb.PbFieldType.OM, $1.HumanAnnotationConfig.getDefault, $1.HumanAnnotationConfig.create)
    ..a<$1.ImageClassificationConfig>(2, 'imageClassificationConfig', $pb.PbFieldType.OM, $1.ImageClassificationConfig.getDefault, $1.ImageClassificationConfig.create)
    ..a<$1.BoundingPolyConfig>(3, 'boundingPolyConfig', $pb.PbFieldType.OM, $1.BoundingPolyConfig.getDefault, $1.BoundingPolyConfig.create)
    ..a<$1.PolylineConfig>(4, 'polylineConfig', $pb.PbFieldType.OM, $1.PolylineConfig.getDefault, $1.PolylineConfig.create)
    ..a<$1.SegmentationConfig>(5, 'segmentationConfig', $pb.PbFieldType.OM, $1.SegmentationConfig.getDefault, $1.SegmentationConfig.create)
    ..a<$1.VideoClassificationConfig>(6, 'videoClassificationConfig', $pb.PbFieldType.OM, $1.VideoClassificationConfig.getDefault, $1.VideoClassificationConfig.create)
    ..a<$1.ObjectDetectionConfig>(7, 'objectDetectionConfig', $pb.PbFieldType.OM, $1.ObjectDetectionConfig.getDefault, $1.ObjectDetectionConfig.create)
    ..a<$1.ObjectTrackingConfig>(8, 'objectTrackingConfig', $pb.PbFieldType.OM, $1.ObjectTrackingConfig.getDefault, $1.ObjectTrackingConfig.create)
    ..a<$1.EventConfig>(9, 'eventConfig', $pb.PbFieldType.OM, $1.EventConfig.getDefault, $1.EventConfig.create)
    ..a<$1.TextClassificationConfig>(10, 'textClassificationConfig', $pb.PbFieldType.OM, $1.TextClassificationConfig.getDefault, $1.TextClassificationConfig.create)
  ...
  AnnotatedDatasetMetadata.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  AnnotatedDatasetMetadata.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  AnnotatedDatasetMetadata clone() => AnnotatedDatasetMetadata()..mergeFromMessage(this);
  AnnotatedDatasetMetadata copyWith(void Function(AnnotatedDatasetMetadata) updates) => super.copyWith((message) => updates(message as AnnotatedDatasetMetadata));
  $pb.BuilderInfo get info_ => _i;
  ...
  static AnnotatedDatasetMetadata getDefault() => _defaultInstance ??= create()..freeze();
  ...
  set humanAnnotationConfig($1.HumanAnnotationConfig v) { setField(1, v); }
  ...
  set imageClassificationConfig($1.ImageClassificationConfig v) { setField(2, v); }
  ...
  set boundingPolyConfig($1.BoundingPolyConfig v) { setField(3, v); }
  ...
  set polylineConfig($1.PolylineConfig v) { setField(4, v); }
  ...
  set segmentationConfig($1.SegmentationConfig v) { setField(5, v); }
  ...
  set videoClassificationConfig($1.VideoClassificationConfig v) { setField(6, v); }
  ...
  set objectDetectionConfig($1.ObjectDetectionConfig v) { setField(7, v); }
  ...
  set textClassificationConfig($1.TextClassificationConfig v) { setField(10, v); }
  ...
  set textEntityExtractionConfig($1.TextEntityExtractionConfig v) { setField(11, v); }
...
class LabelStats extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('LabelStats', package: const $pb.PackageName('google.cloud.datalabeling.v1beta1'))
    ..m<$core.String, Int64>(1, 'exampleCount', 'LabelStats.ExampleCountEntry',$pb.PbFieldType.OS, $pb.PbFieldType.O6, null, null, null , const $pb.PackageName('google.cloud.datalabeling.v1beta1'))
    ..hasRequiredFields = false
  ;

  LabelStats() : super();
  LabelStats.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  LabelStats.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  LabelStats clone() => LabelStats()..mergeFromMessage(this);
  LabelStats copyWith(void Function(LabelStats) updates) => super.copyWith((message) => updates(message as LabelStats));
  $pb.BuilderInfo get info_ => _i;
...
class Example extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Example', package: const $pb.PackageName('google.cloud.datalabeling.v1beta1'))
    ..aOS(1, 'name')
    ..a<ImagePayload>(2, 'imagePayload', $pb.PbFieldType.OM, ImagePayload.getDefault, ImagePayload.create)
    ..pc<$2.Annotation>(5, 'annotations', $pb.PbFieldType.PM,$2.Annotation.create)
    ..a<TextPayload>(6, 'textPayload', $pb.PbFieldType.OM, TextPayload.getDefault, TextPayload.create)
    ..a<VideoPayload>(7, 'videoPayload', $pb.PbFieldType.OM, VideoPayload.getDefault, VideoPayload.create)
    ..a<AudioPayload>(8, 'audioPayload', $pb.PbFieldType.OM, AudioPayload.getDefault, AudioPayload.create)
    ..oo(0, [2, 6, 7, 8])
    ..hasRequiredFields = false
  ;

  Example() : super();
  Example.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  Example.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  Example clone() => Example()..mergeFromMessage(this);
  Example copyWith(void Function(Example) updates) => super.copyWith((message) => updates(message as Example));
  $pb.BuilderInfo get info_ => _i;
...
class ImagePayload extends $pb.GeneratedMessage {
  ...
  ImagePayload() : super();
  ImagePayload.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  ImagePayload.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ImagePayload clone() => ImagePayload()..mergeFromMessage(this);
  ImagePayload copyWith(void Function(ImagePayload) updates) => super.copyWith((message) => updates(message as ImagePayload));
  $pb.BuilderInfo get info_ => _i;
...
class TextPayload extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('TextPayload', package: const $pb.PackageName('google.cloud.datalabeling.v1beta1'))
    ..aOS(1, 'textContent')
    ..hasRequiredFields = false
  ;

  TextPayload() : super();
  TextPayload.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  TextPayload.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  TextPayload clone() => TextPayload()..mergeFromMessage(this);
  TextPayload copyWith(void Function(TextPayload) updates) => super.copyWith((message) => updates(message as TextPayload));
  $pb.BuilderInfo get info_ => _i;
...
class VideoThumbnail extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('VideoThumbnail', package: const $pb.PackageName('google.cloud.datalabeling.v1beta1'))
    ..a<$core.List<$core.int>>(1, 'thumbnail', $pb.PbFieldType.OY)
    ..a<$3.Duration>(2, 'timeOffset', $pb.PbFieldType.OM, $3.Duration.getDefault, $3.Duration.create)
    ..hasRequiredFields = false
  ;

  VideoThumbnail() : super();
  VideoThumbnail.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  VideoThumbnail.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  VideoThumbnail clone() => VideoThumbnail()..mergeFromMessage(this);
  VideoThumbnail copyWith(void Function(VideoThumbnail) updates) => super.copyWith((message) => updates(message as VideoThumbnail));
  $pb.BuilderInfo get info_ => _i;
...
class VideoPayload extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('VideoPayload', package: const $pb.PackageName('google.cloud.datalabeling.v1beta1'))
    ..aOS(1, 'mimeType')
    ..aOS(2, 'videoUri')
    ..pc<VideoThumbnail>(3, 'videoThumbnails', $pb.PbFieldType.PM,VideoThumbnail.create)
    ..a<$core.double>(4, 'frameRate', $pb.PbFieldType.OF)
    ..hasRequiredFields = false
  ;

  VideoPayload() : super();
  VideoPayload.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  VideoPayload.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  VideoPayload clone() => VideoPayload()..mergeFromMessage(this);
  VideoPayload copyWith(void Function(VideoPayload) updates) => super.copyWith((message) => updates(message as VideoPayload));
  $pb.BuilderInfo get info_ => _i;
...
class AudioPayload extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('AudioPayload', package: const $pb.PackageName('google.cloud.datalabeling.v1beta1'))
    ..aOS(1, 'audioUri')
  ...
  AudioPayload() : super();
  AudioPayload.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  AudioPayload.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  AudioPayload clone() => AudioPayload()..mergeFromMessage(this);
  AudioPayload copyWith(void Function(AudioPayload) updates) => super.copyWith((message) => updates(message as AudioPayload));
  $pb.BuilderInfo get info_ => _i;
  static AudioPayload create() => AudioPayload();
  AudioPayload createEmptyInstance() => create();
  static $pb.PbList<AudioPayload> createRepeated() => $pb.PbList<AudioPayload>();
