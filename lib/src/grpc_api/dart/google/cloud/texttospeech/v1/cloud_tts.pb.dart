...
class ListVoicesRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ListVoicesRequest', package: const $pb.PackageName('google.cloud.texttospeech.v1'))
    ..aOS(1, 'languageCode')
...
class ListVoicesResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ListVoicesResponse', package: const $pb.PackageName('google.cloud.texttospeech.v1'))
...
class Voice extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Voice', package: const $pb.PackageName('google.cloud.texttospeech.v1'))
    ..pPS(1, 'languageCodes')
    ..aOS(2, 'name')
...
class SynthesizeSpeechRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('SynthesizeSpeechRequest', package: const $pb.PackageName('google.cloud.texttospeech.v1'))
...
class SynthesisInput extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('SynthesisInput', package: const $pb.PackageName('google.cloud.texttospeech.v1'))
    ..aOS(1, 'text')
    ..aOS(2, 'ssml')
    ..oo(0, [1, 2])
    ..hasRequiredFields = false
...
class VoiceSelectionParams extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('VoiceSelectionParams', package: const $pb.PackageName('google.cloud.texttospeech.v1'))
    ..aOS(1, 'languageCode')
    ..aOS(2, 'name')
    ..e<SsmlVoiceGender>(3, 'ssmlGender', $pb.PbFieldType.OE, SsmlVoiceGender.SSML_VOICE_GENDER_UNSPECIFIED, SsmlVoiceGender.valueOf, SsmlVoiceGender.values)
    ..hasRequiredFields = false
...
class AudioConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('AudioConfig', package: const $pb.PackageName('google.cloud.texttospeech.v1'))
...
class SynthesizeSpeechResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('SynthesizeSpeechResponse', package: const $pb.PackageName('google.cloud.texttospeech.v1'))
