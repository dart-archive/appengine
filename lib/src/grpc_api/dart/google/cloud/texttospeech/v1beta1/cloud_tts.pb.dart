...
class ListVoicesRequest extends GeneratedMessage {
  ...
  ListVoicesRequest.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  ListVoicesRequest.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ...
  static PbList<ListVoicesRequest> createRepeated() => new PbList<ListVoicesRequest>();
  static ListVoicesRequest getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyListVoicesRequest();
...
class _ReadonlyListVoicesRequest extends ListVoicesRequest with ReadonlyMessageMixin {}
...
class ListVoicesResponse extends GeneratedMessage {
  ...
  ListVoicesResponse.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  ListVoicesResponse.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ...
  static PbList<ListVoicesResponse> createRepeated() => new PbList<ListVoicesResponse>();
  static ListVoicesResponse getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyListVoicesResponse();
    return _defaultInstance;
  }
...
class _ReadonlyListVoicesResponse extends ListVoicesResponse with ReadonlyMessageMixin {}

class Voice extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('Voice')
    ..pPS(1, 'languageCodes')
    ..aOS(2, 'name')
    ..e<SsmlVoiceGender>(3, 'ssmlGender', PbFieldType.OE, SsmlVoiceGender.SSML_VOICE_GENDER_UNSPECIFIED, SsmlVoiceGender.valueOf, SsmlVoiceGender.values)
    ..a<int>(4, 'naturalSampleRateHertz', PbFieldType.O3)
    ..hasRequiredFields = false
  ;

  Voice() : super();
  Voice.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  Voice.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
...
class SynthesizeSpeechRequest extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('SynthesizeSpeechRequest')
    ..a<SynthesisInput>(1, 'input', PbFieldType.OM, SynthesisInput.getDefault, SynthesisInput.create)
    ..a<VoiceSelectionParams>(2, 'voice', PbFieldType.OM, VoiceSelectionParams.getDefault, VoiceSelectionParams.create)
    ..a<AudioConfig>(3, 'audioConfig', PbFieldType.OM, AudioConfig.getDefault, AudioConfig.create)
    ..hasRequiredFields = false
  ;

  SynthesizeSpeechRequest() : super();
  SynthesizeSpeechRequest.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  SynthesizeSpeechRequest.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ...
  static PbList<SynthesizeSpeechRequest> createRepeated() => new PbList<SynthesizeSpeechRequest>();
  static SynthesizeSpeechRequest getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlySynthesizeSpeechRequest();
    return _defaultInstance;
  }
  static SynthesizeSpeechRequest _defaultInstance;
  static void $checkItem(SynthesizeSpeechRequest v) {
    if (v is! SynthesizeSpeechRequest) checkItemFailed(v, 'SynthesizeSpeechRequest');
  }
...
class _ReadonlySynthesizeSpeechRequest extends SynthesizeSpeechRequest with ReadonlyMessageMixin {}
...
class SynthesisInput extends GeneratedMessage {
  ...
  SynthesisInput.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  SynthesisInput.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  SynthesisInput clone() => new SynthesisInput()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static SynthesisInput create() => new SynthesisInput();
  static PbList<SynthesisInput> createRepeated() => new PbList<SynthesisInput>();
  static SynthesisInput getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlySynthesisInput();
    return _defaultInstance;
  }
...
class VoiceSelectionParams extends GeneratedMessage {
  ...
  VoiceSelectionParams.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  VoiceSelectionParams.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ...
  static PbList<VoiceSelectionParams> createRepeated() => new PbList<VoiceSelectionParams>();
  static VoiceSelectionParams getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyVoiceSelectionParams();
    return _defaultInstance;
  }
...
class _ReadonlyVoiceSelectionParams extends VoiceSelectionParams with ReadonlyMessageMixin {}
...
class AudioConfig extends GeneratedMessage {
  ...
  AudioConfig() : super();
  AudioConfig.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  AudioConfig.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
...
class SynthesizeSpeechResponse extends GeneratedMessage {
  ...
  SynthesizeSpeechResponse.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  SynthesizeSpeechResponse.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ...
  static PbList<SynthesizeSpeechResponse> createRepeated() => new PbList<SynthesizeSpeechResponse>();
  static SynthesizeSpeechResponse getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlySynthesizeSpeechResponse();
    return _defaultInstance;
  }
  static SynthesizeSpeechResponse _defaultInstance;
  static void $checkItem(SynthesizeSpeechResponse v) {
    if (v is! SynthesizeSpeechResponse) checkItemFailed(v, 'SynthesizeSpeechResponse');
  }
...
class _ReadonlySynthesizeSpeechResponse extends SynthesizeSpeechResponse with ReadonlyMessageMixin {}

class TextToSpeechApi {
  RpcClient _client;
  TextToSpeechApi(this._client);

  Future<ListVoicesResponse> listVoices(ClientContext ctx, ListVoicesRequest request) {
    var emptyResponse = new ListVoicesResponse();
    return _client.invoke<ListVoicesResponse>(ctx, 'TextToSpeech', 'ListVoices', request, emptyResponse);
  }
  Future<SynthesizeSpeechResponse> synthesizeSpeech(ClientContext ctx, SynthesizeSpeechRequest request) {
    var emptyResponse = new SynthesizeSpeechResponse();
    return _client.invoke<SynthesizeSpeechResponse>(ctx, 'TextToSpeech', 'SynthesizeSpeech', request, emptyResponse);
  }
}
