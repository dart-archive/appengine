...
class TrainingInput extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('TrainingInput', package: const $pb.PackageName('google.cloud.ml.v1'))
    ..e<TrainingInput_ScaleTier>(1, 'scaleTier', $pb.PbFieldType.OE, TrainingInput_ScaleTier.BASIC, TrainingInput_ScaleTier.valueOf, TrainingInput_ScaleTier.values)
    ..aOS(2, 'masterType')
    ..aOS(3, 'workerType')
    ...
    ..aOS(8, 'pythonModule')
    ..pPS(10, 'args')
    ..a<HyperparameterSpec>(12, 'hyperparameters', $pb.PbFieldType.OM, HyperparameterSpec.getDefault, HyperparameterSpec.create)
    ..aOS(14, 'region')
  ...
  TrainingInput() : super();
  TrainingInput.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  TrainingInput.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  TrainingInput clone() => TrainingInput()..mergeFromMessage(this);
  TrainingInput copyWith(void Function(TrainingInput) updates) => super.copyWith((message) => updates(message as TrainingInput));
  $pb.BuilderInfo get info_ => _i;
  static TrainingInput create() => TrainingInput();
  TrainingInput createEmptyInstance() => create();
  static $pb.PbList<TrainingInput> createRepeated() => $pb.PbList<TrainingInput>();
  ...
  set pythonModule($core.String v) { $_setString(7, v); }
  ...
  set runtimeVersion($core.String v) { $_setString(11, v); }
  $core.bool hasRuntimeVersion() => $_has(11);
  void clearRuntimeVersion() => clearField(15);

  $core.String get jobDir => $_getS(12, '');
  set jobDir($core.String v) { $_setString(12, v); }
  $core.bool hasJobDir() => $_has(12);
  void clearJobDir() => clearField(16);
}

class HyperparameterSpec extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('HyperparameterSpec', package: const $pb.PackageName('google.cloud.ml.v1'))
    ..e<HyperparameterSpec_GoalType>(1, 'goal', $pb.PbFieldType.OE, HyperparameterSpec_GoalType.GOAL_TYPE_UNSPECIFIED, HyperparameterSpec_GoalType.valueOf, HyperparameterSpec_GoalType.values)
  ...
  HyperparameterSpec.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  HyperparameterSpec.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  HyperparameterSpec clone() => HyperparameterSpec()..mergeFromMessage(this);
  HyperparameterSpec copyWith(void Function(HyperparameterSpec) updates) => super.copyWith((message) => updates(message as HyperparameterSpec));
  $pb.BuilderInfo get info_ => _i;
  static HyperparameterSpec create() => HyperparameterSpec();
  HyperparameterSpec createEmptyInstance() => create();
  static $pb.PbList<HyperparameterSpec> createRepeated() => $pb.PbList<HyperparameterSpec>();
  static HyperparameterSpec getDefault() => _defaultInstance ??= create()..freeze();
  ...
  set hyperparameterMetricTag($core.String v) { $_setString(4, v); }
...
class ParameterSpec extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ParameterSpec', package: const $pb.PackageName('google.cloud.ml.v1'))
    ..aOS(1, 'parameterName')
    ..a<$core.double>(2, 'minValue', $pb.PbFieldType.OD)
    ..a<$core.double>(3, 'maxValue', $pb.PbFieldType.OD)
    ..e<ParameterSpec_ParameterType>(4, 'type', $pb.PbFieldType.OE, ParameterSpec_ParameterType.PARAMETER_TYPE_UNSPECIFIED, ParameterSpec_ParameterType.valueOf, ParameterSpec_ParameterType.values)
    ..pPS(5, 'categoricalValues')
    ..p<$core.double>(6, 'discreteValues', $pb.PbFieldType.PD)
    ..e<ParameterSpec_ScaleType>(7, 'scaleType', $pb.PbFieldType.OE, ParameterSpec_ScaleType.NONE, ParameterSpec_ScaleType.valueOf, ParameterSpec_ScaleType.values)
    ..hasRequiredFields = false
  ;

  ParameterSpec() : super();
  ParameterSpec.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  ParameterSpec.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ParameterSpec clone() => ParameterSpec()..mergeFromMessage(this);
  ParameterSpec copyWith(void Function(ParameterSpec) updates) => super.copyWith((message) => updates(message as ParameterSpec));
  $pb.BuilderInfo get info_ => _i;
  static ParameterSpec create() => ParameterSpec();
  ParameterSpec createEmptyInstance() => create();
  static $pb.PbList<ParameterSpec> createRepeated() => $pb.PbList<ParameterSpec>();
...
class HyperparameterOutput_HyperparameterMetric extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('HyperparameterOutput.HyperparameterMetric', package: const $pb.PackageName('google.cloud.ml.v1'))
  ...
  HyperparameterOutput_HyperparameterMetric.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  HyperparameterOutput_HyperparameterMetric.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  HyperparameterOutput_HyperparameterMetric clone() => HyperparameterOutput_HyperparameterMetric()..mergeFromMessage(this);
  HyperparameterOutput_HyperparameterMetric copyWith(void Function(HyperparameterOutput_HyperparameterMetric) updates) => super.copyWith((message) => updates(message as HyperparameterOutput_HyperparameterMetric));
  $pb.BuilderInfo get info_ => _i;
  static HyperparameterOutput_HyperparameterMetric create() => HyperparameterOutput_HyperparameterMetric();
  HyperparameterOutput_HyperparameterMetric createEmptyInstance() => create();
  static $pb.PbList<HyperparameterOutput_HyperparameterMetric> createRepeated() => $pb.PbList<HyperparameterOutput_HyperparameterMetric>();
  static HyperparameterOutput_HyperparameterMetric getDefault() => _defaultInstance ??= create()..freeze();
  ...
  set objectiveValue($core.double v) { $_setDouble(1, v); }
...
class HyperparameterOutput extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('HyperparameterOutput', package: const $pb.PackageName('google.cloud.ml.v1'))
    ..aOS(1, 'trialId')
    ..m<$core.String, $core.String>(2, 'hyperparameters', 'HyperparameterOutput.HyperparametersEntry',$pb.PbFieldType.OS, $pb.PbFieldType.OS, null, null, null , const $pb.PackageName('google.cloud.ml.v1'))
    ..a<HyperparameterOutput_HyperparameterMetric>(3, 'finalMetric', $pb.PbFieldType.OM, HyperparameterOutput_HyperparameterMetric.getDefault, HyperparameterOutput_HyperparameterMetric.create)
    ..pc<HyperparameterOutput_HyperparameterMetric>(4, 'allMetrics', $pb.PbFieldType.PM,HyperparameterOutput_HyperparameterMetric.create)
    ..hasRequiredFields = false
  ;

  HyperparameterOutput() : super();
  HyperparameterOutput.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  HyperparameterOutput.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  HyperparameterOutput clone() => HyperparameterOutput()..mergeFromMessage(this);
  HyperparameterOutput copyWith(void Function(HyperparameterOutput) updates) => super.copyWith((message) => updates(message as HyperparameterOutput));
  $pb.BuilderInfo get info_ => _i;
  static HyperparameterOutput create() => HyperparameterOutput();
  HyperparameterOutput createEmptyInstance() => create();
  static $pb.PbList<HyperparameterOutput> createRepeated() => $pb.PbList<HyperparameterOutput>();
  static HyperparameterOutput getDefault() => _defaultInstance ??= create()..freeze();
  static HyperparameterOutput _defaultInstance;

  $core.String get trialId => $_getS(0, '');
  set trialId($core.String v) { $_setString(0, v); }
  ...
  $core.List<HyperparameterOutput_HyperparameterMetric> get allMetrics => $_getList(3);
}

class TrainingOutput extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('TrainingOutput', package: const $pb.PackageName('google.cloud.ml.v1'))
    ..aInt64(1, 'completedTrialCount')
    ..pc<HyperparameterOutput>(2, 'trials', $pb.PbFieldType.PM,HyperparameterOutput.create)
  ...
  TrainingOutput.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  TrainingOutput.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  TrainingOutput clone() => TrainingOutput()..mergeFromMessage(this);
  TrainingOutput copyWith(void Function(TrainingOutput) updates) => super.copyWith((message) => updates(message as TrainingOutput));
  $pb.BuilderInfo get info_ => _i;
  static TrainingOutput create() => TrainingOutput();
  TrainingOutput createEmptyInstance() => create();
  static $pb.PbList<TrainingOutput> createRepeated() => $pb.PbList<TrainingOutput>();
  ...
  set consumedMlUnits($core.double v) { $_setDouble(2, v); }
...
class PredictionInput extends $pb.GeneratedMessage {
  static const $core.Map<$core.int, PredictionInput_ModelVersion> _PredictionInput_ModelVersionByTag = {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('PredictionInput', package: const $pb.PackageName('google.cloud.ml.v1'))
    ..aOS(1, 'modelName')
    ..aOS(2, 'versionName')
    ..e<PredictionInput_DataFormat>(3, 'dataFormat', $pb.PbFieldType.OE, PredictionInput_DataFormat.DATA_FORMAT_UNSPECIFIED, PredictionInput_DataFormat.valueOf, PredictionInput_DataFormat.values)
    ..pPS(4, 'inputPaths')
    ..aOS(5, 'outputPath')
  ...
  PredictionInput.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  PredictionInput.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  PredictionInput clone() => PredictionInput()..mergeFromMessage(this);
  PredictionInput copyWith(void Function(PredictionInput) updates) => super.copyWith((message) => updates(message as PredictionInput));
  $pb.BuilderInfo get info_ => _i;
  static PredictionInput create() => PredictionInput();
  PredictionInput createEmptyInstance() => create();
  static $pb.PbList<PredictionInput> createRepeated() => $pb.PbList<PredictionInput>();
  static PredictionInput getDefault() => _defaultInstance ??= create()..freeze();
  static PredictionInput _defaultInstance;

  PredictionInput_ModelVersion whichModelVersion() => _PredictionInput_ModelVersionByTag[$_whichOneof(0)];
  ...
  set outputPath($core.String v) { $_setString(4, v); }
  ...
  set runtimeVersion($core.String v) { $_setString(7, v); }
...
class PredictionOutput extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('PredictionOutput', package: const $pb.PackageName('google.cloud.ml.v1'))
    ..aOS(1, 'outputPath')
  ...
  PredictionOutput.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  PredictionOutput.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  PredictionOutput clone() => PredictionOutput()..mergeFromMessage(this);
  PredictionOutput copyWith(void Function(PredictionOutput) updates) => super.copyWith((message) => updates(message as PredictionOutput));
  $pb.BuilderInfo get info_ => _i;
  static PredictionOutput create() => PredictionOutput();
  PredictionOutput createEmptyInstance() => create();
  static $pb.PbList<PredictionOutput> createRepeated() => $pb.PbList<PredictionOutput>();
  static PredictionOutput getDefault() => _defaultInstance ??= create()..freeze();
  static PredictionOutput _defaultInstance;

  $core.String get outputPath => $_getS(0, '');
  set outputPath($core.String v) { $_setString(0, v); }
  ...
  set nodeHours($core.double v) { $_setDouble(3, v); }
...
class Job extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Job', package: const $pb.PackageName('google.cloud.ml.v1'))
    ..aOS(1, 'jobId')
    ..a<TrainingInput>(2, 'trainingInput', $pb.PbFieldType.OM, TrainingInput.getDefault, TrainingInput.create)
    ..a<PredictionInput>(3, 'predictionInput', $pb.PbFieldType.OM, PredictionInput.getDefault, PredictionInput.create)
    ...
    ..e<Job_State>(7, 'state', $pb.PbFieldType.OE, Job_State.STATE_UNSPECIFIED, Job_State.valueOf, Job_State.values)
    ..aOS(8, 'errorMessage')
    ..a<TrainingOutput>(9, 'trainingOutput', $pb.PbFieldType.OM, TrainingOutput.getDefault, TrainingOutput.create)
    ..a<PredictionOutput>(10, 'predictionOutput', $pb.PbFieldType.OM, PredictionOutput.getDefault, PredictionOutput.create)
    ..oo(0, [2, 3])
    ..oo(1, [9, 10])
    ..hasRequiredFields = false
  ;
...
class CreateJobRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('CreateJobRequest', package: const $pb.PackageName('google.cloud.ml.v1'))
    ..aOS(1, 'parent')
  ...
  CreateJobRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  CreateJobRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  CreateJobRequest clone() => CreateJobRequest()..mergeFromMessage(this);
  CreateJobRequest copyWith(void Function(CreateJobRequest) updates) => super.copyWith((message) => updates(message as CreateJobRequest));
  $pb.BuilderInfo get info_ => _i;
  ...
  static CreateJobRequest getDefault() => _defaultInstance ??= create()..freeze();
...
class ListJobsRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ListJobsRequest', package: const $pb.PackageName('google.cloud.ml.v1'))
    ..aOS(1, 'parent')
    ..aOS(2, 'filter')
    ..aOS(4, 'pageToken')
...
class ListJobsResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ListJobsResponse', package: const $pb.PackageName('google.cloud.ml.v1'))
...
class GetJobRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('GetJobRequest', package: const $pb.PackageName('google.cloud.ml.v1'))
    ..aOS(1, 'name')
    ..hasRequiredFields = false
  ;
...
class CancelJobRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('CancelJobRequest', package: const $pb.PackageName('google.cloud.ml.v1'))
    ..aOS(1, 'name')
    ..hasRequiredFields = false
  ;
...
class JobServiceApi {
  ...
  $async.Future<Job> createJob($pb.ClientContext ctx, CreateJobRequest request) {
  ...
  $async.Future<$1.Empty> cancelJob($pb.ClientContext ctx, CancelJobRequest request) {
    var emptyResponse = $1.Empty();
    return _client.invoke<$1.Empty>(ctx, 'JobService', 'CancelJob', request, emptyResponse);
  }
}
