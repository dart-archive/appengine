...
abstract class ProjectManagementServiceBase extends $pb.GeneratedService {
  $async.Future<GetConfigResponse> getConfig($pb.ServerContext ctx, GetConfigRequest request);
  ...
  $core.Map<$core.String, $core.dynamic> get $json => ProjectManagementServiceBase$json;
  $core.Map<$core.String, $core.Map<$core.String, $core.dynamic>> get $messageJson => ProjectManagementServiceBase$messageJson;
}
