...
class OperationMetadata_OperationType extends ProtobufEnum {
  ...
  static OperationMetadata_OperationType valueOf(int value) =>
      _byValue[value] as OperationMetadata_OperationType;
  static void $checkItem(OperationMetadata_OperationType v) {
    if (v is! OperationMetadata_OperationType)
      checkItemFailed(v, 'OperationMetadata_OperationType');
  }
