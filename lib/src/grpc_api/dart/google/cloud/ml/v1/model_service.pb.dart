...
class Model extends GeneratedMessage {
  ...
  set onlinePredictionLogging(bool v) { $_setBool(4, v); }
...
class Version extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('Version')
    ...
    ..a<ManualScaling>(9, 'manualScaling', PbFieldType.OM, ManualScaling.getDefault, ManualScaling.create)
    ..hasRequiredFields = false
  ;
  ...
  set lastUseTime($google$protobuf.Timestamp v) { setField(6, v); }
  bool hasLastUseTime() => $_has(5);
  void clearLastUseTime() => clearField(6);

  String get runtimeVersion => $_getS(6, '');
  set runtimeVersion(String v) { $_setString(6, v); }
...
class ManualScaling extends GeneratedMessage {
  ...
  set nodes(int v) { $_setSignedInt32(0, v); }
...
class ModelServiceApi {
  ...
  Future<$google$longrunning.Operation> deleteModel(ClientContext ctx, DeleteModelRequest request) {
    ...
    return _client.invoke<$google$longrunning.Operation>(ctx, 'ModelService', 'DeleteModel', request, emptyResponse);
  }
  Future<$google$longrunning.Operation> createVersion(ClientContext ctx, CreateVersionRequest request) {
    var emptyResponse = new $google$longrunning.Operation();
    return _client.invoke<$google$longrunning.Operation>(ctx, 'ModelService', 'CreateVersion', request, emptyResponse);
  }
  ...
  Future<$google$longrunning.Operation> deleteVersion(ClientContext ctx, DeleteVersionRequest request) {
    var emptyResponse = new $google$longrunning.Operation();
    return _client.invoke<$google$longrunning.Operation>(ctx, 'ModelService', 'DeleteVersion', request, emptyResponse);
  }
