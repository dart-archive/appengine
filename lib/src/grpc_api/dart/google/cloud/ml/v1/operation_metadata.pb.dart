...
class OperationMetadata extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('OperationMetadata', package: const $pb.PackageName('google.cloud.ml.v1'))
    ...
    ..e<OperationMetadata_OperationType>(5, 'operationType', $pb.PbFieldType.OE, OperationMetadata_OperationType.OPERATION_TYPE_UNSPECIFIED, OperationMetadata_OperationType.valueOf, OperationMetadata_OperationType.values)
    ..aOS(6, 'modelName')
    ..a<$1.Version>(7, 'version', $pb.PbFieldType.OM, $1.Version.getDefault, $1.Version.create)
  ...
  set isCancellationRequested($core.bool v) { $_setBool(3, v); }
  ...
  set operationType(OperationMetadata_OperationType v) { setField(5, v); }
