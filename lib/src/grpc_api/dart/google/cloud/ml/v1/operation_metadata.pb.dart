...
class OperationMetadata extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('OperationMetadata')
    ...
    ..e<OperationMetadata_OperationType>(5, 'operationType', PbFieldType.OE, OperationMetadata_OperationType.OPERATION_TYPE_UNSPECIFIED, OperationMetadata_OperationType.valueOf, OperationMetadata_OperationType.values)
    ..aOS(6, 'modelName')
  ...
  set isCancellationRequested(bool v) { $_setBool(3, v); }
  ...
  set modelName(String v) { $_setString(5, v); }
