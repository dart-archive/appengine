...
class Schema extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Schema', package: const $pb.PackageName('google.cloud.datacatalog.v1beta1'))
...
class ColumnSchema extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ColumnSchema', package: const $pb.PackageName('google.cloud.datacatalog.v1beta1'))
    ..aOS(1, 'type')
    ..aOS(2, 'description')
    ..aOS(3, 'mode')
    ..aOS(6, 'column')
  ...
  ColumnSchema() : super();
  ColumnSchema.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  ColumnSchema.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ColumnSchema clone() => ColumnSchema()..mergeFromMessage(this);
  ColumnSchema copyWith(void Function(ColumnSchema) updates) => super.copyWith((message) => updates(message as ColumnSchema));
  $pb.BuilderInfo get info_ => _i;
