...
class LookupEntryRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('LookupEntryRequest', package: const $pb.PackageName('google.cloud.datacatalog.v1beta1'))
  ...
  LookupEntryRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  LookupEntryRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  LookupEntryRequest clone() => LookupEntryRequest()..mergeFromMessage(this);
  LookupEntryRequest copyWith(void Function(LookupEntryRequest) updates) => super.copyWith((message) => updates(message as LookupEntryRequest));
  ...
  static LookupEntryRequest getDefault() => _defaultInstance ??= create()..freeze();
...
class Entry extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Entry', package: const $pb.PackageName('google.cloud.datacatalog.v1beta1'))
    ..aOS(1, 'name')
    ..e<EntryType>(2, 'type', $pb.PbFieldType.OE, EntryType.ENTRY_TYPE_UNSPECIFIED, EntryType.valueOf, EntryType.values)
    ..aOS(3, 'displayName')
    ..aOS(4, 'description')
    ..a<$0.Schema>(5, 'schema', $pb.PbFieldType.OM, $0.Schema.getDefault, $0.Schema.create)
    ..a<$1.SystemTimestamps>(7, 'sourceSystemTimestamps', $pb.PbFieldType.OM, $1.SystemTimestamps.getDefault, $1.SystemTimestamps.create)
    ..aOS(9, 'linkedResource')
    ..a<$2.BigQueryTableSpec>(12, 'bigqueryTableSpec', $pb.PbFieldType.OM, $2.BigQueryTableSpec.getDefault, $2.BigQueryTableSpec.create)
    ..oo(0, [12])
    ..hasRequiredFields = false
  ;

  Entry() : super();
  Entry.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  Entry.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
...
class DataCatalogApi {
  ...
  $async.Future<Entry> lookupEntry($pb.ClientContext ctx, LookupEntryRequest request) {
    var emptyResponse = Entry();
    return _client.invoke<Entry>(ctx, 'DataCatalog', 'LookupEntry', request, emptyResponse);
  }
}
