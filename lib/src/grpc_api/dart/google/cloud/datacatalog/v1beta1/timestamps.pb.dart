...
class SystemTimestamps extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('SystemTimestamps', package: const $pb.PackageName('google.cloud.datacatalog.v1beta1'))
  ...
  SystemTimestamps.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  SystemTimestamps.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  SystemTimestamps clone() => SystemTimestamps()..mergeFromMessage(this);
  SystemTimestamps copyWith(void Function(SystemTimestamps) updates) => super.copyWith((message) => updates(message as SystemTimestamps));
  ...
  static SystemTimestamps getDefault() => _defaultInstance ??= create()..freeze();
