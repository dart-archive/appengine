...
abstract class FoldersServiceBase extends GeneratedService {
  Future<ListFoldersResponse> listFolders(ServerContext ctx, ListFoldersRequest request);
  Future<SearchFoldersResponse> searchFolders(ServerContext ctx, SearchFoldersRequest request);
  Future<Folder> getFolder(ServerContext ctx, GetFolderRequest request);
  Future<$google$longrunning.Operation> createFolder(ServerContext ctx, CreateFolderRequest request);
  Future<Folder> updateFolder(ServerContext ctx, UpdateFolderRequest request);
  Future<$google$longrunning.Operation> moveFolder(ServerContext ctx, MoveFolderRequest request);
  Future<Folder> deleteFolder(ServerContext ctx, DeleteFolderRequest request);
  Future<Folder> undeleteFolder(ServerContext ctx, UndeleteFolderRequest request);
  ...
  GeneratedMessage createRequest(String method) {
    switch (method) {
      case 'ListFolders': return new ListFoldersRequest();
      case 'SearchFolders': return new SearchFoldersRequest();
      case 'GetFolder': return new GetFolderRequest();
      case 'CreateFolder': return new CreateFolderRequest();
      case 'UpdateFolder': return new UpdateFolderRequest();
      case 'MoveFolder': return new MoveFolderRequest();
      case 'DeleteFolder': return new DeleteFolderRequest();
      case 'UndeleteFolder': return new UndeleteFolderRequest();
