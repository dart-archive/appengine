...
class LogEntry extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('LogEntry', package: const $pb.PackageName('google.logging.v2'))
    ..a<$0.Any>(2, 'protoPayload', $pb.PbFieldType.OM, $0.Any.getDefault, $0.Any.create)
    ..aOS(3, 'textPayload')
    ..aOS(4, 'insertId')
    ..a<$1.Struct>(6, 'jsonPayload', $pb.PbFieldType.OM, $1.Struct.getDefault, $1.Struct.create)
    ..a<$2.HttpRequest>(7, 'httpRequest', $pb.PbFieldType.OM, $2.HttpRequest.getDefault, $2.HttpRequest.create)
    ..a<$3.MonitoredResource>(8, 'resource', $pb.PbFieldType.OM, $3.MonitoredResource.getDefault, $3.MonitoredResource.create)
    ..a<$4.Timestamp>(9, 'timestamp', $pb.PbFieldType.OM, $4.Timestamp.getDefault, $4.Timestamp.create)
    ..e<$5.LogSeverity>(10, 'severity', $pb.PbFieldType.OE, $5.LogSeverity.DEFAULT, $5.LogSeverity.valueOf, $5.LogSeverity.values)
    ..m<$core.String, $core.String>(11, 'labels', 'LogEntry.LabelsEntry',$pb.PbFieldType.OS, $pb.PbFieldType.OS, null, null, null , const $pb.PackageName('google.logging.v2'))
    ..aOS(12, 'logName')
    ..a<LogEntryOperation>(15, 'operation', $pb.PbFieldType.OM, LogEntryOperation.getDefault, LogEntryOperation.create)
    ..aOS(22, 'trace')
    ..a<LogEntrySourceLocation>(23, 'sourceLocation', $pb.PbFieldType.OM, LogEntrySourceLocation.getDefault, LogEntrySourceLocation.create)
    ..a<$4.Timestamp>(24, 'receiveTimestamp', $pb.PbFieldType.OM, $4.Timestamp.getDefault, $4.Timestamp.create)
...
class LogEntryOperation extends $pb.GeneratedMessage {
  ...
  LogEntryOperation.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  LogEntryOperation.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  LogEntryOperation clone() => LogEntryOperation()..mergeFromMessage(this);
  LogEntryOperation copyWith(void Function(LogEntryOperation) updates) => super.copyWith((message) => updates(message as LogEntryOperation));
  $pb.BuilderInfo get info_ => _i;
  ...
  static LogEntryOperation getDefault() => _defaultInstance ??= create()..freeze();
...
class LogEntrySourceLocation extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('LogEntrySourceLocation', package: const $pb.PackageName('google.logging.v2'))
    ..aOS(1, 'file')
    ..aInt64(2, 'line')
    ..aOS(3, 'function')
    ..hasRequiredFields = false
  ...
  LogEntrySourceLocation.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  LogEntrySourceLocation.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  LogEntrySourceLocation clone() => LogEntrySourceLocation()..mergeFromMessage(this);
  LogEntrySourceLocation copyWith(void Function(LogEntrySourceLocation) updates) => super.copyWith((message) => updates(message as LogEntrySourceLocation));
  $pb.BuilderInfo get info_ => _i;
  ...
  static LogEntrySourceLocation getDefault() => _defaultInstance ??= create()..freeze();
