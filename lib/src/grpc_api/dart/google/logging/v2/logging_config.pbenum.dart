...
class LogSink_VersionFormat extends ProtobufEnum {
  ...
  static LogSink_VersionFormat valueOf(int value) =>
      _byValue[value] as LogSink_VersionFormat;
  static void $checkItem(LogSink_VersionFormat v) {
    if (v is! LogSink_VersionFormat)
      checkItemFailed(v, 'LogSink_VersionFormat');
  }
