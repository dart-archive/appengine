...
class DeleteLogRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('DeleteLogRequest', package: const $pb.PackageName('google.logging.v2'))
    ..aOS(1, 'logName')
    ..hasRequiredFields = false
  ;

  DeleteLogRequest() : super();
  DeleteLogRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  DeleteLogRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  DeleteLogRequest clone() => DeleteLogRequest()..mergeFromMessage(this);
  DeleteLogRequest copyWith(void Function(DeleteLogRequest) updates) => super.copyWith((message) => updates(message as DeleteLogRequest));
  ...
  static DeleteLogRequest getDefault() => _defaultInstance ??= create()..freeze();
...
class WriteLogEntriesRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('WriteLogEntriesRequest', package: const $pb.PackageName('google.logging.v2'))
    ..aOS(1, 'logName')
    ..a<$0.MonitoredResource>(2, 'resource', $pb.PbFieldType.OM, $0.MonitoredResource.getDefault, $0.MonitoredResource.create)
    ..m<$core.String, $core.String>(3, 'labels', 'WriteLogEntriesRequest.LabelsEntry',$pb.PbFieldType.OS, $pb.PbFieldType.OS, null, null, null , const $pb.PackageName('google.logging.v2'))
  ...
  WriteLogEntriesRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  WriteLogEntriesRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  WriteLogEntriesRequest clone() => WriteLogEntriesRequest()..mergeFromMessage(this);
  WriteLogEntriesRequest copyWith(void Function(WriteLogEntriesRequest) updates) => super.copyWith((message) => updates(message as WriteLogEntriesRequest));
  $pb.BuilderInfo get info_ => _i;
  ...
  static WriteLogEntriesRequest getDefault() => _defaultInstance ??= create()..freeze();
  ...
  set resource($0.MonitoredResource v) { setField(2, v); }
...
class WriteLogEntriesResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('WriteLogEntriesResponse', package: const $pb.PackageName('google.logging.v2'))
    ..hasRequiredFields = false
  ;

  WriteLogEntriesResponse() : super();
  WriteLogEntriesResponse.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  WriteLogEntriesResponse.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  WriteLogEntriesResponse clone() => WriteLogEntriesResponse()..mergeFromMessage(this);
  WriteLogEntriesResponse copyWith(void Function(WriteLogEntriesResponse) updates) => super.copyWith((message) => updates(message as WriteLogEntriesResponse));
  $pb.BuilderInfo get info_ => _i;
  ...
  static WriteLogEntriesResponse getDefault() => _defaultInstance ??= create()..freeze();
  static WriteLogEntriesResponse _defaultInstance;
}

class WriteLogEntriesPartialErrors extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('WriteLogEntriesPartialErrors', package: const $pb.PackageName('google.logging.v2'))
    ..m<$core.int, $2.Status>(1, 'logEntryErrors', 'WriteLogEntriesPartialErrors.LogEntryErrorsEntry',$pb.PbFieldType.O3, $pb.PbFieldType.OM, $2.Status.create, null, null , const $pb.PackageName('google.logging.v2'))
    ..hasRequiredFields = false
  ;

  WriteLogEntriesPartialErrors() : super();
  WriteLogEntriesPartialErrors.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  WriteLogEntriesPartialErrors.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  WriteLogEntriesPartialErrors clone() => WriteLogEntriesPartialErrors()..mergeFromMessage(this);
  WriteLogEntriesPartialErrors copyWith(void Function(WriteLogEntriesPartialErrors) updates) => super.copyWith((message) => updates(message as WriteLogEntriesPartialErrors));
  $pb.BuilderInfo get info_ => _i;
  static WriteLogEntriesPartialErrors create() => WriteLogEntriesPartialErrors();
  ...
  static WriteLogEntriesPartialErrors getDefault() => _defaultInstance ??= create()..freeze();
...
class ListLogEntriesRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ListLogEntriesRequest', package: const $pb.PackageName('google.logging.v2'))
    ..pPS(1, 'projectIds')
    ..aOS(2, 'filter')
    ..aOS(3, 'orderBy')
  ...
  ListLogEntriesRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  ListLogEntriesRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ListLogEntriesRequest clone() => ListLogEntriesRequest()..mergeFromMessage(this);
  ListLogEntriesRequest copyWith(void Function(ListLogEntriesRequest) updates) => super.copyWith((message) => updates(message as ListLogEntriesRequest));
  $pb.BuilderInfo get info_ => _i;
  ...
  static ListLogEntriesRequest getDefault() => _defaultInstance ??= create()..freeze();
...
class ListLogEntriesResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ListLogEntriesResponse', package: const $pb.PackageName('google.logging.v2'))
  ...
  ListLogEntriesResponse.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  ListLogEntriesResponse.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ListLogEntriesResponse clone() => ListLogEntriesResponse()..mergeFromMessage(this);
  ListLogEntriesResponse copyWith(void Function(ListLogEntriesResponse) updates) => super.copyWith((message) => updates(message as ListLogEntriesResponse));
  $pb.BuilderInfo get info_ => _i;
  ...
  static ListLogEntriesResponse getDefault() => _defaultInstance ??= create()..freeze();
...
class ListMonitoredResourceDescriptorsRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ListMonitoredResourceDescriptorsRequest', package: const $pb.PackageName('google.logging.v2'))
...
class ListMonitoredResourceDescriptorsResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ListMonitoredResourceDescriptorsResponse', package: const $pb.PackageName('google.logging.v2'))
...
class ListLogsRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ListLogsRequest', package: const $pb.PackageName('google.logging.v2'))
    ..aOS(1, 'parent')
  ...
  ListLogsRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  ListLogsRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ListLogsRequest clone() => ListLogsRequest()..mergeFromMessage(this);
  ListLogsRequest copyWith(void Function(ListLogsRequest) updates) => super.copyWith((message) => updates(message as ListLogsRequest));
  $pb.BuilderInfo get info_ => _i;
  ...
  static ListLogsRequest getDefault() => _defaultInstance ??= create()..freeze();
...
class ListLogsResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ListLogsResponse', package: const $pb.PackageName('google.logging.v2'))
    ..aOS(2, 'nextPageToken')
    ..pPS(3, 'logNames')
    ..hasRequiredFields = false
  ;
  ...
  ListLogsResponse.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  ListLogsResponse.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ListLogsResponse clone() => ListLogsResponse()..mergeFromMessage(this);
  ListLogsResponse copyWith(void Function(ListLogsResponse) updates) => super.copyWith((message) => updates(message as ListLogsResponse));
  $pb.BuilderInfo get info_ => _i;
  ...
  static ListLogsResponse getDefault() => _defaultInstance ??= create()..freeze();
...
class LoggingServiceV2Api {
  ...
  $async.Future<$3.Empty> deleteLog($pb.ClientContext ctx, DeleteLogRequest request) {
    var emptyResponse = $3.Empty();
    return _client.invoke<$3.Empty>(ctx, 'LoggingServiceV2', 'DeleteLog', request, emptyResponse);
  }
  $async.Future<WriteLogEntriesResponse> writeLogEntries($pb.ClientContext ctx, WriteLogEntriesRequest request) {
  ...
  $async.Future<ListLogEntriesResponse> listLogEntries($pb.ClientContext ctx, ListLogEntriesRequest request) {
