...
class HttpRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('HttpRequest', package: const $pb.PackageName('google.logging.type'))
    ..aOS(1, 'requestMethod')
    ..aOS(2, 'requestUrl')
    ...
    ..aOS(13, 'serverIp')
    ..a<$0.Duration>(14, 'latency', $pb.PbFieldType.OM, $0.Duration.getDefault, $0.Duration.create)
    ..aOS(15, 'protocol')
  ...
  set requestSize(Int64 v) { $_setInt64(2, v); }
  ...
  set responseSize(Int64 v) { $_setInt64(4, v); }
  ...
  set cacheFillBytes(Int64 v) { $_setInt64(11, v); }
